...
pub unsafe extern "C" fn xmlBufCreate() -> xmlBufPtr {
    ...
    ret = xmlMalloc
        ...
        )(::std::mem::size_of::<xmlBuf>() as libc::c_ulong) as xmlBufPtr;
    if ret.is_null() {
        xmlBufMemoryError(
            0 as xmlBufPtr,
    ...
    *fresh0 = 0 as xmlBufferPtr;
    ...
    if (*ret).size < 2147483647 as libc::c_int as libc::c_ulong {
        (*ret).compat_size = (*ret).size as libc::c_uint;
    } else {
        (*ret).compat_size = 2147483647 as libc::c_int as libc::c_uint;
    }
    if (*ret).use_0 < 2147483647 as libc::c_int as libc::c_ulong {
        (*ret).compat_use = (*ret).use_0 as libc::c_uint;
    } else {
    ...
    *fresh1 = xmlMallocAtomic
        .expect(
            "non-null function pointer",
        )(((*ret).size).wrapping_mul(::std::mem::size_of::<xmlChar>() as libc::c_ulong))
        as *mut xmlChar;
...
pub unsafe extern "C" fn xmlBufEmpty(mut buf: xmlBufPtr) {
        ...
        == XML_BUFFER_ALLOC_IMMUTABLE as libc::c_int as libc::c_uint
    {
        ...
        *fresh11 = b"\0" as *const u8 as *const libc::c_char as *mut xmlChar;
        ...
        *fresh12 = (*fresh12 as libc::c_ulong).wrapping_add(start_buf) as size_t
            as size_t;
...
pub unsafe extern "C" fn xmlBufShrink(mut buf: xmlBufPtr, mut len: size_t) -> size_t {
    ...
    *fresh14 = (*fresh14 as libc::c_ulong).wrapping_sub(len) as size_t as size_t;
    if (*buf).alloc as libc::c_uint
        == XML_BUFFER_ALLOC_IMMUTABLE as libc::c_int as libc::c_uint
        || (*buf).alloc as libc::c_uint
            == XML_BUFFER_ALLOC_IO as libc::c_int as libc::c_uint
            && !((*buf).contentIO).is_null()
    {
        ...
        *fresh16 = (*fresh16 as libc::c_ulong).wrapping_sub(len) as size_t as size_t;
        if (*buf).alloc as libc::c_uint
            == XML_BUFFER_ALLOC_IO as libc::c_int as libc::c_uint
            && !((*buf).contentIO).is_null()
        {
            ...
            if start_buf >= (*buf).size {
                ...
                *fresh18 = (*fresh18 as libc::c_ulong).wrapping_add(start_buf) as size_t
                    as size_t;
            }
        }
    } else {
...
unsafe extern "C" fn xmlBufGrowInternal(mut buf: xmlBufPtr, mut len: size_t) -> size_t {
    ...
    if len >= (-(1 as libc::c_int) as size_t).wrapping_sub((*buf).use_0) {
        xmlBufMemoryError(
            buf,
            b"growing buffer past SIZE_MAX\0" as *const u8 as *const libc::c_char,
        );
        return 0 as libc::c_int as size_t;
    }
    if (*buf).size > len {
                ...
                .wrapping_div(2 as libc::c_int as libc::c_ulong)
        {
            ...
            ((*buf).size).wrapping_mul(2 as libc::c_int as libc::c_ulong)
        };
    } else {
                ...
                .wrapping_sub(100 as libc::c_int as libc::c_ulong)
        {
            ...
            size.wrapping_add(100 as libc::c_int as libc::c_ulong)
        };
    }
    if (*buf).alloc as libc::c_uint
        == XML_BUFFER_ALLOC_BOUNDED as libc::c_int as libc::c_uint
    {
        if ((*buf).use_0)
            ...
            || (*buf).size >= 10000000 as libc::c_int as libc::c_ulong
        {
            xmlBufMemoryError(
                buf,
        ...
        if size >= 10000000 as libc::c_int as libc::c_ulong {
...
pub unsafe extern "C" fn xmlBufAddLen(
    ...
    *fresh22 = (*fresh22 as libc::c_ulong).wrapping_add(len) as size_t as size_t;
    *((*buf).content).offset((*buf).use_0 as isize) = 0 as libc::c_int as xmlChar;
    if (*buf).size < 2147483647 as libc::c_int as libc::c_ulong {
        (*buf).compat_size = (*buf).size as libc::c_uint;
    } else {
...
pub unsafe extern "C" fn xmlBufIsEmpty(buf: xmlBufPtr) -> libc::c_int {
    ...
    return ((*buf).use_0 == 0 as libc::c_int as libc::c_ulong) as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn xmlBufResize(
    ...
    match (*buf).alloc as libc::c_uint {
        3 | 0 => {
            if (*buf).size == 0 as libc::c_int as libc::c_ulong {
                newSize = if size
                    > (-(1 as libc::c_int) as size_t)
                        .wrapping_sub(10 as libc::c_int as libc::c_ulong)
                {
                    ...
                    size.wrapping_add(10 as libc::c_int as libc::c_ulong)
                };
            } else {
                newSize = (*buf).size;
            }
        ...
        4 => {
            if (*buf).use_0 < 4096 as libc::c_int as libc::c_ulong {
                newSize = size;
            } else {
                newSize = (*buf).size;
                while size > newSize {
        ...
        && !((*buf).contentIO).is_null()
    {
        ...
        if start_buf > newSize {
            ...
            *fresh24 = (*fresh24 as libc::c_ulong).wrapping_add(start_buf) as size_t
                as size_t;
        } else {
            rebuf = xmlRealloc
                .expect(
...
pub unsafe extern "C" fn xmlBufAdd(
    ...
    if len as size_t >= ((*buf).size).wrapping_sub((*buf).use_0) {
        if len as size_t >= (-(1 as libc::c_int) as size_t).wrapping_sub((*buf).use_0) {
            xmlBufMemoryError(
                buf,
                b"growing buffer past SIZE_MAX\0" as *const u8 as *const libc::c_char,
            );
        ...
        if (*buf).alloc as libc::c_uint
            == XML_BUFFER_ALLOC_BOUNDED as libc::c_int as libc::c_uint
        {
            if needSize >= 10000000 as libc::c_int as libc::c_ulong {
                xmlBufMemoryError(
                    buf,
                    b"buffer error: text too long\n\0" as *const u8
    ...
    *fresh28 = (*fresh28 as libc::c_ulong).wrapping_add(len as libc::c_ulong) as size_t
        as size_t;
    *((*buf).content).offset((*buf).use_0 as isize) = 0 as libc::c_int as xmlChar;
    if (*buf).size < 2147483647 as libc::c_int as libc::c_ulong {
        (*buf).compat_size = (*buf).size as libc::c_uint;
...
pub unsafe extern "C" fn xmlBufBackToBuffer(mut buf: xmlBufPtr) -> xmlBufferPtr {
    ...
    } else if (*buf).size > 2147483647 as libc::c_int as libc::c_ulong {
        xmlBufOverflowError(
            buf,
...
pub unsafe extern "C" fn xmlBufSetInputBaseCur(
    ...
    if buf.is_null() || (*buf).error != 0 {
        ...
        *fresh37 = b"\0" as *const u8 as *const libc::c_char as *mut xmlChar;
