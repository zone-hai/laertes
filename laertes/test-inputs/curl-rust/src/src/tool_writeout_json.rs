...
pub unsafe extern "C" fn jsonWriteString(
    ...
    let mut in_end: *const libc::c_char = in_0.offset(strlen(in_0) as isize);
    while i < in_end {
        match *i as libc::c_int {
            ...
            8 => {
                fputs(b"\\b\0" as *const u8 as *const libc::c_char, stream);
            }
            12 => {
                fputs(b"\\f\0" as *const u8 as *const libc::c_char, stream);
            }
            10 => {
                fputs(b"\\n\0" as *const u8 as *const libc::c_char, stream);
            }
            13 => {
                fputs(b"\\r\0" as *const u8 as *const libc::c_char, stream);
            }
            9 => {
                fputs(b"\\t\0" as *const u8 as *const libc::c_char, stream);
            }
...
pub unsafe extern "C" fn ourWriteOutJSON(
    ...
    curl_mfprintf(stream, b"\"curl_version\":\"\0" as *const u8 as *const libc::c_char);
    jsonWriteString(stream, curl_version());
    curl_mfprintf(stream, b"\"}\0" as *const u8 as *const libc::c_char);
}
