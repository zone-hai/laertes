...
pub unsafe extern "C" fn getfiletime(
    ...
    let mut result: curl_off_t = -(1 as libc::c_int) as curl_off_t;
    ...
    if -(1 as libc::c_int) != stat(filename, &mut statbuf) {
...
pub unsafe extern "C" fn setfiletime(
    ...
    if filetime >= 0 as libc::c_int as libc::c_long {
        ...
        times[1 as libc::c_int as usize].tv_sec = filetime;
        times[0 as libc::c_int as usize]
            .tv_sec = times[1 as libc::c_int as usize].tv_sec;
