...
extern "C" {
    ...
    fn Curl_is_ASCII_name(hostname: *const libc::c_char) -> bool;
    fn Curl_idnconvert_hostname(data: *mut Curl_easy, host: *mut hostname) -> CURLcode;
    fn Curl_free_idnconverted_hostname(host: *mut hostname);
    fn Curl_gethostname(name: *mut libc::c_char, namelen: size_t) -> libc::c_int;
...
pub static mut Curl_handler_smtp: Curl_handler = unsafe {
    {
        let mut init = Curl_handler {
            scheme: b"SMTP\0" as *const u8 as *const libc::c_char,
            ...
            attach: None,
            defport: 25 as libc::c_int,
            protocol: ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_uint,
            family: ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_uint,
...
pub static mut Curl_handler_smtps: Curl_handler = unsafe {
    {
        let mut init = Curl_handler {
            scheme: b"SMTPS\0" as *const u8 as *const libc::c_char,
            setup_connection: Some(
                smtp_setup_connection
                    as unsafe extern "C" fn(*mut Curl_easy, *mut connectdata) -> CURLcode,
            ),
            ...
            connection_check: None,
            attach: None,
            defport: 465 as libc::c_int,
            protocol: ((1 as libc::c_int) << 17 as libc::c_int) as libc::c_uint,
            family: ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_uint,
            flags: ((1 as libc::c_int) << 2 as libc::c_int
...
static mut saslsmtp: SASLproto = unsafe {
    {
        let mut init = SASLproto {
            service: b"smtp\0" as *const u8 as *const libc::c_char,
            contcode: 334 as libc::c_int,
            finalcode: 235 as libc::c_int,
            maxirlen: (512 as libc::c_int - 8 as libc::c_int) as size_t,
            sendauth: Some(
                smtp_perform_auth
                    as unsafe extern "C" fn(
                        *mut Curl_easy,
...
unsafe extern "C" fn smtp_endofresp(
    ...
    if *line.offset(3 as libc::c_int as isize) as libc::c_int == ' ' as i32
        || len == 5 as libc::c_int as libc::c_ulong
    {
        let mut tmpline: [libc::c_char; 6] = [0; 6];
        ...
        *resp = curlx_sltosi(
            strtol(tmpline.as_mut_ptr(), 0 as *mut *mut libc::c_char, 10 as libc::c_int),
        );
        if *resp == 1 as libc::c_int {
            *resp = 0 as libc::c_int;
        }
    } else if *line.offset(3 as libc::c_int as isize) as libc::c_int == '-' as i32
            && ((*smtpc).state as libc::c_uint
                == SMTP_EHLO as libc::c_int as libc::c_uint
                || (*smtpc).state as libc::c_uint
                    == SMTP_COMMAND as libc::c_int as libc::c_uint)
        {
        result = 1 as libc::c_int != 0;
...
unsafe extern "C" fn smtp_get_message(
    ...
    if len > 4 as libc::c_int as libc::c_ulong {
        len = (len as libc::c_ulong).wrapping_sub(4 as libc::c_int as libc::c_ulong)
            as size_t as size_t;
        message = buffer.offset(4 as libc::c_int as isize);
...
unsafe extern "C" fn smtp_perform_ehlo(mut data: *mut Curl_easy) -> CURLcode {
    ...
    let mut smtpc: *mut smtp_conn = &mut (*conn).proto.smtpc;
    (*smtpc).sasl.authmechs = 0 as libc::c_int as libc::c_ushort;
    (*smtpc).sasl.authused = 0 as libc::c_int as libc::c_ushort;
    (*smtpc).tls_supported = 0 as libc::c_int != 0;
    (*smtpc).auth_supported = 0 as libc::c_int != 0;
    result = Curl_pp_sendf(
        data,
        &mut (*smtpc).pp as *mut pingpong,
        b"EHLO %s\0" as *const u8 as *const libc::c_char,
        (*smtpc).domain,
    );
    if result as u64 == 0 {
...
unsafe extern "C" fn smtp_perform_helo(
    ...
    result = Curl_pp_sendf(
        data,
        &mut (*smtpc).pp as *mut pingpong,
        b"HELO %s\0" as *const u8 as *const libc::c_char,
        (*smtpc).domain,
    );
    if result as u64 == 0 {
...
unsafe extern "C" fn smtp_perform_upgrade_tls(mut data: *mut Curl_easy) -> CURLcode {
    ...
    if result as u64 == 0 {
        if (*smtpc).state as libc::c_uint
            != SMTP_UPGRADETLS as libc::c_int as libc::c_uint
        {
...
unsafe extern "C" fn smtp_perform_command(mut data: *mut Curl_easy) -> CURLcode {
    ...
    if !((*smtp).rcpt).is_null() {
        let mut utf8: bool = 0 as libc::c_int != 0;
        if ((*smtp).custom).is_null()
            || *((*smtp).custom).offset(0 as libc::c_int as isize) == 0
        {
            let mut address: *mut libc::c_char = 0 as *mut libc::c_char;
            let mut host: hostname = {
                let mut init = hostname {
                    rawalloc: 0 as *mut libc::c_char,
                    encalloc: 0 as *mut libc::c_char,
                    name: 0 as *mut libc::c_char,
                    dispname: 0 as *const libc::c_char,
                };
                init
            };
            ...
            utf8 = (*conn).proto.smtpc.utf8_supported as libc::c_int != 0
                && (!(host.encalloc).is_null() || !Curl_is_ASCII_name(address)
                    || !Curl_is_ASCII_name(host.name));
            result = Curl_pp_sendf(
                data,
                &mut (*conn).proto.smtpc.pp as *mut pingpong,
                b"VRFY %s%s%s%s\0" as *const u8 as *const libc::c_char,
                address,
                ...
                if !(host.name).is_null() {
                    host.name as *const libc::c_char
                } else {
                    b"\0" as *const u8 as *const libc::c_char
                },
                if utf8 as libc::c_int != 0 {
                    b" SMTPUTF8\0" as *const u8 as *const libc::c_char
                } else {
                    b"\0" as *const u8 as *const libc::c_char
                },
            );
            ...
            utf8 = (*conn).proto.smtpc.utf8_supported as libc::c_int != 0
                && strcmp((*smtp).custom, b"EXPN\0" as *const u8 as *const libc::c_char)
                    == 0;
            result = Curl_pp_sendf(
                data,
                &mut (*conn).proto.smtpc.pp as *mut pingpong,
        ...
        result = Curl_pp_sendf(
            ...
            b"%s\0" as *const u8 as *const libc::c_char,
            if !((*smtp).custom).is_null()
                && *((*smtp).custom).offset(0 as libc::c_int as isize) as libc::c_int
                    != '\u{0}' as i32
            {
                (*smtp).custom as *const libc::c_char
            } else {
...
unsafe extern "C" fn smtp_perform_mail(mut data: *mut Curl_easy) -> CURLcode {
    ...
    let mut size: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut result: CURLcode = CURLE_OK;
    let mut conn: *mut connectdata = (*data).conn;
    let mut utf8: bool = 0 as libc::c_int != 0;
    if !((*data).set.str_0[STRING_MAIL_FROM as libc::c_int as usize]).is_null() {
        let mut address: *mut libc::c_char = 0 as *mut libc::c_char;
        let mut host: hostname = {
            let mut init = hostname {
                rawalloc: 0 as *mut libc::c_char,
        ...
        result = smtp_parse_address(
            data,
            (*data).set.str_0[STRING_MAIL_FROM as libc::c_int as usize],
            &mut address,
            &mut host,
        );
        if result as u64 != 0 {
        ...
        if !(host.name).is_null() {
            ...
            from = curl_maprintf(b"<%s>\0" as *const u8 as *const libc::c_char, address);
        }
        Curl_cfree.expect("non-null function pointer")(address as *mut libc::c_void);
    } else {
        from = Curl_cstrdup
    ...
    if !((*data).set.str_0[STRING_MAIL_AUTH as libc::c_int as usize]).is_null()
        && (*conn).proto.smtpc.sasl.authused as libc::c_int != 0
    {
        if *((*data).set.str_0[STRING_MAIL_AUTH as libc::c_int as usize])
            .offset(0 as libc::c_int as isize) as libc::c_int != '\u{0}' as i32
        {
            let mut address_0: *mut libc::c_char = 0 as *mut libc::c_char;
            ...
            result = smtp_parse_address(
                data,
                (*data).set.str_0[STRING_MAIL_AUTH as libc::c_int as usize],
                &mut address_0,
                &mut host_0,
            );
            if result as u64 != 0 {
        ...
        != MIMEKIND_NONE as libc::c_int as libc::c_uint
    {
        ...
        let ref mut fresh3 = (*data).state.fread_func;
        *fresh3 = ::std::mem::transmute::<
        ...
        let ref mut fresh4 = (*data).state.in_0;
        *fresh4 = &mut (*data).set.mimepost as *mut curl_mimepart as *mut libc::c_void;
    }
    if (*conn).proto.smtpc.size_supported as libc::c_int != 0
        && (*data).state.infilesize > 0 as libc::c_int as libc::c_long
    {
        size = curl_maprintf(
    ...
    if (*conn).proto.smtpc.utf8_supported as libc::c_int != 0 && !utf8 {
        let mut smtp: *mut SMTP = (*data).req.p.smtp;
    ...
    result = Curl_pp_sendf(
        data,
        &mut (*conn).proto.smtpc.pp as *mut pingpong,
        b"MAIL FROM:%s%s%s%s%s%s\0" as *const u8 as *const libc::c_char,
        from,
        if !auth.is_null() {
...
unsafe extern "C" fn smtp_perform_rcpt_to(mut data: *mut Curl_easy) -> CURLcode {
    ...
    if !(host.name).is_null() {
        result = Curl_pp_sendf(
            data,
            &mut (*conn).proto.smtpc.pp as *mut pingpong,
            b"RCPT TO:<%s@%s>\0" as *const u8 as *const libc::c_char,
            address,
            host.name,
        );
    } else {
        result = Curl_pp_sendf(
            data,
            &mut (*conn).proto.smtpc.pp as *mut pingpong,
            b"RCPT TO:<%s>\0" as *const u8 as *const libc::c_char,
            address,
        );
    }
    Curl_free_idnconverted_hostname(&mut host);
...
unsafe extern "C" fn smtp_state_servergreet_resp(
    mut data: *mut Curl_easy,
    mut smtpcode: libc::c_int,
    mut instate: smtpstate,
) -> CURLcode {
    let mut result: CURLcode = CURLE_OK;
    if smtpcode / 100 as libc::c_int != 2 as libc::c_int {
        Curl_failf(
            data,
...
unsafe extern "C" fn smtp_state_starttls_resp(
    ...
    if smtpcode != 220 as libc::c_int {
        if (*data).set.use_ssl as libc::c_uint
            != CURLUSESSL_TRY as libc::c_int as libc::c_uint
        {
            Curl_failf(
                data,
                b"STARTTLS denied, code %d\0" as *const u8 as *const libc::c_char,
                smtpcode,
            );
...
unsafe extern "C" fn smtp_state_ehlo_resp(
    ...
    if smtpcode / 100 as libc::c_int != 2 as libc::c_int && smtpcode != 1 as libc::c_int
    {
        if (*data).set.use_ssl as libc::c_uint
            <= CURLUSESSL_TRY as libc::c_int as libc::c_uint
            || ((*conn).ssl[0 as libc::c_int as usize]).use_0() as libc::c_int != 0
        {
            result = smtp_perform_helo(data, conn);
        } else {
            Curl_failf(
                data,
                b"Remote access denied: %d\0" as *const u8 as *const libc::c_char,
                smtpcode,
            );
            result = CURLE_REMOTE_ACCESS_DENIED;
        }
    } else if len >= 4 as libc::c_int as libc::c_ulong {
        ...
        if len >= 8 as libc::c_int as libc::c_ulong
            && memcmp(
                line as *const libc::c_void,
                b"STARTTLS\0" as *const u8 as *const libc::c_char as *const libc::c_void,
                8 as libc::c_int as libc::c_ulong,
            ) == 0
        {
            (*smtpc).tls_supported = 1 as libc::c_int != 0;
        } else if len >= 4 as libc::c_int as libc::c_ulong
                && memcmp(
                    line as *const libc::c_void,
            ...
            {
            (*smtpc).size_supported = 1 as libc::c_int != 0;
            ...
            {
            (*smtpc).utf8_supported = 1 as libc::c_int != 0;
            ...
            {
            (*smtpc).auth_supported = 1 as libc::c_int != 0;
            ...
            loop {
                ...
                if mechbit as libc::c_int != 0 && llen == wordlen {
                    let ref mut fresh5 = (*smtpc).sasl.authmechs;
                    *fresh5 = (*fresh5 as libc::c_int | mechbit as libc::c_int)
                        as libc::c_ushort;
                }
                line = line.offset(wordlen as isize);
                len = (len as libc::c_ulong).wrapping_sub(wordlen) as size_t as size_t;
            }
        }
        if smtpcode != 1 as libc::c_int {
                ...
                && ((*conn).ssl[0 as libc::c_int as usize]).use_0() == 0
            {
                if (*smtpc).tls_supported {
                    ...
                    Curl_failf(
                        data,
                        b"STARTTLS not supported.\0" as *const u8 as *const libc::c_char,
                    );
                    result = CURLE_USE_SSL_FAILED;
                }
            } else {
        ...
        Curl_failf(
            data,
            b"Unexpectedly short EHLO response\0" as *const u8 as *const libc::c_char,
        );
        result = CURLE_WEIRD_SERVER_REPLY;
    }
    return result;
...
unsafe extern "C" fn smtp_state_command_resp(
    ...
    let mut len: size_t = strlen(line);
    if !((*smtp).rcpt).is_null() && smtpcode / 100 as libc::c_int != 2 as libc::c_int
        && smtpcode != 553 as libc::c_int && smtpcode != 1 as libc::c_int
        || ((*smtp).rcpt).is_null() && smtpcode / 100 as libc::c_int != 2 as libc::c_int
            && smtpcode != 1 as libc::c_int
    {
        Curl_failf(
            data,
            b"Command failed: %d\0" as *const u8 as *const libc::c_char,
            smtpcode,
        );
...
unsafe extern "C" fn smtp_state_mail_resp(
    ...
    if smtpcode / 100 as libc::c_int != 2 as libc::c_int {
        Curl_failf(
            data,
            b"MAIL failed: %d\0" as *const u8 as *const libc::c_char,
            smtpcode,
        );
...
unsafe extern "C" fn smtp_state_rcpt_resp(
    ...
    let mut result: CURLcode = CURLE_OK;
    let mut smtp: *mut SMTP = (*data).req.p.smtp;
    let mut is_smtp_err: bool = 0 as libc::c_int != 0;
    let mut is_smtp_blocking_err: bool = 0 as libc::c_int != 0;
    is_smtp_err = if smtpcode / 100 as libc::c_int != 2 as libc::c_int {
        1 as libc::c_int
    } else {
        0 as libc::c_int
    } != 0;
    is_smtp_blocking_err = if is_smtp_err as libc::c_int != 0
    ...
    if is_smtp_err {
        ...
        if is_smtp_blocking_err {
            Curl_failf(
                data,
                b"RCPT failed: %d\0" as *const u8 as *const libc::c_char,
                smtpcode,
            );
            result = CURLE_SEND_ERROR;
        }
    } else {
        (*smtp).rcpt_had_ok = 1 as libc::c_int != 0;
    }
    if !is_smtp_blocking_err {
        let ref mut fresh7 = (*smtp).rcpt;
        *fresh7 = (*(*smtp).rcpt).next;
        if !((*smtp).rcpt).is_null() {
            ...
            Curl_failf(
                data,
                b"RCPT failed: %d (last error)\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn smtp_state_data_resp(
    ...
    let mut result: CURLcode = CURLE_OK;
    if smtpcode != 354 as libc::c_int {
        Curl_failf(
            data,
            b"DATA failed: %d\0" as *const u8 as *const libc::c_char,
            smtpcode,
        );
        result = CURLE_SEND_ERROR;
    } else {
...
unsafe extern "C" fn smtp_statemachine(
    ...
    let mut smtpcode: libc::c_int = 0;
    let mut smtpc: *mut smtp_conn = &mut (*conn).proto.smtpc;
    let mut pp: *mut pingpong = &mut (*smtpc).pp;
    let mut nread: size_t = 0 as libc::c_int as size_t;
    if (*smtpc).state as libc::c_uint == SMTP_UPGRADETLS as libc::c_int as libc::c_uint {
    ...
    loop {
        ...
        if (*smtpc).state as libc::c_uint != SMTP_QUIT as libc::c_int as libc::c_uint
            && smtpcode != 1 as libc::c_int
        {
        ...
        match (*smtpc).state as libc::c_uint {
            1 => {
        ...
        if !(result as u64 == 0
            && (*smtpc).state as libc::c_uint != SMTP_STOP as libc::c_int as libc::c_uint
...
unsafe extern "C" fn smtp_multi_statemach(
        ...
        && !(*smtpc).ssldone
    {
        ...
        if result as libc::c_uint != 0 || !(*smtpc).ssldone {
            return result;
        }
    }
    ...
    *done = if (*smtpc).state as libc::c_uint == SMTP_STOP as libc::c_int as libc::c_uint
    {
        1 as libc::c_int
    } else {
        0 as libc::c_int
...
unsafe extern "C" fn smtp_block_statemach(
    ...
    let mut result: CURLcode = CURLE_OK;
    let mut smtpc: *mut smtp_conn = &mut (*conn).proto.smtpc;
    while (*smtpc).state as libc::c_uint != SMTP_STOP as libc::c_int as libc::c_uint
        && result as u64 == 0
    {
        result = Curl_pp_statemach(
            data,
...
unsafe extern "C" fn smtp_init(mut data: *mut Curl_easy) -> CURLcode {
    ...
    let ref mut fresh8 = (*data).req.p.smtp;
    *fresh8 = Curl_ccalloc
        .expect(
            "non-null function pointer",
        )(::std::mem::size_of::<SMTP>() as libc::c_ulong, 1 as libc::c_int as size_t)
        as *mut SMTP;
    smtp = *fresh8;
    if smtp.is_null() {
...
unsafe extern "C" fn smtp_connect(
    ...
    *done = 0 as libc::c_int != 0;
    ...
    let ref mut fresh9 = (*pp).statemachine;
    *fresh9 = Some(
        smtp_statemachine
            as unsafe extern "C" fn(*mut Curl_easy, *mut connectdata) -> CURLcode,
    );
    let ref mut fresh10 = (*pp).endofresp;
    *fresh10 = Some(
        smtp_endofresp
            as unsafe extern "C" fn(
                *mut Curl_easy,
...
unsafe extern "C" fn smtp_done(
    ...
    let ref mut fresh11 = (*smtp).custom;
    ...
    if status as u64 != 0 {
        ...
        result = status;
            ...
            && (((*data).set).upload() as libc::c_int != 0
                || (*data).set.mimepost.kind as libc::c_uint != 0)
        {
        if (*smtp).trailing_crlf as libc::c_int != 0 || (*data).state.infilesize == 0 {
            eob = Curl_cstrdup
                .expect(
                    "non-null function pointer",
                )(
            ...
            len = (5 as libc::c_int - 2 as libc::c_int) as ssize_t;
        } else {
            eob = Curl_cstrdup
                .expect(
                    "non-null function pointer",
                )(b"\r\n.\r\n\0" as *const u8 as *const libc::c_char);
            len = 5 as libc::c_int as ssize_t;
        }
        if eob.is_null() {
            return CURLE_OUT_OF_MEMORY;
        }
        ...
        if bytes_written != len {
            let ref mut fresh12 = (*pp).sendthis;
            *fresh12 = eob;
        ...
        result = smtp_block_statemach(data, conn, 0 as libc::c_int != 0);
    }
...
unsafe extern "C" fn smtp_perform(
    ...
    *dophase_done = 0 as libc::c_int != 0;
    let ref mut fresh13 = (*smtp).rcpt;
    *fresh13 = (*data).set.mail_rcpt;
    (*smtp).rcpt_had_ok = 0 as libc::c_int != 0;
    (*smtp).rcpt_last_error = 0 as libc::c_int;
    (*smtp).trailing_crlf = 1 as libc::c_int != 0;
    (*smtp).eob = 2 as libc::c_int as size_t;
...
unsafe extern "C" fn smtp_disconnect(
    ...
    if !dead_connection && ((*conn).bits).protoconnstart() as libc::c_int != 0 {
        if smtp_perform_quit(data, conn) as u64 == 0 {
            smtp_block_statemach(data, conn, 1 as libc::c_int != 0);
        }
    }
    Curl_pp_disconnect(&mut (*smtpc).pp);
    Curl_sasl_cleanup(conn, (*smtpc).sasl.authused as libc::c_uint);
    Curl_cfree.expect("non-null function pointer")((*smtpc).domain as *mut libc::c_void);
    let ref mut fresh14 = (*smtpc).domain;
...
unsafe extern "C" fn smtp_dophase_done(
    ...
    let mut smtp: *mut SMTP = (*data).req.p.smtp;
    if (*smtp).transfer as libc::c_uint != PPTRANSFER_BODY as libc::c_int as libc::c_uint
    {
        Curl_setup_transfer(
            data,
            -(1 as libc::c_int),
...
unsafe extern "C" fn smtp_doing(
    ...
    if !(result as u64 != 0) {
        if *dophase_done {
            result = smtp_dophase_done(data, 0 as libc::c_int != 0);
        }
    }
    return result;
}
...
unsafe extern "C" fn smtp_setup_connection(
    ...
    (*fresh15).set_tls_upgraded(0 as libc::c_int as bit);
...
unsafe extern "C" fn smtp_parse_url_options(mut conn: *mut connectdata) -> CURLcode {
    ...
    (*smtpc).sasl.resetprefs = 1 as libc::c_int != 0;
...
unsafe extern "C" fn smtp_parse_url_path(mut data: *mut Curl_easy) -> CURLcode {
    let mut conn: *mut connectdata = (*data).conn;
    let mut smtpc: *mut smtp_conn = &mut (*conn).proto.smtpc;
    let mut path: *const libc::c_char = &mut *((*data).state.up.path)
        .offset(1 as libc::c_int as isize) as *mut libc::c_char;
    let mut localhost: [libc::c_char; 1025] = [0; 1025];
    if *path == 0 {
        if Curl_gethostname(
        ...
        ) == 0
        {
            ...
            path = b"localhost\0" as *const u8 as *const libc::c_char;
        }
    }
...
unsafe extern "C" fn smtp_parse_address(
    mut data: *mut Curl_easy,
    mut fqma: *const libc::c_char,
    mut address: *mut *mut libc::c_char,
    mut host: *mut hostname,
) -> CURLcode {
    let mut result: CURLcode = CURLE_OK;
    let mut length: size_t = 0;
    let mut dup: *mut libc::c_char = Curl_cstrdup
        .expect(
            "non-null function pointer",
        )(
        if *fqma.offset(0 as libc::c_int as isize) as libc::c_int == '<' as i32 {
            fqma.offset(1 as libc::c_int as isize)
        } else {
            fqma
        },
    );
    ...
    length = strlen(dup);
    if length != 0 {
        if *dup.offset(length.wrapping_sub(1 as libc::c_int as libc::c_ulong) as isize)
    ...
    let ref mut fresh16 = (*host).name;
    *fresh16 = strpbrk(dup, b"@\0" as *const u8 as *const libc::c_char);
    if !((*host).name).is_null() {
        *(*host).name = '\u{0}' as i32 as libc::c_char;
        let ref mut fresh17 = (*host).name;
        *fresh17 = ((*host).name).offset(1 as libc::c_int as isize);
...
pub unsafe extern "C" fn Curl_smtp_escape_eob(
    ...
    let mut smtp: *mut SMTP = (*data).req.p.smtp;
    let mut scratch: *mut libc::c_char = (*data).state.scratch;
    let mut newscratch: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut oldscratch: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut eob_sent: size_t = 0;
    if scratch.is_null() || ((*data).set).crlf() as libc::c_int != 0 {
        oldscratch = scratch;
        ...
        if newscratch.is_null() {
            Curl_failf(
                data,
                b"Failed to alloc scratch buffer!\0" as *const u8 as *const libc::c_char,
            );
            return CURLE_OUT_OF_MEMORY;
        }
    }
    ...
    while i < nread {
        if (*::std::mem::transmute::<
            &[u8; 6],
            &[libc::c_char; 6],
        >(b"\r\n.\r\n\0"))[(*smtp).eob as usize] as libc::c_int
            == *((*data).req.upload_fromhere).offset(i as isize) as libc::c_int
        {
            let ref mut fresh18 = (*smtp).eob;
            *fresh18 = (*fresh18).wrapping_add(1);
            if 2 as libc::c_int as libc::c_ulong == (*smtp).eob
                || 5 as libc::c_int as libc::c_ulong == (*smtp).eob
            {
                (*smtp).trailing_crlf = 1 as libc::c_int != 0;
            } else {
                (*smtp).trailing_crlf = 0 as libc::c_int != 0;
            }
        } else if (*smtp).eob != 0 {
            memcpy(
                &mut *scratch.offset(si as isize) as *mut libc::c_char
                    as *mut libc::c_void,
                &*(b"\r\n.\r\n\0" as *const u8 as *const libc::c_char)
                    .offset(eob_sent as isize) as *const libc::c_char
                    as *const libc::c_void,
                ((*smtp).eob).wrapping_sub(eob_sent),
            );
            si = (si as libc::c_ulong).wrapping_add(((*smtp).eob).wrapping_sub(eob_sent))
                as ssize_t as ssize_t;
            if (*::std::mem::transmute::<
                &[u8; 6],
                &[libc::c_char; 6],
            >(b"\r\n.\r\n\0"))[0 as libc::c_int as usize] as libc::c_int
                == *((*data).req.upload_fromhere).offset(i as isize) as libc::c_int
            {
                (*smtp).eob = 1 as libc::c_int as size_t;
            } else {
                (*smtp).eob = 0 as libc::c_int as size_t;
            }
            eob_sent = 0 as libc::c_int as size_t;
            (*smtp).trailing_crlf = 0 as libc::c_int != 0;
        }
        if 3 as libc::c_int as libc::c_ulong == (*smtp).eob {
            memcpy(
                &mut *scratch.offset(si as isize) as *mut libc::c_char
                    as *mut libc::c_void,
                &*(b"\r\n..\0" as *const u8 as *const libc::c_char)
                    .offset(eob_sent as isize) as *const libc::c_char
                    as *const libc::c_void,
                (4 as libc::c_int as libc::c_ulong).wrapping_sub(eob_sent),
            );
            si = (si as libc::c_ulong)
                .wrapping_add((4 as libc::c_int as libc::c_ulong).wrapping_sub(eob_sent))
                as ssize_t as ssize_t;
            (*smtp).eob = 0 as libc::c_int as size_t;
            eob_sent = 0 as libc::c_int as size_t;
        } else if (*smtp).eob == 0 {
    ...
    if ((*smtp).eob).wrapping_sub(eob_sent) != 0 {
        memcpy(
            &mut *scratch.offset(si as isize) as *mut libc::c_char as *mut libc::c_void,
            &*(b"\r\n.\r\n\0" as *const u8 as *const libc::c_char)
                .offset(eob_sent as isize) as *const libc::c_char as *const libc::c_void,
            ((*smtp).eob).wrapping_sub(eob_sent),
        );
        si = (si as libc::c_ulong).wrapping_add(((*smtp).eob).wrapping_sub(eob_sent))
            as ssize_t as ssize_t;
    ...
    if si != nread {
        let ref mut fresh20 = (*data).req.upload_fromhere;
        *fresh20 = scratch;
        let ref mut fresh21 = (*data).state.scratch;
        *fresh21 = scratch;
