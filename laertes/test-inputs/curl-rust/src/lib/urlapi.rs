...
extern "C" {
    ...
    fn Curl_isupper(c: libc::c_int) -> libc::c_int;
    ...
    fn Curl_isgraph(c: libc::c_int) -> libc::c_int;
    fn Curl_isspace(c: libc::c_int) -> libc::c_int;
    fn Curl_iscntrl(c: libc::c_int) -> libc::c_int;
    ...
    fn Curl_dedotdotify(input: *const libc::c_char) -> *mut libc::c_char;
    ...
    fn Curl_builtin_scheme(scheme: *const libc::c_char) -> *const Curl_handler;
    fn Curl_isunreserved(in_0: libc::c_uchar) -> bool;
    fn Curl_urldecode(
        data: *mut Curl_easy,
...
pub struct Curl_URL {
    ...
    pub options: *mut libc::c_char,
    pub host: *mut libc::c_char,
    pub zoneid: *mut libc::c_char,
    pub port: *mut libc::c_char,
    pub path: *mut libc::c_char,
    pub query: *mut libc::c_char,
    pub fragment: *mut libc::c_char,
    pub scratch: *mut libc::c_char,
    pub temppath: *mut libc::c_char,
    pub portnum: libc::c_long,
}
...
unsafe extern "C" fn free_urlhandle(mut u: *mut Curl_URL) {
...
unsafe extern "C" fn mv_urlhandle(mut from: *mut Curl_URL, mut to: *mut Curl_URL) {
    free_urlhandle(to);
    *to = *from;
    Curl_cfree.expect("non-null function pointer")(from as *mut libc::c_void);
}
unsafe extern "C" fn find_host_sep(mut url: *const libc::c_char) -> *const libc::c_char {
    let mut sep: *const libc::c_char = 0 as *const libc::c_char;
    let mut query: *const libc::c_char = 0 as *const libc::c_char;
    sep = strstr(url, b"//\0" as *const u8 as *const libc::c_char);
    if sep.is_null() {
        sep = url;
    } else {
        sep = sep.offset(2 as libc::c_int as isize);
    }
...
unsafe extern "C" fn urlchar_needs_escaping(mut c: libc::c_int) -> bool {
    return !(Curl_iscntrl(c as libc::c_uchar as libc::c_int) != 0
        || Curl_isspace(c as libc::c_uchar as libc::c_int) != 0
        || Curl_isgraph(c as libc::c_uchar as libc::c_int) != 0);
}
unsafe extern "C" fn strlen_url(
    ...
    let mut left: bool = 1 as libc::c_int != 0;
    let mut host_sep: *const libc::c_uchar = url as *const libc::c_uchar;
    if !relative {
        host_sep = find_host_sep(url) as *const libc::c_uchar;
    }
    ptr = url as *mut libc::c_uchar;
    while *ptr != 0 {
        if ptr < host_sep {
            ...
            match current_block_10 {
                8167214597936611784 => {
                    if urlchar_needs_escaping(*ptr as libc::c_int) {
                        newlen = (newlen as libc::c_ulong)
...
unsafe extern "C" fn strcpy_url(
    ...
    let mut left: bool = 1 as libc::c_int != 0;
    let mut iptr: *const libc::c_uchar = 0 as *const libc::c_uchar;
    let mut optr: *mut libc::c_char = output;
    let mut host_sep: *const libc::c_uchar = url as *const libc::c_uchar;
    if !relative {
        host_sep = find_host_sep(url) as *const libc::c_uchar;
    }
    iptr = url as *mut libc::c_uchar;
    while *iptr != 0 {
        if iptr < host_sep {
            let fresh0 = optr;
            optr = optr.offset(1);
            *fresh0 = *iptr as libc::c_char;
        } else {
                ...
                32 => {
                    if left {
                        ...
                        *fresh2 = '%' as i32 as libc::c_char;
                        let fresh3 = optr;
                        optr = optr.offset(1);
                        *fresh3 = '2' as i32 as libc::c_char;
                        let fresh4 = optr;
                        optr = optr.offset(1);
            ...
            match current_block_15 {
                11997719445127346396 => {
                    if urlchar_needs_escaping(*iptr as libc::c_int) {
                        curl_msnprintf(
                            optr,
                        ...
                        optr = optr.offset(3 as libc::c_int as isize);
                    } else {
                        let fresh1 = optr;
                        optr = optr.offset(1);
                        *fresh1 = *iptr as libc::c_char;
                    }
                }
                _ => {}
            }
    ...
    *optr = 0 as libc::c_int as libc::c_char;
}
#[no_mangle]
pub unsafe extern "C" fn Curl_is_absolute_url(
    ...
    while i < buflen && *url.offset(i as isize) as libc::c_int != 0 {
        let mut s: libc::c_char = *url.offset(i as isize);
        if s as libc::c_int == ':' as i32
            && *url.offset(i.wrapping_add(1 as libc::c_int as libc::c_ulong) as isize)
                as libc::c_int == '/' as i32
        {
            ...
            if !(Curl_isalnum(s as libc::c_uchar as libc::c_int) != 0
                ...
                *buf
                        ...
                        > 1 as libc::c_int as libc::c_ulong
                    {
                        if 0 != 0 {
                            ...
                            __res = tolower(s as libc::c_uchar as libc::c_int);
                        }
                    } else {
...
unsafe extern "C" fn concat_url(
    ...
    mut relurl: *const libc::c_char,
) -> *mut libc::c_char {
    let mut newest: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut protsep: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut pathsep: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut newlen: size_t = 0;
    let mut host_changed: bool = 0 as libc::c_int != 0;
    let mut useurl: *const libc::c_char = relurl;
    let mut urllen: size_t = 0;
    let mut url_clone: *mut libc::c_char = Curl_cstrdup
        .expect("non-null function pointer")(base);
    if url_clone.is_null() {
        return 0 as *mut libc::c_char;
    }
    protsep = strstr(url_clone, b"//\0" as *const u8 as *const libc::c_char);
    if protsep.is_null() {
        protsep = url_clone;
    } else {
        protsep = protsep.offset(2 as libc::c_int as isize);
    }
    if '/' as i32 != *relurl.offset(0 as libc::c_int as isize) as libc::c_int {
        let mut level: libc::c_int = 0 as libc::c_int;
        pathsep = strchr(protsep, '?' as i32);
        if !pathsep.is_null() {
            *pathsep = 0 as libc::c_int as libc::c_char;
        }
        if *useurl.offset(0 as libc::c_int as isize) as libc::c_int != '?' as i32 {
        ...
        pathsep = strchr(protsep, '/' as i32);
        if !pathsep.is_null() {
            protsep = pathsep.offset(1 as libc::c_int as isize);
        } else {
            protsep = 0 as *mut libc::c_char;
        }
        if *useurl.offset(0 as libc::c_int as isize) as libc::c_int == '.' as i32
            && *useurl.offset(1 as libc::c_int as isize) as libc::c_int == '/' as i32
        {
            useurl = useurl.offset(2 as libc::c_int as isize);
        }
        while *useurl.offset(0 as libc::c_int as isize) as libc::c_int == '.' as i32
            && *useurl.offset(1 as libc::c_int as isize) as libc::c_int == '.' as i32
            && *useurl.offset(2 as libc::c_int as isize) as libc::c_int == '/' as i32
        {
            level += 1;
            useurl = useurl.offset(3 as libc::c_int as isize);
        }
        if !protsep.is_null() {
            loop {
                let fresh6 = level;
                ...
                if !pathsep.is_null() {
                    ...
                    *protsep = 0 as libc::c_int as libc::c_char;
                    break;
                }
            }
        }
    } else if *relurl.offset(1 as libc::c_int as isize) as libc::c_int == '/' as i32 {
        *protsep = 0 as libc::c_int as libc::c_char;
        useurl = &*relurl.offset(2 as libc::c_int as isize) as *const libc::c_char;
        host_changed = 1 as libc::c_int != 0;
    } else {
        pathsep = strchr(protsep, '/' as i32);
        if !pathsep.is_null() {
            let mut sep: *mut libc::c_char = strchr(protsep, '?' as i32);
    ...
    if !('/' as i32 == *useurl.offset(0 as libc::c_int as isize) as libc::c_int
        || !protsep.is_null() && *protsep == 0
        || '?' as i32 == *useurl.offset(0 as libc::c_int as isize) as libc::c_int)
    {
        let fresh7 = urllen;
        urllen = urllen.wrapping_add(1);
        *newest.offset(fresh7 as isize) = '/' as i32 as libc::c_char;
    }
    strcpy_url(&mut *newest.offset(urllen as isize), useurl, !host_changed);
    Curl_cfree.expect("non-null function pointer")(url_clone as *mut libc::c_void);
    return newest;
}
unsafe extern "C" fn parse_hostname_login(
    mut u: *mut Curl_URL,
    ...
    let mut passwdp: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut optionsp: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut h: *const Curl_handler = 0 as *const Curl_handler;
    let mut ptr: *mut libc::c_char = strchr(*hostname, '@' as i32);
    let mut login: *mut libc::c_char = *hostname;
    if !ptr.is_null() {
        ptr = ptr.offset(1);
        *hostname = ptr;
        if !((*u).scheme).is_null() {
        ...
        ccode = Curl_parse_login_details(
            login,
            (ptr.offset_from(login) as libc::c_long - 1 as libc::c_int as libc::c_long)
                as size_t,
            &mut userp,
            &mut passwdp,
            if !h.is_null()
                && (*h).flags & ((1 as libc::c_int) << 10 as libc::c_int) as libc::c_uint
                    != 0
            {
                &mut optionsp
            } else {
        ...
        if ccode as u64 != 0 {
            ...
            match current_block {
                ...
                _ => {
                    if !passwdp.is_null() {
                        let ref mut fresh9 = (*u).password;
                        *fresh9 = passwdp;
                    }
                    if !optionsp.is_null() {
                        let ref mut fresh10 = (*u).options;
                        *fresh10 = optionsp;
                    }
                    return CURLUE_OK;
                }
...
unsafe extern "C" fn Curl_parse_port(
    ...
    let mut endbracket: libc::c_char = 0;
    let mut len: libc::c_int = 0;
    if 1 as libc::c_int
        == sscanf(
            hostname,
            b"[%*45[0123456789abcdefABCDEF:.]%c%n\0" as *const u8 as *const libc::c_char,
            &mut endbracket as *mut libc::c_char,
            &mut len as *mut libc::c_int,
        )
    {
        if ']' as i32 == endbracket as libc::c_int {
            portptr = &mut *hostname.offset(len as isize) as *mut libc::c_char;
        } else if '%' as i32 == endbracket as libc::c_int {
            let mut zonelen: libc::c_int = len;
            if 1 as libc::c_int
                == sscanf(
                    hostname.offset(zonelen as isize),
                    b"%*[^]]%c%n\0" as *const u8 as *const libc::c_char,
                    &mut endbracket as *mut libc::c_char,
                    &mut len as *mut libc::c_int,
                )
            {
                ...
                portptr = &mut *hostname
                    .offset((zonelen + len + 1 as libc::c_int) as isize)
                    as *mut libc::c_char;
            } else {
                return CURLUE_MALFORMED_INPUT
            }
        ...
        if !portptr.is_null() && *portptr as libc::c_int != 0 {
            if *portptr as libc::c_int != ':' as i32 {
                return CURLUE_MALFORMED_INPUT;
            }
        } else {
            portptr = 0 as *mut libc::c_char;
        }
    } else {
    ...
    if !portptr.is_null() {
        ...
        let mut portbuf: [libc::c_char; 7] = [0; 7];
        if *portptr.offset(1 as libc::c_int as isize) == 0 {
            *portptr = '\u{0}' as i32 as libc::c_char;
            return (if has_scheme as libc::c_int != 0 {
                CURLUE_OK as libc::c_int
            } else {
                CURLUE_BAD_PORT_NUMBER as libc::c_int
            }) as CURLUcode;
        }
        if Curl_isdigit(
            *portptr.offset(1 as libc::c_int as isize) as libc::c_uchar as libc::c_int,
        ) == 0
        {
            return CURLUE_BAD_PORT_NUMBER;
        }
        port = strtol(
            portptr.offset(1 as libc::c_int as isize),
            &mut rest,
            10 as libc::c_int,
        );
        if port <= 0 as libc::c_int as libc::c_long
            || port > 0xffff as libc::c_int as libc::c_long
        {
            return CURLUE_BAD_PORT_NUMBER;
        }
        if *rest.offset(0 as libc::c_int as isize) != 0 {
            return CURLUE_BAD_PORT_NUMBER;
        }
        let fresh11 = portptr;
        portptr = portptr.offset(1);
        *fresh11 = '\u{0}' as i32 as libc::c_char;
        *rest = 0 as libc::c_int as libc::c_char;
        curl_msnprintf(
            portbuf.as_mut_ptr(),
...
unsafe extern "C" fn junkscan(
    ...
    if !part.is_null() {
        static mut badbytes: [libc::c_char; 33] = [
            ...
            0x7 as libc::c_int as libc::c_char,
            0x8 as libc::c_int as libc::c_char,
            0x9 as libc::c_int as libc::c_char,
            0xa as libc::c_int as libc::c_char,
            0xb as libc::c_int as libc::c_char,
            0xc as libc::c_int as libc::c_char,
...
unsafe extern "C" fn hostname_check(
    ...
    if *hostname.offset(0 as libc::c_int as isize) as libc::c_int == '[' as i32 {
        let mut dest: [libc::c_char; 16] = [0; 16];
        let mut l: *const libc::c_char = b"0123456789abcdefABCDEF:.\0" as *const u8
            as *const libc::c_char;
        if hlen < 4 as libc::c_int as libc::c_ulong {
            return CURLUE_MALFORMED_INPUT;
        }
        hostname = hostname.offset(1);
        hlen = (hlen as libc::c_ulong).wrapping_sub(2 as libc::c_int as libc::c_ulong)
            as size_t as size_t;
        if *hostname.offset(hlen as isize) as libc::c_int != ']' as i32 {
            return CURLUE_MALFORMED_INPUT;
        }
        len = strspn(hostname, l);
        if hlen != len {
            hlen = len;
            if *hostname.offset(len as isize) as libc::c_int == '%' as i32 {
                let mut zoneid: [libc::c_char; 16] = [0; 16];
                let mut i: libc::c_int = 0 as libc::c_int;
                let mut h: *mut libc::c_char = &mut *hostname
                ...
                ) == 0 && *h.offset(2 as libc::c_int as isize) as libc::c_int != 0
                    && *h.offset(2 as libc::c_int as isize) as libc::c_int != ']' as i32
                {
                    h = h.offset(2 as libc::c_int as isize);
                }
                while *h as libc::c_int != 0 && *h as libc::c_int != ']' as i32
                    && i < 15 as libc::c_int
                {
                    let fresh13 = h;
                    h = h.offset(1);
                ...
                if i == 0 || ']' as i32 != *h as libc::c_int {
                    return CURLUE_MALFORMED_INPUT;
                }
                zoneid[i as usize] = 0 as libc::c_int as libc::c_char;
                let ref mut fresh15 = (*u).zoneid;
                *fresh15 = Curl_cstrdup
                    .expect("non-null function pointer")(zoneid.as_mut_ptr());
                if ((*u).zoneid).is_null() {
                    return CURLUE_OUT_OF_MEMORY;
                }
                *hostname.offset(len as isize) = ']' as i32 as libc::c_char;
                *hostname
                    .offset(
        ...
        *hostname.offset(hlen as isize) = 0 as libc::c_int as libc::c_char;
        if 1 as libc::c_int
            != inet_pton(
                10 as libc::c_int,
                hostname,
        ...
        *hostname.offset(hlen as isize) = ']' as i32 as libc::c_char;
    } else {
        len = strcspn(hostname, b" \0" as *const u8 as *const libc::c_char);
        if hlen != len {
            return CURLUE_MALFORMED_INPUT;
        }
    }
    if *hostname.offset(0 as libc::c_int as isize) == 0 {
...
unsafe extern "C" fn ipv4_normalize(
    ...
    mut outp: *mut libc::c_char,
    mut olen: size_t,
) -> bool {
    let mut done: bool = 0 as libc::c_int != 0;
    let mut n: libc::c_int = 0 as libc::c_int;
    let mut c: *const libc::c_char = hostname;
    let mut parts: [libc::c_ulong; 4] = [
    ...
    while !done {
        ...
        l = strtoul(c, &mut endp, 0 as libc::c_int);
        if l
            == (9223372036854775807 as libc::c_long as libc::c_ulong)
                .wrapping_mul(2 as libc::c_ulong)
                .wrapping_add(1 as libc::c_ulong)
            && *__errno_location() == 34 as libc::c_int || endp == c as *mut libc::c_char
        {
            return 0 as libc::c_int != 0;
        }
        if l
    ...
    match n {
        0 => {
            curl_msnprintf(
                ...
                parts[0 as libc::c_int as usize] >> 24 as libc::c_int,
                parts[0 as libc::c_int as usize] >> 16 as libc::c_int
                    & 0xff as libc::c_int as libc::c_ulong,
                parts[0 as libc::c_int as usize] >> 8 as libc::c_int
                    & 0xff as libc::c_int as libc::c_ulong,
                parts[0 as libc::c_int as usize] & 0xff as libc::c_int as libc::c_ulong,
            );
        }
        1 => {
            if parts[0 as libc::c_int as usize] > 0xff as libc::c_int as libc::c_ulong
                || parts[1 as libc::c_int as usize]
            ...
            curl_msnprintf(
                ...
                olen,
                b"%u.%u.%u.%u\0" as *const u8 as *const libc::c_char,
                parts[0 as libc::c_int as usize],
                parts[1 as libc::c_int as usize] >> 16 as libc::c_int
                    & 0xff as libc::c_int as libc::c_ulong,
                parts[1 as libc::c_int as usize] >> 8 as libc::c_int
                    & 0xff as libc::c_int as libc::c_ulong,
                parts[1 as libc::c_int as usize] & 0xff as libc::c_int as libc::c_ulong,
            );
        }
        2 => {
            if parts[0 as libc::c_int as usize] > 0xff as libc::c_int as libc::c_ulong
                || parts[1 as libc::c_int as usize]
                    > 0xff as libc::c_int as libc::c_ulong
                || parts[2 as libc::c_int as usize]
            ...
            curl_msnprintf(
                ...
                parts[0 as libc::c_int as usize],
                parts[1 as libc::c_int as usize],
                parts[2 as libc::c_int as usize] >> 8 as libc::c_int
                    & 0xff as libc::c_int as libc::c_ulong,
                parts[2 as libc::c_int as usize] & 0xff as libc::c_int as libc::c_ulong,
            );
        }
        3 => {
            if parts[0 as libc::c_int as usize] > 0xff as libc::c_int as libc::c_ulong
                ...
                || parts[2 as libc::c_int as usize]
                    > 0xff as libc::c_int as libc::c_ulong
                || parts[3 as libc::c_int as usize]
                    > 0xff as libc::c_int as libc::c_ulong
            {
                return 0 as libc::c_int != 0;
            }
...
unsafe extern "C" fn seturl(
    ...
    let mut path_alloced: bool = 0 as libc::c_int != 0;
    ...
    let mut result: CURLUcode = CURLUE_OK;
    let mut url_has_scheme: bool = 0 as libc::c_int != 0;
    let mut schemebuf: [libc::c_char; 41] = [0; 41];
    let mut schemep: *const libc::c_char = 0 as *const libc::c_char;
    let mut schemelen: size_t = 0 as libc::c_int as size_t;
    let mut urllen: size_t = 0;
    urllen = strlen(url);
    if urllen > 8000000 as libc::c_int as libc::c_ulong {
        return CURLUE_MALFORMED_INPUT;
    }
    let ref mut fresh16 = (*u).scratch;
    *fresh16 = Curl_cmalloc
    ...
    hostname = &mut *path
        .offset(urllen.wrapping_add(1 as libc::c_int as libc::c_ulong) as isize)
        as *mut libc::c_char;
    *hostname.offset(0 as libc::c_int as isize) = 0 as libc::c_int as libc::c_char;
    if Curl_is_absolute_url(
        url,
        schemebuf.as_mut_ptr(),
        ::std::mem::size_of::<[libc::c_char; 41]>() as libc::c_ulong,
    ) {
        url_has_scheme = 1 as libc::c_int != 0;
        schemelen = strlen(schemebuf.as_mut_ptr());
    }
    if url_has_scheme as libc::c_int != 0
        && Curl_strcasecompare(
            schemebuf.as_mut_ptr(),
            b"file\0" as *const u8 as *const libc::c_char,
        ) != 0
    {
        strcpy(path, &*url.offset(5 as libc::c_int as isize));
        hostname = 0 as *mut libc::c_char;
        let ref mut fresh17 = (*u).scheme;
        *fresh17 = Curl_cstrdup
        ...
        {
            let mut ptr: *mut libc::c_char = &mut *path.offset(2 as libc::c_int as isize)
                as *mut libc::c_char;
            if *ptr.offset(0 as libc::c_int as isize) as libc::c_int != '/' as i32
                && !(('a' as i32 <= *ptr.offset(0 as libc::c_int as isize) as libc::c_int
                            ...
                            == 0 as libc::c_int))
            {
                if curl_strnequal(
                    ...
                    ptr,
                    strlen(b"localhost/\0" as *const u8 as *const libc::c_char),
                ) == 0
                    && curl_strnequal(
                        b"127.0.0.1/\0" as *const u8 as *const libc::c_char,
                        ptr,
                        strlen(b"127.0.0.1/\0" as *const u8 as *const libc::c_char),
                    ) == 0
                {
                    return CURLUE_MALFORMED_INPUT;
                }
                ptr = ptr.offset(9 as libc::c_int as isize);
            }
            path = ptr;
        }
        if '/' as i32 == *path.offset(0 as libc::c_int as isize) as libc::c_int
            && (('a' as i32
                <= *(&mut *path.offset(1 as libc::c_int as isize) as *mut libc::c_char)
                    .offset(0 as libc::c_int as isize) as libc::c_int
                && *(&mut *path.offset(1 as libc::c_int as isize) as *mut libc::c_char)
                    .offset(0 as libc::c_int as isize) as libc::c_int <= 'z' as i32
                || 'A' as i32
                    <= *(&mut *path.offset(1 as libc::c_int as isize)
                        as *mut libc::c_char)
                        .offset(0 as libc::c_int as isize) as libc::c_int
                    && *(&mut *path.offset(1 as libc::c_int as isize)
                        as *mut libc::c_char)
                ...
                && (*(&mut *path.offset(1 as libc::c_int as isize) as *mut libc::c_char)
                    ...
                    || *(&mut *path.offset(1 as libc::c_int as isize)
                        ...
                        == 0 as libc::c_int))
            || ('a' as i32 <= *path.offset(0 as libc::c_int as isize) as libc::c_int
                && *path.offset(0 as libc::c_int as isize) as libc::c_int <= 'z' as i32
                || 'A' as i32 <= *path.offset(0 as libc::c_int as isize) as libc::c_int
                    && *path.offset(0 as libc::c_int as isize) as libc::c_int
                        <= 'Z' as i32)
                && (*path.offset(1 as libc::c_int as isize) as libc::c_int == ':' as i32
                    || *path.offset(1 as libc::c_int as isize) as libc::c_int
                        == '|' as i32)
        ...
        let mut hostp: *const libc::c_char = 0 as *const libc::c_char;
        let mut len: size_t = 0;
        *path.offset(0 as libc::c_int as isize) = 0 as libc::c_int as libc::c_char;
        if url_has_scheme {
            let mut i: libc::c_int = 0 as libc::c_int;
            p = &*url
                .offset(
                    schemelen.wrapping_add(1 as libc::c_int as libc::c_ulong) as isize,
                ) as *const libc::c_char;
            while !p.is_null() && *p as libc::c_int == '/' as i32 && i < 4 as libc::c_int
            {
                p = p.offset(1);
                i += 1;
            }
            ...
            if flags & ((1 as libc::c_int) << 2 as libc::c_int) as libc::c_uint != 0 {
                schemep = b"https\0" as *const u8 as *const libc::c_char;
            }
            p = url;
        }
        hostp = p;
        ...
        len = p.offset_from(hostp) as libc::c_long as size_t;
        if len != 0 {
        ...
        } else if flags & ((1 as libc::c_int) << 10 as libc::c_int) as libc::c_uint == 0
            {
            return CURLUE_MALFORMED_INPUT
        }
        len = strlen(p);
        memcpy(path as *mut libc::c_void, p as *const libc::c_void, len);
        *path.offset(len as isize) = 0 as libc::c_int as libc::c_char;
        if !schemep.is_null() {
            let ref mut fresh18 = (*u).scheme;
    ...
    if flags & ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint != 0
        && *path.offset(0 as libc::c_int as isize) as libc::c_int != 0
    {
        let mut newp: *mut libc::c_char = Curl_cmalloc
            .expect(
                "non-null function pointer",
            )((strlen(path)).wrapping_mul(3 as libc::c_int as libc::c_ulong))
            as *mut libc::c_char;
        if newp.is_null() {
            return CURLUE_OUT_OF_MEMORY;
        }
        path_alloced = 1 as libc::c_int != 0;
        strcpy_url(newp, path, 1 as libc::c_int != 0);
        path = newp;
        let ref mut fresh19 = (*u).temppath;
        *fresh19 = path;
    }
    ...
    if !fragment.is_null() {
        ...
        *fresh20 = 0 as libc::c_int as libc::c_char;
        if *fragment.offset(0 as libc::c_int as isize) != 0 {
            let ref mut fresh21 = (*u).fragment;
    ...
    if !query.is_null() {
        ...
        *fresh22 = 0 as libc::c_int as libc::c_char;
        let ref mut fresh23 = (*u).query;
        *fresh23 = Curl_cstrdup.expect("non-null function pointer")(query);
        if ((*u).query).is_null() {
            return CURLUE_OUT_OF_MEMORY;
        }
    }
    if *path.offset(0 as libc::c_int as isize) == 0 {
        path = 0 as *mut libc::c_char;
    } else {
        if flags & ((1 as libc::c_int) << 4 as libc::c_int) as libc::c_uint == 0 {
            let mut newp_0: *mut libc::c_char = Curl_dedotdotify(path);
            if newp_0.is_null() {
                return CURLUE_OUT_OF_MEMORY;
            }
            if strcmp(newp_0, path) != 0 {
                if path_alloced {
                    ...
                    let ref mut fresh24 = (*u).temppath;
                    *fresh24 = 0 as *mut libc::c_char;
                }
                path = newp_0;
                let ref mut fresh25 = (*u).temppath;
                *fresh25 = path;
                path_alloced = 1 as libc::c_int != 0;
            } else {
                Curl_cfree
        ...
        let ref mut fresh26 = (*u).path;
        *fresh26 = if path_alloced as libc::c_int != 0 {
            path
        } else {
        ...
        let ref mut fresh27 = (*u).temppath;
        *fresh27 = 0 as *mut libc::c_char;
    }
    if !hostname.is_null() {
        let mut normalized_ipv4: [libc::c_char; 17] = [0; 17];
        ...
        if !(0 as libc::c_int as libc::c_ulong == strlen(hostname)
            && flags & ((1 as libc::c_int) << 10 as libc::c_int) as libc::c_uint != 0)
        {
            ...
            && schemep.is_null()
        {
            if curl_strnequal(
                ...
                hostname,
                strlen(b"ftp.\0" as *const u8 as *const libc::c_char),
            ) != 0
            {
                schemep = b"ftp\0" as *const u8 as *const libc::c_char;
            } else if curl_strnequal(
                    b"dict.\0" as *const u8 as *const libc::c_char,
                    hostname,
                    strlen(b"dict.\0" as *const u8 as *const libc::c_char),
                ) != 0
                {
                schemep = b"dict\0" as *const u8 as *const libc::c_char;
            } else if curl_strnequal(
                    b"ldap.\0" as *const u8 as *const libc::c_char,
                    hostname,
                    strlen(b"ldap.\0" as *const u8 as *const libc::c_char),
                ) != 0
                {
                schemep = b"ldap\0" as *const u8 as *const libc::c_char;
            } else if curl_strnequal(
                    b"imap.\0" as *const u8 as *const libc::c_char,
                    hostname,
                    strlen(b"imap.\0" as *const u8 as *const libc::c_char),
                ) != 0
                {
                schemep = b"imap\0" as *const u8 as *const libc::c_char;
            } else if curl_strnequal(
                    b"smtp.\0" as *const u8 as *const libc::c_char,
                    hostname,
                    strlen(b"smtp.\0" as *const u8 as *const libc::c_char),
                ) != 0
                {
                schemep = b"smtp\0" as *const u8 as *const libc::c_char;
            } else if curl_strnequal(
                    b"pop3.\0" as *const u8 as *const libc::c_char,
                    hostname,
                    strlen(b"pop3.\0" as *const u8 as *const libc::c_char),
                ) != 0
                {
                schemep = b"pop3\0" as *const u8 as *const libc::c_char;
            } else {
                schemep = b"http\0" as *const u8 as *const libc::c_char;
            }
            let ref mut fresh30 = (*u).scheme;
    ...
    Curl_cfree.expect("non-null function pointer")((*u).scratch as *mut libc::c_void);
    let ref mut fresh31 = (*u).scratch;
    *fresh31 = 0 as *mut libc::c_char;
    Curl_cfree.expect("non-null function pointer")((*u).temppath as *mut libc::c_void);
    let ref mut fresh32 = (*u).temppath;
...
unsafe extern "C" fn parseurl(
    ...
    if result as u64 != 0 {
        ...
        memset(
            ...
            0 as libc::c_int,
            ::std::mem::size_of::<Curl_URL>() as libc::c_ulong,
        );
    }
    return result;
}
...
pub unsafe extern "C" fn curl_url() -> *mut CURLU {
    return Curl_ccalloc
        .expect(
            "non-null function pointer",
        )(::std::mem::size_of::<Curl_URL>() as libc::c_ulong, 1 as libc::c_int as size_t)
        as *mut CURLU;
}
#[no_mangle]
pub unsafe extern "C" fn curl_url_cleanup(mut u: *mut CURLU) {
    if !u.is_null() {
        free_urlhandle(u);
...
#[no_mangle]
pub unsafe extern "C" fn curl_url_dup(mut in_0: *mut CURLU) -> *mut CURLU {
    let mut current_block: u64;
    let mut u: *mut Curl_URL = Curl_ccalloc
        .expect(
            "non-null function pointer",
        )(::std::mem::size_of::<Curl_URL>() as libc::c_ulong, 1 as libc::c_int as size_t)
        as *mut Curl_URL;
                ...
                match current_block {
                    ...
                    _ => {
                        if !((*in_0).password).is_null() {
                            let ref mut fresh35 = (*u).password;
                                                                ...
                                                                match current_block {
                                                                    ...
                                                                    _ => {
                                                                        if !((*in_0).fragment).is_null() {
                                                                            let ref mut fresh41 = (*u).fragment;
...
pub unsafe extern "C" fn curl_url_get(
    ...
    let mut plusdecode: bool = 0 as libc::c_int != 0;
    if u.is_null() {
    ...
    *part = 0 as *mut libc::c_char;
    match what as libc::c_uint {
        1 => {
            ptr = (*u).scheme;
            ifmissing = CURLUE_NO_SCHEME;
            urldecode = 0 as libc::c_int != 0;
        }
        2 => {
            ptr = (*u).user;
        ...
        6 => {
            ...
            if ptr.is_null()
                ...
                && !((*u).scheme).is_null()
            {
                let mut h: *const Curl_handler = Curl_builtin_scheme((*u).scheme);
                if !h.is_null() {
                    curl_msnprintf(
                        portbuf.as_mut_ptr(),
                        ::std::mem::size_of::<[libc::c_char; 7]>() as libc::c_ulong,
                ...
                let mut h_0: *const Curl_handler = Curl_builtin_scheme((*u).scheme);
                if !h_0.is_null() && (*h_0).defport as libc::c_long == (*u).portnum
        ...
        0 => {
            ...
            let mut options: *mut libc::c_char = (*u).options;
            let mut port: *mut libc::c_char = (*u).port;
            let mut allochost: *mut libc::c_char = 0 as *mut libc::c_char;
            if !((*u).scheme).is_null()
                && Curl_strcasecompare(
                    b"file\0" as *const u8 as *const libc::c_char,
                    (*u).scheme,
            ...
            {
                url = curl_maprintf(
                    b"file://%s%s%s\0" as *const u8 as *const libc::c_char,
                    (*u).path,
                    if !((*u).fragment).is_null() {
                        b"#\0" as *const u8 as *const libc::c_char
                    } else {
                    ...
                    if !((*u).fragment).is_null() {
                        (*u).fragment as *const libc::c_char
                    } else {
                        b"\0" as *const u8 as *const libc::c_char
                    },
                );
                        ...
                        != 0
                {
                    ...
                    if !h_1.is_null() && (*h_1).defport as libc::c_long == (*u).portnum
                        && flags
                            & ((1 as libc::c_int) << 1 as libc::c_int) as libc::c_uint
                            != 0
                    {
                        port = 0 as *mut libc::c_char;
                    }
                }
                if !h_1.is_null()
                    && (*h_1).flags
                ...
                if *((*u).host).offset(0 as libc::c_int as isize) as libc::c_int
                    == '[' as i32 && !((*u).zoneid).is_null()
                {
                    let mut hostlen: size_t = strlen((*u).host);
                    ...
                    memcpy(
                        ...
                        hostlen.wrapping_sub(1 as libc::c_int as libc::c_ulong),
                    );
                    curl_msnprintf(
                        &mut *allochost
                            .offset(
                        ...
                        alen
                            ...
                            .wrapping_add(1 as libc::c_int as libc::c_ulong),
                        b"%%25%s]\0" as *const u8 as *const libc::c_char,
                        (*u).zoneid,
                    );
                }
                url = curl_maprintf(
                    ...
                    if !((*u).password).is_null() {
                        (*u).password as *const libc::c_char
                    } else {
                        b"\0" as *const u8 as *const libc::c_char
                    },
                    if !options.is_null() {
                    ...
                    if !((*u).path).is_null()
                        && *((*u).path).offset(0 as libc::c_int as isize) as libc::c_int
                            != '/' as i32
                    {
                        b"/\0" as *const u8 as *const libc::c_char
                    } else {
                    ...
                    if !((*u).path).is_null() {
                        (*u).path as *const libc::c_char
                    } else {
                        b"/\0" as *const u8 as *const libc::c_char
                    },
                    if !((*u).query).is_null()
                        && *((*u).query).offset(0 as libc::c_int as isize) as libc::c_int
                            != 0
                    {
                        b"?\0" as *const u8 as *const libc::c_char
                    } else {
    ...
    if !ptr.is_null() {
        *part = Curl_cstrdup.expect("non-null function pointer")(ptr);
        if (*part).is_null() {
            return CURLUE_OUT_OF_MEMORY;
        }
        if plusdecode {
            let mut plus: *mut libc::c_char = 0 as *mut libc::c_char;
            plus = *part;
            while *plus != 0 {
                if *plus as libc::c_int == '+' as i32 {
                    *plus = ' ' as i32 as libc::c_char;
                }
                plus = plus.offset(1);
            }
        }
        if urldecode {
            ...
            let mut res: CURLcode = Curl_urldecode(
                0 as *mut Curl_easy,
                *part,
...
pub unsafe extern "C" fn curl_url_set(
    ...
    let mut storep: *mut *mut libc::c_char = 0 as *mut *mut libc::c_char;
    ...
    let mut plusencode: bool = 0 as libc::c_int != 0;
    let mut urlskipslash: bool = 0 as libc::c_int != 0;
    let mut appendquery: bool = 0 as libc::c_int != 0;
    let mut equalsencode: bool = 0 as libc::c_int != 0;
    if u.is_null() {
        return CURLUE_BAD_HANDLE;
    }
    if part.is_null() {
        match what as libc::c_uint {
            ...
            3 => {
                storep = &mut (*u).password;
            }
            4 => {
                storep = &mut (*u).options;
            }
            5 => {
                storep = &mut (*u).host;
            }
            ...
            6 => {
                (*u).portnum = 0 as libc::c_int as libc::c_long;
                storep = &mut (*u).port;
            }
            7 => {
                storep = &mut (*u).path;
            ...
            9 => {
                storep = &mut (*u).fragment;
            }
            _ => return CURLUE_UNKNOWN_PART,
        }
        if !storep.is_null() && !(*storep).is_null() {
            Curl_cfree.expect("non-null function pointer")(*storep as *mut libc::c_void);
            *storep = 0 as *mut libc::c_char;
        }
        return CURLUE_OK;
    }
    match what as libc::c_uint {
        1 => {
            if strlen(part) > 40 as libc::c_int as libc::c_ulong {
                return CURLUE_MALFORMED_INPUT;
            }
        ...
        6 => {
            let mut endp: *mut libc::c_char = 0 as *mut libc::c_char;
            urlencode = 0 as libc::c_int != 0;
            port = strtol(part, &mut endp, 10 as libc::c_int);
            if port <= 0 as libc::c_int as libc::c_long
                || port > 0xffff as libc::c_int as libc::c_long
            {
                return CURLUE_BAD_PORT_NUMBER;
        ...
        7 => {
            urlskipslash = 1 as libc::c_int != 0;
            storep = &mut (*u).path;
        }
        8 => {
        ...
        0 => {
            let mut result: CURLUcode = CURLUE_OK;
            let mut oldurl: *mut libc::c_char = 0 as *mut libc::c_char;
            let mut redired_url: *mut libc::c_char = 0 as *mut libc::c_char;
            let mut handle2: *mut CURLU = 0 as *mut CURLU;
            if Curl_is_absolute_url(
                part,
                0 as *mut libc::c_char,
                (40 as libc::c_int + 1 as libc::c_int) as size_t,
            ) {
                handle2 = curl_url();
                if handle2.is_null() {
                    return CURLUE_OUT_OF_MEMORY;
    ...
    let mut newp: *const libc::c_char = part;
    let mut nalloc: size_t = strlen(part);
    if nalloc > 8000000 as libc::c_int as libc::c_ulong {
        return CURLUE_MALFORMED_INPUT;
    }
    if urlencode {
        let mut i: *const libc::c_uchar = 0 as *const libc::c_uchar;
        let mut o: *mut libc::c_char = 0 as *mut libc::c_char;
        let mut enc: *mut libc::c_char = Curl_cmalloc
            .expect(
                "non-null function pointer",
            )(
            nalloc
        ...
        i = part as *const libc::c_uchar;
        o = enc;
        while *i != 0 {
            if *i as libc::c_int == ' ' as i32 && plusencode as libc::c_int != 0 {
                *o = '+' as i32 as libc::c_char;
                o = o.offset(1);
            } else if Curl_isunreserved(*i) as libc::c_int != 0
                    || *i as libc::c_int == '/' as i32
                        && urlskipslash as libc::c_int != 0
                    || *i as libc::c_int == '=' as i32
                        && equalsencode as libc::c_int != 0
                {
                if *i as libc::c_int == '=' as i32 && equalsencode as libc::c_int != 0 {
                    equalsencode = 0 as libc::c_int != 0;
                }
                *o = *i as libc::c_char;
                o = o.offset(1);
            } else {
                ...
                o = o.offset(3 as libc::c_int as isize);
            }
            i = i.offset(1);
        }
    ...
    if appendquery {
        let mut querylen: size_t = if !((*u).query).is_null() {
            strlen((*u).query)
        } else {
            0 as libc::c_int as libc::c_ulong
        };
        let mut addamperand: bool = querylen != 0
            && *((*u).query)
                .offset(
                    querylen.wrapping_sub(1 as libc::c_int as libc::c_ulong) as isize,
                ) as libc::c_int != '&' as i32;
        if querylen != 0 {
            let mut newplen: size_t = strlen(newp);
            let mut p_0: *mut libc::c_char = Curl_cmalloc
                .expect(
                    "non-null function pointer",
                )(
                querylen
                    .wrapping_add(addamperand as libc::c_ulong)
            ...
            if p_0.is_null() {
                Curl_cfree
                    .expect(
                        "non-null function pointer",
                    )(newp as *mut libc::c_char as *mut libc::c_void);
                return CURLUE_OUT_OF_MEMORY;
            }
            strcpy(p_0, (*u).query);
            if addamperand {
                *p_0.offset(querylen as isize) = '&' as i32 as libc::c_char;
            }
            strcpy(
                &mut *p_0
                    .offset(
                        querylen.wrapping_add(addamperand as libc::c_ulong) as isize,
                    ),
                newp,
            );
            Curl_cfree
    ...
    if what as libc::c_uint == CURLUPART_HOST as libc::c_int as libc::c_uint {
        if !(0 as libc::c_int as libc::c_ulong == strlen(newp)
            && flags & ((1 as libc::c_int) << 10 as libc::c_int) as libc::c_uint != 0)
        {
            if hostname_check(u, newp as *mut libc::c_char) as u64 != 0 {
                Curl_cfree
                    .expect(
                        "non-null function pointer",
                    )(newp as *mut libc::c_char as *mut libc::c_void);
    ...
    Curl_cfree.expect("non-null function pointer")(*storep as *mut libc::c_void);
    *storep = newp as *mut libc::c_char;
    if port != 0 {
        (*u).portnum = port;
    }
    return CURLUE_OK;
