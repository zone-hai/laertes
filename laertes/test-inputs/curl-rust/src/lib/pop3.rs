...
extern "C" {
    ...
    static Curl_DIGEST_MD5: [MD5_params; 1];
    fn Curl_MD5_init(md5params: *const MD5_params) -> *mut MD5_context;
    fn Curl_MD5_update(
        context: *mut MD5_context,
        data: *const libc::c_uchar,
        len: libc::c_uint,
    ) -> CURLcode;
    fn Curl_MD5_final(context: *mut MD5_context, result: *mut libc::c_uchar) -> CURLcode;
...
#[no_mangle]
pub static mut Curl_handler_pop3: Curl_handler = unsafe {
    {
        let mut init = Curl_handler {
            scheme: b"POP3\0" as *const u8 as *const libc::c_char,
            setup_connection: Some(
                pop3_setup_connection
                    as unsafe extern "C" fn(*mut Curl_easy, *mut connectdata) -> CURLcode,
            ),
            do_it: Some(
                pop3_do as unsafe extern "C" fn(*mut Curl_easy, *mut bool) -> CURLcode,
            ),
            done: Some(
                pop3_done
            ...
            doing: Some(
                pop3_doing as unsafe extern "C" fn(*mut Curl_easy, *mut bool) -> CURLcode,
            ),
            proto_getsock: Some(
                pop3_getsock
            ...
            attach: None,
            defport: 110 as libc::c_int,
            protocol: ((1 as libc::c_int) << 14 as libc::c_int) as libc::c_uint,
            family: ((1 as libc::c_int) << 14 as libc::c_int) as libc::c_uint,
...
#[no_mangle]
pub static mut Curl_handler_pop3s: Curl_handler = unsafe {
    {
        let mut init = Curl_handler {
            scheme: b"POP3S\0" as *const u8 as *const libc::c_char,
            setup_connection: Some(
                pop3_setup_connection
                    as unsafe extern "C" fn(*mut Curl_easy, *mut connectdata) -> CURLcode,
            ),
            ...
            connection_check: None,
            attach: None,
            defport: 995 as libc::c_int,
            protocol: ((1 as libc::c_int) << 15 as libc::c_int) as libc::c_uint,
            family: ((1 as libc::c_int) << 14 as libc::c_int) as libc::c_uint,
            flags: ((1 as libc::c_int) << 2 as libc::c_int
...
static mut saslpop3: SASLproto = unsafe {
    {
        let mut init = SASLproto {
            service: b"pop\0" as *const u8 as *const libc::c_char,
            contcode: '*' as i32,
            finalcode: '+' as i32,
            maxirlen: (255 as libc::c_int - 8 as libc::c_int) as size_t,
            sendauth: Some(
                pop3_perform_auth
                    as unsafe extern "C" fn(
                        *mut Curl_easy,
...
unsafe extern "C" fn pop3_to_pop3s(mut conn: *mut connectdata) {
...
unsafe extern "C" fn pop3_endofresp(
    ...
    let mut pop3c: *mut pop3_conn = &mut (*conn).proto.pop3c;
    ...
    if (*pop3c).state as libc::c_uint == POP3_CAPA as libc::c_int as libc::c_uint {
...
unsafe extern "C" fn state(mut data: *mut Curl_easy, mut newstate: pop3state) {
    let mut pop3c: *mut pop3_conn = &mut (*(*data).conn).proto.pop3c;
...
unsafe extern "C" fn pop3_perform_capa(
    ...
    let mut pop3c: *mut pop3_conn = &mut (*conn).proto.pop3c;
    (*pop3c).sasl.authmechs = 0 as libc::c_int as libc::c_ushort;
    (*pop3c).sasl.authused = 0 as libc::c_int as libc::c_ushort;
    (*pop3c).tls_supported = 0 as libc::c_int != 0;
    result = Curl_pp_sendf(
        data,
        &mut (*pop3c).pp as *mut pingpong,
...
unsafe extern "C" fn pop3_perform_starttls(
    ...
    let mut result: CURLcode = Curl_pp_sendf(
        data,
        &mut (*conn).proto.pop3c.pp as *mut pingpong,
        b"%s\0" as *const u8 as *const libc::c_char,
        b"STLS\0" as *const u8 as *const libc::c_char,
    );
    if result as u64 == 0 {
...
unsafe extern "C" fn pop3_perform_upgrade_tls(
    ...
    if result as u64 == 0 {
        if (*pop3c).state as libc::c_uint
            != POP3_UPGRADETLS as libc::c_int as libc::c_uint
        {
...
unsafe extern "C" fn pop3_perform_apop(
    ...
    let mut secret: [libc::c_char; 33] = [0; 33];
    if ((*conn).bits).user_passwd() == 0 {
        state(data, POP3_STOP);
        return result;
    }
    ...
    Curl_MD5_update(
        ctxt,
        (*pop3c).apoptimestamp as *const libc::c_uchar,
        curlx_uztoui(strlen((*pop3c).apoptimestamp)),
    );
    Curl_MD5_update(
        ctxt,
        (*conn).passwd as *const libc::c_uchar,
    ...
    result = Curl_pp_sendf(
        data,
        &mut (*pop3c).pp as *mut pingpong,
        b"APOP %s %s\0" as *const u8 as *const libc::c_char,
        (*conn).user,
        secret.as_mut_ptr(),
    );
    if result as u64 == 0 {
...
unsafe extern "C" fn pop3_perform_authentication(
    ...
    if !Curl_sasl_can_authenticate(&mut (*pop3c).sasl, conn) {
        state(data, POP3_STOP);
        return result;
    }
    ...
    if result as u64 == 0
        && progress as libc::c_uint == SASL_IDLE as libc::c_int as libc::c_uint
    {
        if (*pop3c).authtypes & (*pop3c).preftype
            & ((1 as libc::c_int) << 1 as libc::c_int) as libc::c_uint != 0
        {
            result = pop3_perform_apop(data, conn);
        } else if (*pop3c).authtypes & (*pop3c).preftype
...
unsafe extern "C" fn pop3_perform_command(mut data: *mut Curl_easy) -> CURLcode {
    let mut result: CURLcode = CURLE_OK;
    let mut conn: *mut connectdata = (*data).conn;
    let mut pop3: *mut POP3 = (*data).req.p.pop3;
    let mut command: *const libc::c_char = 0 as *const libc::c_char;
    if *((*pop3).id).offset(0 as libc::c_int as isize) as libc::c_int == '\u{0}' as i32
        || ((*data).set).list_only() as libc::c_int != 0
    {
        command = b"LIST\0" as *const u8 as *const libc::c_char;
        if *((*pop3).id).offset(0 as libc::c_int as isize) as libc::c_int
            != '\u{0}' as i32
        {
            (*pop3).transfer = PPTRANSFER_INFO;
        }
    } else {
        command = b"RETR\0" as *const u8 as *const libc::c_char;
    }
    if *((*pop3).id).offset(0 as libc::c_int as isize) as libc::c_int != '\u{0}' as i32 {
        result = Curl_pp_sendf(
            data,
            ...
            if !((*pop3).custom).is_null()
                && *((*pop3).custom).offset(0 as libc::c_int as isize) as libc::c_int
                    != '\u{0}' as i32
            {
                (*pop3).custom as *const libc::c_char
            } else {
                command
            },
            (*pop3).id,
...
unsafe extern "C" fn pop3_state_servergreet_resp(
    mut data: *mut Curl_easy,
    mut pop3code: libc::c_int,
    mut instate: pop3state,
) -> CURLcode {
    let mut result: CURLcode = CURLE_OK;
    let mut conn: *mut connectdata = (*data).conn;
    let mut pop3c: *mut pop3_conn = &mut (*conn).proto.pop3c;
    ...
    if pop3code != '+' as i32 {
        Curl_failf(
            data,
            b"Got unexpected pop3-server response\0" as *const u8 as *const libc::c_char,
        );
                ...
                as libc::c_int == '>' as i32
        {
            ...
            while i < len.wrapping_sub(2 as libc::c_int as libc::c_ulong) {
                if *line.offset(i as isize) as libc::c_int == '<' as i32 {
                    let mut timestamplen: size_t = len
                    ...
                    let ref mut fresh3 = (*pop3c).apoptimestamp;
                    *fresh3 = Curl_ccalloc
                        .expect(
                            "non-null function pointer",
                        )(
                        1 as libc::c_int as size_t,
                        timestamplen.wrapping_add(1 as libc::c_int as libc::c_ulong),
                    ) as *mut libc::c_char;
                    if ((*pop3c).apoptimestamp).is_null() {
                        break;
                    }
                    memcpy(
                        (*pop3c).apoptimestamp as *mut libc::c_void,
                        line.offset(i as isize) as *const libc::c_void,
                        timestamplen,
                    );
                    *((*pop3c).apoptimestamp)
                        .offset(timestamplen as isize) = '\u{0}' as i32 as libc::c_char;
                    at = strchr((*pop3c).apoptimestamp, '@' as i32);
                    if at.is_null() {
                        Curl_cfree
                            .expect(
                                "non-null function pointer",
                            )((*pop3c).apoptimestamp as *mut libc::c_void);
                        let ref mut fresh4 = (*pop3c).apoptimestamp;
...
unsafe extern "C" fn pop3_state_capa_resp(
    ...
    if pop3code == '*' as i32 {
        if len >= 4 as libc::c_int as libc::c_ulong
            && memcmp(
                line as *const libc::c_void,
                b"STLS\0" as *const u8 as *const libc::c_char as *const libc::c_void,
                4 as libc::c_int as libc::c_ulong,
            ) == 0
        {
            (*pop3c).tls_supported = 1 as libc::c_int != 0;
        } else if len >= 4 as libc::c_int as libc::c_ulong
                && memcmp(
                    line as *const libc::c_void,
                    b"USER\0" as *const u8 as *const libc::c_char as *const libc::c_void,
                    4 as libc::c_int as libc::c_ulong,
                ) == 0
            {
            (*pop3c).authtypes
                ...
                && memcmp(
                    line as *const libc::c_void,
                    b"SASL \0" as *const u8 as *const libc::c_char
            ...
            loop {
                ...
                if mechbit as libc::c_int != 0 && llen == wordlen {
                    let ref mut fresh5 = (*pop3c).sasl.authmechs;
            ...
            || ((*conn).ssl[0 as libc::c_int as usize]).use_0() as libc::c_int != 0
        {
        ...
        } else if pop3code == '+' as i32 && (*pop3c).tls_supported as libc::c_int != 0 {
            ...
            Curl_failf(
                data,
                b"STLS not supported.\0" as *const u8 as *const libc::c_char,
            );
...
unsafe extern "C" fn pop3_state_auth_resp(
    ...
    let mut pop3c: *mut pop3_conn = &mut (*conn).proto.pop3c;
    let mut progress: saslprogress = SASL_IDLE;
    result = Curl_sasl_continue(&mut (*pop3c).sasl, data, conn, pop3code, &mut progress);
    if result as u64 == 0 {
...
unsafe extern "C" fn pop3_state_apop_resp(
    ...
    if pop3code != '+' as i32 {
        Curl_failf(
            data,
            b"Authentication failed: %d\0" as *const u8 as *const libc::c_char,
            pop3code,
        );
        result = CURLE_LOGIN_DENIED;
    } else {
...
unsafe extern "C" fn pop3_state_command_resp(
    ...
    let mut pop3: *mut POP3 = (*data).req.p.pop3;
    let mut pop3c: *mut pop3_conn = &mut (*conn).proto.pop3c;
    let mut pp: *mut pingpong = &mut (*pop3c).pp;
    if pop3code != '+' as i32 {
        state(data, POP3_STOP);
        return CURLE_RECV_ERROR;
    }
    (*pop3c).eob = 2 as libc::c_int as size_t;
    (*pop3c).strip = 2 as libc::c_int as size_t;
    if (*pop3).transfer as libc::c_uint == PPTRANSFER_BODY as libc::c_int as libc::c_uint
    {
        Curl_setup_transfer(
            data,
            0 as libc::c_int,
        ...
        if !((*pp).cache).is_null() {
            ...
            Curl_cfree
                .expect("non-null function pointer")((*pp).cache as *mut libc::c_void);
            let ref mut fresh6 = (*pp).cache;
...
unsafe extern "C" fn pop3_statemachine(
    ...
    let mut pop3code: libc::c_int = 0;
    let mut pop3c: *mut pop3_conn = &mut (*conn).proto.pop3c;
    let mut pp: *mut pingpong = &mut (*pop3c).pp;
    let mut nread: size_t = 0 as libc::c_int as size_t;
    if (*pop3c).state as libc::c_uint == POP3_UPGRADETLS as libc::c_int as libc::c_uint {
    ...
    loop {
        result = Curl_pp_readresp(data, sock, pp, &mut pop3code, &mut nread);
        if result as u64 != 0 {
            return result;
        }
        if pop3code == 0 {
        ...
        match (*pop3c).state as libc::c_uint {
            1 => {
        ...
        if !(result as u64 == 0
            && (*pop3c).state as libc::c_uint != POP3_STOP as libc::c_int as libc::c_uint
...
unsafe extern "C" fn pop3_multi_statemach(
        ...
        && !(*pop3c).ssldone
    {
        ...
        if result as libc::c_uint != 0 || !(*pop3c).ssldone {
            return result;
        }
    }
    ...
    *done = if (*pop3c).state as libc::c_uint == POP3_STOP as libc::c_int as libc::c_uint
    {
        1 as libc::c_int
    } else {
        0 as libc::c_int
...
unsafe extern "C" fn pop3_block_statemach(
    ...
    let mut result: CURLcode = CURLE_OK;
    let mut pop3c: *mut pop3_conn = &mut (*conn).proto.pop3c;
    while (*pop3c).state as libc::c_uint != POP3_STOP as libc::c_int as libc::c_uint
        && result as u64 == 0
    {
        result = Curl_pp_statemach(
            data,
...
unsafe extern "C" fn pop3_init(mut data: *mut Curl_easy) -> CURLcode {
    let mut result: CURLcode = CURLE_OK;
    let mut pop3: *mut POP3 = 0 as *mut POP3;
    let ref mut fresh7 = (*data).req.p.pop3;
    *fresh7 = Curl_ccalloc
        .expect(
            "non-null function pointer",
        )(::std::mem::size_of::<POP3>() as libc::c_ulong, 1 as libc::c_int as size_t)
        as *mut POP3;
    pop3 = *fresh7;
    if pop3.is_null() {
...
unsafe extern "C" fn pop3_getsock(
    ...
    return Curl_pp_getsock(data, &mut (*conn).proto.pop3c.pp, socks);
}
unsafe extern "C" fn pop3_connect(
    ...
    *done = 0 as libc::c_int != 0;
    ...
    let ref mut fresh8 = (*pp).statemachine;
    *fresh8 = Some(
        pop3_statemachine
            as unsafe extern "C" fn(*mut Curl_easy, *mut connectdata) -> CURLcode,
    );
    let ref mut fresh9 = (*pp).endofresp;
    *fresh9 = Some(
        pop3_endofresp
            as unsafe extern "C" fn(
                *mut Curl_easy,
    ...
    (*pop3c).preftype = !(0 as libc::c_uint);
    Curl_sasl_init(&mut (*pop3c).sasl, &saslpop3);
    Curl_pp_setup(pp);
...
unsafe extern "C" fn pop3_do(mut data: *mut Curl_easy, mut done: *mut bool) -> CURLcode {
    let mut result: CURLcode = CURLE_OK;
    *done = 0 as libc::c_int != 0;
...
unsafe extern "C" fn pop3_disconnect(
    ...
    if !dead_connection && ((*conn).bits).protoconnstart() as libc::c_int != 0 {
        if pop3_perform_quit(data, conn) as u64 == 0 {
            pop3_block_statemach(data, conn, 1 as libc::c_int != 0);
        }
    }
    Curl_pp_disconnect(&mut (*pop3c).pp);
    Curl_sasl_cleanup(conn, (*pop3c).sasl.authused as libc::c_uint);
    Curl_cfree
        .expect(
            "non-null function pointer",
        )((*pop3c).apoptimestamp as *mut libc::c_void);
    let ref mut fresh12 = (*pop3c).apoptimestamp;
    *fresh12 = 0 as *mut libc::c_char;
    return CURLE_OK;
}
unsafe extern "C" fn pop3_dophase_done(
    mut data: *mut Curl_easy,
    mut connected: bool,
) -> CURLcode {
    return CURLE_OK;
...
unsafe extern "C" fn pop3_doing(
    ...
    let mut result: CURLcode = pop3_multi_statemach(data, dophase_done);
    if !(result as u64 != 0) {
        if *dophase_done {
            result = pop3_dophase_done(data, 0 as libc::c_int != 0);
        }
    }
    return result;
}
unsafe extern "C" fn pop3_regular_transfer(
    ...
    result = pop3_perform(data, &mut connected, dophase_done);
...
unsafe extern "C" fn pop3_setup_connection(
    ...
    let mut result: CURLcode = pop3_init(data);
    if result as u64 != 0 {
        return result;
    }
    let ref mut fresh13 = (*conn).bits;
    (*fresh13).set_tls_upgraded(0 as libc::c_int as bit);
    return CURLE_OK;
}
unsafe extern "C" fn pop3_parse_url_options(mut conn: *mut connectdata) -> CURLcode {
    let mut result: CURLcode = CURLE_OK;
    let mut pop3c: *mut pop3_conn = &mut (*conn).proto.pop3c;
    let mut ptr: *const libc::c_char = (*conn).options;
    (*pop3c).sasl.resetprefs = 1 as libc::c_int != 0;
        ...
        ) != 0
        {
            ...
            if result as libc::c_uint != 0
                && Curl_strncasecompare(
                    value,
                    b"+APOP\0" as *const u8 as *const libc::c_char,
                    ptr.offset_from(value) as libc::c_long as size_t,
                ) != 0
            {
                (*pop3c)
                    .preftype = ((1 as libc::c_int) << 1 as libc::c_int) as libc::c_uint;
                (*pop3c).sasl.prefmech = 0 as libc::c_int as libc::c_ushort;
                result = CURLE_OK;
            }
        } else {
    ...
    if (*pop3c).preftype != ((1 as libc::c_int) << 1 as libc::c_int) as libc::c_uint {
        match (*pop3c).sasl.prefmech as libc::c_int {
            0 => {
                (*pop3c).preftype = 0 as libc::c_int as libc::c_uint;
            }
            65503 => {
                (*pop3c).preftype = !(0 as libc::c_uint);
            }
            _ => {
                (*pop3c)
                    .preftype = ((1 as libc::c_int) << 2 as libc::c_int) as libc::c_uint;
            }
        }
    }
    return result;
}
unsafe extern "C" fn pop3_parse_url_path(mut data: *mut Curl_easy) -> CURLcode {
    let mut pop3: *mut POP3 = (*data).req.p.pop3;
...
unsafe extern "C" fn pop3_parse_custom_request(mut data: *mut Curl_easy) -> CURLcode {
    let mut result: CURLcode = CURLE_OK;
    let mut pop3: *mut POP3 = (*data).req.p.pop3;
...
pub unsafe extern "C" fn Curl_pop3_write(
    ...
    let mut conn: *mut connectdata = (*data).conn;
    let mut pop3c: *mut pop3_conn = &mut (*conn).proto.pop3c;
    let mut strip_dot: bool = 0 as libc::c_int != 0;
    let mut last: size_t = 0 as libc::c_int as size_t;
    let mut i: size_t = 0;
    i = 0 as libc::c_int as size_t;
    while i < nread {
        let mut prev: size_t = (*pop3c).eob;
        match *str.offset(i as isize) as libc::c_int {
            13 => {
                if (*pop3c).eob == 0 as libc::c_int as libc::c_ulong {
                    let ref mut fresh14 = (*pop3c).eob;
                ...
                } else if (*pop3c).eob == 3 as libc::c_int as libc::c_ulong {
                    let ref mut fresh15 = (*pop3c).eob;
                    *fresh15 = (*fresh15).wrapping_add(1);
                } else {
                    (*pop3c).eob = 1 as libc::c_int as size_t;
                }
            }
            10 => {
                if (*pop3c).eob == 1 as libc::c_int as libc::c_ulong
                    || (*pop3c).eob == 4 as libc::c_int as libc::c_ulong
                {
                    let ref mut fresh16 = (*pop3c).eob;
                    *fresh16 = (*fresh16).wrapping_add(1);
                } else {
                    (*pop3c).eob = 0 as libc::c_int as size_t;
                }
            }
            46 => {
                if (*pop3c).eob == 2 as libc::c_int as libc::c_ulong {
                    let ref mut fresh17 = (*pop3c).eob;
                    *fresh17 = (*fresh17).wrapping_add(1);
                } else if (*pop3c).eob == 3 as libc::c_int as libc::c_ulong {
                    strip_dot = 1 as libc::c_int != 0;
                    (*pop3c).eob = 0 as libc::c_int as size_t;
                } else {
                    (*pop3c).eob = 0 as libc::c_int as size_t;
                }
        ...
        if prev != 0 && prev >= (*pop3c).eob {
            while prev != 0 && (*pop3c).strip != 0 {
                prev = prev.wrapping_sub(1);
                let ref mut fresh18 = (*pop3c).strip;
                *fresh18 = (*fresh18).wrapping_sub(1);
            }
            if prev != 0 {
                if strip_dot as libc::c_int != 0
                    && prev.wrapping_sub(1 as libc::c_int as libc::c_ulong)
                ...
                last = i;
                strip_dot = 0 as libc::c_int != 0;
            }
        }
        i = i.wrapping_add(1);
    }
    if (*pop3c).eob == 5 as libc::c_int as libc::c_ulong {
        result = Curl_client_write(
            data,
            (1 as libc::c_int) << 0 as libc::c_int,
