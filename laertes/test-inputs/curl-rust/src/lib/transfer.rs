...
extern "C" {
    ...
    fn Curl_http_compile_trailers(
        trailers: *mut curl_slist,
        buf: *mut dynbuf,
        handle: *mut Curl_easy,
    ) -> CURLcode;
    fn Curl_http_firstwrite(
        data: *mut Curl_easy,
    ...
    fn Curl_chunked_strerror(code: CHUNKcode) -> *const libc::c_char;
    ...
    fn Curl_loadhostpairs(data: *mut Curl_easy) -> CURLcode;
    ...
    fn Curl_smtp_escape_eob(data: *mut Curl_easy, nread: ssize_t) -> CURLcode;
    fn Curl_http_readwrite_headers(
        data: *mut Curl_easy,
        conn: *mut connectdata,
        nread: *mut ssize_t,
        stop_reading: *mut bool,
    ) -> CURLcode;
    fn Curl_wildcard_init(wc: *mut WildcardData) -> CURLcode;
    ...
    fn Curl_pgrsResetTransferSizes(data: *mut Curl_easy);
    fn Curl_pgrsTime(data: *mut Curl_easy, timer: timerid) -> curltime;
    fn Curl_uc_to_curlcode(uc: CURLUcode) -> CURLcode;
    fn Curl_initinfo(data: *mut Curl_easy) -> CURLcode;
    fn Curl_ssl_initsessions(_: *mut Curl_easy, _: size_t) -> CURLcode;
    ...
    fn Curl_http2_init_state(state: *mut UrlState);
    fn Curl_http2_done_sending(data: *mut Curl_easy, conn: *mut connectdata) -> CURLcode;
...
pub unsafe extern "C" fn Curl_get_upload_buffer(mut data: *mut Curl_easy) -> CURLcode {
    if ((*data).state.ulbuf).is_null() {
        ...
        *fresh0 = Curl_cmalloc
            ...
            )((*data).set.upload_buffer_size as size_t) as *mut libc::c_char;
        if ((*data).state.ulbuf).is_null() {
...
unsafe extern "C" fn trailers_read(
    ...
    if to_copy != 0 {
        ...
        *fresh1 = (*fresh1 as libc::c_ulong).wrapping_add(to_copy) as size_t as size_t;
    }
    return to_copy;
}
...
pub unsafe extern "C" fn Curl_fillreadbuffer(
    ...
    if (*data).state.trailers_state as libc::c_uint
        == TRAILERS_INITIALIZED as libc::c_int as libc::c_uint
    {
        let mut trailers: *mut curl_slist = 0 as *mut curl_slist;
        let mut result: CURLcode = CURLE_OK;
        let mut trailers_ret_code: libc::c_int = 0;
        Curl_infof(
            data,
        ...
        (*data).state.trailers_bytes_sent = 0 as libc::c_int as size_t;
        ...
        if trailers_ret_code == 0 as libc::c_int {
            ...
            *nreadp = 0 as libc::c_int as size_t;
        ...
        Curl_infof(
            data,
            b"Successfully compiled trailers.\0" as *const u8 as *const libc::c_char,
        );
        curl_slist_free_all(trailers);
    }
    if ((*data).req).upload_chunky() as libc::c_int != 0
        && (*data).state.trailers_state as libc::c_uint
            == TRAILERS_NONE as libc::c_int as libc::c_uint
    {
        buffersize = (buffersize as libc::c_ulong)
            .wrapping_sub(
                (8 as libc::c_int + 2 as libc::c_int + 2 as libc::c_int) as libc::c_ulong,
            ) as size_t as size_t;
        let ref mut fresh2 = (*data).req.upload_fromhere;
        *fresh2 = (*fresh2).offset((8 as libc::c_int + 2 as libc::c_int) as isize);
    }
    if (*data).state.trailers_state as libc::c_uint
        == TRAILERS_SENDING as libc::c_int as libc::c_uint
    {
        readfunc = Some(
            trailers_read
    ...
    Curl_set_in_callback(data, 0 as libc::c_int != 0);
    if nread == 0x10000000 as libc::c_int as libc::c_ulong {
        Curl_failf(
            data,
            b"operation aborted by callback\0" as *const u8 as *const libc::c_char,
        );
        *nreadp = 0 as libc::c_int as size_t;
        return CURLE_ABORTED_BY_CALLBACK;
    }
    if nread == 0x10000001 as libc::c_int as libc::c_ulong {
        ...
        (*k).keepon |= (1 as libc::c_int) << 5 as libc::c_int;
    ...
    {
        let mut added_crlf: bool = 0 as libc::c_int != 0;
        let mut hexlen: libc::c_int = 0 as libc::c_int;
        ...
        if (*data).state.trailers_state as libc::c_uint
            != TRAILERS_SENDING as libc::c_int as libc::c_uint
        {
            let mut hexbuffer: [libc::c_char; 11] = *::std::mem::transmute::<
                &[u8; 11],
                &mut [libc::c_char; 11],
            ...
            hexlen = curl_msnprintf(
                ...
                b"%zx%s\0" as *const u8 as *const libc::c_char,
                nread,
                endofline_native,
            );
            let ref mut fresh4 = (*data).req.upload_fromhere;
            *fresh4 = (*fresh4).offset(-(hexlen as isize));
            nread = (nread as libc::c_ulong).wrapping_add(hexlen as libc::c_ulong)
                as size_t as size_t;
            memcpy(
                (*data).req.upload_fromhere as *mut libc::c_void,
                hexbuffer.as_mut_ptr() as *const libc::c_void,
                hexlen as libc::c_ulong,
            );
            if nread.wrapping_sub(hexlen as libc::c_ulong)
            ...
            && trailers_left(data as *mut libc::c_void) == 0
        {
            ...
            *fresh6 = None;
            ...
            (*fresh7).set_upload_done(1 as libc::c_int as bit);
            Curl_infof(
                data,
                b"Signaling end of chunked upload after trailers.\0" as *const u8
                    as *const libc::c_char,
            );
        } else if nread.wrapping_sub(hexlen as libc::c_ulong)
                == 0 as libc::c_int as libc::c_ulong
                && (*data).state.trailers_state as libc::c_uint
                    != TRAILERS_INITIALIZED as libc::c_int as libc::c_uint
            {
            let ref mut fresh8 = (*data).req;
            (*fresh8).set_upload_done(1 as libc::c_int as bit);
            Curl_infof(
                data,
        ...
        if added_crlf {
            nread = (nread as libc::c_ulong).wrapping_add(strlen(endofline_network))
                as size_t as size_t;
        }
    }
    *nreadp = nread;
...
pub unsafe extern "C" fn Curl_readrewind(mut data: *mut Curl_easy) -> CURLcode {
    ...
    (*fresh9).set_rewindaftersend(0 as libc::c_int as bit);
    ...
    if ((*data).set.postfields).is_null() {
                ...
                == HTTPREQ_POST_FORM as libc::c_int as libc::c_uint
        {
            ...
            if result as u64 != 0 {
                Curl_failf(
                    data,
                    b"Cannot rewind mime/post data\0" as *const u8 as *const libc::c_char,
                );
                return result;
            }
            ...
            err_0 = ((*data).set.ioctl_func)
                .expect(
                    "non-null function pointer",
                )(data, CURLIOCMD_RESTARTREAD as libc::c_int, (*data).set.ioctl_client);
            Curl_set_in_callback(data, 0 as libc::c_int != 0);
            Curl_infof(
                data,
                b"the ioctl callback returned %d\0" as *const u8 as *const libc::c_char,
                err_0 as libc::c_int,
            );
            if err_0 as u64 != 0 {
                Curl_failf(
...
unsafe extern "C" fn data_pending(mut data: *const Curl_easy) -> libc::c_int {
    let mut conn: *mut connectdata = (*data).conn;
    if (*(*conn).handler).protocol
        & ((1 as libc::c_int) << 2 as libc::c_int
            | (1 as libc::c_int) << 3 as libc::c_int) as libc::c_uint != 0
    {
        return Curl_ssl_data_pending(conn, 1 as libc::c_int) as libc::c_int;
    }
    return ((*(*conn).handler).protocol
        ...
        || Curl_ssl_data_pending(conn, 0 as libc::c_int) as libc::c_int != 0)
        as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn Curl_meets_timecondition(
    ...
    if timeofdoc == 0 as libc::c_int as libc::c_long
    ...
    match (*data).set.timecondition as libc::c_uint {
        2 => {
            if timeofdoc >= (*data).set.timevalue {
                ...
                (*fresh11).set_timecond(1 as libc::c_int as bit);
        ...
        1 | _ => {
            if timeofdoc <= (*data).set.timevalue {
                ...
                (*fresh10).set_timecond(1 as libc::c_int as bit);
                return 0 as libc::c_int != 0;
            }
        }
    }
...
unsafe extern "C" fn readwrite_data(
    ...
    mut didwhat: *mut libc::c_int,
    mut done: *mut bool,
    mut comeback: *mut bool,
) -> CURLcode {
    let mut result: CURLcode = CURLE_OK;
    let mut nread: ssize_t = 0;
    let mut excess: size_t = 0 as libc::c_int as size_t;
    let mut readmore: bool = 0 as libc::c_int != 0;
    let mut maxloops: libc::c_int = 100 as libc::c_int;
    let mut buf: *mut libc::c_char = (*data).state.buffer;
    *done = 0 as libc::c_int != 0;
    *comeback = 0 as libc::c_int != 0;
    loop {
        let mut is_empty_data: bool = 0 as libc::c_int != 0;
        ...
        let mut is_http2: bool = (*(*conn).handler).protocol
            & ((1 as libc::c_int) << 0 as libc::c_int
                | (1 as libc::c_int) << 1 as libc::c_int) as libc::c_uint != 0
            && (*conn).httpversion as libc::c_int == 20 as libc::c_int;
        if !is_http2 && (*k).size != -(1 as libc::c_int) as libc::c_long
            && (*k).header() == 0
        {
        ...
        if bytestoread != 0 {
            ...
            if result as libc::c_uint > 0 as libc::c_int as libc::c_uint {
                return result;
            }
        } else {
        ...
        *didwhat |= (1 as libc::c_int) << 0 as libc::c_int;
        is_empty_data = if nread == 0 as libc::c_int as libc::c_long
            && (*k).bodywrites == 0 as libc::c_int as libc::c_long
        {
            1 as libc::c_int
        } else {
            0 as libc::c_int
            ...
            || is_empty_data as libc::c_int != 0
        {
            ...
            *fresh12 = buf;
            ...
            if (*k).header() != 0 {
                let mut stop_reading: bool = 0 as libc::c_int != 0;
                ...
                if ((*(*conn).handler).readwrite).is_some()
                    && ((*k).maxdownload <= 0 as libc::c_int as libc::c_long
                        && nread > 0 as libc::c_int as libc::c_long)
                {
                    result = ((*(*conn).handler).readwrite)
                        .expect(
                            "non-null function pointer",
                    ...
                    || is_empty_data as libc::c_int != 0)
            {
                ...
                if 0 as libc::c_int as libc::c_long == (*k).bodywrites && !is_empty_data
                {
                    if (*(*conn).handler).protocol
                        & ((1 as libc::c_int) << 0 as libc::c_int
                        ...
                        != 0
                    {
                        ...
                        if result as libc::c_uint != 0 || *done as libc::c_int != 0 {
                            return result;
                        }
                    }
                }
                ...
                *fresh13 += 1;
                if ((*data).set).verbose() != 0 {
                    if (*k).badheader as u64 != 0 {
                        ...
                        if (*k).badheader as libc::c_uint
                            == HEADER_PARTHEADER as libc::c_int as libc::c_uint
                        {
                            Curl_debug(
                                data,
                                CURLINFO_DATA_IN,
                ...
                if (*k).chunk() != 0 {
                    ...
                    if (CHUNKE_OK as libc::c_int) < res as libc::c_int {
                        if CHUNKE_PASSTHRU_ERROR as libc::c_int == res as libc::c_int {
                            Curl_failf(
                                data,
                    ...
                    if CHUNKE_STOP as libc::c_int == res as libc::c_int {
                    ...
                    && (*k).ignorebody() == 0
                {
                    ...
                    *fresh14 = (*fresh14 as libc::c_ulong).wrapping_add(headlen)
                        as curl_off_t as curl_off_t;
                }
                if -(1 as libc::c_int) as libc::c_long != (*k).maxdownload
                    && (*k).bytecount + nread >= (*k).maxdownload
                {
                    excess = ((*k).bytecount + nread - (*k).maxdownload) as size_t;
                    if excess > 0 as libc::c_int as libc::c_ulong
                        && (*k).ignorebody() == 0
                    {
                        Curl_infof(
                            data,
                ...
                *fresh15 += nread;
                ...
                if (*k).chunk() == 0
                    && (nread != 0 || (*k).badheader as libc::c_uint != 0
                        || is_empty_data as libc::c_int != 0)
                {
                    if (*k).badheader as libc::c_uint != 0 && (*k).ignorebody() == 0 {
                        let mut headlen_0: size_t = Curl_dyn_len(
                            &mut (*data).state.headerb,
                        );
                        if (*k).maxdownload == -(1 as libc::c_int) as libc::c_long
                    ...
                    if ((*k).badheader as libc::c_uint)
                        < HEADER_ALLBAD as libc::c_int as libc::c_uint
                    {
                        if ((*data).set).http_ce_skip() as libc::c_int != 0
            ...
            if ((*(*conn).handler).readwrite).is_some() && excess != 0 {
                ...
                *fresh16 = (*fresh16).offset(nread as isize);
                if &mut *((*k).str_0).offset(excess as isize) as *mut libc::c_char
                    > &mut *buf.offset((*data).set.buffer_size as isize)
                        as *mut libc::c_char
                {
                    excess = (&mut *buf.offset((*data).set.buffer_size as isize)
                        as *mut libc::c_char)
                        .offset_from((*k).str_0) as libc::c_long as size_t;
                }
            ...
            is_http2 as libc::c_int != 0 && nread == 0;
            (*k).keepon &= !((1 as libc::c_int) << 0 as libc::c_int);
            break;
        }
    }
    if maxloops <= 0 as libc::c_int {
        (*conn).cselect_bits = 0x1 as libc::c_int;
        *comeback = 1 as libc::c_int != 0;
    }
    if (*k).keepon
        & ((1 as libc::c_int) << 0 as libc::c_int
            | (1 as libc::c_int) << 1 as libc::c_int)
...
unsafe extern "C" fn readwrite_upload(
    ...
    let mut result: CURLcode = CURLE_OK;
    let mut nread: ssize_t = 0;
    let mut sending_http_headers: bool = 0 as libc::c_int != 0;
    let mut k: *mut SingleRequest = &mut (*data).req;
    if (*k).bytecount == 0 as libc::c_int as libc::c_long
        && (*k).writebytecount == 0 as libc::c_int as libc::c_long
    {
        Curl_pgrsTime(data, TIMER_STARTTRANSFER);
    }
    *didwhat |= (1 as libc::c_int) << 1 as libc::c_int;
    let mut current_block_91: u64;
    let mut nbody: curl_off_t = 0;
    if 0 as libc::c_int as libc::c_long == (*k).upload_present {
        ...
        *fresh18 = (*data).state.ulbuf;
        if (*k).upload_done() == 0 {
            ...
            if (*k).exp100 as libc::c_uint
                == EXP100_SENDING_REQUEST as libc::c_int as libc::c_uint
                && (*http).sending as libc::c_uint
                    == HTTPSEND_BODY as libc::c_int as libc::c_uint
            {
                ...
                *didwhat &= !((1 as libc::c_int) << 1 as libc::c_int);
                        ...
                        | (1 as libc::c_int) << 18 as libc::c_int) as libc::c_uint != 0
                {
                    ...
                    {
                        sending_http_headers = 1 as libc::c_int != 0;
                    } else {
                        sending_http_headers = 0 as libc::c_int != 0;
                    }
                }
        ...
        match current_block_91 {
            ...
            _ => {
                if nread == 0
                    && (*k).keepon & (1 as libc::c_int) << 5 as libc::c_int != 0
                {
                    current_block_91 = 7416055328783156979;
                            ...
                            || ((*data).set).crlf() as libc::c_int != 0)
                    {
                        ...
                        si = 0 as libc::c_int as ssize_t;
                        while i < nread {
                            if *((*k).upload_fromhere).offset(i as isize) as libc::c_int
                                == 0xa as libc::c_int
                            {
                                let fresh20 = si;
                                si = si + 1;
                                ...
                                *((*data).state.scratch)
                                    .offset(si as isize) = 0xa as libc::c_int as libc::c_char;
                                if ((*data).set).crlf() == 0 {
    ...
    match current_block_91 {
        981995395831942902 => {
            ...
            if ((*k).upload_chunky() == 0 || (*k).forbidchunk() as libc::c_int != 0)
            ...
            if (*k).upload_present != bytes_written {
                ...
                *fresh27 = (*data).state.ulbuf;
                (*k).upload_present = 0 as libc::c_int as ssize_t;
                if (*k).upload_done() != 0 {
                    result = Curl_done_sending(data, k);
                    if result as u64 != 0 {
                        return result;
...
pub unsafe extern "C" fn Curl_readwrite(
    ...
    let mut k: *mut SingleRequest = &mut (*data).req;
    let mut result: CURLcode = CURLE_OK;
    let mut didwhat: libc::c_int = 0 as libc::c_int;
    let mut fd_read: curl_socket_t = 0;
    let mut fd_write: curl_socket_t = 0;
    let mut select_res: libc::c_int = (*conn).cselect_bits;
    (*conn).cselect_bits = 0 as libc::c_int;
    if (*k).keepon
        & ((1 as libc::c_int) << 0 as libc::c_int
            | (1 as libc::c_int) << 2 as libc::c_int
            | (1 as libc::c_int) << 4 as libc::c_int)
        ...
        == (1 as libc::c_int) << 1 as libc::c_int
    {
        ...
        fd_write = -(1 as libc::c_int);
    }
    if (*data).state.drain != 0 {
        select_res |= 0x1 as libc::c_int;
    }
    if select_res == 0 {
    ...
    if select_res == 0x4 as libc::c_int {
        Curl_failf(
            data,
            b"select/poll returned error\0" as *const u8 as *const libc::c_char,
        );
        return CURLE_SEND_ERROR;
    }
    if (*k).keepon & (1 as libc::c_int) << 0 as libc::c_int != 0
        && select_res & 0x1 as libc::c_int != 0
    {
    ...
    if (*k).keepon & (1 as libc::c_int) << 1 as libc::c_int != 0
        && select_res & 0x2 as libc::c_int != 0
    {
    ...
    if didwhat == 0 {
        if (*k).exp100 as libc::c_uint
            == EXP100_AWAITING_CONTINUE as libc::c_int as libc::c_uint
        {
    ...
    if (*k).keepon != 0 {
        if 0 as libc::c_int as libc::c_long
            > Curl_timeleft(data, &mut (*k).now, 0 as libc::c_int != 0)
        {
        ...
        if ((*data).set).opt_no_body() == 0 && (*k).chunk() as libc::c_int != 0
            && (*conn).chunk.state as libc::c_uint
                != CHUNK_STOP as libc::c_int as libc::c_uint
        {
            Curl_failf(
                data,
...
pub unsafe extern "C" fn Curl_single_getsock(
    ...
    let mut sockindex: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    ...
    if (*data).req.keepon
        ...
        == (1 as libc::c_int) << 0 as libc::c_int
    {
        bitmap |= (1 as libc::c_int) << sockindex;
    ...
    if (*data).req.keepon
        ...
        == (1 as libc::c_int) << 1 as libc::c_int
    {
        if (*conn).sockfd != (*conn).writesockfd || bitmap == 0 as libc::c_int {
            if bitmap != 0 as libc::c_int {
        ...
        bitmap
            |= (1 as libc::c_int)
                << (16 as libc::c_int as libc::c_uint).wrapping_add(sockindex);
    }
    return bitmap;
}
#[no_mangle]
...
pub unsafe extern "C" fn Curl_pretransfer(mut data: *mut Curl_easy) -> CURLcode {
    ...
    if ((*data).state.url).is_null() && ((*data).set.uh).is_null() {
        Curl_failf(data, b"No URL set!\0" as *const u8 as *const libc::c_char);
    ...
    if ((*data).state).url_alloc() != 0 {
        ...
        *fresh30 = 0 as *mut libc::c_char;
        ...
        (*fresh31).set_url_alloc(0 as libc::c_int as bit);
    }
    if ((*data).state.url).is_null() && !((*data).set.uh).is_null() {
        ...
        Curl_cfree
            ...
            (*data).set.str_0[STRING_SET_URL as libc::c_int as usize]
                as *mut libc::c_void,
        );
        uc = curl_url_get(
            (*data).set.uh,
    ...
    *fresh34 = (*data).set.str_0[STRING_SET_URL as libc::c_int as usize];
    ...
    (*data).state.followlocation = 0 as libc::c_int as libc::c_long;
    let ref mut fresh36 = (*data).state;
    (*fresh36).set_this_is_a_follow(0 as libc::c_int as bit);
    let ref mut fresh37 = (*data).state;
    (*fresh37).set_errorbuf(0 as libc::c_int as bit);
    (*data).state.httpwant = (*data).set.httpwant;
    (*data).state.httpversion = 0 as libc::c_int as libc::c_uchar;
    let ref mut fresh38 = (*data).state;
    (*fresh38).set_authproblem(0 as libc::c_int as bit);
    ...
    *fresh39 = 0 as *mut libc::c_char;
    if (*data).state.httpreq as libc::c_uint
        == HTTPREQ_PUT as libc::c_int as libc::c_uint
    {
        (*data).state.infilesize = (*data).set.filesize;
    } else if (*data).state.httpreq as libc::c_uint
            ...
            && (*data).state.infilesize == -(1 as libc::c_int) as libc::c_long
        {
            (*data)
                .state
                .infilesize = strlen((*data).set.postfields as *const libc::c_char)
                as curl_off_t;
        }
    } else {
        (*data).state.infilesize = 0 as libc::c_int as curl_off_t;
    }
    ...
    if result as u64 == 0 {
        ...
        (*fresh40).set_allow_port(1 as libc::c_int as bit);
        Curl_initinfo(data);
        ...
        if ((*data).state).wildcardmatch() != 0 {
            ...
            if ((*wc).state as libc::c_uint) < CURLWC_INIT as libc::c_int as libc::c_uint
            {
    ...
    if result as u64 == 0 {
        result = Curl_setstropt(
            ...
            (*data).set.str_0[STRING_USERNAME as libc::c_int as usize],
        );
    }
    if result as u64 == 0 {
        result = Curl_setstropt(
            &mut (*data).state.aptr.passwd,
            (*data).set.str_0[STRING_PASSWORD as libc::c_int as usize],
        );
    }
    if result as u64 == 0 {
        result = Curl_setstropt(
            &mut (*data).state.aptr.proxyuser,
            (*data).set.str_0[STRING_PROXYUSERNAME as libc::c_int as usize],
        );
    }
    if result as u64 == 0 {
        result = Curl_setstropt(
            &mut (*data).state.aptr.proxypasswd,
            (*data).set.str_0[STRING_PROXYPASSWORD as libc::c_int as usize],
        );
    }
    (*data).req.headerbytecount = 0 as libc::c_int as curl_off_t;
    return result;
}
#[no_mangle]
pub unsafe extern "C" fn Curl_posttransfer(mut data: *mut Curl_easy) -> CURLcode {
    return CURLE_OK;
}
#[no_mangle]
pub unsafe extern "C" fn Curl_follow(
    mut data: *mut Curl_easy,
    mut newurl: *mut libc::c_char,
    mut type_0: followtype,
) -> CURLcode {
    let mut disallowport: bool = 0 as libc::c_int != 0;
    let mut reachedmax: bool = 0 as libc::c_int != 0;
    let mut uc: CURLUcode = CURLUE_OK;
    if type_0 as libc::c_uint == FOLLOW_REDIR as libc::c_int as libc::c_uint {
        if (*data).set.maxredirs != -(1 as libc::c_int) as libc::c_long
            && (*data).state.followlocation >= (*data).set.maxredirs
        {
            reachedmax = 1 as libc::c_int != 0;
            type_0 = FOLLOW_FAKE;
        } else {
            let ref mut fresh43 = (*data).state;
            (*fresh43).set_this_is_a_follow(1 as libc::c_int as bit);
            ...
            if ((*data).set).http_auto_referer() != 0 {
                ...
                if ((*data).state).referer_alloc() != 0 {
                    ...
                    *fresh45 = 0 as *mut libc::c_char;
                    ...
                    (*fresh46).set_referer_alloc(0 as libc::c_int as bit);
                }
                u = curl_url();
                if u.is_null() {
                    return CURLE_OUT_OF_MEMORY;
                ...
                curl_url_cleanup(u);
                if uc as libc::c_uint != 0 || referer.is_null() {
                    return CURLE_OUT_OF_MEMORY;
                }
                let ref mut fresh47 = (*data).state.referer;
                *fresh47 = referer;
                let ref mut fresh48 = (*data).state;
                (*fresh48).set_referer_alloc(1 as libc::c_int as bit);
            }
        }
    }
    if type_0 as libc::c_uint != FOLLOW_RETRY as libc::c_int as libc::c_uint
    ...
    {
        disallowport = 1 as libc::c_int != 0;
    }
    uc = curl_url_set(
        (*data).state.uh,
        CURLUPART_URL,
        newurl,
        (if type_0 as libc::c_uint == FOLLOW_FAKE as libc::c_int as libc::c_uint {
            (1 as libc::c_int) << 3 as libc::c_int
        } else {
            (if type_0 as libc::c_uint == FOLLOW_REDIR as libc::c_int as libc::c_uint {
    ...
    if disallowport {
        ...
        (*fresh50).set_allow_port(0 as libc::c_int as bit);
    }
    if ((*data).state).url_alloc() != 0 {
        Curl_cfree
            .expect("non-null function pointer")((*data).state.url as *mut libc::c_void);
    ...
    *fresh52 = newurl;
    ...
    (*fresh53).set_url_alloc(1 as libc::c_int as bit);
    Curl_infof(
        data,
        b"Issue another request to this URL: '%s'\0" as *const u8 as *const libc::c_char,
        (*data).state.url,
    );
    match (*data).info.httpcode {
        301 => {
            if ((*data).state.httpreq as libc::c_uint
                ...
                || (*data).state.httpreq as libc::c_uint
                    == HTTPREQ_POST_MIME as libc::c_int as libc::c_uint)
                && (*data).set.keep_post & 1 as libc::c_int == 0
            {
                Curl_infof(
                    data,
                    b"Switch from POST to GET\0" as *const u8 as *const libc::c_char,
                );
        ...
        302 => {
            if ((*data).state.httpreq as libc::c_uint
                ...
                || (*data).state.httpreq as libc::c_uint
                    == HTTPREQ_POST_MIME as libc::c_int as libc::c_uint)
                && (*data).set.keep_post & 2 as libc::c_int == 0
            {
                Curl_infof(
                    data,
                    b"Switch from POST to GET\0" as *const u8 as *const libc::c_char,
        ...
        303 => {
            if (*data).state.httpreq as libc::c_uint
                ...
                && ((*data).state.httpreq as libc::c_uint
                    ...
                    && (*data).state.httpreq as libc::c_uint
                        != HTTPREQ_POST_MIME as libc::c_int as libc::c_uint
                    || (*data).set.keep_post & 4 as libc::c_int == 0)
            {
                (*data).state.httpreq = HTTPREQ_GET;
                let ref mut fresh54 = (*data).set;
                (*fresh54).set_upload(0 as libc::c_int as bit);
                Curl_infof(
                    data,
                    b"Switch to %s\0" as *const u8 as *const libc::c_char,
...
pub unsafe extern "C" fn Curl_retry_request(
    ...
    *url = 0 as *mut libc::c_char;
    ...
    if (*data).req.bytecount + (*data).req.headerbytecount
        == 0 as libc::c_int as libc::c_long && ((*conn).bits).reuse() as libc::c_int != 0
        && (((*data).set).opt_no_body() == 0
            || (*(*conn).handler).protocol
                & ((1 as libc::c_int) << 0 as libc::c_int
                    | (1 as libc::c_int) << 1 as libc::c_int) as libc::c_uint != 0)
        && (*data).set.rtspreq as libc::c_uint
            != RTSPREQ_RECEIVE as libc::c_int as libc::c_uint
    {
        retry = 1 as libc::c_int != 0;
    } else if ((*data).state).refused_stream() as libc::c_int != 0
        ...
        (*fresh55).set_refused_stream(0 as libc::c_int as bit);
        retry = 1 as libc::c_int != 0;
    }
    if retry {
        ...
        *url = Curl_cstrdup.expect("non-null function pointer")((*data).state.url);
        ...
        (*fresh58).set_retry(1 as libc::c_int as bit);
        if (*(*conn).handler).protocol
            & ((1 as libc::c_int) << 0 as libc::c_int
                | (1 as libc::c_int) << 1 as libc::c_int) as libc::c_uint != 0
        {
...
pub unsafe extern "C" fn Curl_setup_transfer(
    ...
    let mut httpsending: bool = (*(*conn).handler).protocol
        ...
        && (*http).sending as libc::c_uint
            == HTTPSEND_REQUEST as libc::c_int as libc::c_uint;
    if ((*conn).bits).multiplex() as libc::c_int != 0
        || (*conn).httpversion as libc::c_int == 20 as libc::c_int
        || httpsending as libc::c_int != 0
    {
        (*conn)
            .sockfd = if sockindex == -(1 as libc::c_int) {
            if writesockindex == -(1 as libc::c_int) {
                -(1 as libc::c_int)
            } else {
        ...
        if httpsending {
            writesockindex = 0 as libc::c_int;
        }
    } else {
        (*conn)
            .sockfd = if sockindex == -(1 as libc::c_int) {
        ...
        (*conn)
            .writesockfd = if writesockindex == -(1 as libc::c_int) {
            -(1 as libc::c_int)
        } else {
            (*conn).sock[writesockindex as usize]
        };
    ...
    if (*k).getheader() as libc::c_int != 0 || ((*data).set).opt_no_body() == 0 {
        if sockindex != -(1 as libc::c_int) {
            (*k).keepon |= (1 as libc::c_int) << 0 as libc::c_int;
        }
        if writesockindex != -(1 as libc::c_int) {
            if ((*data).state).expect100header() as libc::c_int != 0
                && (*(*conn).handler).protocol
                    & ((1 as libc::c_int) << 0 as libc::c_int
                        | (1 as libc::c_int) << 1 as libc::c_int) as libc::c_uint != 0
                && (*http).sending as libc::c_uint
