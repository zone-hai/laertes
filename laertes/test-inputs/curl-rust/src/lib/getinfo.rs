...
pub union C2RustUnnamed_8 {
    pub to_ulong: *mut libc::c_ulong,
    pub to_long: *mut libc::c_long,
}
#[no_mangle]
pub unsafe extern "C" fn Curl_initinfo(mut data: *mut Curl_easy) -> CURLcode {
    let mut pro: *mut Progress = &mut (*data).progress;
    let mut info: *mut PureInfo = &mut (*data).info;
    (*pro).t_nslookup = 0 as libc::c_int as timediff_t;
    (*pro).t_connect = 0 as libc::c_int as timediff_t;
    (*pro).t_appconnect = 0 as libc::c_int as timediff_t;
    (*pro).t_pretransfer = 0 as libc::c_int as timediff_t;
    (*pro).t_starttransfer = 0 as libc::c_int as timediff_t;
    (*pro).timespent = 0 as libc::c_int as timediff_t;
    (*pro).t_redirect = 0 as libc::c_int as timediff_t;
    (*pro).set_is_t_startransfer_set(0 as libc::c_int as bit);
    (*info).httpcode = 0 as libc::c_int;
    (*info).httpproxycode = 0 as libc::c_int;
    (*info).httpversion = 0 as libc::c_int;
    (*info).filetime = -(1 as libc::c_int) as time_t;
    (*info).set_timecond(0 as libc::c_int as bit);
    (*info).header_size = 0 as libc::c_int as curl_off_t;
    (*info).request_size = 0 as libc::c_int as curl_off_t;
    (*info).proxyauthavail = 0 as libc::c_int as libc::c_ulong;
    (*info).httpauthavail = 0 as libc::c_int as libc::c_ulong;
    (*info).numconnects = 0 as libc::c_int as libc::c_long;
    Curl_cfree
        .expect("non-null function pointer")((*info).contenttype as *mut libc::c_void);
    let ref mut fresh0 = (*info).contenttype;
    *fresh0 = 0 as *mut libc::c_char;
    Curl_cfree
        .expect("non-null function pointer")((*info).wouldredirect as *mut libc::c_void);
    let ref mut fresh1 = (*info).wouldredirect;
    *fresh1 = 0 as *mut libc::c_char;
    (*info).conn_primary_ip[0 as libc::c_int as usize] = '\u{0}' as i32 as libc::c_char;
    (*info).conn_local_ip[0 as libc::c_int as usize] = '\u{0}' as i32 as libc::c_char;
    (*info).conn_primary_port = 0 as libc::c_int;
    (*info).conn_local_port = 0 as libc::c_int;
    (*info).retry_after = 0 as libc::c_int as curl_off_t;
    let ref mut fresh2 = (*info).conn_scheme;
    *fresh2 = 0 as *const libc::c_char;
    (*info).conn_protocol = 0 as libc::c_int as libc::c_uint;
...
unsafe extern "C" fn getinfo_char(
    ...
    mut info: CURLINFO,
    mut param_charp: *mut *const libc::c_char,
) -> CURLcode {
    match info as libc::c_uint {
        1048577 => {
        ...
        1048634 => {
            let mut m: *const libc::c_char = (*data)
                .set
                .str_0[STRING_CUSTOMREQUEST as libc::c_int as usize];
            if m.is_null() {
                if ((*data).set).opt_no_body() != 0 {
                    m = b"HEAD\0" as *const u8 as *const libc::c_char;
                } else {
                    match (*data).state.httpreq as libc::c_uint {
                        1 | 2 | 3 => {
                            m = b"POST\0" as *const u8 as *const libc::c_char;
                        }
                        4 => {
                            m = b"PUT\0" as *const u8 as *const libc::c_char;
                        }
                        5 => {
                            m = b"HEAD\0" as *const u8 as *const libc::c_char;
                        }
                        0 | _ => {
                            m = b"GET\0" as *const u8 as *const libc::c_char;
                        }
                    }
                }
            }
        ...
        1048597 => {
            *param_charp = (*data).set.private_data as *mut libc::c_char;
        }
        1048606 => {
...
unsafe extern "C" fn getinfo_long(
    mut data: *mut Curl_easy,
    mut info: CURLINFO,
    mut param_longp: *mut libc::c_long,
) -> CURLcode {
    let mut sockfd: curl_socket_t = 0;
    let mut lptr: C2RustUnnamed_8 = C2RustUnnamed_8 {
        to_ulong: 0 as *mut libc::c_ulong,
    };
    match info as libc::c_uint {
        2097154 => {
            *param_longp = (*data).info.httpcode as libc::c_long;
        }
        2097174 => {
            *param_longp = (*data).info.httpproxycode as libc::c_long;
        }
        2097166 => {
            if (*data).info.filetime > 9223372036854775807 as libc::c_long {
                *param_longp = 9223372036854775807 as libc::c_long;
        ...
        2097177 => {
            *param_longp = (*data).state.os_errno as libc::c_long;
        }
        2097178 => {
            *param_longp = (*data).info.numconnects;
        }
        2097181 => {
            sockfd = Curl_getconnectinfo(data, 0 as *mut *mut connectdata);
            if sockfd != -(1 as libc::c_int) {
                *param_longp = sockfd as libc::c_long;
            } else {
                *param_longp = -(1 as libc::c_int) as libc::c_long;
            }
        }
        2097192 => {
            *param_longp = (*data).info.conn_primary_port as libc::c_long;
        }
        2097194 => {
            *param_longp = (*data).info.conn_local_port as libc::c_long;
        }
        2097211 => {
            *param_longp = (*data).info.pxcode as libc::c_long;
        }
        2097187 => {
            if (*data).info.httpcode == 304 as libc::c_int {
                *param_longp = 1 as libc::c_long;
            } else {
                *param_longp = if ((*data).info).timecond() as libc::c_int != 0 {
                    1 as libc::c_long
                } else {
                    0 as libc::c_long
                };
        ...
        2097198 => {
            match (*data).info.httpversion {
                10 => {
                    *param_longp = CURL_HTTP_VERSION_1_0 as libc::c_int as libc::c_long;
                }
                11 => {
                    *param_longp = CURL_HTTP_VERSION_1_1 as libc::c_int as libc::c_long;
                }
                20 => {
                    *param_longp = CURL_HTTP_VERSION_2_0 as libc::c_int as libc::c_long;
                }
                30 => {
                    *param_longp = CURL_HTTP_VERSION_3 as libc::c_int as libc::c_long;
                }
                _ => {
                    *param_longp = CURL_HTTP_VERSION_NONE as libc::c_int as libc::c_long;
                }
            }
        }
        2097200 => {
            *param_longp = (*data).info.conn_protocol as libc::c_long;
        }
        _ => return CURLE_UNKNOWN_OPTION,
    }
    return CURLE_OK;
...
unsafe extern "C" fn getinfo_double(
    mut data: *mut Curl_easy,
    mut info: CURLINFO,
    mut param_doublep: *mut libc::c_double,
) -> CURLcode {
    match info as libc::c_uint {
        3145731 => {
            *param_doublep = (*data).progress.timespent as libc::c_double
                / 1000000 as libc::c_int as libc::c_double;
        }
        3145732 => {
            *param_doublep = (*data).progress.t_nslookup as libc::c_double
                / 1000000 as libc::c_int as libc::c_double;
        }
        3145733 => {
            *param_doublep = (*data).progress.t_connect as libc::c_double
                / 1000000 as libc::c_int as libc::c_double;
        }
        3145761 => {
            *param_doublep = (*data).progress.t_appconnect as libc::c_double
                / 1000000 as libc::c_int as libc::c_double;
        }
        3145734 => {
            *param_doublep = (*data).progress.t_pretransfer as libc::c_double
                / 1000000 as libc::c_int as libc::c_double;
        }
        3145745 => {
            *param_doublep = (*data).progress.t_starttransfer as libc::c_double
                / 1000000 as libc::c_int as libc::c_double;
        }
        3145735 => {
            *param_doublep = (*data).progress.uploaded as libc::c_double;
        }
        3145736 => {
            *param_doublep = (*data).progress.downloaded as libc::c_double;
        }
        3145737 => {
            *param_doublep = (*data).progress.dlspeed as libc::c_double;
        }
        3145738 => {
            *param_doublep = (*data).progress.ulspeed as libc::c_double;
        }
        3145743 => {
            *param_doublep = if (*data).progress.flags
                & (1 as libc::c_int) << 6 as libc::c_int != 0
            {
                (*data).progress.size_dl as libc::c_double
            } else {
        ...
        3145744 => {
            *param_doublep = if (*data).progress.flags
                & (1 as libc::c_int) << 5 as libc::c_int != 0
            {
                (*data).progress.size_ul as libc::c_double
            } else {
                -(1 as libc::c_int) as libc::c_double
            };
        }
        3145747 => {
            *param_doublep = (*data).progress.t_redirect as libc::c_double
                / 1000000 as libc::c_int as libc::c_double;
        }
        _ => return CURLE_UNKNOWN_OPTION,
    }
...
unsafe extern "C" fn getinfo_slist(
    ...
    match info as libc::c_uint {
        ...
        4194347 | 4194349 => {
            let mut tsip: *mut *mut curl_tlssessioninfo = param_slistp
                as *mut *mut curl_tlssessioninfo;
            let mut tsi: *mut curl_tlssessioninfo = &mut (*data).tsi;
            let mut conn: *mut connectdata = (*data).conn;
            *tsip = tsi;
            (*tsi).backend = Curl_ssl_backend() as curl_sslbackend;
            let ref mut fresh3 = (*tsi).internals;
            *fresh3 = 0 as *mut libc::c_void;
            if !conn.is_null()
                && (*tsi).backend as libc::c_uint
                    != CURLSSLBACKEND_NONE as libc::c_int as libc::c_uint
            {
                let mut i: libc::c_uint = 0;
                i = 0 as libc::c_int as libc::c_uint;
                while (i as libc::c_ulong)
                    < (::std::mem::size_of::<[ssl_connect_data; 2]>() as libc::c_ulong)
                        .wrapping_div(
                            ::std::mem::size_of::<ssl_connect_data>() as libc::c_ulong,
                        )
                {
                    if ((*conn).ssl[i as usize]).use_0() != 0 {
                        let ref mut fresh4 = (*tsi).internals;
...
unsafe extern "C" fn getinfo_socket(
    ...
    match info as libc::c_uint {
        5242924 => {
            *param_socketp = Curl_getconnectinfo(data, 0 as *mut *mut connectdata);
        }
        _ => return CURLE_UNKNOWN_OPTION,
    }
    return CURLE_OK;
...
pub unsafe extern "C" fn Curl_getinfo(
    ...
    let mut param_longp: *mut libc::c_long = 0 as *mut libc::c_long;
    let mut param_doublep: *mut libc::c_double = 0 as *mut libc::c_double;
    let mut param_offt: *mut curl_off_t = 0 as *mut curl_off_t;
    let mut param_charp: *mut *const libc::c_char = 0 as *mut *const libc::c_char;
    ...
    arg = args.clone();
    type_0 = 0xf00000 as libc::c_int & info as libc::c_int;
    match type_0 {
        1048576 => {
            param_charp = arg.arg::<*mut *const libc::c_char>();
            if !param_charp.is_null() {
                result = getinfo_char(data, info, param_charp);
            }
        }
        2097152 => {
            param_longp = arg.arg::<*mut libc::c_long>();
            if !param_longp.is_null() {
                result = getinfo_long(data, info, param_longp);
            }
        }
        3145728 => {
            param_doublep = arg.arg::<*mut libc::c_double>();
