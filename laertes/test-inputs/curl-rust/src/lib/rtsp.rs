...
extern "C" {
    ...
    fn Curl_add_timecondition(data: *mut Curl_easy, req: *mut dynbuf) -> CURLcode;
...
pub static mut Curl_handler_rtsp: Curl_handler = unsafe {
    {
        let mut init = Curl_handler {
            scheme: b"RTSP\0" as *const u8 as *const libc::c_char,
            ...
            attach: None,
            defport: 554 as libc::c_int,
            protocol: ((1 as libc::c_int) << 18 as libc::c_int) as libc::c_uint,
            family: ((1 as libc::c_int) << 18 as libc::c_int) as libc::c_uint,
...
unsafe extern "C" fn rtsp_setup_connection(
    ...
    rtsp = Curl_ccalloc
        ...
        )(1 as libc::c_int as size_t, ::std::mem::size_of::<RTSP>() as libc::c_ulong)
        as *mut RTSP;
...
unsafe extern "C" fn rtsp_connisdead(mut check: *mut connectdata) -> bool {
    ...
    sval = Curl_socket_check(
        (*check).sock[0 as libc::c_int as usize],
        -(1 as libc::c_int),
        -(1 as libc::c_int),
...
unsafe extern "C" fn rtsp_connect(
    ...
    if (*data).state.rtsp_next_client_CSeq == 0 as libc::c_int as libc::c_long {
        (*data).state.rtsp_next_client_CSeq = 1 as libc::c_int as libc::c_long;
    }
    if (*data).state.rtsp_next_server_CSeq == 0 as libc::c_int as libc::c_long {
        (*data).state.rtsp_next_server_CSeq = 1 as libc::c_int as libc::c_long;
    }
    (*(*data).conn).proto.rtspc.rtp_channel = -(1 as libc::c_int);
    return httpStatus;
}
...
unsafe extern "C" fn rtsp_done(
    ...
    let mut httpStatus: CURLcode = CURLE_OK;
    if (*data).set.rtspreq as libc::c_uint
    ...
    if !rtsp.is_null() {
        let mut CSeq_sent: libc::c_long = (*rtsp).CSeq_sent;
        let mut CSeq_recv: libc::c_long = (*rtsp).CSeq_recv;
        if (*data).set.rtspreq as libc::c_uint
            != RTSPREQ_RECEIVE as libc::c_int as libc::c_uint && CSeq_sent != CSeq_recv
        {
            Curl_failf(
                data,
...
unsafe extern "C" fn rtsp_do(mut data: *mut Curl_easy, mut done: *mut bool) -> CURLcode {
    ...
    let mut postsize: curl_off_t = 0 as libc::c_int as curl_off_t;
    let mut putsize: curl_off_t = 0 as libc::c_int as curl_off_t;
    let mut p_request: *const libc::c_char = 0 as *const libc::c_char;
    let mut p_session_id: *const libc::c_char = 0 as *const libc::c_char;
    let mut p_accept: *const libc::c_char = 0 as *const libc::c_char;
    let mut p_accept_encoding: *const libc::c_char = 0 as *const libc::c_char;
    let mut p_range: *const libc::c_char = 0 as *const libc::c_char;
    let mut p_referrer: *const libc::c_char = 0 as *const libc::c_char;
    let mut p_stream_uri: *const libc::c_char = 0 as *const libc::c_char;
    let mut p_transport: *const libc::c_char = 0 as *const libc::c_char;
    let mut p_uagent: *const libc::c_char = 0 as *const libc::c_char;
    let mut p_proxyuserpwd: *const libc::c_char = 0 as *const libc::c_char;
    let mut p_userpwd: *const libc::c_char = 0 as *const libc::c_char;
    *done = 1 as libc::c_int != 0;
    (*rtsp).CSeq_sent = (*data).state.rtsp_next_client_CSeq;
    (*rtsp).CSeq_recv = 0 as libc::c_int as libc::c_long;
    let ref mut fresh2 = (*data).set;
    (*fresh2).set_opt_no_body(1 as libc::c_int as bit);
    match rtspreq as libc::c_uint {
        1 => {
            p_request = b"OPTIONS\0" as *const u8 as *const libc::c_char;
        }
        2 => {
            p_request = b"DESCRIBE\0" as *const u8 as *const libc::c_char;
            let ref mut fresh3 = (*data).set;
            (*fresh3).set_opt_no_body(0 as libc::c_int as bit);
        }
        3 => {
            p_request = b"ANNOUNCE\0" as *const u8 as *const libc::c_char;
        }
        4 => {
            p_request = b"SETUP\0" as *const u8 as *const libc::c_char;
        }
        5 => {
            p_request = b"PLAY\0" as *const u8 as *const libc::c_char;
        }
        6 => {
            p_request = b"PAUSE\0" as *const u8 as *const libc::c_char;
        }
        7 => {
            p_request = b"TEARDOWN\0" as *const u8 as *const libc::c_char;
        }
        8 => {
            p_request = b"GET_PARAMETER\0" as *const u8 as *const libc::c_char;
            let ref mut fresh4 = (*data).set;
            (*fresh4).set_opt_no_body(0 as libc::c_int as bit);
        }
        9 => {
            p_request = b"SET_PARAMETER\0" as *const u8 as *const libc::c_char;
        }
        10 => {
            p_request = b"RECORD\0" as *const u8 as *const libc::c_char;
        }
        11 => {
            p_request = b"\0" as *const u8 as *const libc::c_char;
            let ref mut fresh5 = (*data).set;
            (*fresh5).set_opt_no_body(0 as libc::c_int as bit);
        }
        12 => {
            Curl_failf(
                data,
        ...
        _ => {
            Curl_failf(
                data,
                b"Got invalid RTSP request\0" as *const u8 as *const libc::c_char,
            );
            return CURLE_BAD_FUNCTION_ARGUMENT;
        }
    }
    if rtspreq as libc::c_uint == RTSPREQ_RECEIVE as libc::c_int as libc::c_uint {
        Curl_setup_transfer(
            data,
            0 as libc::c_int,
    ...
    p_session_id = (*data).set.str_0[STRING_RTSP_SESSION_ID as libc::c_int as usize];
    if p_session_id.is_null()
        && rtspreq as libc::c_uint
            & !(RTSPREQ_OPTIONS as libc::c_int | RTSPREQ_DESCRIBE as libc::c_int
                | RTSPREQ_SETUP as libc::c_int) as libc::c_uint != 0
    {
        Curl_failf(
            data,
    ...
    if !((*data).set.str_0[STRING_RTSP_STREAM_URI as libc::c_int as usize]).is_null() {
        p_stream_uri = (*data).set.str_0[STRING_RTSP_STREAM_URI as libc::c_int as usize];
    } else {
        p_stream_uri = b"*\0" as *const u8 as *const libc::c_char;
    }
    p_transport = Curl_checkheaders(
        data,
        b"Transport\0" as *const u8 as *const libc::c_char,
    );
    if rtspreq as libc::c_uint == RTSPREQ_SETUP as libc::c_int as libc::c_uint
        && p_transport.is_null()
    {
        if !((*data).set.str_0[STRING_RTSP_TRANSPORT as libc::c_int as usize]).is_null()
        {
            Curl_cfree
                .expect(
                    "non-null function pointer",
            ...
            *fresh7 = curl_maprintf(
                ...
                (*data).set.str_0[STRING_RTSP_TRANSPORT as libc::c_int as usize],
            );
    ...
    if rtspreq as libc::c_uint == RTSPREQ_DESCRIBE as libc::c_int as libc::c_uint {
    ...
    *fresh12 = 0 as *mut libc::c_char;
    ...
    if ((*data).state).use_range() as libc::c_int != 0
        && rtspreq as libc::c_uint
            & (RTSPREQ_PLAY as libc::c_int | RTSPREQ_PAUSE as libc::c_int
                | RTSPREQ_RECORD as libc::c_int) as libc::c_uint != 0
    {
        if (Curl_checkheaders(data, b"Range\0" as *const u8 as *const libc::c_char))
    ...
    if !(Curl_checkheaders(data, b"CSeq\0" as *const u8 as *const libc::c_char))
        .is_null()
    {
        Curl_failf(
            data,
    ...
    if !(Curl_checkheaders(data, b"Session\0" as *const u8 as *const libc::c_char))
        .is_null()
    {
        Curl_failf(
            data,
    ...
    Curl_dyn_init(&mut req_buffer, (64 as libc::c_int * 1024 as libc::c_int) as size_t);
    ...
    *fresh18 = 0 as *mut libc::c_char;
    ...
    if rtspreq as libc::c_uint == RTSPREQ_SETUP as libc::c_int as libc::c_uint
        || rtspreq as libc::c_uint == RTSPREQ_DESCRIBE as libc::c_int as libc::c_uint
    {
    ...
    result = Curl_add_custom_headers(data, 0 as libc::c_int != 0, &mut req_buffer);
    if result as u64 != 0 {
        return result;
    }
    if rtspreq as libc::c_uint == RTSPREQ_ANNOUNCE as libc::c_int as libc::c_uint
        || rtspreq as libc::c_uint
            == RTSPREQ_SET_PARAMETER as libc::c_int as libc::c_uint
        || rtspreq as libc::c_uint
            == RTSPREQ_GET_PARAMETER as libc::c_int as libc::c_uint
    {
        if ((*data).set).upload() != 0 {
            putsize = (*data).state.infilesize;
            (*data).state.httpreq = HTTPREQ_PUT;
        } else {
            postsize = if (*data).state.infilesize != -(1 as libc::c_int) as libc::c_long
            {
                (*data).state.infilesize
            } else if !((*data).set.postfields).is_null() {
                strlen((*data).set.postfields as *const libc::c_char) as curl_off_t
            } else {
                0 as libc::c_int as libc::c_long
            };
            (*data).state.httpreq = HTTPREQ_POST;
        }
        if putsize > 0 as libc::c_int as libc::c_long
            || postsize > 0 as libc::c_int as libc::c_long
        {
            if (Curl_checkheaders(
                data,
            ...
            (*fresh19).set_expect100header(0 as libc::c_int as bit);
        } else if rtspreq as libc::c_uint
                == RTSPREQ_GET_PARAMETER as libc::c_int as libc::c_uint
            {
            (*data).state.httpreq = HTTPREQ_HEAD;
            let ref mut fresh20 = (*data).set;
            (*fresh20).set_opt_no_body(1 as libc::c_int as bit);
        }
    }
    let ref mut fresh21 = (*data).req;
    (*fresh21).set_forbidchunk(1 as libc::c_int as bit);
    result = Curl_dyn_add(
        &mut req_buffer,
        b"\r\n\0" as *const u8 as *const libc::c_char,
    );
    ...
    if postsize > 0 as libc::c_int as libc::c_long {
    ...
    if result as u64 != 0 {
        Curl_failf(
            data,
            b"Failed sending RTSP request\0" as *const u8 as *const libc::c_char,
        );
        return result;
    }
    Curl_setup_transfer(
        ...
        -(1 as libc::c_int) as curl_off_t,
        1 as libc::c_int != 0,
        if putsize != 0 { 0 as libc::c_int } else { -(1 as libc::c_int) },
    );
...
unsafe extern "C" fn rtsp_rtp_readwrite(
    ...
    let mut rtp: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut rtp_dataleft: ssize_t = 0;
    let mut scratch: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut result: CURLcode = CURLE_OK;
    if !((*rtspc).rtp_buf).is_null() {
        let mut newptr: *mut libc::c_char = Curl_saferealloc(
        ...
        if newptr.is_null() {
            ...
            *fresh23 = 0 as *mut libc::c_char;
            (*rtspc).rtp_bufsize = 0 as libc::c_int as ssize_t;
            return CURLE_OUT_OF_MEMORY;
        }
    ...
    while rtp_dataleft > 0 as libc::c_int as libc::c_long
        && *rtp.offset(0 as libc::c_int as isize) as libc::c_int == '$' as i32
    {
        if rtp_dataleft > 4 as libc::c_int as libc::c_long {
            let mut rtp_length: libc::c_int = 0;
            (*rtspc)
                .rtp_channel = *rtp.offset(1 as libc::c_int as isize) as libc::c_uchar
                as libc::c_int;
            rtp_length = (*rtp.offset(2 as libc::c_int as isize) as libc::c_uchar
                as libc::c_int) << 8 as libc::c_int
                | *rtp.offset(3 as libc::c_int as isize) as libc::c_uchar as libc::c_int;
            if rtp_dataleft < (rtp_length + 4 as libc::c_int) as libc::c_long {
                *readmore = 1 as libc::c_int != 0;
                break;
            } else {
                result = rtp_client_write(
                    data,
                    &mut *rtp.offset(0 as libc::c_int as isize),
                    (rtp_length + 4 as libc::c_int) as size_t,
                );
                if result as u64 != 0 {
                    Curl_failf(
                        data,
                ...
                rtp_dataleft -= (rtp_length + 4 as libc::c_int) as libc::c_long;
                rtp = rtp.offset((rtp_length + 4 as libc::c_int) as isize);
                if (*data).set.rtspreq as libc::c_uint
                    == RTSPREQ_RECEIVE as libc::c_int as libc::c_uint
                {
    ...
    *fresh32 = (*fresh32).offset((*nread - rtp_dataleft) as isize);
    rtp_dataleft > 0 as libc::c_int as libc::c_long;
    *nread = rtp_dataleft;
    Curl_cfree
        .expect("non-null function pointer")((*rtspc).rtp_buf as *mut libc::c_void);
...
unsafe extern "C" fn rtp_client_write(
    ...
    if len == 0 as libc::c_int as libc::c_ulong {
        Curl_failf(
            data,
            b"Cannot write a 0 size RTP packet.\0" as *const u8 as *const libc::c_char,
        );
    ...
    wrote = writeit
        .expect(
            "non-null function pointer",
        )(ptr, 1 as libc::c_int as size_t, len, user_ptr);
    Curl_set_in_callback(data, 0 as libc::c_int != 0);
    if 0x10000001 as libc::c_int as libc::c_ulong == wrote {
        Curl_failf(data, b"Cannot pause RTP\0" as *const u8 as *const libc::c_char);
        return CURLE_WRITE_ERROR;
    }
    if wrote != len {
        Curl_failf(
            data,
            b"Failed writing RTP data\0" as *const u8 as *const libc::c_char,
        );
        return CURLE_WRITE_ERROR;
    }
    return CURLE_OK;
...
pub unsafe extern "C" fn Curl_rtsp_parseheader(
    ...
    let mut CSeq: libc::c_long = 0 as libc::c_int as libc::c_long;
    if curl_strnequal(
        b"CSeq:\0" as *const u8 as *const libc::c_char,
        header,
        strlen(b"CSeq:\0" as *const u8 as *const libc::c_char),
    ) != 0
    {
        let mut nc: libc::c_int = sscanf(
            &mut *header.offset(4 as libc::c_int as isize) as *mut libc::c_char,
            b": %ld\0" as *const u8 as *const libc::c_char,
            &mut CSeq as *mut libc::c_long,
        );
        if nc == 1 as libc::c_int {
            ...
            header,
            strlen(b"Session:\0" as *const u8 as *const libc::c_char),
        ) != 0
        {
        let mut start: *mut libc::c_char = 0 as *mut libc::c_char;
        let mut end: *mut libc::c_char = 0 as *mut libc::c_char;
        let mut idlen: size_t = 0;
        start = header.offset(8 as libc::c_int as isize);
        ...
        if *start == 0 {
            Curl_failf(
                data,
                b"Got a blank Session ID\0" as *const u8 as *const libc::c_char,
            );
            return CURLE_RTSP_SESSION_ERROR;
        }
        end = start;
        while *end as libc::c_int != 0 && *end as libc::c_int != ';' as i32
            && Curl_isspace(*end as libc::c_uchar as libc::c_int) == 0
        {
            end = end.offset(1);
        }
        idlen = end.offset_from(start) as libc::c_long as size_t;
        if !((*data).set.str_0[STRING_RTSP_SESSION_ID as libc::c_int as usize]).is_null()
        {
            if strlen((*data).set.str_0[STRING_RTSP_SESSION_ID as libc::c_int as usize])
                != idlen
                || strncmp(
                    start,
                    (*data).set.str_0[STRING_RTSP_SESSION_ID as libc::c_int as usize],
                    idlen,
                ) != 0 as libc::c_int
            {
                Curl_failf(
            ...
            let ref mut fresh35 = (*data)
                .set
                .str_0[STRING_RTSP_SESSION_ID as libc::c_int as usize];
            *fresh35 = Curl_cmalloc
                .expect(
                    "non-null function pointer",
                )(idlen.wrapping_add(1 as libc::c_int as libc::c_ulong))
                as *mut libc::c_char;
            if ((*data).set.str_0[STRING_RTSP_SESSION_ID as libc::c_int as usize])
                .is_null()
            {
                return CURLE_OUT_OF_MEMORY;
            }
            ...
            *((*data).set.str_0[STRING_RTSP_SESSION_ID as libc::c_int as usize])
                .offset(idlen as isize) = '\u{0}' as i32 as libc::c_char;
        }
    }
    return CURLE_OK;
}
