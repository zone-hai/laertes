...
extern "C" {
    ...
    fn Curl_md4it(output: *mut libc::c_uchar, input: *const libc::c_uchar, len: size_t);
    fn curl_msnprintf(
...
pub struct ms_filetime {
    pub dwLowDateTime: libc::c_uint,
    pub dwHighDateTime: libc::c_uint,
}
unsafe extern "C" fn extend_key_56_to_64(
    mut key_56: *const libc::c_uchar,
    mut key: *mut libc::c_char,
) {
    *key
        .offset(
            0 as libc::c_int as isize,
        ) = *key_56.offset(0 as libc::c_int as isize) as libc::c_char;
    *key
        .offset(
            1 as libc::c_int as isize,
        ) = ((*key_56.offset(0 as libc::c_int as isize) as libc::c_int)
    ...
    *key
        ...
        ) = ((*key_56.offset(1 as libc::c_int as isize) as libc::c_int)
    ...
    *key
        ...
        ) = ((*key_56.offset(2 as libc::c_int as isize) as libc::c_int)
    ...
    *key
        ...
        ) = ((*key_56.offset(3 as libc::c_int as isize) as libc::c_int)
    ...
    *key
        ...
        ) = ((*key_56.offset(4 as libc::c_int as isize) as libc::c_int)
    ...
    *key
        ...
        ) = ((*key_56.offset(5 as libc::c_int as isize) as libc::c_int)
    ...
    *key
        ...
        ) = ((*key_56.offset(6 as libc::c_int as isize) as libc::c_int)
        << 1 as libc::c_int & 0xff as libc::c_int) as libc::c_uchar as libc::c_char;
}
unsafe extern "C" fn setup_des_key(
    ...
    extend_key_56_to_64(key_56, &mut key as *mut DES_cblock as *mut libc::c_char);
    DES_set_odd_parity(&mut key);
    DES_set_key(&mut key, ks);
}
#[no_mangle]
pub unsafe extern "C" fn Curl_ntlm_core_lm_resp(
    mut keys: *const libc::c_uchar,
    mut plaintext: *const libc::c_uchar,
...
pub unsafe extern "C" fn Curl_ntlm_core_mk_lm_hash(
    ...
    let mut len: size_t = if strlen(password) < 14 as libc::c_int as libc::c_ulong {
        strlen(password)
    } else {
        14 as libc::c_int as libc::c_ulong
    };
    Curl_strntoupper(pw.as_mut_ptr() as *mut libc::c_char, password, len);
    memset(
        &mut *pw.as_mut_ptr().offset(len as isize) as *mut libc::c_uchar
            as *mut libc::c_void,
        0 as libc::c_int,
        (14 as libc::c_int as libc::c_ulong).wrapping_sub(len),
    );
    ...
    setup_des_key(pw.as_mut_ptr().offset(7 as libc::c_int as isize), &mut ks);
    DES_ecb_encrypt(
        magic.as_ptr() as *mut DES_cblock,
        lmbuffer.offset(8 as libc::c_int as isize) as *mut DES_cblock,
        &mut ks,
        1 as libc::c_int,
    );
    memset(
        lmbuffer.offset(16 as libc::c_int as isize) as *mut libc::c_void,
        0 as libc::c_int,
        (21 as libc::c_int - 16 as libc::c_int) as libc::c_ulong,
    );
    return CURLE_OK;
}
...
unsafe extern "C" fn ascii_uppercase_to_unicode_le(
    ...
    while i < srclen {
        *dest
            .offset(
                (2 as libc::c_int as libc::c_ulong).wrapping_mul(i) as isize,
            ) = Curl_raw_toupper(*src.offset(i as isize)) as libc::c_uchar;
        *dest
            .offset(
                (2 as libc::c_int as libc::c_ulong)
                    .wrapping_mul(i)
...
pub unsafe extern "C" fn Curl_ntlm_core_mk_nt_hash(
    ...
    result = CURLE_OK as libc::c_int as CURLcode;
    if result as u64 == 0 {
        Curl_md4it(ntbuffer, pw, (2 as libc::c_int as libc::c_ulong).wrapping_mul(len));
        memset(
            ntbuffer.offset(16 as libc::c_int as isize) as *mut libc::c_void,
            0 as libc::c_int,
            (21 as libc::c_int - 16 as libc::c_int) as libc::c_ulong,
        );
    }
...
unsafe extern "C" fn time2filetime(mut ft: *mut ms_filetime, mut t: time_t) {
    t = (t + 11644473600 as libc::c_long) * 10000000 as libc::c_int as libc::c_long;
    (*ft)
        .dwLowDateTime = (t & 0xffffffff as libc::c_uint as libc::c_long)
        as libc::c_uint;
    (*ft).dwHighDateTime = (t >> 32 as libc::c_int) as libc::c_uint;
}
#[no_mangle]
pub unsafe extern "C" fn Curl_ntlm_core_mk_ntlmv2_hash(
    ...
    mut domlen: size_t,
    mut ntlmhash: *mut libc::c_uchar,
    mut ntlmv2hash: *mut libc::c_uchar,
) -> CURLcode {
    let mut identity_len: size_t = 0;
    let mut identity: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut result: CURLcode = CURLE_OK;
    if userlen > 8000000 as libc::c_int as libc::c_ulong
        || domlen > 8000000 as libc::c_int as libc::c_ulong
    {
        return CURLE_OUT_OF_MEMORY;
    }
    ...
    identity = Curl_cmalloc
        .expect(
            "non-null function pointer",
        )(identity_len.wrapping_add(1 as libc::c_int as libc::c_ulong))
        as *mut libc::c_uchar;
    if identity.is_null() {
        return CURLE_OUT_OF_MEMORY;
    }
    ...
    ascii_to_unicode_le(
        identity.offset((userlen << 1 as libc::c_int) as isize),
        domain,
        domlen,
    );
    result = Curl_hmacit(
...
#[no_mangle]
pub unsafe extern "C" fn Curl_ntlm_core_mk_ntlmv2_resp(
    mut ntlmv2hash: *mut libc::c_uchar,
    mut challenge_client: *mut libc::c_uchar,
    mut ntlm: *mut ntlmdata,
    mut ntresp: *mut *mut libc::c_uchar,
    mut ntresp_len: *mut libc::c_uint,
) -> CURLcode {
    let mut len: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut ptr: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut hmac_output: [libc::c_uchar; 16] = [0; 16];
    let mut tw: ms_filetime = ms_filetime {
        dwLowDateTime: 0,
        dwHighDateTime: 0,
    };
    let mut result: CURLcode = CURLE_OK;
    time2filetime(&mut tw, time(0 as *mut time_t));
    len = (16 as libc::c_int as libc::c_uint)
        .wrapping_add(
            ((44 as libc::c_int - 16 as libc::c_int) as libc::c_uint)
                .wrapping_add((*ntlm).target_info_len)
                .wrapping_add(4 as libc::c_int as libc::c_uint),
        );
    ptr = Curl_ccalloc
        .expect("non-null function pointer")(1 as libc::c_int as size_t, len as size_t)
        as *mut libc::c_uchar;
    if ptr.is_null() {
        return CURLE_OUT_OF_MEMORY;
    }
    curl_msnprintf(
        (ptr as *mut libc::c_char).offset(16 as libc::c_int as isize),
        ((44 as libc::c_int - 16 as libc::c_int) as libc::c_uint)
            .wrapping_add((*ntlm).target_info_len)
            .wrapping_add(4 as libc::c_int as libc::c_uint) as size_t,
        b"%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c\0" as *const u8 as *const libc::c_char,
        (*::std::mem::transmute::<
            &[u8; 5],
            &[libc::c_char; 5],
        >(b"\x01\x01\0\0\0"))[0 as libc::c_int as usize] as libc::c_int,
        (*::std::mem::transmute::<
            &[u8; 5],
            &[libc::c_char; 5],
        >(b"\x01\x01\0\0\0"))[1 as libc::c_int as usize] as libc::c_int,
        (*::std::mem::transmute::<
            &[u8; 5],
            &[libc::c_char; 5],
        >(b"\x01\x01\0\0\0"))[2 as libc::c_int as usize] as libc::c_int,
        (*::std::mem::transmute::<
            &[u8; 5],
            &[libc::c_char; 5],
        >(b"\x01\x01\0\0\0"))[3 as libc::c_int as usize] as libc::c_int,
        0 as libc::c_int,
        0 as libc::c_int,
        0 as libc::c_int,
        0 as libc::c_int,
        (tw.dwLowDateTime & 0xff as libc::c_int as libc::c_uint) as libc::c_int,
        (tw.dwLowDateTime >> 8 as libc::c_int & 0xff as libc::c_int as libc::c_uint)
            as libc::c_int,
        (tw.dwLowDateTime >> 16 as libc::c_int & 0xff as libc::c_int as libc::c_uint)
            as libc::c_int,
        (tw.dwLowDateTime >> 24 as libc::c_int & 0xff as libc::c_int as libc::c_uint)
            as libc::c_int,
        (tw.dwHighDateTime & 0xff as libc::c_int as libc::c_uint) as libc::c_int,
        (tw.dwHighDateTime >> 8 as libc::c_int & 0xff as libc::c_int as libc::c_uint)
            as libc::c_int,
        (tw.dwHighDateTime >> 16 as libc::c_int & 0xff as libc::c_int as libc::c_uint)
            as libc::c_int,
        (tw.dwHighDateTime >> 24 as libc::c_int & 0xff as libc::c_int as libc::c_uint)
            as libc::c_int,
    );
    memcpy(
        ptr.offset(32 as libc::c_int as isize) as *mut libc::c_void,
        challenge_client as *const libc::c_void,
        8 as libc::c_int as libc::c_ulong,
    );
    memcpy(
        ptr.offset(44 as libc::c_int as isize) as *mut libc::c_void,
        (*ntlm).target_info,
        (*ntlm).target_info_len as libc::c_ulong,
    );
    memcpy(
        ptr.offset(8 as libc::c_int as isize) as *mut libc::c_void,
    ...
    result = Curl_hmacit(
        ...
        ntlmv2hash,
        16 as libc::c_int as size_t,
        ptr.offset(8 as libc::c_int as isize),
        ((44 as libc::c_int - 16 as libc::c_int) as libc::c_uint)
            .wrapping_add((*ntlm).target_info_len)
            .wrapping_add(4 as libc::c_int as libc::c_uint)
            .wrapping_add(8 as libc::c_int as libc::c_uint) as size_t,
...
pub unsafe extern "C" fn Curl_ntlm_core_mk_lmv2_resp(
    mut ntlmv2hash: *mut libc::c_uchar,
    mut challenge_client: *mut libc::c_uchar,
    mut challenge_server: *mut libc::c_uchar,
    mut lmresp: *mut libc::c_uchar,
) -> CURLcode {
    let mut data: [libc::c_uchar; 16] = [0; 16];
    let mut hmac_output: [libc::c_uchar; 16] = [0; 16];
    let mut result: CURLcode = CURLE_OK;
    memcpy(
        &mut *data.as_mut_ptr().offset(0 as libc::c_int as isize) as *mut libc::c_uchar
            as *mut libc::c_void,
        challenge_server as *const libc::c_void,
        8 as libc::c_int as libc::c_ulong,
    );
    memcpy(
        &mut *data.as_mut_ptr().offset(8 as libc::c_int as isize) as *mut libc::c_uchar
            as *mut libc::c_void,
        challenge_client as *const libc::c_void,
        8 as libc::c_int as libc::c_ulong,
    );
    ...
    memcpy(
        lmresp.offset(16 as libc::c_int as isize) as *mut libc::c_void,
        challenge_client as *const libc::c_void,
        8 as libc::c_int as libc::c_ulong,
    );
    return result;
