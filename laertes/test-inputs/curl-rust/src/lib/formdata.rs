...
extern "C" {
    ...
    fn Curl_mime_contenttype(filename: *const libc::c_char) -> *const libc::c_char;
...
>;
pub type CURLformoption = libc::c_uint;
...
pub type CURLFORMcode = libc::c_uint;
...
pub type curl_formget_callback = Option::<
    unsafe extern "C" fn(*mut libc::c_void, *const libc::c_char, size_t) -> size_t,
>;
...
unsafe extern "C" fn AddHttpPost(
    ...
    mut contenttype: *mut libc::c_char,
    mut flags: libc::c_long,
    mut contentHeader: *mut curl_slist,
    mut showfilename: *mut libc::c_char,
    mut userp: *mut libc::c_char,
    ...
    post = Curl_ccalloc
        ...
        ::std::mem::size_of::<curl_httppost>() as libc::c_ulong,
    ...
    if !post.is_null() {
        ...
        *fresh2 = buffer;
        (*post).bufferlength = bufferlength as libc::c_long;
        ...
        *fresh6 = userp as *mut libc::c_void;
        (*post).flags = flags | ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_long;
    } else {
...
unsafe extern "C" fn AddFormInfo(
    ...
    form_info = Curl_ccalloc
        .expect(
            "non-null function pointer",
        )(1 as libc::c_int as size_t, ::std::mem::size_of::<FormInfo>() as libc::c_ulong)
        as *mut FormInfo;
    if !form_info.is_null() {
        ...
        (*form_info).flags = ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_long;
    } else {
...
unsafe extern "C" fn FormAdd(
    ...
    let mut prevtype: *const libc::c_char = 0 as *const libc::c_char;
    let mut post: *mut curl_httppost = 0 as *mut curl_httppost;
    let mut option: CURLformoption = CURLFORM_NOTHING;
    let mut forms: *mut curl_forms = 0 as *mut curl_forms;
    let mut array_value: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut array_state: bool = 0 as libc::c_int != 0;
    ...
    while return_value as libc::c_uint == CURL_FORMADD_OK as libc::c_int as libc::c_uint
    {
        if array_state as libc::c_int != 0 && !forms.is_null() {
            option = (*forms).option;
            array_value = (*forms).value as *mut libc::c_char;
            forms = forms.offset(1);
            if CURLFORM_END as libc::c_int as libc::c_uint == option as libc::c_uint {
                array_state = 0 as libc::c_int != 0;
                continue;
            }
        } else {
        ...
        match option as libc::c_uint {
            ...
            3 => {
                if (*current_form).namelength != 0 {
                    ...
                    (*current_form)
                        .namelength = if array_state as libc::c_int != 0 {
                        array_value as size_t
                    } else {
                        params.arg::<libc::c_long>() as size_t
                    };
                }
                current_block_137 = 2704538829018177290;
            }
            ...
            6 => {
                (*current_form)
                    .contentslength = (if array_state as libc::c_int != 0 {
                    array_value as size_t
                } else {
                    params.arg::<libc::c_long>() as size_t
                }) as curl_off_t;
            ...
            7 => {
                        ...
                        | (1 as libc::c_int) << 1 as libc::c_int) as libc::c_long != 0
                {
                    ...
                    let mut filename: *const libc::c_char = if array_state as libc::c_int
                        != 0
                    {
                        array_value
                    } else {
                        params.arg::<*mut libc::c_char>()
                    };
                    if !filename.is_null() {
                        ...
                        *fresh16 = Curl_cstrdup
                        ...
                        if ((*current_form).value).is_null() {
                            ...
                            (*current_form).value_alloc = 1 as libc::c_int != 0;
                        }
                    } else {
                        return_value = CURL_FORMADD_NULL;
                    }
            ...
            10 => {
                let mut filename_0: *const libc::c_char = if array_state as libc::c_int
                    != 0
                {
                    array_value
                } else {
                ...
                if !((*current_form).value).is_null() {
                        ...
                        & ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_long != 0
                    {
                        if !filename_0.is_null() {
                            let mut fname: *mut libc::c_char = Curl_cstrdup
                            ...
                            if fname.is_null() {
                                ...
                                if form.is_null() {
                                    ...
                                    (*form).value_alloc = 1 as libc::c_int != 0;
                                    current_form = form;
            ...
            12 => {
                ...
                if !((*current_form).buffer).is_null() {
                    ...
                    let mut buffer: *mut libc::c_char = if array_state as libc::c_int
                        != 0
                    {
                        array_value
                    } else {
            ...
            13 => {
                if (*current_form).bufferlength != 0 {
                    ...
                    (*current_form)
                        .bufferlength = if array_state as libc::c_int != 0 {
                        array_value as size_t
                    } else {
                        params.arg::<libc::c_long>() as size_t
                    };
            ...
            19 => {
                ...
                if !((*current_form).userp).is_null() {
                    ...
                    let mut userp: *mut libc::c_char = if array_state as libc::c_int != 0
                    {
                        array_value
                    } else {
                        params.arg::<*mut libc::c_char>()
            ...
            14 => {
                let mut contenttype: *const libc::c_char = if array_state as libc::c_int
                    != 0
                {
                    array_value
                } else {
                ...
                if !((*current_form).contenttype).is_null() {
                    ...
                    {
                        if !contenttype.is_null() {
                            let mut type_0: *mut libc::c_char = Curl_cstrdup
                            ...
                            if type_0.is_null() {
                                ...
                                if form.is_null() {
                                    ...
                                    (*form).contenttype_alloc = 1 as libc::c_int != 0;
                                    current_form = form;
                                    form = 0 as *mut FormInfo;
                                }
                            }
                    ...
                    *fresh22 = Curl_cstrdup
                    ...
                    if ((*current_form).contenttype).is_null() {
                        ...
                        (*current_form).contenttype_alloc = 1 as libc::c_int != 0;
                    }
                } else {
                    return_value = CURL_FORMADD_NULL;
                }
            ...
            15 => {
                let mut list: *mut curl_slist = if array_state as libc::c_int != 0 {
            ...
            16 | 11 => {
                let mut filename_1: *const libc::c_char = if array_state as libc::c_int
                    != 0
                {
                    array_value
                } else {
                ...
                if !((*current_form).showfilename).is_null() {
                    ...
                    *fresh24 = Curl_cstrdup
                    ...
                    if ((*current_form).showfilename).is_null() {
                        ...
                        (*current_form).showfilename_alloc = 1 as libc::c_int != 0;
                    }
                }
                current_block_137 = 2704538829018177290;
            }
        ...
        match current_block_137 {
            14371220985979925773 => {
                if !((*current_form).name).is_null() {
                    ...
                    let mut name: *mut libc::c_char = if array_state as libc::c_int != 0
                    {
                        array_value
                    } else {
                        params.arg::<*mut libc::c_char>()
            ...
            11213271726480235426 => {
                if !((*current_form).value).is_null() {
                    ...
                    let mut value: *mut libc::c_char = if array_state as libc::c_int != 0
                    {
                        array_value
                    } else {
                        params.arg::<*mut libc::c_char>()
    ...
    if CURL_FORMADD_OK as libc::c_int as libc::c_uint != return_value as libc::c_uint {
        ...
        while !ptr.is_null() {
            if (*ptr).name_alloc {
                ...
                *fresh25 = 0 as *mut libc::c_char;
                (*ptr).name_alloc = 0 as libc::c_int != 0;
            }
            if (*ptr).value_alloc {
                Curl_cfree
                    .expect(
                ...
                *fresh26 = 0 as *mut libc::c_char;
                (*ptr).value_alloc = 0 as libc::c_int != 0;
            }
            if (*ptr).contenttype_alloc {
                ...
                *fresh27 = 0 as *mut libc::c_char;
                (*ptr).contenttype_alloc = 0 as libc::c_int != 0;
            }
            if (*ptr).showfilename_alloc {
                ...
                *fresh28 = 0 as *mut libc::c_char;
                (*ptr).showfilename_alloc = 0 as libc::c_int != 0;
            }
            ptr = (*ptr).more;
        }
    }
        ...
        while !form.is_null() {
            if (((*form).name).is_null() || ((*form).value).is_null()) && post.is_null()
                ...
                || (*form).flags
                    & ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_long != 0
                    && (*form).flags
                        & ((1 as libc::c_int) << 3 as libc::c_int) as libc::c_long != 0
                || ((*form).buffer).is_null()
                    && (*form).flags
                        & ((1 as libc::c_int) << 4 as libc::c_int) as libc::c_long != 0
                    && (*form).flags
                        & ((1 as libc::c_int) << 5 as libc::c_int) as libc::c_long != 0
                || (*form).flags
                    & ((1 as libc::c_int) << 1 as libc::c_int) as libc::c_long != 0
                    && (*form).flags
                        & ((1 as libc::c_int) << 3 as libc::c_int) as libc::c_long != 0
            {
                ...
                {
                    let mut f: *mut libc::c_char = if (*form).flags
                        & ((1 as libc::c_int) << 4 as libc::c_int) as libc::c_long != 0
                    {
                        (*form).showfilename
                    } else {
                    ...
                    let mut type_1: *const libc::c_char = 0 as *const libc::c_char;
                ...
                if !((*form).name).is_null() && (*form).namelength != 0 {
                    ...
                    if return_value as libc::c_uint
                        != CURL_FORMADD_OK as libc::c_int as libc::c_uint
                    {
                        break;
                    }
                }
                if (*form).flags
                    & ((1 as libc::c_int) << 2 as libc::c_int) as libc::c_long == 0
                    && form == first_form
                {
                    ...
                    if ((*form).name).is_null() {
                        ...
                        (*form).name_alloc = 1 as libc::c_int != 0;
                    }
                }
                if (*form).flags
                    & ((1 as libc::c_int) << 0 as libc::c_int
                        ...
                        | (1 as libc::c_int) << 3 as libc::c_int
                        | (1 as libc::c_int) << 5 as libc::c_int
                        | (1 as libc::c_int) << 6 as libc::c_int) as libc::c_long == 0
                    && !((*form).value).is_null()
                {
            ...
            while !ptr_0.is_null() {
                if (*ptr_0).name_alloc {
                    ...
                    *fresh32 = 0 as *mut libc::c_char;
                    (*ptr_0).name_alloc = 0 as libc::c_int != 0;
                }
                if (*ptr_0).value_alloc {
                    ...
                    *fresh33 = 0 as *mut libc::c_char;
                    (*ptr_0).value_alloc = 0 as libc::c_int != 0;
                }
                if (*ptr_0).contenttype_alloc {
                    ...
                    *fresh34 = 0 as *mut libc::c_char;
                    (*ptr_0).contenttype_alloc = 0 as libc::c_int != 0;
                }
                if (*ptr_0).showfilename_alloc {
                    ...
                    *fresh35 = 0 as *mut libc::c_char;
                    (*ptr_0).showfilename_alloc = 0 as libc::c_int != 0;
                }
                ptr_0 = (*ptr_0).more;
            }
        }
...
pub unsafe extern "C" fn curl_formget(
    ...
    while result as u64 == 0 {
        ...
        if nread > ::std::mem::size_of::<[libc::c_char; 8192]>() as libc::c_ulong
            || append
...
pub unsafe extern "C" fn curl_formfree(mut form: *mut curl_httppost) {
    ...
    loop {
        ...
        if (*form).flags & ((1 as libc::c_int) << 2 as libc::c_int) as libc::c_long == 0
        {
            Curl_cfree
...
unsafe extern "C" fn setname(
    ...
    *zname.offset(len as isize) = '\u{0}' as i32 as libc::c_char;
    ...
    while result as u64 == 0 && !post.is_null() {
        ...
        while result as u64 == 0 && !file.is_null() {
            ...
            if result as u64 == 0 {
                ...
                if (*post).flags
                    & ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_long != 0
                {
                        ...
                        | (1 as libc::c_int) << 1 as libc::c_int) as libc::c_long != 0
                {
                    ...
                    if result as u64 == 0
                        && (*post).flags
                            ...
                            != 0
                    {
                        result = curl_mime_filename(part, 0 as *const libc::c_char);
                    }
                } else if (*post).flags
                        & ((1 as libc::c_int) << 4 as libc::c_int) as libc::c_long != 0
                    {
                    ...
                    {
                    if clen == 0 {
                        clen = -(1 as libc::c_int) as curl_off_t;
                    }
                    result = curl_mime_data_cb(
                        part,
                        clen,
                    ...
                    if clen == 0 {
                        uclen = -(1 as libc::c_int) as size_t;
                    } else {
