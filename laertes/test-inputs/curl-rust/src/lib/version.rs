...
extern "C" {
    ...
    fn psl_get_version() -> *const libc::c_char;
    fn gsasl_check_version(req_version: *const libc::c_char) -> *const libc::c_char;
    static mut Curl_ssl: *const Curl_ssl;
    fn Curl_ssl_version(buffer: *mut libc::c_char, size: size_t);
    fn Curl_http2_ver(p: *mut libc::c_char, len: size_t);
    fn curl_msnprintf(
    ...
    fn ber_memvfree(vector: *mut *mut libc::c_void);
...
pub struct ldapapiinfo {
    pub ldapai_info_version: libc::c_int,
    pub ldapai_api_version: libc::c_int,
    pub ldapai_protocol_version: libc::c_int,
    pub ldapai_extensions: *mut *mut libc::c_char,
    pub ldapai_vendor_name: *mut libc::c_char,
    pub ldapai_vendor_version: libc::c_int,
}
pub type LDAP = ldap;
#[derive(Copy, Clone)]
#[repr(C)]
...
#[no_mangle]
pub unsafe extern "C" fn curl_version() -> *mut libc::c_char {
    static mut out: [libc::c_char; 300] = [0; 300];
    let mut outp: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut outlen: size_t = 0;
    let mut src: [*const libc::c_char; 17] = [0 as *const libc::c_char; 17];
    let mut ssl_version: [libc::c_char; 200] = [0; 200];
    let mut z_version: [libc::c_char; 40] = [0; 40];
    let mut psl_version: [libc::c_char; 40] = [0; 40];
    let mut h2_version: [libc::c_char; 40] = [0; 40];
    let mut gsasl_buf: [libc::c_char; 30] = [0; 30];
    let mut ldap_buf: [libc::c_char; 30] = [0; 30];
    let mut i: libc::c_int = 0 as libc::c_int;
    let mut j: libc::c_int = 0;
    let fresh0 = i;
    i = i + 1;
    src[fresh0 as usize] = b"libcurl/7.79.1\0" as *const u8 as *const libc::c_char;
    Curl_ssl_version(
        ssl_version.as_mut_ptr(),
        ::std::mem::size_of::<[libc::c_char; 200]>() as libc::c_ulong,
    );
    let fresh1 = i;
    i = i + 1;
    src[fresh1 as usize] = ssl_version.as_mut_ptr();
    curl_msnprintf(
        z_version.as_mut_ptr(),
        ::std::mem::size_of::<[libc::c_char; 40]>() as libc::c_ulong,
        b"zlib/%s\0" as *const u8 as *const libc::c_char,
        zlibVersion(),
    );
    let fresh2 = i;
    i = i + 1;
    src[fresh2 as usize] = z_version.as_mut_ptr();
    curl_msnprintf(
        psl_version.as_mut_ptr(),
        ::std::mem::size_of::<[libc::c_char; 40]>() as libc::c_ulong,
        b"libpsl/%s\0" as *const u8 as *const libc::c_char,
        psl_get_version(),
    );
    let fresh3 = i;
    i = i + 1;
    src[fresh3 as usize] = psl_version.as_mut_ptr();
    Curl_http2_ver(
        h2_version.as_mut_ptr(),
        ::std::mem::size_of::<[libc::c_char; 40]>() as libc::c_ulong,
    );
    let fresh4 = i;
    i = i + 1;
    src[fresh4 as usize] = h2_version.as_mut_ptr();
    curl_msnprintf(
        gsasl_buf.as_mut_ptr(),
        ::std::mem::size_of::<[libc::c_char; 30]>() as libc::c_ulong,
        b"libgsasl/%s\0" as *const u8 as *const libc::c_char,
        gsasl_check_version(0 as *const libc::c_char),
    );
    let fresh5 = i;
    i = i + 1;
    src[fresh5 as usize] = gsasl_buf.as_mut_ptr();
    let mut api: LDAPAPIInfo = LDAPAPIInfo {
        ldapai_info_version: 0,
        ldapai_api_version: 0,
        ldapai_protocol_version: 0,
        ldapai_extensions: 0 as *mut *mut libc::c_char,
        ldapai_vendor_name: 0 as *mut libc::c_char,
        ldapai_vendor_version: 0,
    };
    api.ldapai_info_version = 1 as libc::c_int;
    if ldap_get_option(
        0 as *mut LDAP,
        0 as libc::c_int,
        &mut api as *mut LDAPAPIInfo as *mut libc::c_void,
    ) == 0 as libc::c_int
    {
        let mut patch: libc::c_uint = (api.ldapai_vendor_version % 100 as libc::c_int)
            as libc::c_uint;
        let mut major: libc::c_uint = (api.ldapai_vendor_version / 10000 as libc::c_int)
            as libc::c_uint;
        let mut minor: libc::c_uint = (api.ldapai_vendor_version as libc::c_uint)
            .wrapping_sub(major.wrapping_mul(10000 as libc::c_int as libc::c_uint))
            .wrapping_sub(patch)
            .wrapping_div(100 as libc::c_int as libc::c_uint);
        curl_msnprintf(
            ldap_buf.as_mut_ptr(),
            ::std::mem::size_of::<[libc::c_char; 30]>() as libc::c_ulong,
            b"%s/%u.%u.%u\0" as *const u8 as *const libc::c_char,
        ...
        let fresh6 = i;
        i = i + 1;
        src[fresh6 as usize] = ldap_buf.as_mut_ptr();
        ldap_memfree(api.ldapai_vendor_name as *mut libc::c_void);
        ber_memvfree(api.ldapai_extensions as *mut *mut libc::c_void);
    }
    outp = &mut *out.as_mut_ptr().offset(0 as libc::c_int as isize) as *mut libc::c_char;
    outlen = ::std::mem::size_of::<[libc::c_char; 300]>() as libc::c_ulong;
    j = 0 as libc::c_int;
    while j < i {
        let mut n: size_t = strlen(src[j as usize]);
        if outlen <= n.wrapping_add(2 as libc::c_int as libc::c_ulong) {
            break;
        }
        if j != 0 {
            let fresh7 = outp;
        ...
        memcpy(outp as *mut libc::c_void, src[j as usize] as *const libc::c_void, n);
        outp = outp.offset(n as isize);
        outlen = (outlen as libc::c_ulong).wrapping_sub(n) as size_t as size_t;
        j += 1;
    }
    *outp = 0 as libc::c_int as libc::c_char;
    return out.as_mut_ptr();
}
static mut protocols: [*const libc::c_char; 23] = [
    ...
    b"gophers\0" as *const u8 as *const libc::c_char,
    ...
    b"imaps\0" as *const u8 as *const libc::c_char,
    b"ldap\0" as *const u8 as *const libc::c_char,
    b"ldaps\0" as *const u8 as *const libc::c_char,
    b"mqtt\0" as *const u8 as *const libc::c_char,
    b"pop3\0" as *const u8 as *const libc::c_char,
    b"pop3s\0" as *const u8 as *const libc::c_char,
    b"rtsp\0" as *const u8 as *const libc::c_char,
    b"smb\0" as *const u8 as *const libc::c_char,
    b"smbs\0" as *const u8 as *const libc::c_char,
    b"smtp\0" as *const u8 as *const libc::c_char,
    b"smtps\0" as *const u8 as *const libc::c_char,
    b"telnet\0" as *const u8 as *const libc::c_char,
    b"tftp\0" as *const u8 as *const libc::c_char,
    0 as *const libc::c_char,
];
static mut version_info: curl_version_info_data = unsafe {
    {
        let mut init = curl_version_info_data {
            age: CURLVERSION_TENTH,
            version: b"7.79.1\0" as *const u8 as *const libc::c_char,
            version_num: 0x74f01 as libc::c_int as libc::c_uint,
            host: b"x86_64-pc-linux-gnu\0" as *const u8 as *const libc::c_char,
            features: 0 as libc::c_int | (1 as libc::c_int) << 0 as libc::c_int
            ...
            ssl_version: 0 as *const libc::c_char,
            ssl_version_num: 0 as libc::c_int as libc::c_long,
            libz_version: 0 as *const libc::c_char,
            protocols: protocols.as_ptr(),
            ares: 0 as *const libc::c_char,
            ares_num: 0 as libc::c_int,
            libidn: 0 as *const libc::c_char,
            iconv_ver_num: 0 as libc::c_int,
            libssh_version: 0 as *const libc::c_char,
            brotli_ver_num: 0 as libc::c_int as libc::c_uint,
            brotli_version: 0 as *const libc::c_char,
            nghttp2_ver_num: 0 as libc::c_int as libc::c_uint,
            nghttp2_version: 0 as *const libc::c_char,
            quic_version: 0 as *const libc::c_char,
            cainfo: b"/etc/ssl/certs/ca-certificates.crt\0" as *const u8
                as *const libc::c_char,
            capath: 0 as *const libc::c_char,
            zstd_ver_num: 0 as libc::c_int as libc::c_uint,
            zstd_version: 0 as *const libc::c_char,
            hyper_version: 0 as *const libc::c_char,
            gsasl_version: 0 as *const libc::c_char,
        };
        init
    }
};
#[no_mangle]
pub unsafe extern "C" fn curl_version_info(
    mut stamp: CURLversion,
) -> *mut curl_version_info_data {
    static mut ssl_buffer: [libc::c_char; 80] = [0; 80];
    Curl_ssl_version(
        ssl_buffer.as_mut_ptr(),
        ::std::mem::size_of::<[libc::c_char; 80]>() as libc::c_ulong,
    );
    version_info.ssl_version = ssl_buffer.as_mut_ptr();
    if (*Curl_ssl).supports & ((1 as libc::c_int) << 4 as libc::c_int) as libc::c_uint
        != 0
    {
        version_info.features |= (1 as libc::c_int) << 21 as libc::c_int;
    } else {
        version_info.features &= !((1 as libc::c_int) << 21 as libc::c_int);
    }
    version_info.libz_version = zlibVersion();
    let mut h2: *mut nghttp2_info = nghttp2_version(0 as libc::c_int);
    version_info.nghttp2_ver_num = (*h2).version_num as libc::c_uint;
    version_info.nghttp2_version = (*h2).version_str;
    version_info.gsasl_version = gsasl_check_version(0 as *const libc::c_char);
    return &mut version_info;
}
