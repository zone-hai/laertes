...
extern "C" {
    ...
    fn Curl_auth_create_plain_message(
        authzid: *const libc::c_char,
        authcid: *const libc::c_char,
        passwd: *const libc::c_char,
        out: *mut bufref,
    ) -> CURLcode;
    fn Curl_auth_create_login_message(
        value: *const libc::c_char,
        out: *mut bufref,
    ) -> CURLcode;
    fn Curl_auth_create_external_message(
        user: *const libc::c_char,
        out: *mut bufref,
    ) -> CURLcode;
    fn Curl_auth_create_cram_md5_message(
        chlg: *const bufref,
    ...
    fn Curl_auth_create_digest_md5_message(
        data: *mut Curl_easy,
        chlg: *const bufref,
        userp: *const libc::c_char,
        passwdp: *const libc::c_char,
    ...
    fn Curl_auth_gsasl_is_supported(
        data: *mut Curl_easy,
        mech: *const libc::c_char,
        gsasl: *mut gsasldata,
    ) -> bool;
    fn Curl_auth_gsasl_start(
        data: *mut Curl_easy,
        userp: *const libc::c_char,
        passwdp: *const libc::c_char,
        gsasl: *mut gsasldata,
    ) -> CURLcode;
    fn Curl_auth_gsasl_token(
        data: *mut Curl_easy,
        chlg: *const bufref,
        gsasl: *mut gsasldata,
        out: *mut bufref,
    ) -> CURLcode;
    fn Curl_auth_gsasl_cleanup(digest: *mut gsasldata);
    ...
    fn Curl_auth_create_oauth_bearer_message(
        user: *const libc::c_char,
        host: *const libc::c_char,
        port: libc::c_long,
        bearer: *const libc::c_char,
        out: *mut bufref,
    ) -> CURLcode;
    fn Curl_auth_create_xoauth_bearer_message(
        user: *const libc::c_char,
        bearer: *const libc::c_char,
        out: *mut bufref,
    ) -> CURLcode;
...
static mut mechtable: [C2RustUnnamed_6; 12] = [
    {
        let mut init = C2RustUnnamed_6 {
            ...
            bit: ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_ushort,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_6 {
            ...
            len: 5 as libc::c_int as size_t,
            bit: ((1 as libc::c_int) << 1 as libc::c_int) as libc::c_ushort,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_6 {
            name: b"CRAM-MD5\0" as *const u8 as *const libc::c_char,
            len: 8 as libc::c_int as size_t,
            bit: ((1 as libc::c_int) << 2 as libc::c_int) as libc::c_ushort,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_6 {
            name: b"DIGEST-MD5\0" as *const u8 as *const libc::c_char,
            len: 10 as libc::c_int as size_t,
            bit: ((1 as libc::c_int) << 3 as libc::c_int) as libc::c_ushort,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_6 {
            name: b"GSSAPI\0" as *const u8 as *const libc::c_char,
            len: 6 as libc::c_int as size_t,
            bit: ((1 as libc::c_int) << 4 as libc::c_int) as libc::c_ushort,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_6 {
            name: b"EXTERNAL\0" as *const u8 as *const libc::c_char,
            len: 8 as libc::c_int as size_t,
            bit: ((1 as libc::c_int) << 5 as libc::c_int) as libc::c_ushort,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_6 {
            ...
            bit: ((1 as libc::c_int) << 6 as libc::c_int) as libc::c_ushort,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_6 {
            name: b"XOAUTH2\0" as *const u8 as *const libc::c_char,
            len: 7 as libc::c_int as size_t,
            bit: ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_ushort,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_6 {
            name: b"OAUTHBEARER\0" as *const u8 as *const libc::c_char,
            len: 11 as libc::c_int as size_t,
            bit: ((1 as libc::c_int) << 8 as libc::c_int) as libc::c_ushort,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_6 {
            name: b"SCRAM-SHA-1\0" as *const u8 as *const libc::c_char,
            len: 11 as libc::c_int as size_t,
            bit: ((1 as libc::c_int) << 9 as libc::c_int) as libc::c_ushort,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_6 {
            name: b"SCRAM-SHA-256\0" as *const u8 as *const libc::c_char,
            len: 13 as libc::c_int as size_t,
            bit: ((1 as libc::c_int) << 10 as libc::c_int) as libc::c_ushort,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_6 {
            ...
            bit: 0 as libc::c_int as libc::c_ushort,
        };
        init
    },
];
...
pub unsafe extern "C" fn Curl_sasl_cleanup(
    ...
    if authused == ((1 as libc::c_int) << 6 as libc::c_int) as libc::c_uint {
...
pub unsafe extern "C" fn Curl_sasl_decode_mech(
    ...
    while !(mechtable[i as usize].name).is_null() {
            ...
            ) == 0
        {
            ...
            if Curl_isupper(c as libc::c_uchar as libc::c_int) == 0
                && Curl_isdigit(c as libc::c_uchar as libc::c_int) == 0
...
pub unsafe extern "C" fn Curl_sasl_parse_url_auth_option(
    ...
    if (*sasl).resetprefs {
        (*sasl).resetprefs = 0 as libc::c_int != 0;
        (*sasl).prefmech = 0 as libc::c_int as libc::c_ushort;
    }
    if strncmp(value, b"*\0" as *const u8 as *const libc::c_char, len) == 0 {
        (*sasl)
            .prefmech = (0xffff as libc::c_int
            & !((1 as libc::c_int) << 5 as libc::c_int)) as libc::c_ushort;
    } else {
        let mut mechbit: libc::c_ushort = Curl_sasl_decode_mech(
            value,
            len,
            &mut mechlen,
        );
        if mechbit as libc::c_int != 0 && mechlen == len {
            let ref mut fresh0 = (*sasl).prefmech;
            *fresh0 = (*fresh0 as libc::c_int | mechbit as libc::c_int)
                as libc::c_ushort;
        } else {
...
pub unsafe extern "C" fn Curl_sasl_init(
    ...
    *fresh1 = params;
    ...
    (*sasl).authmechs = 0 as libc::c_int as libc::c_ushort;
    (*sasl)
        .prefmech = (0xffff as libc::c_int & !((1 as libc::c_int) << 5 as libc::c_int))
        as libc::c_ushort;
    (*sasl).authused = 0 as libc::c_int as libc::c_ushort;
    (*sasl).resetprefs = 1 as libc::c_int != 0;
    (*sasl).mutual_auth = 0 as libc::c_int != 0;
    (*sasl).force_ir = 0 as libc::c_int != 0;
}
...
unsafe extern "C" fn get_server_message(
    ...
    let mut msg: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut msglen: size_t = 0;
    let mut serverdata: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut result: CURLcode = CURLE_OK;
    ((*(*sasl).params).getmessage)
        .expect("non-null function pointer")((*data).state.buffer, &mut serverdata);
    if serverdata.is_null() {
        result = CURLE_BAD_CONTENT_ENCODING;
    } else if *serverdata == 0 || *serverdata as libc::c_int == '=' as i32 {
        Curl_bufref_set(out, 0 as *const libc::c_void, 0 as libc::c_int as size_t, None);
    } else {
...
unsafe extern "C" fn build_message(
    ...
    if (Curl_bufref_ptr(msg)).is_null() {
        ...
        result = Curl_base64_encode(
            data,
            Curl_bufref_ptr(msg) as *const libc::c_char,
            Curl_bufref_len(msg),
            &mut base64,
            &mut base64len,
        );
...
pub unsafe extern "C" fn Curl_sasl_can_authenticate(
    ...
    if (*sasl).authmechs as libc::c_int & (*sasl).prefmech as libc::c_int
...
pub unsafe extern "C" fn Curl_sasl_start(
    ...
    let mut result: CURLcode = CURLE_OK;
    let mut enabledmechs: libc::c_uint = 0;
    let mut mech: *const libc::c_char = 0 as *const libc::c_char;
    ...
    let mut service: *const libc::c_char = if !((*data)
        .set
        .str_0[STRING_SERVICE_NAME as libc::c_int as usize])
        .is_null()
    {
    ...
    let mut oauth_bearer: *const libc::c_char = (*data)
        .set
        .str_0[STRING_BEARER as libc::c_int as usize];
    ...
    (*sasl).authused = 0 as libc::c_int as libc::c_ushort;
    enabledmechs = ((*sasl).authmechs as libc::c_int & (*sasl).prefmech as libc::c_int)
        as libc::c_uint;
    *progress = SASL_IDLE;
    if enabledmechs & ((1 as libc::c_int) << 5 as libc::c_int) as libc::c_uint != 0
        && *((*conn).passwd).offset(0 as libc::c_int as isize) == 0
    {
        mech = b"EXTERNAL\0" as *const u8 as *const libc::c_char;
        state1 = SASL_EXTERNAL;
        (*sasl).authused = ((1 as libc::c_int) << 5 as libc::c_int) as libc::c_ushort;
        if force_ir as libc::c_int != 0 || ((*data).set).sasl_ir() as libc::c_int != 0 {
            result = Curl_auth_create_external_message((*conn).user, &mut resp);
        }
    } else if ((*conn).bits).user_passwd() != 0 {
        if enabledmechs & ((1 as libc::c_int) << 10 as libc::c_int) as libc::c_uint != 0
            && Curl_auth_gsasl_is_supported(
                data,
                b"SCRAM-SHA-256\0" as *const u8 as *const libc::c_char,
                &mut (*conn).gsasl,
            ) as libc::c_int != 0
        {
            mech = b"SCRAM-SHA-256\0" as *const u8 as *const libc::c_char;
            (*sasl)
                .authused = ((1 as libc::c_int) << 10 as libc::c_int) as libc::c_ushort;
            state1 = SASL_GSASL;
            state2 = SASL_GSASL;
            ...
            if result as libc::c_uint == CURLE_OK as libc::c_int as libc::c_uint
                && (force_ir as libc::c_int != 0
                    || ((*data).set).sasl_ir() as libc::c_int != 0)
            {
        ...
        } else if enabledmechs & ((1 as libc::c_int) << 9 as libc::c_int) as libc::c_uint
                != 0
                && Curl_auth_gsasl_is_supported(
                    data,
                    b"SCRAM-SHA-1\0" as *const u8 as *const libc::c_char,
                    &mut (*conn).gsasl,
                ) as libc::c_int != 0
            {
            mech = b"SCRAM-SHA-1\0" as *const u8 as *const libc::c_char;
            (*sasl)
                .authused = ((1 as libc::c_int) << 9 as libc::c_int) as libc::c_ushort;
            state1 = SASL_GSASL;
            state2 = SASL_GSASL;
            result = Curl_auth_gsasl_start(
                data,
        ...
        } else if enabledmechs & ((1 as libc::c_int) << 3 as libc::c_int) as libc::c_uint
                != 0 && Curl_auth_is_digest_supported() as libc::c_int != 0
            {
            mech = b"DIGEST-MD5\0" as *const u8 as *const libc::c_char;
            state1 = SASL_DIGESTMD5;
            (*sasl)
                .authused = ((1 as libc::c_int) << 3 as libc::c_int) as libc::c_ushort;
        } else if enabledmechs & ((1 as libc::c_int) << 2 as libc::c_int) as libc::c_uint
                != 0
            {
            mech = b"CRAM-MD5\0" as *const u8 as *const libc::c_char;
            state1 = SASL_CRAMMD5;
            (*sasl)
                .authused = ((1 as libc::c_int) << 2 as libc::c_int) as libc::c_ushort;
        } else if enabledmechs & ((1 as libc::c_int) << 6 as libc::c_int) as libc::c_uint
                != 0 && Curl_auth_is_ntlm_supported() as libc::c_int != 0
            {
            mech = b"NTLM\0" as *const u8 as *const libc::c_char;
            state1 = SASL_NTLM;
            state2 = SASL_NTLM_TYPE2MSG;
            (*sasl)
                .authused = ((1 as libc::c_int) << 6 as libc::c_int) as libc::c_ushort;
            if force_ir as libc::c_int != 0
                || ((*data).set).sasl_ir() as libc::c_int != 0
            {
        ...
        } else if enabledmechs & ((1 as libc::c_int) << 8 as libc::c_int) as libc::c_uint
                != 0 && !oauth_bearer.is_null()
            {
            mech = b"OAUTHBEARER\0" as *const u8 as *const libc::c_char;
            state1 = SASL_OAUTH2;
            state2 = SASL_OAUTH2_RESP;
            (*sasl)
                .authused = ((1 as libc::c_int) << 8 as libc::c_int) as libc::c_ushort;
            if force_ir as libc::c_int != 0
                || ((*data).set).sasl_ir() as libc::c_int != 0
            {
        ...
        } else if enabledmechs & ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint
                != 0 && !oauth_bearer.is_null()
            {
            mech = b"XOAUTH2\0" as *const u8 as *const libc::c_char;
            state1 = SASL_OAUTH2;
            (*sasl)
                .authused = ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_ushort;
            if force_ir as libc::c_int != 0
                || ((*data).set).sasl_ir() as libc::c_int != 0
            {
        ...
        } else if enabledmechs & ((1 as libc::c_int) << 1 as libc::c_int) as libc::c_uint
                != 0
            {
            mech = b"PLAIN\0" as *const u8 as *const libc::c_char;
            state1 = SASL_PLAIN;
            (*sasl)
                .authused = ((1 as libc::c_int) << 1 as libc::c_int) as libc::c_ushort;
            if force_ir as libc::c_int != 0
                || ((*data).set).sasl_ir() as libc::c_int != 0
            {
        ...
        } else if enabledmechs & ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint
                != 0
            {
            mech = b"LOGIN\0" as *const u8 as *const libc::c_char;
            state1 = SASL_LOGIN;
            state2 = SASL_LOGIN_PASSWD;
            (*sasl)
                .authused = ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_ushort;
            if force_ir as libc::c_int != 0
                || ((*data).set).sasl_ir() as libc::c_int != 0
            {
    ...
    if result as u64 == 0 && !mech.is_null() {
        ...
        if result as u64 == 0 {
            result = ((*(*sasl).params).sendauth)
                ...
                )(data, conn, mech, Curl_bufref_ptr(&mut resp) as *const libc::c_char);
        }
        if result as u64 == 0 {
            *progress = SASL_INPROGRESS;
            state(
                ...
                data,
                (if !(Curl_bufref_ptr(&mut resp)).is_null() {
                    state2 as libc::c_uint
                } else {
                    state1 as libc::c_uint
                }) as saslstate,
            );
        }
    }
...
pub unsafe extern "C" fn Curl_sasl_continue(
    ...
    Curl_bufref_init(&mut resp);
    *progress = SASL_INPROGRESS;
    if (*sasl).state as libc::c_uint == SASL_FINAL as libc::c_int as libc::c_uint {
    ...
    if (*sasl).state as libc::c_uint != SASL_CANCEL as libc::c_int as libc::c_uint
        && (*sasl).state as libc::c_uint
            != SASL_OAUTH2_RESP as libc::c_int as libc::c_uint
    ...
    match (*sasl).state as libc::c_uint {
        0 => {
            *progress = SASL_DONE;
            return result;
        }
        ...
        15 => {
            ...
            if result as u64 == 0
                && Curl_bufref_len(&mut resp) > 0 as libc::c_int as libc::c_ulong
            {
                newstate = SASL_GSASL;
            }
        }
        ...
        13 => {
            if (*sasl).authused as libc::c_int == (1 as libc::c_int) << 8 as libc::c_int
            {
                result = Curl_auth_create_oauth_bearer_message(
                    (*conn).user,
                    hostname,
        ...
        16 => {
            ...
            *fresh2 = (*fresh2 as libc::c_int ^ (*sasl).authused as libc::c_int)
                as libc::c_ushort;
    ...
    match result as libc::c_uint {
        61 => {
            result = ((*(*sasl).params).sendcont)
                .expect(
                    "non-null function pointer",
                )(data, conn, b"*\0" as *const u8 as *const libc::c_char);
        ...
        0 => {
            ...
            if result as u64 == 0 {
                result = ((*(*sasl).params).sendcont)
                    .expect(
                        "non-null function pointer",
                    )(data, conn, Curl_bufref_ptr(&mut resp) as *const libc::c_char);
            }
        }
        _ => {
            newstate = SASL_STOP;
