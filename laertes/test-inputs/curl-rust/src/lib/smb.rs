...
extern "C" {
    ...
    fn Curl_ntlm_core_mk_lm_hash(
        ...
        lmbuffer: *mut libc::c_uchar,
    ) -> CURLcode;
    fn Curl_ntlm_core_mk_nt_hash(
        data: *mut Curl_easy,
        password: *const libc::c_char,
        ntbuffer: *mut libc::c_uchar,
    ) -> CURLcode;
    fn Curl_ntlm_core_lm_resp(
        keys: *const libc::c_uchar,
        plaintext: *const libc::c_uchar,
        results: *mut libc::c_uchar,
    );
    fn Curl_urldecode(
        data: *mut Curl_easy,
    ...
    fn Curl_read16_le(buf: *const libc::c_uchar) -> libc::c_ushort;
    fn Curl_read16_be(buf: *const libc::c_uchar) -> libc::c_ushort;
...
pub struct smb_request {
    ...
    pub path: *mut libc::c_char,
    pub tid: libc::c_ushort,
    pub fid: libc::c_ushort,
    pub result: CURLcode,
}
pub type smb_req_state = libc::c_uint;
...
pub struct smb_header {
    pub nbt_type: libc::c_uchar,
    pub nbt_flags: libc::c_uchar,
    pub nbt_length: libc::c_ushort,
    pub magic: [libc::c_uchar; 4],
    pub command: libc::c_uchar,
    pub status: libc::c_uint,
    pub flags: libc::c_uchar,
    pub flags2: libc::c_ushort,
    pub pid_high: libc::c_ushort,
    pub signature: [libc::c_uchar; 8],
    pub pad: libc::c_ushort,
    pub tid: libc::c_ushort,
    pub pid: libc::c_ushort,
    pub uid: libc::c_ushort,
    pub mid: libc::c_ushort,
}
#[derive(Copy, Clone)]
#[repr(C, packed)]
pub struct smb_negotiate_response {
    pub h: smb_header,
    pub word_count: libc::c_uchar,
    pub dialect_index: libc::c_ushort,
    pub security_mode: libc::c_uchar,
    pub max_mpx_count: libc::c_ushort,
    pub max_number_vcs: libc::c_ushort,
    pub max_buffer_size: libc::c_uint,
    pub max_raw_size: libc::c_uint,
    pub session_key: libc::c_uint,
    pub capabilities: libc::c_uint,
    pub system_time_low: libc::c_uint,
    pub system_time_high: libc::c_uint,
    pub server_time_zone: libc::c_ushort,
    pub encryption_key_length: libc::c_uchar,
    pub byte_count: libc::c_ushort,
...
pub struct smb_setup {
    pub word_count: libc::c_uchar,
    pub andx: andx,
    pub max_buffer_size: libc::c_ushort,
    pub max_mpx_count: libc::c_ushort,
    pub vc_number: libc::c_ushort,
    pub session_key: libc::c_uint,
    pub lengths: [libc::c_ushort; 2],
    pub pad: libc::c_uint,
    pub capabilities: libc::c_uint,
    pub byte_count: libc::c_ushort,
...
pub struct smb_nt_create {
    ...
    pub andx: andx,
    pub pad: libc::c_uchar,
    pub name_length: libc::c_ushort,
    pub flags: libc::c_uint,
    pub root_fid: libc::c_uint,
    pub access: libc::c_uint,
    pub allocation_size: curl_off_t,
    pub ext_file_attributes: libc::c_uint,
    pub share_access: libc::c_uint,
    pub create_disposition: libc::c_uint,
    pub create_options: libc::c_uint,
    pub impersonation_level: libc::c_uint,
    pub security_flags: libc::c_uchar,
    pub byte_count: libc::c_ushort,
    pub bytes: [libc::c_char; 1024],
}
#[derive(Copy, Clone)]
...
pub struct smb_nt_create_response {
    ...
    pub word_count: libc::c_uchar,
    pub andx: andx,
    pub op_lock_level: libc::c_uchar,
    pub fid: libc::c_ushort,
    pub create_disposition: libc::c_uint,
...
pub struct smb_read {
    ...
    pub max_bytes: libc::c_ushort,
    pub min_bytes: libc::c_ushort,
    pub timeout: libc::c_uint,
    pub remaining: libc::c_ushort,
    pub offset_high: libc::c_uint,
    pub byte_count: libc::c_ushort,
}
#[derive(Copy, Clone)]
#[repr(C, packed)]
pub struct smb_write {
    ...
    pub offset: libc::c_uint,
    pub timeout: libc::c_uint,
    pub write_mode: libc::c_ushort,
    pub remaining: libc::c_ushort,
    pub pad: libc::c_ushort,
    pub data_length: libc::c_ushort,
    pub data_offset: libc::c_ushort,
    pub offset_high: libc::c_uint,
    pub byte_count: libc::c_ushort,
...
pub static mut Curl_handler_smb: Curl_handler = unsafe {
    {
        let mut init = Curl_handler {
            scheme: b"SMB\0" as *const u8 as *const libc::c_char,
            ...
            attach: None,
            defport: 445 as libc::c_int,
            protocol: ((1 as libc::c_int) << 26 as libc::c_int) as libc::c_uint,
            family: ((1 as libc::c_int) << 26 as libc::c_int) as libc::c_uint,
...
pub static mut Curl_handler_smbs: Curl_handler = unsafe {
    {
        let mut init = Curl_handler {
            scheme: b"SMBS\0" as *const u8 as *const libc::c_char,
            setup_connection: Some(
                smb_setup_connection
                    as unsafe extern "C" fn(*mut Curl_easy, *mut connectdata) -> CURLcode,
            ),
            ...
            attach: None,
            defport: 445 as libc::c_int,
            protocol: ((1 as libc::c_int) << 27 as libc::c_int) as libc::c_uint,
            family: ((1 as libc::c_int) << 26 as libc::c_int) as libc::c_uint,
...
unsafe extern "C" fn smb_setup_connection(
    ...
    req = Curl_ccalloc
        ...
        ::std::mem::size_of::<smb_request>() as libc::c_ulong,
    ) as *mut smb_request;
...
unsafe extern "C" fn smb_connect(
    ...
    *fresh1 = Curl_cmalloc
        .expect(
            "non-null function pointer",
        )((0x8000 as libc::c_int + 0x1000 as libc::c_int) as size_t)
        as *mut libc::c_char;
    ...
    if !slash.is_null() {
        ...
        *fresh2 = slash.offset(1 as libc::c_int as isize);
        ...
        *((*smbc).domain)
            .offset(
                slash.offset_from((*conn).user) as libc::c_long as isize,
...
unsafe extern "C" fn smb_recv_message(
    ...
    let mut conn: *mut connectdata = (*data).conn;
    let mut smbc: *mut smb_conn = &mut (*conn).proto.smbc;
    let mut buf: *mut libc::c_char = (*smbc).recv_buf;
    let mut bytes_read: ssize_t = 0;
    let mut nbt_size: size_t = 0;
    let mut msg_size: size_t = 0;
    let mut len: size_t = ((0x8000 as libc::c_int + 0x1000 as libc::c_int)
        as libc::c_ulong)
    ...
    *fresh6 = (*fresh6 as libc::c_ulong).wrapping_add(bytes_read as libc::c_ulong)
        as size_t as size_t;
    if (*smbc).got < ::std::mem::size_of::<libc::c_uint>() as libc::c_ulong {
        return CURLE_OK;
    }
    nbt_size = (Curl_read16_be(
        buf.offset(::std::mem::size_of::<libc::c_ushort>() as libc::c_ulong as isize)
    ...
    msg_size = ::std::mem::size_of::<smb_header>() as libc::c_ulong;
    if nbt_size >= msg_size.wrapping_add(1 as libc::c_int as libc::c_ulong) {
        msg_size = (msg_size as libc::c_ulong)
            .wrapping_add(
                (1 as libc::c_int as libc::c_ulong)
                    .wrapping_add(
                        (*buf.offset(msg_size as isize) as libc::c_uchar
                            as libc::c_ulong)
                            .wrapping_mul(
            ...
            msg_size = (msg_size as libc::c_ulong)
                .wrapping_add(
                    (::std::mem::size_of::<libc::c_ushort>() as libc::c_ulong)
                        .wrapping_add(
                            Curl_read16_le(
                                &mut *buf.offset(msg_size as isize) as *mut libc::c_char
                                    as *const libc::c_uchar,
                            ) as libc::c_ulong,
                        ),
                ) as size_t as size_t;
...
unsafe extern "C" fn smb_pop_message(mut conn: *mut connectdata) {
    let mut smbc: *mut smb_conn = &mut (*conn).proto.smbc;
    (*smbc).got = 0 as libc::c_int as size_t;
}
unsafe extern "C" fn smb_format_message(
    ...
    memset(
        ...
        0 as libc::c_int,
        ::std::mem::size_of::<smb_header>() as libc::c_ulong,
    );
    (*h)
        .nbt_length = __bswap_16(
        (::std::mem::size_of::<smb_header>() as libc::c_ulong)
            .wrapping_sub(::std::mem::size_of::<libc::c_uint>() as libc::c_ulong)
            .wrapping_add(len) as libc::c_ushort,
    );
    memcpy(
        ((*h).magic).as_mut_ptr() as *mut libc::c_char as *mut libc::c_void,
        b"\xFFSMB\0" as *const u8 as *const libc::c_char as *const libc::c_void,
        4 as libc::c_int as libc::c_ulong,
    );
    (*h).command = cmd;
    (*h).flags = (0x10 as libc::c_int | 0x8 as libc::c_int) as libc::c_uchar;
    (*h).flags2 = (0x40 as libc::c_int | 0x1 as libc::c_int) as libc::c_ushort;
    (*h).uid = (*smbc).uid;
    (*h).tid = (*req).tid;
    pid = getpid() as libc::c_uint;
    (*h).pid_high = (pid >> 16 as libc::c_int) as libc::c_ushort;
    (*h).pid = pid as libc::c_ushort;
}
...
unsafe extern "C" fn smb_flush(mut data: *mut Curl_easy) -> CURLcode {
    ...
    if bytes_written != len {
        ...
        *fresh7 = (*fresh7 as libc::c_ulong).wrapping_add(bytes_written as libc::c_ulong)
            as size_t as size_t;
    } else {
        (*smbc).send_size = 0 as libc::c_int as size_t;
    }
    return CURLE_OK;
}
unsafe extern "C" fn smb_send_message(
    ...
    memcpy(
        ((*data).state.ulbuf)
            .offset(::std::mem::size_of::<smb_header>() as libc::c_ulong as isize)
            as *mut libc::c_void,
        msg,
        msg_len,
    );
    return smb_send(
        data,
        (::std::mem::size_of::<smb_header>() as libc::c_ulong).wrapping_add(msg_len)
            as ssize_t,
        0 as libc::c_int as size_t,
    );
}
unsafe extern "C" fn smb_send_negotiate(mut data: *mut Curl_easy) -> CURLcode {
    let mut msg: *const libc::c_char = b"\0\x0C\0\x02NT LM 0.12\0" as *const u8
...
unsafe extern "C" fn smb_send_setup(mut data: *mut Curl_easy) -> CURLcode {
    ...
    let mut p: *mut libc::c_char = (msg.bytes).as_mut_ptr();
    let mut lm_hash: [libc::c_uchar; 21] = [0; 21];
    let mut lm: [libc::c_uchar; 24] = [0; 24];
    let mut nt_hash: [libc::c_uchar; 21] = [0; 21];
    let mut nt: [libc::c_uchar; 24] = [0; 24];
    let mut byte_count: size_t = (::std::mem::size_of::<[libc::c_uchar; 24]>()
        as libc::c_ulong)
        .wrapping_add(::std::mem::size_of::<[libc::c_uchar; 24]>() as libc::c_ulong);
    byte_count = (byte_count as libc::c_ulong)
        .wrapping_add((strlen((*smbc).user)).wrapping_add(strlen((*smbc).domain)))
        as size_t as size_t;
    byte_count = (byte_count as libc::c_ulong)
        .wrapping_add(
            (strlen(b"x86_64-pc-linux-gnu\0" as *const u8 as *const libc::c_char))
                .wrapping_add(strlen(b"curl\0" as *const u8 as *const libc::c_char))
                .wrapping_add(4 as libc::c_int as libc::c_ulong),
        ) as size_t as size_t;
    if byte_count > ::std::mem::size_of::<[libc::c_char; 1024]>() as libc::c_ulong {
    ...
    memset(
        ...
        0 as libc::c_int,
        ::std::mem::size_of::<smb_setup>() as libc::c_ulong,
    );
    msg.word_count = 0xd as libc::c_int as libc::c_uchar;
    msg.andx.command = 0xff as libc::c_int as libc::c_uchar;
    msg
        .max_buffer_size = (0x8000 as libc::c_int + 0x1000 as libc::c_int)
        as libc::c_ushort;
    msg.max_mpx_count = 1 as libc::c_int as libc::c_ushort;
    msg.vc_number = 1 as libc::c_int as libc::c_ushort;
    msg.session_key = (*smbc).session_key;
    msg.capabilities = 0x8 as libc::c_int as libc::c_uint;
    msg
        .lengths[0 as libc::c_int
        as usize] = ::std::mem::size_of::<[libc::c_uchar; 24]>() as libc::c_ulong
        as libc::c_ushort;
    msg
    ...
    p = p.offset(::std::mem::size_of::<[libc::c_uchar; 24]>() as libc::c_ulong as isize);
    memcpy(
        p as *mut libc::c_void,
    ...
    p = p
        .offset(
            (strlen((*smbc).user)).wrapping_add(1 as libc::c_int as libc::c_ulong)
                as isize,
        );
    strcpy(p, (*smbc).domain);
    p = p
        .offset(
            (strlen((*smbc).domain)).wrapping_add(1 as libc::c_int as libc::c_ulong)
                as isize,
        );
    strcpy(p, b"x86_64-pc-linux-gnu\0" as *const u8 as *const libc::c_char);
    p = p
        .offset(
            (strlen(b"x86_64-pc-linux-gnu\0" as *const u8 as *const libc::c_char))
                .wrapping_add(1 as libc::c_int as libc::c_ulong) as isize,
        );
    strcpy(p, b"curl\0" as *const u8 as *const libc::c_char);
    p = p
        .offset(
            (strlen(b"curl\0" as *const u8 as *const libc::c_char))
                .wrapping_add(1 as libc::c_int as libc::c_ulong) as isize,
        );
    byte_count = p.offset_from((msg.bytes).as_mut_ptr()) as libc::c_long as size_t;
    msg.byte_count = byte_count as libc::c_ushort;
    return smb_send_message(
        data,
        0x73 as libc::c_int as libc::c_uchar,
        &mut msg as *mut smb_setup as *const libc::c_void,
        (::std::mem::size_of::<smb_setup>() as libc::c_ulong)
            .wrapping_sub(::std::mem::size_of::<[libc::c_char; 1024]>() as libc::c_ulong)
...
unsafe extern "C" fn smb_send_tree_connect(mut data: *mut Curl_easy) -> CURLcode {
    ...
    memset(
        ...
        0 as libc::c_int,
        ::std::mem::size_of::<smb_tree_connect>() as libc::c_ulong,
    );
    msg.word_count = 0x4 as libc::c_int as libc::c_uchar;
    msg.andx.command = 0xff as libc::c_int as libc::c_uchar;
    msg.pw_len = 0 as libc::c_int as libc::c_ushort;
    strcpy(p, b"\\\\\0" as *const u8 as *const libc::c_char);
    p = p.offset(strlen(b"\\\\\0" as *const u8 as *const libc::c_char) as isize);
    ...
    p = p
        .offset(
            (strlen((*smbc).share)).wrapping_add(1 as libc::c_int as libc::c_ulong)
                as isize,
        );
    strcpy(p, b"?????\0" as *const u8 as *const libc::c_char);
    p = p
...
unsafe extern "C" fn smb_send_open(mut data: *mut Curl_easy) -> CURLcode {
    ...
    if (strlen((*req).path)).wrapping_add(1 as libc::c_int as libc::c_ulong)
    ...
    memset(
        ...
        0 as libc::c_int,
        ::std::mem::size_of::<smb_nt_create>() as libc::c_ulong,
    );
    msg.word_count = 0x18 as libc::c_int as libc::c_uchar;
    msg.andx.command = 0xff as libc::c_int as libc::c_uchar;
    byte_count = strlen((*req).path);
    msg.name_length = byte_count as libc::c_ushort;
    msg.share_access = 0x7 as libc::c_int as libc::c_uint;
    if ((*data).set).upload() != 0 {
        msg
            .access = 0x80000000 as libc::c_uint
            | 0x40000000 as libc::c_int as libc::c_uint;
        msg.create_disposition = 0x5 as libc::c_int as libc::c_uint;
    } else {
        msg.access = 0x80000000 as libc::c_uint;
        msg.create_disposition = 0x1 as libc::c_int as libc::c_uint;
    }
...
unsafe extern "C" fn smb_send_close(mut data: *mut Curl_easy) -> CURLcode {
    ...
    memset(
        ...
        0 as libc::c_int,
        ::std::mem::size_of::<smb_close>() as libc::c_ulong,
    );
    msg.word_count = 0x3 as libc::c_int as libc::c_uchar;
    msg.fid = (*req).fid;
    return smb_send_message(
        data,
...
unsafe extern "C" fn smb_send_tree_disconnect(mut data: *mut Curl_easy) -> CURLcode {
    ...
    memset(
        ...
        0 as libc::c_int,
        ::std::mem::size_of::<smb_tree_disconnect>() as libc::c_ulong,
    );
    return smb_send_message(
        data,
...
unsafe extern "C" fn smb_send_read(mut data: *mut Curl_easy) -> CURLcode {
    ...
    memset(
        ...
        0 as libc::c_int,
        ::std::mem::size_of::<smb_read>() as libc::c_ulong,
    );
    msg.word_count = 0xc as libc::c_int as libc::c_uchar;
    msg.andx.command = 0xff as libc::c_int as libc::c_uchar;
    msg.fid = (*req).fid;
    msg.offset = offset as libc::c_uint;
    msg.offset_high = (offset >> 32 as libc::c_int) as libc::c_uint;
    msg.min_bytes = 0x8000 as libc::c_int as libc::c_ushort;
    msg.max_bytes = 0x8000 as libc::c_int as libc::c_ushort;
    return smb_send_message(
        data,
...
unsafe extern "C" fn smb_send_write(mut data: *mut Curl_easy) -> CURLcode {
    ...
    if upload_size >= (0x8000 as libc::c_int - 1 as libc::c_int) as libc::c_long {
        upload_size = (0x8000 as libc::c_int - 1 as libc::c_int) as curl_off_t;
    }
    memset(
        msg as *mut libc::c_void,
        0 as libc::c_int,
        ::std::mem::size_of::<smb_write>() as libc::c_ulong,
    );
    (*msg).word_count = 0xe as libc::c_int as libc::c_uchar;
    (*msg).andx.command = 0xff as libc::c_int as libc::c_uchar;
    (*msg).fid = (*req).fid;
    (*msg).offset = offset as libc::c_uint;
    (*msg).offset_high = (offset >> 32 as libc::c_int) as libc::c_uint;
    (*msg).data_length = upload_size as libc::c_ushort;
    (*msg)
        .data_offset = (::std::mem::size_of::<smb_write>() as libc::c_ulong)
        .wrapping_sub(::std::mem::size_of::<libc::c_uint>() as libc::c_ulong)
        as libc::c_ushort;
    (*msg)
        .byte_count = (upload_size + 1 as libc::c_int as libc::c_long) as libc::c_ushort;
    smb_format_message(
        data,
        &mut (*msg).h,
        0x2f as libc::c_int as libc::c_uchar,
        (::std::mem::size_of::<smb_write>() as libc::c_ulong)
            .wrapping_sub(::std::mem::size_of::<smb_header>() as libc::c_ulong)
            .wrapping_add(upload_size as size_t),
    );
    return smb_send(
        data,
        ::std::mem::size_of::<smb_write>() as libc::c_ulong as ssize_t,
    ...
    if (*smbc).send_size == 0 && (*smbc).upload_size != 0 {
        ...
        *fresh8 = (*data).state.ulbuf;
        ...
        if result as libc::c_uint != 0
            && result as libc::c_uint != CURLE_AGAIN as libc::c_int as libc::c_uint
        {
            return result;
        }
        if nread == 0 {
        ...
        *fresh9 = (*fresh9 as libc::c_ulong).wrapping_sub(nread) as size_t as size_t;
        (*smbc).send_size = nread;
        (*smbc).sent = 0 as libc::c_int as size_t;
    }
    if (*smbc).send_size != 0 {
...
unsafe extern "C" fn smb_connection_state(
    ...
    if (*smbc).state as libc::c_uint == SMB_CONNECTING as libc::c_int as libc::c_uint {
        if (*(*conn).handler).flags
            & ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint != 0
        {
            let mut ssl_done: bool = 0 as libc::c_int != 0;
    ...
    match (*smbc).state as libc::c_uint {
        2 => {
            if (*smbc).got
                < (::std::mem::size_of::<smb_negotiate_response>() as libc::c_ulong)
                    .wrapping_add(
                        ::std::mem::size_of::<[libc::c_uchar; 8]>() as libc::c_ulong,
                    )
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) || (*h).status != 0
            {
                Curl_conncontrol(conn, 1 as libc::c_int);
...
unsafe extern "C" fn get_posix_time(mut out: *mut time_t, mut timestamp: curl_off_t) {
    timestamp -= 116444736000000000 as libc::c_long;
    timestamp /= 10000000 as libc::c_int as libc::c_long;
    *out = timestamp;
}
unsafe extern "C" fn smb_request_state(
    ...
    let mut off: libc::c_ushort = 0;
    let mut result: CURLcode = CURLE_OK;
    let mut msg: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut smb_m: *const smb_nt_create_response = 0 as *const smb_nt_create_response;
    if (*req).state as libc::c_uint == SMB_REQUESTING as libc::c_int as libc::c_uint {
    ...
    match (*req).state as libc::c_uint {
        1 => {
            if (*h).status != 0 {
                (*req).result = CURLE_REMOTE_FILE_NOT_FOUND;
                if (*h).status == 0x50001 as libc::c_int as libc::c_uint {
        ...
        2 => {
            if (*h).status != 0
                || (*smbc).got
                    < ::std::mem::size_of::<smb_nt_create_response>() as libc::c_ulong
            {
                (*req).result = CURLE_REMOTE_FILE_NOT_FOUND;
                if (*h).status == 0x50001 as libc::c_int as libc::c_uint {
                    (*req).result = CURLE_REMOTE_ACCESS_DENIED;
                ...
                (*req).fid = (*smb_m).fid;
                (*data).req.offset = 0 as libc::c_int as curl_off_t;
                if ((*data).set).upload() != 0 {
                    ...
                    if (*data).req.size < 0 as libc::c_int as libc::c_long {
                        ...
                        .wrapping_add(14 as libc::c_int as libc::c_ulong)
            {
                ...
                len = Curl_read16_le(
                    (msg as *const libc::c_uchar)
                        .offset(
                            ::std::mem::size_of::<smb_header>() as libc::c_ulong as isize,
                        )
                ...
                if len as libc::c_int > 0 as libc::c_int {
                    if (off as libc::c_ulong)
                        .wrapping_add(
                            ::std::mem::size_of::<libc::c_uint>() as libc::c_ulong,
                        )
                        .wrapping_add(len as libc::c_ulong) > (*smbc).got
                    {
                        Curl_failf(
                            data,
                            b"Invalid input packet\0" as *const u8 as *const libc::c_char,
                        );
                ...
                match current_block_72 {
                    ...
                    _ => {
                        ...
                        *fresh10 += len as libc::c_long;
                        let ref mut fresh11 = (*data).req.offset;
                        *fresh11 += len as libc::c_long;
                        Curl_pgrsSetDownloadCounter(data, (*data).req.bytecount);
                        next_state = (if (len as libc::c_int) < 0x8000 as libc::c_int {
                            SMB_CLOSE as libc::c_int
                        } else {
                            SMB_DOWNLOAD as libc::c_int
                        }) as smb_req_state;
                    }
                }
            }
        ...
        4 => {
                        ...
                        .wrapping_add(6 as libc::c_int as libc::c_ulong)
            {
                ...
                *fresh12 += len as libc::c_long;
                let ref mut fresh13 = (*data).req.offset;
                *fresh13 += len as libc::c_long;
