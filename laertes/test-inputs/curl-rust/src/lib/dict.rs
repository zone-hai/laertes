...
#[no_mangle]
pub static mut Curl_handler_dict: Curl_handler = unsafe {
    {
        let mut init = Curl_handler {
            scheme: b"DICT\0" as *const u8 as *const libc::c_char,
            setup_connection: None,
            do_it: Some(
                dict_do as unsafe extern "C" fn(*mut Curl_easy, *mut bool) -> CURLcode,
            ),
            done: None,
            do_more: None,
            connect_it: None,
            ...
            attach: None,
            defport: 2628 as libc::c_int,
            protocol: ((1 as libc::c_int) << 9 as libc::c_int) as libc::c_uint,
            family: ((1 as libc::c_int) << 9 as libc::c_int) as libc::c_uint,
...
unsafe extern "C" fn unescape_word(
    ...
    let mut dictp: *mut libc::c_char = 0 as *mut libc::c_char;
    ...
    if newp.is_null() || result as libc::c_uint != 0 {
    ...
    if !dictp.is_null() {
        ...
        loop {
                ...
                || ch as libc::c_int == '\\' as i32
            {
                let fresh0 = olen;
                olen = olen + 1;
                *dictp.offset(fresh0 as isize) = '\\' as i32 as libc::c_char;
            }
            let fresh1 = olen;
            olen = olen + 1;
        ...
        *dictp.offset(olen as isize) = 0 as libc::c_int as libc::c_char;
    }
...
unsafe extern "C" fn sendf(
    ...
    loop {
        ...
        write_len = (write_len as libc::c_ulong)
...
unsafe extern "C" fn dict_do(mut data: *mut Curl_easy, mut done: *mut bool) -> CURLcode {
    let mut word: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut eword: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut ppath: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut database: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut strategy: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut nthdef: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut result: CURLcode = CURLE_OK;
    ...
    *done = 1 as libc::c_int != 0;
        ...
        ) != 0
    {
                ...
                *fresh2 = 0 as libc::c_int as libc::c_char;
                ...
                if !strategy.is_null() {
                    ...
                    *fresh3 = 0 as libc::c_int as libc::c_char;
                    ...
                    if !nthdef.is_null() {
                        *nthdef = 0 as libc::c_int as libc::c_char;
                    }
                }
            }
        }
        if word.is_null()
            || *word as libc::c_int == 0 as libc::c_int as libc::c_char as libc::c_int
        {
            Curl_infof(
                data,
                b"lookup word is missing\0" as *const u8 as *const libc::c_char,
            );
            word = b"default\0" as *const u8 as *const libc::c_char as *mut libc::c_char;
        }
        if database.is_null()
            || *database as libc::c_int
                == 0 as libc::c_int as libc::c_char as libc::c_int
        {
            database = b"!\0" as *const u8 as *const libc::c_char as *mut libc::c_char;
        }
        if strategy.is_null()
            || *strategy as libc::c_int
                == 0 as libc::c_int as libc::c_char as libc::c_int
        {
            strategy = b".\0" as *const u8 as *const libc::c_char as *mut libc::c_char;
        }
        ...
        if result as u64 != 0 {
            Curl_failf(
                data,
                b"Failed sending DICT request\0" as *const u8 as *const libc::c_char,
            );
            return result;
        }
        Curl_setup_transfer(
        ...
        if !ppath.is_null() {
            ...
            while *ppath.offset(i as isize) != 0 {
                if *ppath.offset(i as isize) as libc::c_int == ':' as i32 {
                    *ppath.offset(i as isize) = ' ' as i32 as libc::c_char;
                }
                i += 1;
            }
            result = sendf(
