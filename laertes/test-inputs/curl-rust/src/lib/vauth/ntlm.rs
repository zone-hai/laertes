...
extern "C" {
    ...
    fn Curl_ntlm_core_mk_lmv2_resp(
        ntlmv2hash: *mut libc::c_uchar,
        challenge_client: *mut libc::c_uchar,
        challenge_server: *mut libc::c_uchar,
        lmresp: *mut libc::c_uchar,
    ) -> CURLcode;
    fn Curl_ntlm_core_mk_ntlmv2_resp(
        ntlmv2hash: *mut libc::c_uchar,
        challenge_client: *mut libc::c_uchar,
        ntlm: *mut ntlmdata,
        ntresp: *mut *mut libc::c_uchar,
        ntresp_len: *mut libc::c_uint,
    ) -> CURLcode;
    fn Curl_ntlm_core_mk_ntlmv2_hash(
        user: *const libc::c_char,
        userlen: size_t,
        domain: *const libc::c_char,
        domlen: size_t,
        ntlmhash: *mut libc::c_uchar,
        ntlmv2hash: *mut libc::c_uchar,
    ) -> CURLcode;
    ...
    fn Curl_bufref_memdup(
        br: *mut bufref,
        ptr: *const libc::c_void,
        len: size_t,
    ) -> CURLcode;
    fn Curl_read16_le(buf: *const libc::c_uchar) -> libc::c_ushort;
    fn Curl_read32_le(buf: *const libc::c_uchar) -> libc::c_uint;
    fn curl_msnprintf(
...
unsafe extern "C" fn ntlm_decode_type2_target(
    ...
    let mut target_info_len: libc::c_ushort = 0 as libc::c_int as libc::c_ushort;
    let mut target_info_offset: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut type2: *const libc::c_uchar = Curl_bufref_ptr(type2ref);
    let mut type2len: size_t = Curl_bufref_len(type2ref);
    if type2len >= 48 as libc::c_int as libc::c_ulong {
        target_info_len = Curl_read16_le(&*type2.offset(40 as libc::c_int as isize));
        target_info_offset = Curl_read32_le(&*type2.offset(44 as libc::c_int as isize));
        if target_info_len as libc::c_int > 0 as libc::c_int {
            if target_info_offset as libc::c_ulong > type2len
                || target_info_offset.wrapping_add(target_info_len as libc::c_uint)
                    as libc::c_ulong > type2len
                || target_info_offset < 48 as libc::c_int as libc::c_uint
            {
                Curl_infof(
                    data,
            ...
            let ref mut fresh0 = (*ntlm).target_info;
            *fresh0 = Curl_cmalloc
            ...
            memcpy(
                (*ntlm).target_info,
                &*type2.offset(target_info_offset as isize) as *const libc::c_uchar
                    as *const libc::c_void,
                target_info_len as libc::c_ulong,
            );
        }
    }
    (*ntlm).target_info_len = target_info_len as libc::c_uint;
    return CURLE_OK;
}
#[no_mangle]
pub unsafe extern "C" fn Curl_auth_is_ntlm_supported() -> bool {
...
pub unsafe extern "C" fn Curl_auth_decode_ntlm_type2_message(
    ...
    static mut type2_marker: [libc::c_char; 4] = [
    ...
    let mut type2: *const libc::c_uchar = Curl_bufref_ptr(type2ref);
    let mut type2len: size_t = Curl_bufref_len(type2ref);
    (*ntlm).flags = 0 as libc::c_int as libc::c_uint;
    if type2len < 32 as libc::c_int as libc::c_ulong
        || memcmp(
            type2 as *const libc::c_void,
            b"NTLMSSP\0" as *const u8 as *const libc::c_char as *const libc::c_void,
            8 as libc::c_int as libc::c_ulong,
        ) != 0 as libc::c_int
        || memcmp(
            type2.offset(8 as libc::c_int as isize) as *const libc::c_void,
    ...
    (*ntlm).flags = Curl_read32_le(&*type2.offset(20 as libc::c_int as isize));
    memcpy(
        ((*ntlm).nonce).as_mut_ptr() as *mut libc::c_void,
        &*type2.offset(24 as libc::c_int as isize) as *const libc::c_uchar
            as *const libc::c_void,
        8 as libc::c_int as libc::c_ulong,
    );
    if (*ntlm).flags & ((1 as libc::c_int) << 23 as libc::c_int) as libc::c_uint != 0 {
...
unsafe extern "C" fn unicodecpy(
    ...
    while i < length {
        *dest
            ...
            ) = *src.offset(i as isize) as libc::c_uchar;
        *dest
            .offset(
...
pub unsafe extern "C" fn Curl_auth_create_ntlm_type1_message(
    ...
    let mut ntlmbuf: *mut libc::c_char = 0 as *mut libc::c_char;
    ...
    let mut domlen: size_t = 0 as libc::c_int as size_t;
    let mut hostoff: size_t = 0 as libc::c_int as size_t;
    ...
    ntlmbuf = curl_maprintf(
        ...
        ((1 as libc::c_int) << 1 as libc::c_int | (1 as libc::c_int) << 2 as libc::c_int
            ...
            | (1 as libc::c_int) << 15 as libc::c_int) & 0xff as libc::c_int,
        ((1 as libc::c_int) << 1 as libc::c_int | (1 as libc::c_int) << 2 as libc::c_int
            | (1 as libc::c_int) << 9 as libc::c_int
            | (1 as libc::c_int) << 19 as libc::c_int
        ...
        ((1 as libc::c_int) << 1 as libc::c_int | (1 as libc::c_int) << 2 as libc::c_int
            | (1 as libc::c_int) << 9 as libc::c_int
            | (1 as libc::c_int) << 19 as libc::c_int
            | (1 as libc::c_int) << 15 as libc::c_int) >> 24 as libc::c_int
            & 0xff as libc::c_int,
        (domlen & 0xff as libc::c_int as libc::c_ulong) as libc::c_int,
        (domlen >> 8 as libc::c_int & 0xff as libc::c_int as libc::c_ulong)
            as libc::c_int,
        (domlen & 0xff as libc::c_int as libc::c_ulong) as libc::c_int,
        (domlen >> 8 as libc::c_int & 0xff as libc::c_int as libc::c_ulong)
            as libc::c_int,
        (domoff & 0xff as libc::c_int as libc::c_ulong) as libc::c_int,
        (domoff >> 8 as libc::c_int & 0xff as libc::c_int as libc::c_ulong)
            as libc::c_int,
        0 as libc::c_int,
        0 as libc::c_int,
        (hostlen & 0xff as libc::c_int as libc::c_ulong) as libc::c_int,
        (hostlen >> 8 as libc::c_int & 0xff as libc::c_int as libc::c_ulong)
            as libc::c_int,
        (hostlen & 0xff as libc::c_int as libc::c_ulong) as libc::c_int,
        (hostlen >> 8 as libc::c_int & 0xff as libc::c_int as libc::c_ulong)
            as libc::c_int,
        (hostoff & 0xff as libc::c_int as libc::c_ulong) as libc::c_int,
        (hostoff >> 8 as libc::c_int & 0xff as libc::c_int as libc::c_ulong)
            as libc::c_int,
        0 as libc::c_int,
        0 as libc::c_int,
        host,
...
pub unsafe extern "C" fn Curl_auth_create_ntlm_type3_message(
    ...
    let mut result: CURLcode = CURLE_OK;
    let mut size: size_t = 0;
    let mut ntlmbuf: [libc::c_uchar; 1024] = [0; 1024];
    let mut lmrespoff: libc::c_int = 0;
    let mut lmresp: [libc::c_uchar; 24] = [0; 24];
    let mut ntrespoff: libc::c_int = 0;
    let mut ntresplen: libc::c_uint = 24 as libc::c_int as libc::c_uint;
    let mut ntresp: [libc::c_uchar; 24] = [0; 24];
    let mut ptr_ntresp: *mut libc::c_uchar = &mut *ntresp
        .as_mut_ptr()
        .offset(0 as libc::c_int as isize) as *mut libc::c_uchar;
    let mut ntlmv2resp: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    ...
    let mut host: [libc::c_char; 1025] = *::std::mem::transmute::<
        &[u8; 1025],
    ...
    let mut domain: *const libc::c_char = b"\0" as *const u8 as *const libc::c_char;
    let mut hostoff: size_t = 0 as libc::c_int as size_t;
    let mut useroff: size_t = 0 as libc::c_int as size_t;
    let mut domoff: size_t = 0 as libc::c_int as size_t;
    let mut hostlen: size_t = 0 as libc::c_int as size_t;
    let mut userlen: size_t = 0 as libc::c_int as size_t;
    let mut domlen: size_t = 0 as libc::c_int as size_t;
    ...
    if !user.is_null() {
        domain = userp;
        domlen = user.offset_from(domain) as libc::c_long as size_t;
        user = user.offset(1);
    } else {
        user = userp;
    }
    ...
    ) != 0
    {
        ...
        hostlen = 0 as libc::c_int as size_t;
    } else {
        hostlen = strlen(host.as_mut_ptr());
    }
    if (*ntlm).flags & ((1 as libc::c_int) << 19 as libc::c_int) as libc::c_uint != 0 {
        let mut ntbuffer: [libc::c_uchar; 24] = [0; 24];
        let mut entropy: [libc::c_uchar; 8] = [0; 8];
        let mut ntlmv2hash: [libc::c_uchar; 24] = [0; 24];
        result = Curl_rand(data, entropy.as_mut_ptr(), 8 as libc::c_int as size_t);
        if result as u64 != 0 {
            return result;
        }
        ...
        let mut ntbuffer_0: [libc::c_uchar; 24] = [0; 24];
        let mut lmbuffer: [libc::c_uchar; 24] = [0; 24];
        ...
        (*ntlm).flags &= !((1 as libc::c_int) << 19 as libc::c_int) as libc::c_uint;
    }
    if unicode {
        domlen = domlen.wrapping_mul(2 as libc::c_int as libc::c_ulong);
        userlen = userlen.wrapping_mul(2 as libc::c_int as libc::c_ulong);
        hostlen = hostlen.wrapping_mul(2 as libc::c_int as libc::c_ulong);
    }
    lmrespoff = 64 as libc::c_int;
    ntrespoff = lmrespoff + 0x18 as libc::c_int;
    domoff = (ntrespoff as libc::c_uint).wrapping_add(ntresplen) as size_t;
    useroff = domoff.wrapping_add(domlen);
    hostoff = useroff.wrapping_add(userlen);
    size = curl_msnprintf(
        ntlmbuf.as_mut_ptr() as *mut libc::c_char,
        ...
        0 as libc::c_int,
        0 as libc::c_int,
        0x18 as libc::c_int & 0xff as libc::c_int,
        0x18 as libc::c_int >> 8 as libc::c_int & 0xff as libc::c_int,
        0x18 as libc::c_int & 0xff as libc::c_int,
        0x18 as libc::c_int >> 8 as libc::c_int & 0xff as libc::c_int,
        lmrespoff & 0xff as libc::c_int,
        lmrespoff >> 8 as libc::c_int & 0xff as libc::c_int,
        0 as libc::c_int,
        0 as libc::c_int,
        (ntresplen & 0xff as libc::c_int as libc::c_uint) as libc::c_int,
        (ntresplen >> 8 as libc::c_int & 0xff as libc::c_int as libc::c_uint)
            as libc::c_int,
        (ntresplen & 0xff as libc::c_int as libc::c_uint) as libc::c_int,
        (ntresplen >> 8 as libc::c_int & 0xff as libc::c_int as libc::c_uint)
            as libc::c_int,
        ntrespoff & 0xff as libc::c_int,
        ntrespoff >> 8 as libc::c_int & 0xff as libc::c_int,
        0 as libc::c_int,
        0 as libc::c_int,
        (domlen & 0xff as libc::c_int as libc::c_ulong) as libc::c_int,
        (domlen >> 8 as libc::c_int & 0xff as libc::c_int as libc::c_ulong)
        ...
        0 as libc::c_int,
        0 as libc::c_int,
        (userlen & 0xff as libc::c_int as libc::c_ulong) as libc::c_int,
        (userlen >> 8 as libc::c_int & 0xff as libc::c_int as libc::c_ulong)
            as libc::c_int,
        (userlen & 0xff as libc::c_int as libc::c_ulong) as libc::c_int,
        (userlen >> 8 as libc::c_int & 0xff as libc::c_int as libc::c_ulong)
            as libc::c_int,
        (useroff & 0xff as libc::c_int as libc::c_ulong) as libc::c_int,
        (useroff >> 8 as libc::c_int & 0xff as libc::c_int as libc::c_ulong)
            as libc::c_int,
        0 as libc::c_int,
        0 as libc::c_int,
        (hostlen & 0xff as libc::c_int as libc::c_ulong) as libc::c_int,
        ...
        0 as libc::c_int,
        0 as libc::c_int,
        ((*ntlm).flags & 0xff as libc::c_int as libc::c_uint) as libc::c_int,
        ((*ntlm).flags >> 8 as libc::c_int & 0xff as libc::c_int as libc::c_uint)
            as libc::c_int,
        ((*ntlm).flags >> 16 as libc::c_int & 0xff as libc::c_int as libc::c_uint)
            as libc::c_int,
        ((*ntlm).flags >> 24 as libc::c_int & 0xff as libc::c_int as libc::c_uint)
            as libc::c_int,
    ) as size_t;
    if size < (1024 as libc::c_int - 0x18 as libc::c_int) as libc::c_ulong {
        memcpy(
            &mut *ntlmbuf.as_mut_ptr().offset(size as isize) as *mut libc::c_uchar
                as *mut libc::c_void,
            lmresp.as_mut_ptr() as *const libc::c_void,
            0x18 as libc::c_int as libc::c_ulong,
        );
        size = (size as libc::c_ulong).wrapping_add(0x18 as libc::c_int as libc::c_ulong)
            as size_t as size_t;
    }
    if (ntresplen as libc::c_ulong).wrapping_add(size)
        > ::std::mem::size_of::<[libc::c_uchar; 1024]>() as libc::c_ulong
    {
        Curl_failf(
            data,
            b"incoming NTLM message too big\0" as *const u8 as *const libc::c_char,
        );
        return CURLE_OUT_OF_MEMORY;
    }
    memcpy(
        ...
        ntresplen as libc::c_ulong,
    );
    size = (size as libc::c_ulong).wrapping_add(ntresplen as libc::c_ulong) as size_t
        as size_t;
        ...
        >= 1024 as libc::c_int as libc::c_ulong
    {
        Curl_failf(
            data,
            b"user + domain + host name too big\0" as *const u8 as *const libc::c_char,
        );
        return CURLE_OUT_OF_MEMORY;
    }
    if unicode {
        unicodecpy(
            ...
            domain,
            domlen.wrapping_div(2 as libc::c_int as libc::c_ulong),
        );
    } else {
        memcpy(
            &mut *ntlmbuf.as_mut_ptr().offset(size as isize) as *mut libc::c_uchar
    ...
    if unicode {
        unicodecpy(
            &mut *ntlmbuf.as_mut_ptr().offset(size as isize),
            user,
            userlen.wrapping_div(2 as libc::c_int as libc::c_ulong),
        );
    } else {
        memcpy(
            &mut *ntlmbuf.as_mut_ptr().offset(size as isize) as *mut libc::c_uchar
    ...
    if unicode {
        unicodecpy(
            &mut *ntlmbuf.as_mut_ptr().offset(size as isize),
            host.as_mut_ptr(),
            hostlen.wrapping_div(2 as libc::c_int as libc::c_ulong),
        );
    } else {
        memcpy(
            &mut *ntlmbuf.as_mut_ptr().offset(size as isize) as *mut libc::c_uchar
    ...
    size = (size as libc::c_ulong).wrapping_add(hostlen) as size_t as size_t;
...
pub unsafe extern "C" fn Curl_auth_cleanup_ntlm(mut ntlm: *mut ntlmdata) {
    Curl_cfree.expect("non-null function pointer")((*ntlm).target_info);
    let ref mut fresh1 = (*ntlm).target_info;
    *fresh1 = 0 as *mut libc::c_void;
    (*ntlm).target_info_len = 0 as libc::c_int as libc::c_uint;
}
