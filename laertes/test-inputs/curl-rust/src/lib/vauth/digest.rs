...
extern "C" {
    ...
    fn Curl_md5it(output: *mut libc::c_uchar, input: *const libc::c_uchar, len: size_t);
...
pub unsafe extern "C" fn Curl_auth_digest_get_pair(
    ...
    let mut starts_with_quote: bool = 0 as libc::c_int != 0;
    let mut escape: bool = 0 as libc::c_int != 0;
    c = 256 as libc::c_int - 1 as libc::c_int;
    ...
    *value = 0 as libc::c_int as libc::c_char;
    let fresh3 = str;
    str = str.offset(1);
    if '=' as i32 != *fresh3 as libc::c_int {
        return 0 as libc::c_int != 0;
    }
    if '"' as i32 == *str as libc::c_int {
        str = str.offset(1);
        starts_with_quote = 1 as libc::c_int != 0;
    }
    let mut current_block_17: u64;
    c = 1024 as libc::c_int - 1 as libc::c_int;
        ...
        }
    {
        match *str as libc::c_int {
            ...
            34 => {
                if !escape && starts_with_quote as libc::c_int != 0 {
                    c = 0 as libc::c_int;
                    current_block_17 = 2968425633554183086;
                } else {
                    current_block_17 = 15125582407903384992;
    ...
    *content = 0 as libc::c_int as libc::c_char;
    *endptr = str;
    return 1 as libc::c_int != 0;
}
unsafe extern "C" fn auth_digest_md5_to_ascii(
    mut source: *mut libc::c_uchar,
    ...
    while i < 16 as libc::c_int {
        curl_msnprintf(
            &mut *dest.offset((i * 2 as libc::c_int) as isize) as *mut libc::c_uchar
                as *mut libc::c_char,
            3 as libc::c_int as size_t,
            b"%02x\0" as *const u8 as *const libc::c_char,
            *source.offset(i as isize) as libc::c_int,
        );
        i += 1;
    }
}
...
unsafe extern "C" fn auth_digest_string_quoted(
    ...
    let mut s: *const libc::c_char = source;
    ...
    dest = Curl_cmalloc.expect("non-null function pointer")(n) as *mut libc::c_char;
    if !dest.is_null() {
...
unsafe extern "C" fn auth_digest_get_key_value(
    mut chlg: *const libc::c_char,
    mut key: *const libc::c_char,
    mut value: *mut libc::c_char,
    mut max_val_len: size_t,
    mut end_char: libc::c_char,
) -> bool {
    let mut find_pos: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut i: size_t = 0;
    ...
    while *find_pos as libc::c_int != 0
        && *find_pos as libc::c_int != end_char as libc::c_int
        && i < max_val_len.wrapping_sub(1 as libc::c_int as libc::c_ulong)
    {
    ...
    *value.offset(i as isize) = '\u{0}' as i32 as libc::c_char;
    return 1 as libc::c_int != 0;
}
unsafe extern "C" fn auth_digest_get_qop_values(
    ...
    *value = 0 as libc::c_int;
    ...
    token = strtok_r(tmp, b",\0" as *const u8 as *const libc::c_char, &mut tok_buf);
    while !token.is_null() {
        if Curl_strcasecompare(token, b"auth\0" as *const u8 as *const libc::c_char) != 0
        {
            *value |= (1 as libc::c_int) << 0 as libc::c_int;
        } else if Curl_strcasecompare(
                token,
                b"auth-int\0" as *const u8 as *const libc::c_char,
            ) != 0
            {
            *value |= (1 as libc::c_int) << 1 as libc::c_int;
        } else if Curl_strcasecompare(
                token,
                b"auth-conf\0" as *const u8 as *const libc::c_char,
            ) != 0
            {
            *value |= (1 as libc::c_int) << 2 as libc::c_int;
        }
        token = strtok_r(
...
unsafe extern "C" fn auth_decode_digest_md5_message(
    ...
    mut rlen: size_t,
    mut alg: *mut libc::c_char,
    mut alen: size_t,
    mut qop: *mut libc::c_char,
    mut qlen: size_t,
) -> CURLcode {
    let mut chlg: *const libc::c_char = Curl_bufref_ptr(chlgref) as *const libc::c_char;
    ...
    if !auth_digest_get_key_value(
        ...
        strcpy(realm, b"\0" as *const u8 as *const libc::c_char);
    }
    if !auth_digest_get_key_value(
        chlg,
...
#[no_mangle]
pub unsafe extern "C" fn Curl_auth_is_digest_supported() -> bool {
    return 1 as libc::c_int != 0;
}
#[no_mangle]
pub unsafe extern "C" fn Curl_auth_create_digest_md5_message(
    ...
    let mut HA1_hex: [libc::c_char; 33] = [0; 33];
    let mut HA2_hex: [libc::c_char; 33] = [0; 33];
    let mut resp_hash_hex: [libc::c_char; 33] = [0; 33];
    let mut nonce: [libc::c_char; 64] = [0; 64];
    let mut realm: [libc::c_char; 128] = [0; 128];
    let mut algorithm: [libc::c_char; 64] = [0; 64];
    let mut qop_options: [libc::c_char; 64] = [0; 64];
    let mut qop_values: libc::c_int = 0;
    let mut cnonce: [libc::c_char; 33] = [0; 33];
    let mut nonceCount: [libc::c_char; 9] = *::std::mem::transmute::<
        &[u8; 9],
        &mut [libc::c_char; 9],
    >(b"00000001\0");
    let mut method: [libc::c_char; 13] = *::std::mem::transmute::<
        &[u8; 13],
        &mut [libc::c_char; 13],
    >(b"AUTHENTICATE\0");
    let mut qop: [libc::c_char; 5] = *::std::mem::transmute::<
        &[u8; 5],
        &mut [libc::c_char; 5],
    >(b"auth\0");
    ...
    if strcmp(algorithm.as_mut_ptr(), b"md5-sess\0" as *const u8 as *const libc::c_char)
        != 0 as libc::c_int
    {
        return CURLE_BAD_CONTENT_ENCODING;
    }
    ...
    if qop_values & (1 as libc::c_int) << 0 as libc::c_int == 0 {
        return CURLE_BAD_CONTENT_ENCODING;
    }
    result = Curl_rand_hex(
        data,
        cnonce.as_mut_ptr() as *mut libc::c_uchar,
    ...
    Curl_MD5_update(ctxt, userp as *const libc::c_uchar, curlx_uztoui(strlen(userp)));
    Curl_MD5_update(
        ctxt,
    ...
    Curl_MD5_update(
        ctxt,
        realm.as_mut_ptr() as *const libc::c_uchar,
    ...
    Curl_MD5_update(
        ctxt,
        digest.as_mut_ptr() as *const libc::c_uchar,
    ...
    Curl_MD5_update(
        ctxt,
        nonce.as_mut_ptr() as *const libc::c_uchar,
    ...
    Curl_MD5_update(
        ctxt,
        cnonce.as_mut_ptr() as *const libc::c_uchar,
    ...
    spn = Curl_auth_build_spn(service, realm.as_mut_ptr(), 0 as *const libc::c_char);
    if spn.is_null() {
        return CURLE_OUT_OF_MEMORY;
    }
    ctxt = Curl_MD5_init(Curl_DIGEST_MD5.as_ptr());
    ...
    Curl_MD5_update(
        ctxt,
        method.as_mut_ptr() as *const libc::c_uchar,
    ...
    Curl_MD5_update(ctxt, spn as *const libc::c_uchar, curlx_uztoui(strlen(spn)));
    Curl_MD5_final(ctxt, digest.as_mut_ptr());
    i = 0 as libc::c_int as size_t;
    while i < 16 as libc::c_int as libc::c_ulong {
        curl_msnprintf(
    ...
    Curl_MD5_update(
        ctxt,
        HA1_hex.as_mut_ptr() as *const libc::c_uchar,
    ...
    Curl_MD5_update(
        ctxt,
        nonceCount.as_mut_ptr() as *const libc::c_uchar,
    ...
    Curl_MD5_update(
        ctxt,
        qop.as_mut_ptr() as *const libc::c_uchar,
    ...
    Curl_MD5_update(
        ctxt,
        HA2_hex.as_mut_ptr() as *const libc::c_uchar,
        (2 as libc::c_int * 16 as libc::c_int) as libc::c_uint,
    );
    Curl_MD5_final(ctxt, digest.as_mut_ptr());
    i = 0 as libc::c_int as size_t;
...
pub unsafe extern "C" fn Curl_auth_decode_digest_http_message(
    ...
    let mut before: bool = 0 as libc::c_int != 0;
    let mut foundAuth: bool = 0 as libc::c_int != 0;
    let mut foundAuthInt: bool = 0 as libc::c_int != 0;
    let mut token: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut tmp: *mut libc::c_char = 0 as *mut libc::c_char;
    ...
    loop {
        let mut value: [libc::c_char; 256] = [0; 256];
        let mut content: [libc::c_char; 1024] = [0; 1024];
        while *chlg as libc::c_int != 0
            && Curl_isspace(*chlg as libc::c_uchar as libc::c_int) != 0
        {
            chlg = chlg.offset(1);
        }
        ...
        ) != 0
        {
            ...
            let ref mut fresh11 = (*digest).nonce;
            *fresh11 = Curl_cstrdup
            ...
            {
                (*digest).set_stale(1 as libc::c_int as bit);
                (*digest).nc = 1 as libc::c_int;
            }
        } else if Curl_strcasecompare(
                value.as_mut_ptr(),
                b"realm\0" as *const u8 as *const libc::c_char,
            ...
            let ref mut fresh12 = (*digest).realm;
            *fresh12 = Curl_cstrdup
            ...
            let ref mut fresh13 = (*digest).opaque;
            *fresh13 = Curl_cstrdup
            ...
            while !token.is_null() {
                ...
                {
                    foundAuth = 1 as libc::c_int != 0;
                } else if Curl_strcasecompare(
                        token,
                        b"auth-int\0" as *const u8 as *const libc::c_char,
                    ) != 0
                    {
                    foundAuthInt = 1 as libc::c_int != 0;
                }
                token = strtok_r(
                    0 as *mut libc::c_char,
                    b",\0" as *const u8 as *const libc::c_char,
            ...
            if foundAuth {
                ...
                let ref mut fresh14 = (*digest).qop;
                *fresh14 = Curl_cstrdup
                ...
                let ref mut fresh15 = (*digest).qop;
            ...
            let ref mut fresh16 = (*digest).algorithm;
            *fresh16 = Curl_cstrdup
            ...
            {
                (*digest).algo = CURLDIGESTALGO_MD5SESS as libc::c_int;
            } else if Curl_strcasecompare(
                    content.as_mut_ptr(),
                    b"MD5\0" as *const u8 as *const libc::c_char,
                ) != 0
                {
                (*digest).algo = CURLDIGESTALGO_MD5 as libc::c_int;
            } else if Curl_strcasecompare(
                    content.as_mut_ptr(),
                    b"SHA-256\0" as *const u8 as *const libc::c_char,
                ) != 0
                {
                (*digest).algo = CURLDIGESTALGO_SHA256 as libc::c_int;
            } else if Curl_strcasecompare(
                    content.as_mut_ptr(),
                    b"SHA-256-SESS\0" as *const u8 as *const libc::c_char,
                ) != 0
                {
                (*digest).algo = CURLDIGESTALGO_SHA256SESS as libc::c_int;
            } else if Curl_strcasecompare(
                    content.as_mut_ptr(),
                    b"SHA-512-256\0" as *const u8 as *const libc::c_char,
                ) != 0
                {
                (*digest).algo = CURLDIGESTALGO_SHA512_256 as libc::c_int;
            } else if Curl_strcasecompare(
                    content.as_mut_ptr(),
                    b"SHA-512-256-SESS\0" as *const u8 as *const libc::c_char,
                ) != 0
                {
                (*digest).algo = CURLDIGESTALGO_SHA512_256SESS as libc::c_int;
            } else {
                return CURLE_BAD_CONTENT_ENCODING
            }
        } else if Curl_strcasecompare(
            ...
            {
                (*digest).set_userhash(1 as libc::c_int as bit);
            }
        }
        while *chlg as libc::c_int != 0
            && Curl_isspace(*chlg as libc::c_uchar as libc::c_int) != 0
        ...
        if ',' as i32 == *chlg as libc::c_int {
            chlg = chlg.offset(1);
        }
    }
    if before as libc::c_int != 0 && (*digest).stale() == 0 {
        return CURLE_BAD_CONTENT_ENCODING;
    }
    if ((*digest).nonce).is_null() {
        return CURLE_BAD_CONTENT_ENCODING;
...
unsafe extern "C" fn auth_create_digest_http_message(
    ...
    mut convert_to_ascii: Option::<
        unsafe extern "C" fn(*mut libc::c_uchar, *mut libc::c_uchar) -> (),
    >,
    mut hash: Option::<
        unsafe extern "C" fn(*mut libc::c_uchar, *const libc::c_uchar, size_t) -> (),
    >,
) -> CURLcode {
    let mut result: CURLcode = CURLE_OK;
    let mut hashbuf: [libc::c_uchar; 32] = [0; 32];
    let mut request_digest: [libc::c_uchar; 65] = [0; 65];
    let mut ha1: [libc::c_uchar; 65] = [0; 65];
    let mut ha2: [libc::c_uchar; 65] = [0; 65];
    let mut userh: [libc::c_char; 65] = [0; 65];
    let mut cnonce: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut cnonce_sz: size_t = 0 as libc::c_int as size_t;
    let mut userp_quoted: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut response: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut hashthis: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut tmp: *mut libc::c_char = 0 as *mut libc::c_char;
    if (*digest).nc == 0 {
        (*digest).nc = 1 as libc::c_int;
    }
    if ((*digest).cnonce).is_null() {
        let mut cnoncebuf: [libc::c_char; 33] = [0; 33];
        result = Curl_rand_hex(
            data,
            cnoncebuf.as_mut_ptr() as *mut libc::c_uchar,
            ::std::mem::size_of::<[libc::c_char; 33]>() as libc::c_ulong,
        );
        if result as u64 != 0 {
            return result;
        ...
        let ref mut fresh17 = (*digest).cnonce;
        *fresh17 = cnonce;
    }
    if (*digest).userhash() != 0 {
        ...
        hash
            .expect(
                "non-null function pointer",
            )(hashbuf.as_mut_ptr(), hashthis as *mut libc::c_uchar, strlen(hashthis));
        Curl_cfree.expect("non-null function pointer")(hashthis as *mut libc::c_void);
        convert_to_ascii
            .expect(
                "non-null function pointer",
            )(hashbuf.as_mut_ptr(), userh.as_mut_ptr() as *mut libc::c_uchar);
    }
    hashthis = curl_maprintf(
        b"%s:%s:%s\0" as *const u8 as *const libc::c_char,
        if (*digest).userhash() as libc::c_int != 0 {
            userh.as_mut_ptr() as *const libc::c_char
        } else {
            userp
        },
        (*digest).realm,
    ...
    if (*digest).algo == CURLDIGESTALGO_MD5SESS as libc::c_int
        || (*digest).algo == CURLDIGESTALGO_SHA256SESS as libc::c_int
        || (*digest).algo == CURLDIGESTALGO_SHA512_256SESS as libc::c_int
    {
        tmp = curl_maprintf(
        ...
        hash
            .expect(
                "non-null function pointer",
            )(hashbuf.as_mut_ptr(), tmp as *mut libc::c_uchar, strlen(tmp));
        Curl_cfree.expect("non-null function pointer")(tmp as *mut libc::c_void);
        convert_to_ascii
            .expect("non-null function pointer")(hashbuf.as_mut_ptr(), ha1.as_mut_ptr());
    }
    ...
    {
        let mut hashed: [libc::c_char; 65] = [0; 65];
        let mut hashthis2: *mut libc::c_char = 0 as *mut libc::c_char;
        hash
            .expect(
                "non-null function pointer",
            )(
        ...
        convert_to_ascii
            .expect(
                "non-null function pointer",
            )(hashbuf.as_mut_ptr(), hashed.as_mut_ptr() as *mut libc::c_uchar);
    ...
    if !((*digest).qop).is_null() {
        hashthis = curl_maprintf(
            b"%s:%s:%08x:%s:%s:%s\0" as *const u8 as *const libc::c_char,
            ha1.as_mut_ptr(),
            (*digest).nonce,
            (*digest).nc,
            (*digest).cnonce,
    ...
    if !((*digest).opaque).is_null() {
        tmp = curl_maprintf(
            b"%s, opaque=\"%s\"\0" as *const u8 as *const libc::c_char,
            response,
            (*digest).opaque,
        );
    ...
    if !((*digest).algorithm).is_null() {
        tmp = curl_maprintf(
            b"%s, algorithm=%s\0" as *const u8 as *const libc::c_char,
            response,
            (*digest).algorithm,
        );
        Curl_cfree.expect("non-null function pointer")(response as *mut libc::c_void);
    ...
    if (*digest).userhash() != 0 {
        tmp = curl_maprintf(
            b"%s, userhash=true\0" as *const u8 as *const libc::c_char,
            response,
        );
        Curl_cfree.expect("non-null function pointer")(response as *mut libc::c_void);
        if tmp.is_null() {
