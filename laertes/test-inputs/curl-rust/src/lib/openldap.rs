...
extern "C" {
    ...
    pub type sockbuf;
    pub type ldapmsg;
    fn Curl_isprint(c: libc::c_int) -> libc::c_int;
    ...
    fn ber_free(ber: *mut BerElement, freebuf: libc::c_int);
    ...
    fn ldap_parse_result(
        ld: *mut LDAP,
        res: *mut LDAPMessage,
        errcodep: *mut libc::c_int,
        matcheddnp: *mut *mut libc::c_char,
        diagmsgp: *mut *mut libc::c_char,
        referralsp: *mut *mut *mut libc::c_char,
    ...
    fn ldap_msgtype(lm: *mut LDAPMessage) -> libc::c_int;
    fn ldap_result(
        ld: *mut LDAP,
        msgid: libc::c_int,
        all: libc::c_int,
    ...
    fn ldap_pvt_url_scheme2proto(_: *const libc::c_char) -> libc::c_int;
    fn ldap_init_fd(
        fd: ber_socket_t,
        proto: libc::c_int,
        url: *const libc::c_char,
...
>;
pub type ber_tag_t = libc::c_ulong;
pub type ber_socket_t = libc::c_int;
pub type ber_len_t = libc::c_ulong;
pub type ber_slen_t = libc::c_long;
...
pub struct sockbuf_io {
    pub sbi_setup: Option::<
        unsafe extern "C" fn(*mut Sockbuf_IO_Desc, *mut libc::c_void) -> libc::c_int,
    >,
    pub sbi_remove: Option::<unsafe extern "C" fn(*mut Sockbuf_IO_Desc) -> libc::c_int>,
    pub sbi_ctrl: Option::<
        unsafe extern "C" fn(
            *mut Sockbuf_IO_Desc,
            libc::c_int,
    ...
    >,
    pub sbi_close: Option::<unsafe extern "C" fn(*mut Sockbuf_IO_Desc) -> libc::c_int>,
}
pub type Sockbuf_IO_Desc = sockbuf_io_desc;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct sockbuf_io_desc {
    pub sbiod_level: libc::c_int,
...
pub struct ldap_url_desc {
    ...
    pub lud_scheme: *mut libc::c_char,
    pub lud_host: *mut libc::c_char,
    pub lud_port: libc::c_int,
    pub lud_dn: *mut libc::c_char,
    pub lud_attrs: *mut *mut libc::c_char,
    pub lud_scope: libc::c_int,
    pub lud_filter: *mut libc::c_char,
    pub lud_exts: *mut *mut libc::c_char,
    pub lud_crit_exts: libc::c_int,
}
...
pub static mut Curl_handler_ldap: Curl_handler = unsafe {
    {
        let mut init = Curl_handler {
            scheme: b"LDAP\0" as *const u8 as *const libc::c_char,
            ...
            attach: None,
            defport: 389 as libc::c_int,
            protocol: ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint,
            family: ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint,
...
pub static mut Curl_handler_ldaps: Curl_handler = unsafe {
    {
        let mut init = Curl_handler {
            scheme: b"LDAPS\0" as *const u8 as *const libc::c_char,
            setup_connection: Some(
                oldap_setup_connection
                    as unsafe extern "C" fn(*mut Curl_easy, *mut connectdata) -> CURLcode,
            ),
            ...
            connection_check: None,
            attach: None,
            defport: 636 as libc::c_int,
            protocol: ((1 as libc::c_int) << 8 as libc::c_int) as libc::c_uint,
            family: ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint,
...
static mut url_errs: [*const libc::c_char; 11] = [
    ...
    b"unrecognized scheme\0" as *const u8 as *const libc::c_char,
    b"unbalanced delimiter\0" as *const u8 as *const libc::c_char,
    b"bad URL\0" as *const u8 as *const libc::c_char,
    b"bad host or port\0" as *const u8 as *const libc::c_char,
    b"bad or missing attributes\0" as *const u8 as *const libc::c_char,
    b"bad or missing scope\0" as *const u8 as *const libc::c_char,
    b"bad or missing filter\0" as *const u8 as *const libc::c_char,
    b"bad or missing extensions\0" as *const u8 as *const libc::c_char,
];
unsafe extern "C" fn oldap_setup_connection(
    ...
    if rc != 0 as libc::c_int {
        let mut msg: *const libc::c_char = b"url parsing problem\0" as *const u8
            as *const libc::c_char;
        status = CURLE_URL_MALFORMAT;
        if rc > 0 as libc::c_int && rc <= 0xa as libc::c_int {
            if rc == 0x1 as libc::c_int {
                status = CURLE_OUT_OF_MEMORY;
            }
            msg = url_errs[rc as usize];
        }
        Curl_failf(data, b"LDAP local: %s\0" as *const u8 as *const libc::c_char, msg);
        return status;
    }
    ...
    li = Curl_ccalloc
        ...
        ::std::mem::size_of::<ldapconninfo>() as libc::c_ulong,
    ) as *mut ldapconninfo;
    if li.is_null() {
...
unsafe extern "C" fn oldap_connect(
    ...
    let mut rc: libc::c_int = 0;
    let mut proto: libc::c_int = 3 as libc::c_int;
    let mut hosturl: [libc::c_char; 1024] = [0; 1024];
    let mut ptr: *mut libc::c_char = 0 as *mut libc::c_char;
    strcpy(hosturl.as_mut_ptr(), b"ldap\0" as *const u8 as *const libc::c_char);
    ptr = hosturl.as_mut_ptr().offset(4 as libc::c_int as isize);
    ...
    curl_msnprintf(
        ...
        (::std::mem::size_of::<[libc::c_char; 1024]>() as libc::c_ulong)
            .wrapping_sub(
                ptr.offset_from(hosturl.as_mut_ptr()) as libc::c_long as libc::c_ulong,
            ),
    ...
    ldap_set_option(
        (*li).ld,
        0x11 as libc::c_int,
        &mut proto as *mut libc::c_int as *const libc::c_void,
    );
    if (*(*conn).handler).flags
        & ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint != 0
    {
...
unsafe extern "C" fn oldap_connecting(
    ...
    let mut tv: timeval = {
        let mut init = timeval {
            ...
            tv_usec: 1 as libc::c_int as __suseconds_t,
        };
        init
    };
        ...
        & ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint != 0
    {
        if !(*li).ssldone {
            ...
            if result as libc::c_uint != 0 || !(*li).ssldone {
                return result;
            }
        }
        if !(*li).sslinst {
            ...
            (*li).sslinst = 1 as libc::c_int != 0;
            let ref mut fresh2 = (*li).recv;
            *fresh2 = (*conn).recv[0 as libc::c_int as usize];
            let ref mut fresh3 = (*li).send;
            *fresh3 = (*conn).send[0 as libc::c_int as usize];
        }
    }
    tvp = &mut tv;
    loop {
        if !(*li).didbind {
            let mut binddn: *mut libc::c_char = 0 as *mut libc::c_char;
            let mut passwd: berval = berval {
                bv_len: 0,
                bv_val: 0 as *mut libc::c_char,
            };
            if ((*conn).bits).user_passwd() != 0 {
                ...
                binddn = 0 as *mut libc::c_char;
                passwd.bv_val = 0 as *mut libc::c_char;
                passwd.bv_len = 0 as libc::c_int as ber_len_t;
            }
            rc = ldap_sasl_bind(
                (*li).ld,
                binddn,
            ...
            (*li).didbind = 1 as libc::c_int != 0;
            if !tvp.is_null() {
                return CURLE_OK;
            }
        }
        rc = ldap_result((*li).ld, (*li).msgid, 0 as libc::c_int, tvp, &mut msg);
        if rc < 0 as libc::c_int {
            Curl_failf(
                data,
                b"LDAP local: bind ldap_result %s\0" as *const u8 as *const libc::c_char,
                ldap_err2string(rc),
            );
            return CURLE_LDAP_CANNOT_BIND;
        }
        ...
        proto = 2 as libc::c_int;
        ldap_set_option(
            (*li).ld,
            0x11 as libc::c_int,
            &mut proto as *mut libc::c_int as *const libc::c_void,
        );
        (*li).didbind = 0 as libc::c_int != 0;
    }
    if err != 0 {
        Curl_failf(
            data,
            b"LDAP remote: bind failed %s %s\0" as *const u8 as *const libc::c_char,
            ldap_err2string(rc),
            if !info.is_null() {
    ...
    let ref mut fresh4 = (*conn).recv[0 as libc::c_int as usize];
...
unsafe extern "C" fn oldap_do(
    ...
    let mut msgid: libc::c_int = 0;
    Curl_conncontrol(conn, 0 as libc::c_int);
    Curl_infof(
        data,
        b"LDAP local: %s\0" as *const u8 as *const libc::c_char,
        (*data).state.url,
    );
    ...
    if rc != 0 as libc::c_int {
        Curl_failf(
            data,
            b"LDAP local: ldap_search_ext %s\0" as *const u8 as *const libc::c_char,
            ldap_err2string(rc),
        );
    ...
    lr = Curl_ccalloc
        ...
        1 as libc::c_int as size_t,
        ::std::mem::size_of::<ldapreqinfo>() as libc::c_ulong,
    ) as *mut ldapreqinfo;
    if lr.is_null() {
        return CURLE_OUT_OF_MEMORY;
    }
...
unsafe extern "C" fn oldap_recv(
    ...
    rc = ldap_result((*li).ld, (*lr).msgid, 0x2 as libc::c_int, &mut tv, &mut msg);
    if rc < 0 as libc::c_int {
        Curl_failf(
            data,
            b"LDAP local: search ldap_result %s\0" as *const u8 as *const libc::c_char,
            ldap_err2string(rc),
        );
    ...
    *err = CURLE_AGAIN;
    ...
    while !ent.is_null() {
        ...
        let mut binary: libc::c_int = 0 as libc::c_int;
        let mut msgtype: libc::c_int = 0;
        let mut writeerr: CURLcode = CURLE_OK;
        msgtype = ldap_msgtype(ent);
        if msgtype as libc::c_ulong == 0x65 as libc::c_uint as ber_tag_t {
            ...
            } else if code != 0 && code != 0x4 as libc::c_int {
                Curl_failf(
                    data,
            ...
            if !(msgtype as libc::c_ulong != 0x64 as libc::c_uint as ber_tag_t) {
                ...
                *fresh10 = (*fresh10 as libc::c_ulong)
                    .wrapping_add(
                        (bv.bv_len).wrapping_add(5 as libc::c_int as libc::c_ulong),
                ...
                while rc == 0 as libc::c_int {
                    ...
                    if bv.bv_len > 7 as libc::c_int as libc::c_ulong
                        && strncmp(
                            (bv.bv_val)
                    ...
                    if bvals.is_null() {
                        ...
                        *fresh11 = (*fresh11 as libc::c_ulong)
                            .wrapping_add(
                                (bv.bv_len).wrapping_add(3 as libc::c_int as libc::c_ulong),
                            ) as curl_off_t as curl_off_t;
                    } else {
                        i = 0 as libc::c_int;
                        while !((*bvals.offset(i as isize)).bv_val).is_null() {
                            let mut binval: libc::c_int = 0 as libc::c_int;
                            writeerr = Curl_client_write(
                                data,
                                (1 as libc::c_int) << 0 as libc::c_int,
                                b"\t\0" as *const u8 as *const libc::c_char
                            ...
                            *fresh12 = (*fresh12 as libc::c_ulong)
                                .wrapping_add(
                                    (bv.bv_len).wrapping_add(2 as libc::c_int as libc::c_ulong),
                                ) as curl_off_t as curl_off_t;
                            if binary == 0 {
                                if Curl_isspace(
                            ...
                            if binary != 0 || binval != 0 {
                                let mut val_b64: *mut libc::c_char = 0 as *mut libc::c_char;
                                let mut val_b64_sz: size_t = 0 as libc::c_int as size_t;
                                ...
                                *fresh13 += 2 as libc::c_int as libc::c_long;
                                if val_b64_sz > 0 as libc::c_int as libc::c_ulong {
                                    writeerr = Curl_client_write(
                                        data,
                                        (1 as libc::c_int) << 0 as libc::c_int,
                                        val_b64,
...
unsafe extern "C" fn ldapsb_tls_remove(mut sbiod: *mut Sockbuf_IO_Desc) -> libc::c_int {
    let ref mut fresh20 = (*sbiod).sbiod_pvt;
    *fresh20 = 0 as *mut libc::c_void;
    return 0 as libc::c_int;
}
unsafe extern "C" fn ldapsb_tls_close(mut sbiod: *mut Sockbuf_IO_Desc) -> libc::c_int {
    return 0 as libc::c_int;
}
unsafe extern "C" fn ldapsb_tls_ctrl(
    ...
    if opt == 8 as libc::c_int {
        let mut data: *mut Curl_easy = (*sbiod).sbiod_pvt as *mut Curl_easy;
        return Curl_ssl_data_pending((*data).conn, 0 as libc::c_int) as libc::c_int;
    }
    return 0 as libc::c_int;
}
unsafe extern "C" fn ldapsb_tls_read(
    ...
    let mut data: *mut Curl_easy = (*sbiod).sbiod_pvt as *mut Curl_easy;
    let mut ret: ber_slen_t = 0 as libc::c_int as ber_slen_t;
    if !data.is_null() {
        let mut conn: *mut connectdata = (*data).conn;
        if !conn.is_null() {
            let mut li: *mut ldapconninfo = (*conn).proto.ldapc;
            ...
            ret = ((*li).recv)
                .expect(
                    "non-null function pointer",
                )(data, 0 as libc::c_int, buf as *mut libc::c_char, len, &mut err);
            if ret < 0 as libc::c_int as libc::c_long
                && err as libc::c_uint == CURLE_AGAIN as libc::c_int as libc::c_uint
            {
    ...
    if !data.is_null() {
        ...
        if !conn.is_null() {
            ...
            ret = ((*li).send)
                .expect(
                    "non-null function pointer",
                )(data, 0 as libc::c_int, buf, len, &mut err);
            if ret < 0 as libc::c_int as libc::c_long
                && err as libc::c_uint == CURLE_AGAIN as libc::c_int as libc::c_uint
            {
                *__errno_location() = 11 as libc::c_int;
...
static mut ldapsb_tls: Sockbuf_IO = unsafe {
    {
        let mut init = sockbuf_io {
            ...
            sbi_remove: Some(
                ldapsb_tls_remove
                    as unsafe extern "C" fn(*mut Sockbuf_IO_Desc) -> libc::c_int,
            ),
            sbi_ctrl: Some(
                ldapsb_tls_ctrl
                    as unsafe extern "C" fn(
