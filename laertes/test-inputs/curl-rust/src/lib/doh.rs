...
extern "C" {
    ...
    fn Curl_dyn_uptr(s: *const dynbuf) -> *mut libc::c_uchar;
...
pub type doh_slots = libc::c_uint;
...
pub struct dohentry {
    pub cname: [dynbuf; 4],
    pub addr: [dohaddr; 24],
    pub numaddr: libc::c_int,
    pub ttl: libc::c_uint,
    pub numcname: libc::c_int,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct dohaddr {
...
static mut errors: [*const libc::c_char; 14] = [
    b"\0" as *const u8 as *const libc::c_char,
    b"Bad label\0" as *const u8 as *const libc::c_char,
    b"Out of range\0" as *const u8 as *const libc::c_char,
    b"Label loop\0" as *const u8 as *const libc::c_char,
    b"Too small\0" as *const u8 as *const libc::c_char,
    b"Out of memory\0" as *const u8 as *const libc::c_char,
    b"RDATA length\0" as *const u8 as *const libc::c_char,
    b"Malformat\0" as *const u8 as *const libc::c_char,
    b"Bad RCODE\0" as *const u8 as *const libc::c_char,
    b"Unexpected TYPE\0" as *const u8 as *const libc::c_char,
    b"Unexpected CLASS\0" as *const u8 as *const libc::c_char,
    b"No content\0" as *const u8 as *const libc::c_char,
    b"Bad ID\0" as *const u8 as *const libc::c_char,
    b"Name too long\0" as *const u8 as *const libc::c_char,
];
unsafe extern "C" fn doh_strerror(mut code: DOHcode) -> *const libc::c_char {
    if code as libc::c_uint >= DOH_OK as libc::c_int as libc::c_uint
        && code as libc::c_uint <= DOH_DNS_NAME_TOO_LONG as libc::c_int as libc::c_uint
    {
        return errors[code as usize];
    }
    return b"bad error code\0" as *const u8 as *const libc::c_char;
}
unsafe extern "C" fn doh_encode(
    mut host: *const libc::c_char,
    mut dnstype: DNStype,
    mut dnsp: *mut libc::c_uchar,
    mut len: size_t,
    mut olen: *mut size_t,
) -> DOHcode {
    let hostlen: size_t = strlen(host);
    let mut orig: *mut libc::c_uchar = dnsp;
    let mut hostp: *const libc::c_char = host;
    let mut expected_len: size_t = 0;
    expected_len = ((12 as libc::c_int + 1 as libc::c_int) as libc::c_ulong)
        .wrapping_add(hostlen)
        .wrapping_add(4 as libc::c_int as libc::c_ulong);
    if *host.offset(hostlen.wrapping_sub(1 as libc::c_int as libc::c_ulong) as isize)
        as libc::c_int != '.' as i32
    {
        expected_len = expected_len.wrapping_add(1);
    }
    if expected_len > (256 as libc::c_int + 16 as libc::c_int) as libc::c_ulong {
    ...
    *fresh1 = 0 as libc::c_int as libc::c_uchar;
    let fresh2 = dnsp;
    dnsp = dnsp.offset(1);
    *fresh2 = 0x1 as libc::c_int as libc::c_uchar;
    let fresh3 = dnsp;
    dnsp = dnsp.offset(1);
    *fresh3 = '\u{0}' as i32 as libc::c_uchar;
    let fresh4 = dnsp;
    dnsp = dnsp.offset(1);
    *fresh4 = '\u{0}' as i32 as libc::c_uchar;
    let fresh5 = dnsp;
    dnsp = dnsp.offset(1);
    *fresh5 = 1 as libc::c_int as libc::c_uchar;
    let fresh6 = dnsp;
    dnsp = dnsp.offset(1);
    *fresh6 = '\u{0}' as i32 as libc::c_uchar;
    let fresh7 = dnsp;
    dnsp = dnsp.offset(1);
    *fresh7 = '\u{0}' as i32 as libc::c_uchar;
    let fresh8 = dnsp;
    dnsp = dnsp.offset(1);
    *fresh8 = '\u{0}' as i32 as libc::c_uchar;
    let fresh9 = dnsp;
    dnsp = dnsp.offset(1);
    *fresh9 = '\u{0}' as i32 as libc::c_uchar;
    let fresh10 = dnsp;
    dnsp = dnsp.offset(1);
    *fresh10 = '\u{0}' as i32 as libc::c_uchar;
    let fresh11 = dnsp;
    dnsp = dnsp.offset(1);
    *fresh11 = '\u{0}' as i32 as libc::c_uchar;
    while *hostp != 0 {
        let mut labellen: size_t = 0;
        let mut dot: *mut libc::c_char = strchr(hostp, '.' as i32);
        if !dot.is_null() {
            labellen = dot.offset_from(hostp) as libc::c_long as size_t;
        } else {
            labellen = strlen(hostp);
        }
        if labellen > 63 as libc::c_int as libc::c_ulong || labellen == 0 {
            *olen = 0 as libc::c_int as size_t;
            return DOH_DNS_BAD_LABEL;
        }
        let fresh12 = dnsp;
        dnsp = dnsp.offset(1);
        *fresh12 = labellen as libc::c_uchar;
    ...
    *fresh13 = 0 as libc::c_int as libc::c_uchar;
    let fresh14 = dnsp;
    dnsp = dnsp.offset(1);
    *fresh14 = (255 as libc::c_int as libc::c_uint
        & dnstype as libc::c_uint >> 8 as libc::c_int) as libc::c_uchar;
    let fresh15 = dnsp;
    dnsp = dnsp.offset(1);
    *fresh15 = (255 as libc::c_int as libc::c_uint & dnstype as libc::c_uint)
        as libc::c_uchar;
    let fresh16 = dnsp;
    dnsp = dnsp.offset(1);
    *fresh16 = '\u{0}' as i32 as libc::c_uchar;
    let fresh17 = dnsp;
    dnsp = dnsp.offset(1);
    *fresh17 = 0x1 as libc::c_int as libc::c_uchar;
    *olen = dnsp.offset_from(orig) as libc::c_long as size_t;
    return DOH_OK;
}
...
unsafe extern "C" fn doh_done(
    ...
    let ref mut fresh18 = (*dohp).pending;
    *fresh18 = (*fresh18).wrapping_sub(1);
    Curl_infof(
        data,
        b"a DoH request is completed, %u to go\0" as *const u8 as *const libc::c_char,
        (*dohp).pending,
    );
    if result as u64 != 0 {
        Curl_infof(
            data,
            b"DoH request %s\0" as *const u8 as *const libc::c_char,
            curl_easy_strerror(result),
        );
    }
    if (*dohp).pending == 0 {
        curl_slist_free_all((*dohp).headers);
        let ref mut fresh19 = (*dohp).headers;
...
unsafe extern "C" fn dohprobe(
    ...
    let mut nurl: *mut libc::c_char = 0 as *mut libc::c_char;
    ...
    if d as u64 != 0 {
        Curl_failf(
            data,
            b"Failed to encode DoH packet [%d]\0" as *const u8 as *const libc::c_char,
            d as libc::c_uint,
        );
        return CURLE_OUT_OF_MEMORY;
    }
    (*p).dnstype = dnstype as libc::c_int;
    Curl_dyn_init(&mut (*p).serverdoh, 3000 as libc::c_int as size_t);
    if ((*data).set).doh_get() != 0 {
        let mut b64: *mut libc::c_char = 0 as *mut libc::c_char;
        let mut b64len: size_t = 0;
        result = Curl_base64url_encode(
            data,
            ((*p).dohbuffer).as_mut_ptr() as *mut libc::c_char,
            (*p).dohlen,
            &mut b64,
            &mut b64len,
        );
        if result as u64 != 0 {
            ...
            nurl = curl_maprintf(
                b"%s?dns=%s\0" as *const u8 as *const libc::c_char,
                url,
                b64,
            );
                                    ...
                                    _ => {
                                                ...
                                                != CURLE_UNKNOWN_OPTION as libc::c_int as libc::c_uint)
                                        {
                                            result = curl_easy_setopt(
                                                ...
                                                CURL_HTTP_VERSION_2TLS as libc::c_int,
                                            );
                                            if !(result as libc::c_uint != 0
                                                && result as libc::c_uint
                                                    != CURLE_NOT_BUILT_IN as libc::c_int as libc::c_uint
                                                                            ...
                                                                            match current_block {
                                                                                ...
                                                                                _ => {
                                                                                    result = curl_easy_setopt(
                                                                                        ...
                                                                                        if ((*data).set).doh_verifyhost() as libc::c_int != 0 {
                                                                                            2 as libc::c_long
                                                                                        } else {
                                                                                            0 as libc::c_long
                                                                                        },
                                                                                            ...
                                                                                            != CURLE_UNKNOWN_OPTION as libc::c_int as libc::c_uint)
                                                                                    {
                                                                                        result = curl_easy_setopt(
                                                                                            ...
                                                                                            if ((*data).set).doh_verifypeer() as libc::c_int != 0 {
                                                                                                1 as libc::c_long
                                                                                            } else {
                                                                                                0 as libc::c_long
                                                                                            },
                                                                                                ...
                                                                                                != CURLE_UNKNOWN_OPTION as libc::c_int as libc::c_uint)
                                                                                        {
                                                                                            result = curl_easy_setopt(
                                                                                                ...
                                                                                                if ((*data).set).doh_verifystatus() as libc::c_int != 0 {
                                                                                                    1 as libc::c_long
                                                                                                } else {
                                                                                                    0 as libc::c_long
                                                                                                },
                                                                                                    ...
                                                                                                    _ => {
                                                                                                            ...
                                                                                                            .is_null()
                                                                                                        {
                                                                                                            result = curl_easy_setopt(
                                                                                                                doh,
                                                                                                                CURLOPT_CAINFO,
                                                                                                                (*data).set.str_0[STRING_SSL_CAFILE as libc::c_int as usize],
                                                                                                            );
                                                                                                            if result as libc::c_uint != 0
                                                                                                                && result as libc::c_uint
                                                                                                                    != CURLE_NOT_BUILT_IN as libc::c_int as libc::c_uint
                                                                                                        ...
                                                                                                        match current_block {
                                                                                                            17522434821883794170 => {}
                                                                                                            _ => {
                                                                                                                if !((*data).set.blobs[BLOB_CAINFO as libc::c_int as usize])
                                                                                                                    .is_null()
                                                                                                                {
                                                                                                                    result = curl_easy_setopt(
                                                                                                                        doh,
                                                                                                                        CURLOPT_CAINFO_BLOB,
                                                                                                                        (*data).set.blobs[BLOB_CAINFO as libc::c_int as usize],
                                                                                                                    );
                                                                                                                    if result as libc::c_uint != 0
                                                                                                                        && result as libc::c_uint
                                                                                                                            != CURLE_NOT_BUILT_IN as libc::c_int as libc::c_uint
                                                                                                                    ...
                                                                                                                    _ => {
                                                                                                                            ...
                                                                                                                            .is_null()
                                                                                                                        {
                                                                                                                            result = curl_easy_setopt(
                                                                                                                                doh,
                                                                                                                                CURLOPT_CAPATH,
                                                                                                                                (*data).set.str_0[STRING_SSL_CAPATH as libc::c_int as usize],
                                                                                                                            );
                                                                                                                            if result as libc::c_uint != 0
                                                                                                                                && result as libc::c_uint
                                                                                                                                    != CURLE_NOT_BUILT_IN as libc::c_int as libc::c_uint
                                                                                                                                                                        ...
                                                                                                                                                                        match current_block {
                                                                                                                                                                            ...
                                                                                                                                                                            _ => {
                                                                                                                                                                                ...
                                                                                                                                                                                match current_block {
                                                                                                                                                                                    17522434821883794170 => {}
                                                                                                                                                                                    _ => {
                                                                                                                                                                                        let mut mask: libc::c_long = ((if ((*data).set.ssl)
                                                                                                                                                                                            .enable_beast() as libc::c_int != 0
                                                                                                                                                                                        {
                                                                                                                                                                                            (1 as libc::c_int) << 0 as libc::c_int
                                                                                                                                                                                        } else {
                                                                                                                                                                                            0 as libc::c_int
                                                                                                                                                                                        })
                                                                                                                                                                                            | (if ((*data).set.ssl).no_revoke() as libc::c_int != 0 {
                                                                                                                                                                                                (1 as libc::c_int) << 1 as libc::c_int
                                                                                                                                                                                            } else {
                                                                                                                                                                                                0 as libc::c_int
                                                                                                                                                                                            })
                                                                                                                                                                                            | (if ((*data).set.ssl).no_partialchain() as libc::c_int
                                                                                                                                                                                                != 0
                                                                                                                                                                                            {
                                                                                                                                                                                            ...
                                                                                                                                                                                            | (if ((*data).set.ssl).revoke_best_effort() as libc::c_int
                                                                                                                                                                                                != 0
                                                                                                                                                                                            {
                                                                                                                                                                                            ...
                                                                                                                                                                                            | (if ((*data).set.ssl).native_ca_store() as libc::c_int
                                                                                                                                                                                                != 0
                                                                                                                                                                                            {
                                                                                                                                                                                            ...
                                                                                                                                                                                            | (if ((*data).set.ssl).auto_client_cert() as libc::c_int
                                                                                                                                                                                                != 0
                                                                                                                                                                                            {
                                                                                                                                                                                        ...
                                                                                                                                                                                        let ref mut fresh20 = (*doh).set.fmultidone;
                                                                                                                                                                                        *fresh20 = Some(
                                                                                                                                                                                            doh_done
                                                                                                                                                                                                as unsafe extern "C" fn(
                                                                                                                                                                                                    *mut Curl_easy,
                                                                                                                                                                                        ...
                                                                                                                                                                                        let ref mut fresh21 = (*doh).set.dohfor;
                                                                                                                                                                                        *fresh21 = data;
                                                                                                                                                                                        let ref mut fresh22 = (*p).easy;
                                                                                                                                                                                        *fresh22 = doh;
...
pub unsafe extern "C" fn Curl_doh(
    ...
    *waitp = 1 as libc::c_int;
    let ref mut fresh23 = (*data).req.doh;
    *fresh23 = Curl_ccalloc
        .expect(
            "non-null function pointer",
        )(::std::mem::size_of::<dohdata>() as libc::c_ulong, 1 as libc::c_int as size_t)
        as *mut dohdata;
    dohp = *fresh23;
    if dohp.is_null() {
    ...
    (*fresh24).set_doh(1 as libc::c_int as bit);
    let ref mut fresh25 = (*dohp).host;
    *fresh25 = hostname;
    (*dohp).port = port;
    let ref mut fresh26 = (*dohp).headers;
    *fresh26 = curl_slist_append(
        0 as *mut curl_slist,
        b"Content-Type: application/dns-message\0" as *const u8 as *const libc::c_char,
    );
    if !((*dohp).headers).is_null() {
        result = dohprobe(
            ...
            &mut *((*dohp).probe)
                .as_mut_ptr()
                .offset(DOH_PROBE_SLOT_IPADDR_V4 as libc::c_int as isize),
            DNS_TYPE_A,
            hostname,
            (*data).set.str_0[STRING_DOH as libc::c_int as usize],
            (*data).multi,
            (*dohp).headers,
        );
        if !(result as u64 != 0) {
            let ref mut fresh27 = (*dohp).pending;
            *fresh27 = (*fresh27).wrapping_add(1);
            if Curl_ipv6works(data) {
                result = dohprobe(
                    ...
                    &mut *((*dohp).probe)
                        .as_mut_ptr()
                        .offset(DOH_PROBE_SLOT_IPADDR_V6 as libc::c_int as isize),
                    DNS_TYPE_AAAA,
                    hostname,
                    (*data).set.str_0[STRING_DOH as libc::c_int as usize],
                    (*data).multi,
                ...
                if result as u64 != 0 {
                    ...
                    let ref mut fresh28 = (*dohp).pending;
    ...
    curl_slist_free_all((*dohp).headers);
    let ref mut fresh29 = (*(*data).req.doh).headers;
    *fresh29 = 0 as *mut curl_slist;
    slot = 0 as libc::c_int;
    while slot < DOH_PROBE_SLOTS as libc::c_int {
    ...
    let ref mut fresh30 = (*data).req.doh;
    *fresh30 = 0 as *mut dohdata;
    return 0 as *mut Curl_addrinfo;
}
unsafe extern "C" fn skipqname(
    mut doh: *const libc::c_uchar,
    mut dohlen: size_t,
    mut indexp: *mut libc::c_uint,
) -> DOHcode {
    let mut length: libc::c_uchar = 0;
    loop {
        if dohlen
            < (*indexp).wrapping_add(1 as libc::c_int as libc::c_uint) as libc::c_ulong
        {
            return DOH_DNS_OUT_OF_RANGE;
        }
        length = *doh.offset(*indexp as isize);
        if length as libc::c_int & 0xc0 as libc::c_int == 0xc0 as libc::c_int {
            if dohlen
                < (*indexp).wrapping_add(2 as libc::c_int as libc::c_uint)
                    as libc::c_ulong
            {
                return DOH_DNS_OUT_OF_RANGE;
            }
            *indexp = (*indexp).wrapping_add(2 as libc::c_int as libc::c_uint);
            break;
        } else {
            if length as libc::c_int & 0xc0 as libc::c_int != 0 {
                return DOH_DNS_BAD_LABEL;
            }
            if dohlen
                < (*indexp)
                    .wrapping_add(1 as libc::c_int as libc::c_uint)
                    .wrapping_add(length as libc::c_uint) as libc::c_ulong
            {
                return DOH_DNS_OUT_OF_RANGE;
            }
            *indexp = (*indexp)
                .wrapping_add(
                    (1 as libc::c_int + length as libc::c_int) as libc::c_uint,
                );
            if !(length != 0) {
                break;
            }
...
unsafe extern "C" fn get16bit(
    ...
    return ((*doh.offset(index as isize) as libc::c_int) << 8 as libc::c_int
        | *doh.offset((index + 1 as libc::c_int) as isize) as libc::c_int)
        as libc::c_ushort;
}
unsafe extern "C" fn get32bit(
    ...
    return (*doh.offset(0 as libc::c_int as isize) as libc::c_uint) << 24 as libc::c_int
        | ((*doh.offset(1 as libc::c_int as isize) as libc::c_int) << 16 as libc::c_int)
            as libc::c_uint
        | ((*doh.offset(2 as libc::c_int as isize) as libc::c_int) << 8 as libc::c_int)
            as libc::c_uint | *doh.offset(3 as libc::c_int as isize) as libc::c_uint;
}
unsafe extern "C" fn store_a(
    ...
    if (*d).numaddr < 24 as libc::c_int {
        let mut a: *mut dohaddr = &mut *((*d).addr)
            .as_mut_ptr()
            .offset((*d).numaddr as isize) as *mut dohaddr;
        (*a).type_0 = DNS_TYPE_A as libc::c_int;
        memcpy(
            &mut (*a).ip.v4 as *mut [libc::c_uchar; 4] as *mut libc::c_void,
            &*doh.offset(index as isize) as *const libc::c_uchar as *const libc::c_void,
            4 as libc::c_int as libc::c_ulong,
        );
        let ref mut fresh31 = (*d).numaddr;
        *fresh31 += 1;
    }
    return DOH_OK;
}
unsafe extern "C" fn store_aaaa(
    ...
    if (*d).numaddr < 24 as libc::c_int {
        let mut a: *mut dohaddr = &mut *((*d).addr)
            .as_mut_ptr()
            .offset((*d).numaddr as isize) as *mut dohaddr;
        (*a).type_0 = DNS_TYPE_AAAA as libc::c_int;
        memcpy(
            &mut (*a).ip.v6 as *mut [libc::c_uchar; 16] as *mut libc::c_void,
            &*doh.offset(index as isize) as *const libc::c_uchar as *const libc::c_void,
            16 as libc::c_int as libc::c_ulong,
        );
        let ref mut fresh32 = (*d).numaddr;
        *fresh32 += 1;
    }
    return DOH_OK;
}
unsafe extern "C" fn store_cname(
    ...
    let mut loop_0: libc::c_uint = 128 as libc::c_int as libc::c_uint;
    let mut length: libc::c_uchar = 0;
    if (*d).numcname == 4 as libc::c_int {
        return DOH_OK;
    }
    let ref mut fresh33 = (*d).numcname;
    let fresh34 = *fresh33;
    *fresh33 = *fresh33 + 1;
    c = &mut *((*d).cname).as_mut_ptr().offset(fresh34 as isize) as *mut dynbuf;
    loop {
        if index as libc::c_ulong >= dohlen {
            return DOH_DNS_OUT_OF_RANGE;
        }
        length = *doh.offset(index as isize);
        if length as libc::c_int & 0xc0 as libc::c_int == 0xc0 as libc::c_int {
            let mut newpos: libc::c_int = 0;
            if index.wrapping_add(1 as libc::c_int as libc::c_uint) as libc::c_ulong
                >= dohlen
            {
                return DOH_DNS_OUT_OF_RANGE;
            }
            newpos = (length as libc::c_int & 0x3f as libc::c_int) << 8 as libc::c_int
                | *doh
                    .offset(
                        index.wrapping_add(1 as libc::c_int as libc::c_uint) as isize,
                    ) as libc::c_int;
            index = newpos as libc::c_uint;
        } else {
            if length as libc::c_int & 0xc0 as libc::c_int != 0 {
                return DOH_DNS_BAD_LABEL
            } else {
            ...
            if length != 0 {
                if Curl_dyn_len(c) != 0 {
                    if Curl_dyn_add(c, b".\0" as *const u8 as *const libc::c_char) as u64
                        != 0
                    {
                        return DOH_OUT_OF_MEM;
                    }
                }
                if index.wrapping_add(length as libc::c_uint) as libc::c_ulong > dohlen {
                    return DOH_DNS_BAD_LABEL;
                }
                if Curl_dyn_addn(
                    c,
                    &*doh.offset(index as isize) as *const libc::c_uchar
                ...
                index = index.wrapping_add(length as libc::c_uint);
            }
        }
        if !(length as libc::c_int != 0
            && {
...
unsafe extern "C" fn rdata(
    ...
    match type_0 as libc::c_int {
        ...
        5 => {
            rc = store_cname(doh, dohlen, index as libc::c_uint, d);
            if rc as u64 != 0 {
                return rc;
            }
        }
...
unsafe extern "C" fn de_init(mut de: *mut dohentry) {
    ...
    memset(
        ...
        0 as libc::c_int,
        ::std::mem::size_of::<dohentry>() as libc::c_ulong,
    );
    (*de).ttl = 2147483647 as libc::c_int as libc::c_uint;
    i = 0 as libc::c_int;
...
unsafe extern "C" fn doh_decode(
    ...
    let mut rcode: libc::c_uchar = 0;
    let mut qdcount: libc::c_ushort = 0;
    let mut ancount: libc::c_ushort = 0;
    let mut type_0: libc::c_ushort = 0 as libc::c_int as libc::c_ushort;
    let mut rdlength: libc::c_ushort = 0;
    let mut nscount: libc::c_ushort = 0;
    let mut arcount: libc::c_ushort = 0;
    let mut index: libc::c_uint = 12 as libc::c_int as libc::c_uint;
    let mut rc: DOHcode = DOH_OK;
    if dohlen < 12 as libc::c_int as libc::c_ulong {
        return DOH_TOO_SMALL_BUFFER;
    }
    if doh.is_null() || *doh.offset(0 as libc::c_int as isize) as libc::c_int != 0
        || *doh.offset(1 as libc::c_int as isize) as libc::c_int != 0
    {
        return DOH_DNS_BAD_ID;
    }
    rcode = (*doh.offset(3 as libc::c_int as isize) as libc::c_int & 0xf as libc::c_int)
        as libc::c_uchar;
    if rcode != 0 {
        return DOH_DNS_BAD_RCODE;
    }
    qdcount = get16bit(doh, 4 as libc::c_int);
    while qdcount != 0 {
        rc = skipqname(doh, dohlen, &mut index);
        if rc as u64 != 0 {
            return rc;
        }
        if dohlen < index.wrapping_add(4 as libc::c_int as libc::c_uint) as libc::c_ulong
        {
            return DOH_DNS_OUT_OF_RANGE;
        }
        index = index.wrapping_add(4 as libc::c_int as libc::c_uint);
        qdcount = qdcount.wrapping_sub(1);
    }
    ancount = get16bit(doh, 6 as libc::c_int);
    while ancount != 0 {
        let mut class: libc::c_ushort = 0;
        let mut ttl: libc::c_uint = 0;
        rc = skipqname(doh, dohlen, &mut index);
        if rc as u64 != 0 {
            return rc;
        }
        if dohlen < index.wrapping_add(2 as libc::c_int as libc::c_uint) as libc::c_ulong
        {
            return DOH_DNS_OUT_OF_RANGE;
        }
        type_0 = get16bit(doh, index as libc::c_int);
        if type_0 as libc::c_int != DNS_TYPE_CNAME as libc::c_int
            && type_0 as libc::c_int != DNS_TYPE_DNAME as libc::c_int
            && type_0 as libc::c_uint != dnstype as libc::c_uint
        {
            return DOH_DNS_UNEXPECTED_TYPE;
        }
        index = index.wrapping_add(2 as libc::c_int as libc::c_uint);
        if dohlen < index.wrapping_add(2 as libc::c_int as libc::c_uint) as libc::c_ulong
        {
            return DOH_DNS_OUT_OF_RANGE;
        }
        class = get16bit(doh, index as libc::c_int);
        if 0x1 as libc::c_int != class as libc::c_int {
        ...
        ttl = get32bit(doh, index as libc::c_int);
        if ttl < (*d).ttl {
            (*d).ttl = ttl;
        }
        index = index.wrapping_add(4 as libc::c_int as libc::c_uint);
        ...
        rdlength = get16bit(doh, index as libc::c_int);
        index = index.wrapping_add(2 as libc::c_int as libc::c_uint);
        if dohlen < index.wrapping_add(rdlength as libc::c_uint) as libc::c_ulong {
            return DOH_DNS_OUT_OF_RANGE;
        }
        rc = rdata(doh, dohlen, rdlength, type_0, index as libc::c_int, d);
        if rc as u64 != 0 {
            return rc;
        }
        index = index.wrapping_add(rdlength as libc::c_uint);
        ancount = ancount.wrapping_sub(1);
    }
    nscount = get16bit(doh, 8 as libc::c_int);
    while nscount != 0 {
        rc = skipqname(doh, dohlen, &mut index);
        if rc as u64 != 0 {
            return rc;
        }
        if dohlen < index.wrapping_add(8 as libc::c_int as libc::c_uint) as libc::c_ulong
        {
            return DOH_DNS_OUT_OF_RANGE;
        }
        index = index
            .wrapping_add(
                (2 as libc::c_int + 2 as libc::c_int + 4 as libc::c_int) as libc::c_uint,
            );
        if dohlen < index.wrapping_add(2 as libc::c_int as libc::c_uint) as libc::c_ulong
        {
            return DOH_DNS_OUT_OF_RANGE;
    ...
    arcount = get16bit(doh, 10 as libc::c_int);
    while arcount != 0 {
        rc = skipqname(doh, dohlen, &mut index);
        if rc as u64 != 0 {
            return rc;
    ...
    if type_0 as libc::c_int != DNS_TYPE_NS as libc::c_int && (*d).numcname == 0
        && (*d).numaddr == 0
    {
...
unsafe extern "C" fn showdoh(mut data: *mut Curl_easy, mut d: *const dohentry) {
    let mut i: libc::c_int = 0;
    Curl_infof(data, b"TTL: %u seconds\0" as *const u8 as *const libc::c_char, (*d).ttl);
    i = 0 as libc::c_int;
    while i < (*d).numaddr {
        let mut a: *const dohaddr = &*((*d).addr).as_ptr().offset(i as isize)
            as *const dohaddr;
        if (*a).type_0 == DNS_TYPE_A as libc::c_int {
            Curl_infof(
                data,
                b"DoH A: %u.%u.%u.%u\0" as *const u8 as *const libc::c_char,
                (*a).ip.v4[0 as libc::c_int as usize] as libc::c_int,
                (*a).ip.v4[1 as libc::c_int as usize] as libc::c_int,
                (*a).ip.v4[2 as libc::c_int as usize] as libc::c_int,
                (*a).ip.v4[3 as libc::c_int as usize] as libc::c_int,
            );
        } else if (*a).type_0 == DNS_TYPE_AAAA as libc::c_int {
            ...
            curl_msnprintf(
                ...
                b"DoH AAAA: \0" as *const u8 as *const libc::c_char,
            );
            ptr = &mut *buffer.as_mut_ptr().offset(10 as libc::c_int as isize)
                as *mut libc::c_char;
            len = 118 as libc::c_int as size_t;
            j = 0 as libc::c_int;
            while j < 16 as libc::c_int {
                ...
                curl_msnprintf(
                    ptr,
                    len,
                    b"%s%02x%02x\0" as *const u8 as *const libc::c_char,
                    if j != 0 {
                        b":\0" as *const u8 as *const libc::c_char
                    } else {
                        b"\0" as *const u8 as *const libc::c_char
                    },
                    (*d).addr[i as usize].ip.v6[j as usize] as libc::c_int,
                    (*d).addr[i as usize].ip.v6[(j + 1 as libc::c_int) as usize]
                        as libc::c_int,
                );
                l = strlen(ptr);
    ...
    while i < (*d).numcname {
        Curl_infof(
            data,
            b"CNAME: %s\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn doh2ai(
    ...
    while i < (*de).numaddr {
        ...
        if (*de).addr[i as usize].type_0 == DNS_TYPE_AAAA as libc::c_int {
            ss_size = ::std::mem::size_of::<sockaddr_in6>() as libc::c_ulong;
            addrtype = 10 as libc::c_int as sa_family_t;
        } else {
            ss_size = ::std::mem::size_of::<sockaddr_in>() as libc::c_ulong;
            addrtype = 2 as libc::c_int as sa_family_t;
        }
        ai = Curl_ccalloc
            .expect(
                "non-null function pointer",
        ...
        if ai.is_null() {
            ...
            let ref mut fresh35 = (*ai).ai_addr;
            *fresh35 = (ai as *mut libc::c_char)
                .offset(::std::mem::size_of::<Curl_addrinfo>() as libc::c_ulong as isize)
                as *mut libc::c_void as *mut sockaddr;
            let ref mut fresh36 = (*ai).ai_canonname;
            *fresh36 = ((*ai).ai_addr as *mut libc::c_char).offset(ss_size as isize)
            ...
            if !prevai.is_null() {
                let ref mut fresh37 = (*prevai).ai_next;
                *fresh37 = ai;
            }
            (*ai).ai_family = addrtype as libc::c_int;
                ...
                2 => {
                    ...
                    memcpy(
                        ...
                        &(*((*de).addr).as_ptr().offset(i as isize)).ip.v4
                            as *const [libc::c_uchar; 4] as *const libc::c_void,
                ...
                10 => {
                    ...
                    memcpy(
                        ...
                        &(*((*de).addr).as_ptr().offset(i as isize)).ip.v6
                            as *const [libc::c_uchar; 16] as *const libc::c_void,
...
unsafe extern "C" fn type2name(mut dnstype: DNStype) -> *const libc::c_char {
    return if dnstype as libc::c_uint == DNS_TYPE_A as libc::c_int as libc::c_uint {
...
pub unsafe extern "C" fn Curl_doh_is_resolved(
    ...
    *dnsp = 0 as *mut Curl_dns_entry;
    ...
    if ((*dohp).probe[DOH_PROBE_SLOT_IPADDR_V4 as libc::c_int as usize].easy).is_null()
        && ((*dohp).probe[DOH_PROBE_SLOT_IPADDR_V6 as libc::c_int as usize].easy)
            .is_null()
    {
        Curl_failf(
            data,
            b"Could not DoH-resolve: %s\0" as *const u8 as *const libc::c_char,
            (*data).state.async_0.hostname,
        );
        return (if ((*(*data).conn).bits).proxy() as libc::c_int != 0 {
            CURLE_COULDNT_RESOLVE_PROXY as libc::c_int
        } else {
            CURLE_COULDNT_RESOLVE_HOST as libc::c_int
        }) as CURLcode;
    } else {
        if (*dohp).pending == 0 {
            ...
            if rc[DOH_PROBE_SLOT_IPADDR_V4 as libc::c_int as usize] as u64 == 0
                || rc[DOH_PROBE_SLOT_IPADDR_V6 as libc::c_int as usize] as u64 == 0
            {
                let mut dns: *mut Curl_dns_entry = 0 as *mut Curl_dns_entry;
                let mut ai: *mut Curl_addrinfo = 0 as *mut Curl_addrinfo;
                Curl_infof(
                    data,
                    b"DoH Host name: %s\0" as *const u8 as *const libc::c_char,
                    (*dohp).host,
                );
                showdoh(data, &mut de);
                ...
                if dns.is_null() {
                    ...
                    let ref mut fresh38 = (*data).state.async_0.dns;
                    *fresh38 = dns;
                    *dnsp = dns;
                    result = CURLE_OK;
                }
            ...
            let ref mut fresh39 = (*data).req.doh;
