...
extern "C" {
    ...
    fn curlx_ultouc(ulnum: libc::c_ulong) -> libc::c_uchar;
    fn curl_msnprintf(
...
static mut base64url: [libc::c_char; 65] = unsafe {
    *::std::mem::transmute::<
        &[u8; 65],
        &[libc::c_char; 65],
    >(b"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_\0")
};
unsafe extern "C" fn decodeQuantum(
    mut dest: *mut libc::c_uchar,
    mut src: *const libc::c_char,
) -> size_t {
    let mut padding: size_t = 0 as libc::c_int as size_t;
    let mut s: *const libc::c_char = 0 as *const libc::c_char;
    let mut p: *const libc::c_char = 0 as *const libc::c_char;
    let mut i: libc::c_ulong = 0;
    let mut x: libc::c_ulong = 0 as libc::c_int as libc::c_ulong;
    ...
    while i < 4 as libc::c_int as libc::c_ulong {
        if *s as libc::c_int == '=' as i32 {
            ...
            p = base64.as_ptr();
            while *p as libc::c_int != 0 && *p as libc::c_int != *s as libc::c_int {
                v = v.wrapping_add(1);
                p = p.offset(1);
            }
            if *p as libc::c_int == *s as libc::c_int {
                x = (x << 6 as libc::c_int).wrapping_add(v);
            } else {
    ...
    if padding < 1 as libc::c_int as libc::c_ulong {
        *dest
            .offset(2 as libc::c_int as isize) = curlx_ultouc(x & 0xff as libc::c_ulong);
    }
    x >>= 8 as libc::c_int;
    if padding < 2 as libc::c_int as libc::c_ulong {
        *dest
            .offset(1 as libc::c_int as isize) = curlx_ultouc(x & 0xff as libc::c_ulong);
    }
    x >>= 8 as libc::c_int;
    *dest.offset(0 as libc::c_int as isize) = curlx_ultouc(x & 0xff as libc::c_ulong);
    return (3 as libc::c_int as libc::c_ulong).wrapping_sub(padding);
}
#[no_mangle]
pub unsafe extern "C" fn Curl_base64_decode(
    mut src: *const libc::c_char,
    mut outptr: *mut *mut libc::c_uchar,
    mut outlen: *mut size_t,
) -> CURLcode {
    let mut srclen: size_t = 0 as libc::c_int as size_t;
    let mut length: size_t = 0 as libc::c_int as size_t;
    let mut padding: size_t = 0 as libc::c_int as size_t;
    let mut i: size_t = 0;
    let mut numQuantums: size_t = 0;
    let mut rawlen: size_t = 0 as libc::c_int as size_t;
    let mut pos: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut newstr: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    *outptr = 0 as *mut libc::c_uchar;
    *outlen = 0 as libc::c_int as size_t;
    srclen = strlen(src);
    if srclen == 0 || srclen.wrapping_rem(4 as libc::c_int as libc::c_ulong) != 0 {
        return CURLE_BAD_CONTENT_ENCODING;
    }
    while *src.offset(length as isize) as libc::c_int != '=' as i32
        && *src.offset(length as isize) as libc::c_int != 0
    {
        length = length.wrapping_add(1);
    }
    if *src.offset(length as isize) as libc::c_int == '=' as i32 {
        padding = padding.wrapping_add(1);
        if *src.offset(length.wrapping_add(1 as libc::c_int as libc::c_ulong) as isize)
            as libc::c_int == '=' as i32
        {
            padding = padding.wrapping_add(1);
        }
    }
    if length.wrapping_add(padding) != srclen {
        return CURLE_BAD_CONTENT_ENCODING;
    }
    numQuantums = srclen.wrapping_div(4 as libc::c_int as libc::c_ulong);
    rawlen = numQuantums
    ...
    newstr = Curl_cmalloc
        ...
        )(rawlen.wrapping_add(1 as libc::c_int as libc::c_ulong)) as *mut libc::c_uchar;
    if newstr.is_null() {
    ...
    while i < numQuantums {
        let mut result: size_t = decodeQuantum(pos, src);
        if result == 0 {
            Curl_cfree.expect("non-null function pointer")(newstr as *mut libc::c_void);
            return CURLE_BAD_CONTENT_ENCODING;
        }
        pos = pos.offset(result as isize);
        src = src.offset(4 as libc::c_int as isize);
        i = i.wrapping_add(1);
    }
    *pos = '\u{0}' as i32 as libc::c_uchar;
    *outptr = newstr;
    *outlen = rawlen;
    return CURLE_OK;
}
unsafe extern "C" fn base64_encode(
    mut table64: *const libc::c_char,
    mut data: *mut Curl_easy,
    mut inputbuff: *const libc::c_char,
    mut insize: size_t,
    mut outptr: *mut *mut libc::c_char,
    mut outlen: *mut size_t,
) -> CURLcode {
    let mut result: CURLcode = CURLE_OK;
    let mut ibuf: [libc::c_uchar; 3] = [0; 3];
    let mut obuf: [libc::c_uchar; 4] = [0; 4];
    let mut i: libc::c_int = 0;
    let mut inputparts: libc::c_int = 0;
    let mut output: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut base64data: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut convbuf: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut indata: *const libc::c_char = inputbuff;
    *outptr = 0 as *mut libc::c_char;
    *outlen = 0 as libc::c_int as size_t;
    if insize == 0 {
    ...
    while insize > 0 as libc::c_int as libc::c_ulong {
        inputparts = 0 as libc::c_int;
        i = inputparts;
        while i < 3 as libc::c_int {
            if insize > 0 as libc::c_int as libc::c_ulong {
                inputparts += 1;
                ibuf[i as usize] = *indata as libc::c_uchar;
                indata = indata.offset(1);
                insize = insize.wrapping_sub(1);
            } else {
                ibuf[i as usize] = 0 as libc::c_int as libc::c_uchar;
            }
            i += 1;
        }
        obuf[0 as libc::c_int
            as usize] = ((ibuf[0 as libc::c_int as usize] as libc::c_int
            & 0xfc as libc::c_int) >> 2 as libc::c_int) as libc::c_uchar;
        obuf[1 as libc::c_int
            as usize] = ((ibuf[0 as libc::c_int as usize] as libc::c_int
            & 0x3 as libc::c_int) << 4 as libc::c_int
            | (ibuf[1 as libc::c_int as usize] as libc::c_int & 0xf0 as libc::c_int)
                >> 4 as libc::c_int) as libc::c_uchar;
        obuf[2 as libc::c_int
            as usize] = ((ibuf[1 as libc::c_int as usize] as libc::c_int
            & 0xf as libc::c_int) << 2 as libc::c_int
            | (ibuf[2 as libc::c_int as usize] as libc::c_int & 0xc0 as libc::c_int)
                >> 6 as libc::c_int) as libc::c_uchar;
        obuf[3 as libc::c_int
            as usize] = (ibuf[2 as libc::c_int as usize] as libc::c_int
        ...
        match inputparts {
            1 => {
                curl_msnprintf(
                    ...
                    *table64.offset(obuf[0 as libc::c_int as usize] as isize)
                        as libc::c_int,
                    *table64.offset(obuf[1 as libc::c_int as usize] as isize)
                        as libc::c_int,
                );
            }
            2 => {
                curl_msnprintf(
                    ...
                    *table64.offset(obuf[1 as libc::c_int as usize] as isize)
                        as libc::c_int,
                    *table64.offset(obuf[2 as libc::c_int as usize] as isize)
                        as libc::c_int,
                );
            }
            _ => {
                curl_msnprintf(
                    ...
                    *table64.offset(obuf[2 as libc::c_int as usize] as isize)
                        as libc::c_int,
                    *table64.offset(obuf[3 as libc::c_int as usize] as isize)
                        as libc::c_int,
                );
            }
        }
        output = output.offset(4 as libc::c_int as isize);
    }
    *output = '\u{0}' as i32 as libc::c_char;
    *outptr = base64data;
    Curl_cfree.expect("non-null function pointer")(convbuf as *mut libc::c_void);
    *outlen = strlen(base64data);
    return CURLE_OK;
}
#[no_mangle]
pub unsafe extern "C" fn Curl_base64_encode(
    mut data: *mut Curl_easy,
    mut inputbuff: *const libc::c_char,
    mut insize: size_t,
    mut outptr: *mut *mut libc::c_char,
    ...
    return base64_encode(base64.as_ptr(), data, inputbuff, insize, outptr, outlen);
}
#[no_mangle]
pub unsafe extern "C" fn Curl_base64url_encode(
    mut data: *mut Curl_easy,
    mut inputbuff: *const libc::c_char,
    mut insize: size_t,
    mut outptr: *mut *mut libc::c_char,
    ...
    return base64_encode(base64url.as_ptr(), data, inputbuff, insize, outptr, outlen);
}
