...
pub use crate::src::arraylist::array_list_add;
pub use crate::src::arraylist::array_list_bsearch;
pub use crate::src::arraylist::array_list_del_idx;
pub use crate::src::arraylist::array_list_free;
pub use crate::src::arraylist::array_list_get_idx;
pub use crate::src::arraylist::array_list_length;
pub use crate::src::arraylist::array_list_new2;
pub use crate::src::arraylist::array_list_put_idx;
pub use crate::src::arraylist::array_list_shrink;
pub use crate::src::arraylist::array_list_sort;
pub use crate::src::json_util::_json_c_set_last_err;
pub use crate::src::json_util::json_parse_int64;
pub use crate::src::json_util::json_parse_uint64;
pub use crate::src::linkhash::lh_kchar_table_new;
pub use crate::src::linkhash::lh_table_delete;
pub use crate::src::linkhash::lh_table_free;
pub use crate::src::linkhash::lh_table_insert_w_hash;
pub use crate::src::linkhash::lh_table_length;
pub use crate::src::linkhash::lh_table_lookup_entry_w_hash;
pub use crate::src::linkhash::lh_table_lookup_ex;
...
impl std::default::Default for json_object_iter {
    fn default() -> Self { json_object_iter::new() }
}
...
pub struct json_object {
    pub o_type: u32,
    pub _ref_count: u32,
    pub _to_json_string: Option<unsafe extern "C"  fn(_: * mut crate::src::json_object::json_object,_: * mut crate::src::apps::json_parse::printbuf,_: i32,_: i32,) -> i32>,
    pub _pb: * mut crate::src::apps::json_parse::printbuf,
    pub _user_delete: Option<unsafe extern "C"  fn(_: * mut crate::src::json_object::json_object,_: * mut core::ffi::c_void,) -> ()>,
...
impl std::default::Default for json_object {
    fn default() -> Self { json_object::new() }
}
...
pub type array_list_free_fn<'a1> = unsafe extern "C"  fn(_: Option<&'a1 mut core::ffi::c_void>,) -> ();
#[derive(Copy, Clone)]
#[repr(C)]
...
impl std::default::Default for json_object_array {
    fn default() -> Self { json_object_array::new() }
}
...
pub struct lh_table {
    ...
    pub equal_fn: Option<unsafe extern "C"  fn(_: * const core::ffi::c_void,_: * const core::ffi::c_void,) -> i32>,
}
impl lh_table {
    pub const fn new() -> Self {
        lh_table {
...
impl std::default::Default for json_object_object {
    fn default() -> Self { json_object_object::new() }
}
...
impl std::default::Default for json_object_double {
    fn default() -> Self { json_object_double::new() }
}
...
impl std::default::Default for json_object_boolean {
    fn default() -> Self { json_object_boolean::new() }
}
...
pub type _IO_lock_t = ();
pub type json_c_shallow_copy_fn<'a1, 'a2, 'a3, 'a4, 'a5> = unsafe extern "C"  fn(_: Option<&'a1 mut crate::src::json_object::json_object>,_: Option<&'a2 mut crate::src::json_object::json_object>,_: Option<&'a3 i8>,_: u64,_: Option<&'a4 mut Option<&'a5 mut crate::src::json_object::json_object>>,) -> i32;
#[inline]
...
#[inline]
unsafe extern "C" fn lh_entry_k_is_constant(mut e: * const crate::src::json_object::lh_entry) -> i32 {
...
#[no_mangle]
pub static mut json_hex_chars: * const i8 = b"0123456789abcdefABCDEF\0"
    as *const u8 as *const i8;
#[inline]
 extern "C" fn JC_OBJECT(mut jso: * mut crate::src::json_object::json_object) -> * mut crate::src::json_object::json_object_object {
...
#[inline]
 extern "C" fn JC_ARRAY(mut jso: * mut crate::src::json_object::json_object) -> * mut crate::src::json_object::json_object_array {
...
#[inline]
 extern "C" fn JC_BOOL(mut jso: * mut crate::src::json_object::json_object) -> * mut crate::src::json_object::json_object_boolean {
...
#[inline]
 extern "C" fn JC_DOUBLE(mut jso: * mut crate::src::json_object::json_object) -> * mut crate::src::json_object::json_object_double {
...
#[inline]
 extern "C" fn JC_INT(mut jso: * mut crate::src::json_object::json_object) -> * mut crate::src::json_object::json_object_int {
    return jso as *mut libc::c_void as *mut json_object_int;
}
#[inline]
 extern "C" fn JC_INT_C(mut jso: * const crate::src::json_object::json_object) -> * const crate::src::json_object::json_object_int {
    return jso as *const libc::c_void as *const json_object_int;
}
#[inline]
 extern "C" fn JC_STRING(mut jso: * mut crate::src::json_object::json_object) -> * mut crate::src::json_object::json_object_string {
...
unsafe extern "C" fn get_string_component_mutable(
    ...
    if (*JC_STRING_C(jso)).len < 0 as i32 as i64 {
...
unsafe extern "C" fn json_escape_str(
    ...
    while len != 0 {
        ...
        c = *str.offset(pos as isize) as u8;
        match c as i32 {
            ...
            _ => {
                if (c as i32) < ' ' as i32 {
                    ...
                    snprintf(
                        ...
                        *json_hex_chars
                            .offset((c as i32 >> 4 as i32) as isize)
                            as i32,
                        *json_hex_chars
                            .offset((c as i32 & 0xf as i32) as isize)
                            as i32,
                    );
                    if (*pb).size - (*pb).bpos
                        > ::std::mem::size_of::<[i8; 7]>() as u64
                            as i32 - 1 as i32
                    {
                        memcpy(
                            ...
                            (::std::mem::size_of::<[i8; 7]>() as u64
                                as i32 - 1 as i32) as u64,
                        );
                        (*pb).bpos
                            += ::std::mem::size_of::<[i8; 7]>()
                                as u64 as i32 - 1 as i32;
                        *((*pb).buf)
                            .offset(
                                (*pb).bpos as isize,
                            ) = '\u{0}' as i32 as i8;
...
#[no_mangle]
pub unsafe extern "C" fn json_object_get(mut jso: * mut crate::src::json_object::json_object) -> * mut crate::src::json_object::json_object {
    if jso.is_null() {
        return jso;
    }
    if (*jso)._ref_count < 4294967295 as u32 {} else {
        __assert_fail(
            b"jso->_ref_count < UINT32_MAX\0" as *const u8 as *const i8,
            b"/home/xial/json-c/json_object.c\0" as *const u8 as *const i8,
            254 as i32 as u32,
            (*core::intrinsics::transmute::<&'_ [u8; 58], &'_ [i8; 58]>(b"struct json_object *json_object_get(struct json_object *)\0"))
                .as_ptr(),
        );
    }
    let mut fresh1 = &mut ((*jso)._ref_count);
    *fresh1 = (*fresh1).wrapping_add(1);
    return jso;
}
#[no_mangle]
pub unsafe extern "C" fn json_object_put(mut jso: * mut crate::src::json_object::json_object) -> i32 {
    if jso.is_null() {
        return 0 as i32;
    }
    if (*jso)._ref_count > 0 as i32 as u32 {} else {
        __assert_fail(
            b"jso->_ref_count > 0\0" as *const u8 as *const i8,
            b"/home/xial/json-c/json_object.c\0" as *const u8 as *const i8,
            273 as i32 as u32,
            (*core::intrinsics::transmute::<&'_ [u8; 42], &'_ [i8; 42]>(b"int json_object_put(struct json_object *)\0"))
                .as_ptr(),
        );
    }
    let mut fresh2 = &mut ((*jso)._ref_count);
...
unsafe extern "C" fn json_object_generic_delete(mut jso: * mut crate::src::json_object::json_object) {
...
unsafe extern "C" fn json_object_new(
    mut o_type: u32,
    mut alloc_size: u64,
    mut to_json_string: Option<unsafe extern "C"  fn(_: * mut crate::src::json_object::json_object,_: * mut crate::src::apps::json_parse::printbuf,_: i32,_: i32,) -> i32>,
    ...
    (*jso).o_type = o_type;
    (*jso)._ref_count = 1 as i32 as uint32_t;
    let mut fresh3 = &mut ((*jso)._to_json_string);
    *fresh3 = to_json_string;
    let mut fresh4 = &mut ((*jso)._pb);
    *fresh4 = 0 as *mut printbuf;
    let mut fresh5 = &mut ((*jso)._user_delete);
    *fresh5 = None;
    let mut fresh6 = &mut ((*jso)._userdata);
...
pub unsafe extern "C" fn json_object_is_type(
    ...
    if jso.is_null() {
        return (type_0 as u32 == json_type_null as i32 as u32)
            as i32;
    }
    return ((*jso).o_type as u32 == type_0 as u32) as i32;
}
#[no_mangle]
pub unsafe extern "C" fn json_object_get_type(mut jso: * const crate::src::json_object::json_object) -> u32 {
    if jso.is_null() {
...
pub unsafe extern "C" fn json_object_set_userdata(
    ...
    mut user_delete: Option<unsafe extern "C"  fn(_: * mut crate::src::json_object::json_object,_: * mut core::ffi::c_void,) -> ()>,
) {
    if !jso.is_null() {} else {
        __assert_fail(
    ...
    let mut fresh7 = &mut ((*jso)._userdata);
    *fresh7 = userdata;
    let mut fresh8 = &mut ((*jso)._user_delete);
    *fresh8 = user_delete;
}
#[no_mangle]
pub unsafe extern "C" fn json_object_set_serializer(
    mut jso: * mut crate::src::json_object::json_object,
    mut to_string_func: Option<unsafe extern "C"  fn(_: * mut crate::src::json_object::json_object,_: * mut crate::src::apps::json_parse::printbuf,_: i32,_: i32,) -> i32>,
    mut userdata: * mut core::ffi::c_void,
    mut user_delete: Option<unsafe extern "C"  fn(_: * mut crate::src::json_object::json_object,_: * mut core::ffi::c_void,) -> ()>,
) {
    ...
    if to_string_func.is_none() {
        match (*jso).o_type as u32 {
            0 => {
                let mut fresh9 = &mut ((*jso)._to_json_string);
                *fresh9 = None;
            }
            1 => {
                let mut fresh10 = &mut ((*jso)._to_json_string);
                *fresh10 = Some(
                    json_object_boolean_to_json_string,
                );
            }
            2 => {
                let mut fresh11 = &mut ((*jso)._to_json_string);
                *fresh11 = Some(
                    json_object_double_to_json_string_default,
                );
            }
            3 => {
                let mut fresh12 = &mut ((*jso)._to_json_string);
                *fresh12 = Some(
                    json_object_int_to_json_string,
                );
            }
            4 => {
                let mut fresh13 = &mut ((*jso)._to_json_string);
                *fresh13 = Some(
                    json_object_object_to_json_string,
                );
            }
            5 => {
                let mut fresh14 = &mut ((*jso)._to_json_string);
                *fresh14 = Some(
                    json_object_array_to_json_string,
                );
            }
            6 => {
                let mut fresh15 = &mut ((*jso)._to_json_string);
                *fresh15 = Some(
    ...
    let mut fresh16 = &mut ((*jso)._to_json_string);
    *fresh16 = to_string_func;
}
#[no_mangle]
pub unsafe extern "C" fn json_object_to_json_string_length<'a1>(
    mut jso: * mut crate::src::json_object::json_object,
    mut flags: i32,
    ...
    if jso.is_null() {
        ...
        if ((*jso)._to_json_string)
            ...
            )(jso, (*jso)._pb, 0 as i32, flags) >= 0 as i32
        {
        ...
        .is_null()
    {
        ...
        if (iter.val).is_null() {
            printbuf_memappend(
                ...
                .expect(
                    "non-null function pointer",
                )(iter.val, pb, level + 1 as i32, flags) < 0 as i32
            {
            return -(1 as i32)
        }
...
unsafe extern "C" fn json_object_lh_entry_free(mut ent: * mut crate::src::json_object::lh_entry) {
    if lh_entry_k_is_constant(ent) == 0 {
        free(lh_entry_k(ent));
    }
    json_object_put(lh_entry_v(ent) as *mut json_object);
}
unsafe extern "C" fn json_object_object_delete(mut jso_base: * mut crate::src::json_object::json_object) {
    lh_table_free((*JC_OBJECT(jso_base)).c_object);
    json_object_generic_delete(jso_base);
}
#[no_mangle]
pub unsafe extern "C" fn json_object_new_object() -> * mut crate::src::json_object::json_object {
    ...
    let mut fresh18 = &mut ((*jso).c_object);
...
pub unsafe extern "C" fn json_object_object_add_ex(
    ...
    if json_object_get_type(jso) as u32
        == json_type_object as i32 as u32
    {} else {
        __assert_fail(
            ...
            b"/home/xial/json-c/json_object.c\0" as *const u8 as *const i8,
            544 as i32 as u32,
            (*core::intrinsics::transmute::<&'_ [u8; 118], &'_ [i8; 118]>(
    ...
    existing_entry = if opts & ((1 as i32) << 1 as i32) as u32
        != 0
    {
        0 as *mut lh_entry
    } else {
    ...
    if existing_entry.is_null() {
        let k: * const core::ffi::c_void = if opts
...
pub unsafe extern "C" fn json_object_object_length(
    ...
    {} else {
        __assert_fail(
            ...
            b"/home/xial/json-c/json_object.c\0" as *const u8 as *const i8,
            581 as i32 as u32,
            (*core::intrinsics::transmute::<&'_ [u8; 58], &'_ [i8; 58]>(b"int json_object_object_length(const struct json_object *)\0"))
                .as_ptr(),
        );
    }
...
pub unsafe extern "C" fn json_object_object_del(
    ...
    {} else {
        __assert_fail(
            ...
            b"/home/xial/json-c/json_object.c\0" as *const u8 as *const i8,
            620 as i32 as u32,
            (*core::intrinsics::transmute::<&'_ [u8; 64], &'_ [i8; 64]>(b"void json_object_object_del(struct json_object *, const char *)\0"))
                .as_ptr(),
        );
    }
...
#[no_mangle]
pub unsafe extern "C" fn json_object_new_boolean(mut b: i32) -> * mut crate::src::json_object::json_object {
...
pub unsafe extern "C" fn json_object_get_boolean(
    ...
    match (*jso).o_type as u32 {
        ...
        3 => {
            match (*JC_INT_C(jso)).cint_type as u32 {
                0 => {
                ...
                _ => {
                    json_abort(
                        b"invalid cint_type\0" as *const u8 as *const i8,
                    );
                }
            }
        }
        2 => {
            return ((*JC_DOUBLE_C(jso)).c_double != 0 as i32 as f64)
                as i32;
        }
        6 => {
            return ((*JC_STRING_C(jso)).len != 0 as i32 as i64)
                as i32;
        }
        _ => return 0 as i32,
    };
...
pub unsafe extern "C" fn json_object_set_boolean(
    ...
    if jso.is_null()
        || (*jso).o_type as u32
            != json_type_boolean as i32 as u32
    {
        return 0 as i32;
    }
...
unsafe extern "C" fn json_object_int_to_json_string(
    ...
    if (*JC_INT(jso)).cint_type as u32
        == json_object_int_type_int64 as i32 as u32
    {
        snprintf(
            sbuf.as_mut_ptr(),
    ...
    return printbuf_memappend(
        pb,
        sbuf.as_mut_ptr(),
        strlen(sbuf.as_mut_ptr()) as i32,
    );
}
#[no_mangle]
pub unsafe extern "C" fn json_object_new_int(mut i: i32) -> * mut crate::src::json_object::json_object {
    return json_object_new_int64(i as int64_t);
}
#[no_mangle]
pub unsafe extern "C" fn json_object_get_int(mut jso: * const crate::src::json_object::json_object) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn json_object_new_int64(mut i: i64) -> * mut crate::src::json_object::json_object {
...
#[no_mangle]
pub unsafe extern "C" fn json_object_new_uint64(mut i: u64) -> * mut crate::src::json_object::json_object {
    let mut jso: * mut crate::src::json_object::json_object_int = json_object_new(
        json_type_int,
        ::std::mem::size_of::<json_object_int>() as u64,
        Some(json_object_int_to_json_string),
...
#[no_mangle]
pub unsafe extern "C" fn json_object_get_int64(mut jso: * const crate::src::json_object::json_object) -> i64 {
    let mut cint: i64 = 0;
    if jso.is_null() {
    ...
    match (*jso).o_type as u32 {
        ...
        2 => {
            if (*JC_DOUBLE_C(jso)).c_double
                >= 9223372036854775807 as i64 as f64
            {
                return 9223372036854775807 as i64;
            }
            if (*JC_DOUBLE_C(jso)).c_double
                <= (-(9223372036854775807 as i64)
                    - 1 as i32 as i64) as f64
            {
                return -(9223372036854775807 as i64)
                    - 1 as i32 as i64;
            }
...
pub unsafe extern "C" fn json_object_get_uint64(
    ...
    match (*jso).o_type as u32 {
        3 => {
            ...
            match (*jsoint).cint_type as u32 {
                0 => {
                    if (*jsoint).cint.c_int64 < 0 as i32 as i64 {
                        return 0 as i32 as uint64_t;
                    }
        ...
        2 => {
            if (*JC_DOUBLE_C(jso)).c_double
                >= 18446744073709551615 as u64 as f64
            {
                return 18446744073709551615 as u64;
            }
            if (*JC_DOUBLE_C(jso)).c_double < 0 as i32 as f64 {
                return 0 as i32 as uint64_t;
            }
        ...
        6 => {
            if json_parse_uint64(get_string_component(jso), Some(&mut cuint))
                == 0 as i32
            {
                return cuint;
            }
...
pub unsafe extern "C" fn json_object_set_int64(
    ...
    if jso.is_null()
        || (*jso).o_type as u32 != json_type_int as i32 as u32
    {
        return 0 as i32;
    }
...
pub unsafe extern "C" fn json_object_int_inc(
    ...
    let mut jsoint: * mut crate::src::json_object::json_object_int = (0 as * mut crate::src::json_object::json_object_int);
    if jso.is_null()
        || (*jso).o_type as u32 != json_type_int as i32 as u32
    {
        return 0 as i32;
    ...
    match (*jsoint).cint_type as u32 {
        0 => {
            if val > 0 as i32 as i64
                && (*jsoint).cint.c_int64 > 9223372036854775807 as i64 - val
            {
                (*jsoint)
                    .cint
                ...
                (*jsoint)
                    .cint
                    .c_int64 = -(9223372036854775807 as i64)
                    - 1 as i32 as i64;
            } else {
                let mut fresh19 = &mut ((*jsoint).cint.c_int64);
                *fresh19 += val;
            }
            return 1 as i32;
        }
        1 => {
            ...
            {
                (*jsoint).cint.c_uint64 = 18446744073709551615 as u64;
            } else if val < 0 as i32 as i64
                ...
                (*jsoint).cint_type = json_object_int_type_int64;
                    ...
                    && (*jsoint).cint.c_uint64 >= -val as uint64_t
                {
                let mut fresh20 = &mut ((*jsoint).cint.c_uint64);
                *fresh20 = (*fresh20 as u64).wrapping_sub(-val as uint64_t)
                    as uint64_t as uint64_t;
            } else {
                let mut fresh21 = &mut ((*jsoint).cint.c_uint64);
                *fresh21 = (*fresh21 as u64).wrapping_add(val as u64)
                    as uint64_t as uint64_t;
            }
            return 1 as i32;
        }
...
#[thread_local]
static mut tls_serialization_float_format: * mut i8 = 0 as *const i8
    as *mut i8;
static mut global_serialization_float_format: * mut i8 = 0
...
pub unsafe extern "C" fn json_c_set_serialization_double_format(
    ...
    if global_or_thread == 0 as i32 {
        if !tls_serialization_float_format.is_null() {
            ...
            tls_serialization_float_format = 0 as *mut i8;
        }
        ...
        if !double_format.is_null() {
            let mut p: * mut i8 = strdup(double_format);
            if p.is_null() {
            ...
            global_serialization_float_format = 0 as *mut i8;
        }
        ...
        if !double_format.is_null() {
            let mut p_0: * mut i8 = strdup(double_format);
            if p_0.is_null() {
                _json_c_set_last_err(
                    b"json_c_set_serialization_double_format: out of memory\n\0"
                        as *const u8 as *const i8,
...
unsafe extern "C" fn json_object_double_to_json_string_format(
    ...
    if ((*jsodbl).c_double).is_nan() as i32 != 0 {
        ...
        {
        if (*jsodbl).c_double > 0 as i32 as f64 {
            size = snprintf(
                buf.as_mut_ptr(),
                ::std::mem::size_of::<[i8; 128]>() as u64,
        ...
        let mut std_format: * const i8 = b"%.17g\0" as *const u8
            as *const i8;
        ...
        if format == std_format
            || (strstr(format, b".0f\0" as *const u8 as *const i8)).is_null()
        {
        ...
        looks_numeric = (buf[0 as i32 as usize] as i32 >= '0' as i32
            ...
            || size > 1 as i32
                ...
                && (buf[1 as i32 as usize] as i32 >= '0' as i32
                    && buf[1 as i32 as usize] as i32 <= '9' as i32))
            as i32;
        if size
            < ::std::mem::size_of::<[i8; 128]>() as u64
                as i32 - 2 as i32 && looks_numeric != 0 && p.is_null()
            && (strchr(buf.as_mut_ptr(), 'e' as i32)).is_null()
            && format_drops_decimals != 0
        {
            strcat(buf.as_mut_ptr(), b".0\0" as *const u8 as *const i8);
            size += 2 as i32;
        }
        if !p.is_null() && flags & (1 as i32) << 2 as i32 != 0 {
            ...
            size = p.offset_from(buf.as_mut_ptr()) as i64 as i32;
        }
    }
    if size < 0 as i32 {
        return -(1 as i32);
    ...
    if size
        >= ::std::mem::size_of::<[i8; 128]>() as u64 as i32
    {
        size = (::std::mem::size_of::<[i8; 128]>() as u64)
            .wrapping_sub(1 as i32 as u64) as i32;
    }
...
pub unsafe extern "C" fn json_object_new_double(
    ...
    let mut fresh22 = &mut ((*jso).base._to_json_string);
    *fresh22 = Some(
        json_object_double_to_json_string_default,
    );
    (*jso).c_double = d;
...
pub unsafe extern "C" fn json_object_userdata_to_json_string(
    ...
    let mut userdata_len: i32 = strlen((*jso)._userdata as *const i8)
        as i32;
    printbuf_memappend(pb, (*jso)._userdata as *const i8, userdata_len);
    return userdata_len;
}
#[no_mangle]
...
pub unsafe extern "C" fn json_object_get_double(
    ...
    match (*jso).o_type as u32 {
        ...
        3 => {
            match (*JC_INT_C(jso)).cint_type as u32 {
                0 => return (*JC_INT_C(jso)).cint.c_int64 as f64,
                1 => return (*JC_INT_C(jso)).cint.c_uint64 as f64,
                _ => {
                    json_abort(
                        b"invalid cint_type\0" as *const u8 as *const i8,
                    );
        ...
        1 => return (*JC_BOOL_C(jso)).c_boolean as f64,
        6 => {
            *__errno_location() = 0 as i32;
            ...
            if *errPtr as i32 != '\u{0}' as i32 {
                *__errno_location() = 22 as i32;
                return 0.0f64;
            }
            if (::std::f64::INFINITY == cdouble || -::std::f64::INFINITY == cdouble)
                && 34 as i32 == *__errno_location()
            {
                cdouble = 0.0f64;
            }
            return cdouble;
...
pub unsafe extern "C" fn json_object_set_double(
    ...
    if jso.is_null()
        || (*jso).o_type as u32
            != json_type_double as i32 as u32
    {
        return 0 as i32;
    }
    (*JC_DOUBLE(jso)).c_double = new_value;
    if ((*jso)._to_json_string
        ).map(|f| f as usize) == ( Some(_json_object_userdata_to_json_string)).map(|f| f as usize)
    {
...
unsafe extern "C" fn json_object_string_to_json_string(
    ...
    let mut len: i64 = (*JC_STRING(jso)).len;
    printbuf_memappend(
        pb,
        b"\"\0" as *const u8 as *const i8,
        (::std::mem::size_of::<[i8; 2]>() as u64)
...
unsafe extern "C" fn json_object_string_delete(mut jso: * mut crate::src::json_object::json_object) {
    if (*JC_STRING(jso)).len < 0 as i32 as i64 {
        ...
        > (9223372036854775807 as i64 as u64)
            .wrapping_sub(
                (::std::mem::size_of::<json_object_string>() as u64)
                    .wrapping_sub(
                        ::std::mem::size_of::<C2RustUnnamed>() as u64,
                    ),
            )
...
unsafe extern "C" fn _json_object_set_string_len(
    ...
    if jso.is_null()
        || (*jso).o_type as u32
            != json_type_string as i32 as u32
    {
        return 0 as i32;
    }
    ...
    if len as ssize_t > curlen {
        dstbuf = malloc(len.wrapping_add(1 as i32 as u64))
            as *mut i8;
        if dstbuf.is_null() {
            return 0 as i32;
        }
        ...
        let mut fresh23 = &mut ((*JC_STRING(jso)).c_string.pdata);
        *fresh23 = dstbuf;
        newlen = -(len as ssize_t);
    } else if (*JC_STRING(jso)).len < 0 as i32 as i64 {
        newlen = -(len as ssize_t);
    }
    memcpy(dstbuf as *mut libc::c_void, s as *const libc::c_void, len);
    *dstbuf.offset(len as isize) = '\u{0}' as i32 as i8;
    ...
    while ii < json_object_array_length(jso) {
        ...
        if val.is_null() {
            printbuf_memappend(
                ...
                .expect(
                    "non-null function pointer",
                )(val, pb, level + 1 as i32, flags) < 0 as i32
            {
            return -(1 as i32)
        }
...
unsafe extern "C" fn json_object_array_delete(mut jso: * mut crate::src::json_object::json_object) {
    array_list_free((*JC_ARRAY(jso)).c_array);
    json_object_generic_delete(jso);
}
#[no_mangle]
pub unsafe extern "C" fn json_object_new_array() -> * mut crate::src::json_object::json_object {
...
pub unsafe extern "C" fn json_object_new_array_ext(
    ...
    let mut fresh24 = &mut ((*jso).c_array);
...
pub unsafe extern "C" fn json_object_array_sort(
    mut jso: * mut crate::src::json_object::json_object,
    mut sort_fn: Option<unsafe extern "C"  fn(_: * const core::ffi::c_void,_: * const core::ffi::c_void,) -> i32>,
) {
    if json_object_get_type(jso) as u32
    ...
    {} else {
        __assert_fail(
            ...
            b"/home/xial/json-c/json_object.c\0" as *const u8 as *const i8,
            1453 as i32 as u32,
            (*core::intrinsics::transmute::<&'_ [u8; 87], &'_ [i8; 87]>(
...
pub unsafe extern "C" fn json_object_array_bsearch(
    ...
    let mut result: * mut * mut crate::src::json_object::json_object = (0 as * mut * mut crate::src::json_object::json_object);
    if json_object_get_type(jso) as u32
        == json_type_array as i32 as u32
    {} else {
        __assert_fail(
            ...
            b"/home/xial/json-c/json_object.c\0" as *const u8 as *const i8,
            1463 as i32 as u32,
            (*core::intrinsics::transmute::<&'_ [u8; 139], &'_ [i8; 139]>(
...
pub unsafe extern "C" fn json_object_array_length(
    ...
    {} else {
        __assert_fail(
            ...
            b"/home/xial/json-c/json_object.c\0" as *const u8 as *const i8,
            1474 as i32 as u32,
            (*core::intrinsics::transmute::<&'_ [u8; 60], &'_ [i8; 60]>(b"size_t json_object_array_length(const struct json_object *)\0"))
                .as_ptr(),
        );
    }
...
pub unsafe extern "C" fn json_object_array_del_idx(
    ...
    {} else {
        __assert_fail(
            ...
            b"/home/xial/json-c/json_object.c\0" as *const u8 as *const i8,
            1492 as i32 as u32,
            (*core::intrinsics::transmute::<&'_ [u8; 68], &'_ [i8; 68]>(b"int json_object_array_del_idx(struct json_object *, size_t, size_t)\0"))
                .as_ptr(),
        );
    }
...
unsafe extern "C" fn json_object_all_values_equal(
    ...
    if json_object_get_type(jso1) as u32
        == json_type_object as i32 as u32
    {} else {
        __assert_fail(
    ...
    if json_object_get_type(jso2) as u32
        == json_type_object as i32 as u32
    {} else {
        __assert_fail(
...
pub unsafe extern "C" fn json_object_equal(
    ...
    if (*jso1).o_type as u32 != (*jso2).o_type as u32 {
        return 0 as i32;
    }
    match (*jso1).o_type as u32 {
        1 => {
        ...
        3 => {
            ...
            if (*int1).cint_type as u32
                == json_object_int_type_int64 as i32 as u32
            {
                if (*int2).cint_type as u32
                    == json_object_int_type_int64 as i32 as u32
                {
                    return ((*int1).cint.c_int64 == (*int2).cint.c_int64) as i32;
                }
                if (*int1).cint.c_int64 < 0 as i32 as i64 {
                    return 0 as i32;
                }
            ...
            if (*int2).cint_type as u32
                == json_object_int_type_uint64 as i32 as u32
            {
                return ((*int1).cint.c_uint64 == (*int2).cint.c_uint64) as i32;
            }
            if (*int2).cint.c_int64 < 0 as i32 as i64 {
                return 0 as i32;
            }
...
unsafe extern "C" fn json_object_copy_serializer_data(
    ...
    if ((*dst)._to_json_string
        ).map(|f| f as usize) == ( Some(json_object_userdata_to_json_string)).map(|f| f as usize)
        || ((*dst)._to_json_string
            ...
            )).map(|f| f as usize)
    {
        ...
        if !((*src)._userdata).is_null() {} else {
            __assert_fail(
                b"src->_userdata\0" as *const u8 as *const i8,
                b"/home/xial/json-c/json_object.c\0" as *const u8 as *const i8,
                1623 as i32 as u32,
                (*core::intrinsics::transmute::<&'_ [u8; 81], &'_ [i8; 81]>(
                    b"int json_object_copy_serializer_data(struct json_object *, struct json_object *)\0",
                ))
                    .as_ptr(),
            );
        }
        p = strdup((*src)._userdata as *const i8);
        if p.is_null() {
            _json_c_set_last_err(
        ...
        let mut fresh25 = &mut ((*dst)._userdata);
        *fresh25 = p as *mut libc::c_void;
    } else {
        _json_c_set_last_err(
            b"json_object_copy_serializer_data: unable to copy unknown serializer data: %p\n\0"
                as *const u8 as *const i8,
            core::intrinsics::transmute::<Option<unsafe extern "C"  fn(_: * mut crate::src::json_object::json_object,_: * mut crate::src::apps::json_parse::printbuf,_: i32,_: i32,) -> i32>, * mut core::ffi::c_void>((*dst)._to_json_string),
        );
        return -(1 as i32);
    }
    let mut fresh26 = &mut ((*dst)._user_delete);
...
pub unsafe extern "C" fn json_c_shallow_copy_default(
    ...
    match (*src).o_type as u32 {
        ...
        3 => {
            match (*JC_INT(src)).cint_type as u32 {
                0 => {
    ...
    let mut fresh27 = &mut ((**dst)._to_json_string);
...
unsafe extern "C" fn json_object_deep_copy_recursive(
    ...
    mut dst: * mut * mut crate::src::json_object::json_object,
    mut shallow_copy: Option<unsafe extern "C"  fn(_: * mut crate::src::json_object::json_object,_: * mut crate::src::json_object::json_object,_: * const i8,_: u64,_: * mut * mut crate::src::json_object::json_object,) -> i32>,
) -> i32 {
    let mut iter: crate::src::json_object::json_object_iter = json_object_iter {
        key: 0 as *mut i8,
        val: 0 as *mut json_object,
    ...
    if !(*dst).is_null() {} else {
        __assert_fail(
            b"*dst != NULL\0" as *const u8 as *const i8,
            b"/home/xial/json-c/json_object.c\0" as *const u8 as *const i8,
            1718 as i32 as u32,
            (*core::intrinsics::transmute::<&'_ [u8; 151], &'_ [i8; 151]>(
    ...
    match (*src).o_type as u32 {
        4 => {
                ...
                .is_null()
            {
                ...
                if json_object_object_add(*dst, iter.key, jso) < 0 as i32 {
                    json_object_put(jso);
                    return -(1 as i32);
                }
                iter.entry = lh_entry_next(iter.entry);
        ...
        5 => {
            ...
            while ii < src_array_len {
                ...
                let mut jso1: * mut crate::src::json_object::json_object = json_object_array_get_idx(src, ii);
                if jso1.is_null() {
                ...
                if json_object_array_add(*dst, jso_0) < 0 as i32 {
                    json_object_put(jso_0);
                    return -(1 as i32);
                }
                ii = ii.wrapping_add(1);
...
#[cold]
unsafe extern "C" fn json_abort(mut message: * const i8) -> ! {
    if !message.is_null() {
        fprintf(
            stderr,
