...
pub type json_c_visit_userfunc<'a1, 'a2, 'a3, 'a4, 'a5> = unsafe extern "C"  fn(_: Option<&'a1 mut crate::src::json_object::json_object>,_: i32,_: Option<&'a2 mut crate::src::json_object::json_object>,_: Option<&'a3 i8>,_: Option<&'a4 mut u64>,_: Option<&'a5 mut core::ffi::c_void>,) -> i32;
#[derive(Copy, Clone)]
#[repr(C)]
