...
extern "C" {
    ...
    fn duplocale(__dataset: * mut crate::src::json_tokener::__locale_struct) -> * mut crate::src::json_tokener::__locale_struct;
    fn uselocale(__dataset: * mut crate::src::json_tokener::__locale_struct) -> * mut crate::src::json_tokener::__locale_struct;
}
...
impl __locale_struct {
    pub const fn new() -> Self {
        __locale_struct {
        __locales: [(0 as * mut crate::src::json_tokener::__locale_data),(0 as * mut crate::src::json_tokener::__locale_data),(0 as * mut crate::src::json_tokener::__locale_data),(0 as * mut crate::src::json_tokener::__locale_data),(0 as * mut crate::src::json_tokener::__locale_data),(0 as * mut crate::src::json_tokener::__locale_data),(0 as * mut crate::src::json_tokener::__locale_data),(0 as * mut crate::src::json_tokener::__locale_data),(0 as * mut crate::src::json_tokener::__locale_data),(0 as * mut crate::src::json_tokener::__locale_data),(0 as * mut crate::src::json_tokener::__locale_data),(0 as * mut crate::src::json_tokener::__locale_data),(0 as * mut crate::src::json_tokener::__locale_data),],
        __ctype_b: (0 as * const u16),
        __ctype_tolower: (0 as * const i32),
        __ctype_toupper: (0 as * const i32),
        __names: [(0 as * const i8),(0 as * const i8),(0 as * const i8),(0 as * const i8),(0 as * const i8),(0 as * const i8),(0 as * const i8),(0 as * const i8),(0 as * const i8),(0 as * const i8),(0 as * const i8),(0 as * const i8),(0 as * const i8),]
        }
    }
}

impl std::default::Default for __locale_struct {
    fn default() -> Self { __locale_struct::new() }
}
...
static mut json_null_str: [i8; 5] = unsafe {
    *core::intrinsics::transmute::<&'_ [u8; 5], &'_ [i8; 5]>(b"null\0")
};
static mut json_null_str_len: i32 = 0;
static mut json_inf_str: [i8; 9] = unsafe {
    *core::intrinsics::transmute::<&'_ [u8; 9], &'_ [i8; 9]>(b"Infinity\0")
};
...
static mut json_nan_str: [i8; 4] = unsafe {
    *core::intrinsics::transmute::<&'_ [u8; 4], &'_ [i8; 4]>(b"NaN\0")
};
static mut json_nan_str_len: i32 = 0;
static mut json_true_str: [i8; 5] = unsafe {
    *core::intrinsics::transmute::<&'_ [u8; 5], &'_ [i8; 5]>(b"true\0")
};
static mut json_true_str_len: i32 = 0;
static mut json_false_str: [i8; 6] = unsafe {
    *core::intrinsics::transmute::<&'_ [u8; 6], &'_ [i8; 6]>(b"false\0")
};
...
#[no_mangle]
pub unsafe extern "C" fn json_tokener_get_error<'a1>(
...
#[no_mangle]
pub unsafe extern "C" fn json_tokener_new_ex<'a1>(
    mut depth: i32,
...
#[no_mangle]
pub unsafe extern "C" fn json_tokener_new<'a1>() -> * mut crate::src::apps::json_parse::json_tokener<'a1> {
    return json_tokener_new_ex(32 as i32);
}
#[no_mangle]
pub unsafe extern "C" fn json_tokener_free<'a1>(mut tok: * mut crate::src::apps::json_parse::json_tokener<'a1>) {
    json_tokener_reset(tok);
    if !((*tok).pb).is_null() {
...
unsafe extern "C" fn json_tokener_reset_level<'a1>(
    mut tok: * mut crate::src::apps::json_parse::json_tokener<'a1>,
    mut depth: i32,
) {
    ...
    let mut fresh2 = &mut ((*((*tok).stack).offset(depth as isize)).current);
    *fresh2 = 0 as *mut json_object;
    free((*((*tok).stack).offset(depth as isize)).obj_field_name as *mut libc::c_void);
    let mut fresh3 = &mut ((*((*tok).stack).offset(depth as isize)).obj_field_name);
    *fresh3 = 0 as *mut i8;
}
#[no_mangle]
pub unsafe extern "C" fn json_tokener_reset<'a1>(mut tok: * mut crate::src::apps::json_parse::json_tokener<'a1>) {
    let mut i: i32 = 0;
    if tok.is_null() {
        return;
    }
...
#[no_mangle]
pub unsafe extern "C" fn json_tokener_parse_verbose<'a1>(
    mut str: * const i8,
    ...
    *(borrow_mut(&mut error)).unwrap() = (*tok).err;
...
#[no_mangle]
pub unsafe extern "C" fn json_tokener_parse_ex<'a1>(
    mut tok: * mut crate::src::apps::json_parse::json_tokener<'a1>,
    mut str: * const i8,
    mut len: i32,
) -> * mut crate::src::json_object::json_object {
    ...
    let mut oldlocale: * mut crate::src::json_tokener::__locale_struct = uselocale(0 as locale_t);
    ...
    let mut duploc: * mut crate::src::json_tokener::__locale_struct = duplocale(oldlocale);
    newloc = newlocale(
        (1 as i32) << 1 as i32,
    ...
    's_76: while if (*tok).char_offset == len {
                ...
                == json_tokener_state_finish as i32 as u32
        {
            ...
            && json_tokener_validate_utf8(*str, borrow_mut(&mut nBytesp)) == 0
        {
    ...
    } != 0
    {
            ...
            match (*((*tok).stack).offset((*tok).depth as isize)).state as u32 {
                0 => {
                    while is_ws_char(c) != 0 {
                        str = str.offset(1);
                        let mut fresh4 = &mut ((*tok).char_offset);
                        *fresh4 += 1;
                        if c == 0
                ...
                26 => {
                    ...
                    while (*tok).st_pos < json_inf_str_len as i32 {
                                        ...
                                        as i32)
                        {
                            ...
                            let mut fresh8 = &mut ((*tok).st_pos);
                            *fresh8 += 1;
                            str = str.offset(1);
                            let mut fresh9 = &mut ((*tok).char_offset);
                            *fresh9 += 1;
                    ...
                    let mut fresh10 = &mut ((*((*tok).stack).offset((*tok).depth as isize))
                        .current);
                ...
                14 => {
                            ...
                            || (*tok).is_double == 0 && c as i32 == '.' as i32)
                    {
                        ...
                        str = str.offset(1);
                        let mut fresh30 = &mut ((*tok).char_offset);
                        *fresh30 += 1;
                        if !(c == 0
                            || (if (*tok).char_offset == len {
                                (if (*tok).depth == 0 as i32
                                ...
                                || c as i32 == 'I' as i32)
                        {
                                ...
                                && (*tok).flags & 0x1 as i32 == 0
                            {
                                while (*(*tok).pb).bpos > 1 as i32 {
                                    ...
                                    *((*(*tok).pb).buf)
                                    ...
                                    let mut fresh31 = &mut ((*(*tok).pb).bpos);
                                    *fresh31 -= 1;
                                }
                            }
                            let mut num64: i64 = 0;
                            ...
                            if (*tok).is_double == 0
                                && *((*(*tok).pb).buf).offset(0 as i32 as isize)
                                    as i32 == '-' as i32
                                && json_parse_int64((*(*tok).pb).buf, Some(&mut num64))
                                    == 0 as i32
                            {
                                    ...
                                    && (*tok).flags & 0x1 as i32 != 0
                                {
                                    ...
                                    *fresh32 = json_object_new_int64(num64);
                                    ...
                                    && *((*(*tok).pb).buf).offset(0 as i32 as isize)
                                        as i32 != '-' as i32
                                    && json_parse_uint64((*(*tok).pb).buf, Some(&mut numuint64))
                                        == 0 as i32
                                {
                                if *__errno_location() == 34 as i32
                                    && (*tok).flags & 0x1 as i32 != 0
                ...
                22 => {
                    ...
                    let mut fresh43 = &mut ((*((*tok).stack).offset((*tok).depth as isize))
                        .obj_field_name);
                    *fresh43 = 0 as *mut i8;
                    (*((*tok).stack).offset((*tok).depth as isize))
        ...
        match current_block {
                ...
                loop {
                    if c as i32 == (*tok).quote_char as i32 {
                            ...
                            > str.offset_from(case_start_3) as i64
                        {
                            ...
                            let mut fresh37 = &mut ((*(*tok).pb).bpos);
                        ...
                        *fresh38 = strdup((*(*tok).pb).buf);
                            ...
                            > str.offset_from(case_start_3) as i64
                        {
                            ...
                            let mut fresh39 = &mut ((*(*tok).pb).bpos);
                        ...
                        str = str.offset(1);
                        let mut fresh40 = &mut ((*tok).char_offset);
                        *fresh40 += 1;
                        if !(c == 0
                            || (if (*tok).char_offset == len {
                                (if (*tok).depth == 0 as i32
                            ...
                            > str.offset_from(case_start_3) as i64
                        {
                            ...
                            let mut fresh41 = &mut ((*(*tok).pb).bpos);
            ...
            5600328731811258759 => {
                loop {
                    if c == 0 || is_hex_char(c) == 0 {
                        ...
                        let mut fresh25 = &mut ((*tok).st_pos);
                        *fresh25 += 1;
                        if (*tok).st_pos >= 4 as i32 {
                            break;
                        }
                        str = str.offset(1);
                        let mut fresh26 = &mut ((*tok).char_offset);
                        *fresh26 += 1;
                        if !(if (*tok).char_offset == len {
                            if (*tok).depth == 0 as i32
                                && (*((*tok).stack).offset((*tok).depth as isize)).state
                ...
                loop {
                    if c as i32 == (*tok).quote_char as i32 {
                            ...
                            > str.offset_from(case_start_1) as i64
                        {
                            ...
                            let mut fresh20 = &mut ((*(*tok).pb).bpos);
                        ...
                        *fresh21 = json_object_new_string_len(
                            ...
                            > str.offset_from(case_start_1) as i64
                        {
                            ...
                            let mut fresh22 = &mut ((*(*tok).pb).bpos);
                        ...
                        str = str.offset(1);
                        let mut fresh23 = &mut ((*tok).char_offset);
                        *fresh23 += 1;
                        if !(c == 0
                            || (if (*tok).char_offset == len {
                                (if (*tok).depth == 0 as i32
                            ...
                            > str.offset_from(case_start_1) as i64
                        {
                            ...
                            let mut fresh24 = &mut ((*(*tok).pb).bpos);
            ...
            6662862405959679103 => {
                while c as i32 != '\n' as i32 {
                    str = str.offset(1);
                    let mut fresh17 = &mut ((*tok).char_offset);
                    *fresh17 += 1;
                    if !(c == 0
                        || (if (*tok).char_offset == len {
                            (if (*tok).depth == 0 as i32
                        ...
                        > str.offset_from(case_start_0) as i64
                    {
                        ...
                        let mut fresh18 = &mut ((*(*tok).pb).bpos);
                    ...
                    > str.offset_from(case_start_0) as i64
                {
                    ...
                    let mut fresh19 = &mut ((*(*tok).pb).bpos);
            ...
            18221534353613080499 => {
                while c as i32 != '*' as i32 {
                    str = str.offset(1);
                    let mut fresh14 = &mut ((*tok).char_offset);
                    *fresh14 += 1;
                    if !(c == 0
                        || (if (*tok).char_offset == len {
                            (if (*tok).depth == 0 as i32
                        ...
                        > str.offset_from(case_start) as i64
                    {
                        ...
                        let mut fresh15 = &mut ((*(*tok).pb).bpos);
                        ...
                        as i64
                {
                    ...
                    let mut fresh16 = &mut ((*(*tok).pb).bpos);
            ...
            13823707972521062695 => {
                let mut fresh13 = &mut ((*tok).st_pos);
                *fresh13 += 1;
                current_block = 14910428593596980134;
            }
            6015864261243718670 => {
                let mut fresh29 = &mut ((*tok).st_pos);
                *fresh29 += 1;
                current_block = 14910428593596980134;
            }
            _ => {}
        ...
        str = str.offset(1);
        let mut fresh44 = &mut ((*tok).char_offset);
        *fresh44 += 1;
        if c == 0 {
            break;
        }
    ...
    if (*tok).err as u32 == json_tokener_success as i32 as u32
    {
        let mut ret: * mut crate::src::json_object::json_object = json_object_get(
            (*((*tok).stack).offset((*tok).depth as isize)).current,
        );
        let mut ii: i32 = 0;
        ii = (*tok).depth;
...
unsafe extern "C" fn json_tokener_validate_utf8<'a1>(
    c: i8,
    mut nBytes: Option<&'a1 mut u32>,
) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn json_tokener_set_flags<'a1>(
    mut tok: * mut crate::src::apps::json_parse::json_tokener<'a1>,
    mut flags: i32,
) {
    (*tok).flags = flags;
...
#[no_mangle]
pub unsafe extern "C" fn json_tokener_get_parse_end<'a1>(
    mut tok: * mut crate::src::apps::json_parse::json_tokener<'a1>,
) -> u64 {
    if (*tok).char_offset >= 0 as i32 {} else {
        __assert_fail(
            ...
            1300 as i32 as u32,
            (*core::intrinsics::transmute::<&'_ [u8; 57], &'_ [i8; 57]>(b"size_t json_tokener_get_parse_end(struct json_tokener *)\0"))
                .as_ptr(),
        );
    }
    return (*tok).char_offset as size_t;
}
unsafe extern "C" fn json_tokener_parse_double<'a1>(
    mut buf: * const i8,
    mut len: i32,
