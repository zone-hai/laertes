...
static mut char_hash_fn: Option<unsafe extern "C"  fn(_: * const core::ffi::c_void,) -> u64> = unsafe {
    Some(lh_char_hash)
};
#[no_mangle]
pub unsafe extern "C" fn json_global_set_string_hash(h: i32) -> i32 {
    match h {
        0 => {
            char_hash_fn = Some(
                lh_char_hash,
 ...
 extern "C" fn lh_ptr_hash(mut k: * const core::ffi::c_void) -> u64 {
    return (k as ptrdiff_t as u64).wrapping_mul(0x9e370001 as u64)
        >> 4 as i32
...
unsafe extern "C" fn hashlittle(
    ...
    u.ptr = key;
    if 1 as i32 != 0
        && u.i & 0x3 as i32 as u64 == 0 as i32 as u64
    {
        let mut k: * const u32 = key as *const uint32_t;
        while length > 12 as i32 as u64 {
            a = (a as u32).wrapping_add(*k.offset(0 as i32 as isize))
                as uint32_t as uint32_t;
            b = (b as u32).wrapping_add(*k.offset(1 as i32 as isize))
                as uint32_t as uint32_t;
            c = (c as u32).wrapping_add(*k.offset(2 as i32 as isize))
                as uint32_t as uint32_t;
            ...
            length = (length as u64)
                .wrapping_sub(12 as i32 as u64) as size_t as size_t;
            k = k.offset(3 as i32 as isize);
        }
        match length {
            12 => {
                c = (c as u32)
                    .wrapping_add(*k.offset(2 as i32 as isize)) as uint32_t
                    as uint32_t;
                b = (b as u32)
                    .wrapping_add(*k.offset(1 as i32 as isize)) as uint32_t
                    as uint32_t;
                a = (a as u32)
                    .wrapping_add(*k.offset(0 as i32 as isize)) as uint32_t
                    as uint32_t;
            }
            11 => {
                c = (c as u32)
                    .wrapping_add(
                        *k.offset(2 as i32 as isize)
            ...
            a = (a as u32)
                .wrapping_add(
                    (*k_0.offset(0 as i32 as isize) as u32)
                        .wrapping_add(
                            (*k_0.offset(1 as i32 as isize) as uint32_t)
                                << 16 as i32,
                        ),
                ) as uint32_t as uint32_t;
            b = (b as u32)
                .wrapping_add(
                    (*k_0.offset(2 as i32 as isize) as u32)
                        .wrapping_add(
                            (*k_0.offset(3 as i32 as isize) as uint32_t)
                                << 16 as i32,
                        ),
                ) as uint32_t as uint32_t;
            c = (c as u32)
                .wrapping_add(
                    (*k_0.offset(4 as i32 as isize) as u32)
                        .wrapping_add(
                            (*k_0.offset(5 as i32 as isize) as uint32_t)
                                << 16 as i32,
                        ),
                ) as uint32_t as uint32_t;
            a = (a as u32).wrapping_sub(c) as uint32_t as uint32_t;
        ...
        match length {
            ...
            11 => {
                c = (c as u32)
                    .wrapping_add(
                        (*k8.offset(10 as i32 as isize) as uint32_t)
                            << 16 as i32,
                    ) as uint32_t as uint32_t;
            ...
            9 => {
                c = (c as u32)
                    .wrapping_add(*k8.offset(8 as i32 as isize) as u32)
                    as uint32_t as uint32_t;
            ...
            7 => {
                b = (b as u32)
                    .wrapping_add(
                        (*k8.offset(6 as i32 as isize) as uint32_t)
                            << 16 as i32,
                    ) as uint32_t as uint32_t;
            ...
            5 => {
                b = (b as u32)
                    .wrapping_add(*k8.offset(4 as i32 as isize) as u32)
                    as uint32_t as uint32_t;
            ...
            3 => {
                a = (a as u32)
                    .wrapping_add(
                        (*k8.offset(2 as i32 as isize) as uint32_t)
                            << 16 as i32,
                    ) as uint32_t as uint32_t;
            ...
            1 => {
                a = (a as u32)
                    .wrapping_add(*k8.offset(0 as i32 as isize) as u32)
                    as uint32_t as uint32_t;
                current_block_102 = 3812947724376655173;
            }
            0 => return c,
        ...
        match current_block_102 {
            3862714763397931078 => {
                b = (b as u32)
                    .wrapping_add(*k_0.offset(2 as i32 as isize) as u32)
                    as uint32_t as uint32_t;
                a = (a as u32)
                    .wrapping_add(
                        (*k_0.offset(0 as i32 as isize) as u32)
            ...
            17716880846291894159 => {
                c = (c as u32)
                    .wrapping_add(*k_0.offset(4 as i32 as isize) as u32)
                    as uint32_t as uint32_t;
                b = (b as u32)
                    .wrapping_add(
                        (*k_0.offset(2 as i32 as isize) as u32)
            ...
            15738368575629814624 => {
                a = (a as u32)
                    .wrapping_add(*k_0.offset(0 as i32 as isize) as u32)
                    as uint32_t as uint32_t;
            }
            _ => {}
        }
        ...
        while length > 12 as i32 as u64 {
            a = (a as u32)
                .wrapping_add(*k_1.offset(0 as i32 as isize) as u32)
                as uint32_t as uint32_t;
            a = (a as u32)
                .wrapping_add(
                    (*k_1.offset(1 as i32 as isize) as uint32_t)
                        << 8 as i32,
                ) as uint32_t as uint32_t;
            a = (a as u32)
                .wrapping_add(
                    (*k_1.offset(2 as i32 as isize) as uint32_t)
                        << 16 as i32,
                ) as uint32_t as uint32_t;
            a = (a as u32)
                .wrapping_add(
                    (*k_1.offset(3 as i32 as isize) as uint32_t)
                        << 24 as i32,
                ) as uint32_t as uint32_t;
            b = (b as u32)
                .wrapping_add(*k_1.offset(4 as i32 as isize) as u32)
                as uint32_t as uint32_t;
            b = (b as u32)
                .wrapping_add(
                    (*k_1.offset(5 as i32 as isize) as uint32_t)
                        << 8 as i32,
                ) as uint32_t as uint32_t;
            b = (b as u32)
                .wrapping_add(
                    (*k_1.offset(6 as i32 as isize) as uint32_t)
                        << 16 as i32,
                ) as uint32_t as uint32_t;
            b = (b as u32)
                .wrapping_add(
                    (*k_1.offset(7 as i32 as isize) as uint32_t)
                        << 24 as i32,
                ) as uint32_t as uint32_t;
            c = (c as u32)
                .wrapping_add(*k_1.offset(8 as i32 as isize) as u32)
                as uint32_t as uint32_t;
            c = (c as u32)
                .wrapping_add(
                    (*k_1.offset(9 as i32 as isize) as uint32_t)
                        << 8 as i32,
                ) as uint32_t as uint32_t;
            c = (c as u32)
                .wrapping_add(
                    (*k_1.offset(10 as i32 as isize) as uint32_t)
                        << 16 as i32,
                ) as uint32_t as uint32_t;
            c = (c as u32)
                .wrapping_add(
                    (*k_1.offset(11 as i32 as isize) as uint32_t)
                        << 24 as i32,
                ) as uint32_t as uint32_t;
            a = (a as u32).wrapping_sub(c) as uint32_t as uint32_t;
            a ^= c << 4 as i32 | c >> 32 as i32 - 4 as i32;
    ...
    c = (c as u32)
        .wrapping_sub(
            b << 14 as i32 | b >> 32 as i32 - 14 as i32,
        ) as uint32_t as uint32_t;
    a ^= c;
    a = (a as u32)
        .wrapping_sub(
            c << 11 as i32 | c >> 32 as i32 - 11 as i32,
        ) as uint32_t as uint32_t;
    b ^= a;
    b = (b as u32)
        .wrapping_sub(
            a << 25 as i32 | a >> 32 as i32 - 25 as i32,
        ) as uint32_t as uint32_t;
    c ^= b;
    c = (c as u32)
        .wrapping_sub(
            b << 16 as i32 | b >> 32 as i32 - 16 as i32,
        ) as uint32_t as uint32_t;
    a ^= c;
    a = (a as u32)
        .wrapping_sub(c << 4 as i32 | c >> 32 as i32 - 4 as i32)
        as uint32_t as uint32_t;
    b ^= a;
    b = (b as u32)
        .wrapping_sub(
            a << 14 as i32 | a >> 32 as i32 - 14 as i32,
        ) as uint32_t as uint32_t;
    c ^= b;
    c = (c as u32)
        .wrapping_sub(
            b << 24 as i32 | b >> 32 as i32 - 24 as i32,
        ) as uint32_t as uint32_t;
    return c;
}
unsafe extern "C" fn lh_perllike_str_hash(mut k: * const core::ffi::c_void) -> u64 {
...
unsafe extern "C" fn lh_char_hash(mut k: * const core::ffi::c_void) -> u64 {
    static mut random_seed: i32 = -(1 as i32);
    if random_seed == -(1 as i32) {
        let mut seed: i32 = 0;
        loop {
        ...
        (::std::intrinsics::atomic_cxchg(&mut random_seed, -(1 as i32), seed)).0;
    }
    return hashlittle(
        k as *const i8 as *const libc::c_void,
        strlen(k as *const i8),
...
pub unsafe extern "C" fn lh_char_equal(
    ...
    return (strcmp(k1 as *const i8, k2 as *const i8)
        == 0 as i32) as i32;
}
#[no_mangle]
pub unsafe extern "C" fn lh_table_new(
    ...
    mut equal_fn: Option<unsafe extern "C"  fn(_: * const core::ffi::c_void,_: * const core::ffi::c_void,) -> i32>,
) -> * mut crate::src::json_object::lh_table {
    let mut i: i32 = 0;
    let mut t: * mut crate::src::json_object::lh_table = 0 as *mut lh_table;
    if size > 0 as i32 {} else {
        __assert_fail(
            b"size > 0\0" as *const u8 as *const i8,
            b"/home/xial/json-c/linkhash.c\0" as *const u8 as *const i8,
            504 as i32 as u32,
    ...
    t = calloc(
        1 as i32 as u64,
        ::std::mem::size_of::<lh_table>() as u64,
    ) as *mut lh_table;
    if t.is_null() {
    ...
    (*t).count = 0 as i32;
    (*t).size = size;
    let mut fresh1 = &mut ((*t).table);
    *fresh1 = calloc(
        size as u64,
        ::std::mem::size_of::<lh_entry>() as u64,
    ) as *mut lh_entry;
    if ((*t).table).is_null() {
        free(t as *mut libc::c_void);
        return 0 as *mut lh_table;
    }
    let mut fresh2 = &mut ((*t).free_fn);
    *fresh2 = free_fn;
    let mut fresh3 = &mut ((*t).hash_fn);
    *fresh3 = hash_fn;
    let mut fresh4 = &mut ((*t).equal_fn);
    *fresh4 = equal_fn;
    i = 0 as i32;
    while i < size {
        let mut fresh5 = &mut ((*((*t).table).offset(i as isize)).k);
...
pub unsafe extern "C" fn lh_table_resize(
    ...
    ent = (*t).head;
    while !ent.is_null() {
        let mut h: u64 = lh_get_hash(new_t, (*ent).k);
        let mut opts: u32 = 0 as i32 as u32;
        if (*ent).k_is_constant != 0 {
            opts = ((1 as i32) << 2 as i32) as u32;
        }
        if lh_table_insert_w_hash(new_t, (*ent).k, (*ent).v, h, opts) != 0 as i32
        {
            lh_table_free(new_t);
            return -(1 as i32);
        }
    ...
    let mut fresh6 = &mut ((*t).table);
    *fresh6 = (*new_t).table;
    (*t).size = new_size;
    let mut fresh7 = &mut ((*t).head);
    *fresh7 = (*new_t).head;
    let mut fresh8 = &mut ((*t).tail);
    *fresh8 = (*new_t).tail;
    free(new_t as *mut libc::c_void);
    return 0 as i32;
}
#[no_mangle]
pub unsafe extern "C" fn lh_table_free(mut t: * mut crate::src::json_object::lh_table) {
...
pub unsafe extern "C" fn lh_table_insert_w_hash(
    ...
    if (*t).count as f64 >= (*t).size as f64 * 0.66f64 {
        let mut new_size: i32 = if (*t).size
        ...
        if (*t).size == 2147483647 as i32
            || lh_table_resize(t, new_size) != 0 as i32
        {
            return -(1 as i32);
        }
    }
    ...
    let mut fresh9 = &mut ((*((*t).table).offset(n as isize)).k);
    *fresh9 = k;
    (*((*t).table).offset(n as isize))
        .k_is_constant = (opts
        & ((1 as i32) << 2 as i32) as u32) as i32;
    let mut fresh10 = &mut ((*((*t).table).offset(n as isize)).v);
    *fresh10 = v;
    let mut fresh11 = &mut ((*t).count);
    *fresh11 += 1;
    if ((*t).head).is_null() {
        let mut fresh12 = &mut ((*t).tail);
        *fresh12 = &mut *((*t).table).offset(n as isize) as *mut lh_entry;
        let mut fresh13 = &mut ((*t).head);
        *fresh13 = *fresh12;
        let mut fresh14 = &mut ((*((*t).table).offset(n as isize)).prev);
        *fresh14 = 0 as *mut lh_entry;
        let mut fresh15 = &mut ((*((*t).table).offset(n as isize)).next);
        *fresh15 = *fresh14;
    } else {
        let mut fresh16 = &mut ((*(*t).tail).next);
        *fresh16 = &mut *((*t).table).offset(n as isize) as *mut lh_entry;
        let mut fresh17 = &mut ((*((*t).table).offset(n as isize)).prev);
        *fresh17 = (*t).tail;
        let mut fresh18 = &mut ((*((*t).table).offset(n as isize)).next);
        *fresh18 = 0 as *mut lh_entry;
        let mut fresh19 = &mut ((*t).tail);
...
pub unsafe extern "C" fn lh_table_delete_entry(
    ...
    let mut n: i64 = e.offset_from((*t).table) as i64;
    ...
    let mut fresh20 = &mut ((*t).count);
    *fresh20 -= 1;
    if ((*t).free_fn).is_some() {
        ((*t).free_fn).expect("non-null function pointer")(e);
    }
    let mut fresh21 = &mut ((*((*t).table).offset(n as isize)).v);
    *fresh21 = 0 as *const libc::c_void;
    let mut fresh22 = &mut ((*((*t).table).offset(n as isize)).k);
    *fresh22 = -(2 as i32) as *mut libc::c_void;
    ...
    {
        let mut fresh23 = &mut ((*t).tail);
        *fresh23 = 0 as *mut lh_entry;
        let mut fresh24 = &mut ((*t).head);
        *fresh24 = *fresh23;
    } else if (*t).head == &mut *((*t).table).offset(n as isize) as *mut lh_entry {
        let mut fresh25 = &mut ((*(*(*t).head).next).prev);
        *fresh25 = 0 as *mut lh_entry;
        let mut fresh26 = &mut ((*t).head);
        *fresh26 = (*(*t).head).next;
    } else if (*t).tail == &mut *((*t).table).offset(n as isize) as *mut lh_entry {
        let mut fresh27 = &mut ((*(*(*t).tail).prev).next);
        *fresh27 = 0 as *mut lh_entry;
        let mut fresh28 = &mut ((*t).tail);
        *fresh28 = (*(*t).tail).prev;
    } else {
        let mut fresh29 = &mut ((*(*((*t).table).offset(n as isize)).prev).next);
        *fresh29 = (*((*t).table).offset(n as isize)).next;
        let mut fresh30 = &mut ((*(*((*t).table).offset(n as isize)).next).prev);
        *fresh30 = (*((*t).table).offset(n as isize)).prev;
    }
    let mut fresh31 = &mut ((*((*t).table).offset(n as isize)).prev);
    *fresh31 = 0 as *mut lh_entry;
    let mut fresh32 = &mut ((*((*t).table).offset(n as isize)).next);
    *fresh32 = *fresh31;
    return 0 as i32;
}
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn lh_table_length(mut t: * mut crate::src::json_object::lh_table) -> i32 {
    return (*t).count;
}
