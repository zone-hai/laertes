...
impl std::default::Default for proto_name_pattern {
    fn default() -> Self { proto_name_pattern::new() }
}

#[no_mangle]
pub static mut curlinfo: * mut crate::src::lib::version::curl_version_info_data<'static> = (0 as * mut crate::src::lib::version::curl_version_info_data<'_>);
#[no_mangle]
pub static mut built_in_protos: i64 = 0 as i32 as i64;
#[no_mangle]
pub unsafe extern "C" fn get_libcurl_info() -> u32 {
    static mut possibly_built_in: [crate::src::src::tool_libinfo::proto_name_pattern; 27] = [
        {
    ...
    if !((*curlinfo).protocols).is_null() {
        ...
        while !(*proto).is_null() {
            let mut p: * const crate::src::src::tool_libinfo::proto_name_pattern = (0 as * const crate::src::src::tool_libinfo::proto_name_pattern);
