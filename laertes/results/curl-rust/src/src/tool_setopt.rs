...
#[no_mangle]
pub static mut setopt_nv_CURLPROXY: [crate::src::src::tool_operate::NameValue; 8] = [
    {
...
#[no_mangle]
pub static mut setopt_nv_CURL_SOCKS_PROXY: [crate::src::src::tool_operate::NameValue; 5] = [
    {
        let mut init = NameValue {
            name: b"CURLPROXY_SOCKS4\0" as *const u8 as *const i8,
            value: CURLPROXY_SOCKS4 as i32 as i64,
...
#[no_mangle]
pub static mut setopt_nv_CURLHSTS: [crate::src::src::tool_operate::NameValueUnsigned; 2] = [
    {
...
#[no_mangle]
pub static mut setopt_nv_CURLAUTH: [crate::src::src::tool_operate::NameValueUnsigned; 11] = [
    {
        let mut init = NameValueUnsigned {
...
#[no_mangle]
pub static mut setopt_nv_CURL_HTTP_VERSION: [crate::src::src::tool_operate::NameValue; 7] = [
    {
        let mut init = NameValue {
...
#[no_mangle]
pub static mut setopt_nv_CURL_SSLVERSION: [crate::src::src::tool_operate::NameValue; 9] = [
    {
        let mut init = NameValue {
...
#[no_mangle]
pub static mut setopt_nv_CURL_TIMECOND: [crate::src::src::tool_operate::NameValue; 5] = [
    {
        let mut init = NameValue {
...
#[no_mangle]
pub static mut setopt_nv_CURLFTPSSL_CCC: [crate::src::src::tool_operate::NameValue; 4] = [
    {
        let mut init = NameValue {
...
#[no_mangle]
pub static mut setopt_nv_CURLUSESSL: [crate::src::src::tool_operate::NameValue; 5] = [
    {
        let mut init = NameValue {
...
#[no_mangle]
pub static mut setopt_nv_CURLSSLOPT: [crate::src::src::tool_operate::NameValueUnsigned; 7] = [
    {
        let mut init = NameValueUnsigned {
...
#[no_mangle]
pub static mut setopt_nv_CURL_NETRC: [crate::src::src::tool_operate::NameValue; 4] = [
    {
        let mut init = NameValue {
...
#[no_mangle]
pub static mut setopt_nv_CURLPROTO: [crate::src::src::tool_operate::NameValue; 24] = [
    {
        let mut init = NameValue {
...
static mut setopt_nv_CURLNONZERODEFAULTS: [crate::src::src::tool_operate::NameValue; 9] = [
    {
        let mut init = NameValue {
...
pub unsafe extern "C" fn tool_setopt_enum(
    ...
    mut name: * const i8,
    mut tag: u32,
    mut nvlist: * const crate::src::src::tool_operate::NameValue,
    mut lval: i64,
) -> u32 {
    ...
    if !((*config).libcurl).is_null() && !skip && ret as u64 == 0 {
        let mut nv: * const crate::src::src::tool_operate::NameValue = 0 as * const crate::src::src::tool_operate::NameValue;
        nv = nvlist;
...
pub unsafe extern "C" fn tool_setopt_bitmask(
    ...
    mut name: * const i8,
    mut tag: u32,
    mut nvlist: * const crate::src::src::tool_operate::NameValueUnsigned,
    mut lval: i64,
) -> u32 {
    let mut current_block: u64;
    let mut ret: u32 = CURLE_OK;
    ...
    if !((*config).libcurl).is_null() && !skip && ret as u64 == 0 {
        ...
        let mut nv: * const crate::src::src::tool_operate::NameValueUnsigned = 0 as * const crate::src::src::tool_operate::NameValueUnsigned;
        curl_msnprintf(
            preamble.as_mut_ptr(),
            ::std::mem::size_of::<[i8; 80]>() as u64,
            b"curl_easy_setopt(hnd, %s, \0" as *const u8 as *const i8,
...
unsafe extern "C" fn libcurl_generate_slist<'a1>(
    mut slist: * mut crate::src::lib::http2::curl_slist,
    mut slistno: Option<&'a1 mut i32>,
) -> u32 {
    let mut ret: u32 = CURLE_OK;
    let mut escaped: * mut i8 = 0 as *mut i8;
    easysrc_slist_count += 1;
    *(borrow_mut(&mut slistno)).unwrap() = easysrc_slist_count;
    ret = easysrc_addf(
        Some(&mut easysrc_decl),
        b"struct curl_slist *slist%d;\0" as *const u8 as *const i8,
        *(borrow(& slistno)).unwrap(),
    );
    if !(ret as u64 != 0) {
        ret = easysrc_addf(
            Some(&mut easysrc_data),
            b"slist%d = NULL;\0" as *const u8 as *const i8,
            *(borrow(& slistno)).unwrap(),
        );
        if !(ret as u64 != 0) {
            ret = easysrc_addf(
                Some(&mut easysrc_clean),
...
unsafe extern "C" fn libcurl_generate_mime_part(
    mut curl: * mut crate::src::lib::http2::Curl_easy,
    mut config: * mut crate::src::src::tool_cb_dbg::GlobalConfig,
    mut part: * mut crate::src::src::tool_cb_dbg::tool_mime,
    mut mimeno: i32,
) -> u32 {
    let mut current_block: u64;
    let mut ret: u32 = CURLE_OK;
    ...
    if !(ret as u64 != 0) {
        match (*part).kind as u32 {
            1 => {
                ret = libcurl_generate_mime(curl, config, part, Some(&mut submimeno));
                if ret as u64 == 0 {
                    ret = easysrc_addf(
                        Some(&mut easysrc_code),
                                                ...
                                                match current_block {
                                                    ...
                                                    _ => {
                                                        if ret as u64 == 0 && !((*part).headers).is_null() {
                                                            ...
                                                            ret = libcurl_generate_slist((*part).headers, Some(&mut slistno));
                                                            if ret as u64 == 0 {
                                                                ret = easysrc_addf(
                                                                    Some(&mut easysrc_code),
...
unsafe extern "C" fn libcurl_generate_mime<'a1>(
    mut curl: * mut crate::src::lib::http2::Curl_easy,
    mut config: * mut crate::src::src::tool_cb_dbg::GlobalConfig,
    mut toolmime: * mut crate::src::src::tool_cb_dbg::tool_mime,
    mut mimeno: Option<&'a1 mut i32>,
) -> u32 {
    let mut ret: u32 = CURLE_OK;
    easysrc_mime_count += 1;
    *(borrow_mut(&mut mimeno)).unwrap() = easysrc_mime_count;
    ret = easysrc_addf(
        Some(&mut easysrc_decl),
        b"curl_mime *mime%d;\0" as *const u8 as *const i8,
        *(borrow(& mimeno)).unwrap(),
    );
    if !(ret as u64 != 0) {
        ret = easysrc_addf(
            Some(&mut easysrc_data),
...
pub unsafe extern "C" fn tool_setopt_mimepost(
    ...
    mut name: * const i8,
    mut tag: u32,
    mut mimepost: * mut crate::src::lib::http2::curl_mime,
) -> u32 {
    let mut ret: u32 = curl_easy_setopt(curl, tag, mimepost);
...
pub unsafe extern "C" fn tool_setopt_slist(
    ...
    if !((*config).libcurl).is_null() && !list.is_null() && ret as u64 == 0 {
        let mut i: i32 = 0;
        ret = libcurl_generate_slist(list, Some(&mut i));
        if ret as u64 == 0 {
            ret = easysrc_addf(
                Some(&mut easysrc_code),
...
pub unsafe extern "C" fn tool_setopt(
    ...
    if (tag as u32) < 10000 as i32 as u32 {
        ...
        let mut pval: * mut core::ffi::c_void = arg.arg::<*mut libc::c_void>();
        ...
        let mut oval: i64 = arg.arg::<curl_off_t>();
        curl_msnprintf(
            buf.as_mut_ptr(),
            ::std::mem::size_of::<[i8; 256]>() as u64,
        ...
        let mut pblob: * mut core::ffi::c_void = arg.arg::<*mut libc::c_void>();
        if !pblob.is_null() {
    ...
    if !((*global).libcurl).is_null() && !skip && ret as u64 == 0 {
        if remark {
            ...
            let mut len: i64 = -(1 as i32) as curl_off_t;
...
#[no_mangle]
pub extern "C" fn tool_setopt_skip(mut _tag: u32) -> bool {
    return 0 as i32 != 0;
}
