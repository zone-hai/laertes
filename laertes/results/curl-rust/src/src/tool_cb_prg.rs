...
impl std::default::Default for winsize {
    fn default() -> Self { winsize::new() }
}
...
unsafe extern "C" fn fly(mut bar: * mut crate::src::src::tool_cb_hdr::ProgressData, mut moved: bool) {
...
pub unsafe extern "C" fn tool_progress_cb(
    ...
    let mut now: crate::src::lib::openldap::timeval = tvnow();
    ...
    let mut bar: * mut crate::src::src::tool_cb_hdr::ProgressData = &mut (*per).progressbar;
    let mut total: i64 = 0;
    let mut point: i64 = 0;
...
pub unsafe extern "C" fn progressbarinit(
    mut bar: * mut crate::src::src::tool_cb_hdr::ProgressData,
    ...
    if (*bar).width == 0 {
        ...
        let mut ts: crate::src::src::tool_cb_prg::winsize = winsize {
            ws_row: 0,
            ws_col: 0,
            ws_xpixel: 0,
            ws_ypixel: 0,
