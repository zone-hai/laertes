...
impl std::default::Default for curl_easyoption {
    fn default() -> Self { curl_easyoption::new() }
}

unsafe extern "C" fn lookup(
    mut name: * const i8,
    mut id: u32,
) -> * mut crate::src::lib::easygetopt::curl_easyoption {
    if !name.is_null() || id as u32 != 0 {
        let mut o: * mut crate::src::lib::easygetopt::curl_easyoption = &mut *Curl_easyopts
            .as_mut_ptr()
    ...
    return (0 as * mut crate::src::lib::easygetopt::curl_easyoption);
}
#[no_mangle]
pub unsafe extern "C" fn curl_easy_option_by_name(
    mut name: * const i8,
) -> * const crate::src::lib::easygetopt::curl_easyoption {
...
pub unsafe extern "C" fn curl_easy_option_next(
    mut prev: * const crate::src::lib::easygetopt::curl_easyoption,
) -> * const crate::src::lib::easygetopt::curl_easyoption {
    ...
    return (0 as * const crate::src::lib::easygetopt::curl_easyoption);
}
