...
#[no_mangle]
pub unsafe extern "C" fn Curl_range(mut data: * mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut from: i64 = 0;
    let mut to: i64 = 0;
    ...
    {
        let mut from_t: u32 = CURL_OFFT_OK;
        let mut to_t: u32 = CURL_OFFT_OK;
        ...
        to_t = curlx_strtoofft(ptr, Some(&mut ptr2), 0 as i32, Some(&mut to));
