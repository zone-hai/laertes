...
impl std::default::Default for contenc_writer {
    fn default() -> Self { contenc_writer::new() }
}
...
pub struct content_encoding {
    pub name: * const i8,
    pub alias: * const i8,
    pub init_writer: Option<unsafe extern "C"  fn(_: * mut crate::src::lib::http2::Curl_easy,_: * mut crate::src::lib::content_encoding::contenc_writer,) -> u32>,
    pub unencode_write: Option<unsafe extern "C"  fn(_: * mut crate::src::lib::http2::Curl_easy,_: * mut crate::src::lib::content_encoding::contenc_writer,_: * const i8,_: u64,) -> u32>,
    pub close_writer: Option<unsafe extern "C"  fn(_: * mut crate::src::lib::http2::Curl_easy,_: * mut crate::src::lib::content_encoding::contenc_writer,) -> ()>,
    pub paramsize: u64,
}
...
impl std::default::Default for content_encoding {
    fn default() -> Self { content_encoding::new() }
}
...
pub type alloc_func<'a1, 'a2> = Option<unsafe extern "C"  fn(_: Option<&'a1 mut core::ffi::c_void>,_: u32,_: u32,) -> Option<&'a2 mut core::ffi::c_void>>;
...
impl std::default::Default for zlib_params {
    fn default() -> Self { zlib_params::new() }
}
...
unsafe extern "C" fn zfree_cb(mut opaque: * mut core::ffi::c_void, mut ptr: * mut core::ffi::c_void) {
...
unsafe extern "C" fn exit_zlib<'a1>(
    mut data: * mut crate::src::lib::http2::Curl_easy,
    mut z: * mut crate::src::lib::content_encoding::z_stream_s,
...
unsafe extern "C" fn process_trailer(
    ...
    let mut z: * mut crate::src::lib::content_encoding::z_stream_s = &mut (*zp).z;
    let mut result: u32 = CURLE_OK;
    let mut len: u32 = if (*z).avail_in < (*zp).trailerlen {
        (*z).avail_in
    } else {
        (*zp).trailerlen
    };
    let mut fresh1 = &mut ((*zp).trailerlen);
    *fresh1 = (*fresh1 as u32).wrapping_sub(len) as uInt as uInt;
    let mut fresh2 = &mut ((*z).avail_in);
    *fresh2 = (*fresh2 as u32).wrapping_sub(len) as uInt as uInt;
    let mut fresh3 = &mut ((*z).next_in);
    *fresh3 = (*fresh3).offset(len as isize);
    if (*z).avail_in != 0 {
        result = CURLE_WRITE_ERROR;
    }
    if result as u32 != 0 || (*zp).trailerlen == 0 {
        result = exit_zlib(data, z, Some(&mut (*zp).zlib_init), result);
    } else {
...
unsafe extern "C" fn inflate_stream(
    ...
    let mut zp: * mut crate::src::lib::content_encoding::zlib_params = &mut (*writer).params as *mut *mut libc::c_void
        as *mut zlib_params;
    let mut z: * mut crate::src::lib::content_encoding::z_stream_s = &mut (*zp).z;
    let mut nread: u32 = (*z).avail_in;
    let mut orig_in: * mut u8 = (*z).next_in;
    ...
    {
        return exit_zlib(data, z, Some(&mut (*zp).zlib_init), CURLE_WRITE_ERROR);
    }
    decomp = Curl_cmalloc
        .expect("non-null function pointer")(16384 as i32 as size_t)
        as *mut i8;
    if decomp.is_null() {
        return exit_zlib(data, z, Some(&mut (*zp).zlib_init), CURLE_OUT_OF_MEMORY);
    }
    while !done {
        let mut status: i32 = 0;
        done = 1 as i32 != 0;
        let mut fresh4 = &mut ((*z).next_out);
        *fresh4 = decomp as *mut Bytef;
        ...
        if (*z).avail_out != 16384 as i32 as u32 {
            if status == 0 as i32 || status == 1 as i32 {
                ...
                if result as u64 != 0 {
                    exit_zlib(data, z, Some(&mut (*zp).zlib_init), result);
                    break;
                }
            }
        }
...
unsafe extern "C" fn deflate_init_writer(
    ...
    let mut fresh6 = &mut ((*z).zalloc);
    *fresh6 = core::intrinsics::transmute::<Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: u32,_: u32,) -> * mut core::ffi::c_void>, Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: u32,_: u32,) -> * mut core::ffi::c_void>>(
        Some(
            zalloc_cb,
        ),
    );
    let mut fresh7 = &mut ((*z).zfree);
    *fresh7 = core::intrinsics::transmute::<Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: * mut core::ffi::c_void,) -> ()>, Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: * mut core::ffi::c_void,) -> ()>>(Some(zfree_cb));
    if inflateInit_(
        z,
        b"1.2.11\0" as *const u8 as *const i8,
        ::std::mem::size_of::<z_stream>() as u64 as i32,
...
unsafe extern "C" fn deflate_unencode_write(
    ...
    let mut zp: * mut crate::src::lib::content_encoding::zlib_params = &mut (*writer).params as *mut *mut libc::c_void
        as *mut zlib_params;
    let mut z: Option<&'_ mut crate::src::lib::content_encoding::z_stream_s> = Some(&mut (*zp).z);
...
unsafe extern "C" fn deflate_close_writer(
    ...
    let mut zp: * mut crate::src::lib::content_encoding::zlib_params = &mut (*writer).params as *mut *mut libc::c_void
        as *mut zlib_params;
    let mut z: * mut crate::src::lib::content_encoding::z_stream_s = &mut (*zp).z;
    exit_zlib(data, z, Some(&mut (*zp).zlib_init), CURLE_OK);
}
static mut deflate_encoding: crate::src::lib::content_encoding::content_encoding = unsafe {
    {
...
unsafe extern "C" fn gzip_init_writer(
    ...
    let mut fresh9 = &mut ((*z).zalloc);
    *fresh9 = core::intrinsics::transmute::<Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: u32,_: u32,) -> * mut core::ffi::c_void>, Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: u32,_: u32,) -> * mut core::ffi::c_void>>(
        Some(
            zalloc_cb,
        ),
    );
    let mut fresh10 = &mut ((*z).zfree);
    *fresh10 = core::intrinsics::transmute::<Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: * mut core::ffi::c_void,) -> ()>, Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: * mut core::ffi::c_void,) -> ()>>(Some(zfree_cb));
...
unsafe extern "C" fn check_gzip_header<'a1>(
    mut data: * const u8,
    mut len: i64,
...
unsafe extern "C" fn gzip_unencode_write(
    ...
    match (*zp).zlib_init as u32 {
        ...
        4 => {
            ...
            let mut fresh14 = &mut ((*z).avail_in);
            *fresh14 = (*fresh14 as u32).wrapping_add(nbytes as uInt) as uInt
                as uInt;
            let mut fresh15 = &mut ((*z).next_in);
            *fresh15 = Curl_saferealloc(
            ...
            match check_gzip_header((*z).next_in, (*z).avail_in as ssize_t, Some(&mut hlen_0))
                as u32
            {
                0 => {
                    Curl_cfree
        ...
        3 => {
            let mut fresh17 = &mut ((*z).next_in);
            *fresh17 = buf as *mut Bytef;
            (*z).avail_in = nbytes as uInt;
            return process_trailer(data, zp);
        }
        5 | _ => {
            let mut fresh18 = &mut ((*z).next_in);
...
static mut gzip_encoding: crate::src::lib::content_encoding::content_encoding = unsafe {
    {
        let mut init = content_encoding {
...
static mut identity_encoding: crate::src::lib::content_encoding::content_encoding = unsafe {
    {
        let mut init = content_encoding {
...
pub unsafe extern "C" fn Curl_all_content_encodings() -> * mut i8 {
    ...
    let mut cep: * const * const crate::src::lib::content_encoding::content_encoding = (0 as * const * const crate::src::lib::content_encoding::content_encoding);
    let mut ce: * const crate::src::lib::content_encoding::content_encoding = 0 as *const content_encoding;
...
static mut client_encoding: crate::src::lib::content_encoding::content_encoding = unsafe {
    {
        let mut init = content_encoding {
            name: 0 as *const i8,
            alias: 0 as *const i8,
...
static mut error_encoding: crate::src::lib::content_encoding::content_encoding = unsafe {
    {
        let mut init = content_encoding {
            name: 0 as *const i8,
            alias: 0 as *const i8,
...
unsafe extern "C" fn new_unencoding_writer(
    ...
    let mut sz: u64 = (16 as u64).wrapping_add((*handler).paramsize);
    let mut writer: * mut crate::src::lib::content_encoding::contenc_writer = Curl_ccalloc
        .expect("non-null function pointer")(1 as i32 as size_t, sz)
        as *mut contenc_writer;
    if !writer.is_null() {
        let mut fresh21 = &mut ((*writer).handler);
        *fresh21 = handler;
        let mut fresh22 = &mut ((*writer).downstream);
        *fresh22 = downstream;
...
#[no_mangle]
pub unsafe extern "C" fn Curl_unencode_cleanup(mut data: * mut crate::src::lib::http2::Curl_easy) {
    let mut k: Option<&'_ mut crate::src::lib::http2::SingleRequest> = Some(&mut (*data).req);
    let mut writer: * mut crate::src::lib::content_encoding::contenc_writer = (*(borrow_mut(&mut k)).unwrap()).writer_stack;
...
unsafe extern "C" fn find_encoding(
    ...
    cep = encodings.as_ptr();
    while !(*cep).is_null() {
        let mut ce: * const crate::src::lib::content_encoding::content_encoding = *cep;
...
pub unsafe extern "C" fn Curl_build_unencoding_stack(
    ...
    loop {
            ...
            ) != 0
        {
            ...
            let mut encoding: * const crate::src::lib::content_encoding::content_encoding = find_encoding(name, namelen);
            let mut writer: * mut crate::src::lib::content_encoding::contenc_writer = 0 as *mut contenc_writer;
            ...
            writer = new_unencoding_writer(data, encoding, (*(borrow_mut(&mut k)).unwrap()).writer_stack);
            if writer.is_null() {
                return CURLE_OUT_OF_MEMORY;
            }
