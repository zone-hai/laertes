...
#[repr(C)]
pub struct dohentry {
    pub cname: Option<crate::__laertes_array::CustomSlice<'static, crate::src::lib::http2::dynbuf, [crate::src::lib::http2::dynbuf; 4]>>,
    pub addr: Option<crate::__laertes_array::CustomSlice<'static, crate::src::lib::doh::dohaddr, [crate::src::lib::doh::dohaddr; 24]>>,
    pub numaddr: i32,
    pub ttl: u32,
    pub numcname: i32,
}
...
unsafe extern "C" fn doh_strerror(mut code: u32) -> * const i8 {
...
unsafe extern "C" fn doh_encode<'a1>(
    mut host: * const i8,
    mut dnstype: u32,
    mut dnsp: * mut u8,
    mut len: u64,
    ...
    *(borrow_mut(&mut olen)).unwrap() = dnsp.offset_from(orig) as i64 as size_t;
    return DOH_OK;
}
...
unsafe extern "C" fn doh_done(
    mut doh: * mut crate::src::lib::http2::Curl_easy,
    mut result: u32,
) -> i32 {
    let mut data: * mut crate::src::lib::http2::Curl_easy = (*doh).set.dohfor;
    let mut dohp: * mut crate::src::lib::http2::dohdata = (*data).req.doh;
    let mut fresh18 = &mut ((*dohp).pending);
...
unsafe extern "C" fn dohprobe<'a1>(
    ...
    Curl_dyn_init(&mut (*(borrow_mut(&mut p)).unwrap()).serverdoh, 3000 as i32 as size_t);
    ...
    match current_block {
        15652330335145281839 => {
            timeout_ms = Curl_timeleft(data, (0 as * mut crate::src::lib::http2::curltime), 1 as i32 != 0);
            if timeout_ms <= 0 as i32 as i64 {
                result = CURLE_OPERATION_TIMEDOUT;
            } else {
                result = Curl_open(Some(&mut doh));
                if result as u64 == 0 {
                    let mut resp: * mut crate::src::lib::http2::dynbuf = &mut (*(borrow_mut(&mut p)).unwrap()).serverdoh;
                                                                                                                                                                            ...
                                                                                                                                                                            _ => {
                                                                                                                                                                                ...
                                                                                                                                                                                match current_block {
                                                                                                                                                                                    ...
                                                                                                                                                                                    _ => {
                                                                                                                                                                                        ...
                                                                                                                                                                                        let mut fresh20 = &mut ((*doh).set.fmultidone);
                                                                                                                                                                                        *fresh20 = Some(
                                                                                                                                                                                            doh_done,
                                                                                                                                                                                        );
                                                                                                                                                                                        let mut fresh21 = &mut ((*doh).set.dohfor);
                                                                                                                                                                                        *fresh21 = data;
                                                                                                                                                                                        let mut fresh22 = &mut ((*(borrow_mut(&mut p)).unwrap()).easy);
                                                                                                                                                                                        *fresh22 = doh;
...
#[no_mangle]
pub unsafe extern "C" fn Curl_doh<'a1>(
    mut data: * mut crate::src::lib::http2::Curl_easy,
    ...
    *(borrow_mut(&mut waitp)).unwrap() = 1 as i32;
    let mut fresh23 = &mut ((*data).req.doh);
    *fresh23 = Curl_ccalloc
    ...
    let mut fresh25 = &mut ((*dohp).host);
    *fresh25 = hostname;
    (*dohp).port = port;
    let mut fresh26 = &mut ((*dohp).headers);
    *fresh26 = curl_slist_append(
    ...
    if !((*dohp).headers).is_null() {
        ...
        if !(result as u64 != 0) {
            let mut fresh27 = &mut ((*dohp).pending);
            *fresh27 = (*fresh27).wrapping_add(1);
            if Curl_ipv6works(data) {
                ...
                if result as u64 != 0 {
                    ...
                    let mut fresh28 = &mut ((*dohp).pending);
    ...
    curl_slist_free_all((*dohp).headers);
    let mut fresh29 = &mut ((*(*data).req.doh).headers);
    *fresh29 = 0 as *mut curl_slist;
    slot = 0 as i32;
    while slot < DOH_PROBE_SLOTS as i32 {
        Curl_close(Some(&mut (*((*dohp).probe).as_mut_ptr().offset(slot as isize)).easy));
        slot += 1;
    }
    Curl_cfree.expect("non-null function pointer")((*data).req.doh as *mut libc::c_void);
    let mut fresh30 = &mut ((*data).req.doh);
    *fresh30 = 0 as *mut dohdata;
    return 0 as *mut Curl_addrinfo;
}
unsafe extern "C" fn skipqname<'a1>(
    mut doh: * const u8,
    mut dohlen: u64,
    ...
    loop {
        if dohlen
            < (*(borrow(& indexp)).unwrap()).wrapping_add(1 as i32 as u32) as u64
        {
            return DOH_DNS_OUT_OF_RANGE;
        }
        length = *doh.offset(*(borrow(& indexp)).unwrap() as isize);
        if length as i32 & 0xc0 as i32 == 0xc0 as i32 {
            ...
            *(borrow_mut(&mut indexp)).unwrap() = (*(borrow(& indexp)).unwrap()).wrapping_add(2 as i32 as u32);
            break;
        } else {
            ...
            *(borrow_mut(&mut indexp)).unwrap() = (*(borrow(& indexp)).unwrap())
                .wrapping_add(
...
unsafe extern "C" fn store_a(
    ...
    if (*d).numaddr < 24 as i32 {
        let mut a: Option<&'_ mut crate::src::lib::doh::dohaddr> = Some(&mut (*crate::__laertes_array::GetMut::<&mut _>::get_offset_mut(((*d).addr).as_mut().unwrap(), ((*d).numaddr as isize))));
...
unsafe extern "C" fn store_cname(
    ...
    let mut fresh33 = &mut ((*d).numcname);
    let mut fresh34 = *fresh33;
    *fresh33 = *fresh33 + 1;
    c = &mut (*crate::__laertes_array::GetMut::<&mut _>::get_offset_mut(((*d).cname).as_mut().unwrap(), (fresh34 as isize))) as *mut dynbuf;
    loop {
...
unsafe extern "C" fn de_init(mut de: * mut crate::src::lib::doh::dohentry) {
    let mut i: i32 = 0;
    memset(
    ...
    while i < 4 as i32 {
        Curl_dyn_init(
            &mut (*crate::__laertes_array::GetMut::<&mut _>::get_offset_mut(((*de).cname).as_mut().unwrap(), (i as isize))),
...
unsafe extern "C" fn showdoh<'a1>(mut data: * mut crate::src::lib::http2::Curl_easy, mut d: Option<&'a1 crate::src::lib::doh::dohentry>) {
    let mut i: i32 = 0;
    Curl_infof(data, b"TTL: %u seconds\0" as *const u8 as *const i8, (*((d).clone()).unwrap()).ttl);
    i = 0 as i32;
    while i < (*((d).clone()).unwrap()).numaddr {
        let mut a: Option<&'_ crate::src::lib::doh::dohaddr> = (Some(&(*crate::__laertes_array::Get::<&_>::get_offset(((*((d).clone()).unwrap()).addr).as_ref().unwrap(), (i as isize))))).clone();
        if (*((a).clone()).unwrap()).type_0 == DNS_TYPE_A as i32 {
            ...
            while j < 16 as i32 {
                ...
                curl_msnprintf(
                    ...
                    (*crate::__laertes_array::Get::<&_>::get_add(((*((d).clone()).unwrap()).addr).as_ref().unwrap(), (i as usize))).ip.v6[j as usize] as i32,
                    (*crate::__laertes_array::Get::<&_>::get_add(((*((d).clone()).unwrap()).addr).as_ref().unwrap(), (i as usize))).ip.v6[(j + 1 as i32) as usize]
                        as i32,
                );
                l = strlen(ptr);
    ...
    while i < (*((d).clone()).unwrap()).numcname {
        Curl_infof(
            ...
            Curl_dyn_ptr(&(*crate::__laertes_array::Get::<&_>::get_offset(((*((d).clone()).unwrap()).cname).as_ref().unwrap(), (i as isize)))),
        );
        i += 1;
    }
}
unsafe extern "C" fn doh2ai<'a1>(
    ...
    let mut result: u32 = CURLE_OK;
    let mut i: i32 = 0;
    let mut hostlen: u64 = (strlen(hostname))
    ...
    while i < (*((de).clone()).unwrap()).numaddr {
        ...
        if (*crate::__laertes_array::Get::<&_>::get_add(((*((de).clone()).unwrap()).addr).as_ref().unwrap(), (i as usize))).type_0 == DNS_TYPE_AAAA as i32 {
        ...
        if ai.is_null() {
            ...
            *fresh36 = ((*ai).ai_addr as *mut i8).offset(ss_size as isize)
            ...
            if !prevai.is_null() {
                let mut fresh37 = &mut ((*prevai).ai_next);
                *fresh37 = ai;
            }
            ...
            match (*ai).ai_family {
                2 => {
                    ...
                    memcpy(
                        ...
                        &(*crate::__laertes_array::Get::<&_>::get_offset(((*((de).clone()).unwrap()).addr).as_ref().unwrap(), (i as isize))).ip.v4
                ...
                10 => {
                    ...
                    memcpy(
                        ...
                        &(*crate::__laertes_array::Get::<&_>::get_offset(((*((de).clone()).unwrap()).addr).as_ref().unwrap(), (i as isize))).ip.v6
...
unsafe extern "C" fn de_cleanup<'a1>(mut d: Option<&'a1 mut crate::src::lib::doh::dohentry>) {
    let mut i: i32 = 0 as i32;
    i = 0 as i32;
    while i < (*(borrow(& d)).unwrap()).numcname {
        Curl_dyn_free(&mut (*crate::__laertes_array::GetMut::<&mut _>::get_offset_mut(((*(borrow_mut(&mut d)).unwrap()).cname).as_mut().unwrap(), (i as isize))));
        i += 1;
    }
}
#[no_mangle]
pub unsafe extern "C" fn Curl_doh_is_resolved<'a1>(
    mut data: * mut crate::src::lib::http2::Curl_easy,
            ...
            .is_null()
    {
        ...
        if (*dohp).pending == 0 {
            ...
            let mut de: crate::src::lib::doh::dohentry = dohentry {
                cname: Some(crate::__laertes_array::CustomSlice::new([dynbuf {
                    bufr: 0 as *mut i8,
                    leng: 0,
                    allc: 0,
                    toobig: 0,
                }; 4])),
                addr: Some(crate::__laertes_array::CustomSlice::new([dohaddr {
                    type_0: 0,
            ...
            while slot < DOH_PROBE_SLOTS as i32 {
                ...
                Curl_close(
                    Some(&mut (*((*dohp).probe).as_mut_ptr().offset(slot as isize)).easy),
                );
                slot += 1;
            }
            de_init(&mut de);
            slot = 0 as i32;
            while slot < DOH_PROBE_SLOTS as i32 {
                let mut p: Option<&'_ mut crate::src::lib::http2::dnsprobe> = Some(&mut *((*dohp).probe)
                    .as_mut_ptr()
                ...
                || rc[DOH_PROBE_SLOT_IPADDR_V6 as i32 as usize] as u64 == 0
            {
                ...
                ai = doh2ai(Some(&mut de), (*dohp).host, (*dohp).port);
                if ai.is_null() {
                ...
                if dns.is_null() {
                    ...
                    let mut fresh38 = &mut ((*data).state.async_0.dns);
                    *fresh38 = dns;
            ...
            let mut fresh39 = &mut ((*data).req.doh);
