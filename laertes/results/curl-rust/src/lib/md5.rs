...
extern "C" {
    ...
    fn MD5_Final(md: * mut u8, c: * mut crate::src::lib::md5::MD5state_st) -> i32;
    fn MD5_Init(c: * mut crate::src::lib::md5::MD5state_st) -> i32;
    fn MD5_Update(
        c: * mut crate::src::lib::md5::MD5state_st,
...
pub struct MD5_params {
    pub md5_init_func: Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,) -> ()>,
    pub md5_update_func: Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: * const u8,_: u32,) -> ()>,
    pub md5_final_func: Option<unsafe extern "C"  fn(_: * mut u8,_: * mut core::ffi::c_void,) -> ()>,
    pub md5_ctxtsize: u32,
    pub md5_resultlen: u32,
}
impl MD5_params {
    pub const fn new() -> Self {
        MD5_params {
        md5_init_func: None,
        md5_update_func: None,
        md5_final_func: None,
        md5_ctxtsize: 0,
        md5_resultlen: 0
        }
...
impl std::default::Default for MD5_params {
    fn default() -> Self { MD5_params::new() }
}

#[derive(Copy, Clone)]
#[repr(C)]
pub struct MD5_context {
    pub md5_hash: * const crate::src::lib::md5::MD5_params,
    pub md5_hashctx: * mut core::ffi::c_void,
}
impl MD5_context {
    pub const fn new() -> Self {
        MD5_context {
        md5_hash: (0 as * const crate::src::lib::md5::MD5_params),
        md5_hashctx: (0 as * mut core::ffi::c_void)
        }
    }
}

impl std::default::Default for MD5_context {
    fn default() -> Self { MD5_context::new() }
}

pub type MD5_CTX = crate::src::lib::md5::MD5state_st;
#[derive(Copy, Clone)]
#[repr(C)]
...
impl std::default::Default for MD5state_st {
    fn default() -> Self { MD5state_st::new() }
}

#[no_mangle]
pub static mut Curl_HMAC_MD5: [crate::src::lib::curl_ntlm_core::HMAC_params; 1] = unsafe {
    [
        {
            let mut init = HMAC_params {
                hmac_hinit: core::intrinsics::transmute::<Option<unsafe extern "C"  fn() -> ()>, Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,) -> ()>>(
                    core::intrinsics::transmute::<Option<unsafe extern "C"  fn(_: * mut crate::src::lib::md5::MD5state_st,) -> i32>, Option<unsafe extern "C"  fn() -> ()>>(
                        Some(
                            MD5_Init,
                        ),
                    ),
                ...
                hmac_hupdate: core::intrinsics::transmute::<Option<unsafe extern "C"  fn() -> ()>, Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: * const u8,_: u32,) -> ()>>(
                    core::intrinsics::transmute::<Option<unsafe extern "C"  fn(_: * mut crate::src::lib::md5::MD5state_st,_: * const core::ffi::c_void,_: u64,) -> i32>, Option<unsafe extern "C"  fn() -> ()>>(
                        Some(
                            MD5_Update,
                        ),
                    ),
                ...
                hmac_hfinal: core::intrinsics::transmute::<Option<unsafe extern "C"  fn() -> ()>, Option<unsafe extern "C"  fn(_: * mut u8,_: * mut core::ffi::c_void,) -> ()>>(
                    core::intrinsics::transmute::<Option<unsafe extern "C"  fn(_: * mut u8,_: * mut crate::src::lib::md5::MD5state_st,) -> i32>, Option<unsafe extern "C"  fn() -> ()>>(
                        Some(
                            MD5_Final,
                        ),
                    ),
                ),
                hmac_ctxtsize: ::std::mem::size_of::<MD5_CTX>() as u64
                    as u32,
                hmac_maxkeylen: 64 as i32 as u32,
                hmac_resultlen: 16 as i32 as u32,
            };
            init
        },
    ]
...
#[no_mangle]
pub static mut Curl_DIGEST_MD5: [crate::src::lib::md5::MD5_params; 1] = unsafe {
    [
        {
            let mut init = MD5_params {
                md5_init_func: core::intrinsics::transmute::<Option<unsafe extern "C"  fn() -> ()>, Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,) -> ()>>(
                    core::intrinsics::transmute::<Option<unsafe extern "C"  fn(_: * mut crate::src::lib::md5::MD5state_st,) -> i32>, Option<unsafe extern "C"  fn() -> ()>>(
                        Some(
                            MD5_Init,
                        ),
                ...
                md5_update_func: core::intrinsics::transmute::<Option<unsafe extern "C"  fn() -> ()>, Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: * const u8,_: u32,) -> ()>>(
                    core::intrinsics::transmute::<Option<unsafe extern "C"  fn(_: * mut crate::src::lib::md5::MD5state_st,_: * const core::ffi::c_void,_: u64,) -> i32>, Option<unsafe extern "C"  fn() -> ()>>(
                        Some(
                            MD5_Update,
                        ),
                ...
                md5_final_func: core::intrinsics::transmute::<Option<unsafe extern "C"  fn() -> ()>, Option<unsafe extern "C"  fn(_: * mut u8,_: * mut core::ffi::c_void,) -> ()>>(
                    core::intrinsics::transmute::<Option<unsafe extern "C"  fn(_: * mut u8,_: * mut crate::src::lib::md5::MD5state_st,) -> i32>, Option<unsafe extern "C"  fn() -> ()>>(
                        Some(
                            MD5_Final,
                        ),
                ...
                md5_ctxtsize: ::std::mem::size_of::<MD5_CTX>() as u64
                    as u32,
                md5_resultlen: 16 as i32 as u32,
            };
            init
        },
    ]
...
pub unsafe extern "C" fn Curl_md5it(
    mut outbuffer: * mut u8,
    mut input: * const u8,
    len: u64,
) {
    let mut ctx: crate::src::lib::md5::MD5state_st = MD5_CTX {
        A: 0,
        B: 0,
        C: 0,
        D: 0,
...
pub unsafe extern "C" fn Curl_MD5_init(
    mut md5params: * const crate::src::lib::md5::MD5_params,
) -> * mut crate::src::lib::md5::MD5_context {
    let mut ctxt: * mut crate::src::lib::md5::MD5_context = 0 as *mut MD5_context;
    ctxt = Curl_cmalloc
        .expect(
            "non-null function pointer",
        )(::std::mem::size_of::<MD5_context>() as u64) as *mut MD5_context;
    if ctxt.is_null() {
        return ctxt;
    }
    let mut fresh0 = &mut ((*ctxt).md5_hashctx);
    *fresh0 = Curl_cmalloc
    ...
    let mut fresh1 = &mut ((*ctxt).md5_hash);
    *fresh1 = md5params;
...
pub unsafe extern "C" fn Curl_MD5_update(
    mut context: * mut crate::src::lib::md5::MD5_context,
    mut data: * const u8,
    mut len: u32,
) -> u32 {
