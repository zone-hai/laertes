...
#[no_mangle]
pub extern "C" fn Curl_none_check_cxn(mut _conn: * mut crate::src::lib::http2::connectdata) -> i32 {
    return -(1 as i32);
}
#[no_mangle]
...
#[no_mangle]
pub extern "C" fn Curl_none_close_all(mut _data: * mut crate::src::lib::http2::Curl_easy) {}
#[no_mangle]
pub extern "C" fn Curl_none_session_free(mut _ptr: * mut core::ffi::c_void) {}
#[no_mangle]
pub extern "C" fn Curl_none_data_pending(
    mut _conn: * const crate::src::lib::http2::connectdata,
    mut _connindex: i32,
) -> bool {
    return 0 as i32 != 0;
}
...
static mut Curl_ssl_multi: crate::src::lib::getinfo::Curl_ssl =
    {
