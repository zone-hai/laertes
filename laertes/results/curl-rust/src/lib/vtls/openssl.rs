...
unsafe extern "C" fn ossl_keylog_callback(
    mut _ssl: * const crate::src::lib::vtls::openssl::ssl_st,
    mut line: * const i8,
) {
...
unsafe extern "C" fn ossl_engines_list(mut _data: * mut crate::src::lib::http2::Curl_easy) -> * mut crate::src::lib::http2::curl_slist {
...
unsafe extern "C" fn ossl_trace(
    ...
    mut len: u64,
    mut _ssl: * mut crate::src::lib::vtls::openssl::ssl_st,
...
#[no_mangle]
pub static mut Curl_ssl_openssl: crate::src::lib::getinfo::Curl_ssl =
    {
