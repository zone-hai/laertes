...
#[no_mangle]
pub static mut Curl_handler_http: crate::src::lib::http2::Curl_handler =
    {
...
#[no_mangle]
pub static mut Curl_handler_https: crate::src::lib::http2::Curl_handler =
    {
        let mut init = Curl_handler {
...
pub unsafe extern "C" fn Curl_http_statusline(
    ...
    if (*conn).httpversion as i32 == 10 as i32 {
        ...
        let _ = (*conn).httpversion as i32 >= 11 as i32
            && ((*conn).bits).close() == 0;
    }
    (*k)
        .set_http_bodyless(
