...
impl std::default::Default for curl_forms {
    fn default() -> Self { curl_forms::new() }
}
...
pub struct FormInfo {
    ...
    pub more: * mut crate::src::lib::formdata::FormInfo,
    pub name_alloc: bool,
...
impl FormInfo {
    pub const fn new() -> Self {
        ...
        more: (0 as * mut crate::src::lib::formdata::FormInfo),
        name_alloc: false,
        value_alloc: false,
        contenttype_alloc: false,
        showfilename_alloc: false
        }
    }
}

impl std::default::Default for FormInfo {
    fn default() -> Self { FormInfo::new() }
}

pub type curl_formget_callback<'a1, 'a2> = Option<unsafe extern "C"  fn(_: Option<&'a1 mut core::ffi::c_void>,_: Option<&'a2 i8>,_: u64,) -> u64>;
...
unsafe extern "C" fn AddHttpPost<'a1, 'a2>(
    mut name: * mut i8,
    mut namelength: u64,
    mut value: * mut i8,
    mut contentslength: i64,
    mut buffer: * mut i8,
    mut bufferlength: u64,
    mut contenttype: * mut i8,
    mut flags: i64,
    mut contentHeader: * mut crate::src::lib::http2::curl_slist,
    mut showfilename: * mut i8,
    mut userp: * mut i8,
    mut parent_post: * mut crate::src::lib::http2::curl_httppost,
    mut httppost: Option<&'a1 mut * mut crate::src::lib::http2::curl_httppost>,
    mut last_post: Option<&'a2 mut * mut crate::src::lib::http2::curl_httppost>,
) -> * mut crate::src::lib::http2::curl_httppost {
    let mut post: * mut crate::src::lib::http2::curl_httppost = 0 as *mut curl_httppost;
    post = Curl_ccalloc
        .expect(
    ...
    if !post.is_null() {
        ...
        *fresh0 = name;
        ...
        let mut fresh1 = &mut ((*post).contents);
        *fresh1 = value;
        (*post).contentlen = contentslength;
        let mut fresh2 = &mut ((*post).buffer);
        *fresh2 = buffer;
        (*post).bufferlength = bufferlength as i64;
        let mut fresh3 = &mut ((*post).contenttype);
        *fresh3 = contenttype;
        let mut fresh4 = &mut ((*post).contentheader);
        *fresh4 = contentHeader;
        let mut fresh5 = &mut ((*post).showfilename);
        *fresh5 = showfilename;
        let mut fresh6 = &mut ((*post).userp);
    ...
    if !parent_post.is_null() {
        let mut fresh7 = &mut ((*post).more);
        *fresh7 = (*parent_post).more;
        let mut fresh8 = &mut ((*parent_post).more);
        *fresh8 = post;
    } else {
        if !(*(borrow_mut(&mut last_post)).unwrap()).is_null() {
            let mut fresh9 = &mut ((**(borrow_mut(&mut last_post)).unwrap()).next);
            *fresh9 = post;
        } else {
            *(borrow_mut(&mut httppost)).unwrap() = post;
        }
        *(borrow_mut(&mut last_post)).unwrap() = post;
    }
    return post;
}
unsafe extern "C" fn AddFormInfo(
    mut value: * mut i8,
    mut contenttype: * mut i8,
    mut parent_form_info: * mut crate::src::lib::formdata::FormInfo,
) -> * mut crate::src::lib::formdata::FormInfo {
    let mut form_info: * mut crate::src::lib::formdata::FormInfo = 0 as *mut FormInfo;
    ...
    if !form_info.is_null() {
        if !value.is_null() {
            let mut fresh10 = &mut ((*form_info).value);
            *fresh10 = value;
        }
        if !contenttype.is_null() {
            let mut fresh11 = &mut ((*form_info).contenttype);
            *fresh11 = contenttype;
        }
    ...
    if !parent_form_info.is_null() {
        let mut fresh12 = &mut ((*form_info).more);
        *fresh12 = (*parent_form_info).more;
        let mut fresh13 = &mut ((*parent_form_info).more);
        *fresh13 = form_info;
    }
    return form_info;
}
unsafe extern "C" fn FormAdd<'a1, 'a2>(
    mut httppost: Option<&'a1 mut * mut crate::src::lib::http2::curl_httppost>,
    mut last_post: Option<&'a2 mut * mut crate::src::lib::http2::curl_httppost>,
    mut params: core::ffi::VaList,
) -> u32 {
    let mut first_form: * mut crate::src::lib::formdata::FormInfo = 0 as *mut FormInfo;
    let mut current_form: * mut crate::src::lib::formdata::FormInfo = 0 as *mut FormInfo;
    let mut form: * mut crate::src::lib::formdata::FormInfo = 0 as *mut FormInfo;
    let mut return_value: u32 = CURL_FORMADD_OK;
    let mut prevtype: * const i8 = 0 as *const i8;
    let mut post: * mut crate::src::lib::http2::curl_httppost = 0 as *mut curl_httppost;
    let mut option: u32 = CURLFORM_NOTHING;
    let mut forms: * mut crate::src::lib::formdata::curl_forms = 0 as *mut curl_forms;
        ...
        match option as u32 {
            ...
            7 => {
                        ...
                        | (1 as i32) << 1 as i32) as i64 != 0
                {
                    ...
                    if !filename.is_null() {
                        let mut fresh16 = &mut ((*current_form).value);
            ...
            10 => {
                ...
                if !((*current_form).value).is_null() {
                    ...
                    let mut fresh17 = &mut ((*current_form).value);
            ...
            12 => {
                ...
                if !((*current_form).buffer).is_null() {
                    ...
                    if !buffer.is_null() {
                        let mut fresh18 = &mut ((*current_form).buffer);
                        *fresh18 = buffer;
                        let mut fresh19 = &mut ((*current_form).value);
                        *fresh19 = buffer;
                    } else {
                        return_value = CURL_FORMADD_NULL;
                    }
            ...
            19 => {
                ...
                if !((*current_form).userp).is_null() {
                    ...
                    if !userp.is_null() {
                        let mut fresh20 = &mut ((*current_form).userp);
                        *fresh20 = userp;
                        let mut fresh21 = &mut ((*current_form).value);
                        *fresh21 = userp;
                    } else {
                        return_value = CURL_FORMADD_NULL;
                    }
            ...
            14 => {
                ...
                if !((*current_form).contenttype).is_null() {
                    ...
                    let mut fresh22 = &mut ((*current_form).contenttype);
            ...
            15 => {
                let mut list: * mut crate::src::lib::http2::curl_slist = if array_state as i32 != 0 {
                ...
                if !((*current_form).contentheader).is_null() {
                    ...
                    let mut fresh23 = &mut ((*current_form).contentheader);
                    *fresh23 = list;
                }
                current_block_137 = 2704538829018177290;
            }
            16 | 11 => {
                ...
                if !((*current_form).showfilename).is_null() {
                    ...
                    let mut fresh24 = &mut ((*current_form).showfilename);
        ...
        match current_block_137 {
            14371220985979925773 => {
                if !((*current_form).name).is_null() {
                    ...
                    if !name.is_null() {
                        let mut fresh14 = &mut ((*current_form).name);
                        *fresh14 = name;
                    } else {
                        return_value = CURL_FORMADD_NULL;
                    }
            ...
            11213271726480235426 => {
                if !((*current_form).value).is_null() {
                    ...
                    if !value.is_null() {
                        let mut fresh15 = &mut ((*current_form).value);
                        *fresh15 = value;
                    } else {
                        return_value = CURL_FORMADD_NULL;
                    }
    ...
    if CURL_FORMADD_OK as i32 as u32 != return_value as u32 {
        let mut ptr: * mut crate::src::lib::formdata::FormInfo = 0 as *mut FormInfo;
        ptr = first_form;
        while !ptr.is_null() {
            if (*ptr).name_alloc {
                Curl_cfree
            ...
            if (*ptr).contenttype_alloc {
                ...
                let mut fresh27 = &mut ((*ptr).contenttype);
                *fresh27 = 0 as *mut i8;
            ...
            if (*ptr).showfilename_alloc {
                ...
                let mut fresh28 = &mut ((*ptr).showfilename);
                *fresh28 = 0 as *mut i8;
    ...
    if CURL_FORMADD_OK as i32 as u32 == return_value as u32 {
        ...
        while !form.is_null() {
                        ...
                        & ((1 as i32) << 3 as i32) as i64 != 0
            {
                    ...
                    && ((*form).contenttype).is_null()
                {
                    ...
                    let mut fresh29 = &mut ((*form).contenttype);
                ...
                if (*form).flags
                    ...
                    && !((*form).value).is_null()
                {
                    let mut clen: u64 = (*form).contentslength as size_t;
                    if clen == 0 {
                        clen = (strlen((*form).value))
                            .wrapping_add(1 as i32 as u64);
                    }
                    let mut fresh31 = &mut ((*form).value);
                ...
                post = AddHttpPost(
                    ...
                    (*form).userp,
                    post,
                    borrow_mut(&mut httppost),
                    borrow_mut(&mut last_post),
                );
                if post.is_null() {
                    return_value = CURL_FORMADD_MEMORY;
                    break;
        ...
        if CURL_FORMADD_OK as i32 as u32 != return_value as u32
        {
            let mut ptr_0: * mut crate::src::lib::formdata::FormInfo = 0 as *mut FormInfo;
            ptr_0 = form;
            while !ptr_0.is_null() {
                if (*ptr_0).name_alloc {
                    Curl_cfree
                    ...
                    let mut fresh32 = &mut ((*ptr_0).name);
                    *fresh32 = 0 as *mut i8;
                ...
                if (*ptr_0).value_alloc {
                    ...
                    let mut fresh33 = &mut ((*ptr_0).value);
                    *fresh33 = 0 as *mut i8;
                ...
                if (*ptr_0).contenttype_alloc {
                    ...
                    let mut fresh34 = &mut ((*ptr_0).contenttype);
                    *fresh34 = 0 as *mut i8;
                ...
                if (*ptr_0).showfilename_alloc {
                    ...
                    let mut fresh35 = &mut ((*ptr_0).showfilename);
                    *fresh35 = 0 as *mut i8;
    ...
    while !first_form.is_null() {
        let mut ptr_1: * mut crate::src::lib::formdata::FormInfo = (*first_form).more;
...
#[no_mangle]
pub unsafe extern "C" fn curl_formadd<'a1, 'a2>(
    mut httppost: Option<&'a1 mut * mut crate::src::lib::http2::curl_httppost>,
    mut last_post: Option<&'a2 mut * mut crate::src::lib::http2::curl_httppost>,
    mut args: ...
) -> u32 {
    let mut arg: core::ffi::VaListImpl;
    let mut result: u32 = CURL_FORMADD_OK;
    arg = args.clone();
    result = FormAdd(borrow_mut(&mut httppost), borrow_mut(&mut last_post), arg.as_va_list());
    return result;
}
#[no_mangle]
pub unsafe extern "C" fn curl_formget(
    mut form: * mut crate::src::lib::http2::curl_httppost,
    mut arg: * mut core::ffi::c_void,
    mut append: Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: * const i8,_: u64,) -> u64>,
) -> i32 {
    let mut result: u32 = CURLE_OK;
    let mut toppart: crate::src::lib::http2::curl_mimepart = curl_mimepart {
    ...
    while result as u64 == 0 {
        ...
        let mut nread: u64 = Curl_mime_read(
            buffer.as_mut_ptr(),
            1 as i32 as size_t,
...
#[no_mangle]
pub unsafe extern "C" fn curl_formfree(mut form: * mut crate::src::lib::http2::curl_httppost) {
    let mut next: * mut crate::src::lib::http2::curl_httppost = 0 as *mut curl_httppost;
    if form.is_null() {
        return;
    }
    loop {
...
pub unsafe extern "C" fn Curl_getformdata(
    ...
    mut finalform: * mut crate::src::lib::http2::curl_mimepart,
    mut post: * mut crate::src::lib::http2::curl_httppost,
    mut fread_func: Option<unsafe extern "C"  fn(_: * mut i8,_: u64,_: u64,_: * mut core::ffi::c_void,) -> u64>,
) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut form: * mut crate::src::lib::http2::curl_mime = 0 as *mut curl_mime;
    let mut part: * mut crate::src::lib::http2::curl_mimepart = 0 as *mut curl_mimepart;
    let mut file: * mut crate::src::lib::http2::curl_httppost = 0 as *mut curl_httppost;
    ...
    while result as u64 == 0 && !post.is_null() {
        let mut multipart: * mut crate::src::lib::http2::curl_mime = form;
        ...
        while result as u64 == 0 && !file.is_null() {
            ...
            if result as u64 == 0 {
                let mut clen: i64 = (*post).contentslength;
                if (*post).flags
                        ...
                        | (1 as i32) << 1 as i32) as i64 != 0
                {
                    ...
                    ) == 0
                    {
                        result = curl_mime_data_cb(
                            ...
                            core::intrinsics::transmute::<Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: u64,_: u64,_: * mut crate::src::lib::http2::_IO_FILE,) -> u64>, Option<unsafe extern "C"  fn(_: * mut i8,_: u64,_: u64,_: * mut core::ffi::c_void,) -> u64>>(
                                Some(
                                    fread,
                                ),
                            ),
                            core::intrinsics::transmute::<Option<unsafe extern "C"  fn() -> ()>, Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: i64,_: i32,) -> i32>>(
                                core::intrinsics::transmute::<Option<unsafe extern "C"  fn(_: * mut crate::src::lib::http2::_IO_FILE,_: i64,_: i32,) -> i32>, Option<unsafe extern "C"  fn() -> ()>>(
                                    Some(
                                        fseek,
                                    ),
                                ),
