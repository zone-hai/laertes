...
static mut Curl_handler_http2: crate::src::lib::http2::Curl_handler = 
    {
...
static mut Curl_handler_http2_ssl: crate::src::lib::http2::Curl_handler =
    {
        let mut init = Curl_handler {
...
unsafe extern "C" fn send_callback(
    mut _h2: * mut crate::src::lib::speedcheck::nghttp2_session,
    mut mem: * const u8,
    mut length: u64,
    mut _flags: i32,
...
unsafe extern "C" fn on_begin_headers(
    mut session: * mut crate::src::lib::speedcheck::nghttp2_session,
    mut frame: * const crate::src::lib::http2::nghttp2_frame,
    mut _userp: * mut core::ffi::c_void,
) -> i32 {
    let mut stream: * mut crate::src::lib::http2::HTTP = 0 as *mut HTTP;
...
unsafe extern "C" fn data_source_read_callback(
    ...
    mut _source: * mut crate::src::lib::http2::nghttp2_data_source,
    mut _userp: * mut core::ffi::c_void,
) -> i64 {
    let mut data_s: * mut crate::src::lib::http2::Curl_easy = 0 as * mut crate::src::lib::http2::Curl_easy;
    let mut stream: * mut crate::src::lib::http2::HTTP = 0 as *mut HTTP;
 ...
 extern "C" fn error_callback(
    mut _session: * mut crate::src::lib::speedcheck::nghttp2_session,
    mut _msg: * const i8,
    mut _len: u64,
    mut _userp: * mut core::ffi::c_void,
) -> i32 {
