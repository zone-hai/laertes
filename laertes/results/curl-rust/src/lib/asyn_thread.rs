...
pub unsafe extern "C" fn Curl_resolver_init<'a1>(
    mut _easy: * mut crate::src::lib::http2::Curl_easy,
...
pub extern "C" fn Curl_set_dns_servers<'a1, 'a2>(
    mut _data: Option<&'a1 mut crate::src::lib::http2::Curl_easy>,
    mut _servers: Option<&'a2 mut i8>,
) -> u32 {
