...
impl std::default::Default for http_connect_state {
    fn default() -> Self { http_connect_state::new() }
}
...
impl std::default::Default for ftp_wc {
    fn default() -> Self { ftp_wc::new() }
}

#[derive(Copy, Clone)]
#[repr(C)]
pub struct C2RustUnnamed_11 {
    pub write_function: Option<unsafe extern "C"  fn(_: * mut i8,_: u64,_: u64,_: * mut core::ffi::c_void,) -> u64>,
...
impl std::default::Default for C2RustUnnamed_11 {
    fn default() -> Self { C2RustUnnamed_11::new() }
}
...
#[no_mangle]
pub static mut Curl_handler_ftp: crate::src::lib::http2::Curl_handler = unsafe {
    {
...
#[no_mangle]
pub static mut Curl_handler_ftps: crate::src::lib::http2::Curl_handler = unsafe {
    {
        let mut init = Curl_handler {
...
unsafe extern "C" fn freedirs(mut ftpc: * mut crate::src::lib::http2::ftp_conn) {
...
unsafe extern "C" fn AcceptServerConnect(mut data: * mut crate::src::lib::http2::Curl_easy) -> u32 {
    ...
    let mut size: u32 = ::std::mem::size_of::<Curl_sockaddr_storage>()
...
unsafe extern "C" fn ftp_timeleft_accept(mut data: * mut crate::src::lib::http2::Curl_easy) -> i64 {
...
unsafe extern "C" fn ReceivedServerConnect<'a1>(
    mut data: * mut crate::src::lib::http2::Curl_easy,
    mut received: Option<&'a1 mut bool>,
) -> u32 {
    let mut conn: * mut crate::src::lib::http2::connectdata = (*data).conn;
    let mut ctrl_sock: i32 = (*conn).sock[0 as i32 as usize];
    let mut data_sock: i32 = (*conn).sock[1 as i32 as usize];
    let mut ftpc: Option<&'_ mut crate::src::lib::http2::ftp_conn> = Some(&mut (*conn).proto.ftpc);
    let mut pp: Option<&'_ mut crate::src::lib::http2::pingpong> = Some(&mut (*(borrow_mut(&mut ftpc)).unwrap()).pp);
    ...
    *(borrow_mut(&mut received)).unwrap() = 0 as i32 != 0;
    ...
    if (*(borrow(& pp)).unwrap()).cache_size != 0 && !((*(borrow(& pp)).unwrap()).cache).is_null()
        && *((*(borrow(& pp)).unwrap()).cache).offset(0 as i32 as isize) as i32 > '3' as i32
    {
        Curl_infof(
            data,
...
unsafe extern "C" fn InitiateTransfer(mut data: * mut crate::src::lib::http2::Curl_easy) -> u32 {
...
unsafe extern "C" fn AllowServerConnect<'a1>(
    mut data: * mut crate::src::lib::http2::Curl_easy,
...
unsafe extern "C" fn ftp_readresp<'a1>(
    mut data: * mut crate::src::lib::http2::Curl_easy,
    mut sockfd: i32,
...
#[no_mangle]
pub unsafe extern "C" fn Curl_GetFTPResponse<'a1>(
    mut data: * mut crate::src::lib::http2::Curl_easy,
    ...
    *(borrow_mut(&mut nreadp)).unwrap() = 0 as i32 as ssize_t;
    ...
    while *ftpcode == 0 && result as u64 == 0 {
        let mut timeout: i64 = Curl_pp_state_timeout(
            data,
            pp,
            0 as i32 != 0,
        );
        ...
        *(borrow_mut(&mut nreadp)).unwrap() = (*(borrow(& nreadp)).unwrap() as u64).wrapping_add(nread) as ssize_t as ssize_t;
    }
    (*pp).pending_resp = 0 as i32 != 0;
    return result;
}
unsafe extern "C" fn _state(mut data: * mut crate::src::lib::http2::Curl_easy, mut newstate: u32) {
    let mut conn: * mut crate::src::lib::http2::connectdata = (*data).conn;
    let mut ftpc: Option<&'_ mut crate::src::lib::http2::ftp_conn> = Some(&mut (*conn).proto.ftpc);
...
unsafe extern "C" fn ftp_getsock(
    ...
    return Curl_pp_getsock(data, Some(&mut (*conn).proto.ftpc.pp), socks);
}
...
unsafe extern "C" fn ftp_state_cwd(
    ...
    let mut result: u32 = CURLE_OK;
    let mut ftpc: * mut crate::src::lib::http2::ftp_conn = &mut (*conn).proto.ftpc;
    if (*ftpc).cwddone {
...
unsafe extern "C" fn ftp_state_use_port(
    ...
    let mut myhost: [i8; 47] = *core::intrinsics::transmute::<&'_ [u8; 47], &'_ mut [i8; 47]>(
    ...
    let mut sa: * mut crate::src::lib::http2::sockaddr = &mut ss as *mut Curl_sockaddr_storage as *mut sockaddr;
    let sa4: * mut crate::src::lib::connect::sockaddr_in = sa as *mut libc::c_void as *mut sockaddr_in;
    let sa6: * mut crate::src::lib::connect::sockaddr_in6 = sa as *mut libc::c_void as *mut sockaddr_in6;
    ...
    if !((*data).set.str_0[STRING_FTPPORT as i32 as usize]).is_null()
        && strlen((*data).set.str_0[STRING_FTPPORT as i32 as usize])
            > 1 as i32 as u64
    {
        let mut addrlen: u64 = if 46 as i32 as u64
...
unsafe extern "C" fn ftp_state_prepare_transfer(mut data: * mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut ftp: * mut crate::src::lib::http2::FTP = (*data).req.p.ftp;
    let mut conn: * mut crate::src::lib::http2::connectdata = (*data).conn;
...
unsafe extern "C" fn ftp_state_list(mut data: * mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut ftp: * mut crate::src::lib::http2::FTP = (*data).req.p.ftp;
    let mut conn: * mut crate::src::lib::http2::connectdata = (*data).conn;
        ...
        == FTPFILE_NOCWD as i32 as u32 && !((*ftp).path).is_null()
    {
        ...
        if !slashPos.is_null() {
            let mut n: u64 = slashPos.offset_from(rawPath) as i64 as size_t;
...
unsafe extern "C" fn ftp_state_retr_prequote(mut data: * mut crate::src::lib::http2::Curl_easy) -> u32 {
    return ftp_state_quote(data, 1 as i32 != 0, FTP_RETR_PREQUOTE);
}
unsafe extern "C" fn ftp_state_stor_prequote(mut data: * mut crate::src::lib::http2::Curl_easy) -> u32 {
    return ftp_state_quote(data, 1 as i32 != 0, FTP_STOR_PREQUOTE);
}
unsafe extern "C" fn ftp_state_type(mut data: * mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut ftp: * mut crate::src::lib::http2::FTP = (*data).req.p.ftp;
    let mut conn: * mut crate::src::lib::http2::connectdata = (*data).conn;
    let mut ftpc: Option<&'_ mut crate::src::lib::http2::ftp_conn> = Some(&mut (*conn).proto.ftpc);
    if ((*data).set).opt_no_body() as i32 != 0 && !((*(borrow(& ftpc)).unwrap()).file).is_null()
...
unsafe extern "C" fn ftp_state_mdtm(mut data: * mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut conn: * mut crate::src::lib::http2::connectdata = (*data).conn;
    let mut ftpc: * mut crate::src::lib::http2::ftp_conn = &mut (*conn).proto.ftpc;
...
unsafe extern "C" fn ftp_state_ul_setup(
            ...
            && sizechecked as i32 != 0
    {
        ...
        if seekerr != 0 as i32 {
            ...
            loop {
                let mut readthisamountnow: u64 = if (*data).state.resume_from - passed
        ...
        if (*data).state.infilesize > 0 as i32 as i64 {
            let mut fresh10 = &mut ((*data).state.infilesize);
...
unsafe extern "C" fn ftp_state_quote(
    ...
    if init {
        ...
        let mut fresh11 = &mut ((*ftpc).count1);
        *fresh11 += 1;
    }
    if !item.is_null() {
...
unsafe extern "C" fn ftp_epsv_disable(
    ...
    if result as u64 == 0 {
        let mut fresh14 = &mut ((*conn).proto.ftpc.count1);
        *fresh14 += 1;
        _state(data, FTP_PASV);
    }
    return result;
}
unsafe extern "C" fn control_address(mut conn: * mut crate::src::lib::http2::connectdata) -> * mut i8 {
...
unsafe extern "C" fn ftp_state_pasv_resp(
    ...
    Curl_cfree.expect("non-null function pointer")((*(borrow_mut(&mut ftpc)).unwrap()).newhost as *mut libc::c_void);
    ...
    *fresh15 = 0 as *mut i8;
    if (*(borrow(& ftpc)).unwrap()).count1 == 0 as i32 && ftpcode == 229 as i32 {
        ...
        if !ptr.is_null() {
            let mut num: u32 = 0;
            let mut separator: Option<crate::__laertes_array::CustomSlice<'static, i8, [i8; 4]>> = Some(crate::__laertes_array::CustomSlice::new([0; 4]));
            ptr = ptr.offset(1);
            if 5 as i32
                == sscanf(
                    ptr,
                    b"%c%c%c%u%c\0" as *const u8 as *const i8,
                    &mut (*crate::__laertes_array::GetMut::<&mut _>::get_offset_mut(separator.as_mut().unwrap(), (0 as i32 as isize)))
                        as *mut i8,
                    &mut (*crate::__laertes_array::GetMut::<&mut _>::get_offset_mut(separator.as_mut().unwrap(), (1 as i32 as isize)))
                        as *mut i8,
                    &mut (*crate::__laertes_array::GetMut::<&mut _>::get_offset_mut(separator.as_mut().unwrap(), (2 as i32 as isize)))
                        as *mut i8,
                    &mut num as *mut u32,
                    &mut (*crate::__laertes_array::GetMut::<&mut _>::get_offset_mut(separator.as_mut().unwrap(), (3 as i32 as isize)))
                        as *mut i8,
                )
            {
                let sep1: i8 = (*crate::__laertes_array::Get::<&_>::get_add((separator).as_ref().unwrap(), (0 as i32 as usize)));
                let mut i: i32 = 0;
                i = 1 as i32;
                while i < 4 as i32 {
                    if (*crate::__laertes_array::Get::<&_>::get_add((separator).as_ref().unwrap(), (i as usize))) as i32 != sep1 as i32 {
                        ptr = 0 as *mut i8;
                        break;
                    } else {
                        i += 1;
        ...
        let mut ip: Option<crate::__laertes_array::CustomSlice<'static, u32, [u32; 4]>> = Some(crate::__laertes_array::CustomSlice::new([
            0 as i32 as u32,
            0 as i32 as u32,
            0 as i32 as u32,
            0 as i32 as u32,
        ]));
        let mut port: Option<crate::__laertes_array::CustomSlice<'static, u32, [u32; 2]>> = Some(crate::__laertes_array::CustomSlice::new([
            0 as i32 as u32,
            0 as i32 as u32,
        ]));
        while *str != 0 {
            if 6 as i32
                == sscanf(
                    ...
                    &mut (*crate::__laertes_array::GetMut::<&mut _>::get_offset_mut(ip.as_mut().unwrap(), (0 as i32 as isize)))
                        as *mut u32,
                    &mut (*crate::__laertes_array::GetMut::<&mut _>::get_offset_mut(ip.as_mut().unwrap(), (1 as i32 as isize)))
                        as *mut u32,
                    &mut (*crate::__laertes_array::GetMut::<&mut _>::get_offset_mut(ip.as_mut().unwrap(), (2 as i32 as isize)))
                        as *mut u32,
                    &mut (*crate::__laertes_array::GetMut::<&mut _>::get_offset_mut(ip.as_mut().unwrap(), (3 as i32 as isize)))
                        as *mut u32,
                    &mut (*crate::__laertes_array::GetMut::<&mut _>::get_offset_mut(port.as_mut().unwrap(), (0 as i32 as isize)))
                        as *mut u32,
                    &mut (*crate::__laertes_array::GetMut::<&mut _>::get_offset_mut(port.as_mut().unwrap(), (1 as i32 as isize)))
                        as *mut u32,
                )
            {
                break;
        ...
        if *str == 0
            || (*crate::__laertes_array::Get::<&_>::get_add((ip).as_ref().unwrap(), (0 as i32 as usize))) > 255 as i32 as u32
            || (*crate::__laertes_array::Get::<&_>::get_add((ip).as_ref().unwrap(), (1 as i32 as usize))) > 255 as i32 as u32
            || (*crate::__laertes_array::Get::<&_>::get_add((ip).as_ref().unwrap(), (2 as i32 as usize))) > 255 as i32 as u32
            || (*crate::__laertes_array::Get::<&_>::get_add((ip).as_ref().unwrap(), (3 as i32 as usize))) > 255 as i32 as u32
            || (*crate::__laertes_array::Get::<&_>::get_add((port).as_ref().unwrap(), (0 as i32 as usize))) > 255 as i32 as u32
            || (*crate::__laertes_array::Get::<&_>::get_add((port).as_ref().unwrap(), (1 as i32 as usize))) > 255 as i32 as u32
        {
            Curl_failf(
                data,
        ...
        if ((*data).set).ftp_skip_ip() != 0 {
            Curl_infof(
                ...
                b"Skip %u.%u.%u.%u for data connection, re-use %s instead\0" as *const u8
                    as *const i8,
                (*crate::__laertes_array::Get::<&_>::get_add((ip).as_ref().unwrap(), (0 as i32 as usize))),
                (*crate::__laertes_array::Get::<&_>::get_add((ip).as_ref().unwrap(), (1 as i32 as usize))),
                (*crate::__laertes_array::Get::<&_>::get_add((ip).as_ref().unwrap(), (2 as i32 as usize))),
                (*crate::__laertes_array::Get::<&_>::get_add((ip).as_ref().unwrap(), (3 as i32 as usize))),
                (*conn).host.name,
            );
        ...
        (*(borrow_mut(&mut ftpc)).unwrap())
            .newport = (((*crate::__laertes_array::Get::<&_>::get_add((port).as_ref().unwrap(), (0 as i32 as usize))) << 8 as i32)
            .wrapping_add((*crate::__laertes_array::Get::<&_>::get_add((port).as_ref().unwrap(), (1 as i32 as usize))))
    ...
    if ((*conn).bits).proxy() != 0 {
        ...
        if ((*conn).bits).tcp_fastopen() as i32 != 0
            && ((*conn).bits).reuse() == 0
            && *((*(borrow(& ftpc)).unwrap()).newhost).offset(0 as i32 as isize) == 0
        {
    ...
    let mut fresh21 = &mut ((*conn).secondaryhostname);
    *fresh21 = 0 as *mut i8;
    (*conn).secondary_port = (*(borrow_mut(&mut ftpc)).unwrap()).newport;
    let mut fresh22 = &mut ((*conn).secondaryhostname);
    *fresh22 = Curl_cstrdup.expect("non-null function pointer")((*(borrow(& ftpc)).unwrap()).newhost);
    if ((*conn).secondaryhostname).is_null() {
        return CURLE_OUT_OF_MEMORY;
    }
    let mut fresh23 = &mut ((*conn).bits);
    ...
    match ftpcode {
        213 => {
                ...
                && (*data).info.filetime >= 0 as i32 as i64
            {
                ...
                let mut filetime: i64 = (*data).info.filetime;
...
unsafe extern "C" fn ftp_state_rest_resp(
    ...
    match instate as u32 {
        ...
        26 | _ => {
            if ftpcode == 350 as i32 {
                let mut buffer: [i8; 24] = *core::intrinsics::transmute::<&'_ [u8; 24], &'_ mut [i8; 24]>(b"Accept-ranges: bytes\r\n\0\0");
                result = Curl_client_write(
                    data,
                    (1 as i32) << 0 as i32
                        | (1 as i32) << 1 as i32,
...
unsafe extern "C" fn ftp_state_get_resp(
    ...
    if ftpcode == 150 as i32 || ftpcode == 125 as i32 {
        ...
        {
            let mut fresh27 = &mut ((*data).req.size);
...
unsafe extern "C" fn ftp_state_loggedin(mut data: * mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut conn: * mut crate::src::lib::http2::connectdata = (*data).conn;
...
unsafe extern "C" fn ftp_state_user_resp(
    ...
    if ftpcode == 331 as i32
        && (*(borrow(& ftpc)).unwrap()).state as u32 == FTP_USER as i32 as u32
    {
        result = Curl_pp_sendf(
            data,
            Some(&mut (*(borrow_mut(&mut ftpc)).unwrap()).pp),
...
unsafe extern "C" fn ftp_statemachine(
    ...
    let mut ftpcode: i32 = 0;
    let mut ftpc: * mut crate::src::lib::http2::ftp_conn = &mut (*conn).proto.ftpc;
    let mut pp: * mut crate::src::lib::http2::pingpong = &mut (*ftpc).pp;
    ...
    if ftpcode != 0 {
        ...
        match (*ftpc).state as u32 {
            ...
            9 => {
                if ftpcode == 257 as i32 {
                    let mut ptr: * mut i8 = &mut *((*data).state.buffer)
                        .offset(4 as i32 as isize) as *mut i8;
                    let buf_size: u64 = (*data).set.buffer_size as size_t;
                    ...
                    if entry_extracted {
                                ...
                                != '/' as i32
                        {
                            ...
                            let mut fresh33 = &mut ((*ftpc).entrypath);
                            *fresh33 = 0 as *mut i8;
                            let mut fresh34 = &mut ((*ftpc).entrypath);
                            *fresh34 = dir;
                            Curl_infof(
                                data,
                            ...
                            *fresh35 = (*ftpc).entrypath;
                            ...
                            let mut fresh36 = &mut ((*ftpc).entrypath);
                            *fresh36 = 0 as *mut i8;
                            let mut fresh37 = &mut ((*ftpc).entrypath);
                            *fresh37 = dir;
                            Curl_infof(
                                data,
                                b"Entry path is '%s'\0" as *const u8 as *const i8,
                ...
                if ftpcode == 215 as i32 {
                    ...
                    *store_0 = '\u{0}' as i32 as i8;
                    ...
                    ) != 0
                    {
                        ...
                        let mut fresh41 = &mut ((*ftpc).server_os);
                        *fresh41 = 0 as *mut i8;
                        let mut fresh42 = &mut ((*ftpc).server_os);
                        *fresh42 = os;
                        ...
                        let mut fresh43 = &mut ((*ftpc).server_os);
                        *fresh43 = 0 as *mut i8;
                        let mut fresh44 = &mut ((*ftpc).server_os);
                        *fresh44 = os;
            ...
            16 => {
                if ftpcode / 100 as i32 != 2 as i32 {
                    if (*data).set.ftp_create_missing_dirs != 0 && (*ftpc).cwdcount != 0
                        && (*ftpc).count2 == 0
                    {
                        let mut fresh45 = &mut ((*ftpc).count2);
                        *fresh45 += 1;
                        result = Curl_pp_sendf(
                            data,
                            Some(&mut (*ftpc).pp),
                    ...
                    (*ftpc).count2 = 0 as i32;
                    let mut fresh46 = &mut ((*ftpc).cwdcount);
                    *fresh46 += 1;
            ...
            17 => {
                if ftpcode / 100 as i32 != 2 as i32
                    && {
                        let mut fresh47 = &mut ((*ftpc).count3);
...
unsafe extern "C" fn ftp_multi_statemach(
    ...
    *done = if (*(borrow(& ftpc)).unwrap()).state as u32 == FTP_STOP as i32 as u32 {
        1 as i32
    } else {
        0 as i32
    } != 0;
...
unsafe extern "C" fn ftp_done(
    ...
    let mut ftp: * mut crate::src::lib::http2::FTP = (*data).req.p.ftp;
    let mut ftpc: * mut crate::src::lib::http2::ftp_conn = &mut (*conn).proto.ftpc;
    let mut pp: Option<&'_ mut crate::src::lib::http2::pingpong> = Some(&mut (*ftpc).pp);
    let mut nread: i64 = 0;
    let mut ftpcode: i32 = 0;
    let mut result: u32 = CURLE_OK;
    let mut rawPath: * mut i8 = 0 as *mut i8;
    ...
    if result as u64 != 0 {
        ...
        let mut fresh52 = &mut ((*ftpc).prevpath);
        *fresh52 = 0 as *mut i8;
    } else {
        if (*data).set.ftp_filemethod as u32
            ...
            && *rawPath.offset(0 as i32 as isize) as i32 == '/' as i32
        {
            ...
            if !(*ftpc).cwdfail {
                ...
                *rawPath.offset(pathLen as isize) = '\u{0}' as i32 as i8;
                let mut fresh53 = &mut ((*ftpc).prevpath);
                *fresh53 = rawPath;
            } else {
                Curl_cfree
                    .expect("non-null function pointer")(rawPath as *mut libc::c_void);
                let mut fresh54 = &mut ((*ftpc).prevpath);
                *fresh54 = 0 as *mut i8;
            }
        }
    ...
    if result as u64 == 0
        ...
        && (*(borrow(& pp)).unwrap()).pending_resp as i32 != 0 && !premature
    {
        ...
        if result as u64 != 0 {
            ...
            let mut fresh55 = &mut ((*ftp).pathalloc);
            *fresh55 = 0 as *mut i8;
            return result;
        }
    ...
    let mut fresh56 = &mut ((*ftp).pathalloc);
    *fresh56 = 0 as *mut i8;
    return result;
}
...
unsafe extern "C" fn ftp_perform<'a1>(
    mut data: * mut crate::src::lib::http2::Curl_easy,
    mut connected: Option<&'a1 mut bool>,
    ...
    *(borrow_mut(&mut connected)).unwrap() = (*conn).bits.tcpconnect[1 as i32 as usize];
    Curl_infof(
        data,
...
unsafe extern "C" fn wc_data_dtor(mut ptr: * mut core::ffi::c_void) {
    let mut ftpwc: * mut crate::src::lib::ftp::ftp_wc = ptr as *mut ftp_wc;
    if !ftpwc.is_null() && !((*ftpwc).parser).is_null() {
        Curl_ftp_parselist_data_free(Some(&mut (*ftpwc).parser));
    }
    Curl_cfree.expect("non-null function pointer")(ftpwc as *mut libc::c_void);
}
unsafe extern "C" fn init_wc_data(mut data: * mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut last_slash: * mut i8 = 0 as *mut i8;
    let mut ftp: * mut crate::src::lib::http2::FTP = (*data).req.p.ftp;
    let mut path: * mut i8 = (*ftp).path;
    let mut wildcard: Option<&'_ mut crate::src::lib::http2::WildcardData> = Some(&mut (*data).wildcard);
    let mut result: u32 = CURLE_OK;
    ...
    if ftpwc.is_null() {
        ...
        let mut fresh59 = &mut ((*ftpwc).parser);
            ...
            if !(result as u64 != 0) {
                ...
                *fresh62 = Curl_cstrdup.expect("non-null function pointer")((*ftp).path);
                if ((*(borrow(& wildcard)).unwrap()).path).is_null() {
                    ...
                    let mut fresh63 = &mut ((*ftpwc).backup.write_function);
                    *fresh63 = (*data).set.fwrite_func;
                    let mut fresh64 = &mut ((*data).set.fwrite_func);
                    *fresh64 = Some(
                        Curl_ftp_parselist,
                    );
                    let mut fresh65 = &mut ((*ftpwc).backup.file_descriptor);
                    *fresh65 = (*data).set.out as *mut FILE;
                    let mut fresh66 = &mut ((*data).set.out);
    ...
    Curl_cfree
        .expect("non-null function pointer")((*(borrow_mut(&mut wildcard)).unwrap()).pattern as *mut libc::c_void);
...
unsafe extern "C" fn wc_statemach(mut data: * mut crate::src::lib::http2::Curl_easy) -> u32 {
    let wildcard: * mut crate::src::lib::http2::WildcardData = &mut (*data).wildcard;
    let mut conn: * mut crate::src::lib::http2::connectdata = (*data).conn;
    let mut result: u32 = CURLE_OK;
    ...
    loop {
        match (*wildcard).state as u32 {
            ...
            2 => {
                let mut ftpwc: * mut crate::src::lib::ftp::ftp_wc = (*wildcard).protdata as *mut ftp_wc;
                let mut fresh70 = &mut ((*data).set.fwrite_func);
                *fresh70 = (*ftpwc).backup.write_function;
                let mut fresh71 = &mut ((*data).set.out);
                *fresh71 = (*ftpwc).backup.file_descriptor as *mut libc::c_void;
                let mut fresh72 = &mut ((*ftpwc).backup.write_function);
                *fresh72 = None;
                let mut fresh73 = &mut ((*ftpwc).backup.file_descriptor);
            ...
            3 => {
                let mut ftpc: Option<&'_ mut crate::src::lib::http2::ftp_conn> = Some(&mut (*conn).proto.ftpc);
                let mut finfo: * mut crate::src::lib::fileinfo::curl_fileinfo = (*(*wildcard).filelist.head).ptr
                ...
                let mut fresh74 = &mut ((*ftp).path);
                *fresh74 = tmp_path;
                let mut fresh75 = &mut ((*ftp).pathalloc);
                *fresh75 = *fresh74;
                Curl_infof(
                    data,
                    ...
                    != CURLFILETYPE_FILE as i32 as u32
                {
                    ...
                    {
                        (*(borrow_mut(&mut ftpc)).unwrap()).known_filesize = (*finfo).size;
                    }
                    result = ftp_parse_url_path(data);
                    if result as u64 != 0 {
                        return result;
            ...
            4 => {
                let mut ftpwc_0: * mut crate::src::lib::ftp::ftp_wc = (*wildcard).protdata as *mut ftp_wc;
                result = CURLE_OK;
                if !ftpwc_0.is_null() {
...
unsafe extern "C" fn ftp_do(mut data: * mut crate::src::lib::http2::Curl_easy, mut done: * mut bool) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut conn: * mut crate::src::lib::http2::connectdata = (*data).conn;
    let mut ftpc: Option<&'_ mut crate::src::lib::http2::ftp_conn> = Some(&mut (*conn).proto.ftpc);
    *done = 0 as i32 != 0;
...
unsafe extern "C" fn ftp_disconnect(
    ...
    if !((*ftpc).entrypath).is_null() {
        if (*data).state.most_recent_ftp_entrypath == (*ftpc).entrypath {
            let mut fresh76 = &mut ((*data).state.most_recent_ftp_entrypath);
            *fresh76 = 0 as *mut i8;
        }
        Curl_cfree
            .expect("non-null function pointer")((*ftpc).entrypath as *mut libc::c_void);
        let mut fresh77 = &mut ((*ftpc).entrypath);
        *fresh77 = 0 as *mut i8;
    }
    freedirs(ftpc);
    Curl_cfree
        .expect("non-null function pointer")((*ftpc).prevpath as *mut libc::c_void);
    let mut fresh78 = &mut ((*ftpc).prevpath);
    *fresh78 = 0 as *mut i8;
    Curl_cfree
        .expect("non-null function pointer")((*ftpc).server_os as *mut libc::c_void);
    let mut fresh79 = &mut ((*ftpc).server_os);
    *fresh79 = 0 as *mut i8;
    Curl_pp_disconnect(borrow_mut(&mut pp));
    return CURLE_OK;
}
unsafe extern "C" fn ftp_parse_url_path(mut data: * mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut ftp: * mut crate::src::lib::http2::FTP = (*data).req.p.ftp;
    let mut conn: * mut crate::src::lib::http2::connectdata = (*data).conn;
    let mut ftpc: Option<&'_ mut crate::src::lib::http2::ftp_conn> = Some(&mut (*conn).proto.ftpc);
    let mut slashPos: * const i8 = 0 as *const i8;
    ...
    match (*data).set.ftp_filemethod as u32 {
        ...
        3 => {
            slashPos = strrchr(rawPath, '/' as i32);
            if !slashPos.is_null() {
                let mut dirlen: u64 = slashPos.offset_from(rawPath) as i64
                    as size_t;
                ...
                *fresh80 = Curl_ccalloc
                ...
                let mut fresh81 = &mut (*((*(borrow(& ftpc)).unwrap()).dirs).offset(0 as i32 as isize));
                *fresh81 = Curl_ccalloc
                ...
                if (*((*(borrow(& ftpc)).unwrap()).dirs).offset(0 as i32 as isize)).is_null() {
                    Curl_cfree
                        .expect(
                            "non-null function pointer",
                        )(rawPath as *mut libc::c_void);
            ...
            if dirAlloc > 0 as i32 {
                ...
                *fresh82 = Curl_ccalloc
                ...
                loop {
                    ...
                    let mut compLen: u64 = slashPos.offset_from(curPos)
                        as i64 as size_t;
                    ...
                    if compLen > 0 as i32 as u64 {
                        ...
                        *fresh83 = *fresh83 + 1;
                        let mut fresh85 = &mut (*((*(borrow(& ftpc)).unwrap()).dirs).offset(fresh84 as isize));
                        *fresh85 = comp;
                    }
    ...
    if ((*data).set).upload() as i32 != 0 && ((*(borrow(& ftpc)).unwrap()).file).is_null()
        && (*ftp).transfer as u32
            == PPTRANSFER_BODY as i32 as u32
    {
        Curl_failf(
        ...
        && *rawPath.offset(0 as i32 as isize) as i32 == '/' as i32
    {
        ...
        if !oldPath.is_null() {
                ...
                == FTPFILE_NOCWD as i32 as u32
            {
                ...
                n = (n as u64)
                    .wrapping_sub(
                        if !((*(borrow(& ftpc)).unwrap()).file).is_null() {
                            strlen((*(borrow(& ftpc)).unwrap()).file)
                        } else {
                            0 as i32 as u64
                        },
                    ) as size_t as size_t;
...
unsafe extern "C" fn ftp_setup_connection(
    ...
    ftp = Curl_ccalloc
        ...
        as *mut FTP;
    let mut fresh89 = &mut ((*data).req.p.ftp);
    *fresh89 = ftp;
    if ftp.is_null() {
        return CURLE_OUT_OF_MEMORY;
    }
    let mut fresh90 = &mut ((*ftp).path);
    ...
    if !type_0.is_null() {
        ...
        *type_0 = 0 as i32 as i8;
        ...
        match command as i32 {
            65 => {
                let mut fresh91 = &mut ((*data).state);
            ...
            73 | _ => {
                let mut fresh93 = &mut ((*data).state);
