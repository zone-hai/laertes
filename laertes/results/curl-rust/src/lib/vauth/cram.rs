...
pub use crate::src::lib::hmac::Curl_HMAC_final;
pub use crate::src::lib::hmac::Curl_HMAC_init;
pub use crate::src::lib::hmac::Curl_HMAC_update;
...
pub type HMAC_context = crate::src::lib::hmac::HMAC_context;
// #[derive(Copy, Clone)]
...
pub unsafe extern "C" fn Curl_auth_create_cram_md5_message<'a1, 'a2>(
    ...
    if Curl_bufref_len((chlg).clone()) != 0 {
        Curl_HMAC_update(
            ctxt,
            Curl_bufref_ptr((chlg).clone()),
            curlx_uztoui(Curl_bufref_len((chlg).clone())),
        );
    }
    ...
    response = curl_maprintf(
        ...
        userp,
        digest[0 as i32 as usize] as i32,
        digest[1 as i32 as usize] as i32,
        digest[2 as i32 as usize] as i32,
        digest[3 as i32 as usize] as i32,
        digest[4 as i32 as usize] as i32,
        digest[5 as i32 as usize] as i32,
        digest[6 as i32 as usize] as i32,
        digest[7 as i32 as usize] as i32,
        digest[8 as i32 as usize] as i32,
        digest[9 as i32 as usize] as i32,
        digest[10 as i32 as usize] as i32,
        digest[11 as i32 as usize] as i32,
        digest[12 as i32 as usize] as i32,
        digest[13 as i32 as usize] as i32,
        digest[14 as i32 as usize] as i32,
        digest[15 as i32 as usize] as i32,
    );
    if response.is_null() {
        return CURLE_OUT_OF_MEMORY;
    }
