...
extern "C" {
    ...
    fn gsasl_done(ctx: * mut crate::src::lib::escape::Gsasl);
    fn gsasl_client_start(
        ctx: * mut crate::src::lib::escape::Gsasl,
        mech: * const i8,
        sctx: * mut * mut crate::src::lib::conncache::Gsasl_session,
    ) -> i32;
    fn gsasl_strerror(err: i32) -> * const i8;
    fn gsasl_init(ctx: * mut * mut crate::src::lib::escape::Gsasl) -> i32;
    fn gsasl_property_set(
        sctx: * mut crate::src::lib::conncache::Gsasl_session,
        prop: u32,
        data: * const i8,
    );
    fn gsasl_free(ptr: * mut core::ffi::c_void);
    fn gsasl_step(
        sctx: * mut crate::src::lib::conncache::Gsasl_session,
        input: * const i8,
        input_len: u64,
    ...
    fn gsasl_finish(sctx: * mut crate::src::lib::conncache::Gsasl_session);
...
pub const GSASL_OK: C2RustUnnamed_6 = 0;
...
pub const GSASL_NEEDS_MORE: C2RustUnnamed_6 = 1;
pub type C2RustUnnamed_6 = u32;
pub const GSASL_GSSAPI_RELEASE_OID_SET_ERROR: C2RustUnnamed_6 = 64;
pub const GSASL_GSSAPI_TEST_OID_SET_MEMBER_ERROR: C2RustUnnamed_6 = 63;
pub const GSASL_GSSAPI_INQUIRE_MECH_FOR_SASLNAME_ERROR: C2RustUnnamed_6 = 62;
pub const GSASL_GSSAPI_DECAPSULATE_TOKEN_ERROR: C2RustUnnamed_6 = 61;
pub const GSASL_GSSAPI_ENCAPSULATE_TOKEN_ERROR: C2RustUnnamed_6 = 60;
pub const GSASL_SECURID_SERVER_NEED_NEW_PIN: C2RustUnnamed_6 = 49;
pub const GSASL_SECURID_SERVER_NEED_ADDITIONAL_PASSCODE: C2RustUnnamed_6 = 48;
pub const GSASL_SHISHI_ERROR: C2RustUnnamed_6 = 47;
pub const GSASL_KERBEROS_V5_INTERNAL_ERROR: C2RustUnnamed_6 = 47;
pub const GSASL_KERBEROS_V5_INIT_ERROR: C2RustUnnamed_6 = 46;
pub const GSASL_GSSAPI_UNSUPPORTED_PROTECTION_ERROR: C2RustUnnamed_6 = 45;
pub const GSASL_GSSAPI_DISPLAY_NAME_ERROR: C2RustUnnamed_6 = 44;
pub const GSASL_GSSAPI_ACQUIRE_CRED_ERROR: C2RustUnnamed_6 = 43;
pub const GSASL_GSSAPI_WRAP_ERROR: C2RustUnnamed_6 = 42;
pub const GSASL_GSSAPI_UNWRAP_ERROR: C2RustUnnamed_6 = 41;
pub const GSASL_GSSAPI_ACCEPT_SEC_CONTEXT_ERROR: C2RustUnnamed_6 = 40;
pub const GSASL_GSSAPI_INIT_SEC_CONTEXT_ERROR: C2RustUnnamed_6 = 39;
pub const GSASL_GSSAPI_IMPORT_NAME_ERROR: C2RustUnnamed_6 = 38;
pub const GSASL_GSSAPI_RELEASE_BUFFER_ERROR: C2RustUnnamed_6 = 37;
pub const GSASL_NO_OPENID20_REDIRECT_URL: C2RustUnnamed_6 = 68;
pub const GSASL_NO_SAML20_REDIRECT_URL: C2RustUnnamed_6 = 67;
pub const GSASL_NO_SAML20_IDP_IDENTIFIER: C2RustUnnamed_6 = 66;
pub const GSASL_NO_CB_TLS_UNIQUE: C2RustUnnamed_6 = 65;
pub const GSASL_NO_HOSTNAME: C2RustUnnamed_6 = 59;
pub const GSASL_NO_SERVICE: C2RustUnnamed_6 = 58;
pub const GSASL_NO_PIN: C2RustUnnamed_6 = 57;
pub const GSASL_NO_PASSCODE: C2RustUnnamed_6 = 56;
pub const GSASL_NO_PASSWORD: C2RustUnnamed_6 = 55;
pub const GSASL_NO_AUTHZID: C2RustUnnamed_6 = 54;
pub const GSASL_NO_AUTHID: C2RustUnnamed_6 = 53;
pub const GSASL_NO_ANONYMOUS_TOKEN: C2RustUnnamed_6 = 52;
pub const GSASL_NO_CALLBACK: C2RustUnnamed_6 = 51;
pub const GSASL_NO_SERVER_CODE: C2RustUnnamed_6 = 36;
pub const GSASL_NO_CLIENT_CODE: C2RustUnnamed_6 = 35;
pub const GSASL_INTEGRITY_ERROR: C2RustUnnamed_6 = 33;
pub const GSASL_AUTHENTICATION_ERROR: C2RustUnnamed_6 = 31;
pub const GSASL_MECHANISM_PARSE_ERROR: C2RustUnnamed_6 = 30;
pub const GSASL_SASLPREP_ERROR: C2RustUnnamed_6 = 29;
pub const GSASL_CRYPTO_ERROR: C2RustUnnamed_6 = 9;
pub const GSASL_BASE64_ERROR: C2RustUnnamed_6 = 8;
pub const GSASL_MALLOC_ERROR: C2RustUnnamed_6 = 7;
pub const GSASL_MECHANISM_CALLED_TOO_MANY_TIMES: C2RustUnnamed_6 = 3;
pub const GSASL_UNKNOWN_MECHANISM: C2RustUnnamed_6 = 2;
#[no_mangle]
pub unsafe extern "C" fn Curl_auth_gsasl_is_supported<'a1>(
    mut data: * mut crate::src::lib::http2::Curl_easy,
    mut mech: * const i8,
    mut gsasl: Option<&'a1 mut crate::src::lib::http2::gsasldata>,
) -> bool {
    let mut res: i32 = 0;
    res = gsasl_init(&mut (*(borrow_mut(&mut gsasl)).unwrap()).ctx);
    if res != GSASL_OK as i32 {
        Curl_failf(
            data,
    ...
    res = gsasl_client_start((*(borrow_mut(&mut gsasl)).unwrap()).ctx, mech, &mut (*(borrow_mut(&mut gsasl)).unwrap()).client);
    if res != GSASL_OK as i32 {
        gsasl_done((*(borrow_mut(&mut gsasl)).unwrap()).ctx);
        return 0 as i32 != 0;
    }
    return 1 as i32 != 0;
}
#[no_mangle]
pub unsafe extern "C" fn Curl_auth_gsasl_start<'a1>(
    mut data: * mut crate::src::lib::http2::Curl_easy,
    mut userp: * const i8,
    mut passwdp: * const i8,
    mut gsasl: Option<&'a1 mut crate::src::lib::http2::gsasldata>,
) -> u32 {
    gsasl_property_set((*(borrow_mut(&mut gsasl)).unwrap()).client, GSASL_AUTHID, userp);
    gsasl_property_set((*(borrow_mut(&mut gsasl)).unwrap()).client, GSASL_PASSWORD, passwdp);
    return CURLE_OK;
}
#[no_mangle]
pub unsafe extern "C" fn Curl_auth_gsasl_token<'a1, 'a2, 'a3>(
    mut data: * mut crate::src::lib::http2::Curl_easy,
    mut chlg: Option<&'a1 crate::src::lib::bufref::bufref>,
    mut gsasl: Option<&'a2 mut crate::src::lib::http2::gsasldata>,
    mut out: Option<&'a3 mut crate::src::lib::bufref::bufref>,
) -> u32 {
    let mut res: i32 = 0;
    let mut response: * mut i8 = 0 as *mut i8;
    let mut outlen: u64 = 0;
    res = gsasl_step(
        (*(borrow_mut(&mut gsasl)).unwrap()).client,
        Curl_bufref_ptr((chlg).clone()) as *const i8,
        Curl_bufref_len((chlg).clone()),
        &mut response,
        &mut outlen,
    );
    if res != GSASL_OK as i32 && res != GSASL_NEEDS_MORE as i32 {
        Curl_failf(
            data,
            b"GSASL step: %s\n\0" as *const u8 as *const i8,
            gsasl_strerror(res),
...
#[no_mangle]
pub unsafe extern "C" fn Curl_auth_gsasl_cleanup<'a1>(mut gsasl: Option<&'a1 mut crate::src::lib::http2::gsasldata>) {
    gsasl_finish((*(borrow_mut(&mut gsasl)).unwrap()).client);
    let mut fresh0 = &mut ((*(borrow_mut(&mut gsasl)).unwrap()).client);
    *fresh0 = 0 as *mut Gsasl_session;
    gsasl_done((*(borrow_mut(&mut gsasl)).unwrap()).ctx);
    let mut fresh1 = &mut ((*(borrow_mut(&mut gsasl)).unwrap()).ctx);
    *fresh1 = 0 as *mut Gsasl;
}
