...
extern "C" {
    ...
    fn DES_ecb_encrypt(
        input: * mut [u8; 8],
        output: * mut [u8; 8],
        ks: * mut crate::src::lib::curl_ntlm_core::DES_ks,
        enc: i32,
    );
    fn DES_set_odd_parity(key: * mut [u8; 8]);
    fn DES_set_key(
        key: * mut [u8; 8],
        schedule: * mut crate::src::lib::curl_ntlm_core::DES_ks,
    ) -> i32;
...
pub use crate::src::lib::md4::Curl_md4it;
...
pub use crate::src::lib::md5::Curl_HMAC_MD5;
...
pub type DES_LONG = u32;
pub type DES_cblock = [u8; 8];
pub type const_DES_cblock = [u8; 8];
#[derive(Copy, Clone)]
#[repr(C)]
pub struct DES_ks {
    pub ks: [crate::src::lib::curl_ntlm_core::C2RustUnnamed_6; 16],
}
#[derive(Copy, Clone)]
#[repr(C)]
...
pub type DES_key_schedule = crate::src::lib::curl_ntlm_core::DES_ks;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct HMAC_params {
    pub hmac_hinit: Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,) -> ()>,
    pub hmac_hupdate: Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: * const u8,_: u32,) -> ()>,
    pub hmac_hfinal: Option<unsafe extern "C"  fn(_: * mut u8,_: * mut core::ffi::c_void,) -> ()>,
...
impl std::default::Default for HMAC_params {
    fn default() -> Self { HMAC_params::new() }
}
...
impl std::default::Default for ms_filetime {
    fn default() -> Self { ms_filetime::new() }
}

unsafe extern "C" fn extend_key_56_to_64(
    mut key_56: * const u8,
    mut key: * mut i8,
) {
    *key
        .offset(
            0 as i32 as isize,
        ) = *key_56.offset(0 as i32 as isize) as i8;
    *key
        .offset(
            1 as i32 as isize,
        ) = ((*key_56.offset(0 as i32 as isize) as i32)
        << 7 as i32 & 0xff as i32
        | *key_56.offset(1 as i32 as isize) as i32 >> 1 as i32)
        as u8 as i8;
    *key
        .offset(
            2 as i32 as isize,
        ) = ((*key_56.offset(1 as i32 as isize) as i32)
        << 6 as i32 & 0xff as i32
        | *key_56.offset(2 as i32 as isize) as i32 >> 2 as i32)
        as u8 as i8;
    *key
        .offset(
            3 as i32 as isize,
        ) = ((*key_56.offset(2 as i32 as isize) as i32)
        << 5 as i32 & 0xff as i32
        | *key_56.offset(3 as i32 as isize) as i32 >> 3 as i32)
        as u8 as i8;
    *key
        .offset(
            4 as i32 as isize,
        ) = ((*key_56.offset(3 as i32 as isize) as i32)
        << 4 as i32 & 0xff as i32
        | *key_56.offset(4 as i32 as isize) as i32 >> 4 as i32)
        as u8 as i8;
    *key
        .offset(
            5 as i32 as isize,
        ) = ((*key_56.offset(4 as i32 as isize) as i32)
        << 3 as i32 & 0xff as i32
        | *key_56.offset(5 as i32 as isize) as i32 >> 5 as i32)
        as u8 as i8;
    *key
        .offset(
            6 as i32 as isize,
        ) = ((*key_56.offset(5 as i32 as isize) as i32)
        << 2 as i32 & 0xff as i32
        | *key_56.offset(6 as i32 as isize) as i32 >> 6 as i32)
        as u8 as i8;
    *key
        .offset(
            7 as i32 as isize,
        ) = ((*key_56.offset(6 as i32 as isize) as i32)
        << 1 as i32 & 0xff as i32) as u8 as i8;
}
unsafe extern "C" fn setup_des_key(
    mut key_56: * const u8,
    mut ks: * mut crate::src::lib::curl_ntlm_core::DES_ks,
) {
    let mut key: [u8; 8] = [0; 8];
    extend_key_56_to_64(key_56, &mut key as *mut DES_cblock as *mut i8);
    DES_set_odd_parity(&mut key);
    DES_set_key(&mut key, ks);
}
#[no_mangle]
pub unsafe extern "C" fn Curl_ntlm_core_lm_resp(
    mut keys: * const u8,
    mut plaintext: * const u8,
    mut results: * mut u8,
) {
    let mut ks: crate::src::lib::curl_ntlm_core::DES_ks = DES_key_schedule {
        ks: [C2RustUnnamed_6 { cblock: [0; 8] }; 16],
    };
    ...
    setup_des_key(keys.offset(7 as i32 as isize), &mut ks);
    DES_ecb_encrypt(
        plaintext as *mut DES_cblock,
        results.offset(8 as i32 as isize) as *mut DES_cblock,
        &mut ks,
        1 as i32,
    );
    setup_des_key(keys.offset(14 as i32 as isize), &mut ks);
    DES_ecb_encrypt(
        plaintext as *mut DES_cblock,
        results.offset(16 as i32 as isize) as *mut DES_cblock,
        &mut ks,
        1 as i32,
    );
}
#[no_mangle]
pub unsafe extern "C" fn Curl_ntlm_core_mk_lm_hash(
    ...
    let mut len: u64 = if strlen(password) < 14 as i32 as u64 {
        strlen(password)
    } else {
        14 as i32 as u64
    };
    Curl_strntoupper(pw.as_mut_ptr() as *mut i8, password, len);
    memset(
        &mut *pw.as_mut_ptr().offset(len as isize) as *mut u8
            as *mut libc::c_void,
        0 as i32,
        (14 as i32 as u64).wrapping_sub(len),
    );
    ...
    setup_des_key(pw.as_mut_ptr(), &mut ks);
    DES_ecb_encrypt(
        magic.as_ptr() as *mut DES_cblock,
        lmbuffer as *mut DES_cblock,
        &mut ks,
        1 as i32,
    );
    setup_des_key(pw.as_mut_ptr().offset(7 as i32 as isize), &mut ks);
    DES_ecb_encrypt(
        magic.as_ptr() as *mut DES_cblock,
        lmbuffer.offset(8 as i32 as isize) as *mut DES_cblock,
        &mut ks,
        1 as i32,
    );
    memset(
        lmbuffer.offset(16 as i32 as isize) as *mut libc::c_void,
        0 as i32,
        (21 as i32 - 16 as i32) as u64,
    );
    return CURLE_OK;
}
unsafe extern "C" fn ascii_to_unicode_le(
    mut dest: * mut u8,
    mut src: * const i8,
    mut srclen: u64,
) {
...
unsafe extern "C" fn ascii_uppercase_to_unicode_le(
    mut dest: * mut u8,
    mut src: * const i8,
    mut srclen: u64,
) {
    ...
    while i < srclen {
        *dest
            .offset(
                (2 as i32 as u64).wrapping_mul(i) as isize,
            ) = Curl_raw_toupper(*src.offset(i as isize)) as u8;
        *dest
            .offset(
                (2 as i32 as u64)
                    .wrapping_mul(i)
...
#[no_mangle]
pub unsafe extern "C" fn Curl_ntlm_core_mk_nt_hash(
    mut data: * mut crate::src::lib::http2::Curl_easy,
    mut password: * const i8,
    mut ntbuffer: * mut u8,
) -> u32 {
    let mut len: u64 = strlen(password);
    let mut pw: * mut u8 = 0 as *mut u8;
    let mut result: u32 = CURLE_OK;
    if len
    ...
    pw = (if len != 0 {
        ...
        Curl_cstrdup
            .expect(
                "non-null function pointer",
            )(b"\0" as *const u8 as *const i8) as *mut u8
            as *mut libc::c_void
    }) as *mut u8;
    if pw.is_null() {
        return CURLE_OUT_OF_MEMORY;
    ...
    result = CURLE_OK as i32 as CURLcode;
    if result as u64 == 0 {
        Curl_md4it(ntbuffer, pw, (2 as i32 as u64).wrapping_mul(len));
        memset(
            ntbuffer.offset(16 as i32 as isize) as *mut libc::c_void,
            0 as i32,
            (21 as i32 - 16 as i32) as u64,
        );
    }
    Curl_cfree.expect("non-null function pointer")(pw as *mut libc::c_void);
    return result;
}
unsafe extern "C" fn time2filetime<'a1>(mut ft: Option<&'a1 mut crate::src::lib::curl_ntlm_core::ms_filetime>, mut t: i64) {
    t = (t + 11644473600 as i64) * 10000000 as i32 as i64;
    (*(borrow_mut(&mut ft)).unwrap())
        .dwLowDateTime = (t & 0xffffffff as u32 as i64)
        as u32;
    (*(borrow_mut(&mut ft)).unwrap()).dwHighDateTime = (t >> 32 as i32) as u32;
}
#[no_mangle]
pub unsafe extern "C" fn Curl_ntlm_core_mk_ntlmv2_hash(
    mut user: * const i8,
    mut userlen: u64,
    mut domain: * const i8,
    mut domlen: u64,
    mut ntlmhash: * mut u8,
    mut ntlmv2hash: * mut u8,
) -> u32 {
    let mut identity_len: u64 = 0;
    let mut identity: * mut u8 = 0 as *mut u8;
    let mut result: u32 = CURLE_OK;
    if userlen > 8000000 as i32 as u64
        || domlen > 8000000 as i32 as u64
    {
        return CURLE_OUT_OF_MEMORY;
    }
    identity_len = userlen
        .wrapping_add(domlen)
        .wrapping_mul(2 as i32 as u64);
    identity = Curl_cmalloc
        .expect(
            "non-null function pointer",
        )(identity_len.wrapping_add(1 as i32 as u64))
        as *mut u8;
    if identity.is_null() {
        return CURLE_OUT_OF_MEMORY;
    }
    ...
    ascii_to_unicode_le(
        identity.offset((userlen << 1 as i32) as isize),
        domain,
        domlen,
    );
    result = Curl_hmacit(
    ...
    Curl_cfree.expect("non-null function pointer")(identity as *mut libc::c_void);
    return result;
}
#[no_mangle]
pub unsafe extern "C" fn Curl_ntlm_core_mk_ntlmv2_resp<'a1, 'a2, 'a3>(
    mut ntlmv2hash: * mut u8,
    mut challenge_client: * mut u8,
    mut ntlm: Option<&'a1 mut crate::src::lib::http2::ntlmdata>,
    mut ntresp: Option<&'a2 mut * mut u8>,
    mut ntresp_len: Option<&'a3 mut u32>,
) -> u32 {
    let mut len: u32 = 0 as i32 as u32;
    let mut ptr: * mut u8 = 0 as *mut u8;
    let mut hmac_output: [u8; 16] = [0; 16];
    let mut tw: crate::src::lib::curl_ntlm_core::ms_filetime = ms_filetime {
        dwLowDateTime: 0,
        dwHighDateTime: 0,
    };
    let mut result: u32 = CURLE_OK;
    time2filetime(Some(&mut tw), time(0 as *mut time_t));
    len = (16 as i32 as u32)
        .wrapping_add(
            ((44 as i32 - 16 as i32) as u32)
                .wrapping_add((*(borrow(& ntlm)).unwrap()).target_info_len)
                .wrapping_add(4 as i32 as u32),
        );
    ptr = Curl_ccalloc
        .expect("non-null function pointer")(1 as i32 as size_t, len as size_t)
        as *mut u8;
    if ptr.is_null() {
        return CURLE_OUT_OF_MEMORY;
    }
    curl_msnprintf(
        (ptr as *mut i8).offset(16 as i32 as isize),
        ((44 as i32 - 16 as i32) as u32)
            .wrapping_add((*(borrow(& ntlm)).unwrap()).target_info_len)
            .wrapping_add(4 as i32 as u32) as size_t,
        b"%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c\0" as *const u8 as *const i8,
        (*core::intrinsics::transmute::<&'_ [u8; 5], &'_ [i8; 5]>(b"\x01\x01\0\0\0"))[0 as i32 as usize] as i32,
        (*core::intrinsics::transmute::<&'_ [u8; 5], &'_ [i8; 5]>(b"\x01\x01\0\0\0"))[1 as i32 as usize] as i32,
        (*core::intrinsics::transmute::<&'_ [u8; 5], &'_ [i8; 5]>(b"\x01\x01\0\0\0"))[2 as i32 as usize] as i32,
        (*core::intrinsics::transmute::<&'_ [u8; 5], &'_ [i8; 5]>(b"\x01\x01\0\0\0"))[3 as i32 as usize] as i32,
        0 as i32,
        0 as i32,
        0 as i32,
        0 as i32,
        (tw.dwLowDateTime & 0xff as i32 as u32) as i32,
        (tw.dwLowDateTime >> 8 as i32 & 0xff as i32 as u32)
            as i32,
        (tw.dwLowDateTime >> 16 as i32 & 0xff as i32 as u32)
            as i32,
        (tw.dwLowDateTime >> 24 as i32 & 0xff as i32 as u32)
            as i32,
        (tw.dwHighDateTime & 0xff as i32 as u32) as i32,
        (tw.dwHighDateTime >> 8 as i32 & 0xff as i32 as u32)
            as i32,
        (tw.dwHighDateTime >> 16 as i32 & 0xff as i32 as u32)
            as i32,
        (tw.dwHighDateTime >> 24 as i32 & 0xff as i32 as u32)
            as i32,
    );
    memcpy(
        ptr.offset(32 as i32 as isize) as *mut libc::c_void,
        challenge_client as *const libc::c_void,
        8 as i32 as u64,
    );
    memcpy(
        ptr.offset(44 as i32 as isize) as *mut libc::c_void,
        (*(borrow(& ntlm)).unwrap()).target_info,
        (*(borrow_mut(&mut ntlm)).unwrap()).target_info_len as u64,
    );
    memcpy(
        ptr.offset(8 as i32 as isize) as *mut libc::c_void,
        &mut *((*(borrow_mut(&mut ntlm)).unwrap()).nonce).as_mut_ptr().offset(0 as i32 as isize)
    ...
    result = Curl_hmacit(
        ...
        ntlmv2hash,
        16 as i32 as size_t,
        ptr.offset(8 as i32 as isize),
        ((44 as i32 - 16 as i32) as u32)
            .wrapping_add((*(borrow(& ntlm)).unwrap()).target_info_len)
            .wrapping_add(4 as i32 as u32)
            .wrapping_add(8 as i32 as u32) as size_t,
        hmac_output.as_mut_ptr(),
    );
    if result as u64 != 0 {
    ...
    memcpy(
        ...
        hmac_output.as_mut_ptr() as *const libc::c_void,
        16 as i32 as u64,
    );
    *(borrow_mut(&mut ntresp)).unwrap() = ptr;
    *(borrow_mut(&mut ntresp_len)).unwrap() = len;
    return result;
}
#[no_mangle]
pub unsafe extern "C" fn Curl_ntlm_core_mk_lmv2_resp(
    mut ntlmv2hash: * mut u8,
    mut challenge_client: * mut u8,
    mut challenge_server: * mut u8,
    mut lmresp: * mut u8,
) -> u32 {
    ...
    let mut result: u32 = CURLE_OK;
    memcpy(
        &mut *data.as_mut_ptr().offset(0 as i32 as isize) as *mut u8
            as *mut libc::c_void,
        challenge_server as *const libc::c_void,
        8 as i32 as u64,
    );
    memcpy(
        &mut *data.as_mut_ptr().offset(8 as i32 as isize) as *mut u8
            as *mut libc::c_void,
        challenge_client as *const libc::c_void,
        8 as i32 as u64,
    );
    result = Curl_hmacit(
        ...
        ntlmv2hash,
        16 as i32 as size_t,
        &mut *data.as_mut_ptr().offset(0 as i32 as isize),
        16 as i32 as size_t,
        hmac_output.as_mut_ptr(),
    );
    if result as u64 != 0 {
    ...
    memcpy(
        lmresp as *mut libc::c_void,
        hmac_output.as_mut_ptr() as *const libc::c_void,
        16 as i32 as u64,
    );
    memcpy(
        lmresp.offset(16 as i32 as isize) as *mut libc::c_void,
        challenge_client as *const libc::c_void,
        8 as i32 as u64,
    );
    return result;
