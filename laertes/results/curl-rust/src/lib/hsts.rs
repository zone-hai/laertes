...
impl std::default::Default for stsentry {
    fn default() -> Self { stsentry::new() }
}
...
#[no_mangle]
pub unsafe extern "C" fn Curl_hsts_init() -> * mut crate::src::lib::easy::hsts {
    let mut h: * mut crate::src::lib::easy::hsts = Curl_ccalloc
        .expect(
            "non-null function pointer",
        )(::std::mem::size_of::<hsts>() as u64, 1 as i32 as size_t)
        as *mut hsts;
    if !h.is_null() {
        Curl_llist_init(Some(&mut (*h).list), None);
    }
    return h;
}
unsafe extern "C" fn hsts_free(mut e: * mut crate::src::lib::hsts::stsentry) {
    Curl_cfree
        .expect(
            "non-null function pointer",
...
#[no_mangle]
pub unsafe extern "C" fn Curl_hsts_cleanup<'a1>(mut hp: Option<&'a1 mut * mut crate::src::lib::easy::hsts>) {
    let mut h: * mut crate::src::lib::easy::hsts = *(borrow_mut(&mut hp)).unwrap();
    if !h.is_null() {
        ...
        e = (*h).list.head;
        while !e.is_null() {
            let mut sts: * mut crate::src::lib::hsts::stsentry = (*e).ptr as *mut stsentry;
            n = (*e).next;
            hsts_free(sts);
            e = n;
        }
        ...
        *(borrow_mut(&mut hp)).unwrap() = 0 as *mut hsts;
    }
}
unsafe extern "C" fn hsts_entry() -> * mut crate::src::lib::hsts::stsentry {
    return Curl_ccalloc
        .expect(
            "non-null function pointer",
...
unsafe extern "C" fn hsts_create(
    mut h: * mut crate::src::lib::easy::hsts,
    mut hostname: * const i8,
    mut subdomains: bool,
    mut expires: i64,
) -> u32 {
    let mut sts: * mut crate::src::lib::hsts::stsentry = hsts_entry();
    if sts.is_null() {
        return CURLE_OUT_OF_MEMORY;
    }
    (*sts).expires = expires;
    (*sts).includeSubDomains = subdomains;
    let mut fresh0 = &mut ((*sts).host);
...
pub unsafe extern "C" fn Curl_hsts_parse(
    ...
    let mut expires: i64 = 0 as i32 as curl_off_t;
    let mut gotma: bool = 0 as i32 != 0;
    let mut gotinc: bool = 0 as i32 != 0;
    let mut subdomains: bool = 0 as i32 != 0;
    let mut sts: * mut crate::src::lib::hsts::stsentry = 0 as *mut stsentry;
    ...
    loop {
        ...
        ) != 0
        {
            ...
            offt = curlx_strtoofft(p, Some(&mut endp), 10 as i32, Some(&mut expires));
...
pub unsafe extern "C" fn Curl_hsts(
    ...
    mut hostname: * const i8,
    mut subdomain: bool,
) -> * mut crate::src::lib::hsts::stsentry {
    if !h.is_null() {
        let mut now: i64 = time(0 as *mut time_t);
        ...
        while !e.is_null() {
            ...
            if (*sts).expires <= now {
                ...
                {
                    let mut ntail: u64 = strlen((*sts).host);
                    if ntail < hlen {
                        let mut offs: u64 = hlen.wrapping_sub(ntail);
                        if *hostname
                            .offset(
...
unsafe extern "C" fn hsts_push<'a1>(
    mut data: * mut crate::src::lib::http2::Curl_easy,
    mut i: * mut crate::src::lib::http2::curl_index,
    mut sts: * mut crate::src::lib::hsts::stsentry,
    mut stop: Option<&'a1 mut bool>,
) -> u32 {
    let mut e: crate::src::lib::http2::curl_hstsentry = curl_hstsentry {
        name: 0 as *mut i8,
        namelen: 0,
        includeSubDomains: [0; 1],
        expire: [0; 18],
    };
    let mut sc: u32 = CURLSTS_OK;
    ...
    *(borrow_mut(&mut stop)).unwrap() = sc as u32 != CURLSTS_OK as i32 as u32;
...
unsafe extern "C" fn hsts_out(mut sts: * mut crate::src::lib::hsts::stsentry, mut fp: * mut crate::src::lib::http2::_IO_FILE) -> u32 {
    let mut stamp: crate::src::lib::altsvc::tm = tm {
        tm_sec: 0,
        tm_min: 0,
        tm_hour: 0,
    ...
    if (*sts).expires != 0x7fffffffffffffff as i64 {
        let mut result: u32 = Curl_gmtime((*sts).expires, &mut stamp);
        if result as u64 != 0 {
            return result;
        }
        curl_mfprintf(
...
pub unsafe extern "C" fn Curl_hsts_save(
    ...
    if ((*data).set.hsts_write).is_some() {
        let mut i: crate::src::lib::http2::curl_index = curl_index { index: 0, total: 0 };
        i.total = (*h).list.size;
        i.index = 0 as i32 as size_t;
        e = (*h).list.head;
        while !e.is_null() {
            let mut sts_0: * mut crate::src::lib::hsts::stsentry = (*e).ptr as *mut stsentry;
            let mut stop: bool = false;
            n = (*e).next;
            result = hsts_push(data, &mut i, sts_0, Some(&mut stop));
...
unsafe extern "C" fn hsts_pull(mut data: * mut crate::src::lib::http2::Curl_easy, mut h: * mut crate::src::lib::easy::hsts) -> u32 {
