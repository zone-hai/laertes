...
#[no_mangle]
pub static mut Curl_handler_smtp: crate::src::lib::http2::Curl_handler = unsafe {
    {
...
#[no_mangle]
pub static mut Curl_handler_smtps: crate::src::lib::http2::Curl_handler = unsafe {
    {
        let mut init = Curl_handler {
...
static mut saslsmtp: crate::src::lib::http2::SASLproto = unsafe {
    {
...
unsafe extern "C" fn smtp_to_smtps(mut conn: * mut crate::src::lib::http2::connectdata) {
...
unsafe extern "C" fn smtp_endofresp(
    ...
    let mut smtpc: Option<&'_ mut crate::src::lib::http2::smtp_conn> = Some(&mut (*conn).proto.smtpc);
        ...
        *resp = curlx_sltosi(
        ...
        if *resp == 1 as i32 {
            *resp = 0 as i32;
            ...
            && ((*(borrow(& smtpc)).unwrap()).state as u32
...
unsafe extern "C" fn state(mut data: * mut crate::src::lib::http2::Curl_easy, mut newstate: u32) {
    let mut smtpc: Option<&'_ mut crate::src::lib::http2::smtp_conn> = Some(&mut (*(*data).conn).proto.smtpc);
    (*(borrow_mut(&mut smtpc)).unwrap()).state = newstate;
}
unsafe extern "C" fn smtp_perform_ehlo(mut data: * mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut conn: * mut crate::src::lib::http2::connectdata = (*data).conn;
    let mut smtpc: * mut crate::src::lib::http2::smtp_conn = &mut (*conn).proto.smtpc;
...
unsafe extern "C" fn smtp_perform_upgrade_tls(mut data: * mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut conn: * mut crate::src::lib::http2::connectdata = (*data).conn;
    let mut smtpc: Option<&'_ mut crate::src::lib::http2::smtp_conn> = Some(&mut (*conn).proto.smtpc);
    let mut result: u32 = Curl_ssl_connect_nonblocking(
        ...
        0 as i32 != 0,
        0 as i32,
        &mut (*(borrow_mut(&mut smtpc)).unwrap()).ssldone,
    );
    if result as u64 == 0 {
        if (*(borrow(& smtpc)).unwrap()).state as u32
            != SMTP_UPGRADETLS as i32 as u32
        {
            state(data, SMTP_UPGRADETLS);
        }
        if (*(borrow(& smtpc)).unwrap()).ssldone {
            smtp_to_smtps(conn);
...
unsafe extern "C" fn smtp_perform_auth(
    ...
    if !initresp.is_null() {
        result = Curl_pp_sendf(
            data,
            Some(&mut (*(borrow_mut(&mut smtpc)).unwrap()).pp),
...
unsafe extern "C" fn smtp_perform_authentication(mut data: * mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut conn: * mut crate::src::lib::http2::connectdata = (*data).conn;
    let mut smtpc: Option<&'_ mut crate::src::lib::http2::smtp_conn> = Some(&mut (*conn).proto.smtpc);
    let mut progress: u32 = SASL_IDLE;
    if !(*(borrow(& smtpc)).unwrap()).auth_supported || !Curl_sasl_can_authenticate(Some(&mut (*(borrow_mut(&mut smtpc)).unwrap()).sasl), conn)
    {
        state(data, SMTP_STOP);
        return result;
    }
    result = Curl_sasl_start(
        &mut (*(borrow_mut(&mut smtpc)).unwrap()).sasl,
        data,
        conn,
        0 as i32 != 0,
        Some(&mut progress),
...
unsafe extern "C" fn smtp_perform_command(mut data: * mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut conn: * mut crate::src::lib::http2::connectdata = (*data).conn;
    let mut smtp: * mut crate::src::lib::http2::SMTP = (*data).req.p.smtp;
    if !((*smtp).rcpt).is_null() {
            ...
            || *((*smtp).custom).offset(0 as i32 as isize) == 0
        {
            ...
            let mut host: crate::src::lib::http2::hostname = {
            ...
            Curl_free_idnconverted_hostname(Some(&mut host));
...
unsafe extern "C" fn smtp_perform_mail(mut data: * mut crate::src::lib::http2::Curl_easy) -> u32 {
        ...
        && (*conn).proto.smtpc.sasl.authused as i32 != 0
    {
            ...
            .offset(0 as i32 as isize) as i32 != '\u{0}' as i32
        {
            ...
            let mut host_0: crate::src::lib::http2::hostname = {
                let mut init = hostname {
                    rawalloc: 0 as *mut i8,
                    encalloc: 0 as *mut i8,
                    name: 0 as *mut i8,
            ...
            if !(host_0.name).is_null() {
                ...
                Curl_free_idnconverted_hostname(Some(&mut host_0));
            } else {
                auth = curl_maprintf(
                    b"<%s>\0" as *const u8 as *const i8,
                    address_0,
        ...
        != MIMEKIND_NONE as i32 as u32
    {
        ...
        let mut fresh3 = &mut ((*data).state.fread_func);
        *fresh3 = core::intrinsics::transmute::<Option<unsafe extern "C"  fn(_: * mut i8,_: u64,_: u64,_: * mut core::ffi::c_void,) -> u64>, Option<unsafe extern "C"  fn(_: * mut i8,_: u64,_: u64,_: * mut core::ffi::c_void,) -> u64>>(
            Some(
                Curl_mime_read,
            ),
        );
        let mut fresh4 = &mut ((*data).state.in_0);
    ...
    if (*conn).proto.smtpc.utf8_supported as i32 != 0 && !utf8 {
        let mut smtp: * mut crate::src::lib::http2::SMTP = (*data).req.p.smtp;
        let mut rcpt: * mut crate::src::lib::http2::curl_slist = (*smtp).rcpt;
...
unsafe extern "C" fn smtp_perform_rcpt_to(mut data: * mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut conn: * mut crate::src::lib::http2::connectdata = (*data).conn;
    let mut smtp: * mut crate::src::lib::http2::SMTP = (*data).req.p.smtp;
    let mut address: * mut i8 = 0 as *mut i8;
    ...
    result = smtp_parse_address(data, (*(*smtp).rcpt).data, Some(&mut address), &mut host);
    if result as u64 != 0 {
        return result;
    }
    if !(host.name).is_null() {
...
unsafe extern "C" fn smtp_state_ehlo_resp(
    ...
    if smtpcode / 100 as i32 != 2 as i32 && smtpcode != 1 as i32
    {
        ...
        {
            (*(borrow_mut(&mut smtpc)).unwrap()).tls_supported = 1 as i32 != 0;
        } else if len >= 4 as i32 as u64
                && memcmp(
                    line as *const libc::c_void,
            ...
            {
            (*(borrow_mut(&mut smtpc)).unwrap()).size_supported = 1 as i32 != 0;
            ...
            {
            (*(borrow_mut(&mut smtpc)).unwrap()).utf8_supported = 1 as i32 != 0;
            ...
            {
            (*(borrow_mut(&mut smtpc)).unwrap()).auth_supported = 1 as i32 != 0;
            ...
            loop {
                ...
                if mechbit as i32 != 0 && llen == wordlen {
                    let mut fresh5 = &mut ((*(borrow_mut(&mut smtpc)).unwrap()).sasl.authmechs);
        ...
        if smtpcode != 1 as i32 {
            ...
            {
                if (*(borrow(& smtpc)).unwrap()).tls_supported {
...
unsafe extern "C" fn smtp_state_auth_resp(
    ...
    let mut smtpc: Option<&'_ mut crate::src::lib::http2::smtp_conn> = Some(&mut (*conn).proto.smtpc);
    let mut progress: u32 = SASL_IDLE;
    result = Curl_sasl_continue(&mut (*(borrow_mut(&mut smtpc)).unwrap()).sasl, data, conn, smtpcode, Some(&mut progress));
    if result as u64 == 0 {
...
unsafe extern "C" fn smtp_statemachine(
    ...
    let mut smtpc: * mut crate::src::lib::http2::smtp_conn = &mut (*conn).proto.smtpc;
    let mut pp: * mut crate::src::lib::http2::pingpong = &mut (*smtpc).pp;
    ...
    loop {
        result = Curl_pp_readresp(data, sock, pp, &mut smtpcode, Some(&mut nread));
        if result as u64 != 0 {
            return result;
        }
...
unsafe extern "C" fn smtp_multi_statemach(
        ...
        && !(*(borrow(& smtpc)).unwrap()).ssldone
    {
        ...
        if result as u32 != 0 || !(*(borrow(& smtpc)).unwrap()).ssldone {
            return result;
        }
    }
    result = Curl_pp_statemach(
        data,
        &mut (*(borrow_mut(&mut smtpc)).unwrap()).pp,
        0 as i32 != 0,
        0 as i32 != 0,
    );
    *done = if (*(borrow(& smtpc)).unwrap()).state as u32 == SMTP_STOP as i32 as u32
    {
        1 as i32
    } else {
        0 as i32
...
unsafe extern "C" fn smtp_block_statemach(
    ...
    let mut result: u32 = CURLE_OK;
    let mut smtpc: Option<&'_ mut crate::src::lib::http2::smtp_conn> = Some(&mut (*conn).proto.smtpc);
    while (*(borrow(& smtpc)).unwrap()).state as u32 != SMTP_STOP as i32 as u32
        && result as u64 == 0
    {
        result = Curl_pp_statemach(
            data,
...
unsafe extern "C" fn smtp_init(mut data: * mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut smtp: * mut crate::src::lib::http2::SMTP = (0 as * mut crate::src::lib::http2::SMTP);
    let mut fresh8 = &mut ((*data).req.p.smtp);
    *fresh8 = Curl_ccalloc
        .expect(
            "non-null function pointer",
...
unsafe extern "C" fn smtp_getsock(
    ...
    return Curl_pp_getsock(data, Some(&mut (*conn).proto.smtpc.pp), socks);
}
unsafe extern "C" fn smtp_connect(
    ...
    let mut conn: * mut crate::src::lib::http2::connectdata = (*data).conn;
    let mut smtpc: * mut crate::src::lib::http2::smtp_conn = &mut (*conn).proto.smtpc;
    let mut pp: Option<&'_ mut crate::src::lib::http2::pingpong> = Some(&mut (*smtpc).pp);
    *done = 0 as i32 != 0;
    Curl_conncontrol(conn, 0 as i32);
    (*(borrow_mut(&mut pp)).unwrap()).response_time = (120 as i32 * 1000 as i32) as timediff_t;
    let mut fresh9 = &mut ((*(borrow_mut(&mut pp)).unwrap()).statemachine);
    *fresh9 = Some(
        smtp_statemachine,
    );
    let mut fresh10 = &mut ((*(borrow_mut(&mut pp)).unwrap()).endofresp);
    *fresh10 = Some(
        smtp_endofresp,
    );
    Curl_sasl_init(Some(&mut (*smtpc).sasl), &saslsmtp);
...
unsafe extern "C" fn smtp_done(
    ...
    let mut conn: * mut crate::src::lib::http2::connectdata = (*data).conn;
    let mut smtp: * mut crate::src::lib::http2::SMTP = (*data).req.p.smtp;
    let mut pp: Option<&'_ mut crate::src::lib::http2::pingpong> = Some(&mut (*conn).proto.smtpc.pp);
    ...
    let mut fresh11 = &mut ((*smtp).custom);
    *fresh11 = 0 as *mut i8;
    if status as u64 != 0 {
        ...
        if bytes_written != len {
            let mut fresh12 = &mut ((*(borrow_mut(&mut pp)).unwrap()).sendthis);
            *fresh12 = eob;
            (*(borrow_mut(&mut pp)).unwrap()).sendsize = len as size_t;
            (*(borrow_mut(&mut pp)).unwrap()).sendleft = (len - bytes_written) as size_t;
        } else {
...
unsafe extern "C" fn smtp_perform<'a1>(
    mut data: * mut crate::src::lib::http2::Curl_easy,
...
unsafe extern "C" fn smtp_do(mut data: * mut crate::src::lib::http2::Curl_easy, mut done: * mut bool) -> u32 {
    let mut result: u32 = CURLE_OK;
    *done = 0 as i32 != 0;
...
unsafe extern "C" fn smtp_disconnect(
    ...
    Curl_pp_disconnect(Some(&mut (*(borrow_mut(&mut smtpc)).unwrap()).pp));
    Curl_sasl_cleanup(conn, (*(borrow_mut(&mut smtpc)).unwrap()).sasl.authused as u32);
    Curl_cfree.expect("non-null function pointer")((*(borrow_mut(&mut smtpc)).unwrap()).domain as *mut libc::c_void);
    let mut fresh14 = &mut ((*(borrow_mut(&mut smtpc)).unwrap()).domain);
    *fresh14 = 0 as *mut i8;
    return CURLE_OK;
}
...
unsafe extern "C" fn smtp_doing(
    ...
    let mut result: u32 = smtp_multi_statemach(data, dophase_done);
    if !(result as u64 != 0) {
        if *dophase_done {
...
unsafe extern "C" fn smtp_regular_transfer(
    ...
    result = smtp_perform(data, Some(&mut connected), dophase_done);
...
unsafe extern "C" fn smtp_parse_url_options(mut conn: * mut crate::src::lib::http2::connectdata) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut smtpc: Option<&'_ mut crate::src::lib::http2::smtp_conn> = Some(&mut (*conn).proto.smtpc);
    let mut ptr: * const i8 = (*conn).options;
    (*(borrow_mut(&mut smtpc)).unwrap()).sasl.resetprefs = 1 as i32 != 0;
    while result as u64 == 0 && !ptr.is_null() && *ptr as i32 != 0 {
        ...
        ) != 0
        {
            result = Curl_sasl_parse_url_auth_option(
                Some(&mut (*(borrow_mut(&mut smtpc)).unwrap()).sasl),
                value,
...
unsafe extern "C" fn smtp_parse_url_path(mut data: * mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut conn: * mut crate::src::lib::http2::connectdata = (*data).conn;
    let mut smtpc: Option<&'_ mut crate::src::lib::http2::smtp_conn> = Some(&mut (*conn).proto.smtpc);
    ...
    return Curl_urldecode(
        ...
        path,
        0 as i32 as size_t,
        Some(&mut (*(borrow_mut(&mut smtpc)).unwrap()).domain),
        Option::<&'_ mut u64>::None,
        REJECT_CTRL,
    );
}
unsafe extern "C" fn smtp_parse_custom_request(mut data: * mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut smtp: * mut crate::src::lib::http2::SMTP = (*data).req.p.smtp;
...
unsafe extern "C" fn smtp_parse_address<'a1>(
    mut data: * mut crate::src::lib::http2::Curl_easy,
    mut fqma: * const i8,
    mut address: Option<&'a1 mut * mut i8>,
...
pub unsafe extern "C" fn Curl_smtp_escape_eob(
    ...
    if si != nread {
        let mut fresh20 = &mut ((*data).req.upload_fromhere);
        *fresh20 = scratch;
        let mut fresh21 = &mut ((*data).state.scratch);
        *fresh21 = scratch;
