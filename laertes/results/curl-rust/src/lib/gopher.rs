...
#[no_mangle]
pub static mut Curl_handler_gopher: crate::src::lib::http2::Curl_handler = unsafe {
    {
...
#[no_mangle]
pub static mut Curl_handler_gophers: crate::src::lib::http2::Curl_handler = unsafe {
    {
        let mut init = Curl_handler {
...
unsafe extern "C" fn gopher_connecting(
    ...
    let mut result: u32 = Curl_ssl_connect(data, conn, 0 as i32);
    if result as u64 != 0 {
...
unsafe extern "C" fn gopher_do(
    ...
    *done = 1 as i32 != 0;
    ...
    while !(strlen(sel) < 1 as i32 as u64) {
        ...
        timeout_ms = Curl_timeleft(data, (0 as * mut crate::src::lib::http2::curltime), 0 as i32 != 0);
