...
unsafe extern "C" fn mstate(mut data: * mut crate::src::lib::http2::Curl_easy, mut state: u32) {
    ...
    static mut finit: [Option<unsafe extern "C"  fn(_: * mut crate::src::lib::http2::Curl_easy,) -> ()>; 17] =
        [
            None,
            None,
...
unsafe extern "C" fn trhash_compare(
 ...
 extern "C" fn trhash_dtor(mut _nada: * mut core::ffi::c_void) {}
...
unsafe extern "C" fn close_connect_only(
    ...
    mut _param: * mut core::ffi::c_void,
) -> i32 {
...
pub unsafe extern "C" fn curl_multi_fdset<'a1, 'a2, 'a3, 'a4, 'a5>(
    ...
    mut _exc_fd_set: Option<&'a4 mut crate::src::lib::multi::fd_set>,
