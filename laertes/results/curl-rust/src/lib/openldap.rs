...
#[no_mangle]
pub static mut Curl_handler_ldap: crate::src::lib::http2::Curl_handler =
    {
...
#[no_mangle]
pub static mut Curl_handler_ldaps: crate::src::lib::http2::Curl_handler =
    {
        let mut init = Curl_handler {
...
unsafe extern "C" fn ldapsb_tls_remove(mut sbiod: * mut crate::src::lib::openldap::sockbuf_io_desc) -> i32 {
 ...
 extern "C" fn ldapsb_tls_close(mut _sbiod: * mut crate::src::lib::openldap::sockbuf_io_desc) -> i32 {
    return 0 as i32;
}
...
static mut ldapsb_tls: crate::src::lib::openldap::sockbuf_io =
    {
