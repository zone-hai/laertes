...
pub struct _xmlGlobalState {
    ...
    pub xmlStructuredError: Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: * mut crate::src::threads::_xmlError,) -> ()>,
    ...
    pub xmlRegisterNodeDefaultValue: Option<unsafe extern "C"  fn(_: * mut crate::src::threads::_xmlNode,) -> ()>,
    pub xmlDeregisterNodeDefaultValue: Option<unsafe extern "C"  fn(_: * mut crate::src::threads::_xmlNode,) -> ()>,
    pub xmlMallocAtomic: Option<unsafe extern "C"  fn(_: u64,) -> * mut core::ffi::c_void>,
    pub xmlLastError: crate::src::threads::_xmlError,
    pub xmlParserInputBufferCreateFilenameValue: Option<unsafe extern "C"  fn(_: * const i8,_: i32,) -> * mut crate::src::threads::_xmlParserInputBuffer>,
    pub xmlOutputBufferCreateFilenameValue: Option<unsafe extern "C"  fn(_: * const i8,_: * mut crate::src::threads::_xmlCharEncodingHandler,_: i32,) -> * mut crate::src::threads::_xmlOutputBuffer>,
...
static mut xmlLibraryLock: * mut crate::src::threads::_xmlRMutex = (0 as * mut crate::src::threads::_xmlRMutex);
#[no_mangle]
pub unsafe extern "C" fn xmlNewMutex() -> * mut crate::src::threads::_xmlMutex {
...
#[no_mangle]
pub unsafe extern "C" fn xmlFreeMutex(mut tok: * mut crate::src::threads::_xmlMutex) {
    if tok.is_null() {
        return;
    }
    if libxml_is_threaded != 0 as i32 {
...
#[no_mangle]
pub unsafe extern "C" fn xmlMutexLock(mut tok: * mut crate::src::threads::_xmlMutex) {
    if tok.is_null() {
        return;
    }
    if libxml_is_threaded != 0 as i32 {
...
#[no_mangle]
pub unsafe extern "C" fn xmlMutexUnlock(mut tok: * mut crate::src::threads::_xmlMutex) {
    if tok.is_null() {
        return;
    }
    if libxml_is_threaded != 0 as i32 {
...
#[no_mangle]
pub unsafe extern "C" fn xmlNewRMutex() -> * mut crate::src::threads::_xmlRMutex {
...
#[no_mangle]
pub unsafe extern "C" fn xmlFreeRMutex(mut tok: * mut crate::src::threads::_xmlRMutex) {
    if tok.is_null() {
        return;
    }
    if libxml_is_threaded != 0 as i32 {
...
#[no_mangle]
pub unsafe extern "C" fn xmlRMutexLock(mut tok: * mut crate::src::threads::_xmlRMutex) {
    if tok.is_null() {
        return;
    }
    if libxml_is_threaded == 0 as i32 {
...
#[no_mangle]
pub unsafe extern "C" fn xmlRMutexUnlock(mut tok: * mut crate::src::threads::_xmlRMutex) {
    if tok.is_null() {
        return;
    }
    if libxml_is_threaded == 0 as i32 {
...
unsafe extern "C" fn xmlNewGlobalState() -> * mut crate::src::threads::_xmlGlobalState {
...
#[no_mangle]
pub unsafe extern "C" fn xmlGetGlobalState() -> * mut crate::src::threads::_xmlGlobalState {
    let mut globalval: * mut crate::src::threads::_xmlGlobalState = 0 as *mut xmlGlobalState;
    if libxml_is_threaded == 0 as i32 {
        return 0 as xmlGlobalStatePtr;
    }
    pthread_once(&mut once_control, Some(xmlOnceInit));
