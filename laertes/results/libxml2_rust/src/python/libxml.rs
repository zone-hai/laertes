...
pub extern "C" fn libxml_xmlDebugMemory(
    ...
    if activate != 0 as i32 {
        if (unsafe { libxmlMemoryDebug }) == 0 as i32 {
            ...
            if (unsafe { freeFunc }) == Some(xmlMemFree as unsafe extern "C" fn(*mut libc::c_void) -> ())
                && (unsafe { mallocFunc })
                ...
                && (unsafe { strdupFunc }) == Some(xmlMemoryStrdup as unsafe extern "C" fn(*const i8) -> *mut i8)
            {
                (unsafe { libxmlMemoryAllocatedBase = xmlMemUsed() as i64 });
                current_block = 10048703153582371463;
            } else {
                (unsafe { xmlCleanupParser() });
                ret = (unsafe { xmlMemSetup(
...
pub extern "C" fn libxml_xmlPythonCleanupParser(
    ...
    if !(unsafe { libxml_xpathCallbacks }).is_null() {
        ...
        while ix < (unsafe { libxml_xpathCallbacksNb }) {
            if !(unsafe { (*(*libxml_xpathCallbacks).as_mut_ptr().offset(ix as isize)).name }).is_null() {
                (unsafe { xmlFree.expect("non-null function pointer")(
                    (*(*libxml_xpathCallbacks).as_mut_ptr().offset(ix as isize)).name
                        as *mut libc::c_void,
                ) });
            }
            if !(unsafe { (*(*libxml_xpathCallbacks).as_mut_ptr().offset(ix as isize)).ns_uri }).is_null() {
                (unsafe { xmlFree.expect("non-null function pointer")(
        ...
        (unsafe { xmlFree.expect("non-null function pointer")(libxml_xpathCallbacks as *mut libc::c_void) });
...
extern "C" fn xmlPythonFileCloseRaw(mut context: *mut libc::c_void) -> i32 {
    ...
    if !ret.is_null() {
        ...
        *fresh2 -= 1;
        if !(*fresh2 != 0 as i32 as i64) {
            (unsafe { (Some(((*(*ret).ob_type).tp_dealloc).expect("non-null function pointer")))
    ...
    *fresh3 -= 1;
    if !(*fresh3 != 0 as i32 as i64) {
        (unsafe { (Some(((*(*file).ob_type).tp_dealloc).expect("non-null function pointer")))
...
extern "C" fn xmlPythonFileReadRaw(
    ...
    if ret.is_null() {
        ...
        if (unsafe { (*(*ret).ob_type).tp_flags }) & (1 as i64) << 27 as i32 != 0 as i32 as i64 {
        ...
        } else if (unsafe { (*(*ret).ob_type).tp_flags }) & (1 as i64) << 28 as i32 != 0 as i32 as i64 {
            ...
            *fresh4 -= 1;
            ...
            (unsafe { printf(b"xmlPythonFileReadRaw: result is not a String\n\0" as *const u8 as *const i8) });
    ...
    if ret.is_null() {
        ...
        if (unsafe { (*(*ret).ob_type).tp_flags }) & (1 as i64) << 27 as i32 != 0 as i32 as i64 {
            ...
            *fresh7 -= 1;
            ...
            (unsafe { printf(b"xmlPythonFileRead: result is not a String\n\0" as *const u8 as *const i8) });
...
extern "C" fn xmlPythonFileWrite(
    ...
    if (unsafe { PyObject_HasAttrString(file, b"io_write\0" as *const u8 as *const i8 as *mut i8) }) != 0 {
        ret = unsafe { PyEval_CallMethod(
            file,
    ...
    } else if (unsafe { PyObject_HasAttrString(file, b"write\0" as *const u8 as *const i8 as *mut i8) }) != 0 {
        ret = unsafe { PyEval_CallMethod(
            file,
    ...
    *fresh10 -= 1;
    if !(*fresh10 != 0 as i32 as i64) {
        (unsafe { (Some(((*(*string).ob_type).tp_dealloc).expect("non-null function pointer")))
...
extern "C" fn xmlPythonFileClose(mut context: *mut libc::c_void) -> i32 {
    ...
    if (unsafe { PyObject_HasAttrString(file, b"io_close\0" as *const u8 as *const i8 as *mut i8) }) != 0 {
        ret = unsafe { PyEval_CallMethod(
            file,
            b"io_close\0" as *const u8 as *const i8 as *mut i8,
            b"()\0" as *const u8 as *const i8 as *mut i8,
        ) };
    } else if (unsafe { PyObject_HasAttrString(file, b"flush\0" as *const u8 as *const i8 as *mut i8) }) != 0 {
        ret = unsafe { PyEval_CallMethod(
            file,
...
pub extern "C" fn libxml_xmlCreateOutputBuffer(
    ...
    if buffer.is_null() {
        (unsafe { printf(b"libxml_xmlCreateOutputBuffer: buffer == NULL\n\0" as *const u8 as *const i8) });
    }
...
pub extern "C" fn libxml_xmlCreateInputBuffer(
    ...
    if buffer.is_null() {
        (unsafe { printf(b"libxml_xmlParserInputBufferCreate: buffer == NULL\n\0" as *const u8 as *const i8) });
    }
...
extern "C" fn pythonExternalEntityLoader(
    ...
    if !(unsafe { pythonExternalEntityLoaderObjext }).is_null() {
        ...
        ret = unsafe { _PyObject_CallFunction_SizeT(
        ...
        if !ctxtobj.is_null() {
            ...
            *fresh28 -= 1;
            if !(*fresh28 != 0 as i32 as i64) {
                (unsafe { (Some(((*(*ctxtobj).ob_type).tp_dealloc).expect("non-null function pointer")))
                    .expect("non-null function pointer")(ctxtobj) });
            }
        }
        if !ret.is_null() {
            if (unsafe { PyObject_HasAttrString(ret, b"read\0" as *const u8 as *const i8 as *mut i8) }) != 0 {
    ...
    if result.is_null() && (unsafe { defaultExternalEntityLoader.is_some() }) {
        result = unsafe { defaultExternalEntityLoader.expect("non-null function pointer")(URL, ID, ctxt) };
    }
    return result;
}
#[no_mangle]
    ...
    if ret == (unsafe { &mut _Py_NoneStruct }) as *mut PyObject {
        ...
        *fresh37 -= 1;
        if !(*fresh37 != 0 as i32 as i64) {
            ...
            .expect("non-null function pointer")(&mut _Py_NoneStruct as *mut PyObject) });
        }
...
pub extern "C" fn libxml_xmlRegisterInputCallback(
    ...
    if (unsafe { pythonInputCallbackID }) == -(1 as i32) {
        (unsafe { pythonInputCallbackID = xmlRegisterInputCallbacks(
            Some(pythonInputMatchCallback as unsafe extern "C" fn(*const i8) -> i32),
            Some(pythonInputOpenCallback as unsafe extern "C" fn(*const i8) -> *mut libc::c_void),
            Some(
                xmlPythonFileReadRaw
                    as unsafe extern "C" fn(*mut libc::c_void, *mut i8, i32) -> i32,
            ),
...
extern "C" fn pythonStartElement(
    ...
    if (unsafe { PyObject_HasAttrString(
        handler,
        b"startElement\0" as *const u8 as *const i8 as *mut i8,
    ) }) != 0
    {
        type_0 = 1 as i32;
    } else if (unsafe { PyObject_HasAttrString(handler, b"start\0" as *const u8 as *const i8 as *mut i8) }) != 0
    {
        type_0 = 2 as i32;
    }
    if type_0 != 0 as i32 {
        if attrs.is_null() && type_0 == 1 as i32 {
            ...
            while !(unsafe { *attrs.offset(i as isize) }).is_null() {
                ...
                if !(unsafe { *attrs.offset(i as isize) }).is_null() {
                    attrvalue = unsafe { PyString_FromString(*attrs.offset(i as isize) as *mut i8) };
                } else {
                    if !((unsafe { &mut _Py_NoneStruct }) as *mut PyObject).is_null() {
                ...
                *fresh44 -= 1;
                if !(*fresh44 != 0 as i32 as i64) {
                    (unsafe { (Some(((*(*attrname).ob_type).tp_dealloc).expect("non-null function pointer")))
                ...
                *fresh45 -= 1;
                if !(*fresh45 != 0 as i32 as i64) {
                    (unsafe { (Some(
                        ((*(*attrvalue).ob_type).tp_dealloc).expect("non-null function pointer"),
                    ))
        ...
        if type_0 == 1 as i32 {
            result = unsafe { _PyObject_CallMethod_SizeT(
                handler,
                b"startElement\0" as *const u8 as *const i8 as *mut i8,
        ...
        if !dict.is_null() {
            ...
            *fresh46 -= 1;
            if !(*fresh46 != 0 as i32 as i64) {
                (unsafe { (Some(((*(*dict).ob_type).tp_dealloc).expect("non-null function pointer")))
        ...
        if !result.is_null() {
            ...
            *fresh47 -= 1;
            if !(*fresh47 != 0 as i32 as i64) {
                (unsafe { (Some(((*(*result).ob_type).tp_dealloc).expect("non-null function pointer")))
    ...
    if !handler.is_null() {
        ...
        *fresh50 -= 1;
        if !(*fresh50 != 0 as i32 as i64) {
            (unsafe { (Some(((*(*handler).ob_type).tp_dealloc).expect("non-null function pointer")))
...
extern "C" fn pythonEndElement(mut user_data: *mut libc::c_void, mut name: *const xmlChar) {
    ...
    } else if (unsafe { PyObject_HasAttrString(handler, b"end\0" as *const u8 as *const i8 as *mut i8) }) != 0 {
        result = unsafe { _PyObject_CallMethod_SizeT(
            handler,
...
extern "C" fn pythonReference(mut user_data: *mut libc::c_void, mut name: *const xmlChar) {
    ...
    let mut result: *mut PyObject = 0 as *mut PyObject;
    handler = user_data as *mut PyObject;
    if (unsafe { PyObject_HasAttrString(handler, b"reference\0" as *const u8 as *const i8 as *mut i8) }) != 0 {
        result = unsafe { _PyObject_CallMethod_SizeT(
            handler,
...
extern "C" fn pythonCharacters(
    ...
    {
        type_0 = 1 as i32;
    } else if (unsafe { PyObject_HasAttrString(handler, b"data\0" as *const u8 as *const i8 as *mut i8) }) != 0 {
        type_0 = 2 as i32;
    }
    if type_0 != 0 as i32 {
        if type_0 == 1 as i32 {
...
extern "C" fn pythonComment(mut user_data: *mut libc::c_void, mut value: *const xmlChar) {
    ...
    let mut result: *mut PyObject = 0 as *mut PyObject;
    handler = user_data as *mut PyObject;
    if (unsafe { PyObject_HasAttrString(handler, b"comment\0" as *const u8 as *const i8 as *mut i8) }) != 0 {
        result = unsafe { _PyObject_CallMethod_SizeT(
            handler,
...
extern "C" fn pythonCdataBlock(
    ...
    {
        type_0 = 1 as i32;
    } else if (unsafe { PyObject_HasAttrString(handler, b"cdata\0" as *const u8 as *const i8 as *mut i8) }) != 0
    {
        type_0 = 2 as i32;
    }
    if type_0 != 0 as i32 {
        ...
        while !node.is_null() {
            ...
            *fresh65 -= 1;
            if !(*fresh65 != 0 as i32 as i64) {
                (unsafe { (Some(((*(*newName).ob_type).tp_dealloc).expect("non-null function pointer")))
        ...
        if !nameList.is_null() {
            ...
            *fresh66 -= 1;
            if !(*fresh66 != 0 as i32 as i64) {
                (unsafe { (Some(((*(*nameList).ob_type).tp_dealloc).expect("non-null function pointer")))
...
pub extern "C" fn libxml_xmlCreatePushParser(
    ...
    ret = unsafe { xmlCreatePushParserCtxt(SAX, pyobj_SAX as *mut libc::c_void, chunk, size, URI) };
...
pub extern "C" fn libxml_htmlCreatePushParser(
    ...
    ret = unsafe { htmlCreatePushParserCtxt(
        SAX,
...
extern "C" fn libxml_buildMessage(mut msg: *const i8, mut ap: ::std::ffi::VaList) -> *mut i8 {
    ...
    str = (unsafe { xmlMalloc.expect("non-null function pointer")(1000 as i32 as size_t) }) as *mut i8;
    if str.is_null() {
        return 0 as *mut i8;
    }
...
extern "C" fn libxml_xmlErrorInitialize() {
    ...
    (unsafe { xmlThrDefSetGenericErrorFunc(
        0 as *mut libc::c_void,
        Some(
            libxml_xmlErrorFuncHandler
                as unsafe extern "C" fn(*mut libc::c_void, *const i8, ...) -> (),
...
extern "C" fn libxml_xmlParserCtxtGenericErrorFuncHandler(
    ...
    *fresh87 += 1;
    result =
        unsafe { PyEval_CallObjectWithKeywords((*pyCtxt).f, list, 0 as *mut libc::c_void as *mut PyObject) };
    if result.is_null() {
        (unsafe { PyErr_Print() });
    }
    if !list.is_null() {
        ...
        *fresh88 -= 1;
        if !(*fresh88 != 0 as i32 as i64) {
            (unsafe { (Some(((*(*list).ob_type).tp_dealloc).expect("non-null function pointer")))
                .expect("non-null function pointer")(list) });
        }
    }
    if !result.is_null() {
...
extern "C" fn libxml_xmlParserCtxtSetErrorHandler(
    ...
    if (unsafe { (*ctxt)._private }).is_null() {
        pyCtxt = (unsafe { xmlMalloc.expect("non-null function pointer")(::std::mem::size_of::<
            xmlParserCtxtPyCtxt,
        >() as u64) }) as xmlParserCtxtPyCtxtPtr;
        if pyCtxt.is_null() {
            py_retval = unsafe { libxml_intWrap(-(1 as i32)) };
            return py_retval;
        }
    ...
    if !(unsafe { (*pyCtxt).f }).is_null() {
        ...
        *fresh91 -= 1;
        if !(*fresh91 != 0 as i32 as i64) {
            (unsafe { (Some(((*(*(*pyCtxt).f).ob_type).tp_dealloc).expect("non-null function pointer")))
    ...
    if !(unsafe { (*pyCtxt).arg }).is_null() {
        ...
        *fresh94 -= 1;
        if !(*fresh94 != 0 as i32 as i64) {
            (unsafe { (Some(((*(*(*pyCtxt).arg).ob_type).tp_dealloc).expect("non-null function pointer")))
            ...
            if !(unsafe { (*pyCtxt).f }).is_null() {
                ...
                *fresh109 -= 1;
                if !(*fresh109 != 0 as i32 as i64) {
                    (unsafe { (Some(
                        ((*(*(*pyCtxt).f).ob_type).tp_dealloc).expect("non-null function pointer"),
                    ))
                    .expect("non-null function pointer")((*pyCtxt).f) });
                }
            }
...
extern "C" fn libxml_xmlValidCtxtGenericErrorFuncHandler(
    ...
    result = unsafe { PyEval_CallObjectWithKeywords(
        (*pyCtxt).error,
        list,
        0 as *mut libc::c_void as *mut PyObject,
    ) };
...
extern "C" fn libxml_xmlSetValidErrors(
    ...
    pyCtxt = (unsafe { xmlMalloc.expect("non-null function pointer")(
    ...
    if !(unsafe { (*pyCtxt).error }).is_null() {
        ...
        *fresh118 -= 1;
        if !(*fresh118 != 0 as i32 as i64) {
            (unsafe { (Some(((*(*(*pyCtxt).error).ob_type).tp_dealloc).expect("non-null function pointer")))
    ...
    if !(unsafe { (*pyCtxt).warn }).is_null() {
        ...
        *fresh121 -= 1;
        if !(*fresh121 != 0 as i32 as i64) {
            (unsafe { (Some(((*(*(*pyCtxt).warn).ob_type).tp_dealloc).expect("non-null function pointer")))
        ...
        if !(unsafe { (*pyCtxt).arg }).is_null() {
            ...
            *fresh132 -= 1;
            if !(*fresh132 != 0 as i32 as i64) {
                (unsafe { (Some(
                    ((*(*(*pyCtxt).arg).ob_type).tp_dealloc).expect("non-null function pointer"),
                ))
                .expect("non-null function pointer")((*pyCtxt).arg) });
            }
        }
...
extern "C" fn libxml_xmlTextReaderSetErrorHandler(
    ...
    if pyobj_f != (unsafe { &mut _Py_NoneStruct }) as *mut PyObject {
        pyCtxt = (unsafe { xmlMalloc.expect("non-null function pointer")(::std::mem::size_of::<
            xmlTextReaderPyCtxt,
        >() as u64) }) as xmlTextReaderPyCtxtPtr;
        if pyCtxt.is_null() {
            py_retval = unsafe { libxml_intWrap(-(1 as i32)) };
            return py_retval;
        }
        ...
        *fresh142 = pyobj_arg;
        (unsafe { xmlTextReaderSetErrorHandler(
            reader,
            ::std::mem::transmute::<
                Option<
                    unsafe extern "C" fn(
...
extern "C" fn libxml_xmlTextReaderGetErrorHandler(
    ...
    if f == (unsafe { ::std::mem::transmute::<
        Option<
            unsafe extern "C" fn(*mut libc::c_void, *const i8, i32, xmlTextReaderLocatorPtr) -> (),
        >,
        xmlTextReaderErrorFunc,
    >(Some(
        libxml_xmlTextReaderErrorCallback
...
extern "C" fn libxml_xmlFreeTextReader(
    ...
    if !((unsafe { (*pyobj_reader).ob_type }) == (unsafe { &mut PyCapsule_Type }) as *mut PyTypeObject) {
...
extern "C" fn libxml_xmlXPathFuncCallback(mut ctxt: xmlXPathParserContextPtr, mut nargs: i32) {
    ...
    while i < (unsafe { libxml_xpathCallbacksNb }) {
        ...
        {
            current_function = unsafe { (*(*libxml_xpathCallbacks).as_mut_ptr().offset(i as isize)).function };
        }
        i += 1;
    }
...
extern "C" fn libxml_xmlXPathFuncLookupFunc(
    ...
    while i < (unsafe { libxml_xpathCallbacksNb }) {
        if ctxt
            == (unsafe { (*(*libxml_xpathCallbacks).as_mut_ptr().offset(i as isize)).ctx }) as *mut libc::c_void
            && (unsafe { xmlStrEqual(
                name,
                (*(*libxml_xpathCallbacks).as_mut_ptr().offset(i as isize)).name,
            ) }) != 0
...
extern "C" fn libxml_xpathCallbacksInitialize() {
    ...
    (unsafe { libxml_xpathCallbacks = xmlMalloc.expect("non-null function pointer")(
    ...
    while i < (unsafe { libxml_xpathCallbacksAllocd }) {
        let fresh153 = unsafe { &mut ((*(*libxml_xpathCallbacks).as_mut_ptr().offset(i as isize)).ctx) };
        *fresh153 = 0 as xmlXPathContextPtr;
        let fresh154 = unsafe { &mut ((*(*libxml_xpathCallbacks).as_mut_ptr().offset(i as isize)).name) };
        *fresh154 = 0 as *mut xmlChar;
        let fresh155 = unsafe { &mut ((*(*libxml_xpathCallbacks).as_mut_ptr().offset(i as isize)).ns_uri) };
        *fresh155 = 0 as *mut xmlChar;
        let fresh156 = unsafe { &mut ((*(*libxml_xpathCallbacks).as_mut_ptr().offset(i as isize)).function) };
...
pub extern "C" fn libxml_xmlRegisterXPathFunction(
    ...
    (unsafe { xmlXPathRegisterFuncLookup(
        ctx,
        Some(
    ...
    loop {
            ...
            ) }) != 0
        {
            ...
            if !(unsafe { (*(*libxml_xpathCallbacks).as_mut_ptr().offset(i as isize)).function }).is_null() {
                let fresh158 =
                    unsafe { &mut ((*(*(*libxml_xpathCallbacks).as_mut_ptr().offset(i as isize)).function)
                        .ob_refcnt) };
                *fresh158 -= 1;
    ...
    match current_block {
        18377268871191777778 => {
            if (unsafe { libxml_xpathCallbacksNb }) >= (unsafe { libxml_xpathCallbacksAllocd }) {
                ...
                (unsafe { libxml_xpathCallbacks = xmlRealloc.expect("non-null function pointer")(
            ...
            let fresh162 = unsafe { &mut ((*(*libxml_xpathCallbacks).as_mut_ptr().offset(i as isize)).ctx) };
            *fresh162 = ctx;
            let fresh163 = unsafe { &mut ((*(*libxml_xpathCallbacks).as_mut_ptr().offset(i as isize)).name) };
...
extern "C" fn libxml_xmlRelaxNGSetValidErrors(
    ...
    if (unsafe { xmlRelaxNGGetValidErrors(
        ctxt,
    ...
    if pyCtxt.is_null() {
        ...
        >() as u64) }) as xmlRelaxNGValidCtxtPyCtxtPtr;
        if pyCtxt.is_null() {
            py_retval = unsafe { libxml_intWrap(-(1 as i32)) };
            return py_retval;
        }
...
pub extern "C" fn libxml_xmlSchemaSetValidErrors(
    ...
    if (unsafe { xmlSchemaGetValidErrors(
        ctxt,
    ...
    if pyCtxt.is_null() {
        ...
        >() as u64) }) as xmlSchemaValidCtxtPyCtxtPtr;
        if pyCtxt.is_null() {
            py_retval = unsafe { libxml_intWrap(-(1 as i32)) };
            return py_retval;
        }
...
extern "C" fn PyxmlNodeSet_Convert(
    ...
    if (unsafe { (*(*py_nodeset).ob_type).tp_flags }) & (1 as i64) << 26 as i32 != 0 as i32 as i64 {
        is_tuple = 1 as i32;
    } else if (unsafe { (*(*py_nodeset).ob_type).tp_flags }) & (1 as i64) << 25 as i32 != 0 as i32 as i64 {
        is_tuple = 0 as i32;
    ...
    nodeSet =
        (unsafe { xmlMalloc.expect("non-null function pointer")(::std::mem::size_of::<xmlNodeSet>() as u64) })
            as xmlNodeSetPtr;
    if nodeSet.is_null() {
    ...
    (unsafe { (*nodeSet).nodeMax = (if is_tuple != 0 {
        (*(py_nodeset as *mut PyVarObject)).ob_size
    } else {
        (*(py_nodeset as *mut PyVarObject)).ob_size
    }) as i32 });
    let fresh220 = unsafe { &mut ((*nodeSet).nodeTab) };
    *fresh220 = (unsafe { xmlMalloc.expect("non-null function pointer")(
    ...
    while idx < (unsafe { (*nodeSet).nodeMax }) {
        let mut pynode: xmlNodePtr = if (if is_tuple != 0 {
            unsafe { *((*(py_nodeset as *mut PyTupleObject)).ob_item)
                .as_mut_ptr()
                .offset(idx as isize) }
        } else {
...
extern "C" fn PystringSet_Convert(
    ...
    if (unsafe { (*(*py_strings).ob_type).tp_flags }) & (1 as i64) << 26 as i32 != 0 as i32 as i64 {
        is_tuple = 1 as i32;
    } else if (unsafe { (*(*py_strings).ob_type).tp_flags }) & (1 as i64) << 25 as i32 != 0 as i32 as i64 {
        is_tuple = 0 as i32;
    ...
    strings = (unsafe { xmlMalloc.expect("non-null function pointer")(
    ...
    idx = 0 as i32;
    while idx < count {
        let mut s: *mut i8 = unsafe { PyString_AsString(if is_tuple != 0 {
...
extern "C" fn libxml_C14NDocDumpMemory(
    ...
    if exclusive != 0 {
        ...
        if result < 0 as i32 {
            if !nodes.is_null() {
                (unsafe { xmlFree.expect("non-null function pointer")((*nodes).nodeTab as *mut libc::c_void) });
                (unsafe { xmlFree.expect("non-null function pointer")(nodes as *mut libc::c_void) });
            }
            return 0 as *mut PyObject;
        }
    }
    result = unsafe { xmlC14NDocDumpMemory(doc, nodes, exclusive, prefixes, with_comments, &mut doc_txt) };
    if !nodes.is_null() {
        (unsafe { xmlFree.expect("non-null function pointer")((*nodes).nodeTab as *mut libc::c_void) });
        (unsafe { xmlFree.expect("non-null function pointer")(nodes as *mut libc::c_void) });
    }
    if !prefixes.is_null() {
        ...
        while !(unsafe { *idx }).is_null() {
            ...
            (unsafe { xmlFree.expect("non-null function pointer")(*fresh226 as *mut libc::c_void) });
        }
    ...
    if result < 0 as i32 {
        ...
        py_retval = unsafe { PyString_FromStringAndSize(doc_txt as *const i8, result as Py_ssize_t) };
...
extern "C" fn libxml_C14NDocSaveTo(
    ...
    if !prefixes.is_null() {
        ...
        while !(unsafe { *idx }).is_null() {
            let fresh227 = idx;
            idx = unsafe { idx.offset(1) };
            (unsafe { xmlFree.expect("non-null function pointer")(*fresh227 as *mut libc::c_void) });
        }
        (unsafe { xmlFree.expect("non-null function pointer")(prefixes as *mut libc::c_void) });
    }
    len = unsafe { xmlOutputBufferClose(buf) };
...
extern "C" fn libxml_compareNodesEqual(
    ...
    if node1 == node2 {
        return unsafe { _Py_BuildValue_SizeT(b"i\0" as *const u8 as *const i8 as *mut i8, 1 as i32) };
    } else {
        return unsafe { _Py_BuildValue_SizeT(b"i\0" as *const u8 as *const i8 as *mut i8, 0 as i32) };
    };
}
...
pub extern "C" fn initlibxml2mod() {
    ...
    module = unsafe { Py_InitModule4_64(
