...
pub use crate::src::{
    ...
    xmllint::_IO_marker,
    xmlmemory::{_IO_wide_data, xmlMemoryDump},
    xmlsave::_IO_codecvt,
};
pub type xmlChar = u8;
pub type size_t = u64;
    ...
    loop {
        ...
        if i == 0 as i32 {
            ...
            if (unsafe { strcmp(command.as_mut_ptr(), b"exit\0" as *const u8 as *const i8) }) == 0
                || (unsafe { strcmp(command.as_mut_ptr(), b"quit\0" as *const u8 as *const i8) }) == 0
                || (unsafe { strcmp(command.as_mut_ptr(), b"bye\0" as *const u8 as *const i8) }) == 0
            {
                (unsafe { free(cmdline as *mut libc::c_void) });
                break;
            } else {
                if (unsafe { strcmp(command.as_mut_ptr(), b"public\0" as *const u8 as *const i8) }) == 0 {
                    if nbargs != 1 as i32 {
                        (unsafe { printf(b"public requires 1 arguments\n\0" as *const u8 as *const i8) });
                    } else {
                        ans = unsafe { xmlCatalogResolvePublic(argv[0 as i32 as usize] as *const xmlChar) };
                        if ans.is_null() {
                            (unsafe { printf(
                            ...
                            (unsafe { xmlFree.expect("non-null function pointer")(ans as *mut libc::c_void) });
                        }
                    }
                } else if (unsafe { strcmp(command.as_mut_ptr(), b"system\0" as *const u8 as *const i8) }) == 0 {
                    if nbargs != 1 as i32 {
                        (unsafe { printf(b"system requires 1 arguments\n\0" as *const u8 as *const i8) });
                    } else {
                        ans = unsafe { xmlCatalogResolveSystem(argv[0 as i32 as usize] as *const xmlChar) };
                        if ans.is_null() {
                            (unsafe { printf(
                ...
                } else if (unsafe { strcmp(command.as_mut_ptr(), b"add\0" as *const u8 as *const i8) }) == 0 {
                    if nbargs != 3 as i32 && nbargs != 2 as i32 {
                        (unsafe { printf(b"add requires 2 or 3 arguments\n\0" as *const u8 as *const i8) });
                    } else {
                        if (argv[2 as i32 as usize]).is_null() {
                            ret = unsafe { xmlCatalogAdd(
                        ...
                        if ret != 0 as i32 {
                            (unsafe { printf(b"add command failed\n\0" as *const u8 as *const i8) });
                        }
                    }
                } else if (unsafe { strcmp(command.as_mut_ptr(), b"del\0" as *const u8 as *const i8) }) == 0 {
                    if nbargs != 1 as i32 {
                        (unsafe { printf(b"del requires 1\n\0" as *const u8 as *const i8) });
                    } else {
                        ret = unsafe { xmlCatalogRemove(argv[0 as i32 as usize] as *mut xmlChar) };
                        if ret <= 0 as i32 {
                            (unsafe { printf(b"del command failed\n\0" as *const u8 as *const i8) });
                        }
                    }
                } else if (unsafe { strcmp(command.as_mut_ptr(), b"resolve\0" as *const u8 as *const i8) }) == 0
                {
                    if nbargs != 2 as i32 {
                        (unsafe { printf(b"resolve requires 2 arguments\n\0" as *const u8 as *const i8) });
                    } else {
                        ans = unsafe { xmlCatalogResolve(
                            argv[0 as i32 as usize] as *mut xmlChar,
                            argv[1 as i32 as usize] as *mut xmlChar,
                        ) };
                        if ans.is_null() {
                ...
                } else if (unsafe { strcmp(command.as_mut_ptr(), b"dump\0" as *const u8 as *const i8) }) == 0 {
                    if nbargs != 0 as i32 {
                        (unsafe { printf(b"dump has no arguments\n\0" as *const u8 as *const i8) });
                    } else {
                        (unsafe { xmlCatalogDump(stdout) });
                    }
                } else if (unsafe { strcmp(command.as_mut_ptr(), b"debug\0" as *const u8 as *const i8) }) == 0 {
                    if nbargs != 0 as i32 {
                        (unsafe { printf(b"debug has no arguments\n\0" as *const u8 as *const i8) });
                    } else {
                        (unsafe { verbose += 1 });
                        (unsafe { xmlCatalogSetDebug(verbose) });
                    }
                } else if (unsafe { strcmp(command.as_mut_ptr(), b"quiet\0" as *const u8 as *const i8) }) == 0 {
                    if nbargs != 0 as i32 {
                        (unsafe { printf(b"quiet has no arguments\n\0" as *const u8 as *const i8) });
                    } else {
                    ...
                    (unsafe { printf(b"\tdel 'values' : remove values\n\0" as *const u8 as *const i8) });
                    (unsafe { printf(
                        b"\tdump: print the current catalog state\n\0" as *const u8 as *const i8,
                    ) });
                    (unsafe { printf(b"\tdebug: increase the verbosity level\n\0" as *const u8 as *const i8) });
                    (unsafe { printf(b"\tquiet: decrease the verbosity level\n\0" as *const u8 as *const i8) });
...
fn main_0(mut argc: i32, mut argv: *mut *mut i8) -> i32 {
    ...
    while i < argc {
        ...
        } else if !((unsafe { *(*argv.offset(i as isize)).offset(0 as i32 as isize) }) as i32 == '-' as i32) {
            if (unsafe { filename }).is_null()
                && (unsafe { *(*argv.offset(i as isize)).offset(0 as i32 as isize) }) as i32 == '\u{0}' as i32
            {
    ...
    if (unsafe { add }) != 0 || (unsafe { del }) != 0 {
                    ...
                    ) }) != 0)
                {
                    if (unsafe { sgml }) != 0 {
                        ...
                        let mut super_0: *mut crate::src::xmlcatalog::_xmlCatalog =
                            0 as xmlCatalogPtr;
                        catal = unsafe { xmlLoadSGMLSuperCatalog(*argv.offset((i + 1 as i32) as isize)) };
                        if (unsafe { strcmp(
                            *argv.offset(i as isize),
                            b"-add\0" as *const u8 as *const i8,
                        ) }) == 0
                            ...
                            ) }) == 0
                        {
                            ...
                            if (unsafe { no_super_update }) == 0 {
                                super_0 = unsafe { xmlLoadSGMLSuperCatalog(
                        ...
                        ) }) == 0
                    {
                        if (unsafe { *argv.offset((i + 3 as i32) as isize) }).is_null()
                            || (unsafe { *(*argv.offset((i + 3 as i32) as isize)).offset(0 as i32 as isize) })
                                as i32
                                == 0 as i32
                        {
                            ret = unsafe { xmlCatalogAdd(
                    ...
                    {
                        ret =
                            unsafe { xmlCatalogRemove(*argv.offset((i + 1 as i32) as isize) as *mut xmlChar) };
                        if ret < 0 as i32 {
                            (unsafe { fprintf(
                                stderr,
        ...
        while i < argc {
            ...
            if uri.is_null() {
                ans = unsafe { xmlCatalogResolvePublic(*argv.offset(i as isize) as *const xmlChar) };
                if ans.is_null() {
                    (unsafe { printf(
                        b"No entry for PUBLIC %s\n\0" as *const u8 as *const i8,
                        *argv.offset(i as isize),
                ...
                xmlFreeURI(uri);
                ans = unsafe { xmlCatalogResolveSystem(*argv.offset(i as isize) as *const xmlChar) };
                if ans.is_null() {
                    (unsafe { printf(
                        b"No entry for SYSTEM %s\n\0" as *const u8 as *const i8,
                        *argv.offset(i as isize),
                    ) });
                    ans = unsafe { xmlCatalogResolveURI(*argv.offset(i as isize) as *const xmlChar) };
                    if ans.is_null() {
                        (unsafe { printf(
    ...
    if (unsafe { sgml }) == 0 && ((unsafe { add }) != 0 || (unsafe { del }) != 0 || (unsafe { create }) != 0 || (unsafe { convert }) != 0) {
        if (unsafe { noout }) != 0 && !(unsafe { filename }).is_null() && (unsafe { *filename }) as i32 != 0 {
