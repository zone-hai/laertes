...
pub use crate::src::{
    tree::{
        xmlSearchNs, xmlSplitQName2, xmlValidateNCName, xmlValidateNMToken, xmlValidateName,
        xmlValidateQName,
    },
    uri::{xmlFreeURI, xmlParseURI},
    valid::{_xmlValidState, xmlAddID, xmlAddRef, xmlValidateNotationUse},
    xmlregexp::{_xmlAutomata, _xmlAutomataState, _xmlRegexp, xmlRegexpExec},
    xmlsave::_xmlHashTable,
    xmlschemas::{xmlSchemaFreeType, xmlSchemaFreeWildcard, xmlSchemaNewFacet},
    xmlstring::{xmlStrEqual, xmlStrcat, xmlStrcmp, xmlStrdup, xmlStrndup, xmlUTF8Strlen},
    xpointer::_xmlDict,
};
pub type xmlChar = u8;
pub type size_t = u64;
...
extern "C" fn xmlSchemaNewValue(
    ...
    value =
        (unsafe { xmlMalloc.expect("non-null function pointer")(::std::mem::size_of::<xmlSchemaVal>() as u64) })
            as xmlSchemaValPtr;
    if value.is_null() {
...
pub extern "C" fn xmlSchemaInitTypes() {
    ...
    (unsafe { xmlSchemaTypeAnyTypeDef = xmlSchemaInitBasicType(
    ...
    *fresh6 = particle as xmlSchemaTypePtr;
    sequence = (unsafe { xmlMalloc.expect("non-null function pointer")(::std::mem::size_of::<
        xmlSchemaModelGroup,
    >() as u64) }) as xmlSchemaModelGroupPtr;
    if sequence.is_null() {
        xmlSchemaTypeErrMemory(
            0 as xmlNodePtr,
    ...
    *fresh8 = particle as xmlSchemaTreeItemPtr;
    wild = (unsafe { xmlMalloc.expect("non-null function pointer")(
    ...
    *fresh10 = wild;
    (unsafe { xmlSchemaTypeAnySimpleTypeDef = xmlSchemaInitBasicType(
        b"anySimpleType\0" as *const u8 as *const i8,
        XML_SCHEMAS_ANYSIMPLETYPE,
        xmlSchemaTypeAnyTypeDef,
    ) });
    (unsafe { xmlSchemaTypeStringDef = xmlSchemaInitBasicType(
        b"string\0" as *const u8 as *const i8,
        XML_SCHEMAS_STRING,
        xmlSchemaTypeAnySimpleTypeDef,
    ) });
    (unsafe { xmlSchemaTypeDecimalDef = xmlSchemaInitBasicType(
        b"decimal\0" as *const u8 as *const i8,
        XML_SCHEMAS_DECIMAL,
        xmlSchemaTypeAnySimpleTypeDef,
    ) });
    (unsafe { xmlSchemaTypeDateDef = xmlSchemaInitBasicType(
        b"date\0" as *const u8 as *const i8,
        XML_SCHEMAS_DATE,
        xmlSchemaTypeAnySimpleTypeDef,
    ) });
    (unsafe { xmlSchemaTypeDatetimeDef = xmlSchemaInitBasicType(
        b"dateTime\0" as *const u8 as *const i8,
        XML_SCHEMAS_DATETIME,
        xmlSchemaTypeAnySimpleTypeDef,
    ) });
    (unsafe { xmlSchemaTypeTimeDef = xmlSchemaInitBasicType(
        b"time\0" as *const u8 as *const i8,
        XML_SCHEMAS_TIME,
        xmlSchemaTypeAnySimpleTypeDef,
    ) });
    (unsafe { xmlSchemaTypeGYearDef = xmlSchemaInitBasicType(
        b"gYear\0" as *const u8 as *const i8,
        XML_SCHEMAS_GYEAR,
        xmlSchemaTypeAnySimpleTypeDef,
    ) });
    (unsafe { xmlSchemaTypeGYearMonthDef = xmlSchemaInitBasicType(
        b"gYearMonth\0" as *const u8 as *const i8,
        XML_SCHEMAS_GYEARMONTH,
        xmlSchemaTypeAnySimpleTypeDef,
    ) });
    (unsafe { xmlSchemaTypeGMonthDef = xmlSchemaInitBasicType(
        b"gMonth\0" as *const u8 as *const i8,
        XML_SCHEMAS_GMONTH,
        xmlSchemaTypeAnySimpleTypeDef,
    ) });
    (unsafe { xmlSchemaTypeGMonthDayDef = xmlSchemaInitBasicType(
        b"gMonthDay\0" as *const u8 as *const i8,
        XML_SCHEMAS_GMONTHDAY,
        xmlSchemaTypeAnySimpleTypeDef,
    ) });
    (unsafe { xmlSchemaTypeGDayDef = xmlSchemaInitBasicType(
        b"gDay\0" as *const u8 as *const i8,
        XML_SCHEMAS_GDAY,
        xmlSchemaTypeAnySimpleTypeDef,
    ) });
    (unsafe { xmlSchemaTypeDurationDef = xmlSchemaInitBasicType(
        b"duration\0" as *const u8 as *const i8,
        XML_SCHEMAS_DURATION,
        xmlSchemaTypeAnySimpleTypeDef,
    ) });
    (unsafe { xmlSchemaTypeFloatDef = xmlSchemaInitBasicType(
        b"float\0" as *const u8 as *const i8,
        XML_SCHEMAS_FLOAT,
        xmlSchemaTypeAnySimpleTypeDef,
    ) });
    (unsafe { xmlSchemaTypeDoubleDef = xmlSchemaInitBasicType(
        b"double\0" as *const u8 as *const i8,
        XML_SCHEMAS_DOUBLE,
        xmlSchemaTypeAnySimpleTypeDef,
    ) });
    (unsafe { xmlSchemaTypeBooleanDef = xmlSchemaInitBasicType(
        b"boolean\0" as *const u8 as *const i8,
        XML_SCHEMAS_BOOLEAN,
        xmlSchemaTypeAnySimpleTypeDef,
    ) });
    (unsafe { xmlSchemaTypeAnyURIDef = xmlSchemaInitBasicType(
        b"anyURI\0" as *const u8 as *const i8,
        XML_SCHEMAS_ANYURI,
        xmlSchemaTypeAnySimpleTypeDef,
    ) });
    (unsafe { xmlSchemaTypeHexBinaryDef = xmlSchemaInitBasicType(
        b"hexBinary\0" as *const u8 as *const i8,
        XML_SCHEMAS_HEXBINARY,
        xmlSchemaTypeAnySimpleTypeDef,
    ) });
    (unsafe { xmlSchemaTypeBase64BinaryDef = xmlSchemaInitBasicType(
        b"base64Binary\0" as *const u8 as *const i8,
        XML_SCHEMAS_BASE64BINARY,
        xmlSchemaTypeAnySimpleTypeDef,
    ) });
    (unsafe { xmlSchemaTypeNotationDef = xmlSchemaInitBasicType(
        b"NOTATION\0" as *const u8 as *const i8,
        XML_SCHEMAS_NOTATION,
        xmlSchemaTypeAnySimpleTypeDef,
    ) });
    (unsafe { xmlSchemaTypeQNameDef = xmlSchemaInitBasicType(
        b"QName\0" as *const u8 as *const i8,
        XML_SCHEMAS_QNAME,
        xmlSchemaTypeAnySimpleTypeDef,
    ) });
    (unsafe { xmlSchemaTypeIntegerDef = xmlSchemaInitBasicType(
        b"integer\0" as *const u8 as *const i8,
        XML_SCHEMAS_INTEGER,
        xmlSchemaTypeDecimalDef,
    ) });
    (unsafe { xmlSchemaTypeNonPositiveIntegerDef = xmlSchemaInitBasicType(
        b"nonPositiveInteger\0" as *const u8 as *const i8,
        XML_SCHEMAS_NPINTEGER,
        xmlSchemaTypeIntegerDef,
    ) });
    (unsafe { xmlSchemaTypeNegativeIntegerDef = xmlSchemaInitBasicType(
        b"negativeInteger\0" as *const u8 as *const i8,
        XML_SCHEMAS_NINTEGER,
        xmlSchemaTypeNonPositiveIntegerDef,
    ) });
    (unsafe { xmlSchemaTypeLongDef = xmlSchemaInitBasicType(
        b"long\0" as *const u8 as *const i8,
        XML_SCHEMAS_LONG,
        xmlSchemaTypeIntegerDef,
    ) });
    (unsafe { xmlSchemaTypeIntDef = xmlSchemaInitBasicType(
        b"int\0" as *const u8 as *const i8,
        XML_SCHEMAS_INT,
        xmlSchemaTypeLongDef,
    ) });
    (unsafe { xmlSchemaTypeShortDef = xmlSchemaInitBasicType(
        b"short\0" as *const u8 as *const i8,
        XML_SCHEMAS_SHORT,
        xmlSchemaTypeIntDef,
    ) });
    (unsafe { xmlSchemaTypeByteDef = xmlSchemaInitBasicType(
        b"byte\0" as *const u8 as *const i8,
        XML_SCHEMAS_BYTE,
        xmlSchemaTypeShortDef,
    ) });
    (unsafe { xmlSchemaTypeNonNegativeIntegerDef = xmlSchemaInitBasicType(
        b"nonNegativeInteger\0" as *const u8 as *const i8,
        XML_SCHEMAS_NNINTEGER,
        xmlSchemaTypeIntegerDef,
    ) });
    (unsafe { xmlSchemaTypeUnsignedLongDef = xmlSchemaInitBasicType(
        b"unsignedLong\0" as *const u8 as *const i8,
        XML_SCHEMAS_ULONG,
        xmlSchemaTypeNonNegativeIntegerDef,
    ) });
    (unsafe { xmlSchemaTypeUnsignedIntDef = xmlSchemaInitBasicType(
        b"unsignedInt\0" as *const u8 as *const i8,
        XML_SCHEMAS_UINT,
        xmlSchemaTypeUnsignedLongDef,
    ) });
    (unsafe { xmlSchemaTypeUnsignedShortDef = xmlSchemaInitBasicType(
        b"unsignedShort\0" as *const u8 as *const i8,
        XML_SCHEMAS_USHORT,
        xmlSchemaTypeUnsignedIntDef,
    ) });
    (unsafe { xmlSchemaTypeUnsignedByteDef = xmlSchemaInitBasicType(
        b"unsignedByte\0" as *const u8 as *const i8,
        XML_SCHEMAS_UBYTE,
        xmlSchemaTypeUnsignedShortDef,
    ) });
    (unsafe { xmlSchemaTypePositiveIntegerDef = xmlSchemaInitBasicType(
        b"positiveInteger\0" as *const u8 as *const i8,
        XML_SCHEMAS_PINTEGER,
        xmlSchemaTypeNonNegativeIntegerDef,
    ) });
    (unsafe { xmlSchemaTypeNormStringDef = xmlSchemaInitBasicType(
        b"normalizedString\0" as *const u8 as *const i8,
        XML_SCHEMAS_NORMSTRING,
        xmlSchemaTypeStringDef,
    ) });
    (unsafe { xmlSchemaTypeTokenDef = xmlSchemaInitBasicType(
        b"token\0" as *const u8 as *const i8,
        XML_SCHEMAS_TOKEN,
        xmlSchemaTypeNormStringDef,
    ) });
    (unsafe { xmlSchemaTypeLanguageDef = xmlSchemaInitBasicType(
        b"language\0" as *const u8 as *const i8,
        XML_SCHEMAS_LANGUAGE,
        xmlSchemaTypeTokenDef,
    ) });
    (unsafe { xmlSchemaTypeNameDef = xmlSchemaInitBasicType(
        b"Name\0" as *const u8 as *const i8,
        XML_SCHEMAS_NAME,
        xmlSchemaTypeTokenDef,
    ) });
    (unsafe { xmlSchemaTypeNmtokenDef = xmlSchemaInitBasicType(
        b"NMTOKEN\0" as *const u8 as *const i8,
        XML_SCHEMAS_NMTOKEN,
        xmlSchemaTypeTokenDef,
    ) });
    (unsafe { xmlSchemaTypeNCNameDef = xmlSchemaInitBasicType(
        b"NCName\0" as *const u8 as *const i8,
        XML_SCHEMAS_NCNAME,
        xmlSchemaTypeNameDef,
    ) });
    (unsafe { xmlSchemaTypeIdDef = xmlSchemaInitBasicType(
        b"ID\0" as *const u8 as *const i8,
        XML_SCHEMAS_ID,
        xmlSchemaTypeNCNameDef,
    ) });
    (unsafe { xmlSchemaTypeIdrefDef = xmlSchemaInitBasicType(
        b"IDREF\0" as *const u8 as *const i8,
        XML_SCHEMAS_IDREF,
        xmlSchemaTypeNCNameDef,
    ) });
    (unsafe { xmlSchemaTypeEntityDef = xmlSchemaInitBasicType(
        b"ENTITY\0" as *const u8 as *const i8,
        XML_SCHEMAS_ENTITY,
        xmlSchemaTypeNCNameDef,
    ) });
    (unsafe { xmlSchemaTypeEntitiesDef = xmlSchemaInitBasicType(
    ...
    *fresh11 = unsafe { xmlSchemaTypeEntityDef };
    (unsafe { xmlSchemaTypeIdrefsDef = xmlSchemaInitBasicType(
    ...
    *fresh12 = unsafe { xmlSchemaTypeIdrefDef };
    (unsafe { xmlSchemaTypeNmtokensDef = xmlSchemaInitBasicType(
...
pub extern "C" fn xmlSchemaCleanupTypes() {
    ...
    xmlSchemaFreeWildcard((unsafe { (*(*(*particle).children).children).children }) as xmlSchemaWildcardPtr);
...
pub extern "C" fn xmlSchemaNewStringValue(
    ...
    val = (unsafe { xmlMalloc.expect("non-null function pointer")(::std::mem::size_of::<xmlSchemaVal>() as u64) })
        as xmlSchemaValPtr;
    if val.is_null() {
        return 0 as xmlSchemaValPtr;
    }
...
extern "C" fn _xmlSchemaParseGMonth<'a1, 'a2>(
        ...
        || (unsafe { *cur.offset(1 as i32 as isize) }) as i32 > '9' as i32
    {
        ...
        value = (((unsafe { *cur.offset(0 as i32 as isize) }) as i32 - '0' as i32) * 10 as i32
            + ((unsafe { *cur.offset(1 as i32 as isize) }) as i32 - '0' as i32)) as u32;
    }
...
extern "C" fn _xmlSchemaParseTime<'a1, 'a2>(
        ...
        || (unsafe { *cur.offset(1 as i32 as isize) }) as i32 > '9' as i32
    {
        ...
        (*(borrow_mut(&mut dt)).unwrap()).sec =
            (((unsafe { *cur.offset(0 as i32 as isize) }) as i32 - '0' as i32) * 10 as i32
                + ((unsafe { *cur.offset(1 as i32 as isize) }) as i32 - '0' as i32)) as f64;
    }
    cur = unsafe { cur.offset(2 as i32 as isize) };
    if ret == 0 && (unsafe { *cur }) as i32 == '.' as i32 {
        ...
        while (unsafe { *cur }) as i32 >= '0' as i32 && (unsafe { *cur }) as i32 <= '9' as i32 {
            ...
            (*(borrow_mut(&mut dt)).unwrap()).sec += ((unsafe { *cur }) as i32 - '0' as i32) as f64 * mult;
            cur = unsafe { cur.offset(1) };
        }
    }
    if ret != 0 as i32 {
...
extern "C" fn _xmlSchemaParseTimeZone<'a1>(
    ...
    match (unsafe { *cur }) as i32 {
        ...
        43 | 45 => {
            ...
            if !((unsafe { (*dt).tzo() }) >= -(840 as i32) && (unsafe { (*dt).tzo() }) <= 840 as i32) {
                return 2 as i32;
            }
            (unsafe { (*dt).set_tz_flag(1 as i32 as u32) });
        },
...
extern "C" fn xmlSchemaValidateDates<'a1>(
    ...
    if (unsafe { *cur }) as i32 != '-' as i32 && ((unsafe { *cur }) as i32) < '0' as i32 && (unsafe { *cur }) as i32 > '9' as i32 {
        return 1 as i32;
    }
        ...
        && (unsafe { *cur.offset(1 as i32 as isize) }) as i32 == '-' as i32
    {
        ...
        if (unsafe { *cur }) as i32 == '-' as i32 {
            if type_0 as u32 == XML_SCHEMAS_GMONTH as i32 as u32 {
                ...
                if ret != 0 as i32 {
                    ...
                    || (unsafe { *cur }) as i32 == '-' as i32
                {
                    ret = _xmlSchemaParseTimeZone(unsafe { &mut (*dt).value.date }, Some(&mut cur));
                    if ret == 0 as i32 {
            ...
            if ret != 0 as i32 {
                ...
                if (unsafe { *cur }) as i32 == '-' as i32 {
                    ...
                    cur = unsafe { cur.offset(1) };
                    ret = _xmlSchemaParseGDay(Some(unsafe { &mut (*dt).value.date }), Some(&mut cur));
                    if ret == 0 as i32 && ((unsafe { *cur }) as i32 == 0 as i32 || (unsafe { *cur }) as i32 != ':' as i32) {
                        if if (unsafe { (*dt).value.date.year }) % 4 as i32 as i64 == 0 as i32 as i64
        ...
        match current_block {
            ...
            _ => {
                cur = dateTime;
                ret = _xmlSchemaParseGYear(Some(unsafe { &mut (*dt).value.date }), Some(&mut cur));
                if ret != 0 as i32 {
                    current_block = 2568818999146507592;
                } else {
                    if (unsafe { *cur }) as i32 == 0 as i32
                                    ...
                                    match current_block {
                                        ...
                                        _ => {
                                            if (unsafe { *cur }) as i32 != '-' as i32 {
                                                ...
                                                if ret != 0 as i32
                                                    || !((unsafe { (*dt).value.date.year }) != 0 as i32 as i64
                                                        && ((unsafe { ((*dt).value.date).mon() }) as i32
                                                            >= 1 as i32
                                                            && (unsafe { ((*dt).value.date).mon() }) as i32
                                                                <= 12 as i32)
                                                                ...
                                                                == 0 as i32 as i64
                                                        {
                                                            ...
                                                            ((unsafe { ((*dt).value.date).day() })
                                                                <= (unsafe { daysInMonth[(((*dt).value.date)
                                                                    .mon()
                                                                    as i32
                                                                    - 1 as i32)
                                                                    as usize] }))
                                                        ...
                                                        || (unsafe { *cur }) as i32 == '-' as i32
                                                    {
                                                        ...
                                                        if ret == 0 as i32 {
                                                            if (unsafe { *cur }) as i32 != 0 as i32 {
                                                                ...
                                                                (unsafe { (*dt).type_0 = XML_SCHEMAS_DATE });
                                                                current_block =
                                                                    11781036148129668211;
                                                            }
                                                        } else {
                                                        ...
                                                        _ => {
                                                            if (unsafe { *cur }) as i32 != 'T' as i32 {
                                                                ...
                                                                if ret != 0 as i32 {
                                                                    ...
                                                                    if ret != 0 as i32 || (unsafe { * cur }) as i32 != 0 as i32 || ! ((unsafe { (* dt) . value . date . year }) != 0 as i32 as i64 && ((unsafe { ((* dt) . value . date) . mon () }) as i32 >= 1 as i32 && (unsafe { ((* dt) . value . date) . mon () }) as i32 <= 12 as i32) && (if (unsafe { (* dt) . value . date . year }) % 4 as i32 as i64 == 0 as i32 as i64 && (unsafe { (* dt) . value . date . year }) % 100 as i32 as i64 != 0 as i32 as i64 || (unsafe { (* dt) . value . date . year }) % 400 as i32 as i64 == 0 as i32 as i64 { ((unsafe { ((* dt) . value . date) . day () }) <= (unsafe { daysInMonthLeap [(((* dt) . value . date) . mon () as i32 - 1 as i32) as usize] })) as i32 } else { ((unsafe { ((* dt) . value . date) . day () }) <= (unsafe { daysInMonth [(((* dt) . value . date) . mon () as i32 - 1 as i32) as usize] })) as i32 }) != 0 && (((unsafe { ((* dt) . value . date) . hour () }) as i32 >= 0 as i32 && (unsafe { ((* dt) . value . date) . hour () }) as i32 <= 23 as i32 && ((unsafe { ((* dt) . value . date) . min () }) as i32 >= 0 as i32 && (unsafe { ((* dt) . value . date) . min () }) as i32 <= 59 as i32) && ((unsafe { (* dt) . value . date . sec }) >= 0 as i32 as f64 && (unsafe { (* dt) . value . date . sec }) < 60 as i32 as f64) || (unsafe { ((* dt) . value . date) . hour () }) as i32 == 24 as i32 && (unsafe { ((* dt) . value . date) . min () }) as i32 == 0 as i32 && (unsafe { (* dt) . value . date . sec }) == 0 as i32 as f64) && ((unsafe { ((* dt) . value . date) . tzo () }) >= - (840 as i32) && (unsafe { ((* dt) . value . date) . tzo () }) <= 840 as i32))) { current_block = 2568818999146507592 ; } else { (unsafe { (* dt) . type_0 = XML_SCHEMAS_DATETIME }) ; current_block = 11781036148129668211 ; }
                                                                }
                                                            }
                                                        },
                                                    }
...
pub extern "C" fn xmlSchemaWhiteSpaceReplace(mut value: *const u8) -> *mut u8 {
    ...
    while (unsafe { *cur }) as i32 != 0 as i32
        && ((unsafe { *cur }) as i32 != 0xd as i32 && (unsafe { *cur }) as i32 != 0x9 as i32 && (unsafe { *cur }) as i32 != 0xa as i32)
    {
        cur = unsafe { cur.offset(1) };
    }
    if (unsafe { *cur }) as i32 == 0 as i32 {
    ...
    loop {
        if (unsafe { *mcur }) as i32 == 0xd as i32 || (unsafe { *mcur }) as i32 == 0x9 as i32 || (unsafe { *mcur }) as i32 == 0xa as i32 {
...
extern "C" fn xmlSchemaParseUInt<'a1, 'a2, 'a3, 'a4>(
    ...
    tmp = cur;
    while (unsafe { *tmp }) as i32 != 0 as i32 && (unsafe { *tmp }) as i32 >= '0' as i32 && (unsafe { *tmp }) as i32 <= '9' as i32 {
        i += 1;
    ...
    match unsafe { (*type_0).builtInType } {
            ...
            if cur_1.is_null() || (unsafe { *cur_1 }) as i32 == 0 as i32 {
                ...
                if normOnTheFly != 0 {
                    while (unsafe { *cur_1 }) as i32 == 0x20 as i32
                        || 0x9 as i32 <= (unsafe { *cur_1 }) as i32 && (unsafe { *cur_1 }) as i32 <= 0xa as i32
                ...
                if (unsafe { *cur_1 }) as i32 == 0 as i32 {
                    ...
                    if (unsafe { *cur_1 }) as i32 != 0 as i32 {
                        loop {
                            if (unsafe { *cur_1 }) as i32 >= '0' as i32 && (unsafe { *cur_1 }) as i32 <= '9' as i32 {
                                ...
                                cur_1 = unsafe { cur_1.offset(1) };
                                integ = len;
                                while (unsafe { *cur_1 }) as i32 >= '0' as i32 && (unsafe { *cur_1 }) as i32 <= '9' as i32 {
                                ...
                                if !borrow(&val).is_none() {
                                    ...
                                    if !v.is_null() {
                                        if len != 0 as i32 as u32 {
                                            if integ != !(0 as u32) {
                                                while len != integ
                                                    && (unsafe { *cptr.offset(-(1 as i32 as isize)) }) as i32
                                                        == '0' as i32
                                                {
                                                    cptr = unsafe { cptr.offset(-1) };
                                        ...
                                        if len == 0 as i32 as u32 {
                                            ...
                                            if integ == !(0 as u32) {
                                                let fresh40 = unsafe { &mut ((*v).value.decimal) };
                                                (*fresh40).set_frac(0 as i32 as u32);
                                            } else {
                                                let fresh41 = unsafe { &mut ((*v).value.decimal) };
        ...
        13 | 14 => {
            ...
            if normOnTheFly != 0 {
                while (unsafe { *cur_2 }) as i32 == 0x20 as i32
                    || 0x9 as i32 <= (unsafe { *cur_2 }) as i32 && (unsafe { *cur_2 }) as i32 <= 0xa as i32
                ...
                && (unsafe { *cur_2.offset(2 as i32 as isize) }) as i32 == 'N' as i32
            {
                    ...
                    && (unsafe { *cur_2.offset(2 as i32 as isize) }) as i32 == 'F' as i32
                {
                        ...
                        || (unsafe { *cur_2.offset(0 as i32 as isize) }) as i32 == '-' as i32
                    {
                        ...
                        while (unsafe { *cur_2 }) as i32 >= '0' as i32 && (unsafe { *cur_2 }) as i32 <= '9' as i32 {
                            cur_2 = unsafe { cur_2.offset(1) };
                            digits_before += 1;
                        }
                        if (unsafe { *cur_2 }) as i32 == '.' as i32 {
                        ...
                        if digits_before == 0 as i32 && digits_after == 0 as i32 {
                            ...
                            if (unsafe { *cur_2 }) as i32 == 'e' as i32 || (unsafe { *cur_2 }) as i32 == 'E' as i32 {
                                cur_2 = unsafe { cur_2.offset(1) };
                                if (unsafe { *cur_2 }) as i32 == '-' as i32 || (unsafe { *cur_2 }) as i32 == '+' as i32 {
                                    cur_2 = unsafe { cur_2.offset(1) };
                                }
                                while (unsafe { *cur_2 }) as i32 >= '0' as i32 && (unsafe { *cur_2 }) as i32 <= '9' as i32 {
                                    cur_2 = unsafe { cur_2.offset(1) };
        ...
        15 => {
            ...
            if normOnTheFly != 0 {
                while (unsafe { *cur_3 }) as i32 == 0x20 as i32
                    || 0x9 as i32 <= (unsafe { *cur_3 }) as i32 && (unsafe { *cur_3 }) as i32 <= 0xa as i32
                ...
                _ => {
                        ...
                        && (unsafe { (*node).type_0 }) as u32 == XML_ATTRIBUTE_NODE as i32 as u32
                    {
                        ...
                        if (unsafe { (*attr).atype }) as u32 != XML_ATTRIBUTE_ID as i32 as u32 {
                            ...
                            if !strip.is_null() {
                                res = xmlAddID(0 as xmlValidCtxtPtr, unsafe { (*node).doc }, strip, attr);
                                (unsafe { xmlFree.expect("non-null function pointer")(
                                    strip as *mut libc::c_void,
                                ) });
                            } else {
                                res = xmlAddID(0 as xmlValidCtxtPtr, unsafe { (*node).doc }, value, attr);
                            }
                            if res.is_null() {
                                ret = 2 as i32;
                            } else {
            ...
            match current_block {
                ...
                _ => {
                        ...
                        && (unsafe { (*node).type_0 }) as u32 == XML_ATTRIBUTE_NODE as i32 as u32
                    {
                        ...
                        if !strip_0.is_null() {
                            xmlAddRef(0 as xmlValidCtxtPtr, unsafe { (*node).doc }, strip_0, attr_0);
                            (unsafe { xmlFree.expect("non-null function pointer")(
                                strip_0 as *mut libc::c_void,
                            ) });
                        } else {
                            xmlAddRef(0 as xmlValidCtxtPtr, unsafe { (*node).doc }, value, attr_0);
                        }
        ...
        26 => {
            ...
            if ret == 0 as i32 {
                ...
                if !strip_1.is_null() {
                    ...
                    (unsafe { xmlFree.expect("non-null function pointer")(strip_1 as *mut libc::c_void) });
                } else {
                    ent = unsafe { xmlGetDocEntity((*node).doc, value) };
                }
                if ent.is_null()
                    || (unsafe { (*ent).etype }) as u32 != XML_EXTERNAL_GENERAL_UNPARSED_ENTITY as i32 as u32
                {
                    ret = 4 as i32;
                }
            }
        ...
        28 => {
            ...
            if ret == 0 as i32 && !node.is_null() {
                ...
                if !local_0.is_null() && (borrow(&val).is_none() || ret != 0 as i32) {
                    (unsafe { xmlFree.expect("non-null function pointer")(local_0 as *mut libc::c_void) });
                }
                if !prefix_0.is_null() {
                    (unsafe { xmlFree.expect("non-null function pointer")(prefix_0 as *mut libc::c_void) });
                }
            }
            if node.is_null() || (unsafe { (*node).doc }).is_null() {
                ret = 3 as i32;
            ...
            if ret == 0 as i32 && !borrow(&val).is_none() {
                ...
                if !v.is_null() {
                    ...
                    *(borrow_mut(&mut val)).unwrap() = v;
                    ...
                    if !uri_0.is_null() {
                        (unsafe { xmlFree.expect("non-null function pointer")(uri_0 as *mut libc::c_void) });
                    }
                    current_block = 8144989253473847324;
                }
            } else {
        ...
        29 => {
            if (unsafe { *value }) as i32 != 0 as i32 {
                ...
                (unsafe { xmlFree.expect("non-null function pointer")(tmpval as *mut libc::c_void) });
                if uri_1.is_null() {
                    current_block = 16644619750446575830;
                } else {
                    xmlFreeURI(uri_1);
            ...
            if cur_6.is_null() {
                ...
                if normOnTheFly != 0 {
                    while (unsafe { *cur_6 }) as i32 == 0x20 as i32
                        || 0x9 as i32 <= (unsafe { *cur_6 }) as i32 && (unsafe { *cur_6 }) as i32 <= 0xa as i32
                ...
                start_0 = cur_6;
                while (unsafe { *cur_6 }) as i32 >= '0' as i32 && (unsafe { *cur_6 }) as i32 <= '9' as i32
                    || (unsafe { *cur_6 }) as i32 >= 'A' as i32 && (unsafe { *cur_6 }) as i32 <= 'F' as i32
                    || (unsafe { *cur_6 }) as i32 >= 'a' as i32 && (unsafe { *cur_6 }) as i32 <= 'f' as i32
                {
                    i += 1;
                    cur_6 = unsafe { cur_6.offset(1) };
                ...
                if (unsafe { *cur_6 }) as i32 != 0 as i32 {
                    ...
                    if v.is_null() {
                        ...
                        if cur_6.is_null() {
                            ...
                            (unsafe { xmlFree.expect("non-null function pointer")(v as *mut libc::c_void) });
                            current_block = 16644619750446575830;
                        } else {
                            total = i / 2 as i32;
                            ...
                            loop {
                                ...
                                if (unsafe { *base }) as i32 >= 'a' as i32 {
                                    (unsafe { *base = (*base as i32 - ('a' as i32 - 'A' as i32)) as xmlChar });
                                }
                            ...
                            _ => {
                                if !borrow(&val).is_none() {
                                    ...
                                    if v.is_null() {
                                        ...
                                        base_0 = (unsafe { xmlMallocAtomic.expect("non-null function pointer")(
                                        ...
                                        if base_0.is_null() {
                                            ...
                                            let fresh65 = unsafe { &mut ((*v).value.base64.str_0) };
                                            *fresh65 = base_0;
                                            cur_7 = value;
                                            while (unsafe { *cur_7 }) != 0 {
                                                if _xmlSchemaBase64Decode(unsafe { *cur_7 }) >= 0 as i32 {
                                                    (unsafe { *base_0 = *cur_7 });
            ...
            if cur_8.is_null() {
                ...
                if normOnTheFly != 0 {
                    while (unsafe { *cur_8 }) as i32 == 0x20 as i32
                        || 0x9 as i32 <= (unsafe { *cur_8 }) as i32 && (unsafe { *cur_8 }) as i32 <= 0xa as i32
            ...
            if cur_9.is_null() {
                ...
                if normOnTheFly != 0 {
                    while (unsafe { *cur_9 }) as i32 == 0x20 as i32
                        || 0x9 as i32 <= (unsafe { *cur_9 }) as i32 && (unsafe { *cur_9 }) as i32 <= 0xa as i32
            ...
            if cur_10.is_null() {
                ...
                if normOnTheFly != 0 {
                    while (unsafe { *cur_10 }) as i32 == 0x20 as i32
                        || 0x9 as i32 <= (unsafe { *cur_10 }) as i32 && (unsafe { *cur_10 }) as i32 <= 0xa as i32
...
extern "C" fn xmlSchemaCompareDecimals(
    ...
    integx = (unsafe { ((*x).value.decimal).total() }) as i32 - (unsafe { ((*x).value.decimal).frac() }) as i32;
    integy = (unsafe { ((*y).value.decimal).total() }) as i32 - (unsafe { ((*y).value.decimal).frac() }) as i32;
    if integx == 1 as i32 {
    ...
    dlen = (unsafe { ((*x).value.decimal).total() }) as i32 - (unsafe { ((*y).value.decimal).total() }) as i32;
    if dlen < 0 as i32 {
        swp = x;
...
extern "C" fn xmlSchemaDupVal(
    ...
    let mut ret: *mut crate::src::xmlschemastypes::_xmlSchemaVal = xmlSchemaNewValue(unsafe { (*v).type_0 });
    if ret.is_null() {
        return 0 as xmlSchemaValPtr;
    }
    (unsafe { memcpy(
...
extern "C" fn _xmlSchemaDateAdd(
    ...
    carry = (unsafe { floor((carry - 1 as i32 as i64) as f64 / (13 as i32 - 1 as i32) as f64) }) as i64;
    ...
    carry = (unsafe { floor((*(borrow(&r)).unwrap()).sec as i64 as f64 / 60 as i32 as f64) }) as i64;
    if (*(borrow(&r)).unwrap()).sec != 0.0f64 {
        (*(borrow_mut(&mut r)).unwrap()).sec =
            (*(borrow(&r)).unwrap()).sec - (unsafe { floor((*(borrow(&r)).unwrap()).sec / 60.0f64) }) * 60.0f64;
    }
    carry += (*(borrow(&d)).unwrap()).min() as i64;
    (*(borrow_mut(&mut r)).unwrap())
        .set_min((carry as f64 - (unsafe { floor(carry as f64 / 60 as i32 as f64) }) * 60 as i32 as f64) as u32);
    carry = (unsafe { floor(carry as f64 / 60 as i32 as f64) }) as i64;
    carry += (*(borrow(&d)).unwrap()).hour() as i64;
    (*(borrow_mut(&mut r)).unwrap()).set_hour(
        (carry as f64 - (unsafe { floor(carry as f64 / 24 as i32 as f64) }) * 24 as i32 as f64) as u32,
    );
    ...
    if (*(borrow(&r)).unwrap()).year != 0 as i32 as i64
        ...
        && (*(borrow(&d)).unwrap()).day()
            ...
            {
                unsafe { daysInMonthLeap[((*(borrow(&r)).unwrap()).mon() as i32 - 1 as i32) as usize] }
            } else {
    ...
    loop {
        ...
        (*(borrow_mut(&mut r)).unwrap()).year = (*(borrow(&r)).unwrap()).year
            + (unsafe { floor((temp - 1 as i32 as i64) as f64 / (13 as i32 - 1 as i32) as f64) }) as i64;
        if (*(borrow(&r)).unwrap()).year == 0 as i32 as i64 {
...
extern "C" fn xmlSchemaCompareDates(
    ...
    if (unsafe { (*x).value.date.year }) > 9223372036854775807 as i64 / 366 as i32 as i64
        || (unsafe { (*x).value.date.year }) < (-(9223372036854775807 as i64) - 1 as i64) / 366 as i32 as i64
        || (unsafe { (*y).value.date.year }) > 9223372036854775807 as i64 / 366 as i32 as i64
        || (unsafe { (*y).value.date.year }) < (-(9223372036854775807 as i64) - 1 as i64) / 366 as i32 as i64
    {
        return -(2 as i32);
    }
            ...
            if p1d < q1d {
                ...
                if p1d == q1d {
                    ...
                    if sec < 0.0f64 {
                        ...
                        q2d = _xmlSchemaDateCastYMToDays(q2) + (unsafe { ((*q2).value.date).day() }) as i64;
                        if p1d > q2d {
                            ret = 1 as i32;
                        } else if p1d == q2d {
                            sec = ((unsafe { ((*p1).value.date).hour() }) as i32 * (60 as i32 * 60 as i32)
                                ...
                                as f64
                                + (unsafe { (*p1).value.date.sec })
                                - (((unsafe { ((*q2).value.date).hour() }) as i32 * (60 as i32 * 60 as i32)
        ...
        if p1d < q1d {
            ...
            if p1d == q1d {
                ...
                if sec_0 < 0.0f64 {
                    ...
                    p2d = _xmlSchemaDateCastYMToDays(p2) + (unsafe { ((*p2).value.date).day() }) as i64;
                    if p2d > q1d {
                        ret_0 = 1 as i32;
                    } else if p2d == q1d {
                        sec_0 = ((unsafe { ((*p2).value.date).hour() }) as i32 * (60 as i32 * 60 as i32)
    ...
    if xor_mask as i32 & 2 as i32 != 0 {
        ...
        if and_mask as i32 & 2 as i32 != 0 {
            if ((unsafe { ((*x).value.date).mon() }) as i32) < (unsafe { ((*y).value.date).mon() }) as i32 {
                return -(1 as i32);
            } else {
                if (unsafe { ((*x).value.date).mon() }) as i32 > (unsafe { ((*y).value.date).mon() }) as i32 {
                    return 1 as i32;
    ...
    if xor_mask as i32 & 4 as i32 != 0 {
        ...
        if and_mask as i32 & 4 as i32 != 0 {
            if ((unsafe { ((*x).value.date).day() }) as i32) < (unsafe { ((*y).value.date).day() }) as i32 {
                return -(1 as i32);
            } else {
                if (unsafe { ((*x).value.date).day() }) as i32 > (unsafe { ((*y).value.date).day() }) as i32 {
                    return 1 as i32;
    ...
    if xor_mask as i32 & 8 as i32 != 0 {
        ...
        if and_mask as i32 & 8 as i32 != 0 {
            if ((unsafe { ((*x).value.date).hour() }) as i32) < (unsafe { ((*y).value.date).hour() }) as i32 {
                return -(1 as i32);
            } else {
                if (unsafe { ((*x).value.date).hour() }) as i32 > (unsafe { ((*y).value.date).hour() }) as i32 {
                    return 1 as i32;
                } else {
                    if ((unsafe { ((*x).value.date).min() }) as i32) < (unsafe { ((*y).value.date).min() }) as i32 {
                        return -(1 as i32);
                    } else {
                        if (unsafe { ((*x).value.date).min() }) as i32 > (unsafe { ((*y).value.date).min() }) as i32 {
                            return 1 as i32;
...
extern "C" fn xmlSchemaComparePreserveReplaceStrings(
    ...
    while (unsafe { *x }) as i32 != 0 as i32 && (unsafe { *y }) as i32 != 0 as i32 {
        if (unsafe { *y }) as i32 == 0x9 as i32 || (unsafe { *y }) as i32 == 0xa as i32 || (unsafe { *y }) as i32 == 0xd as i32 {
...
extern "C" fn xmlSchemaCompareValuesInternal(
    ...
    match xtype as u32 {
        ...
        21 | 28 => {
            ...
            {
                if xmlStrEqual(unsafe { (*x).value.qname.name }, unsafe { (*y).value.qname.name }) != 0
                    && xmlStrEqual(unsafe { (*x).value.qname.uri }, unsafe { (*y).value.qname.uri }) != 0
                {
                    return 0 as i32;
                }
                return 2 as i32;
        ...
        43 => {
            ...
            if ytype as u32 == XML_SCHEMAS_HEXBINARY as i32 as u32 {
                if (unsafe { (*x).value.hex.total }) == (unsafe { (*y).value.hex.total }) {
                    let mut ret: i32 = xmlStrcmp(unsafe { (*x).value.hex.str_0 }, unsafe { (*y).value.hex.str_0 });
                    if ret > 0 as i32 {
                        return 1 as i32;
                    } else {
                        if ret == 0 as i32 {
        ...
        44 => {
            ...
            if ytype as u32 == XML_SCHEMAS_BASE64BINARY as i32 as u32 {
                if (unsafe { (*x).value.base64.total }) == (unsafe { (*y).value.base64.total }) {
                    let mut ret_0: i32 =
                        xmlStrcmp(unsafe { (*x).value.base64.str_0 }, unsafe { (*y).value.base64.str_0 });
                    if ret_0 > 0 as i32 {
                        return 1 as i32;
                ...
                } else if (unsafe { (*x).value.base64.total }) > (unsafe { (*y).value.base64.total }) {
                    return 1 as i32;
                } else {
                    return -(1 as i32);
                }
        ...
        if (unsafe { *utf.offset(0 as i32 as isize) }) as i32 & 0x80 as i32 != 0 {
            ...
            if (unsafe { *utf.offset(0 as i32 as isize) }) as i32 & 0xe0 as i32 == 0xe0 as i32 {
                ...
                if (unsafe { *utf.offset(0 as i32 as isize) }) as i32 & 0xf0 as i32 == 0xf0 as i32 {
                    if (unsafe { *utf.offset(0 as i32 as isize) }) as i32 & 0xf8 as i32 != 0xf0 as i32
                        || (unsafe { *utf.offset(3 as i32 as isize) }) as i32 & 0xc0 as i32 != 0x80 as i32
                    {
                        return -(1 as i32);
                    }
    ...
    if (unsafe { (*facet).type_0 }) as u32 == XML_SCHEMA_FACET_LENGTH as i32 as u32 {
        if actualLen != (unsafe { (*(*facet).val).value.decimal.lo }) {
            if !borrow(&expectedLen).is_none() {
                *(borrow_mut(&mut expectedLen)).unwrap() = unsafe { (*(*facet).val).value.decimal.lo };
            }
...
extern "C" fn xmlSchemaValidateLengthFacetInternal<'a1, 'a2>(
    ...
    *(borrow_mut(&mut length)).unwrap() = 0 as i32 as u64;
    ...
    } else if !val.is_null() && (unsafe { (*val).type_0 }) as u32 == XML_SCHEMAS_BASE64BINARY as i32 as u32 {
...
extern "C" fn xmlSchemaValidateFacetInternal<'a1>(
    ...
    match (unsafe { (*facet).type_0 }) as u32 {
        ...
        1007 => {
            if ws as u32 == XML_SCHEMA_WHITESPACE_UNKNOWN as i32 as u32 {
                if !(unsafe { (*facet).value }).is_null() && xmlStrEqual(unsafe { (*facet).value }, value) != 0 {
                    return 0 as i32;
                }
            } else {
        ...
        1004 | 1005 => {
            ...
            if (unsafe { (*facet).type_0 }) as u32 == XML_SCHEMA_FACET_TOTALDIGITS as i32 as u32 {
                if (unsafe { ((*val).value.decimal).total() }) as u64 > (unsafe { (*(*facet).val).value.decimal.lo }) {
                    return XML_SCHEMAV_CVC_TOTALDIGITS_VALID as i32;
                }
            } else if (unsafe { (*facet).type_0 }) as u32 == XML_SCHEMA_FACET_FRACTIONDIGITS as i32 as u32 {
                if (unsafe { ((*val).value.decimal).frac() }) as u64 > (unsafe { (*(*facet).val).value.decimal.lo }) {
    ...
    *(borrow_mut(&mut retValue)).unwrap() = 0 as *const xmlChar;
    match (unsafe { (*val).type_0 }) as u32 {
        ...
        16 | 17 | 18 | 20 | 22 | 23 | 24 | 26 | 28 | 29 => {
            ...
            *(borrow_mut(&mut retValue)).unwrap() = xmlSchemaCollapseString(unsafe { (*val).value.str_0 });
            if (*(borrow(&retValue)).unwrap()).is_null() {
                *(borrow_mut(&mut retValue)).unwrap() =
                    xmlStrdup((unsafe { (*val).value.str_0 }) as *const xmlChar);
            }
        ...
        21 => {
            if (unsafe { (*val).value.qname.uri }).is_null() {
                *(borrow_mut(&mut retValue)).unwrap() = xmlStrdup(unsafe { (*val).value.qname.name });
                return 0 as i32;
            } else {
                *(borrow_mut(&mut retValue)).unwrap() =
                    xmlStrdup(b"{\0" as *const u8 as *const i8 as *mut xmlChar);
        ...
        3 => {
                ...
                && (unsafe { (*val).value.decimal.lo }) == 0 as i32 as u64
            {
                *(borrow_mut(&mut retValue)).unwrap() =
                ...
                buf = (unsafe { xmlMalloc.expect("non-null function pointer")(bufsize as size_t) }) as *mut i8;
                if buf.is_null() {
                    return -(1 as i32);
                }
                offs = buf;
        ...
        12 => {
            ...
            left = (unsafe { fabs((*val).value.dur.sec) }) - day.wrapping_mul(86400 as i32 as u64) as f64;
            ...
            if (unsafe { (*val).value.dur.mon }) < 0 as i32 as i64 || (unsafe { (*val).value.dur.sec }) < 0 as i32 as f64 {
                (unsafe { snprintf(
                    buf_0.as_mut_ptr(),
                    100 as i32 as u64,
        ...
        6 => {
            *(borrow_mut(&mut retValue)).unwrap() =
                (unsafe { xmlMalloc.expect("non-null function pointer")(6 as i32 as size_t) }) as *const xmlChar;
            if (*(borrow_mut(&mut retValue)).unwrap()).is_null() {
                return -(1 as i32);
            }
            (unsafe { snprintf(
        ...
        7 => {
            *(borrow_mut(&mut retValue)).unwrap() =
                (unsafe { xmlMalloc.expect("non-null function pointer")(8 as i32 as size_t) }) as *const xmlChar;
            if (*(borrow_mut(&mut retValue)).unwrap()).is_null() {
                return -(1 as i32);
            }
            (unsafe { snprintf(
        ...
        44 => {
            *(borrow_mut(&mut retValue)).unwrap() = xmlStrdup(unsafe { (*val).value.base64.str_0 });
        },
        13 => {
