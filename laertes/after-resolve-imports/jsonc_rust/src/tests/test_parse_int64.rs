...
pub unsafe extern "C" fn checkit(mut buf: *const i8) {
    let mut cint64: int64_t = -(666 as i32) as int64_t;
    let mut retval: i32 = json_parse_int64(buf, &mut cint64);
    printf(
...
pub unsafe extern "C" fn checkit_uint(mut buf: *const i8) {
    let mut cuint64: uint64_t = 666 as i32 as uint64_t;
    let mut retval: i32 = json_parse_uint64(buf, &mut cuint64);
    printf(
