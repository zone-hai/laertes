...
unsafe fn main_0(
    ...
    let mut int1: *mut json_object = json_object_new_int(0 as i32);
    let mut int2: *mut json_object = json_object_new_int(1 as i32);
    let mut int3: *mut json_object = json_object_new_int(1 as i32);
    let mut int4: *mut json_object = json_object_new_int(-(1 as i32));
    ...
    let mut int5: *mut json_object = json_object_new_int(0 as i32);
