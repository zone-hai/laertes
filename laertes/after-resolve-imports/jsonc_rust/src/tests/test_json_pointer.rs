...
unsafe extern "C" fn test_example_int(
    ...
    if 0 as i32 == json_pointer_get(jo1, json_pointer, &mut jo2) {} else {
        __assert_fail(
...
unsafe extern "C" fn test_example_get() {
    ...
    if 0 as i32
        == json_pointer_get(jo1, b"\0" as *const u8 as *const i8, &mut jo2)
    {} else {
        __assert_fail(
    ...
    if 0 as i32
        == json_pointer_get(jo1, b"/foo\0" as *const u8 as *const i8, &mut jo2)
    {} else {
        __assert_fail(
...
unsafe extern "C" fn test_wrong_inputs_get() {
    ...
    *__errno_location() = 0 as i32;
    if 0 as i32
        != json_pointer_get(jo1, 0 as *const i8, 0 as *mut *mut json_object)
    {} else {
        __assert_fail(
    ...
    *__errno_location() = 0 as i32;
    if 0 as i32
        != json_pointer_getf(jo1, 0 as *mut *mut json_object, 0 as *const i8)
    {} else {
        __assert_fail(
...
unsafe extern "C" fn test_wrong_inputs_set() {
    ...
    if 0 as i32
        != json_pointer_set(&mut jo1, 0 as *const i8, 0 as *mut json_object)
    {} else {
        __assert_fail(
    ...
    jo2 = json_object_new_string(b"cod\0" as *const u8 as *const i8);
    if 0 as i32
        != json_pointer_set(&mut jo1, b"0\0" as *const u8 as *const i8, jo2)
    {} else {
        __assert_fail(
