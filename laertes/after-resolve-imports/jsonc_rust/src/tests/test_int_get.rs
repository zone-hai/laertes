...
unsafe fn main_0(
    ...
    let mut jtmp: *mut json_object = json_object_new_int(5 as i32);
    *__errno_location() = 0 as i32;
    ...
    let mut jtmp_0: *mut json_object = json_object_new_int(5 as i32);
    *__errno_location() = 0 as i32;
    ...
    let mut jtmp_1: *mut json_object = json_object_new_int(5 as i32);
    *__errno_location() = 0 as i32;
    ...
    let mut jtmp_2: *mut json_object = json_object_new_int(0 as i32);
    *__errno_location() = 0 as i32;
    ...
    let mut jtmp_3: *mut json_object = json_object_new_int(0 as i32);
    *__errno_location() = 0 as i32;
    ...
    let mut jtmp_4: *mut json_object = json_object_new_int(0 as i32);
    *__errno_location() = 0 as i32;
