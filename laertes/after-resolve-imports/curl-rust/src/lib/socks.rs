...
pub unsafe extern "C" fn Curl_SOCKS4(
    ...
    if !((*sx).state as u32 >= CONNECT_SOCKS_INIT as i32 as u32
        && ((*sx).state as u32) < CONNECT_DONE as i32 as u32)
        && !*done
    {
        socksstate(data, CONNECT_SOCKS_INIT);
    }
    let mut current_block_107: u64;
    match (*sx).state as u32 {
        1 => {
    ...
    match current_block_107 {
        10721739657148430059 => {
            *socksreq
            ...
            let mut packetsize: size_t = (9 as i32 as u64)
                .wrapping_add(
                    strlen(
            ...
            if protocol4a {
                let mut hostnamelen: size_t = 0 as i32 as size_t;
                *socksreq
                    .offset(
                        4 as i32 as isize,
                    ) = 0 as i32 as u8;
    ...
    match current_block_107 {
        4542371696367325799 => {
            result = Curl_write_plain(
                data,
                sockfd,
                (*sx).outp as *mut i8 as *const libc::c_void,
            ...
            (*sx).outstanding = 8 as i32 as ssize_t;
...
pub unsafe extern "C" fn Curl_SOCKS5(
    ...
    let mut conn: *mut connectdata = (*data).conn;
    let mut socksreq: *mut u8 = (*data).state.buffer as *mut u8;
    let mut dest: [i8; 256] = *::std::mem::transmute::<
        &[u8; 256],
        &mut [i8; 256],
    >(
    ...
    let mut len: ssize_t = 0 as i32 as ssize_t;
        ...
        1 => {
            ...
            *socksreq
            ...
            if written != idx as i64 {
                ...
                (*sx).outstanding = idx as i64 - written;
    ...
    match current_block_276 {
        3729150195017652645 => {
            (*sx).outstanding = 2 as i32 as ssize_t;
    ...
    match current_block_276 {
        1406533880978078420 => {
            ...
            (*sx).outstanding = 10 as i32 as ssize_t;
    ...
    match current_block_276 {
        17002506680330119909 => {
            ...
            if len > 10 as i32 as i64 {
                (*sx).outstanding = len - 10 as i32 as i64;
