...
pub unsafe extern "C" fn Curl_SOCKS4(
    ...
    match (*sx).state as u32 {
        ...
        10 => {
            ...
            if !dns.is_null() {
                let fresh0 = &mut ((*data).state.async_0.dns);
                *fresh0 = dns;
                let fresh1 = &mut ((*data).state.async_0);
    ...
    match current_block_107 {
        4542371696367325799 => {
            ...
            if written != (*sx).outstanding {
                let fresh3 = &mut ((*sx).outstanding);
                *fresh3 -= written;
                let fresh4 = &mut ((*sx).outp);
                *fresh4 = (*fresh4).offset(written as isize);
                return CURLPX_OK;
            }
            (*sx).outstanding = 8 as i32 as ssize_t;
            let fresh5 = &mut ((*sx).outp);
            *fresh5 = socksreq;
                ...
                && CURLE_AGAIN as i32 as u32 != result as u32
            {
                ...
                if result as u64 == 0 && actualread == 0 {
                    ...
                    if actualread != (*sx).outstanding {
                        let fresh6 = &mut ((*sx).outstanding);
                        *fresh6 -= actualread;
                        let fresh7 = &mut ((*sx).outp);
...
pub unsafe extern "C" fn Curl_SOCKS5(
    ...
    match (*sx).state as u32 {
        ...
        2 => {
            ...
            if written != (*sx).outstanding {
                let fresh13 = &mut ((*sx).outstanding);
                *fresh13 -= written;
                let fresh14 = &mut ((*sx).outp);
        ...
        10 => {
            ...
            if !dns.is_null() {
                let fresh27 = &mut ((*data).state.async_0.dns);
                *fresh27 = dns;
                let fresh28 = &mut ((*data).state.async_0);
    ...
    match current_block_276 {
        17113687173598995549 => {
                ...
                && CURLE_AGAIN as i32 as u32 != result as u32
            {
                ...
                let fresh16 = &mut ((*sx).outstanding);
                *fresh16 -= actualread;
                let fresh17 = &mut ((*sx).outp);
    ...
    match current_block_276 {
        2986675497777506938 => {
            ...
            if (*sx).outstanding != written {
                let fresh22 = &mut ((*sx).outstanding);
                *fresh22 -= written;
                let fresh23 = &mut ((*sx).outp);
                *fresh23 = (*fresh23).offset(written as isize);
                return CURLPX_OK;
            }
            let fresh24 = &mut ((*sx).outp);
            *fresh24 = socksreq;
            (*sx).outstanding = 2 as i32 as ssize_t;
        ...
        5249903830285462583 => {
                ...
                && CURLE_AGAIN as i32 as u32 != result as u32
            {
                ...
                if result as u64 == 0 && actualread == 0 {
                    ...
                    if actualread != (*sx).outstanding {
                        let fresh25 = &mut ((*sx).outstanding);
                        *fresh25 -= actualread;
                        let fresh26 = &mut ((*sx).outp);
    ...
    match current_block_276 {
        1406533880978078420 => {
            ...
            if (*sx).outstanding != written {
                let fresh44 = &mut ((*sx).outstanding);
                *fresh44 -= written;
                let fresh45 = &mut ((*sx).outp);
                *fresh45 = (*fresh45).offset(written as isize);
                return CURLPX_OK;
            }
            (*sx).outstanding = 10 as i32 as ssize_t;
            let fresh46 = &mut ((*sx).outp);
            *fresh46 = socksreq;
        ...
        17002506680330119909 => {
                ...
                && CURLE_AGAIN as i32 as u32 != result as u32
            {
                ...
                if result as u64 == 0 && actualread == 0 {
                    ...
                    if actualread != (*sx).outstanding {
                        let fresh47 = &mut ((*sx).outstanding);
                        *fresh47 -= actualread;
                        let fresh48 = &mut ((*sx).outp);
        ...
        5405868585544072297 => {
                ...
                && CURLE_AGAIN as i32 as u32 != result as u32
            {
                ...
                if result as u64 == 0 && actualread == 0 {
                    ...
                    if actualread != (*sx).outstanding {
                        let fresh50 = &mut ((*sx).outstanding);
                        *fresh50 -= actualread;
                        let fresh51 = &mut ((*sx).outp);
