...
unsafe extern "C" fn smb_connect(
    ...
    *fresh1 = Curl_cmalloc
    ...
    if !slash.is_null() {
        let fresh2 = &mut ((*smbc).user);
        *fresh2 = slash.offset(1 as i32 as isize);
        let fresh3 = &mut ((*smbc).domain);
        ...
        *((*smbc).domain)
        ...
        let fresh4 = &mut ((*smbc).user);
        *fresh4 = (*conn).user;
        let fresh5 = &mut ((*smbc).domain);
...
unsafe extern "C" fn smb_send_and_recv(
    ...
    *msg = 0 as *mut libc::c_void;
    if (*smbc).send_size == 0 && (*smbc).upload_size != 0 {
        ...
        let fresh8 = &mut ((*data).req.upload_fromhere);
        *fresh8 = (*data).state.ulbuf;
        ...
        let fresh9 = &mut ((*smbc).upload_size);
    ...
    match (*req).state as u32 {
                        ...
                        .wrapping_add(14 as i32 as u64)
            {
                ...
                match current_block_72 {
                    ...
                    _ => {
                        ...
                        *fresh10 += len as i64;
                        let fresh11 = &mut ((*data).req.offset);
                        *fresh11 += len as i64;
        ...
        4 => {
                        ...
                        .wrapping_add(6 as i32 as u64)
            {
                ...
                *fresh12 += len as i64;
                let fresh13 = &mut ((*data).req.offset);
                *fresh13 += len as i64;
...
unsafe extern "C" fn smb_done(
    ...
    let fresh14 = &mut ((*data).req.p.smb);
