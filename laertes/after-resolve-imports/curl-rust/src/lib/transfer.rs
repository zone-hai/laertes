...
pub unsafe extern "C" fn Curl_get_upload_buffer(mut data: *mut Curl_easy) -> CURLcode {
    if ((*data).state.ulbuf).is_null() {
        let fresh0 = &mut ((*data).state.ulbuf);
        *fresh0 = Curl_cmalloc
            .expect(
...
unsafe extern "C" fn trailers_read(
    ...
    if to_copy != 0 {
        ...
        let fresh1 = &mut ((*data).state.trailers_bytes_sent);
...
pub unsafe extern "C" fn Curl_fillreadbuffer(
            ...
            == TRAILERS_NONE as i32 as u32
    {
        ...
        let fresh2 = &mut ((*data).req.upload_fromhere);
    ...
    if nread == 0x10000001 as i32 as u64 {
        ...
        if ((*data).req).upload_chunky() != 0 {
            let fresh3 = &mut ((*data).req.upload_fromhere);
            *fresh3 = (*fresh3)
        ...
        && ((*data).req).upload_chunky() as i32 != 0
    {
            ...
            != TRAILERS_SENDING as i32 as u32
        {
            ...
            let fresh4 = &mut ((*data).req.upload_fromhere);
            ...
            && trailers_left(data as *mut libc::c_void) == 0
        {
            ...
            let fresh5 = &mut ((*data).set.trailer_data);
            *fresh5 = 0 as *mut libc::c_void;
            let fresh6 = &mut ((*data).set.trailer_callback);
            *fresh6 = None;
            let fresh7 = &mut ((*data).req);
...
unsafe extern "C" fn readwrite_upload(
    ...
    *didwhat |= (1 as i32) << 1 as i32;
    ...
    if 0 as i32 as i64 == (*k).upload_present {
        ...
        let fresh18 = &mut ((*k).upload_fromhere);
            ...
            _ => {
                    ...
                    && (*k).keepon & (1 as i32) << 5 as i32 != 0
                {
                            ...
                            || ((*data).set).crlf() as i32 != 0)
                    {
                                ...
                                *((*data).state.scratch)
                                ...
                                if ((*data).set).crlf() == 0 {
                                    if (*data).state.infilesize
                                        != -(1 as i32) as i64
                                    {
                                        let fresh21 = &mut ((*data).state.infilesize);
                                        *fresh21 += 1;
                                    }
                                }
                            } else {
                        ...
                        if si != nread {
                            nread = si;
                            let fresh22 = &mut ((*k).upload_fromhere);
    ...
    match current_block_91 {
        981995395831942902 => {
            ...
            if (*k).pendingheader != 0 {
                ...
                let fresh23 = &mut ((*k).pendingheader);
                *fresh23 -= n;
            ...
            if nbody != 0 {
                ...
                let fresh24 = &mut ((*k).writebytecount);
                *fresh24 += nbody;
            ...
            if (*k).upload_present != bytes_written {
                let fresh25 = &mut ((*k).upload_present);
                *fresh25 -= bytes_written;
                let fresh26 = &mut ((*k).upload_fromhere);
                *fresh26 = (*fresh26).offset(bytes_written as isize);
                ...
                let fresh27 = &mut ((*k).upload_fromhere);
...
pub unsafe extern "C" fn Curl_pretransfer(mut data: *mut Curl_easy) -> CURLcode {
    ...
    if ((*data).state).url_alloc() != 0 {
        ...
        let fresh30 = &mut ((*data).state.url);
        *fresh30 = 0 as *mut i8;
    ...
    *fresh34 = (*data).set.str_0[STRING_SET_URL as i32 as usize];
    ...
    let fresh39 = &mut ((*data).info.wouldredirect);
    *fresh39 = 0 as *mut i8;
    if (*data).state.httpreq as u32
    ...
    if !((*data).set.str_0[STRING_USERAGENT as i32 as usize]).is_null() {
        ...
        let fresh41 = &mut ((*data).state.aptr.uagent);
        *fresh41 = 0 as *mut i8;
        let fresh42 = &mut ((*data).state.aptr.uagent);
...
pub unsafe extern "C" fn Curl_follow(
    ...
    if type_0 as u32 == FOLLOW_REDIR as i32 as u32 {
            ...
            && (*data).state.followlocation >= (*data).set.maxredirs
        {
            ...
            let fresh43 = &mut ((*data).state);
            (*fresh43).set_this_is_a_follow(1 as i32 as bit);
            let fresh44 = &mut ((*data).state.followlocation);
            *fresh44 += 1;
            if ((*data).set).http_auto_referer() != 0 {
                ...
                if ((*data).state).referer_alloc() != 0 {
                    ...
                    let fresh45 = &mut ((*data).state.referer);
                    *fresh45 = 0 as *mut i8;
                ...
                let fresh47 = &mut ((*data).state.referer);
                *fresh47 = referer;
                let fresh48 = &mut ((*data).state);
    ...
    if type_0 as u32 == FOLLOW_FAKE as i32 as u32 {
        let fresh49 = &mut ((*data).info.wouldredirect);
        *fresh49 = newurl;
        if reachedmax {
            Curl_failf(
                data,
    ...
    if disallowport {
        let fresh50 = &mut ((*data).state);
        (*fresh50).set_allow_port(0 as i32 as bit);
    }
    if ((*data).state).url_alloc() != 0 {
        Curl_cfree
            .expect("non-null function pointer")((*data).state.url as *mut libc::c_void);
        let fresh51 = &mut ((*data).state.url);
        *fresh51 = 0 as *mut i8;
    }
    let fresh52 = &mut ((*data).state.url);
    *fresh52 = newurl;
...
pub unsafe extern "C" fn Curl_retry_request(
    ...
    *url = 0 as *mut i8;
            ...
            != RTSPREQ_RECEIVE as i32 as u32
    {
        ...
        let fresh55 = &mut ((*data).state);
        (*fresh55).set_refused_stream(0 as i32 as bit);
        retry = 1 as i32 != 0;
    }
    if retry {
        let fresh56 = &mut ((*data).state.retrycount);
        let fresh57 = *fresh56;
        *fresh56 = *fresh56 + 1;
        if fresh57 >= 5 as i32 {
            Curl_failf(
