...
unsafe extern "C" fn ainext(
    ...
    let fresh3 = &mut ((*conn).tempaddr[tempindex as usize]);
    *fresh3 = ai;
    return ai;
}
...
pub unsafe extern "C" fn Curl_persistconninfo(
    ...
    let fresh4 = &mut ((*data).info.conn_scheme);
...
unsafe extern "C" fn post_SOCKS(
    ...
    *connected = 1 as i32 != 0;
    ...
    let fresh5 = &mut ((*data).info.numconnects);
    *fresh5 += 1;
}
#[no_mangle]
...
pub unsafe extern "C" fn Curl_connecthost(
    ...
    let fresh9 = &mut ((*conn).tempaddr[1 as i32 as usize]);
    *fresh9 = (*remotehost).addr;
    let fresh10 = &mut ((*conn).tempaddr[0 as i32 as usize]);
    *fresh10 = *fresh9;
    let fresh11 = &mut ((*conn).tempsock[1 as i32 as usize]);
    *fresh11 = -(1 as i32);
