...
unsafe extern "C" fn AddHttpPost(
    ...
    if !post.is_null() {
        ...
        *fresh0 = name;
        ...
        let fresh1 = &mut ((*post).contents);
        *fresh1 = value;
        (*post).contentlen = contentslength;
        let fresh2 = &mut ((*post).buffer);
        *fresh2 = buffer;
        (*post).bufferlength = bufferlength as i64;
        let fresh3 = &mut ((*post).contenttype);
        *fresh3 = contenttype;
        let fresh4 = &mut ((*post).contentheader);
        *fresh4 = contentHeader;
        let fresh5 = &mut ((*post).showfilename);
        *fresh5 = showfilename;
        let fresh6 = &mut ((*post).userp);
    ...
    if !parent_post.is_null() {
        let fresh7 = &mut ((*post).more);
        *fresh7 = (*parent_post).more;
        let fresh8 = &mut ((*parent_post).more);
        *fresh8 = post;
    } else {
        if !(*last_post).is_null() {
            let fresh9 = &mut ((**last_post).next);
            *fresh9 = post;
        } else {
            *httppost = post;
        }
...
unsafe extern "C" fn AddFormInfo(
    ...
    if !form_info.is_null() {
        if !value.is_null() {
            let fresh10 = &mut ((*form_info).value);
            *fresh10 = value;
        }
        if !contenttype.is_null() {
            let fresh11 = &mut ((*form_info).contenttype);
            *fresh11 = contenttype;
        }
    ...
    if !parent_form_info.is_null() {
        let fresh12 = &mut ((*form_info).more);
        *fresh12 = (*parent_form_info).more;
        let fresh13 = &mut ((*parent_form_info).more);
        *fresh13 = form_info;
    }
    return form_info;
}
        ...
        match option as u32 {
            ...
            7 => {
                        ...
                        | (1 as i32) << 1 as i32) as i64 != 0
                {
                    ...
                    if !filename.is_null() {
                        let fresh16 = &mut ((*current_form).value);
            ...
            10 => {
                ...
                if !((*current_form).value).is_null() {
                    ...
                    let fresh17 = &mut ((*current_form).value);
            ...
            12 => {
                ...
                if !((*current_form).buffer).is_null() {
                    ...
                    if !buffer.is_null() {
                        let fresh18 = &mut ((*current_form).buffer);
                        *fresh18 = buffer;
                        let fresh19 = &mut ((*current_form).value);
                        *fresh19 = buffer;
                    } else {
                        return_value = CURL_FORMADD_NULL;
                    }
            ...
            19 => {
                ...
                if !((*current_form).userp).is_null() {
                    ...
                    if !userp.is_null() {
                        let fresh20 = &mut ((*current_form).userp);
                        *fresh20 = userp;
                        let fresh21 = &mut ((*current_form).value);
                        *fresh21 = userp;
                    } else {
                        return_value = CURL_FORMADD_NULL;
                    }
            ...
            14 => {
                ...
                if !((*current_form).contenttype).is_null() {
                    ...
                    let fresh22 = &mut ((*current_form).contenttype);
            ...
            15 => {
                ...
                if !((*current_form).contentheader).is_null() {
                    ...
                    let fresh23 = &mut ((*current_form).contentheader);
                    *fresh23 = list;
                }
                current_block_137 = 2704538829018177290;
            }
            16 | 11 => {
                ...
                if !((*current_form).showfilename).is_null() {
                    ...
                    let fresh24 = &mut ((*current_form).showfilename);
        ...
        match current_block_137 {
            14371220985979925773 => {
                if !((*current_form).name).is_null() {
                    ...
                    if !name.is_null() {
                        let fresh14 = &mut ((*current_form).name);
                        *fresh14 = name;
                    } else {
                        return_value = CURL_FORMADD_NULL;
                    }
            ...
            11213271726480235426 => {
                if !((*current_form).value).is_null() {
                    ...
                    if !value.is_null() {
                        let fresh15 = &mut ((*current_form).value);
                        *fresh15 = value;
                    } else {
                        return_value = CURL_FORMADD_NULL;
                    }
    ...
    if CURL_FORMADD_OK as i32 as u32 != return_value as u32 {
        ...
        while !ptr.is_null() {
            ...
            if (*ptr).contenttype_alloc {
                ...
                let fresh27 = &mut ((*ptr).contenttype);
                *fresh27 = 0 as *mut i8;
            ...
            if (*ptr).showfilename_alloc {
                ...
                let fresh28 = &mut ((*ptr).showfilename);
                *fresh28 = 0 as *mut i8;
        ...
        while !form.is_null() {
                        ...
                        & ((1 as i32) << 3 as i32) as i64 != 0
            {
                    ...
                    && ((*form).contenttype).is_null()
                {
                    ...
                    let fresh29 = &mut ((*form).contenttype);
        ...
        if CURL_FORMADD_OK as i32 as u32 != return_value as u32
        {
            ...
            while !ptr_0.is_null() {
                ...
                if (*ptr_0).contenttype_alloc {
                    ...
                    let fresh34 = &mut ((*ptr_0).contenttype);
                    *fresh34 = 0 as *mut i8;
                ...
                if (*ptr_0).showfilename_alloc {
                    ...
                    let fresh35 = &mut ((*ptr_0).showfilename);
                    *fresh35 = 0 as *mut i8;
