...
pub unsafe extern "C" fn Curl_initinfo(mut data: *mut Curl_easy) -> CURLcode {
    ...
    *fresh1 = 0 as *mut i8;
    ...
    let fresh2 = &mut ((*info).conn_scheme);
