...
unsafe extern "C" fn imap_perform_select(mut data: *mut Curl_easy) -> CURLcode {
    ...
    let fresh3 = &mut ((*imapc).mailbox);
    *fresh3 = 0 as *mut i8;
    Curl_cfree
        .expect(
            "non-null function pointer",
        )((*imapc).mailbox_uidvalidity as *mut libc::c_void);
    let fresh4 = &mut ((*imapc).mailbox_uidvalidity);
    *fresh4 = 0 as *mut i8;
...
unsafe extern "C" fn imap_perform_append(mut data: *mut Curl_easy) -> CURLcode {
        ...
        != MIMEKIND_NONE as i32 as u32
    {
        ...
        let fresh5 = &mut ((*data).state.fread_func);
        *fresh5 = ::std::mem::transmute::<
        ...
        let fresh6 = &mut ((*data).state.in_0);
        ...
        loop {
                ...
                ) == 0
            {
                ...
                if mechbit as i32 != 0 && llen == wordlen {
                    let fresh7 = &mut ((*imapc).sasl.authmechs);
...
unsafe extern "C" fn imap_state_select_resp(
    ...
    if imapcode == '*' as i32 {
        ...
        ) == 1 as i32
        {
            ...
            let fresh8 = &mut ((*imapc).mailbox_uidvalidity);
            *fresh8 = 0 as *mut i8;
            let fresh9 = &mut ((*imapc).mailbox_uidvalidity);
...
unsafe extern "C" fn imap_state_fetch_resp(
    ...
    if parsed {
        ...
        if !((*pp).cache).is_null() {
            ...
            let fresh11 = &mut ((*data).req.bytecount);
...
unsafe extern "C" fn imap_init(mut data: *mut Curl_easy) -> CURLcode {
    ...
    let fresh14 = &mut ((*data).req.p.imap);
...
unsafe extern "C" fn imap_connect(
    ...
    *done = 0 as i32 != 0;
    ...
    let fresh15 = &mut ((*pp).statemachine);
    *fresh15 = Some(
        imap_statemachine
            as unsafe extern "C" fn(*mut Curl_easy, *mut connectdata) -> CURLcode,
    );
    let fresh16 = &mut ((*pp).endofresp);
    *fresh16 = Some(
        imap_endofresp
            as unsafe extern "C" fn(
                *mut Curl_easy,
...
unsafe extern "C" fn imap_disconnect(
    ...
    Curl_cfree
        .expect("non-null function pointer")((*imapc).mailbox as *mut libc::c_void);
    let fresh26 = &mut ((*imapc).mailbox);
    *fresh26 = 0 as *mut i8;
    Curl_cfree
        .expect(
            "non-null function pointer",
        )((*imapc).mailbox_uidvalidity as *mut libc::c_void);
    let fresh27 = &mut ((*imapc).mailbox_uidvalidity);
    *fresh27 = 0 as *mut i8;
    return CURLE_OK;
}
...
unsafe extern "C" fn imap_parse_url_path(mut data: *mut Curl_easy) -> CURLcode {
    ...
    while *ptr as i32 == ';' as i32 {
        ...
        ) != 0 && ((*imap).uidvalidity).is_null()
        {
            ...
            let fresh31 = &mut ((*imap).uidvalidity);
            *fresh31 = value;
            value = 0 as *mut i8;
...
unsafe extern "C" fn imap_parse_custom_request(mut data: *mut Curl_easy) -> CURLcode {
    ...
    if !custom.is_null() {
        ...
        if result as u64 == 0 {
            ...
            if *params != 0 {
                let fresh36 = &mut ((*imap).custom_params);
