...
pub unsafe extern "C" fn curl_share_setopt(
    ...
    match option as u32 {
            ...
            match type_0 {
                ...
                4 => {
                    if ((*share).sslsession).is_null() {
                        ...
                        let fresh1 = &mut ((*share).sslsession);
                        *fresh1 = Curl_ccalloc
                            .expect(
                                "non-null function pointer",
                            )(
        ...
        2 => {
            ...
            match type_0 {
                ...
                4 => {
                    ...
                    let fresh3 = &mut ((*share).sslsession);
        ...
        4 => {
            ...
            let fresh5 = &mut ((*share).unlockfunc);
            *fresh5 = unlockfunc;
        }
        5 => {
            ptr = param.arg::<*mut libc::c_void>();
            let fresh6 = &mut ((*share).clientdata);
            *fresh6 = ptr;
        }
        _ => {
            res = CURLSHE_BAD_OPTION;
