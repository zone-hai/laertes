...
pub unsafe extern "C" fn Curl_pp_init(mut data: *mut Curl_easy, mut pp: *mut pingpong) {
    ...
    let fresh0 = &mut ((*pp).linestart_resp);
...
pub unsafe extern "C" fn Curl_pp_vsendf(
    ...
    if bytes_written != write_len as ssize_t {
        let fresh1 = &mut ((*pp).sendthis);
        *fresh1 = s;
        (*pp).sendsize = write_len;
        (*pp).sendleft = write_len.wrapping_sub(bytes_written as u64);
    } else {
        let fresh2 = &mut ((*pp).sendthis);
        *fresh2 = 0 as *mut i8;
        let fresh3 = &mut ((*pp).sendsize);
        ...
        && (keepon as i32 != 0 && result as u64 == 0)
    {
        ...
        if keepon {
            if gotbytes <= 0 as i32 as i64 {
                ...
                let fresh5 = &mut ((*data).req.headerbytecount);
                *fresh5 += gotbytes;
                let fresh6 = &mut ((*pp).nread_resp);
                *fresh6 = (*fresh6 as u64)
                    ...
                    if *ptr as i32 == '\n' as i32 {
                            ...
                            )(data, conn, (*pp).linestart_resp, perline as size_t, code)
                        {
                            ...
                            *buf.offset(n as isize) = 0 as i32 as i8;
                            keepon = 0 as i32 != 0;
                            let fresh7 = &mut ((*pp).linestart_resp);
                            ...
                            *size = (*pp).nread_resp;
                            ...
                            let fresh8 = &mut ((*pp).linestart_resp);
                ...
                if restart {
                    (*pp).nread_resp = 0 as i32 as size_t;
                    let fresh10 = &mut ((*pp).linestart_resp);
                    *fresh10 = buf;
                    ptr = *fresh10;
                    perline = 0 as i32 as ssize_t;
                }
