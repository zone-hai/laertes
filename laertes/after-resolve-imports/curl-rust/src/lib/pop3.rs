                ...
                as i32 == '>' as i32
        {
            ...
            while i < len.wrapping_sub(2 as i32 as u64) {
                if *line.offset(i as isize) as i32 == '<' as i32 {
                    ...
                    let fresh3 = &mut ((*pop3c).apoptimestamp);
                    *fresh3 = Curl_ccalloc
                        .expect(
                    ...
                    *((*pop3c).apoptimestamp)
                    ...
                    if at.is_null() {
                        ...
                        let fresh4 = &mut ((*pop3c).apoptimestamp);
                        *fresh4 = 0 as *mut i8;
                    } else {
                        (*pop3c).authtypes
            ...
            ) == 0
        {
            ...
            loop {
                ...
                if mechbit as i32 != 0 && llen == wordlen {
                    let fresh5 = &mut ((*pop3c).sasl.authmechs);
...
unsafe extern "C" fn pop3_init(mut data: *mut Curl_easy) -> CURLcode {
    ...
    let fresh7 = &mut ((*data).req.p.pop3);
    *fresh7 = Curl_ccalloc
        .expect(
            "non-null function pointer",
...
unsafe extern "C" fn pop3_connect(
    ...
    *done = 0 as i32 != 0;
    ...
    let fresh8 = &mut ((*pp).statemachine);
    *fresh8 = Some(
        pop3_statemachine
            as unsafe extern "C" fn(*mut Curl_easy, *mut connectdata) -> CURLcode,
    );
    let fresh9 = &mut ((*pp).endofresp);
    *fresh9 = Some(
        pop3_endofresp
            as unsafe extern "C" fn(
                *mut Curl_easy,
...
unsafe extern "C" fn pop3_disconnect(
    ...
    let fresh12 = &mut ((*pop3c).apoptimestamp);
    *fresh12 = 0 as *mut i8;
    return CURLE_OK;
}
