...
pub type HMAC_hfinal_func = Option::<
    unsafe extern "C" fn(*mut u8, *mut libc::c_void) -> (),
>;
pub type HMAC_hupdate_func = Option::<
    unsafe extern "C" fn(*mut libc::c_void, *const u8, u32) -> (),
>;
...
pub unsafe extern "C" fn Curl_ntlm_core_mk_lm_hash(
    ...
    let mut len: size_t = if strlen(password) < 14 as i32 as u64 {
        strlen(password)
    } else {
        14 as i32 as u64
    };
...
unsafe extern "C" fn time2filetime(mut ft: *mut ms_filetime, mut t: time_t) {
    ...
    (*ft)
        ...
        as u32;
    (*ft).dwHighDateTime = (t >> 32 as i32) as u32;
}
#[no_mangle]
...
pub unsafe extern "C" fn Curl_ntlm_core_mk_ntlmv2_resp(
    ...
    mut ntresp: *mut *mut u8,
    mut ntresp_len: *mut u32,
) -> CURLcode {
    ...
    curl_msnprintf(
        ...
        (*::std::mem::transmute::<
            &[u8; 5],
            &[i8; 5],
        >(b"\x01\x01\0\0\0"))[0 as i32 as usize] as i32,
        (*::std::mem::transmute::<
            &[u8; 5],
            &[i8; 5],
        >(b"\x01\x01\0\0\0"))[1 as i32 as usize] as i32,
        (*::std::mem::transmute::<
            &[u8; 5],
            &[i8; 5],
        >(b"\x01\x01\0\0\0"))[2 as i32 as usize] as i32,
        (*::std::mem::transmute::<
            &[u8; 5],
            &[i8; 5],
        >(b"\x01\x01\0\0\0"))[3 as i32 as usize] as i32,
        0 as i32,
        0 as i32,
        0 as i32,
        0 as i32,
