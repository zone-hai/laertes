        ...
        *hostname = ptr;
        ...
        if ccode as u64 != 0 {
            ...
            match current_block {
                ...
                _ => {
                    if !passwdp.is_null() {
                        let fresh9 = &mut ((*u).password);
                        *fresh9 = passwdp;
                    }
                    if !optionsp.is_null() {
                        let fresh10 = &mut ((*u).options);
                        *fresh10 = optionsp;
                    }
                    return CURLUE_OK;
                }
...
unsafe extern "C" fn seturl(
    ...
    *hostname.offset(0 as i32 as isize) = 0 as i32 as i8;
        ...
        if flags & ((1 as i32) << 4 as i32) as u32 == 0 {
            ...
            if strcmp(newp_0, path) != 0 {
                if path_alloced {
                    ...
                    let fresh24 = &mut ((*u).temppath);
                    *fresh24 = 0 as *mut i8;
                }
                path = newp_0;
                let fresh25 = &mut ((*u).temppath);
                *fresh25 = path;
                path_alloced = 1 as i32 != 0;
            } else {
                Curl_cfree
    ...
    Curl_cfree.expect("non-null function pointer")((*u).scratch as *mut libc::c_void);
    let fresh31 = &mut ((*u).scratch);
    *fresh31 = 0 as *mut i8;
    Curl_cfree.expect("non-null function pointer")((*u).temppath as *mut libc::c_void);
    let fresh32 = &mut ((*u).temppath);
    *fresh32 = 0 as *mut i8;
    return CURLUE_OK;
}
