...
unsafe extern "C" fn bundle_create(mut bundlep: *mut *mut connectbundle) -> CURLcode {
    *bundlep = Curl_cmalloc
    ...
    (**bundlep).num_connections = 0 as i32 as size_t;
    (**bundlep).multiuse = 0 as i32;
    Curl_llist_init(
...
pub unsafe extern "C" fn Curl_conncache_extract_bundle(
    ...
    let mut curr: *mut Curl_llist_element = 0 as *mut Curl_llist_element;
    let mut highscore: timediff_t = -(1 as i32) as timediff_t;
...
pub unsafe extern "C" fn Curl_conncache_close_all_connections(
    ...
    *fresh14 = buffer.as_mut_ptr();
    (*(*connc).closure_handle).set.buffer_size = 1024 as i32 as i64;
    ...
    while !conn.is_null() {
        ...
        Curl_conncache_remove_conn((*connc).closure_handle, conn, 1 as i32 != 0);
        Curl_disconnect((*connc).closure_handle, conn, 0 as i32 != 0);
