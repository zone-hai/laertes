...
pub struct Curl_ssl {
    ...
    pub data_pending: Option::<
        unsafe extern "C" fn(*const connectdata, i32) -> bool,
    >,
    pub random: Option::<
        unsafe extern "C" fn(*mut Curl_easy, *mut u8, size_t) -> CURLcode,
    >,
    pub cert_status_request: Option::<unsafe extern "C" fn() -> bool>,
    pub connect_blocking: Option::<
        unsafe extern "C" fn(*mut Curl_easy, *mut connectdata, i32) -> CURLcode,
    >,
    ...
    >,
    pub getsock: Option::<
        unsafe extern "C" fn(*mut connectdata, *mut curl_socket_t) -> i32,
    >,
    pub get_internals: Option::<
        unsafe extern "C" fn(*mut ssl_connect_data, CURLINFO) -> *mut libc::c_void,
    >,
    pub close_one: Option::<
        unsafe extern "C" fn(*mut Curl_easy, *mut connectdata, i32) -> (),
    >,
    ...
    pub set_engine: Option::<
        unsafe extern "C" fn(*mut Curl_easy, *const i8) -> CURLcode,
    >,
    ...
    pub disassociate_connection: Option::<
        unsafe extern "C" fn(*mut Curl_easy, i32) -> (),
    >,
}
#[derive(Copy, Clone)]
#[repr(C)]
...
pub unsafe extern "C" fn Curl_initinfo(mut data: *mut Curl_easy) -> CURLcode {
    ...
    (*pro).t_nslookup = 0 as i32 as timediff_t;
    (*pro).t_connect = 0 as i32 as timediff_t;
    (*pro).t_appconnect = 0 as i32 as timediff_t;
    (*pro).t_pretransfer = 0 as i32 as timediff_t;
    (*pro).t_starttransfer = 0 as i32 as timediff_t;
    (*pro).timespent = 0 as i32 as timediff_t;
    (*pro).t_redirect = 0 as i32 as timediff_t;
    (*pro).set_is_t_startransfer_set(0 as i32 as bit);
    (*info).httpcode = 0 as i32;
    (*info).httpproxycode = 0 as i32;
    (*info).httpversion = 0 as i32;
    (*info).filetime = -(1 as i32) as time_t;
    (*info).set_timecond(0 as i32 as bit);
    (*info).header_size = 0 as i32 as curl_off_t;
    (*info).request_size = 0 as i32 as curl_off_t;
    (*info).proxyauthavail = 0 as i32 as u64;
    (*info).httpauthavail = 0 as i32 as u64;
    (*info).numconnects = 0 as i32 as i64;
    Curl_cfree
    ...
    *fresh1 = 0 as *mut i8;
    (*info).conn_primary_ip[0 as i32 as usize] = '\u{0}' as i32 as i8;
    (*info).conn_local_ip[0 as i32 as usize] = '\u{0}' as i32 as i8;
    (*info).conn_primary_port = 0 as i32;
    (*info).conn_local_port = 0 as i32;
    (*info).retry_after = 0 as i32 as curl_off_t;
    let ref mut fresh2 = (*info).conn_scheme;
    *fresh2 = 0 as *const i8;
    (*info).conn_protocol = 0 as i32 as u32;
