...
unsafe extern "C" fn lh_perllike_str_hash(mut k: *const libc::c_void) -> u64 {
...
unsafe extern "C" fn lh_char_hash(mut k: *const libc::c_void) -> u64 {
...
pub unsafe extern "C" fn lh_table_delete_entry(
    ...
    let mut n: ptrdiff_t = e.offset_from((*t).table) as i64;
