...
pub type time_t = crate::src::random_seed::time_t;
// #[derive(Copy, Clone)]
...
pub type json_c_shallow_copy_fn = crate::src::json_object::json_c_shallow_copy_fn;
...
unsafe fn main_0(
    ...
    let mut udata: [i8; 15] = *::std::mem::transmute::<
        &[u8; 15],
        &mut [i8; 15],
    >(b"dummy userdata\0");
    json_object_set_serializer(
