...
pub unsafe extern "C" fn xmlModuleOpen(
    ...
    if module.is_null() {
        xmlModuleErrMemory(
            0 as xmlModulePtr,
            b"creating module\0" as *const u8 as *const i8,
        );
...
#[no_mangle]
pub unsafe extern "C" fn xmlModuleClose(mut module: xmlModulePtr) -> i32 {
    let mut rc: i32 = 0;
    if module.is_null() {
        __xmlRaiseError(
            None,
...
#[no_mangle]
pub unsafe extern "C" fn xmlModuleFree(mut module: xmlModulePtr) -> i32 {
    if module.is_null() {
        __xmlRaiseError(
            None,
            None,
