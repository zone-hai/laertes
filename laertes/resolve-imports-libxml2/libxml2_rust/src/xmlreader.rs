...
pub type xmlParserSeverities = crate::src::python::libxml::xmlParserSeverities;
...
pub type xmlTextReaderErrorFunc = crate::src::python::libxml::xmlTextReaderErrorFunc;
