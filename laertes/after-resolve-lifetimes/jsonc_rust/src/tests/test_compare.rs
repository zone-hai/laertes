...
pub use crate::src::json_object::{
    json_object, json_object_array_add, json_object_equal, json_object_new_array,
    json_object_new_double, json_object_new_int, json_object_new_object, json_object_new_string,
...
fn main_0(mut argc: i32, mut argv: *mut *mut i8) -> i32 {
    ...
    let mut uint1: *mut crate::src::json_object::json_object =
        json_object_new_uint64(0 as i32 as uint64_t);
    let mut uint2: *mut crate::src::json_object::json_object =
        json_object_new_uint64(1 as i32 as uint64_t);
    let mut uint3: *mut crate::src::json_object::json_object =
        json_object_new_uint64(1 as i32 as uint64_t);
    ...
    let mut str1: *mut crate::src::json_object::json_object =
        json_object_new_string(b"TESTSTRING\0" as *const u8 as *const i8);
    let mut str2: *mut crate::src::json_object::json_object =
        json_object_new_string(b"TESTSTRING\0" as *const u8 as *const i8);
    let mut str3: *mut crate::src::json_object::json_object =
        json_object_new_string(b"DIFFERENT\0" as *const u8 as *const i8);
