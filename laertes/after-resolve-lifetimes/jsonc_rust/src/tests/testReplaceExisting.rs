...
pub use crate::src::{
    debug::mc_set_debug,
    json_object::{
        json_object, json_object_get_object, json_object_new_object, json_object_new_string,
...
fn main_0(mut argc: i32, mut argv: *mut *mut i8) -> i32 {
    ...
    let mut entrykey0: *mut crate::src::json_object::lh_entry =
    ...
    let mut entrykey2: *mut crate::src::json_object::lh_entry =
        lh_table_head(json_object_get_object(my_object));
