...
#[no_mangle]
pub extern "C" fn printbuf_new() -> *mut crate::src::apps::json_parse::printbuf {
    ...
    let (unsafe { ref mut fresh0 }) = (*p).buf;
...
extern "C" fn printbuf_extend(
    ...
    let (unsafe { ref mut fresh1 }) = (*p).buf;
    *fresh1 = t;
    return 0 as i32;
}
#[no_mangle]
...
#[no_mangle]
pub extern "C" fn printbuf_reset(mut p: *mut crate::src::apps::json_parse::printbuf) {
    (unsafe { *((*p).buf).offset(0 as i32 as isize) = '\u{0}' as i32 as i8 });
    (unsafe { (*p).bpos = 0 as i32 });
}
#[no_mangle]
pub extern "C" fn printbuf_free(mut p: *mut crate::src::apps::json_parse::printbuf) {
    if !p.is_null() {
