...
#[no_mangle]
pub static mut easysrc_decl: * mut crate::src::src::slist_wc::slist_wc = 0 as *const slist_wc as *mut slist_wc;
#[no_mangle]
pub static mut easysrc_data: * mut crate::src::src::slist_wc::slist_wc = 0 as *const slist_wc as *mut slist_wc;
#[no_mangle]
pub static mut easysrc_code: * mut crate::src::src::slist_wc::slist_wc = 0 as *const slist_wc as *mut slist_wc;
#[no_mangle]
pub static mut easysrc_toohard: * mut crate::src::src::slist_wc::slist_wc = 0 as *const slist_wc as *mut slist_wc;
#[no_mangle]
pub static mut easysrc_clean: * mut crate::src::src::slist_wc::slist_wc = 0 as *const slist_wc as *mut slist_wc;
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn easysrc_add<'a1>(
    mut plist: Option<&'a1 mut * mut crate::src::src::slist_wc::slist_wc>,
    mut line: * const i8,
) -> u32 {
    let mut ret: u32 = CURLE_OK;
    let mut list: * mut crate::src::src::slist_wc::slist_wc = slist_wc_append(*(borrow_mut(&mut plist)).unwrap(), line);
    if list.is_null() {
        easysrc_free();
        ret = CURLE_OUT_OF_MEMORY;
    } else {
        *(borrow_mut(&mut plist)).unwrap() = list;
    }
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn easysrc_addf<'a1>(
    mut plist: Option<&'a1 mut * mut crate::src::src::slist_wc::slist_wc>,
    mut fmt: * const i8,
    mut args: ...
) -> u32 {
    ...
    if bufp.is_null() {
        ...
        ret = easysrc_add(borrow_mut(&mut plist), bufp);
        curl_free(bufp as *mut libc::c_void);
    }
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn easysrc_init() -> u32 {
    let mut ret: u32 = easysrc_add(
...
#[no_mangle]
pub unsafe extern "C" fn easysrc_perform() -> u32 {
    if !easysrc_toohard.is_null() {
        let mut i: i32 = 0;
        let mut ptr: * mut crate::src::lib::http2::curl_slist = 0 as *mut curl_slist;
        ...
        loop {
            ...
            let mut ret_0: u32 = easysrc_add(Some(&mut easysrc_code), c);
            if ret_0 as u64 != 0 {
                return ret_0;
            }
            i += 1;
        ...
        if !easysrc_toohard.is_null() {
            ...
            while !ptr.is_null() {
                let mut ret_1: u32 = easysrc_add(Some(&mut easysrc_code), (*ptr).data);
                if ret_1 as u64 != 0 {
                    return ret_1;
                }
                ptr = (*ptr).next;
...
#[no_mangle]
pub unsafe extern "C" fn easysrc_cleanup() -> u32 {
    let mut ret: u32 = easysrc_add(
        Some(&mut easysrc_code),
...
#[no_mangle]
pub unsafe extern "C" fn dumpeasysrc(mut config: * mut crate::src::src::tool_cb_dbg::GlobalConfig) {
    let mut ptr: * mut crate::src::lib::http2::curl_slist = 0 as *mut curl_slist;
