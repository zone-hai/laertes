...
pub type curl_unlock_function = Option<unsafe extern "C"  fn(_: * mut crate::src::lib::http2::Curl_easy,_: u32,_: * mut core::ffi::c_void,) -> ()>;
...
pub type curl_lock_function = Option<unsafe extern "C"  fn(_: * mut crate::src::lib::http2::Curl_easy,_: u32,_: u32,_: * mut core::ffi::c_void,) -> ()>;
...
unsafe extern "C" fn get_protocol_family(mut h: * const crate::src::lib::http2::Curl_handler) -> u32 {
    return (*h).family;
}
...
#[no_mangle]
pub unsafe extern "C" fn Curl_freeset(mut data: * mut crate::src::lib::http2::Curl_easy) {
    ...
    while (i as u32) < STRING_LAST as i32 as u32 {
        ...
        let mut fresh0 = &mut ((*data).set.str_0[i as usize]);
        *fresh0 = 0 as *mut i8;
        i += 1;
    }
    j = BLOB_CERT;
    while (j as u32) < BLOB_LAST as i32 as u32 {
        ...
        let mut fresh1 = &mut ((*data).set.blobs[j as usize]);
    ...
    if ((*data).state).referer_alloc() != 0 {
        ...
        let mut fresh2 = &mut ((*data).state.referer);
        *fresh2 = 0 as *mut i8;
        let mut fresh3 = &mut ((*data).state);
        (*fresh3).set_referer_alloc(0 as i32 as bit);
    }
    let mut fresh4 = &mut ((*data).state.referer);
    *fresh4 = 0 as *mut i8;
    if ((*data).state).url_alloc() != 0 {
        Curl_cfree
            .expect("non-null function pointer")((*data).state.url as *mut libc::c_void);
        let mut fresh5 = &mut ((*data).state.url);
        *fresh5 = 0 as *mut i8;
        let mut fresh6 = &mut ((*data).state);
        (*fresh6).set_url_alloc(0 as i32 as bit);
    }
    let mut fresh7 = &mut ((*data).state.url);
    *fresh7 = 0 as *mut i8;
    Curl_mime_cleanpart(&mut (*data).set.mimepost);
}
unsafe extern "C" fn up_free(mut data: * mut crate::src::lib::http2::Curl_easy) {
    let mut up: Option<&'_ mut crate::src::lib::http2::urlpieces> = Some(&mut (*data).state.up);
    Curl_cfree.expect("non-null function pointer")((*(borrow_mut(&mut up)).unwrap()).scheme as *mut libc::c_void);
    let mut fresh8 = &mut ((*(borrow_mut(&mut up)).unwrap()).scheme);
    *fresh8 = 0 as *mut i8;
    Curl_cfree.expect("non-null function pointer")((*(borrow_mut(&mut up)).unwrap()).hostname as *mut libc::c_void);
    let mut fresh9 = &mut ((*(borrow_mut(&mut up)).unwrap()).hostname);
    *fresh9 = 0 as *mut i8;
    Curl_cfree.expect("non-null function pointer")((*(borrow_mut(&mut up)).unwrap()).port as *mut libc::c_void);
    let mut fresh10 = &mut ((*(borrow_mut(&mut up)).unwrap()).port);
    *fresh10 = 0 as *mut i8;
    Curl_cfree.expect("non-null function pointer")((*(borrow_mut(&mut up)).unwrap()).user as *mut libc::c_void);
    let mut fresh11 = &mut ((*(borrow_mut(&mut up)).unwrap()).user);
    *fresh11 = 0 as *mut i8;
    Curl_cfree.expect("non-null function pointer")((*(borrow_mut(&mut up)).unwrap()).password as *mut libc::c_void);
    let mut fresh12 = &mut ((*(borrow_mut(&mut up)).unwrap()).password);
    *fresh12 = 0 as *mut i8;
    Curl_cfree.expect("non-null function pointer")((*(borrow_mut(&mut up)).unwrap()).options as *mut libc::c_void);
    let mut fresh13 = &mut ((*(borrow_mut(&mut up)).unwrap()).options);
    *fresh13 = 0 as *mut i8;
    Curl_cfree.expect("non-null function pointer")((*(borrow_mut(&mut up)).unwrap()).path as *mut libc::c_void);
    let mut fresh14 = &mut ((*(borrow_mut(&mut up)).unwrap()).path);
    *fresh14 = 0 as *mut i8;
    Curl_cfree.expect("non-null function pointer")((*(borrow_mut(&mut up)).unwrap()).query as *mut libc::c_void);
    let mut fresh15 = &mut ((*(borrow_mut(&mut up)).unwrap()).query);
    *fresh15 = 0 as *mut i8;
    curl_url_cleanup((*data).state.uh);
    let mut fresh16 = &mut ((*data).state.uh);
    *fresh16 = 0 as *mut CURLU;
}
#[no_mangle]
pub unsafe extern "C" fn Curl_close<'a1>(mut datap: Option<&'a1 mut * mut crate::src::lib::http2::Curl_easy>) -> u32 {
    ...
    *(borrow_mut(&mut datap)).unwrap() = 0 as *mut Curl_easy;
    ...
    if !((*data).multi_easy).is_null() {
        ...
        let mut fresh17 = &mut ((*data).multi_easy);
    ...
    let mut fresh18 = &mut ((*data).state.first_host);
    *fresh18 = 0 as *mut i8;
    Curl_cfree
    ...
    *fresh19 = 0 as *mut i8;
    ...
    let mut fresh20 = &mut ((*data).req.newurl);
    *fresh20 = 0 as *mut i8;
    if ((*data).state).referer_alloc() != 0 {
        Curl_cfree
            .expect(
    ...
    *fresh27 = 0 as *mut i8;
    ...
    let mut fresh29 = &mut ((*data).state.aptr.proxyuserpwd);
    *fresh29 = 0 as *mut i8;
    Curl_cfree
        .expect(
            "non-null function pointer",
        )((*data).state.aptr.uagent as *mut libc::c_void);
    let mut fresh30 = &mut ((*data).state.aptr.uagent);
    *fresh30 = 0 as *mut i8;
    Curl_cfree
        .expect(
            "non-null function pointer",
        )((*data).state.aptr.userpwd as *mut libc::c_void);
    let mut fresh31 = &mut ((*data).state.aptr.userpwd);
    *fresh31 = 0 as *mut i8;
    Curl_cfree
        .expect(
            "non-null function pointer",
        )((*data).state.aptr.accept_encoding as *mut libc::c_void);
    let mut fresh32 = &mut ((*data).state.aptr.accept_encoding);
    *fresh32 = 0 as *mut i8;
    Curl_cfree
        .expect("non-null function pointer")((*data).state.aptr.te as *mut libc::c_void);
    let mut fresh33 = &mut ((*data).state.aptr.te);
    *fresh33 = 0 as *mut i8;
    Curl_cfree
        .expect(
            "non-null function pointer",
        )((*data).state.aptr.rangeline as *mut libc::c_void);
    let mut fresh34 = &mut ((*data).state.aptr.rangeline);
    *fresh34 = 0 as *mut i8;
    Curl_cfree
        .expect(
            "non-null function pointer",
        )((*data).state.aptr.ref_0 as *mut libc::c_void);
    let mut fresh35 = &mut ((*data).state.aptr.ref_0);
    *fresh35 = 0 as *mut i8;
    Curl_cfree
        .expect(
            "non-null function pointer",
        )((*data).state.aptr.host as *mut libc::c_void);
    let mut fresh36 = &mut ((*data).state.aptr.host);
    *fresh36 = 0 as *mut i8;
    Curl_cfree
        .expect(
            "non-null function pointer",
        )((*data).state.aptr.cookiehost as *mut libc::c_void);
    let mut fresh37 = &mut ((*data).state.aptr.cookiehost);
    *fresh37 = 0 as *mut i8;
    Curl_cfree
        .expect(
            "non-null function pointer",
        )((*data).state.aptr.rtsp_transport as *mut libc::c_void);
    let mut fresh38 = &mut ((*data).state.aptr.rtsp_transport);
    *fresh38 = 0 as *mut i8;
    Curl_cfree
        .expect(
            "non-null function pointer",
        )((*data).state.aptr.user as *mut libc::c_void);
    let mut fresh39 = &mut ((*data).state.aptr.user);
    *fresh39 = 0 as *mut i8;
    Curl_cfree
        .expect(
            "non-null function pointer",
        )((*data).state.aptr.passwd as *mut libc::c_void);
    let mut fresh40 = &mut ((*data).state.aptr.passwd);
    *fresh40 = 0 as *mut i8;
    Curl_cfree
        .expect(
            "non-null function pointer",
        )((*data).state.aptr.proxyuser as *mut libc::c_void);
    let mut fresh41 = &mut ((*data).state.aptr.proxyuser);
    *fresh41 = 0 as *mut i8;
    Curl_cfree
        .expect(
            "non-null function pointer",
        )((*data).state.aptr.proxypasswd as *mut libc::c_void);
    let mut fresh42 = &mut ((*data).state.aptr.proxypasswd);
    *fresh42 = 0 as *mut i8;
    if !((*data).req.doh).is_null() {
        ...
        let mut fresh43 = &mut ((*data).req.doh);
...
#[no_mangle]
pub unsafe extern "C" fn Curl_init_userdefined(mut data: * mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut set: Option<&'_ mut crate::src::lib::http2::UserDefined> = Some(&mut (*data).set);
    ...
    *fresh47 = core::intrinsics::transmute::<Option<unsafe extern "C"  fn(_: * const core::ffi::c_void,_: u64,_: u64,_: * mut crate::src::lib::http2::_IO_FILE,) -> u64>, Option<unsafe extern "C"  fn(_: * mut i8,_: u64,_: u64,_: * mut core::ffi::c_void,) -> u64>>(
        Some(
            fwrite,
        ),
    );
    let mut fresh48 = &mut ((*(borrow_mut(&mut set)).unwrap()).fread_func_set);
    *fresh48 = core::intrinsics::transmute::<Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: u64,_: u64,_: * mut crate::src::lib::http2::_IO_FILE,) -> u64>, Option<unsafe extern "C"  fn(_: * mut i8,_: u64,_: u64,_: * mut core::ffi::c_void,) -> u64>>(
        Some(
            fread,
        ),
    );
    ...
    *fresh53 = None;
    ...
    (*(borrow_mut(&mut set)).unwrap()).general_ssl.max_ssl_sessions = 5 as i32 as size_t;
    ...
    if Curl_ssl_backend() != CURLSSLBACKEND_SCHANNEL as i32 {
        result = Curl_setstropt(
            Some(&mut *((*(borrow_mut(&mut set)).unwrap()).str_0)
                .as_mut_ptr()
...
#[no_mangle]
pub unsafe extern "C" fn Curl_open<'a1>(mut curl: Option<&'a1 mut * mut crate::src::lib::http2::Curl_easy>) -> u32 {
    let mut result: u32 = CURLE_OK;
    let mut data: * mut crate::src::lib::http2::Curl_easy = 0 as *mut Curl_easy;
    data = Curl_ccalloc
        .expect(
    ...
    result = Curl_resolver_init(data, Some(&mut (*data).state.async_0.resolver));
    if result as u64 != 0 {
        Curl_cfree.expect("non-null function pointer")(data as *mut libc::c_void);
        return result;
    }
...
unsafe extern "C" fn conn_shutdown(
    ...
    {
        let mut fresh60 = &mut ((*data).req.p.http);
        *fresh60 = 0 as *mut HTTP;
        Curl_cfree
            .expect(
                "non-null function pointer",
            )((*(*conn).connect_state).prot_save as *mut libc::c_void);
        let mut fresh61 = &mut ((*(*conn).connect_state).prot_save);
...
unsafe extern "C" fn conn_free(mut conn: * mut crate::src::lib::http2::connectdata) {
    Curl_free_idnconverted_hostname(Some(&mut (*conn).host));
    Curl_free_idnconverted_hostname(Some(&mut (*conn).conn_to_host));
    Curl_free_idnconverted_hostname(Some(&mut (*conn).http_proxy.host));
    Curl_free_idnconverted_hostname(Some(&mut (*conn).socks_proxy.host));
    Curl_cfree
        .expect(
            "non-null function pointer",
        )((*conn).http_proxy.user as *mut libc::c_void);
    let mut fresh62 = &mut ((*conn).http_proxy.user);
    *fresh62 = 0 as *mut i8;
    Curl_cfree
        .expect(
            "non-null function pointer",
        )((*conn).socks_proxy.user as *mut libc::c_void);
    let mut fresh63 = &mut ((*conn).socks_proxy.user);
    *fresh63 = 0 as *mut i8;
    Curl_cfree
        .expect(
            "non-null function pointer",
        )((*conn).http_proxy.passwd as *mut libc::c_void);
    let mut fresh64 = &mut ((*conn).http_proxy.passwd);
    *fresh64 = 0 as *mut i8;
    Curl_cfree
        .expect(
            "non-null function pointer",
        )((*conn).socks_proxy.passwd as *mut libc::c_void);
    let mut fresh65 = &mut ((*conn).socks_proxy.passwd);
    *fresh65 = 0 as *mut i8;
    Curl_cfree
        .expect(
            "non-null function pointer",
        )((*conn).http_proxy.host.rawalloc as *mut libc::c_void);
    let mut fresh66 = &mut ((*conn).http_proxy.host.rawalloc);
    *fresh66 = 0 as *mut i8;
    Curl_cfree
        .expect(
            "non-null function pointer",
        )((*conn).socks_proxy.host.rawalloc as *mut libc::c_void);
    let mut fresh67 = &mut ((*conn).socks_proxy.host.rawalloc);
    *fresh67 = 0 as *mut i8;
    Curl_free_primary_ssl_config(Some(&mut (*conn).proxy_ssl_config));
    Curl_cfree.expect("non-null function pointer")((*conn).user as *mut libc::c_void);
    let mut fresh68 = &mut ((*conn).user);
    *fresh68 = 0 as *mut i8;
    Curl_cfree.expect("non-null function pointer")((*conn).passwd as *mut libc::c_void);
    let mut fresh69 = &mut ((*conn).passwd);
    *fresh69 = 0 as *mut i8;
    Curl_cfree
        .expect("non-null function pointer")((*conn).sasl_authzid as *mut libc::c_void);
    let mut fresh70 = &mut ((*conn).sasl_authzid);
    *fresh70 = 0 as *mut i8;
    Curl_cfree.expect("non-null function pointer")((*conn).options as *mut libc::c_void);
    let mut fresh71 = &mut ((*conn).options);
    *fresh71 = 0 as *mut i8;
    Curl_dyn_free(&mut (*conn).trailer);
    Curl_cfree
        .expect("non-null function pointer")((*conn).host.rawalloc as *mut libc::c_void);
    let mut fresh72 = &mut ((*conn).host.rawalloc);
    *fresh72 = 0 as *mut i8;
    Curl_cfree
        .expect(
            "non-null function pointer",
        )((*conn).conn_to_host.rawalloc as *mut libc::c_void);
    let mut fresh73 = &mut ((*conn).conn_to_host.rawalloc);
    *fresh73 = 0 as *mut i8;
    Curl_cfree
        .expect(
            "non-null function pointer",
        )((*conn).hostname_resolve as *mut libc::c_void);
    let mut fresh74 = &mut ((*conn).hostname_resolve);
    *fresh74 = 0 as *mut i8;
    Curl_cfree
        .expect(
            "non-null function pointer",
        )((*conn).secondaryhostname as *mut libc::c_void);
    let mut fresh75 = &mut ((*conn).secondaryhostname);
    *fresh75 = 0 as *mut i8;
    Curl_cfree
        .expect("non-null function pointer")((*conn).connect_state as *mut libc::c_void);
    let mut fresh76 = &mut ((*conn).connect_state);
    *fresh76 = 0 as *mut http_connect_state;
    ...
    let mut fresh77 = &mut ((*conn).localdev);
    *fresh77 = 0 as *mut i8;
    Curl_free_primary_ssl_config(Some(&mut (*conn).ssl_config));
    Curl_cfree
        .expect(
            "non-null function pointer",
        )((*conn).unix_domain_socket as *mut libc::c_void);
    let mut fresh78 = &mut ((*conn).unix_domain_socket);
    *fresh78 = 0 as *mut i8;
    Curl_cfree.expect("non-null function pointer")((*conn).ssl_extra);
    let mut fresh79 = &mut ((*conn).ssl_extra);
...
pub unsafe extern "C" fn Curl_disconnect(
    ...
    if !((*conn).dns_entry).is_null() {
        ...
        let mut fresh80 = &mut ((*conn).dns_entry);
...
unsafe extern "C" fn SocketIsDead(mut sock: i32) -> bool {
    let mut sval: i32 = 0;
...
unsafe extern "C" fn proxy_info_matches<'a1, 'a2>(
    mut data: Option<&'a1 crate::src::lib::http2::proxy_info>,
    mut needle: Option<&'a2 crate::src::lib::http2::proxy_info>,
) -> bool {
    if (*((data).clone()).unwrap()).proxytype as u32 == (*((needle).clone()).unwrap()).proxytype as u32
        && (*((data).clone()).unwrap()).port == (*((needle).clone()).unwrap()).port
        && Curl_safe_strcasecompare((*((data).clone()).unwrap()).host.name, (*((needle).clone()).unwrap()).host.name) != 0
    {
        return 1 as i32 != 0;
    }
    return 0 as i32 != 0;
}
unsafe extern "C" fn socks_proxy_info_matches<'a1, 'a2>(
    mut data: Option<&'a1 crate::src::lib::http2::proxy_info>,
    mut needle: Option<&'a2 crate::src::lib::http2::proxy_info>,
) -> bool {
    ...
    if ((*(data).unwrap()).user).is_null() as i32
        != ((*(needle).unwrap()).user).is_null() as i32
    {
        return 0 as i32 != 0;
    }
    if !((*((data).clone()).unwrap()).user).is_null() && !((*((needle).clone()).unwrap()).user).is_null()
        && strcmp((*((data).clone()).unwrap()).user, (*((needle).clone()).unwrap()).user) != 0 as i32
    {
        return 0 as i32 != 0;
    }
    ...
    if !((*((data).clone()).unwrap()).passwd).is_null() && !((*((needle).clone()).unwrap()).passwd).is_null()
        && strcmp((*((data).clone()).unwrap()).passwd, (*((needle).clone()).unwrap()).passwd) != 0 as i32
    {
        return 0 as i32 != 0;
    }
    return 1 as i32 != 0;
...
unsafe extern "C" fn conn_maxage(
    ...
    let mut idletime: i64 = Curl_timediff(now, (*conn).lastused);
...
unsafe extern "C" fn call_extract_if_dead(
    ...
    if extract_if_dead(conn, data) {
        let mut fresh81 = &mut ((*p).extracted);
        *fresh81 = conn;
        return 1 as i32;
    }
    return 0 as i32;
}
unsafe extern "C" fn prune_dead_connections(mut data: * mut crate::src::lib::http2::Curl_easy) {
    let mut now: crate::src::lib::http2::curltime = Curl_now();
...
unsafe extern "C" fn ConnectionExists<'a1, 'a2, 'a3>(
    mut data: * mut crate::src::lib::http2::Curl_easy,
                ...
                if extract_if_dead(check, data) {
                    ...
                    if ((*needle).bits).socksproxy() as i32 != 0
                        && !socks_proxy_info_matches(
                            Some(&mut (*needle).socks_proxy),
                            Some(&mut (*check).socks_proxy),
                        )
                    {
                        continue;
                    }
                            ...
                            != ((*check).bits).conn_to_port() as i32)
                        {
                            if ((*needle).bits).httpproxy() != 0 {
                                if !proxy_info_matches(
                                    Some(&mut (*needle).http_proxy),
                                    Some(&mut (*check).http_proxy),
                                ) {
                                    continue;
                                }
                                    ...
                                    == CURLPROXY_HTTPS as i32 as u32
                                {
                                        ...
                                        != 0
                                    {
                                        if !Curl_ssl_config_matches(
                                            ...
                                            Some(&mut (*check).proxy_ssl_config),
                                        ) {
                                            continue;
                                        }
                            ...
                            if !(!canmultiplex && (*check).easyq.size != 0) {
                                if (*check).easyq.size != 0 {
                                    let mut e: * mut crate::src::lib::http2::Curl_llist_element = (*check).easyq.head;
                                    let mut entry: * mut crate::src::lib::http2::Curl_easy = (*e).ptr as *mut Curl_easy;
                                    ...
                                    *(borrow_mut(&mut force_reuse)).unwrap() = 1 as i32 != 0;
                                    ...
                                    if multiplexed == 0 {
                                        ...
                                        if ((*check).bits).multiplex() != 0 {
                                            let mut httpc: Option<&'_ mut crate::src::lib::http2::http_conn> = Some(&mut (*check).proto.httpc);
                                            if multiplexed
                                                >= (*(borrow(& httpc)).unwrap()).settings.max_concurrent_streams as u64
                                            {
                                                Curl_infof(
                                                    data,
...
unsafe extern "C" fn strip_trailing_dot<'a1>(mut host: Option<&'a1 mut crate::src::lib::http2::hostname>) {
    let mut len: u64 = 0;
    if borrow(& host).is_none() || ((*(borrow_mut(&mut host)).unwrap()).name).is_null() {
        return;
    }
    len = strlen((*(borrow(& host)).unwrap()).name);
    if len != 0
        && *((*(borrow(& host)).unwrap()).name)
...
pub unsafe extern "C" fn Curl_idnconvert_hostname(
    ...
    let mut fresh83 = &mut ((*host).dispname);
    *fresh83 = (*host).name;
...
#[no_mangle]
pub extern "C" fn Curl_free_idnconverted_hostname<'a1>(mut host: Option<&'a1 mut crate::src::lib::http2::hostname>) {}
unsafe extern "C" fn allocate_conn(mut data: * mut crate::src::lib::http2::Curl_easy) -> * mut crate::src::lib::http2::connectdata {
    let mut conn: * mut crate::src::lib::http2::connectdata = Curl_ccalloc
        .expect(
            "non-null function pointer",
        )(
        1 as i32 as size_t,
    ...
    let mut sslsize: u64 = (*Curl_ssl).sizeof_ssl_backend_data;
    ...
    *fresh89 = &Curl_handler_dummy;
    ...
    if !((*data).set.str_0[STRING_PRE_PROXY as i32 as usize]).is_null()
        && *(*data).set.str_0[STRING_PRE_PROXY as i32 as usize] as i32
            != 0
    {
        let mut fresh93 = &mut ((*conn).bits);
        (*fresh93).set_proxy(1 as i32 as bit);
        let mut fresh94 = &mut ((*conn).bits);
        (*fresh94).set_socksproxy(1 as i32 as bit);
    }
    let mut fresh95 = &mut ((*conn).bits);
    (*fresh95)
    ...
    let mut fresh96 = &mut ((*conn).bits);
    (*fresh96).set_tunnel_proxy(((*data).set).tunnel_thru_httpproxy());
    let mut fresh97 = &mut ((*conn).bits);
    (*fresh97)
        .set_user_passwd(
    ...
    Curl_llist_init(Some(&mut (*conn).easyq), None);
    if !((*data).set.str_0[STRING_DEVICE as i32 as usize]).is_null() {
        let mut fresh107 = &mut ((*conn).localdev);
    ...
    let mut fresh108 = &mut ((*conn).fclosesocket);
    *fresh108 = (*data).set.fclosesocket;
    let mut fresh109 = &mut ((*conn).closesocket_client);
...
pub unsafe extern "C" fn Curl_builtin_scheme(
    ...
    let mut pp: * const * const crate::src::lib::http2::Curl_handler = (0 as * const * const crate::src::lib::http2::Curl_handler);
...
unsafe extern "C" fn findprotocol(
    ...
    if !p.is_null() && (*data).set.allowed_protocols & (*p).protocol as i64 != 0
    {
        ...
        {} else {
            let mut fresh110 = &mut ((*conn).given);
            *fresh110 = p;
            let mut fresh111 = &mut ((*conn).handler);
            *fresh111 = *fresh110;
            return CURLE_OK;
        }
    }
...
unsafe extern "C" fn parseurlandfillconn(
    ...
    up_free(data);
    if use_set_uh {
        let mut fresh112 = &mut ((*data).state.uh);
        *fresh112 = curl_url_dup((*data).set.uh);
        uh = *fresh112;
    } else {
        let mut fresh113 = &mut ((*data).state.uh);
        *fresh113 = curl_url();
        uh = *fresh113;
    }
    if uh.is_null() {
        ...
        )
    {
        ...
        let mut fresh114 = &mut ((*data).state.url);
        *fresh114 = url;
        let mut fresh115 = &mut ((*data).state);
    ...
    if !use_set_uh {
        ...
        let mut fresh116 = &mut ((*data).state.url);
        *fresh116 = newurl;
        let mut fresh117 = &mut ((*data).state);
        (*fresh117).set_url_alloc(1 as i32 as bit);
    }
    uc = curl_url_get(
        uh,
        CURLUPART_SCHEME,
        Some(&mut (*data).state.up.scheme),
        0 as i32 as u32,
    );
    if uc as u64 != 0 {
        return Curl_uc_to_curlcode(uc);
    ...
    uc = curl_url_get(
        uh,
        CURLUPART_HOST,
        Some(&mut (*data).state.up.hostname),
        0 as i32 as u32,
    );
    if uc as u64 != 0 {
        if Curl_strcasecompare(
        ...
        ) != 0
    {
            ...
            .is_null()
        {
            ...
            let mut fresh118 = &mut ((*data).state.up.scheme);
            *fresh118 = 0 as *mut i8;
            ...
            if ((*data).state).url_alloc() != 0 {
                ...
                let mut fresh119 = &mut ((*data).state.url);
            ...
            let mut fresh120 = &mut ((*data).state.url);
            *fresh120 = url_0;
            let mut fresh121 = &mut ((*data).state);
    ...
    if ((*data).state.aptr.user).is_null() {
        ...
        if uc as u64 == 0 {
            ...
            let mut fresh122 = &mut ((*conn).user);
            *fresh122 = decoded;
            let mut fresh123 = &mut ((*conn).bits);
            (*fresh123).set_user_passwd(1 as i32 as bit);
            result = Curl_setstropt(Some(&mut (*data).state.aptr.user), decoded);
            if result as u64 != 0 {
                return result;
            }
    ...
    if ((*data).state.aptr.passwd).is_null() {
        uc = curl_url_get(
            uh,
            CURLUPART_PASSWORD,
            Some(&mut (*data).state.up.password),
            0 as i32 as u32,
        );
        if uc as u64 == 0 {
            ...
            let mut fresh124 = &mut ((*conn).passwd);
            *fresh124 = decoded_0;
            let mut fresh125 = &mut ((*conn).bits);
            (*fresh125).set_user_passwd(1 as i32 as bit);
            result = Curl_setstropt(Some(&mut (*data).state.aptr.passwd), decoded_0);
            if result as u64 != 0 {
                return result;
            }
    ...
    uc = curl_url_get(
        uh,
        CURLUPART_OPTIONS,
        Some(&mut (*data).state.up.options),
        ((1 as i32) << 6 as i32) as u32,
    );
    if uc as u64 == 0 {
        let mut fresh126 = &mut ((*conn).options);
    ...
    if uc as u64 != 0 {
        ...
        let mut fresh127 = &mut ((*conn).remote_port);
    ...
    {
        let mut hlen: u64 = 0;
        let mut fresh128 = &mut ((*conn).bits);
    ...
    let mut fresh129 = &mut ((*conn).host.rawalloc);
    *fresh129 = Curl_cstrdup
    ...
    let mut fresh130 = &mut ((*conn).host.name);
...
unsafe extern "C" fn setup_range(mut data: * mut crate::src::lib::http2::Curl_easy) -> u32 {
    let mut s: * mut crate::src::lib::http2::UrlState = &mut (*data).state;
        ...
        || !((*data).set.str_0[STRING_SET_RANGE as i32 as usize]).is_null()
    {
        ...
        if (*s).resume_from != 0 {
            let mut fresh131 = &mut ((*s).range);
            *fresh131 = curl_maprintf(
                b"%ld-\0" as *const u8 as *const i8,
                (*s).resume_from,
            );
        } else {
            let mut fresh132 = &mut ((*s).range);
...
#[no_mangle]
pub unsafe extern "C" fn Curl_free_request_state(mut data: * mut crate::src::lib::http2::Curl_easy) {
    Curl_cfree
        .expect("non-null function pointer")((*data).req.p.http as *mut libc::c_void);
    let mut fresh133 = &mut ((*data).req.p.http);
    *fresh133 = 0 as *mut HTTP;
    Curl_cfree
        .expect("non-null function pointer")((*data).req.newurl as *mut libc::c_void);
    let mut fresh134 = &mut ((*data).req.newurl);
    *fresh134 = 0 as *mut i8;
    if !((*data).req.doh).is_null() {
        Curl_close(
            Some(&mut (*((*(*data).req.doh).probe)
                .as_mut_ptr()
                .offset(0 as i32 as isize))
                .easy),
        );
                                    ...
                                    != CURLUE_NO_USER as i32 as u32)
                            {
                                        ...
                                        != CURLUE_NO_PASSWORD as i32 as u32)
                                {
                                    if !proxyuser.is_null() || !proxypasswd.is_null() {
                                        ...
                                        let mut fresh139 = &mut ((*proxyinfo).user);
                                        *fresh139 = 0 as *mut i8;
                                        let mut fresh140 = &mut ((*proxyinfo).user);
                                        *fresh140 = proxyuser;
                                        result = Curl_setstropt(
                                        ...
                                        if result as u64 != 0 {
                                            ...
                                            let mut fresh141 = &mut ((*proxyinfo).passwd);
                                            *fresh141 = 0 as *mut i8;
                                            ...
                                            match current_block {
                                                467357264955599708 => {}
                                                _ => {
                                                    let mut fresh142 = &mut ((*proxyinfo).passwd);
                                                    *fresh142 = proxypasswd;
                                                    ...
                                                    if result as u64 != 0 {
                                                        ...
                                                        let mut fresh143 = &mut ((*conn).bits);
                                    ...
                                    match current_block {
                                        ...
                                        _ => {
                                            ...
                                            if uc as u64 != 0 {
                                                ...
                                                let mut fresh144 = &mut ((*proxyinfo).host.rawalloc);
                                                *fresh144 = 0 as *mut i8;
                                                let mut fresh145 = &mut ((*proxyinfo).host.rawalloc);
                                                *fresh145 = host;
                                                if *host.offset(0 as i32 as isize) as i32
                                                    == '[' as i32
                                                {
                                                    let mut len: u64 = strlen(host);
                                                    *host
                                                        .offset(
                                                            len.wrapping_sub(1 as i32 as u64) as isize,
                                                        ) = 0 as i32 as i8;
                                                ...
                                                let mut fresh146 = &mut ((*proxyinfo).host.name);
                                                *fresh146 = host;
                                            }
                                        }
                                    }
...
unsafe extern "C" fn parse_proxy_auth(
    ...
    if result as u64 == 0 && !proxypasswd.is_null() {
        result = Curl_urldecode(
            ...
            proxypasswd,
            0 as i32 as size_t,
            Some(&mut (*conn).http_proxy.passwd),
            Option::<&'_ mut u64>::None,
            REJECT_ZERO,
        );
        if result as u64 == 0 {
                    ...
                    match current_block {
                        ...
                        _ => {
                            ...
                            if !proxy.is_null() || !socksproxy.is_null() {
                                            ...
                                            _ => {
                                                if !((*conn).http_proxy.host.rawalloc).is_null() {
                                                        ...
                                                        == 0
                                                    {
                                                        ...
                                                        {
                                                            let mut fresh147 = &mut ((*conn).handler);
                                                            *fresh147 = &Curl_handler_http;
                                                        } else {
                                                            let mut fresh148 = &mut ((*conn).bits);
                                                            (*fresh148).set_tunnel_proxy(1 as i32 as bit);
                                                        }
                                                    }
                                                    let mut fresh149 = &mut ((*conn).bits);
                                                    (*fresh149).set_httpproxy(1 as i32 as bit);
                                                } else {
                                                    let mut fresh150 = &mut ((*conn).bits);
                                                    (*fresh150).set_httpproxy(0 as i32 as bit);
                                                    let mut fresh151 = &mut ((*conn).bits);
                                                    (*fresh151).set_tunnel_proxy(0 as i32 as bit);
                                                }
                                                if !((*conn).socks_proxy.host.rawalloc).is_null() {
                                                    if ((*conn).http_proxy.host.rawalloc).is_null() {
                                                        if ((*conn).socks_proxy.user).is_null() {
                                                            let mut fresh152 = &mut ((*conn).socks_proxy.user);
                                                            *fresh152 = (*conn).http_proxy.user;
                                                            let mut fresh153 = &mut ((*conn).http_proxy.user);
                                                            *fresh153 = 0 as *mut i8;
                                                            Curl_cfree
                                                                .expect(
                                                                    "non-null function pointer",
                                                                )((*conn).socks_proxy.passwd as *mut libc::c_void);
                                                            let mut fresh154 = &mut ((*conn).socks_proxy.passwd);
                                                            *fresh154 = 0 as *mut i8;
                                                            let mut fresh155 = &mut ((*conn).socks_proxy.passwd);
                                                            *fresh155 = (*conn).http_proxy.passwd;
                                                            let mut fresh156 = &mut ((*conn).http_proxy.passwd);
                                                            *fresh156 = 0 as *mut i8;
                                                        }
                                                    }
                                                    let mut fresh157 = &mut ((*conn).bits);
                                                    (*fresh157).set_socksproxy(1 as i32 as bit);
                                                } else {
                                                    let mut fresh158 = &mut ((*conn).bits);
                                ...
                                let mut fresh159 = &mut ((*conn).bits);
                                (*fresh159).set_socksproxy(0 as i32 as bit);
                                let mut fresh160 = &mut ((*conn).bits);
                            ...
                            match current_block {
                                5128804967847913759 => {}
                                _ => {
                                    let mut fresh161 = &mut ((*conn).bits);
                                    (*fresh161)
                                        .set_proxy(
...
#[no_mangle]
pub unsafe extern "C" fn Curl_parse_login_details<'a1, 'a2>(
    mut login: * const i8,
    len: u64,
    ...
    if result as u64 == 0 {
        ...
        if !pbuf.is_null() {
            ...
            *pbuf.offset(plen as isize) = '\u{0}' as i32 as i8;
            Curl_cfree
                .expect("non-null function pointer")(*(borrow_mut(&mut passwdp)).unwrap() as *mut libc::c_void);
...
unsafe extern "C" fn override_login(
    ...
    let mut uc: u32 = CURLUE_OK;
    let mut userp: Option<&'_ mut * mut i8> = Some(&mut (*conn).user);
    let mut passwdp: Option<&'_ mut * mut i8> = Some(&mut (*conn).passwd);
    let mut optionsp: Option<&'_ mut * mut i8> = Some(&mut (*conn).options);
        ...
        && ((*conn).bits).user_passwd() as i32 != 0
    {
        Curl_cfree.expect("non-null function pointer")(*(borrow_mut(&mut userp)).unwrap() as *mut libc::c_void);
        *(borrow_mut(&mut userp)).unwrap() = 0 as *mut i8;
        Curl_cfree.expect("non-null function pointer")(*(borrow_mut(&mut passwdp)).unwrap() as *mut libc::c_void);
        *(borrow_mut(&mut passwdp)).unwrap() = 0 as *mut i8;
        let mut fresh167 = &mut ((*conn).bits);
        (*fresh167).set_user_passwd(0 as i32 as bit);
    }
    if !((*data).set.str_0[STRING_OPTIONS as i32 as usize]).is_null() {
        Curl_cfree.expect("non-null function pointer")(*(borrow_mut(&mut optionsp)).unwrap() as *mut libc::c_void);
        *(borrow_mut(&mut optionsp)).unwrap() = Curl_cstrdup
            .expect(
                "non-null function pointer",
    ...
    let mut fresh168 = &mut ((*conn).bits);
        ...
        && ((*data).set.str_0[STRING_USERNAME as i32 as usize]).is_null()
    {
        ...
        if ret > 0 as i32 {
            ...
            let mut fresh169 = &mut ((*conn).bits);
            (*fresh169).set_netrc(1 as i32 as bit);
            let mut fresh170 = &mut ((*conn).bits);
            (*fresh170).set_user_passwd(1 as i32 as bit);
        }
    }
    if !(*(borrow(& userp)).unwrap()).is_null() {
        let mut result: u32 = Curl_setstropt(Some(&mut (*data).state.aptr.user), *(borrow(& userp)).unwrap());
        if result as u64 != 0 {
            return result;
        }
    }
    if !((*data).state.aptr.user).is_null() {
        ...
        if (*(borrow_mut(&mut userp)).unwrap()).is_null() {
            *(borrow_mut(&mut userp)).unwrap() = Curl_cstrdup
    ...
    if !((*data).state.aptr.passwd).is_null() {
        ...
        if (*(borrow_mut(&mut passwdp)).unwrap()).is_null() {
            *(borrow_mut(&mut passwdp)).unwrap() = Curl_cstrdup
...
unsafe extern "C" fn set_login(mut conn: * mut crate::src::lib::http2::connectdata) -> u32 {
    let mut result: u32 = CURLE_OK;
    ...
    if ((*conn).user).is_null() {
        let mut fresh171 = &mut ((*conn).user);
    ...
    if ((*conn).passwd).is_null() {
        let mut fresh172 = &mut ((*conn).passwd);
...
unsafe extern "C" fn parse_connect_to_host_port<'a1, 'a2>(
    mut data: * mut crate::src::lib::http2::Curl_easy,
    mut host: * const i8,
    ...
    *(borrow_mut(&mut port_result)).unwrap() = -(1 as i32);
    ...
    match current_block {
        10692455896603418738 => {
            if !hostptr.is_null() {
                *(borrow_mut(&mut hostname_result)).unwrap() = Curl_cstrdup
...
unsafe extern "C" fn parse_connect_to_string<'a1, 'a2>(
    mut data: * mut crate::src::lib::http2::Curl_easy,
    mut conn: * mut crate::src::lib::http2::connectdata,
    ...
    *(borrow_mut(&mut port_result)).unwrap() = -(1 as i32);
    ...
    if host_match != 0 && port_match != 0 {
        result = parse_connect_to_host_port(data, ptr, borrow_mut(&mut host_result), borrow_mut(&mut port_result));
    }
    return result;
}
unsafe extern "C" fn parse_connect_to_slist(
    ...
    while !conn_to_host.is_null() && host.is_null() && port == -(1 as i32) {
        ...
        if !host.is_null() && *host as i32 != 0 {
            let mut fresh174 = &mut ((*conn).conn_to_host.rawalloc);
            *fresh174 = host;
            let mut fresh175 = &mut ((*conn).conn_to_host.name);
            *fresh175 = host;
            let mut fresh176 = &mut ((*conn).bits);
            ...
            let mut fresh177 = &mut ((*conn).bits);
        ...
        if port >= 0 as i32 {
            ...
            let mut fresh178 = &mut ((*conn).bits);
            ...
            let mut fresh179 = &mut ((*conn).bits);
            ...
            || 0 as i32 != 0)
    {
        ...
        if hit {
            ...
            let mut fresh180 = &mut ((*conn).conn_to_host.rawalloc);
            *fresh180 = hostd;
            let mut fresh181 = &mut ((*conn).conn_to_host.name);
            *fresh181 = hostd;
            let mut fresh182 = &mut ((*conn).bits);
            (*fresh182).set_conn_to_host(1 as i32 as bit);
            (*conn).conn_to_port = (*as_0).dst.port as i32;
            let mut fresh183 = &mut ((*conn).bits);
            (*fresh183).set_conn_to_port(1 as i32 as bit);
            let mut fresh184 = &mut ((*conn).bits);
...
unsafe extern "C" fn resolve_server<'a1>(
    mut data: * mut crate::src::lib::http2::Curl_easy,
    mut conn: * mut crate::src::lib::http2::connectdata,
        ...
        *(borrow_mut(&mut async_0)).unwrap() = 0 as i32 != 0;
        ...
        if !((*conn).unix_domain_socket).is_null() {
            ...
            if hostaddr.is_null() {
                ...
                let mut fresh185 = &mut ((*hostaddr).addr);
                *fresh185 = Curl_unix2addr(
                ...
                if !((*hostaddr).addr).is_null() {
                    let mut fresh186 = &mut ((*hostaddr).inuse);
                    *fresh186 += 1;
                } else {
                    if longpath {
                        Curl_failf(
            ...
            let mut connhost: Option<&'_ mut crate::src::lib::http2::hostname> = Option::<&'_ mut crate::src::lib::http2::hostname>::None;
            if ((*conn).bits).conn_to_host() != 0 {
                connhost = Some(&mut (*conn).conn_to_host);
            } else {
                connhost = Some(&mut (*conn).host);
            }
            ...
            let mut fresh187 = &mut ((*conn).hostname_resolve);
            *fresh187 = Curl_cstrdup
                .expect("non-null function pointer")((*(borrow(& connhost)).unwrap()).name);
            ...
            let host: * mut crate::src::lib::http2::hostname = if ((*conn).bits).socksproxy() as i32 != 0
            {
                &mut (*conn).socks_proxy.host
            } else {
                &mut (*conn).http_proxy.host
            };
            let mut fresh188 = &mut ((*conn).hostname_resolve);
        ...
        let mut fresh189 = &mut ((*conn).dns_entry);
        *fresh189 = hostaddr;
    }
    return result;
}
unsafe extern "C" fn reuse_conn(
    ...
    let mut local_ip: [i8; 46] = *core::intrinsics::transmute::<&'_ [u8; 46], &'_ mut [i8; 46]>(
    ...
    Curl_free_idnconverted_hostname(Some(&mut (*old_conn).http_proxy.host));
    Curl_free_idnconverted_hostname(Some(&mut (*old_conn).socks_proxy.host));
    Curl_cfree
        .expect(
            "non-null function pointer",
    ...
    Curl_free_primary_ssl_config(Some(&mut (*old_conn).proxy_ssl_config));
    Curl_free_primary_ssl_config(Some(&mut (*old_conn).ssl_config));
    let mut fresh190 = &mut ((*conn).bits);
    ...
    if ((*conn).bits).user_passwd() != 0 {
        ...
        let mut fresh191 = &mut ((*conn).user);
        *fresh191 = 0 as *mut i8;
        Curl_cfree
            .expect("non-null function pointer")((*conn).passwd as *mut libc::c_void);
        let mut fresh192 = &mut ((*conn).passwd);
        *fresh192 = 0 as *mut i8;
        let mut fresh193 = &mut ((*conn).user);
        *fresh193 = (*old_conn).user;
        let mut fresh194 = &mut ((*conn).passwd);
        *fresh194 = (*old_conn).passwd;
        let mut fresh195 = &mut ((*old_conn).user);
        *fresh195 = 0 as *mut i8;
        let mut fresh196 = &mut ((*old_conn).passwd);
        *fresh196 = 0 as *mut i8;
    }
    let mut fresh197 = &mut ((*conn).bits);
    ...
    if ((*conn).bits).proxy_user_passwd() != 0 {
        ...
        let mut fresh198 = &mut ((*conn).http_proxy.user);
        *fresh198 = 0 as *mut i8;
        Curl_cfree
            .expect(
                "non-null function pointer",
            )((*conn).socks_proxy.user as *mut libc::c_void);
        let mut fresh199 = &mut ((*conn).socks_proxy.user);
        *fresh199 = 0 as *mut i8;
        Curl_cfree
            .expect(
                "non-null function pointer",
            )((*conn).http_proxy.passwd as *mut libc::c_void);
        let mut fresh200 = &mut ((*conn).http_proxy.passwd);
        *fresh200 = 0 as *mut i8;
        Curl_cfree
            .expect(
                "non-null function pointer",
            )((*conn).socks_proxy.passwd as *mut libc::c_void);
        let mut fresh201 = &mut ((*conn).socks_proxy.passwd);
        *fresh201 = 0 as *mut i8;
        let mut fresh202 = &mut ((*conn).http_proxy.user);
        *fresh202 = (*old_conn).http_proxy.user;
        let mut fresh203 = &mut ((*conn).socks_proxy.user);
        *fresh203 = (*old_conn).socks_proxy.user;
        let mut fresh204 = &mut ((*conn).http_proxy.passwd);
        *fresh204 = (*old_conn).http_proxy.passwd;
        let mut fresh205 = &mut ((*conn).socks_proxy.passwd);
        *fresh205 = (*old_conn).socks_proxy.passwd;
        let mut fresh206 = &mut ((*old_conn).http_proxy.user);
        *fresh206 = 0 as *mut i8;
        let mut fresh207 = &mut ((*old_conn).socks_proxy.user);
        *fresh207 = 0 as *mut i8;
        let mut fresh208 = &mut ((*old_conn).http_proxy.passwd);
        *fresh208 = 0 as *mut i8;
        let mut fresh209 = &mut ((*old_conn).socks_proxy.passwd);
    ...
    let mut fresh210 = &mut ((*old_conn).http_proxy.user);
    *fresh210 = 0 as *mut i8;
    Curl_cfree
        .expect(
            "non-null function pointer",
        )((*old_conn).socks_proxy.user as *mut libc::c_void);
    let mut fresh211 = &mut ((*old_conn).socks_proxy.user);
    *fresh211 = 0 as *mut i8;
    Curl_cfree
        .expect(
            "non-null function pointer",
        )((*old_conn).http_proxy.passwd as *mut libc::c_void);
    let mut fresh212 = &mut ((*old_conn).http_proxy.passwd);
    *fresh212 = 0 as *mut i8;
    Curl_cfree
        .expect(
            "non-null function pointer",
        )((*old_conn).socks_proxy.passwd as *mut libc::c_void);
    let mut fresh213 = &mut ((*old_conn).socks_proxy.passwd);
    *fresh213 = 0 as *mut i8;
    Curl_free_idnconverted_hostname(Some(&mut (*conn).host));
    Curl_free_idnconverted_hostname(Some(&mut (*conn).conn_to_host));
    Curl_cfree
        .expect("non-null function pointer")((*conn).host.rawalloc as *mut libc::c_void);
    let mut fresh214 = &mut ((*conn).host.rawalloc);
    *fresh214 = 0 as *mut i8;
    Curl_cfree
        .expect(
            "non-null function pointer",
        )((*conn).conn_to_host.rawalloc as *mut libc::c_void);
    let mut fresh215 = &mut ((*conn).conn_to_host.rawalloc);
    *fresh215 = 0 as *mut i8;
    ...
    let mut fresh216 = &mut ((*conn).hostname_resolve);
    *fresh216 = 0 as *mut i8;
    let mut fresh217 = &mut ((*conn).hostname_resolve);
    *fresh217 = (*old_conn).hostname_resolve;
    let mut fresh218 = &mut ((*old_conn).hostname_resolve);
    ...
    *fresh223 = 0 as *mut i8;
    ...
    let mut fresh224 = &mut ((*old_conn).unix_domain_socket);
    *fresh224 = 0 as *mut i8;
}
unsafe extern "C" fn create_conn<'a1, 'a2>(
    mut data: * mut crate::src::lib::http2::Curl_easy,
    ...
    let mut max_host_connections: u64 = Curl_multi_max_host_connections(
        (*data).multi,
    );
    let mut max_total_connections: u64 = Curl_multi_max_total_connections(
        (*data).multi,
    );
    *(borrow_mut(&mut async_0)).unwrap() = 0 as i32 != 0;
            ...
            *(borrow_mut(&mut in_connect)).unwrap() = conn;
            ...
            if !(result as u64 != 0) {
                if !((*data).set.str_0[STRING_SASL_AUTHZID as i32 as usize])
                    .is_null()
                {
                    let mut fresh225 = &mut ((*conn).sasl_authzid);
                ...
                match current_block {
                    ...
                    _ => {
                        if !((*data)
                            ...
                            .is_null()
                        {
                            let mut fresh226 = &mut ((*conn).unix_domain_socket);
                            *fresh226 = Curl_cstrdup
                            ...
                            if ((*conn).unix_domain_socket).is_null() {
                                ...
                                let mut fresh227 = &mut ((*conn).bits);
                                (*fresh227)
                        ...
                        match current_block {
                            ...
                            _ => {
                                ...
                                if !(result as u64 != 0) {
                                    ...
                                    {
                                        let mut fresh228 = &mut ((*conn).bits);
                                                                        ...
                                                                        match current_block {
                                                                            ...
                                                                            _ => {
                                                                                ...
                                                                                if (((*conn).bits).conn_to_host() as i32 != 0
                                                                                    ...
                                                                                    && ((*conn).bits).httpproxy() as i32 != 0
                                                                                {
                                                                                    let mut fresh231 = &mut ((*conn).bits);
                                                                                    (*fresh231).set_tunnel_proxy(1 as i32 as bit);
                                                                                }
                                                                                result = setup_connection_internals(data, conn);
                                                                                if !(result as u64 != 0) {
                                                                                    let mut fresh232 = &mut ((*conn)
                                                                                        .recv[0 as i32 as usize]);
                                                                                    *fresh232 = Some(
                                                                                        Curl_recv_plain,
                                                                                    );
                                                                                    let mut fresh233 = &mut ((*conn)
                                                                                        .send[0 as i32 as usize]);
                                                                                    *fresh233 = Some(
                                                                                        Curl_send_plain,
                                                                                    );
                                                                                    let mut fresh234 = &mut ((*conn)
                                                                                        .recv[1 as i32 as usize]);
                                                                                    *fresh234 = Some(
                                                                                        Curl_recv_plain,
                                                                                    );
                                                                                    let mut fresh235 = &mut ((*conn)
                                                                                        .send[1 as i32 as usize]);
                                                                                    *fresh235 = Some(
                                                                                        Curl_send_plain,
                                                                                    );
                                                                                    let mut fresh236 = &mut ((*conn).bits);
                                                                                        ...
                                                                                        != 0
                                                                                    {
                                                                                        ...
                                                                                        let mut fresh237 = &mut ((*data).set.ssl.primary.CApath);
                                                                                        *fresh237 = (*data)
                                                                                            .set
                                                                                            .str_0[STRING_SSL_CAPATH as i32 as usize];
                                                                                        let mut fresh238 = &mut ((*data).set.ssl.primary.CAfile);
                                                                                        *fresh238 = (*data)
                                                                                            .set
                                                                                            .str_0[STRING_SSL_CAFILE as i32 as usize];
                                                                                        let mut fresh239 = &mut ((*data).set.ssl.primary.issuercert);
                                                                                        *fresh239 = (*data)
                                                                                            .set
                                                                                            .str_0[STRING_SSL_ISSUERCERT as i32 as usize];
                                                                                        let mut fresh240 = &mut ((*data)
                                                                                            .set
                                                                                            .ssl
                                                                                            .primary
                                                                                            .issuercert_blob);
                                                                                        *fresh240 = (*data)
                                                                                        ...
                                                                                        let mut fresh241 = &mut ((*data).set.ssl.primary.random_file);
                                                                                        *fresh241 = (*data)
                                                                                            .set
                                                                                            .str_0[STRING_SSL_RANDOM_FILE as i32 as usize];
                                                                                        let mut fresh242 = &mut ((*data).set.ssl.primary.egdsocket);
                                                                                        *fresh242 = (*data)
                                                                                            .set
                                                                                            .str_0[STRING_SSL_EGDSOCKET as i32 as usize];
                                                                                        let mut fresh243 = &mut ((*data).set.ssl.primary.cipher_list);
                                                                                        *fresh243 = (*data)
                                                                                            .set
                                                                                            .str_0[STRING_SSL_CIPHER_LIST as i32 as usize];
                                                                                        let mut fresh244 = &mut ((*data)
                                                                                            .set
                                                                                            .ssl
                                                                                            .primary
                                                                                            .cipher_list13);
                                                                                        *fresh244 = (*data)
                                                                                        ...
                                                                                        let mut fresh245 = &mut ((*data).set.ssl.primary.pinned_key);
                                                                                        *fresh245 = (*data)
                                                                                            .set
                                                                                            .str_0[STRING_SSL_PINNEDPUBLICKEY as i32 as usize];
                                                                                        let mut fresh246 = &mut ((*data).set.ssl.primary.cert_blob);
                                                                                        *fresh246 = (*data)
                                                                                            .set
                                                                                            .blobs[BLOB_CERT as i32 as usize];
                                                                                        let mut fresh247 = &mut ((*data).set.ssl.primary.ca_info_blob);
                                                                                        *fresh247 = (*data)
                                                                                            .set
                                                                                            .blobs[BLOB_CAINFO as i32 as usize];
                                                                                        let mut fresh248 = &mut ((*data).set.ssl.primary.curves);
                                                                                        *fresh248 = (*data)
                                                                                            .set
                                                                                            .str_0[STRING_SSL_EC_CURVES as i32 as usize];
                                                                                        let mut fresh249 = &mut ((*data).set.proxy_ssl.primary.CApath);
                                                                                        *fresh249 = (*data)
                                                                                            .set
                                                                                            .str_0[STRING_SSL_CAPATH_PROXY as i32 as usize];
                                                                                        let mut fresh250 = &mut ((*data).set.proxy_ssl.primary.CAfile);
                                                                                        *fresh250 = (*data)
                                                                                            .set
                                                                                            .str_0[STRING_SSL_CAFILE_PROXY as i32 as usize];
                                                                                        let mut fresh251 = &mut ((*data)
                                                                                            .set
                                                                                            .proxy_ssl
                                                                                            .primary
                                                                                            .random_file);
                                                                                        ...
                                                                                        *fresh259 = (*data)
                                                                                        ...
                                                                                        let mut fresh260 = &mut ((*data).set.proxy_ssl.CRLfile);
                                                                                        *fresh260 = (*data)
                                                                                            .set
                                                                                            .str_0[STRING_SSL_CRLFILE_PROXY as i32 as usize];
                                                                                        let mut fresh261 = &mut ((*data).set.proxy_ssl.cert_type);
                                                                                        *fresh261 = (*data)
                                                                                            .set
                                                                                            .str_0[STRING_CERT_TYPE_PROXY as i32 as usize];
                                                                                        let mut fresh262 = &mut ((*data).set.proxy_ssl.key);
                                                                                        *fresh262 = (*data)
                                                                                            .set
                                                                                            .str_0[STRING_KEY_PROXY as i32 as usize];
                                                                                        let mut fresh263 = &mut ((*data).set.proxy_ssl.key_type);
                                                                                        *fresh263 = (*data)
                                                                                            .set
                                                                                            .str_0[STRING_KEY_TYPE_PROXY as i32 as usize];
                                                                                        let mut fresh264 = &mut ((*data).set.proxy_ssl.key_passwd);
                                                                                        *fresh264 = (*data)
                                                                                            .set
                                                                                            .str_0[STRING_KEY_PASSWD_PROXY as i32 as usize];
                                                                                        let mut fresh265 = &mut ((*data)
                                                                                            .set
                                                                                            .proxy_ssl
                                                                                            .primary
                                                                                            .clientcert);
                                                                                        *fresh265 = (*data)
                                                                                        ...
                                                                                        let mut fresh266 = &mut ((*data).set.proxy_ssl.key_blob);
                                                                                        *fresh266 = (*data)
                                                                                            .set
                                                                                            .blobs[BLOB_KEY_PROXY as i32 as usize];
                                                                                        let mut fresh267 = &mut ((*data).set.ssl.CRLfile);
                                                                                        *fresh267 = (*data)
                                                                                            .set
                                                                                            .str_0[STRING_SSL_CRLFILE as i32 as usize];
                                                                                        let mut fresh268 = &mut ((*data).set.ssl.cert_type);
                                                                                        *fresh268 = (*data)
                                                                                            .set
                                                                                            .str_0[STRING_CERT_TYPE as i32 as usize];
                                                                                        let mut fresh269 = &mut ((*data).set.ssl.key);
                                                                                        *fresh269 = (*data)
                                                                                            .set
                                                                                            .str_0[STRING_KEY as i32 as usize];
                                                                                        let mut fresh270 = &mut ((*data).set.ssl.key_type);
                                                                                        *fresh270 = (*data)
                                                                                            .set
                                                                                            .str_0[STRING_KEY_TYPE as i32 as usize];
                                                                                        let mut fresh271 = &mut ((*data).set.ssl.key_passwd);
                                                                                        *fresh271 = (*data)
                                                                                            .set
                                                                                            .str_0[STRING_KEY_PASSWD as i32 as usize];
                                                                                        let mut fresh272 = &mut ((*data).set.ssl.primary.clientcert);
                                                                                        *fresh272 = (*data)
                                                                                            .set
                                                                                            .str_0[STRING_CERT as i32 as usize];
                                                                                        let mut fresh273 = &mut ((*data).set.ssl.username);
                                                                                        *fresh273 = (*data)
                                                                                            .set
                                                                                            .str_0[STRING_TLSAUTH_USERNAME as i32 as usize];
                                                                                        let mut fresh274 = &mut ((*data).set.ssl.password);
                                                                                        *fresh274 = (*data)
                                                                                            .set
                                                                                            .str_0[STRING_TLSAUTH_PASSWORD as i32 as usize];
                                                                                        let mut fresh275 = &mut ((*data).set.proxy_ssl.username);
                                                                                        *fresh275 = (*data)
                                                                                            .set
                                                                                            .str_0[STRING_TLSAUTH_USERNAME_PROXY as i32
                                                                                            as usize];
                                                                                        let mut fresh276 = &mut ((*data).set.proxy_ssl.password);
                                                                                        *fresh276 = (*data)
                                                                                            .set
                                                                                            .str_0[STRING_TLSAUTH_PASSWORD_PROXY as i32
                                                                                            as usize];
                                                                                        let mut fresh277 = &mut ((*data).set.ssl.key_blob);
                                                                                        *fresh277 = (*data)
                                                                                            .set
                                                                                            .blobs[BLOB_KEY as i32 as usize];
                                                                                        if !Curl_clone_primary_ssl_config(
                                                                                            &mut (*data).set.ssl.primary,
                                                                                            Some(&mut (*conn).ssl_config),
                                                                                        ) {
                                                                                            result = CURLE_OUT_OF_MEMORY;
                                                                                        } else if !Curl_clone_primary_ssl_config(
                                                                                                &mut (*data).set.proxy_ssl.primary,
                                                                                                Some(&mut (*conn).proxy_ssl_config),
                                                                                            ) {
                                                                                            result = CURLE_OUT_OF_MEMORY;
                                                                                        } else {
                                                                                                ...
                                                                                                *(borrow_mut(&mut in_connect)).unwrap() = conn;
                                                                                                ...
                                                                                                if waitpipe {
                                                                                                    ...
                                                                                                    let mut bundlehost: * const i8 = 0
                                                                                                        as *const i8;
                                                                                                    let mut bundle: * mut crate::src::lib::http2::connectbundle = Curl_conncache_find_bundle(
                                                                                                        data,
                                                                                                        conn,
                                                                                                        (*data).state.conn_cache,
                                                                                                        Some(&mut bundlehost),
                                                                                                    ...
                                                                                                    {
                                                                                                        let mut conn_candidate: * mut crate::src::lib::http2::connectdata = 0
                                                                                                            as *mut connectdata;
                                                                                                ...
                                                                                                {
                                                                                                    let mut conn_candidate_0: * mut crate::src::lib::http2::connectdata = 0
                                                                                                        as *mut connectdata;
                                                                                                    ...
                                                                                                    *(borrow_mut(&mut in_connect)).unwrap() = 0 as *mut connectdata;
                                                                                                    ...
                                                                                                    if result as u64 != 0 {
                                                                                                            ...
                                                                                                            != 0 && ((*data).state.authhost).done() as i32 != 0
                                                                                                        {
                                                                                                            ...
                                                                                                            let mut fresh280 = &mut ((*data).state.authhost);
                                                                                                            ...
                                                                                                            != 0 && ((*data).state.authproxy).done() as i32 != 0
                                                                                                        {
                                                                                                            ...
                                                                                                            (*data)
                                                                                                                ...
                                                                                                                .authproxy
                                                                                                                .picked = 0 as i32 as u64;
                                                                                                            let mut fresh281 = &mut ((*data).state.authproxy);
                                                                                            ...
                                                                                            match current_block {
                                                                                                ...
                                                                                                _ => {
                                                                                                    ...
                                                                                                    result = setup_range(data);
                                                                                                    if !(result as u64 != 0) {
                                                                                                        let mut fresh282 = &mut ((*conn).seek_func);
                                                                                                        *fresh282 = (*data).set.seek_func;
                                                                                                        let mut fresh283 = &mut ((*conn).seek_client);
                                                                                                        *fresh283 = (*data).set.seek_client;
                                                                                                        result = resolve_server(data, conn, borrow_mut(&mut async_0));
                                                                                                        strip_trailing_dot(Some(&mut (*conn).host));
                                                                                                        if ((*conn).bits).httpproxy() != 0 {
                                                                                                            strip_trailing_dot(Some(&mut (*conn).http_proxy.host));
                                                                                                        }
                                                                                                        if ((*conn).bits).socksproxy() != 0 {
                                                                                                            strip_trailing_dot(Some(&mut (*conn).socks_proxy.host));
                                                                                                        }
                                                                                                        if ((*conn).bits).conn_to_host() != 0 {
                                                                                                            strip_trailing_dot(Some(&mut (*conn).conn_to_host));
                                                                                                        }
                                                                                                    }
                                                                                                }
                                                                                            }
...
#[no_mangle]
pub unsafe extern "C" fn Curl_setup_conn<'a1>(
    mut data: * mut crate::src::lib::http2::Curl_easy,
    ...
    *(borrow_mut(&mut protocol_done)).unwrap() = 0 as i32 != 0;
    let mut fresh284 = &mut ((*conn).bits);
...
#[no_mangle]
pub unsafe extern "C" fn Curl_connect<'a1, 'a2>(
    mut data: * mut crate::src::lib::http2::Curl_easy,
