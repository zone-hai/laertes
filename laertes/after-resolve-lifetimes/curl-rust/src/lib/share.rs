...
pub use crate::src::lib::vtls::vtls::Curl_ssl_kill_session;
...
#[no_mangle]
pub unsafe extern "C" fn curl_share_init() -> * mut crate::src::lib::asyn_thread::Curl_share {
    let mut share: * mut crate::src::lib::asyn_thread::Curl_share = Curl_ccalloc
        .expect(
            "non-null function pointer",
        )(
        1 as i32 as size_t,
        ::std::mem::size_of::<Curl_share>() as u64,
    ) as *mut Curl_share;
    if !share.is_null() {
        (*share).magic = 0x7e117a1e as i32 as u32;
        (*share).specifier
            |= ((1 as i32) << CURL_LOCK_DATA_SHARE as i32)
                as u32;
        if Curl_mk_dnscache(Some(&mut (*share).hostcache)) != 0 {
            Curl_cfree.expect("non-null function pointer")(share as *mut libc::c_void);
            return 0 as *mut CURLSH;
        }
    }
    return share;
}
...
pub unsafe extern "C" fn curl_share_setopt(
    ...
    let mut lockfunc: Option<unsafe extern "C"  fn(_: * mut crate::src::lib::http2::Curl_easy,_: u32,_: u32,_: * mut core::ffi::c_void,) -> ()> = None;
    let mut unlockfunc: Option<unsafe extern "C"  fn(_: * mut crate::src::lib::http2::Curl_easy,_: u32,_: * mut core::ffi::c_void,) -> ()> = None;
    let mut ptr: * mut core::ffi::c_void = 0 as *mut libc::c_void;
    let mut res: u32 = CURLSHE_OK;
    if !(!share.is_null() && (*share).magic == 0x7e117a1e as i32 as u32)
    {
    ...
    match option as u32 {
        1 => {
            type_0 = param.arg::<i32>();
            match type_0 {
                2 => {
                    if ((*share).cookies).is_null() {
                        let mut fresh0 = &mut ((*share).cookies);
                        *fresh0 = Curl_cookie_init(
                            0 as *mut Curl_easy,
                            0 as *const i8,
                            0 as *mut CookieInfo,
                            1 as i32 != 0,
                ...
                4 => {
                    if ((*share).sslsession).is_null() {
                        (*share).max_ssl_sessions = 8 as i32 as size_t;
                        let mut fresh1 = &mut ((*share).sslsession);
                        *fresh1 = Curl_ccalloc
                            .expect(
                                "non-null function pointer",
                            )(
                        ...
                        (*share).sessionage = 0 as i32 as i64;
                        if ((*share).sslsession).is_null() {
                            res = CURLSHE_NOMEM;
                        }
                    }
                ...
                5 => {
                    if Curl_conncache_init(&mut (*share).conn_cache, 103 as i32)
                        != 0
                    {
                        res = CURLSHE_NOMEM;
                    }
            ...
            if res as u64 == 0 {
                (*share).specifier |= ((1 as i32) << type_0) as u32;
            }
        }
        2 => {
            type_0 = param.arg::<i32>();
            ...
            match type_0 {
                2 => {
                    if !((*share).cookies).is_null() {
                        ...
                        let mut fresh2 = &mut ((*share).cookies);
                        *fresh2 = 0 as *mut CookieInfo;
                    }
                }
                4 => {
                    Curl_cfree
                        .expect(
                            "non-null function pointer",
                        )((*share).sslsession as *mut libc::c_void);
                    let mut fresh3 = &mut ((*share).sslsession);
                    *fresh3 = 0 as *mut Curl_ssl_session;
                }
                3 | 5 => {}
                _ => {
                    res = CURLSHE_BAD_OPTION;
        ...
        3 => {
            lockfunc = core::intrinsics::transmute::<* mut unsafe extern "C"  fn(_: * mut crate::src::lib::http2::Curl_easy,_: u32,_: u32,_: * mut core::ffi::c_void,) -> (), Option<unsafe extern "C"  fn(_: * mut crate::src::lib::http2::Curl_easy,_: u32,_: u32,_: * mut core::ffi::c_void,) -> ()>>(
                param
                    .arg::<
            ...
            let mut fresh4 = &mut ((*share).lockfunc);
            *fresh4 = lockfunc;
        }
        4 => {
            unlockfunc = core::intrinsics::transmute::<* mut unsafe extern "C"  fn(_: * mut crate::src::lib::http2::Curl_easy,_: u32,_: * mut core::ffi::c_void,) -> (), Option<unsafe extern "C"  fn(_: * mut crate::src::lib::http2::Curl_easy,_: u32,_: * mut core::ffi::c_void,) -> ()>>(
                param
                    .arg::<
                    *mut unsafe extern "C" fn(
                        *mut CURL,
            ...
            let mut fresh5 = &mut ((*share).unlockfunc);
            *fresh5 = unlockfunc;
        }
        5 => {
            ptr = param.arg::<*mut libc::c_void>();
            let mut fresh6 = &mut ((*share).clientdata);
            *fresh6 = ptr;
        }
        _ => {
            res = CURLSHE_BAD_OPTION;
...
#[no_mangle]
pub unsafe extern "C" fn curl_share_cleanup(mut share: * mut crate::src::lib::asyn_thread::Curl_share) -> u32 {
    if !(!share.is_null() && (*share).magic == 0x7e117a1e as i32 as u32)
    {
        return CURLSHE_INVALID;
    }
    if ((*share).lockfunc).is_some() {
        ((*share).lockfunc)
            .expect(
                "non-null function pointer",
            )(
    ...
    if (*share).dirty != 0 {
        if ((*share).unlockfunc).is_some() {
            ((*share).unlockfunc)
                .expect(
                    "non-null function pointer",
                )(0 as *mut CURL, CURL_LOCK_DATA_SHARE, (*share).clientdata);
        }
        return CURLSHE_IN_USE;
    }
    Curl_conncache_close_all_connections(Some(&mut (*share).conn_cache));
    Curl_conncache_destroy(Some(&mut (*share).conn_cache));
    Curl_hash_destroy(&mut (*share).hostcache);
    Curl_cookie_cleanup((*share).cookies);
    if !((*share).sslsession).is_null() {
        let mut i: u64 = 0;
        i = 0 as i32 as size_t;
        while i < (*share).max_ssl_sessions {
            Curl_ssl_kill_session(Some(&mut *((*share).sslsession).offset(i as isize)));
            i = i.wrapping_add(1);
        }
        Curl_cfree
            .expect(
    ...
    Curl_psl_destroy(&mut (*share).psl);
    if ((*share).unlockfunc).is_some() {
        ((*share).unlockfunc)
            .expect(
                "non-null function pointer",
    ...
    (*share).magic = 0 as i32 as u32;
    Curl_cfree.expect("non-null function pointer")(share as *mut libc::c_void);
    return CURLSHE_OK;
}
#[no_mangle]
pub unsafe extern "C" fn Curl_share_lock(
    mut data: * mut crate::src::lib::http2::Curl_easy,
    mut type_0: u32,
    mut accesstype: u32,
) -> u32 {
    let mut share: * mut crate::src::lib::asyn_thread::Curl_share = (*data).share;
    if share.is_null() {
        return CURLSHE_INVALID;
    }
    if (*share).specifier
        & ((1 as i32) << type_0 as u32) as u32 != 0
    {
        if ((*share).lockfunc).is_some() {
            ((*share).lockfunc)
                .expect(
                    "non-null function pointer",
                )(data, type_0, accesstype, (*share).clientdata);
        }
    }
    return CURLSHE_OK;
}
#[no_mangle]
pub unsafe extern "C" fn Curl_share_unlock(
    mut data: * mut crate::src::lib::http2::Curl_easy,
    mut type_0: u32,
) -> u32 {
    let mut share: * mut crate::src::lib::asyn_thread::Curl_share = (*data).share;
        ...
        & ((1 as i32) << type_0 as u32) as u32 != 0
    {
        if ((*share).unlockfunc).is_some() {
            ((*share).unlockfunc)
                .expect("non-null function pointer")(data, type_0, (*share).clientdata);
        }
    }
    return CURLSHE_OK;
}
