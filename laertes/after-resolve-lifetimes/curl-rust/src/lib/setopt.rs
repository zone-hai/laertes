...
#[no_mangle]
pub unsafe extern "C" fn Curl_setstropt<'a1>(
    mut charp: Option<&'a1 mut * mut i8>,
    mut s: * const i8,
) -> u32 {
    Curl_cfree.expect("non-null function pointer")(*(borrow_mut(&mut charp)).unwrap() as *mut libc::c_void);
    *(borrow_mut(&mut charp)).unwrap() = 0 as *mut i8;
    if !s.is_null() {
        ...
        *(borrow_mut(&mut charp)).unwrap() = str;
    }
    return CURLE_OK;
}
#[no_mangle]
pub unsafe extern "C" fn Curl_setblobopt<'a1>(
    mut blobp: Option<&'a1 mut * mut crate::src::lib::http2::curl_blob>,
    mut blob: * const crate::src::lib::http2::curl_blob,
) -> u32 {
    Curl_cfree.expect("non-null function pointer")(*(borrow_mut(&mut blobp)).unwrap() as *mut libc::c_void);
    *(borrow_mut(&mut blobp)).unwrap() = 0 as *mut curl_blob;
    if !blob.is_null() {
        let mut nblob: * mut crate::src::lib::http2::curl_blob = 0 as *mut curl_blob;
        ...
        *nblob = *blob;
        if (*blob).flags & 1 as i32 as u32 != 0 {
            let mut fresh0 = &mut ((*nblob).data);
            *fresh0 = (nblob as *mut i8)
                .offset(::std::mem::size_of::<curl_blob>() as u64 as isize)
                as *mut libc::c_void;
            memcpy((*nblob).data, (*blob).data, (*blob).len);
        }
        *(borrow_mut(&mut blobp)).unwrap() = nblob;
        return CURLE_OK;
    }
    return CURLE_OK;
}
unsafe extern "C" fn setstropt_userpwd<'a1, 'a2>(
    mut option: * mut i8,
    ...
    if !option.is_null() {
        result = Curl_parse_login_details(
            option,
            strlen(option),
            borrow_mut(&mut if !borrow(& userp).is_none() { Some(&mut user) } else { Option::<&'_ mut * mut i8>::None }),
            borrow_mut(&mut if !borrow(& passwdp).is_none() { Some(&mut passwd) } else { Option::<&'_ mut * mut i8>::None }),
            0 as *mut *mut i8,
        );
    }
    if result as u64 == 0 {
        if !borrow(& userp).is_none() {
            ...
            *(borrow_mut(&mut userp)).unwrap() = user;
        }
        if !borrow(& passwdp).is_none() {
            ...
            *(borrow_mut(&mut passwdp)).unwrap() = passwd;
        }
    }
    return result;
}
...
pub unsafe extern "C" fn Curl_vsetopt(
    ...
    mut option: u32,
    mut param: core::ffi::VaList,
) -> u32 {
    let mut argptr: * mut i8 = 0 as *mut i8;
    let mut result: u32 = CURLE_OK;
    let mut arg: i64 = 0;
    let mut uarg: u64 = 0;
    let mut bigsize: i64 = 0;
    match option as u32 {
        92 => {
            arg = param.arg::<i64>();
        ...
        32 | 250 => {
            ...
            let mut primary: Option<&'_ mut crate::src::lib::http2::ssl_primary_config> = Some(&mut (*data).set.ssl.primary);
            if option as u32
                != CURLOPT_SSLVERSION as i32 as u32
            {
                primary = Some(&mut (*data).set.proxy_ssl.primary);
            }
            arg = param.arg::<i64>();
            ...
            (*(borrow_mut(&mut primary)).unwrap()).version = version;
            (*(borrow_mut(&mut primary)).unwrap()).version_max = version_max;
        }
        10165 => {
        ...
        60 => {
                        ...
                        as *mut libc::c_void
            {
                ...
                let mut fresh17 = &mut ((*data).set.postfields);
        ...
        30120 => {
                        ...
                        as *mut libc::c_void
            {
                ...
                let mut fresh18 = &mut ((*data).set.postfields);
                *fresh18 = 0 as *mut libc::c_void;
            }
            (*data).set.postfieldsize = bigsize;
        }
        58 => {
            let mut fresh19 = &mut ((*data).set);
            (*fresh19)
        ...
        10024 => {
            let mut fresh24 = &mut ((*data).set.httppost);
            *fresh24 = param.arg::<*mut curl_httppost>();
            (*data).set.method = HTTPREQ_POST_FORM;
            let mut fresh25 = &mut ((*data).set);
        ...
        10016 => {
            if ((*data).state).referer_alloc() != 0 {
                ...
                let mut fresh27 = &mut ((*data).state.referer);
                *fresh27 = 0 as *mut i8;
                let mut fresh28 = &mut ((*data).state);
            ...
            let mut fresh29 = &mut ((*data).state.referer);
        ...
        10023 => {
            let mut fresh30 = &mut ((*data).set.headers);
            *fresh30 = param.arg::<*mut curl_slist>();
        }
        10228 => {
            let mut fresh31 = &mut ((*data).set.proxyheaders);
            *fresh31 = param.arg::<*mut curl_slist>();
        }
        229 => {
            arg = param.arg::<i64>();
            let mut fresh32 = &mut ((*data).set);
            (*fresh32)
                .set_sep_headers(
        ...
        10104 => {
            let mut fresh33 = &mut ((*data).set.http200aliases);
        ...
        10031 => {
            ...
            if !argptr.is_null() {
                ...
                if cl.is_null() {
                    ...
                    let mut fresh34 = &mut ((*data).state.cookielist);
                    *fresh34 = 0 as *mut curl_slist;
                    return CURLE_OUT_OF_MEMORY;
                }
                let mut fresh35 = &mut ((*data).state.cookielist);
                *fresh35 = cl;
            } else {
                curl_slist_free_all((*data).state.cookielist);
                let mut fresh36 = &mut ((*data).state.cookielist);
                *fresh36 = 0 as *mut curl_slist;
                if ((*data).share).is_null() || ((*(*data).share).cookies).is_null() {
                    Curl_cookie_clearall((*data).cookies);
                    Curl_cookie_cleanup((*data).cookies);
                }
                let mut fresh37 = &mut ((*data).cookies);
                *fresh37 = 0 as *mut CookieInfo;
            }
        }
        10082 => {
            let mut newcookies: * mut crate::src::lib::http2::CookieInfo = 0 as *mut CookieInfo;
            result = Curl_setstropt(
                Some(&mut *((*data).set.str_0)
                    .as_mut_ptr()
            ...
            let mut fresh38 = &mut ((*data).cookies);
            *fresh38 = newcookies;
        }
        96 => {
            let mut fresh39 = &mut ((*data).set);
            (*fresh39)
                .set_cookiesession(
                    (if 0 as i32 as i64 != param.arg::<i64>() {
                        1 as i32
            ...
            if !argptr.is_null() {
                ...
                ) != 0
                {
                    ...
                    if ((*data).cookies).is_null() {
                        let mut fresh40 = &mut ((*data).cookies);
        ...
        80 => {
            if param.arg::<i64>() != 0 {
                (*data).set.method = HTTPREQ_GET;
                let mut fresh41 = &mut ((*data).set);
                (*fresh41).set_upload(0 as i32 as bit);
                let mut fresh42 = &mut ((*data).set);
        ...
        107 => {
            ...
            if auth == 0 as i32 as u64 {
                ...
                let mut fresh44 = &mut ((*data).state.authhost);
                (*fresh44)
                    .set_iestyle(
                        (if auth
        ...
        111 => {
            ...
            if auth_0 == 0 as i32 as u64 {
                ...
                let mut fresh47 = &mut ((*data).state.authproxy);
                (*fresh47)
                    .set_iestyle(
                        (if auth_0
                            & (1 as i32 as u64) << 4 as i32
        ...
        166 => {
            match param.arg::<i64>() {
                0 => {
                    let mut fresh49 = &mut ((*data).set);
                    (*fresh49).set_proxy_transfer_mode(0 as i32 as bit);
                }
                1 => {
                    let mut fresh50 = &mut ((*data).set);
        ...
        10029 => {
            let mut fresh51 = &mut ((*data).set.writeheader);
            *fresh51 = param.arg::<*mut libc::c_void>();
        }
        10010 => {
            let mut fresh52 = &mut ((*data).set.errorbuffer);
            *fresh52 = param.arg::<*mut i8>();
        }
        10001 => {
            let mut fresh53 = &mut ((*data).set.out);
        ...
        10009 => {
            let mut fresh62 = &mut ((*data).set.in_set);
        ...
        10282 => {
            let mut fresh63 = &mut ((*data).set.uh);
        ...
        10002 => {
            if ((*data).state).url_alloc() != 0 {
                ...
                let mut fresh64 = &mut ((*data).state.url);
                *fresh64 = 0 as *mut i8;
                let mut fresh65 = &mut ((*data).state);
            ...
            let mut fresh66 = &mut ((*data).state.url);
        ...
        10039 => {
            let mut fresh67 = &mut ((*data).set.postquote);
            *fresh67 = param.arg::<*mut curl_slist>();
        }
        10093 => {
            let mut fresh68 = &mut ((*data).set.prequote);
            *fresh68 = param.arg::<*mut curl_slist>();
        }
        10028 => {
            let mut fresh69 = &mut ((*data).set.quote);
            *fresh69 = param.arg::<*mut curl_slist>();
        }
        10203 => {
            let mut fresh70 = &mut ((*data).set.resolve);
            *fresh70 = param.arg::<*mut curl_slist>();
            let mut fresh71 = &mut ((*data).state.resolve);
            *fresh71 = (*data).set.resolve;
        }
        20056 => {
            let mut fresh72 = &mut ((*data).set.fprogress);
            *fresh72 = core::intrinsics::transmute::<* mut unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: f64,_: f64,_: f64,_: f64,) -> i32, Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: f64,_: f64,_: f64,_: f64,) -> i32>>(
                param
                    .arg::<
            ...
            if ((*data).set.fprogress).is_some() {
                let mut fresh73 = &mut ((*data).progress);
                (*fresh73).set_callback(1 as i32 as bit);
            } else {
                let mut fresh74 = &mut ((*data).progress);
                (*fresh74).set_callback(0 as i32 as bit);
            }
        }
        20219 => {
            let mut fresh75 = &mut ((*data).set.fxferinfo);
            *fresh75 = core::intrinsics::transmute::<* mut unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: i64,_: i64,_: i64,_: i64,) -> i32, Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: i64,_: i64,_: i64,_: i64,) -> i32>>(
                param
                    .arg::<
                    *mut unsafe extern "C" fn(
                        *mut libc::c_void,
            ...
            if ((*data).set.fxferinfo).is_some() {
                let mut fresh76 = &mut ((*data).progress);
                (*fresh76).set_callback(1 as i32 as bit);
            } else {
                let mut fresh77 = &mut ((*data).progress);
                (*fresh77).set_callback(0 as i32 as bit);
            }
        }
        10057 => {
            let mut fresh78 = &mut ((*data).set.progress_client);
        ...
        20094 => {
            let mut fresh79 = &mut ((*data).set.fdebug);
            *fresh79 = core::intrinsics::transmute::<* mut unsafe extern "C"  fn(_: * mut crate::src::lib::http2::Curl_easy,_: u32,_: * mut i8,_: u64,_: * mut core::ffi::c_void,) -> i32, Option<unsafe extern "C"  fn(_: * mut crate::src::lib::http2::Curl_easy,_: u32,_: * mut i8,_: u64,_: * mut core::ffi::c_void,) -> i32>>(
                param
                    .arg::<
                    *mut unsafe extern "C" fn(
                        *mut CURL,
        ...
        10095 => {
            let mut fresh80 = &mut ((*data).set.debugdata);
            *fresh80 = param.arg::<*mut libc::c_void>();
        }
        10037 => {
            let mut fresh81 = &mut ((*data).set.err);
            *fresh81 = param.arg::<*mut FILE>();
            if ((*data).set.err).is_null() {
                let mut fresh82 = &mut ((*data).set.err);
                *fresh82 = stderr;
            }
        }
        20079 => {
            let mut fresh83 = &mut ((*data).set.fwrite_header);
            *fresh83 = core::intrinsics::transmute::<* mut unsafe extern "C"  fn(_: * mut i8,_: u64,_: u64,_: * mut core::ffi::c_void,) -> u64, Option<unsafe extern "C"  fn(_: * mut i8,_: u64,_: u64,_: * mut core::ffi::c_void,) -> u64>>(
                param
                    .arg::<
                    *mut unsafe extern "C" fn(
                        *mut i8,
        ...
        20011 => {
            let mut fresh84 = &mut ((*data).set.fwrite_func);
            *fresh84 = core::intrinsics::transmute::<* mut unsafe extern "C"  fn(_: * mut i8,_: u64,_: u64,_: * mut core::ffi::c_void,) -> u64, Option<unsafe extern "C"  fn(_: * mut i8,_: u64,_: u64,_: * mut core::ffi::c_void,) -> u64>>(
                param
                    .arg::<
                    *mut unsafe extern "C" fn(
                        *mut i8,
            ...
            if ((*data).set.fwrite_func).is_none() {
                let mut fresh85 = &mut ((*data).set);
                (*fresh85).set_is_fwrite_set(0 as i32 as bit);
                let mut fresh86 = &mut ((*data).set.fwrite_func);
                *fresh86 = core::intrinsics::transmute::<Option<unsafe extern "C"  fn(_: * const core::ffi::c_void,_: u64,_: u64,_: * mut crate::src::lib::http2::_IO_FILE,) -> u64>, Option<unsafe extern "C"  fn(_: * mut i8,_: u64,_: u64,_: * mut core::ffi::c_void,) -> u64>>(
                    Some(
                        fwrite,
                    ),
                );
            } else {
                let mut fresh87 = &mut ((*data).set);
                (*fresh87).set_is_fwrite_set(1 as i32 as bit);
            }
        }
        20012 => {
            let mut fresh88 = &mut ((*data).set.fread_func_set);
            *fresh88 = core::intrinsics::transmute::<* mut unsafe extern "C"  fn(_: * mut i8,_: u64,_: u64,_: * mut core::ffi::c_void,) -> u64, Option<unsafe extern "C"  fn(_: * mut i8,_: u64,_: u64,_: * mut core::ffi::c_void,) -> u64>>(
                param
                    .arg::<
                    *mut unsafe extern "C" fn(
                        *mut i8,
            ...
            if ((*data).set.fread_func_set).is_none() {
                let mut fresh89 = &mut ((*data).set);
                (*fresh89).set_is_fread_set(0 as i32 as bit);
                let mut fresh90 = &mut ((*data).set.fread_func_set);
                *fresh90 = core::intrinsics::transmute::<Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: u64,_: u64,_: * mut crate::src::lib::http2::_IO_FILE,) -> u64>, Option<unsafe extern "C"  fn(_: * mut i8,_: u64,_: u64,_: * mut core::ffi::c_void,) -> u64>>(
                    Some(
                        fread,
                    ),
                );
            } else {
                let mut fresh91 = &mut ((*data).set);
                (*fresh91).set_is_fread_set(1 as i32 as bit);
            }
        }
        20167 => {
            let mut fresh92 = &mut ((*data).set.seek_func);
            *fresh92 = core::intrinsics::transmute::<* mut unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: i64,_: i32,) -> i32, Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: i64,_: i32,) -> i32>>(
                param
                    .arg::<
                    *mut unsafe extern "C" fn(
                        *mut libc::c_void,
        ...
        10168 => {
            let mut fresh93 = &mut ((*data).set.seek_client);
            *fresh93 = param.arg::<*mut libc::c_void>();
        }
        20142 => {
            let mut fresh94 = &mut ((*data).set.convfromnetwork);
            *fresh94 = core::intrinsics::transmute::<* mut unsafe extern "C"  fn(_: * mut i8,_: u64,) -> u32, Option<unsafe extern "C"  fn(_: * mut i8,_: u64,) -> u32>>(
                param
                    .arg::<
        ...
        20143 => {
            let mut fresh95 = &mut ((*data).set.convtonetwork);
            *fresh95 = core::intrinsics::transmute::<* mut unsafe extern "C"  fn(_: * mut i8,_: u64,) -> u32, Option<unsafe extern "C"  fn(_: * mut i8,_: u64,) -> u32>>(
                param
                    .arg::<
                    *mut unsafe extern "C" fn(*mut i8, size_t) -> CURLcode,
                >(),
        ...
        20144 => {
            let mut fresh96 = &mut ((*data).set.convfromutf8);
            *fresh96 = core::intrinsics::transmute::<* mut unsafe extern "C"  fn(_: * mut i8,_: u64,) -> u32, Option<unsafe extern "C"  fn(_: * mut i8,_: u64,) -> u32>>(
                param
                    .arg::<
                    *mut unsafe extern "C" fn(*mut i8, size_t) -> CURLcode,
                >(),
        ...
        20130 => {
            let mut fresh97 = &mut ((*data).set.ioctl_func);
            *fresh97 = core::intrinsics::transmute::<* mut unsafe extern "C"  fn(_: * mut crate::src::lib::http2::Curl_easy,_: i32,_: * mut core::ffi::c_void,) -> u32, Option<unsafe extern "C"  fn(_: * mut crate::src::lib::http2::Curl_easy,_: i32,_: * mut core::ffi::c_void,) -> u32>>(
                param
                    .arg::<
                    *mut unsafe extern "C" fn(
                        *mut CURL,
        ...
        10131 => {
            let mut fresh98 = &mut ((*data).set.ioctl_client);
        ...
        64 => {
            let mut fresh101 = &mut ((*data).set.ssl.primary);
            (*fresh101)
                .set_verifypeer(
                    (if 0 as i32 as i64 != param.arg::<i64>() {
                        1 as i32
            ...
            if !((*data).conn).is_null() {
                let mut fresh102 = &mut ((*(*data).conn).ssl_config);
                (*fresh102).set_verifypeer(((*data).set.ssl.primary).verifypeer());
            }
        }
        306 => {
            let mut fresh103 = &mut ((*data).set);
            (*fresh103)
                .set_doh_verifypeer(
                    (if 0 as i32 as i64 != param.arg::<i64>() {
                        1 as i32
        ...
        248 => {
            let mut fresh104 = &mut ((*data).set.proxy_ssl.primary);
            (*fresh104)
                .set_verifypeer(
                    (if 0 as i32 as i64 != param.arg::<i64>() {
                        1 as i32
            ...
            if !((*data).conn).is_null() {
                let mut fresh105 = &mut ((*(*data).conn).proxy_ssl_config);
                (*fresh105).set_verifypeer(((*data).set.proxy_ssl.primary).verifypeer());
            }
        }
        81 => {
            arg = param.arg::<i64>();
            let mut fresh106 = &mut ((*data).set.ssl.primary);
            (*fresh106)
                .set_verifyhost(
            ...
            if !((*data).conn).is_null() {
                let mut fresh107 = &mut ((*(*data).conn).ssl_config);
                (*fresh107).set_verifyhost(((*data).set.ssl.primary).verifyhost());
            }
        }
        307 => {
            arg = param.arg::<i64>();
            let mut fresh108 = &mut ((*data).set);
            (*fresh108)
                .set_doh_verifyhost(
                    (if arg & 3 as i32 as i64 != 0 {
                        1 as i32
        ...
        249 => {
            arg = param.arg::<i64>();
            let mut fresh109 = &mut ((*data).set.proxy_ssl.primary);
            (*fresh109)
                .set_verifyhost(
                    (if arg & 3 as i32 as i64 != 0 {
                        1 as i32
            ...
            if !((*data).conn).is_null() {
                let mut fresh110 = &mut ((*(*data).conn).proxy_ssl_config);
        ...
        232 => {
            if !Curl_ssl_cert_status_request() {
                ...
                let mut fresh111 = &mut ((*data).set.ssl.primary);
                (*fresh111)
                    .set_verifystatus(
                        (if 0 as i32 as i64
                            != param.arg::<i64>()
                ...
                if !((*data).conn).is_null() {
                    let mut fresh112 = &mut ((*(*data).conn).ssl_config);
                    (*fresh112)
        ...
        20108 => {
            ...
            {
                let mut fresh114 = &mut ((*data).set.ssl.fsslctx);
                *fresh114 = core::intrinsics::transmute::<* mut unsafe extern "C"  fn(_: * mut crate::src::lib::http2::Curl_easy,_: * mut core::ffi::c_void,_: * mut core::ffi::c_void,) -> u32, Option<unsafe extern "C"  fn(_: * mut crate::src::lib::http2::Curl_easy,_: * mut core::ffi::c_void,_: * mut core::ffi::c_void,) -> u32>>(
                    param
                        .arg::<
                        *mut unsafe extern "C" fn(
                            *mut CURL,
        ...
        10109 => {
            if (*Curl_ssl).supports
                & ((1 as i32) << 3 as i32) as u32 != 0
            {
                let mut fresh115 = &mut ((*data).set.ssl.fsslctxp);
        ...
        233 => {
            if !Curl_ssl_false_start() {
                ...
                let mut fresh116 = &mut ((*data).set.ssl);
                (*fresh116)
                    .set_falsestart(
                        (if 0 as i32 as i64
                            != param.arg::<i64>()
        ...
        172 => {
            ...
            {
                let mut fresh117 = &mut ((*data).set.ssl);
                (*fresh117)
                    .set_certinfo(
                        (if 0 as i32 as i64
                            != param.arg::<i64>()
        ...
        10070 => {
            let mut fresh118 = &mut ((*data).set.telnet_options);
        ...
        280 => {
            ...
            let mut fresh119 = &mut ((*data).state.ulbuf);
            *fresh119 = 0 as *mut i8;
        }
        99 => {
            let mut fresh120 = &mut ((*data).set);
            (*fresh120)
                .set_no_signal(
                    (if 0 as i32 as i64 != param.arg::<i64>() {
                        1 as i32
        ...
        10100 => {
            let mut set: * mut crate::src::lib::asyn_thread::Curl_share = 0 as *mut Curl_share;
            ...
            if !((*data).share).is_null() {
                ...
                let mut fresh125 = &mut ((*(*data).share).dirty);
                ...
                let mut fresh126 = &mut ((*data).share);
                *fresh126 = 0 as *mut Curl_share;
            }
            if !set.is_null()
                && (*set).magic == 0x7e117a1e as i32 as u32
            {
                let mut fresh127 = &mut ((*data).share);
                *fresh127 = set;
            }
            if !((*data).share).is_null() {
                Curl_share_lock(data, CURL_LOCK_DATA_SHARE, CURL_LOCK_ACCESS_SINGLE);
                let mut fresh128 = &mut ((*(*data).share).dirty);
                ::std::ptr::write_volatile(
                    fresh128,
                    (::std::ptr::read_volatile::<
                        u32,
                ...
                if (*(*data).share).specifier
                    & ((1 as i32) << CURL_LOCK_DATA_DNS as i32)
                        as u32 != 0
                {
                    let mut fresh129 = &mut ((*data).dns.hostcache);
                    *fresh129 = &mut (*(*data).share).hostcache;
                    (*data).dns.hostcachetype = HCACHE_SHARED;
                }
                if !((*(*data).share).cookies).is_null() {
                    Curl_cookie_cleanup((*data).cookies);
                    let mut fresh130 = &mut ((*data).cookies);
                ...
                if !((*(*data).share).sslsession).is_null() {
                    ...
                    let mut fresh131 = &mut ((*data).state.session);
        ...
        10103 => {
            let mut fresh133 = &mut ((*data).set.private_data);
        ...
        216 => {
            arg = param.arg::<i64>();
            let mut fresh134 = &mut ((*data).set.ssl);
            (*fresh134)
                .set_enable_beast(
                    (arg & ((1 as i32) << 0 as i32) as i64 != 0)
                        as i32 as bit,
                );
            let mut fresh135 = &mut ((*data).set.ssl);
            (*fresh135)
                .set_no_revoke(
                    (arg & ((1 as i32) << 1 as i32) as i64 != 0)
                        as i32 as bit,
                );
            let mut fresh136 = &mut ((*data).set.ssl);
            (*fresh136)
                .set_no_partialchain(
                    (arg & ((1 as i32) << 2 as i32) as i64 != 0)
                        as i32 as bit,
                );
            let mut fresh137 = &mut ((*data).set.ssl);
            (*fresh137)
                .set_revoke_best_effort(
                    (arg & ((1 as i32) << 3 as i32) as i64 != 0)
                        as i32 as bit,
                );
            let mut fresh138 = &mut ((*data).set.ssl);
            (*fresh138)
                .set_native_ca_store(
                    (arg & ((1 as i32) << 4 as i32) as i64 != 0)
                        as i32 as bit,
                );
            let mut fresh139 = &mut ((*data).set.ssl);
            (*fresh139)
        ...
        261 => {
            arg = param.arg::<i64>();
            let mut fresh140 = &mut ((*data).set.proxy_ssl);
            (*fresh140)
                .set_enable_beast(
                    (arg & ((1 as i32) << 0 as i32) as i64 != 0)
                        as i32 as bit,
                );
            let mut fresh141 = &mut ((*data).set.proxy_ssl);
            (*fresh141)
                .set_no_revoke(
                    (arg & ((1 as i32) << 1 as i32) as i64 != 0)
                        as i32 as bit,
                );
            let mut fresh142 = &mut ((*data).set.proxy_ssl);
            (*fresh142)
                .set_no_partialchain(
                    (arg & ((1 as i32) << 2 as i32) as i64 != 0)
                        as i32 as bit,
                );
            let mut fresh143 = &mut ((*data).set.proxy_ssl);
            (*fresh143)
                .set_revoke_best_effort(
                    (arg & ((1 as i32) << 3 as i32) as i64 != 0)
                        as i32 as bit,
                );
            let mut fresh144 = &mut ((*data).set.proxy_ssl);
            (*fresh144)
                .set_native_ca_store(
                    (arg & ((1 as i32) << 4 as i32) as i64 != 0)
                        as i32 as bit,
                );
            let mut fresh145 = &mut ((*data).set.proxy_ssl);
            (*fresh145)
                .set_auto_client_cert(
                    (arg & ((1 as i32) << 5 as i32) as i64 != 0)
                        as i32 as bit,
        ...
        20148 => {
            let mut fresh149 = &mut ((*data).set.fsockopt);
            *fresh149 = core::intrinsics::transmute::<* mut unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: i32,_: u32,) -> i32, Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: i32,_: u32,) -> i32>>(
                param
                    .arg::<
                    *mut unsafe extern "C" fn(
                        *mut libc::c_void,
        ...
        10149 => {
            let mut fresh150 = &mut ((*data).set.sockopt_client);
            *fresh150 = param.arg::<*mut libc::c_void>();
        }
        20163 => {
            let mut fresh151 = &mut ((*data).set.fopensocket);
            *fresh151 = core::intrinsics::transmute::<* mut unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: u32,_: * mut crate::src::lib::http2::curl_sockaddr,) -> i32, Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: u32,_: * mut crate::src::lib::http2::curl_sockaddr,) -> i32>>(
                param
                    .arg::<
                    *mut unsafe extern "C" fn(
                        *mut libc::c_void,
        ...
        10164 => {
            let mut fresh152 = &mut ((*data).set.opensocket_client);
            *fresh152 = param.arg::<*mut libc::c_void>();
        }
        20208 => {
            let mut fresh153 = &mut ((*data).set.fclosesocket);
            *fresh153 = core::intrinsics::transmute::<* mut unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: i32,) -> i32, Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: i32,) -> i32>>(
                param
                    .arg::<
                    *mut unsafe extern "C" fn(
                        *mut libc::c_void,
        ...
        20272 => {
            let mut fresh154 = &mut ((*data).set.resolver_start);
            *fresh154 = core::intrinsics::transmute::<* mut unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: * mut core::ffi::c_void,_: * mut core::ffi::c_void,) -> i32, Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: * mut core::ffi::c_void,_: * mut core::ffi::c_void,) -> i32>>(
                param
                    .arg::<
                    *mut unsafe extern "C" fn(
                        *mut libc::c_void,
        ...
        10273 => {
            let mut fresh155 = &mut ((*data).set.resolver_start_client);
            *fresh155 = param.arg::<*mut libc::c_void>();
        }
        10209 => {
            let mut fresh156 = &mut ((*data).set.closesocket_client);
            *fresh156 = param.arg::<*mut libc::c_void>();
        }
        150 => {
            let mut fresh157 = &mut ((*data).set.ssl.primary);
            (*fresh157)
                .set_sessionid(
                    (if 0 as i32 as i64 != param.arg::<i64>() {
                        1 as i32
            ...
            let mut fresh158 = &mut ((*data).set.proxy_ssl.primary);
            (*fresh158).set_sessionid(((*data).set.ssl.primary).sessionid());
        }
        157 => {
            let mut fresh159 = &mut ((*data).set);
            (*fresh159)
                .set_http_te_skip(
                    (if 0 as i32 as i64 == param.arg::<i64>() {
                        1 as i32
        ...
        10187 => {
            let mut fresh161 = &mut ((*data).set.mail_rcpt);
            *fresh161 = param.arg::<*mut curl_slist>();
        }
        290 => {
            let mut fresh162 = &mut ((*data).set);
            (*fresh162)
        ...
        189 => {
            ...
            let mut rtspreq: u32 = RTSPREQ_NONE;
            match in_rtspreq {
                1 => {
        ...
        10195 => {
            let mut fresh164 = &mut ((*data).set.rtp_out);
            *fresh164 = param.arg::<*mut libc::c_void>();
        }
        20196 => {
            let mut fresh165 = &mut ((*data).set.fwrite_rtp);
            *fresh165 = core::intrinsics::transmute::<* mut unsafe extern "C"  fn(_: * mut i8,_: u64,_: u64,_: * mut core::ffi::c_void,) -> u64, Option<unsafe extern "C"  fn(_: * mut i8,_: u64,_: u64,_: * mut core::ffi::c_void,) -> u64>>(
                param
                    .arg::<
                    *mut unsafe extern "C" fn(
                        *mut i8,
        ...
        20198 => {
            let mut fresh167 = &mut ((*data).set.chunk_bgn);
            *fresh167 = core::intrinsics::transmute::<* mut unsafe extern "C"  fn(_: * const core::ffi::c_void,_: * mut core::ffi::c_void,_: i32,) -> i64, Option<unsafe extern "C"  fn(_: * const core::ffi::c_void,_: * mut core::ffi::c_void,_: i32,) -> i64>>(
                param
                    .arg::<
                    *mut unsafe extern "C" fn(
                        *const libc::c_void,
        ...
        20199 => {
            let mut fresh168 = &mut ((*data).set.chunk_end);
            *fresh168 = core::intrinsics::transmute::<* mut unsafe extern "C"  fn(_: * mut core::ffi::c_void,) -> i64, Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,) -> i64>>(
                param
                    .arg::<
        ...
        20200 => {
            let mut fresh169 = &mut ((*data).set.fnmatch);
            *fresh169 = core::intrinsics::transmute::<* mut unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: * const i8,_: * const i8,) -> i32, Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: * const i8,_: * const i8,) -> i32>>(
                param
                    .arg::<
                    *mut unsafe extern "C" fn(
                        *mut libc::c_void,
        ...
        10201 => {
            let mut fresh170 = &mut ((*data).wildcard.customptr);
            *fresh170 = param.arg::<*mut libc::c_void>();
        }
        10202 => {
            let mut fresh171 = &mut ((*data).set.fnmatch_data);
        ...
        10240 | 10241 => {
            let mut dep: * mut crate::src::lib::http2::Curl_easy = param.arg::<*mut Curl_easy>();
            if dep.is_null()
        ...
        10243 => {
            let mut fresh180 = &mut ((*data).set.connect_to);
            *fresh180 = param.arg::<*mut curl_slist>();
        }
        265 => {
            let mut fresh181 = &mut ((*data).set);
            (*fresh181)
        ...
        20283 => {
            let mut fresh185 = &mut ((*data).set.trailer_callback);
            *fresh185 = core::intrinsics::transmute::<* mut unsafe extern "C"  fn(_: * mut * mut crate::src::lib::http2::curl_slist,_: * mut core::ffi::c_void,) -> i32, Option<unsafe extern "C"  fn(_: * mut * mut crate::src::lib::http2::curl_slist,_: * mut core::ffi::c_void,) -> i32>>(
                param
                    .arg::<
                    *mut unsafe extern "C" fn(
                        *mut *mut curl_slist,
        ...
        10284 => {
            let mut fresh186 = &mut ((*data).set.trailer_data);
            *fresh186 = param.arg::<*mut libc::c_void>();
        }
        20301 => {
            let mut fresh187 = &mut ((*data).set.hsts_read);
            *fresh187 = core::intrinsics::transmute::<* mut unsafe extern "C"  fn(_: * mut crate::src::lib::http2::Curl_easy,_: * mut crate::src::lib::http2::curl_hstsentry,_: * mut core::ffi::c_void,) -> u32, Option<unsafe extern "C"  fn(_: * mut crate::src::lib::http2::Curl_easy,_: * mut crate::src::lib::http2::curl_hstsentry,_: * mut core::ffi::c_void,) -> u32>>(
                param
                    .arg::<
                    *mut unsafe extern "C" fn(
                        *mut CURL,
        ...
        10302 => {
            let mut fresh188 = &mut ((*data).set.hsts_read_userp);
            *fresh188 = param.arg::<*mut libc::c_void>();
        }
        20303 => {
            let mut fresh189 = &mut ((*data).set.hsts_write);
            *fresh189 = core::intrinsics::transmute::<* mut unsafe extern "C"  fn(_: * mut crate::src::lib::http2::Curl_easy,_: * mut crate::src::lib::http2::curl_hstsentry,_: * mut crate::src::lib::http2::curl_index,_: * mut core::ffi::c_void,) -> u32, Option<unsafe extern "C"  fn(_: * mut crate::src::lib::http2::Curl_easy,_: * mut crate::src::lib::http2::curl_hstsentry,_: * mut crate::src::lib::http2::curl_index,_: * mut core::ffi::c_void,) -> u32>>(
                param
                    .arg::<
                    *mut unsafe extern "C" fn(
                        *mut CURL,
        ...
        10304 => {
            let mut fresh190 = &mut ((*data).set.hsts_write_userp);
            *fresh190 = param.arg::<*mut libc::c_void>();
        }
        10300 => {
            if ((*data).hsts).is_null() {
                let mut fresh191 = &mut ((*data).hsts);
        ...
        299 => {
            ...
            if arg & ((1 as i32) << 0 as i32) as i64 != 0 {
                if ((*data).hsts).is_null() {
                    let mut fresh192 = &mut ((*data).hsts);
