...
impl std::default::Default for _xmlHashTable {
    fn default() -> Self { _xmlHashTable::new() }
}
...
impl std::default::Default for _xmlHashEntry {
    fn default() -> Self { _xmlHashEntry::new() }
}
...
#[repr(C)]
pub struct stubData {
    pub hashscanner: Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: * mut core::ffi::c_void,_: * const u8,) -> ()>,
...
#[no_mangle]
pub unsafe extern "C" fn xmlHashCreate(mut size: i32) -> * mut crate::src::hash::_xmlHashTable {
...
pub unsafe extern "C" fn xmlHashScan(
    mut table: * mut crate::src::hash::_xmlHashTable,
    mut f: Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: * mut core::ffi::c_void,_: * const u8,) -> ()>,
    mut data: * mut core::ffi::c_void,
) {
...
pub unsafe extern "C" fn xmlHashScanFull(
    mut table: * mut crate::src::hash::_xmlHashTable,
    mut f: Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: * mut core::ffi::c_void,_: * const u8,_: * const u8,_: * const u8,) -> ()>,
    mut data: * mut core::ffi::c_void,
) {
    let mut i: i32 = 0;
    let mut nb: i32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn xmlHashScan3<'a1>(
...
#[no_mangle]
pub unsafe extern "C" fn xmlHashScanFull3<'a1>(
    mut table: Option<&'a1 mut crate::src::hash::_xmlHashTable>,
    mut name: * const u8,
    mut name2: * const u8,
    mut name3: * const u8,
    ...
    if !((*(borrow_mut(&mut table)).unwrap()).table).is_null() {
        ...
        while i < (*(borrow(& table)).unwrap()).size {
            if !((*((*(borrow(& table)).unwrap()).table).offset(i as isize)).valid == 0 as i32) {
                iter = &mut *((*(borrow(& table)).unwrap()).table).offset(i as isize) as *mut _xmlHashEntry;
                while !iter.is_null() {
                    next = (*iter).next;
...
#[no_mangle]
pub unsafe extern "C" fn xmlHashCopy<'a1>(
    mut table: Option<&'a1 mut crate::src::hash::_xmlHashTable>,
    mut f: Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: * const u8,) -> * mut core::ffi::c_void>,
) -> * mut crate::src::hash::_xmlHashTable {
    let mut i: i32 = 0;
    let mut iter: * mut crate::src::hash::_xmlHashEntry = 0 as *mut xmlHashEntry;
    let mut next: * mut crate::src::hash::_xmlHashEntry = 0 as *mut xmlHashEntry;
    ...
    (*ret).nbElems = (*(borrow_mut(&mut table)).unwrap()).nbElems;
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn xmlHashSize(mut table: * mut crate::src::hash::_xmlHashTable) -> i32 {
    if table.is_null() {
        return -(1 as i32);
    }
