...
extern "C" {
    ...
    fn xmlACatalogDump(catal: * mut crate::src::xmlcatalog::_xmlCatalog, out: * mut crate::src::tree::_IO_FILE);
    ...
    if add != 0 || del != 0 {
        ...
        while i < argc {
                ...
                as i32 != '-' as i32)
            {
                ...
                {
                    if sgml != 0 {
                        let mut catal: * mut crate::src::xmlcatalog::_xmlCatalog = 0 as xmlCatalogPtr;
                        let mut super_0: * mut crate::src::xmlcatalog::_xmlCatalog = 0 as xmlCatalogPtr;
