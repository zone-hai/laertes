...
impl std::default::Default for _xmlSchemaValBase64 {
    fn default() -> Self { _xmlSchemaValBase64::new() }
}
...
impl std::default::Default for _xmlSchemaValHex {
    fn default() -> Self { _xmlSchemaValHex::new() }
}
...
impl std::default::Default for _xmlSchemaValQName {
    fn default() -> Self { _xmlSchemaValQName::new() }
}
...
impl std::default::Default for _xmlSchemaValDuration {
    fn default() -> Self { _xmlSchemaValDuration::new() }
}
...
impl std::default::Default for _xmlSchemaValDate {
    fn default() -> Self { _xmlSchemaValDate::new() }
}
...
impl std::default::Default for _xmlSchemaValDecimal {
    fn default() -> Self { _xmlSchemaValDecimal::new() }
}
...
static mut xmlSchemaTypesBank: * mut crate::src::xmlsave::_xmlHashTable = 0 as *const xmlHashTable
    as xmlHashTablePtr;
static mut xmlSchemaTypeStringDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeAnyTypeDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeAnySimpleTypeDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeDecimalDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeDatetimeDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeDateDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeTimeDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeGYearDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeGYearMonthDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeGDayDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeGMonthDayDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeGMonthDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeDurationDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeFloatDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeBooleanDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeDoubleDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeHexBinaryDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeBase64BinaryDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeAnyURIDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypePositiveIntegerDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeNonPositiveIntegerDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0
    as *const xmlSchemaType as xmlSchemaTypePtr;
static mut xmlSchemaTypeNegativeIntegerDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeNonNegativeIntegerDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0
    as *const xmlSchemaType as xmlSchemaTypePtr;
static mut xmlSchemaTypeIntegerDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeLongDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeIntDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeShortDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeByteDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeUnsignedLongDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeUnsignedIntDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeUnsignedShortDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeUnsignedByteDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeNormStringDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeTokenDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeLanguageDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeNameDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeQNameDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeNCNameDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeIdDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeIdrefDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeIdrefsDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeEntityDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeEntitiesDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeNotationDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeNmtokenDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
static mut xmlSchemaTypeNmtokensDef: * mut crate::src::xmlschemas::_xmlSchemaType<'static> = 0 as *const xmlSchemaType
    as xmlSchemaTypePtr;
...
unsafe extern "C" fn xmlSchemaNewValue(mut type_0: u32) -> * mut crate::src::xmlschemastypes::_xmlSchemaVal {
...
unsafe extern "C" fn xmlSchemaNewMinLengthFacet<'a1>(
    mut value: i32,
...
unsafe extern "C" fn xmlSchemaInitBasicType<'a1, 'a2>(
    mut name: * const i8,
    mut type_0: u32,
    mut baseType: * mut crate::src::xmlschemas::_xmlSchemaType<'a1>,
) -> * mut crate::src::xmlschemas::_xmlSchemaType<'a2> where 'a1: 'a2, 'a2: 'a1 {
...
unsafe extern "C" fn xmlSchemaAddParticle() -> * mut crate::src::xmlschemas::_xmlSchemaParticle {
...
pub unsafe extern "C" fn xmlSchemaInitTypes() {
    ...
    let ref mut fresh5 = (*xmlSchemaTypeAnyTypeDef).baseType;
    *fresh5 = xmlSchemaTypeAnyTypeDef;
    ...
    let mut sequence: * mut crate::src::xmlschemas::_xmlSchemaModelGroup<'_> = 0 as *mut xmlSchemaModelGroup;
    let mut wild: * mut crate::src::xmlschemas::_xmlSchemaWildcard<'_> = 0 as *mut xmlSchemaWildcard;
    particle = xmlSchemaAddParticle();
    if particle.is_null() {
        return;
    }
    let ref mut fresh6 = (*xmlSchemaTypeAnyTypeDef).subtypes;
    *fresh6 = particle as xmlSchemaTypePtr;
    ...
    let ref mut fresh7 = (*particle).children;
    *fresh7 = sequence as xmlSchemaTreeItemPtr;
    ...
    let ref mut fresh8 = (*sequence).children;
    *fresh8 = particle as xmlSchemaTreeItemPtr;
    ...
    let ref mut fresh9 = (*particle).children;
    *fresh9 = wild as xmlSchemaTreeItemPtr;
    ...
    (*wild).any = 1 as i32;
    (*wild).processContents = 2 as i32;
    let ref mut fresh10 = (*xmlSchemaTypeAnyTypeDef).attributeWildcard;
    *fresh10 = wild;
    ...
    let ref mut fresh11 = (*xmlSchemaTypeEntitiesDef).subtypes;
    *fresh11 = xmlSchemaTypeEntityDef;
    ...
    let ref mut fresh12 = (*xmlSchemaTypeIdrefsDef).subtypes;
    *fresh12 = xmlSchemaTypeIdrefDef;
    ...
    let ref mut fresh13 = (*xmlSchemaTypeNmtokensDef).subtypes;
...
pub unsafe extern "C" fn xmlSchemaCleanupTypes() {
    ...
    let ref mut fresh14 = (*xmlSchemaTypeAnyTypeDef).subtypes;
...
#[no_mangle]
pub unsafe extern "C" fn xmlSchemaIsBuiltInTypeFacet<'a1>(
...
#[no_mangle]
pub unsafe extern "C" fn xmlSchemaGetBuiltInType<'a1>(
    mut type_0: u32,
) -> * mut crate::src::xmlschemas::_xmlSchemaType<'a1> where 'a1: 'static {
    if xmlSchemaTypesInitialized == 0 as i32 {
        xmlSchemaInitTypes();
    }
    match type_0 as u32 {
...
pub unsafe extern "C" fn xmlSchemaNewStringValue(
    ...
    (*val).type_0 = type_0;
    let ref mut fresh16 = (*val).value.str_0;
...
pub unsafe extern "C" fn xmlSchemaNewNOTATIONValue(
    ...
    let ref mut fresh17 = (*val).value.qname.name;
    *fresh17 = name as *mut xmlChar;
    if !ns.is_null() {
        let ref mut fresh18 = (*val).value.qname.uri;
...
pub unsafe extern "C" fn xmlSchemaNewQNameValue(
    ...
    let ref mut fresh19 = (*val).value.qname.name;
    *fresh19 = localName as *mut xmlChar;
    let ref mut fresh20 = (*val).value.qname.uri;
    *fresh20 = namespaceName as *mut xmlChar;
    return val;
}
#[no_mangle]
pub unsafe extern "C" fn xmlSchemaFreeValue(mut value: * mut crate::src::xmlschemastypes::_xmlSchemaVal) {
...
#[no_mangle]
pub unsafe extern "C" fn xmlSchemaGetPredefinedType<'a1>(
    mut name: * const u8,
    mut ns: * const u8,
...
#[no_mangle]
pub unsafe extern "C" fn xmlSchemaGetBuiltInListSimpleTypeItemType<'a1, 'a2, 'a3>(
    mut type_0: Option<&'a1 mut crate::src::xmlschemas::_xmlSchemaType<'a2>>,
) -> * mut crate::src::xmlschemas::_xmlSchemaType<'a3> where 'a3: 'static {
    if borrow(& type_0).is_none()
        || (*(borrow(& type_0)).unwrap()).type_0 as u32
            != XML_SCHEMA_TYPE_BASIC as i32 as u32
    {
        return 0 as xmlSchemaTypePtr;
    }
...
unsafe extern "C" fn _xmlSchemaParseGYear<'a1, 'a2>(
...
unsafe extern "C" fn _xmlSchemaParseGMonth<'a1, 'a2>(
    mut dt: Option<&'a1 mut crate::src::xmlschemastypes::_xmlSchemaValDate>,
    mut str: Option<&'a2 mut * const u8>,
) -> i32 {
    let mut cur: * const u8 = *(borrow(& str)).unwrap();
...
unsafe extern "C" fn _xmlSchemaParseGDay<'a1, 'a2>(
    mut dt: Option<&'a1 mut crate::src::xmlschemastypes::_xmlSchemaValDate>,
    mut str: Option<&'a2 mut * const u8>,
) -> i32 {
    let mut cur: * const u8 = *(borrow(& str)).unwrap();
...
unsafe extern "C" fn _xmlSchemaParseTime<'a1, 'a2>(
    mut dt: Option<&'a1 mut crate::src::xmlschemastypes::_xmlSchemaValDate>,
    mut str: Option<&'a2 mut * const u8>,
) -> i32 {
    let mut cur: * const u8 = *(borrow(& str)).unwrap();
    ...
    if ret == 0 && *cur as i32 == '.' as i32 {
        ...
        while *cur as i32 >= '0' as i32 && *cur as i32 <= '9' as i32 {
            ...
            (*(borrow_mut(&mut dt)).unwrap()).sec += (*cur as i32 - '0' as i32) as f64 * mult;
            cur = cur.offset(1);
        }
    }
    if ret != 0 as i32 {
    ...
    if !(((*(borrow(& dt)).unwrap()).hour() as i32 >= 0 as i32
        ...
        || (*(borrow(& dt)).unwrap()).hour() as i32 == 24 as i32
            && (*(borrow(& dt)).unwrap()).min() as i32 == 0 as i32
            && (*(borrow(& dt)).unwrap()).sec == 0 as i32 as f64)
        && ((*(borrow(& dt)).unwrap()).tzo() >= -(840 as i32) && (*(borrow(& dt)).unwrap()).tzo() <= 840 as i32))
    {
        return 2 as i32;
    }
    *(borrow_mut(&mut str)).unwrap() = cur;
...
unsafe extern "C" fn _xmlSchemaParseTimeZone<'a1>(
...
unsafe extern "C" fn xmlSchemaValidateDates<'a1>(
    mut type_0: u32,
        ...
        && *cur.offset(1 as i32 as isize) as i32 == '-' as i32
    {
        ...
        if *cur as i32 == '-' as i32 {
                ...
                == XML_SCHEMAS_GMONTH as i32 as u32
            {
                ...
                cur = cur.offset(1);
                ret = _xmlSchemaParseGDay(Some(&mut (*dt).value.date), Some(&mut cur));
                if ret != 0 as i32 {
                    current_block = 2568818999146507592;
                        ...
                        || *cur as i32 == '-' as i32
                    {
                    ret = _xmlSchemaParseTimeZone(&mut (*dt).value.date, Some(&mut cur));
                    if ret == 0 as i32 {
            ...
            ret = _xmlSchemaParseGMonth(Some(&mut (*dt).value.date), Some(&mut cur));
            if ret != 0 as i32 {
                current_block = 2568818999146507592;
            } else {
                if *cur as i32 == '-' as i32 {
        ...
        if *cur as i32 >= '0' as i32 && *cur as i32 <= '9' as i32 {
            ret = _xmlSchemaParseTime(Some(&mut (*dt).value.date), Some(&mut cur));
            if ret == 0 as i32 {
                if *cur as i32 == 0 as i32
                    || *cur as i32 == 'Z' as i32
                    || *cur as i32 == '+' as i32
        ...
        match current_block {
            ...
            _ => {
                cur = dateTime;
                ret = _xmlSchemaParseGYear(Some(&mut (*dt).value.date), Some(&mut cur));
                if ret != 0 as i32 {
                    current_block = 2568818999146507592;
                } else {
                    if *cur as i32 == 0 as i32
...
unsafe extern "C" fn xmlSchemaValidateDuration<'a1, 'a2>(
    mut type_0: * mut crate::src::xmlschemas::_xmlSchemaType<'a1>,
...
unsafe extern "C" fn xmlSchemaStrip(mut value: * const u8) -> * mut u8 {
...
unsafe extern "C" fn xmlSchemaValAtomicListNode<'a1, 'a2>(
    mut type_0: * mut crate::src::xmlschemas::_xmlSchemaType<'a1>,
    mut value: * const u8,
    ...
    while cur != endval {
        tmp = xmlSchemaValPredefTypeNode(type_0, cur, Option::<&'_ mut * mut crate::src::xmlschemastypes::_xmlSchemaVal>::None, node);
        if tmp != 0 as i32 {
            break;
        }
        while *cur as i32 != 0 as i32 {
...
unsafe extern "C" fn xmlSchemaParseUInt<'a1, 'a2, 'a3, 'a4>(
    mut str: Option<&'a1 mut * const u8>,
...
unsafe extern "C" fn xmlSchemaValAtomicType<'a1, 'a2>(
    mut type_0: * mut crate::src::xmlschemas::_xmlSchemaType<'a1>,
    mut value: * const u8,
    mut val: Option<&'a2 mut * mut crate::src::xmlschemastypes::_xmlSchemaVal>,
    mut node: * mut crate::src::threads::_xmlNode,
    ...
    match (*type_0).builtInType {
        ...
        45 | 46 => {
            if createStringValue != 0 && !borrow(& val).is_none() {
                ...
                if !v.is_null() {
                    let ref mut fresh30 = (*v).value.str_0;
            ...
            match current_block {
                ...
                _ => {
                    if createStringValue != 0 && !borrow(& val).is_none() {
                        ...
                        if !v.is_null() {
                            let ref mut fresh31 = (*v).value.str_0;
            ...
            match current_block {
                ...
                _ => {
                    if !borrow(& val).is_none() {
                        ...
                        if !v.is_null() {
                            let ref mut fresh32 = (*v).value.str_0;
                                            ...
                                            if len != 0 as i32 as u32 {
                                                *cptr = 0 as i32 as xmlChar;
                                                ...
                                                xmlSchemaParseUInt(
                                                    ...
                                                    Some(&mut (*v).value.decimal.lo),
                                                    Some(&mut (*v).value.decimal.mi),
                                                    Some(&mut (*v).value.decimal.hi),
                                                );
                                            }
                                        }
                                        let ref mut fresh37 = (*v).value.decimal;
                                        (*fresh37).set_sign(neg);
                                        if len == 0 as i32 as u32 {
                                            let ref mut fresh38 = (*v).value.decimal;
                                            (*fresh38).set_total(1 as i32 as u32);
                                        } else {
                                            let ref mut fresh39 = (*v).value.decimal;
                                            (*fresh39).set_total(len);
                                            if integ == !(0 as u32) {
                                                let ref mut fresh40 = (*v).value.decimal;
                                                (*fresh40).set_frac(0 as i32 as u32);
                                            } else {
                                                let ref mut fresh41 = (*v).value.decimal;
            ...
            match current_block {
                ...
                _ => {
                    if !borrow(& val).is_none() {
                        ...
                        if !v.is_null() {
                            let ref mut fresh49 = (*v).value.str_0;
        ...
        17 => {
            ...
            if xmlSchemaCheckLanguageType(value) == 1 as i32 {
                if !borrow(& val).is_none() {
                    ...
                    if !v.is_null() {
                        let ref mut fresh50 = (*v).value.str_0;
        ...
        18 => {
            if xmlValidateNMToken(value, 1 as i32) == 0 as i32 {
                if !borrow(& val).is_none() {
                    ...
                    if !v.is_null() {
                        let ref mut fresh51 = (*v).value.str_0;
        ...
        19 => {
            ret = xmlSchemaValAtomicListNode(xmlSchemaTypeNmtokenDef, value, borrow_mut(&mut val), node);
            if ret > 0 as i32 {
                ret = 0 as i32;
            } else {
                ret = 1 as i32;
        ...
        20 => {
            ...
            if ret == 0 as i32 && !borrow(& val).is_none() && !value.is_null() {
                ...
                if !v.is_null() {
                    ...
                    let ref mut fresh52 = (*v).value.str_0;
                    *fresh52 = xmlStrndup(
                        start,
                    ...
                    _ => {
                        if !borrow(& val).is_none() {
                            ...
                            if v.is_null() {
                                ...
                                if !local.is_null() {
                                    let ref mut fresh53 = (*v).value.qname.name;
                                    *fresh53 = local;
                                } else {
                                    let ref mut fresh54 = (*v).value.qname.name;
                                    *fresh54 = xmlStrdup(value);
                                }
                                if !uri.is_null() {
                                    let ref mut fresh55 = (*v).value.qname.uri;
        ...
        22 => {
            ...
            if ret == 0 as i32 && !borrow(& val).is_none() {
                ...
                if !v.is_null() {
                    let ref mut fresh56 = (*v).value.str_0;
        ...
        23 => {
            ...
            if ret == 0 as i32 && !borrow(& val).is_none() {
                ...
                if !v.is_null() {
                    let ref mut fresh57 = (*v).value.str_0;
        ...
        24 => {
            ...
            if ret == 0 as i32 && !borrow(& val).is_none() {
                ...
                if v.is_null() {
                    ...
                    let ref mut fresh58 = (*v).value.str_0;
        ...
        25 => {
            ret = xmlSchemaValAtomicListNode(xmlSchemaTypeIdrefDef, value, borrow_mut(&mut val), node);
            if ret < 0 as i32 {
                ret = 2 as i32;
            } else {
                ret = 0 as i32;
        ...
        28 => {
            ...
            if ret == 0 as i32 && !borrow(& val).is_none() {
                ...
                if !v.is_null() {
                    if !local_0.is_null() {
                        let ref mut fresh59 = (*v).value.qname.name;
                        *fresh59 = local_0;
                    } else {
                        let ref mut fresh60 = (*v).value.qname.name;
                        *fresh60 = xmlStrdup(value);
                    }
                    if !uri_0.is_null() {
                        let ref mut fresh61 = (*v).value.qname.uri;
                        *fresh61 = uri_0;
                    }
                    *(borrow_mut(&mut val)).unwrap() = v;
                    current_block = 3184724535425162531;
                ...
                _ => {
                    if !borrow(& val).is_none() {
                        ...
                        if v.is_null() {
                            ...
                            let ref mut fresh62 = (*v).value.str_0;
                ...
                if *cur_6 as i32 != 0 as i32 {
                    ...
                    if v.is_null() {
                        ...
                        if cur_6.is_null() {
                            ...
                            let ref mut fresh64 = (*v).value.hex.str_0;
                                ...
                                if !borrow(& val).is_none() {
                                    ...
                                    if v.is_null() {
                                        ...
                                        if base_0.is_null() {
                                            ...
                                            let ref mut fresh65 = (*v).value.base64.str_0;
                                            *fresh65 = base_0;
                                            cur_7 = value;
                                            while *cur_7 != 0 {
        ...
        30 | 34 | 31 | 32 | 33 => {
            ...
            if cur_8.is_null() {
                ...
                ret = xmlSchemaParseUInt(Some(&mut cur_8), Some(&mut lo), Some(&mut mi), Some(&mut hi));
                if ret < 0 as i32 {
                    current_block = 16644619750446575830;
                } else {
                    if normOnTheFly != 0 {
                            ...
                            _ => {
                                if !borrow(& val).is_none() {
                                    ...
                                    if !v.is_null() {
                                        ...
                                        let ref mut fresh66 = (*v).value.decimal;
                                        (*fresh66).set_sign(sign as u32);
                                        let ref mut fresh67 = (*v).value.decimal;
                                        (*fresh67).set_frac(0 as i32 as u32);
                                        let ref mut fresh68 = (*v).value.decimal;
        ...
        37 | 41 | 39 | 35 => {
            ...
            if cur_9.is_null() {
                ...
                ret = xmlSchemaParseUInt(Some(&mut cur_9), Some(&mut lo_0), Some(&mut mi_0), Some(&mut hi_0));
                if ret < 0 as i32 {
                    current_block = 16644619750446575830;
                } else {
                    if normOnTheFly != 0 {
                            ...
                            _ => {
                                if !borrow(& val).is_none() {
                                    ...
                                    if !v.is_null() {
                                        ...
                                        let ref mut fresh69 = (*v).value.decimal;
                                        (*fresh69).set_sign(sign_0 as u32);
                                        let ref mut fresh70 = (*v).value.decimal;
                                        (*fresh70).set_frac(0 as i32 as u32);
                                        let ref mut fresh71 = (*v).value.decimal;
        ...
        36 | 38 | 40 | 42 => {
            ...
            if cur_10.is_null() {
                ...
                ret = xmlSchemaParseUInt(Some(&mut cur_10), Some(&mut lo_1), Some(&mut mi_1), Some(&mut hi_1));
                if ret < 0 as i32 {
                    current_block = 16644619750446575830;
                } else {
                    if normOnTheFly != 0 {
                            ...
                            _ => {
                                if !borrow(& val).is_none() {
                                    ...
                                    if !v.is_null() {
                                        ...
                                        let ref mut fresh72 = (*v).value.decimal;
                                        (*fresh72).set_sign(0 as i32 as u32);
                                        let ref mut fresh73 = (*v).value.decimal;
                                        (*fresh73).set_frac(0 as i32 as u32);
                                        let ref mut fresh74 = (*v).value.decimal;
...
#[no_mangle]
pub unsafe extern "C" fn xmlSchemaValPredefTypeNode<'a1, 'a2>(
    mut type_0: * mut crate::src::xmlschemas::_xmlSchemaType<'a1>,
    mut value: * const u8,
    mut val: Option<&'a2 mut * mut crate::src::xmlschemastypes::_xmlSchemaVal>,
    mut node: * mut crate::src::threads::_xmlNode,
...
#[no_mangle]
pub unsafe extern "C" fn xmlSchemaValPredefTypeNodeNoNorm<'a1, 'a2>(
    mut type_0: * mut crate::src::xmlschemas::_xmlSchemaType<'a1>,
    mut value: * const u8,
    mut val: Option<&'a2 mut * mut crate::src::xmlschemastypes::_xmlSchemaVal>,
    mut node: * mut crate::src::threads::_xmlNode,
...
#[no_mangle]
pub unsafe extern "C" fn xmlSchemaValidatePredefinedType<'a1, 'a2>(
    mut type_0: * mut crate::src::xmlschemas::_xmlSchemaType<'a1>,
    mut value: * const u8,
    mut val: Option<&'a2 mut * mut crate::src::xmlschemastypes::_xmlSchemaVal>,
) -> i32 where 'a1: 'static {
...
unsafe extern "C" fn xmlSchemaDupVal(mut v: * mut crate::src::xmlschemastypes::_xmlSchemaVal) -> * mut crate::src::xmlschemastypes::_xmlSchemaVal {
    let mut ret: * mut crate::src::xmlschemastypes::_xmlSchemaVal = xmlSchemaNewValue((*v).type_0);
    if ret.is_null() {
        return 0 as xmlSchemaValPtr;
    }
    memcpy(
        ...
        match (*val).type_0 as u32 {
            ...
            46 | 1 | 2 | 16 | 17 | 20 | 22 | 23 | 24 | 26 | 18 | 29 => {
                ...
                if !((*val).value.str_0).is_null() {
                    let ref mut fresh76 = (*cur).value.str_0;
            ...
            21 | 28 => {
                ...
                if !((*val).value.qname.name).is_null() {
                    let ref mut fresh77 = (*cur).value.qname.name;
                    *fresh77 = xmlStrdup((*val).value.qname.name);
                }
                if !((*val).value.qname.uri).is_null() {
                    let ref mut fresh78 = (*cur).value.qname.uri;
            ...
            43 => {
                ...
                if !((*val).value.hex.str_0).is_null() {
                    let ref mut fresh79 = (*cur).value.hex.str_0;
            ...
            44 => {
                ...
                if !((*val).value.base64.str_0).is_null() {
                    let ref mut fresh80 = (*cur).value.base64.str_0;
...
unsafe extern "C" fn _xmlSchemaDateAdd(
    ...
    let mut temp: i64 = 0;
    let mut r: Option<&'_ mut crate::src::xmlschemastypes::_xmlSchemaValDate> = Option::<&'_ mut crate::src::xmlschemastypes::_xmlSchemaValDate>::None;
    let mut d: Option<&'_ mut crate::src::xmlschemastypes::_xmlSchemaValDate> = Option::<&'_ mut crate::src::xmlschemastypes::_xmlSchemaValDate>::None;
    let mut u: Option<&'_ mut crate::src::xmlschemastypes::_xmlSchemaValDuration> = Option::<&'_ mut crate::src::xmlschemastypes::_xmlSchemaValDuration>::None;
    ...
    r = Some(&mut (*ret).value.date);
    d = Some(&mut (*tmp).value.date);
    u = Some(&mut (*dur).value.dur);
    ...
    if (*(borrow(& r)).unwrap()).year == 0 as i32 as i64 {
        if (*(borrow(& d)).unwrap()).year > 0 as i32 as i64 {
            let ref mut fresh82 = (*(borrow_mut(&mut r)).unwrap()).year;
            *fresh82 -= 1;
        } else {
            let ref mut fresh83 = (*(borrow_mut(&mut r)).unwrap()).year;
            *fresh83 += 1;
        }
    }
    (*(borrow_mut(&mut r)).unwrap()).set_tzo((*(borrow(& d)).unwrap()).tzo());
    (*(borrow_mut(&mut r)).unwrap()).set_tz_flag((*(borrow(& d)).unwrap()).tz_flag());
    (*(borrow_mut(&mut r)).unwrap()).sec = (*(borrow(& d)).unwrap()).sec + (*(borrow(& u)).unwrap()).sec;
    carry = floor(
        (*(borrow(& r)).unwrap()).sec as i64 as f64 / 60 as i32 as f64,
    ) as i64;
    if (*(borrow(& r)).unwrap()).sec != 0.0f64 {
        (*(borrow_mut(&mut r)).unwrap()).sec = (*(borrow(& r)).unwrap()).sec - floor((*(borrow(& r)).unwrap()).sec / 60.0f64) * 60.0f64;
    }
    ...
    if (*(borrow(& r)).unwrap()).year != 0 as i32 as i64
        ...
        && (*(borrow(& d)).unwrap()).day()
            > (if (*(borrow(& r)).unwrap()).year % 4 as i32 as i64
                == 0 as i32 as i64
                && (*(borrow(& r)).unwrap()).year % 100 as i32 as i64
                    != 0 as i32 as i64
                || (*(borrow(& r)).unwrap()).year % 400 as i32 as i64
                    == 0 as i32 as i64
            {
    ...
    {
        tempdays = (if (*(borrow(& r)).unwrap()).year % 4 as i32 as i64
            == 0 as i32 as i64
            && (*(borrow(& r)).unwrap()).year % 100 as i32 as i64
                != 0 as i32 as i64
            || (*(borrow(& r)).unwrap()).year % 400 as i32 as i64
    ...
    loop {
        if tempdays < 1 as i32 as i64 {
            let mut tmon: i64 = (((*(borrow(& r)).unwrap()).mon() as i32 - 1 as i32
                - 1 as i32) as f64
                - floor(
                    ((*(borrow(& r)).unwrap()).mon() as i32 - 1 as i32 - 1 as i32)
                        as f64
                        / (13 as i32 - 1 as i32) as f64,
                ) * (13 as i32 - 1 as i32) as f64
                ...
                && tempdays
                    > (if (*(borrow(& r)).unwrap()).year % 4 as i32 as i64
                        ...
                        || (*(borrow(& r)).unwrap()).year % 400 as i32 as i64
                            == 0 as i32 as i64
                    {
                        daysInMonthLeap[((*(borrow(& r)).unwrap()).mon() as i32 - 1 as i32)
                            as usize]
                    } else {
                        daysInMonth[((*(borrow(& r)).unwrap()).mon() as i32 - 1 as i32)
                            as usize]
                    }) as i64)
            {
                break;
        ...
        if (*(borrow(& r)).unwrap()).year == 0 as i32 as i64 {
            if temp < 1 as i32 as i64 {
                let ref mut fresh84 = (*(borrow_mut(&mut r)).unwrap()).year;
                *fresh84 -= 1;
            } else {
                let ref mut fresh85 = (*(borrow_mut(&mut r)).unwrap()).year;
                *fresh85 += 1;
            }
        }
    }
    ...
    {
        if (*(borrow(& r)).unwrap()).hour() as i32 != 0 || (*(borrow(& r)).unwrap()).min() as i32 != 0
...
unsafe extern "C" fn _xmlSchemaDateCastYMToDays(dt: * mut crate::src::xmlschemastypes::_xmlSchemaVal) -> i64 {
    let mut ret: i64 = 0;
    let mut mon: i32 = 0;
...
unsafe extern "C" fn xmlSchemaNormLen(mut value: * const u8) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn xmlSchemaGetFacetValueAsULong<'a1>(
...
#[no_mangle]
pub unsafe extern "C" fn xmlSchemaValidateListSimpleTypeFacet<'a1, 'a2>(
    mut facet: * mut crate::src::xmlschemas::_xmlSchemaFacet<'a1>,
    mut value: * const u8,
    mut actualLen: u64,
        ...
        == XML_SCHEMA_FACET_LENGTH as i32 as u32
    {
        if actualLen != (*(*facet).val).value.decimal.lo {
            if !borrow(& expectedLen).is_none() {
                *(borrow_mut(&mut expectedLen)).unwrap() = (*(*facet).val).value.decimal.lo;
            }
...
unsafe extern "C" fn xmlSchemaValidateLengthFacetInternal<'a1, 'a2>(
    mut facet: * mut crate::src::xmlschemas::_xmlSchemaFacet<'a1>,
    mut valType: u32,
    mut value: * const u8,
    mut val: * mut crate::src::xmlschemastypes::_xmlSchemaVal,
...
#[no_mangle]
pub unsafe extern "C" fn xmlSchemaValidateLengthFacet<'a1, 'a2, 'a3, 'a4>(
    mut type_0: Option<&'a1 mut crate::src::xmlschemas::_xmlSchemaType<'a2>>,
...
#[no_mangle]
pub unsafe extern "C" fn xmlSchemaValidateLengthFacetWhtsp<'a1, 'a2>(
    mut facet: * mut crate::src::xmlschemas::_xmlSchemaFacet<'a1>,
    mut valType: u32,
    mut value: * const u8,
    mut val: * mut crate::src::xmlschemastypes::_xmlSchemaVal,
    ...
    return xmlSchemaValidateLengthFacetInternal(facet, valType, value, val, borrow_mut(&mut length), ws);
}
unsafe extern "C" fn xmlSchemaValidateFacetInternal<'a1>(
    mut facet: * mut crate::src::xmlschemas::_xmlSchemaFacet<'a1>,
    mut fws: u32,
    mut valType: u32,
    mut value: * const u8,
...
#[no_mangle]
pub unsafe extern "C" fn xmlSchemaValidateFacet<'a1, 'a2, 'a3>(
...
#[no_mangle]
pub unsafe extern "C" fn xmlSchemaValidateFacetWhtsp<'a1>(
    mut facet: * mut crate::src::xmlschemas::_xmlSchemaFacet<'a1>,
    mut fws: u32,
    mut valType: u32,
    mut value: * const u8,
...
#[no_mangle]
pub unsafe extern "C" fn xmlSchemaGetCanonValue<'a1>(
    mut val: * mut crate::src::xmlschemastypes::_xmlSchemaVal,
    ...
    *(borrow_mut(&mut retValue)).unwrap() = 0 as *const xmlChar;
    match (*val).type_0 as u32 {
        1 => {
            if ((*val).value.str_0).is_null() {
                *(borrow_mut(&mut retValue)).unwrap() = xmlStrdup(
                    b"\0" as *const u8 as *const i8 as *mut xmlChar,
                );
            } else {
                *(borrow_mut(&mut retValue)).unwrap() = xmlStrdup((*val).value.str_0 as *const xmlChar);
            }
        }
        2 => {
            if ((*val).value.str_0).is_null() {
                ...
                *(borrow_mut(&mut retValue)).unwrap() = xmlSchemaWhiteSpaceReplace(
        ...
        16 | 17 | 18 | 20 | 22 | 23 | 24 | 26 | 28 | 29 => {
            ...
            *(borrow_mut(&mut retValue)).unwrap() = xmlSchemaCollapseString((*val).value.str_0);
            if (*(borrow(& retValue)).unwrap()).is_null() {
                *(borrow_mut(&mut retValue)).unwrap() = xmlStrdup((*val).value.str_0 as *const xmlChar);
            }
        }
        21 => {
            if ((*val).value.qname.uri).is_null() {
                *(borrow_mut(&mut retValue)).unwrap() = xmlStrdup((*val).value.qname.name);
                return 0 as i32;
            } else {
                *(borrow_mut(&mut retValue)).unwrap() = xmlStrdup(
                    b"{\0" as *const u8 as *const i8 as *mut xmlChar,
                );
                *(borrow_mut(&mut retValue)).unwrap() = xmlStrcat(*(borrow_mut(&mut retValue)).unwrap() as *mut xmlChar, (*val).value.qname.uri);
        ...
        3 => {
                ...
                && (*val).value.decimal.lo == 0 as i32 as u64
            {
                *(borrow_mut(&mut retValue)).unwrap() = xmlStrdup(
                ...
                let mut dec: crate::src::xmlschemastypes::_xmlSchemaValDecimal = (*val).value.decimal;
        ...
        30 | 34 | 31 | 32 | 33 | 37 | 41 | 39 | 35 | 36 | 38 | 40 | 42 => {
                ...
                && (*val).value.decimal.lo == 0 as i32 as u64
            {
                *(borrow_mut(&mut retValue)).unwrap() = xmlStrdup(
                ...
                let mut dec_0: crate::src::xmlschemastypes::_xmlSchemaValDecimal = (*val).value.decimal;
                let mut bufsize_0: i32 = dec_0.total() as i32
                    + 1 as i32;
                if dec_0.sign() != 0 {
                    bufsize_0 += 1;
                }
                *(borrow_mut(&mut retValue)).unwrap() = xmlMalloc
        ...
        4 => {
            ...
            if ((*val).value.date).tz_flag() != 0 {
                let mut norm: * mut crate::src::xmlschemastypes::_xmlSchemaVal = 0 as *mut xmlSchemaVal;
        ...
        10 => {
            ...
            if ((*val).value.date).tz_flag() != 0 {
                let mut norm_0: * mut crate::src::xmlschemastypes::_xmlSchemaVal = 0 as *mut xmlSchemaVal;
        ...
        11 => {
            ...
            if ((*val).value.date).tz_flag() != 0 {
                let mut norm_1: * mut crate::src::xmlschemastypes::_xmlSchemaVal = 0 as *mut xmlSchemaVal;
        ...
        43 => {
            *(borrow_mut(&mut retValue)).unwrap() = xmlStrdup((*val).value.hex.str_0);
        }
        44 => {
            *(borrow_mut(&mut retValue)).unwrap() = xmlStrdup((*val).value.base64.str_0);
        }
        13 => {
...
#[no_mangle]
pub unsafe extern "C" fn xmlSchemaGetCanonValueWhtsp<'a1>(
    mut val: * mut crate::src::xmlschemastypes::_xmlSchemaVal,
    mut retValue: Option<&'a1 mut * const u8>,
    mut ws: u32,
) -> i32 {
        ...
        1 => {
            if ((*val).value.str_0).is_null() {
                ...
                *(borrow_mut(&mut retValue)).unwrap() = xmlSchemaCollapseString((*val).value.str_0);
                    ...
                    == XML_SCHEMA_WHITESPACE_REPLACE as i32 as u32
                {
                *(borrow_mut(&mut retValue)).unwrap() = xmlSchemaWhiteSpaceReplace((*val).value.str_0);
            }
            if (*(borrow_mut(&mut retValue)).unwrap()).is_null() {
                *(borrow_mut(&mut retValue)).unwrap() = xmlStrdup((*val).value.str_0);
            }
        }
        2 => {
            if ((*val).value.str_0).is_null() {
