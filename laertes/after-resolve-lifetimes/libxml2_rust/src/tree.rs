...
extern "C" {
    ...
    fn __xmlRegisterNodeDefaultValue() -> * mut Option<unsafe extern "C"  fn(_: * mut crate::src::threads::_xmlNode,) -> ()>;
    ...
    fn xmlCopyEntitiesTable(table: * mut crate::src::xmlsave::_xmlHashTable) -> * mut crate::src::xmlsave::_xmlHashTable;
    ...
    fn xmlBufFromBuffer(buffer: * mut crate::src::tree::_xmlBuffer) -> * mut crate::src::xmlstring::_xmlBuf;
    fn xmlBufBackToBuffer(buf: * mut crate::src::xmlstring::_xmlBuf) -> * mut crate::src::tree::_xmlBuffer;
    fn xmlEncodeAttributeEntities(doc: * mut crate::src::threads::_xmlDoc, input: * const u8) -> * mut u8;
}
...
pub struct _xmlSAXHandler {
    ...
    pub resolveEntity: Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: * const u8,_: * const u8,) -> * mut crate::src::threads::_xmlParserInput>,
    pub getEntity: Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: * const u8,) -> * mut crate::src::threads::_xmlEntity>,
    ...
    pub attributeDecl: Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: * const u8,_: * const u8,_: i32,_: i32,_: * const u8,_: * mut crate::src::threads::_xmlEnumeration,) -> ()>,
    pub elementDecl: Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: * const u8,_: i32,_: * mut crate::src::threads::_xmlElementContent,) -> ()>,
    pub unparsedEntityDecl: Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: * const u8,_: * const u8,_: * const u8,_: * const u8,) -> ()>,
    pub setDocumentLocator: Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: * mut crate::src::threads::_xmlSAXLocator,) -> ()>,
    ...
    pub getParameterEntity: Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: * const u8,) -> * mut crate::src::threads::_xmlEntity>,
    ...
    pub serror: Option<unsafe extern "C"  fn(_: * mut core::ffi::c_void,_: * mut crate::src::threads::_xmlError,) -> ()>,
}
impl _xmlSAXHandler {
    pub const fn new() -> Self {
        _xmlSAXHandler {
...
pub struct _xmlDOMWrapCtxt<'a> {
    ...
    pub getNsForNodeFunc: Option<unsafe extern "C"  fn(_: * mut crate::src::tree::_xmlDOMWrapCtxt<'a>,_: * mut crate::src::threads::_xmlNode,_: * const u8,_: * const u8,) -> * mut crate::src::threads::_xmlNs>,
}
...
impl<'a> std::default::Default for _xmlDOMWrapCtxt<'a> {
    fn default() -> Self { _xmlDOMWrapCtxt::new() }
}

pub type xmlDOMWrapAcquireNsFunction = Option<unsafe extern "C"  fn(_: * mut crate::src::tree::_xmlDOMWrapCtxt,_: * mut crate::src::threads::_xmlNode,_: * const u8,_: * const u8,) -> * mut crate::src::threads::_xmlNs>;
...
impl std::default::Default for xmlNsMapItem {
    fn default() -> Self { xmlNsMapItem::new() }
}
...
#[no_mangle]
pub unsafe extern "C" fn xmlSplitQName2<'a1>(
    mut name: * const u8,
    ...
    *(borrow_mut(&mut prefix)).unwrap() = xmlStrndup(name, len);
    ...
    if ret.is_null() {
        xmlTreeErrMemory(b"QName split\0" as *const u8 as *const i8);
        if !(*(borrow_mut(&mut prefix)).unwrap()).is_null() {
            xmlFree.expect("non-null function pointer")(*(borrow_mut(&mut prefix)).unwrap() as *mut libc::c_void);
            *(borrow_mut(&mut prefix)).unwrap() = 0 as *mut xmlChar;
        }
        return 0 as *mut xmlChar;
    }
...
#[no_mangle]
pub unsafe extern "C" fn xmlSplitQName3<'a1>(
    mut name: * const u8,
...
#[no_mangle]
pub unsafe extern "C" fn xmlGetBufferAllocationScheme() -> u32 {
    ...
    if !node.is_null() {
        if ((*node).nsDef).is_null() {
            ...
            *fresh2 = cur;
            ...
            let mut prev: * mut crate::src::threads::_xmlNs = (*node).nsDef;
...
#[no_mangle]
pub unsafe extern "C" fn xmlSetNs<'a1>(mut node: Option<&'a1 mut crate::src::threads::_xmlNode>, mut ns: * mut crate::src::threads::_xmlNs) {
    if borrow(& node).is_none() {
        return;
    }
    if (*(borrow(& node)).unwrap()).type_0 as u32 == XML_ELEMENT_NODE as i32 as u32
        || (*(borrow(& node)).unwrap()).type_0 as u32
            == XML_ATTRIBUTE_NODE as i32 as u32
    {
        let ref mut fresh4 = (*(borrow_mut(&mut node)).unwrap()).ns;
        *fresh4 = ns;
    }
}
#[no_mangle]
pub unsafe extern "C" fn xmlFreeNs(mut cur: * mut crate::src::threads::_xmlNs) {
    if cur.is_null() {
        return;
    }
    if !((*cur).href).is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn xmlFreeNsList(mut cur: * mut crate::src::threads::_xmlNs) {
...
#[no_mangle]
pub unsafe extern "C" fn xmlGetIntSubset(mut doc: * const crate::src::threads::_xmlDoc) -> * mut crate::src::threads::_xmlDtd {
...
#[no_mangle]
pub unsafe extern "C" fn xmlFreeDtd(mut cur: * mut crate::src::threads::_xmlDtd) {
    ...
    if !((*cur).children).is_null() {
        let mut next: * mut crate::src::threads::_xmlNode = 0 as *mut xmlNode;
        let mut c: * mut crate::src::threads::_xmlNode = (*cur).children;
        while !c.is_null() {
            next = (*c).next;
            if (*c).type_0 as u32
...
#[no_mangle]
pub unsafe extern "C" fn xmlNewDoc(mut version: * const u8) -> * mut crate::src::threads::_xmlDoc {
...
#[no_mangle]
pub unsafe extern "C" fn xmlFreeDoc(mut cur: * mut crate::src::threads::_xmlDoc) {
                                    ...
                                    as u32
                        {
                            ...
                            if node.is_null() {
                                ...
                                if !ent.is_null() && ((*ent).children).is_null() {
                                    let mut temp: * mut crate::src::threads::_xmlNode = 0 as *mut xmlNode;
    ...
    if !node.is_null() {
        if ((*node).properties).is_null() {
            ...
            *fresh58 = cur;
            ...
            let mut prev: * mut crate::src::threads::_xmlAttr = (*node).properties;
            while !((*prev).next).is_null() {
                prev = (*prev).next;
            }
...
#[no_mangle]
pub unsafe extern "C" fn xmlFreePropList(mut cur: * mut crate::src::threads::_xmlAttr) {
...
#[no_mangle]
pub unsafe extern "C" fn xmlFreeProp(mut cur: * mut crate::src::threads::_xmlAttr) {
    let mut dict: * mut crate::src::xpointer::_xmlDict = 0 as xmlDictPtr;
    if cur.is_null() {
        return;
    }
...
#[no_mangle]
pub unsafe extern "C" fn xmlRemoveProp(mut cur: * mut crate::src::threads::_xmlAttr) -> i32 {
        ...
        *fresh80 = doc;
        if !content.is_null() {
            ...
            *fresh81 = xmlStringGetNodeList(doc as *const xmlDoc, content);
            if !cur.is_null() {
                let mut ulccur: * mut crate::src::threads::_xmlNode = (*cur).children;
                if ulccur.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn xmlNewDocFragment(mut doc: * mut crate::src::threads::_xmlDoc) -> * mut crate::src::threads::_xmlNode {
    let mut cur: * mut crate::src::threads::_xmlNode = 0 as *mut xmlNode;
    cur = xmlMalloc
        .expect(
            "non-null function pointer",
...
#[no_mangle]
pub unsafe extern "C" fn xmlNewText(mut content: * const u8) -> * mut crate::src::threads::_xmlNode {
    let mut cur: * mut crate::src::threads::_xmlNode = 0 as *mut xmlNode;
    cur = xmlMalloc
        .expect(
            "non-null function pointer",
...
#[no_mangle]
pub unsafe extern "C" fn xmlNewComment(mut content: * const u8) -> * mut crate::src::threads::_xmlNode {
    let mut cur: * mut crate::src::threads::_xmlNode = 0 as *mut xmlNode;
    cur = xmlMalloc
        .expect(
            "non-null function pointer",
...
#[no_mangle]
pub unsafe extern "C" fn xmlSetTreeDoc(mut tree: * mut crate::src::threads::_xmlNode, mut doc: * mut crate::src::threads::_xmlDoc) {
    ...
    if (*tree).doc != doc {
        let mut oldTreeDict: * mut crate::src::xpointer::_xmlDict = if !((*tree).doc).is_null() {
            (*(*tree).doc).dict
        } else {
            0 as *mut _xmlDict
        };
            ...
            == XML_ELEMENT_NODE as i32 as u32
        {
            ...
            while !prop.is_null() {
                ...
                if (*prop).doc != doc {
                    let mut oldPropDict: * mut crate::src::xpointer::_xmlDict = if !((*prop).doc).is_null() {
                        (*(*prop).doc).dict
                    } else {
                        0 as *mut _xmlDict
                    };
...
#[no_mangle]
pub unsafe extern "C" fn xmlSetListDoc(mut list: * mut crate::src::threads::_xmlNode, mut doc: * mut crate::src::threads::_xmlDoc) {
    let mut cur: * mut crate::src::threads::_xmlNode = 0 as *mut xmlNode;
    if list.is_null()
        || (*list).type_0 as u32
            == XML_NAMESPACE_DECL as i32 as u32
    ...
    if (*cur).type_0 as u32 == XML_ATTRIBUTE_NODE as i32 as u32
    {
        ...
        if ((*parent).properties).is_null() {
            ...
            *fresh173 = cur as xmlAttrPtr;
            ...
            let mut lastattr_0: * mut crate::src::threads::_xmlAttr = (*parent).properties;
...
#[no_mangle]
pub unsafe extern "C" fn xmlGetLastChild<'a1>(mut parent: Option<&'a1 crate::src::threads::_xmlNode>) -> * mut crate::src::threads::_xmlNode {
    if (parent).clone().is_none()
        || (*((parent).clone()).unwrap()).type_0 as u32
            == XML_NAMESPACE_DECL as i32 as u32
    {
        return 0 as xmlNodePtr;
    }
...
#[no_mangle]
pub unsafe extern "C" fn xmlChildElementCount<'a1>(mut parent: Option<&'a1 mut crate::src::threads::_xmlNode>) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn xmlFirstElementChild<'a1>(mut parent: Option<&'a1 mut crate::src::threads::_xmlNode>) -> * mut crate::src::threads::_xmlNode {
    let mut cur: * mut crate::src::threads::_xmlNode = 0 as xmlNodePtr;
    if borrow(& parent).is_none() {
        return 0 as xmlNodePtr;
    }
...
#[no_mangle]
pub unsafe extern "C" fn xmlLastElementChild<'a1>(mut parent: Option<&'a1 mut crate::src::threads::_xmlNode>) -> * mut crate::src::threads::_xmlNode {
    let mut cur: * mut crate::src::threads::_xmlNode = 0 as xmlNodePtr;
    if borrow(& parent).is_none() {
        return 0 as xmlNodePtr;
    }
...
#[no_mangle]
pub unsafe extern "C" fn xmlPreviousElementSibling(mut node: * mut crate::src::threads::_xmlNode) -> * mut crate::src::threads::_xmlNode {
    if node.is_null() {
        return 0 as xmlNodePtr;
    }
...
#[no_mangle]
pub unsafe extern "C" fn xmlNextElementSibling(mut node: * mut crate::src::threads::_xmlNode) -> * mut crate::src::threads::_xmlNode {
    if node.is_null() {
        return 0 as xmlNodePtr;
    }
    match (*node).type_0 as u32 {
...
#[no_mangle]
pub unsafe extern "C" fn xmlFreeNodeList(mut cur: * mut crate::src::threads::_xmlNode) {
    let mut next: * mut crate::src::threads::_xmlNode = 0 as *mut xmlNode;
    let mut parent: * mut crate::src::threads::_xmlNode = 0 as *mut xmlNode;
    let mut dict: * mut crate::src::xpointer::_xmlDict = 0 as xmlDictPtr;
...
#[no_mangle]
pub unsafe extern "C" fn xmlFreeNode(mut cur: * mut crate::src::threads::_xmlNode) {
    let mut dict: * mut crate::src::xpointer::_xmlDict = 0 as xmlDictPtr;
    if cur.is_null() {
        return;
    }
...
#[no_mangle]
pub unsafe extern "C" fn xmlUnlinkNode(mut cur: * mut crate::src::threads::_xmlNode) {
    if cur.is_null() {
        return;
    }
    if (*cur).type_0 as u32 == XML_NAMESPACE_DECL as i32 as u32
...
#[no_mangle]
pub unsafe extern "C" fn xmlCopyNamespace(mut cur: * mut crate::src::threads::_xmlNs) -> * mut crate::src::threads::_xmlNs {
...
#[no_mangle]
pub unsafe extern "C" fn xmlCopyNamespaceList(mut cur: * mut crate::src::threads::_xmlNs) -> * mut crate::src::threads::_xmlNs {
    ...
    if !(extended == 0) {
            ...
            == XML_ENTITY_REF_NODE as i32 as u32
        {
            ...
            *fresh229 = (*ret).children;
            ...
            insert = ret;
            while !cur.is_null() {
                let mut copy: * mut crate::src::threads::_xmlNode = xmlStaticCopyNode(
                    cur,
                    doc,
                    insert,
                    2 as i32,
...
pub unsafe extern "C" fn xmlDocCopyNodeList(
    ...
    let mut ret: * mut crate::src::threads::_xmlNode = xmlStaticCopyNodeList(node, doc, 0 as xmlNodePtr);
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn xmlCopyNodeList(mut node: * mut crate::src::threads::_xmlNode) -> * mut crate::src::threads::_xmlNode {
    let mut ret: * mut crate::src::threads::_xmlNode = xmlStaticCopyNodeList(
        node,
        0 as xmlDocPtr,
        0 as xmlNodePtr,
    );
...
#[no_mangle]
pub unsafe extern "C" fn xmlCopyDtd(mut dtd: * mut crate::src::threads::_xmlDtd) -> * mut crate::src::threads::_xmlDtd {
...
#[no_mangle]
pub unsafe extern "C" fn xmlGetLineNo(mut node: * const crate::src::threads::_xmlNode) -> i64 {
    return xmlGetLineNoInternal(node, 0 as i32);
}
#[no_mangle]
pub unsafe extern "C" fn xmlGetNodePath(mut node: * const crate::src::threads::_xmlNode) -> * mut u8 {
...
#[no_mangle]
pub unsafe extern "C" fn xmlDocGetRootElement(mut doc: * const crate::src::threads::_xmlDoc) -> * mut crate::src::threads::_xmlNode {
    let mut ret: * mut crate::src::threads::_xmlNode = 0 as *mut xmlNode;
    if doc.is_null() {
        return 0 as xmlNodePtr;
    }
...
#[no_mangle]
pub unsafe extern "C" fn xmlNodeSetLang(mut cur: * mut crate::src::threads::_xmlNode, mut lang: * const u8) {
    let mut ns: * mut crate::src::threads::_xmlNs = 0 as *mut xmlNs;
    if cur.is_null() {
        return;
    }
...
#[no_mangle]
pub unsafe extern "C" fn xmlNodeGetLang(mut cur: * const crate::src::threads::_xmlNode) -> * mut u8 {
...
#[no_mangle]
pub unsafe extern "C" fn xmlNodeSetName<'a1>(mut cur: Option<&'a1 mut crate::src::threads::_xmlNode>, mut name: * const u8) {
    let mut doc: * mut crate::src::threads::_xmlDoc = 0 as *mut xmlDoc;
    ...
    if !dict.is_null() {
        if !((*(borrow(& cur)).unwrap()).name).is_null() && xmlDictOwns(dict, (*(borrow(& cur)).unwrap()).name) == 0 {
            freeme = (*(borrow(& cur)).unwrap()).name;
        }
        let ref mut fresh265 = (*(borrow_mut(&mut cur)).unwrap()).name;
        *fresh265 = xmlDictLookup(dict, name, -(1 as i32));
    } else {
        if !((*(borrow_mut(&mut cur)).unwrap()).name).is_null() {
            freeme = (*(borrow(& cur)).unwrap()).name;
        }
        let ref mut fresh266 = (*(borrow_mut(&mut cur)).unwrap()).name;
...
#[no_mangle]
pub unsafe extern "C" fn xmlNodeSetBase(mut cur: * mut crate::src::threads::_xmlNode, mut uri: * const u8) {
    let mut ns: * mut crate::src::threads::_xmlNs = 0 as *mut xmlNs;
...
pub unsafe extern "C" fn xmlBufGetNodeContent(
    ...
    match (*cur).type_0 as u32 {
        ...
        2 => {
            ...
            let mut tmp_0: * mut crate::src::threads::_xmlNode = (*attr).children;
            while !tmp_0.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn xmlNodeGetContent(mut cur: * const crate::src::threads::_xmlNode) -> * mut u8 {
    if cur.is_null() {
        return 0 as *mut xmlChar;
    }
    match (*cur).type_0 as u32 {
...
unsafe extern "C" fn xmlTreeEnsureXMLDecl(mut doc: * mut crate::src::threads::_xmlDoc) -> * mut crate::src::threads::_xmlNs {
    if doc.is_null() {
        return 0 as xmlNsPtr;
    }
    if !((*doc).oldNs).is_null() {
...
unsafe extern "C" fn xmlGetPropNodeInternal(
    ...
    if !((*node).doc).is_null() && !((*(*node).doc).intSubset).is_null() {
        let mut doc: * mut crate::src::threads::_xmlDoc = (*node).doc;
...
#[no_mangle]
pub unsafe extern "C" fn xmlUnsetNsProp<'a1>(
    mut node: * mut crate::src::threads::_xmlNode,
    ...
    prop = xmlGetPropNodeInternal(
        node as *const xmlNode,
        name,
        if !borrow(& ns).is_none() { (*(borrow(& ns)).unwrap()).href } else { 0 as *const xmlChar },
        0 as i32,
    );
    if prop.is_null() {
        return -(1 as i32);
...
#[no_mangle]
pub unsafe extern "C" fn xmlNodeIsText<'a1>(mut node: Option<&'a1 crate::src::threads::_xmlNode>) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn xmlIsBlankNode(mut node: * const crate::src::threads::_xmlNode) -> i32 {
    let mut cur: * const u8 = 0 as *const xmlChar;
    if node.is_null() {
        return 0 as i32;
    }
...
#[no_mangle]
pub unsafe extern "C" fn xmlBufferCreate() -> * mut crate::src::tree::_xmlBuffer {
...
#[no_mangle]
pub unsafe extern "C" fn xmlBufferCreateSize(mut size: u64) -> * mut crate::src::tree::_xmlBuffer {
    let mut ret: * mut crate::src::tree::_xmlBuffer = 0 as *mut xmlBuffer;
    if size
...
#[no_mangle]
pub unsafe extern "C" fn xmlBufferDetach<'a1>(mut buf: Option<&'a1 mut crate::src::tree::_xmlBuffer>) -> * mut u8 {
    let mut ret: * mut u8 = 0 as *mut xmlChar;
    ...
    let ref mut fresh334 = (*(borrow_mut(&mut buf)).unwrap()).content;
...
#[no_mangle]
pub unsafe extern "C" fn xmlBufferFree(mut buf: * mut crate::src::tree::_xmlBuffer) {
    if buf.is_null() {
        return;
    }
...
#[no_mangle]
pub unsafe extern "C" fn xmlBufferEmpty(mut buf: * mut crate::src::tree::_xmlBuffer) {
    if buf.is_null() {
        return;
    }
...
#[no_mangle]
pub unsafe extern "C" fn xmlBufferGrow<'a1>(
    ...
    {
        let mut start_buf: u64 = ((*(borrow(& buf)).unwrap()).content).offset_from((*(borrow(& buf)).unwrap()).contentIO)
            as i64 as size_t;
        newbuf = xmlRealloc
            .expect(
                "non-null function pointer",
        ...
        let ref mut fresh344 = (*(borrow_mut(&mut buf)).unwrap()).contentIO;
        *fresh344 = newbuf;
        let ref mut fresh345 = (*(borrow_mut(&mut buf)).unwrap()).content;
        *fresh345 = newbuf.offset(start_buf as isize);
    } else {
        newbuf = xmlRealloc
            .expect(
                "non-null function pointer",
            )((*(borrow_mut(&mut buf)).unwrap()).content as *mut libc::c_void, size as size_t) as *mut xmlChar;
        if newbuf.is_null() {
            xmlTreeErrMemory(b"growing buffer\0" as *const u8 as *const i8);
            return -(1 as i32);
        }
        let ref mut fresh346 = (*(borrow_mut(&mut buf)).unwrap()).content;
        *fresh346 = newbuf;
    }
...
#[no_mangle]
pub unsafe extern "C" fn xmlBufferDump<'a1>(
...
#[no_mangle]
pub unsafe extern "C" fn xmlBufferContent<'a1>(mut buf: Option<&'a1 crate::src::tree::_xmlBuffer>) -> * const u8 {
...
#[no_mangle]
pub unsafe extern "C" fn xmlBufferLength<'a1>(mut buf: Option<&'a1 crate::src::tree::_xmlBuffer>) -> i32 {
    if (buf).clone().is_none() {
        return 0 as i32;
    }
...
#[no_mangle]
pub unsafe extern "C" fn xmlGetDocCompressMode<'a1>(mut doc: Option<&'a1 crate::src::threads::_xmlDoc>) -> i32 {
...
unsafe extern "C" fn xmlDOMWrapNsMapFree(mut nsmap: * mut crate::src::tree::xmlNsMap) {
...
unsafe extern "C" fn xmlDOMWrapNsMapAddItem<'a1>(
...
#[no_mangle]
pub unsafe extern "C" fn xmlDOMWrapNewCtxt<'a1>() -> * mut crate::src::tree::_xmlDOMWrapCtxt<'a1> {
...
#[no_mangle]
pub unsafe extern "C" fn xmlDOMWrapFreeCtxt<'a1>(mut ctxt: * mut crate::src::tree::_xmlDOMWrapCtxt<'a1>) {
    if ctxt.is_null() {
        return;
    }
...
unsafe extern "C" fn xmlDOMWrapNSNormGatherInScopeNs<'a1>(
    ...
    while !cur.is_null() && cur != (*cur).doc as xmlNodePtr {
            ...
            == XML_ELEMENT_NODE as i32 as u32
        {
            if !((*cur).nsDef).is_null() {
                ...
                loop {
                    shadowed = 0 as i32;
                    if !(*(borrow_mut(&mut map)).unwrap()).is_null() && !((**(borrow_mut(&mut map)).unwrap()).first).is_null() {
                        mi = (**(borrow_mut(&mut map)).unwrap()).first;
                        while !mi.is_null() {
...
unsafe extern "C" fn xmlDOMWrapNSNormAddNsMapItem2<'a1, 'a2, 'a3>(
    ...
    if (*(borrow(& list)).unwrap()).is_null() {
        *(borrow_mut(&mut list)).unwrap() = xmlMalloc
            .expect(
                "non-null function pointer",
            )(
            (6 as i32 as u64)
        ...
        *(borrow_mut(&mut list)).unwrap() = xmlRealloc
            .expect(
                "non-null function pointer",
            )(
    ...
    let ref mut fresh369 = *(*(borrow(& list)).unwrap()).offset((2 as i32 * *(borrow(& number)).unwrap()) as isize);
    *fresh369 = oldNs;
    let ref mut fresh370 = *(*(borrow(& list)).unwrap())
...
#[no_mangle]
pub unsafe extern "C" fn xmlDOMWrapRemoveNode<'a1, 'a2>(
    ...
    's_67: loop {
        match (*node).type_0 as u32 {
            1 => {
                if borrow(& ctxt).is_none() && !((*node).nsDef).is_null() {
                    ns = (*node).nsDef;
                    loop {
...
unsafe extern "C" fn xmlSearchNsByNamespaceStrict<'a1>(
    mut doc: * mut crate::src::threads::_xmlDoc,
    mut node: * mut crate::src::threads::_xmlNode,
    mut nsName: * const u8,
...
unsafe extern "C" fn xmlSearchNsByPrefixStrict<'a1>(
    mut doc: * mut crate::src::threads::_xmlDoc,
    mut node: * mut crate::src::threads::_xmlNode,
    mut prefix: * const u8,
    mut retNs: Option<&'a1 mut * mut crate::src::threads::_xmlNs>,
                ...
                _ => {
                    ...
                    if ((*elem).nsDef).is_null() {
                        ...
                        *fresh373 = ret;
                        ...
                        let mut ns2: * mut crate::src::threads::_xmlNs = (*elem).nsDef;
...
unsafe extern "C" fn xmlDOMWrapNSNormAcquireNormalizedNs<'a1, 'a2>(
    mut doc: * mut crate::src::threads::_xmlDoc,
    mut elem: * mut crate::src::threads::_xmlNode,
    mut ns: * mut crate::src::threads::_xmlNs,
    mut retNs: Option<&'a1 mut * mut crate::src::threads::_xmlNs>,
    ...
    *(borrow_mut(&mut retNs)).unwrap() = 0 as xmlNsPtr;
    ...
    if !(*(borrow(& nsMap)).unwrap()).is_null() && !((**(borrow(& nsMap)).unwrap()).first).is_null()
        && !(ancestorsOnly != 0 && elem.is_null())
    {
        mi = (**(borrow_mut(&mut nsMap)).unwrap()).first;
        while !mi.is_null() {
                    ...
                    || xmlStrEqual((*(*mi).newNs).href, (*ns).href) != 0)
            {
                ...
                *fresh375 = ns;
                *(borrow_mut(&mut retNs)).unwrap() = (*mi).newNs;
                return 0 as i32;
            }
            mi = (*mi).next;
        }
...
#[no_mangle]
pub unsafe extern "C" fn xmlDOMWrapReconcileNamespaces<'a1, 'a2>(
    mut ctxt: Option<&'a1 mut crate::src::tree::_xmlDOMWrapCtxt<'a2>>,
    mut elem: * mut crate::src::threads::_xmlNode,
    mut options: i32,
) -> i32 {
...
unsafe extern "C" fn xmlDOMWrapAdoptBranch<'a1>(
                        ...
                        match (*cur).type_0 as u32 {
                            ...
                            7 => {
                                if adoptStr != 0 && !((*cur).name).is_null() {
                                    if !((*destDoc).dict).is_null() {
                                        let mut old_0: * const u8 = (*cur).name;
...
#[no_mangle]
pub unsafe extern "C" fn xmlDOMWrapCloneNode<'a1, 'a2>(
    mut ctxt: * mut crate::src::tree::_xmlDOMWrapCtxt<'a1>,
    mut sourceDoc: * mut crate::src::threads::_xmlDoc,
    mut node: * mut crate::src::threads::_xmlNode,
    ...
    let mut cloneNsDefSlot: Option<&'_ mut * mut crate::src::threads::_xmlNs> = Option::<&'_ mut * mut crate::src::threads::_xmlNs>::None;
    let mut dict: * mut crate::src::xpointer::_xmlDict = 0 as *mut xmlDict;
            ...
            match (*cur).type_0 as u32 {
                ...
                1 => {
                    ...
                    if !((*cur).nsDef).is_null() {
                        ...
                        cloneNsDefSlot = Some(&mut (*clone).nsDef);
                        ns = (*cur).nsDef;
                        while !ns.is_null() {
                            cloneNs = xmlMalloc
                                .expect(
                            ...
                            *(borrow_mut(&mut cloneNsDefSlot)).unwrap() = cloneNs;
                            cloneNsDefSlot = Some(&mut (*cloneNs).next);
...
unsafe extern "C" fn xmlDOMWrapAdoptAttr<'a1>(
    mut ctxt: * mut crate::src::tree::_xmlDOMWrapCtxt<'a1>,
    mut sourceDoc: * mut crate::src::threads::_xmlDoc,
    ...
    match current_block {
        12124785117276362961 => {
            if adoptStr != 0 && !((*attr).name).is_null() {
                if !((*destDoc).dict).is_null() {
                    let mut old: * const u8 = (*attr).name;
...
#[no_mangle]
pub unsafe extern "C" fn xmlDOMWrapAdoptNode<'a1>(
    mut ctxt: * mut crate::src::tree::_xmlDOMWrapCtxt<'a1>,
    mut sourceDoc: * mut crate::src::threads::_xmlDoc,
    mut node: * mut crate::src::threads::_xmlNode,
    mut destDoc: * mut crate::src::threads::_xmlDoc,
            ...
            *fresh472 = destDoc;
            ...
            match (*node).type_0 as u32 {
                ...
                5 => {
                    ...
                    *fresh477 = 0 as *mut _xmlNode;
                    ...
                    if adoptStr != 0 && !((*node).name).is_null() {
                        if !((*destDoc).dict).is_null() {
                            let mut old: * const u8 = (*node).name;
                ...
                7 => {
                    if adoptStr != 0 && !((*node).name).is_null() {
                        if !((*destDoc).dict).is_null() {
                            let mut old_0: * const u8 = (*node).name;
