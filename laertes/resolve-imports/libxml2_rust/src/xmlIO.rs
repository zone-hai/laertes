...
=======
    ...
    fn xmlNanoHTTPReturnCode(ctx: *mut libc::c_void) -> i32;
    fn xmlNanoHTTPRedir(ctx: *mut libc::c_void) -> *const i8;
    fn xmlNanoHTTPEncoding(ctx: *mut libc::c_void) -> *const i8;
    fn xmlNanoHTTPMimeType(ctx: *mut libc::c_void) -> *const i8;
    fn xmlNanoHTTPRead(
        ctx: *mut libc::c_void,
    ...
    fn xmlNanoFTPOpen(URL: *const i8) -> *mut libc::c_void;
    fn xmlNanoFTPClose(ctx: *mut libc::c_void) -> i32;
    fn xmlNanoFTPRead(
        ctx: *mut libc::c_void,
        dest: *mut libc::c_void,
        len: i32,
...
=======
pub unsafe extern "C" fn xmlFileMatch(mut filename: *const i8) -> i32 {
>>>>>>> bbfa64d0f7db1b5e94d853ac3a3845e65fc050fe
    return 1 as i32;
}
...
=======
unsafe extern "C" fn xmlGzfileMatch(mut filename: *const i8) -> i32 {
>>>>>>> bbfa64d0f7db1b5e94d853ac3a3845e65fc050fe
    return 1 as i32;
}
