...
pub unsafe extern "C" fn xmlCharInRange(
    ...
    if val < 0x10000 as i32 as u32 {
        if (*rptr).nbShortRange == 0 as i32 {
            return 0 as i32;
        }
        low = 0 as i32;
        high = (*rptr).nbShortRange - 1 as i32;
        ...
        if (*rptr).nbLongRange == 0 as i32 {
            return 0 as i32;
        }
        low = 0 as i32;
        high = (*rptr).nbLongRange - 1 as i32;
        lptr = (*rptr).longRange;
        while low <= high {
            mid = (low + high) / 2 as i32;
...
=======
pub unsafe extern "C" fn xmlIsBlank(mut ch: u32) -> i32 {
>>>>>>> bbfa64d0f7db1b5e94d853ac3a3845e65fc050fe
    return if ch < 0x100 as i32 as u32 {
...
=======
pub unsafe extern "C" fn xmlIsChar(mut ch: u32) -> i32 {
>>>>>>> bbfa64d0f7db1b5e94d853ac3a3845e65fc050fe
    return if ch < 0x100 as i32 as u32 {
        (0x9 as i32 as u32 <= ch
            && ch <= 0xa as i32 as u32
...
=======
pub unsafe extern "C" fn xmlIsIdeographic(mut ch: u32) -> i32 {
>>>>>>> bbfa64d0f7db1b5e94d853ac3a3845e65fc050fe
    return if ch < 0x100 as i32 as u32 {
        0 as i32
    } else {
