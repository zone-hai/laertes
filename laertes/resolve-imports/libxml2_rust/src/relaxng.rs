...
=======
    ...
    fn xmlAutomataIsDeterminist(am: xmlAutomataPtr) -> i32;
    ...
    fn xmlSchemaCompareValues(x: xmlSchemaValPtr, y: xmlSchemaValPtr) -> i32;
    ...
    fn xmlAutomataSetFlags(am: xmlAutomataPtr, flags: i32);
}
pub type xmlChar = u8;
pub type size_t = u64;
