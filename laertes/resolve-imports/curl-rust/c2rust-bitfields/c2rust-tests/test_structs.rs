...
struct OverlappingByteDate {
    ...
    #[bitfield(name = "d", ty = "u64", bits = "0..=4")]
    #[bitfield(name = "m", ty = "u16", bits = "5..=8")]
    d_m: [u8; 2],
    y: u16,
    #[bitfield(padding)]
    _pad: [u8; 4],
...
struct UnnamedBitfield {
    z: f64,
    #[bitfield(name = "x", ty = "u16", bits = "0..=4")]
    x: [u8; 1],
    #[bitfield(padding)]
    _pad: [u8; 1],
    #[bitfield(name = "y", ty = "u16", bits = "0..=8")]
    y: [u8; 2],
}
...
struct SignedBitfields {
    #[bitfield(name = "x", ty = "i16", bits = "0..=3")]
    #[bitfield(name = "y", ty = "u16", bits = "4..=8")]
    #[bitfield(name = "z", ty = "i16", bits = "9..=13")]
    x_y_z: [u8; 2],
}
...
#[derive(BitfieldStruct, Copy, Clone)]
struct SingleBits {
    #[bitfield(name = "x", ty = "u16", bits = "0..=0")]
    #[bitfield(name = "y", ty = "i16", bits = "1..=1")]
    x_y: [u8; 1],
    #[bitfield(padding)]
    _pad: [u8; 1],
}
...
struct ThreeByteDate {
    #[bitfield(name = "day", ty = "u8", bits = "0..=4")]
    #[bitfield(name = "month", ty = "u8", bits = "5..=8")]
    #[bitfield(name = "year", ty = "u16", bits = "9..=23")]
    day_month_year: [u8; 3],
}
